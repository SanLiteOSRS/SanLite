...
public abstract class WorldHoppingMixin implements RSClient
{
	...
	public void openWorldHopper()
	{
		...
		invokeMenuAction(-1, WidgetInfo.WORLD_SWITCHER_BUTTON.getId(), MenuAction.CC_OP.getId(), 1, "World Switcher", "", -1, -1);
	}
	...
	public void hopToWorld(World world)
	{
		...
		invokeMenuAction(worldId, WidgetInfo.WORLD_SWITCHER_LIST.getId(), MenuAction.CC_OP.getId(), 1, "Switch", "<col=ff9040>" + (worldId - 300) + "</col>", -1, -1);
	}
}
