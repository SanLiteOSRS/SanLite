...
public class class301 {
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.field1191 >= Client.cycle) { // L: 3994
			...
			var3 = var0.field1187 * 128 + var0.field1167 * 64; // L: 3996
			var4 = var0.field1189 * 128 + var0.field1167 * 64; // L: 3997
			...
			if (var0.field1192 == Client.cycle || var0.sequence == -1 || var0.sequenceDelay != 0 || var0.sequenceFrameCycle + 1 > class114.SequenceDefinition_get(var0.sequence).frameLengths[var0.sequenceFrame]) { // L: 4004
				...
				var4 = var0.field1187 * 128 + var0.field1167 * 64; // L: 4007
				int var5 = var0.field1189 * 128 + var0.field1167 * 64; // L: 4008
				int var6 = var0.field1188 * 128 + var0.field1167 * 64; // L: 4009
				int var7 = var0.field1190 * 128 + var0.field1167 * 64; // L: 4010
		...
		if (var0.x < 128 || var0.y < 128 || var0.x >= 13184 || var0.y >= 13184) { // L: 4019
			...
			var0.x = var0.pathX[0] * 128 + var0.field1167 * 64; // L: 4024
		...
		if (ModelData0.localPlayer == var0 && (var0.x < 1536 || var0.y < 1536 || var0.x >= 11776 || var0.y >= 11776)) { // L: 4028 4029
			...
			var0.x = var0.pathX[0] * 128 + var0.field1167 * 64; // L: 4034
		...
		if (var0.field1204 != 0) { // L: 4040
			...
			if (var2 != 0) { // L: 4064
				...
				boolean var10;
				if (var2 > 1024) { // L: 4066
					var0.rotation -= var0.field1173 ? var2 : var0.field1204; // L: 4067
					var10 = true; // L: 4068
					...
					var0.rotation += var0.field1173 ? var2 : var0.field1204; // L: 4079
					var10 = true; // L: 4080
		...
		if (!var0) { // L: 5776
			...
			for (var1 = 0; var1 < InterfaceParent.regionLandArchives.length; ++var1) { // L: 5782
				...
				if (var15 != null) { // L: 5784
					var3 = (class241.regions[var1] >> 8) * 64 - SecureRandomCallable.baseX * 64; // L: 5785
					var4 = (class241.regions[var1] & 255) * 64 - GrandExchangeOfferOwnWorldComparator.baseY * 64; // L: 5786
			...
			if (!var0) { // L: 5794
				...
				if (!Client.isInInstance) { // L: 5814
					...
					for (var2 = 0; var2 < var1; ++var2) { // L: 5815
						var3 = (class241.regions[var2] >> 8) * 64 - SecureRandomCallable.baseX * 64; // L: 5816
						var4 = (class241.regions[var2] & 255) * 64 - GrandExchangeOfferOwnWorldComparator.baseY * 64; // L: 5817
					...
					for (var2 = 0; var2 < var1; ++var2) { // L: 5824
						var3 = (class241.regions[var2] >> 8) * 64 - SecureRandomCallable.baseX * 64; // L: 5825
						var4 = (class241.regions[var2] & 255) * 64 - GrandExchangeOfferOwnWorldComparator.baseY * 64; // L: 5826
					...
					for (var2 = 0; var2 < var1; ++var2) { // L: 5834
						...
						if (var13 != null) { // L: 5836
							var4 = (class241.regions[var2] >> 8) * 64 - SecureRandomCallable.baseX * 64; // L: 5837
							var5 = (class241.regions[var2] & 255) * 64 - GrandExchangeOfferOwnWorldComparator.baseY * 64; // L: 5838
				...
				if (class82.client.hasFrame()) { // L: 5919
					var17 = DecorativeObject.getPacketBufferNode(ClientPacket.field2948, Client.packetWriter.isaacCipher); // L: 5921
				...
				var17 = DecorativeObject.getPacketBufferNode(ClientPacket.field3031, Client.packetWriter.isaacCipher); // L: 5941
