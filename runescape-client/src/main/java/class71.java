...
public class class71 {
	...
	static {
		field893 = new BigInteger("10001", 16); // L: 6
		field894 = new BigInteger("", 16); // L: 7
	}
	...
	static void readPlayerUpdate(PacketBuffer var0, int var1) {
		...
		if (var3 == 0) { // L: 195
			if (var2) { // L: 196
				var4.field1116 = false; // L: 197
			} else if (Client.localPlayerIndex == var1) { // L: 200
				throw new RuntimeException();
			} else {
				Players.Players_regions[var1] = (var4.plane << 28) + (class158.baseY * 64 + var4.pathY[0] >> 13) + (class26.baseX * 64 + var4.pathX[0] >> 13 << 14); // L: 201
				if (var4.field1203 != -1) { // L: 202
			...
			if (var3 == 1) { // L: 209
				...
				if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) { // L: 233
					...
					var4.field1116 = false; // L: 235
				} else if (var2) { // L: 237
					var4.field1116 = true; // L: 238
					var4.tileX = var6; // L: 239
					var4.tileY = var7; // L: 240
				} else {
					var4.field1116 = false; // L: 243
					var4.method2291(var6, var7, Players.field1314[var1]); // L: 244
				}
				...
				if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) { // L: 304
					...
					var4.field1116 = false; // L: 306
				} else if (var2) { // L: 308
					var4.field1116 = true; // L: 309
					var4.tileX = var6; // L: 310
					var4.tileY = var7; // L: 311
				} else {
					var4.field1116 = false; // L: 314
					var4.method2291(var6, var7, Players.field1314[var1]); // L: 315
				}
				...
				if (var5 == 0) { // L: 320
					...
					if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) { // L: 329
						...
						var4.field1116 = false; // L: 331
					} else if (var2) { // L: 333
						var4.field1116 = true; // L: 334
						var4.tileX = var10; // L: 335
						var4.tileY = var11; // L: 336
					} else {
						var4.field1116 = false; // L: 339
						var4.method2291(var10, var11, Players.field1314[var1]); // L: 340
					}
					...
					var10 = (class26.baseX * 64 + var8 + var4.pathX[0] & 16383) - class26.baseX * 64; // L: 350
					var11 = (class158.baseY * 64 + var9 + var4.pathY[0] & 16383) - class158.baseY * 64; // L: 351
					if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) { // L: 352
						var4.resetPath(var10, var11); // L: 353
						var4.field1116 = false; // L: 354
					} else if (var2) { // L: 356
						var4.field1116 = true; // L: 357
						var4.tileX = var10; // L: 358
						var4.tileY = var11; // L: 359
					} else {
						var4.field1116 = false; // L: 362
						var4.method2291(var10, var11, Players.field1314[var1]); // L: 363
					}
