	...
	static int method2710(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.CC_SETSCROLLPOS) { // L: 614
			...
			if (var0 == ScriptOpcodes.CC_SETMODELANIM) { // L: 677
				...
				class455 var6 = (class455)Varps.findEnumerated(UserComparator4.FillMode_values(), var8); // L: 769
				if (var6 != null) { // L: 770
	...
	static int method2709(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.CLIENTCLOCK) { // L: 2105
			...
			if (var0 == ScriptOpcodes.INV_GETOBJ) { // L: 2109
				...
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = FriendsChatMember.method6838(var3, var4); // L: 2127
				return 1; // L: 2128
				...
				if (var0 == ScriptOpcodes.COORD) { // L: 2150
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = FriendsChatMember.method6838(var3, var4); // L: 2194
					return 1; // L: 2195
