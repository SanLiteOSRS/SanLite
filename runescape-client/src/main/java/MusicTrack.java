...
public class MusicTrack extends Node {
	...
	MusicTrack(Buffer var1) {
		this.field3474 = new NodeHashTable(16); // L: 11
		...
		var51.writeIntME(1297377380); // L: 158
		var51.writeIntME(6); // L: 159
		...
		for (int var63 = 0; var63 < var2; ++var63) { // L: 178
			var51.writeIntME(1297379947); // L: 179
					...
					if (var68 == 23) { // L: 197
						...
						if (var66 == 0) { // L: 207
							...
							if (var71 > 0) { // L: 215
								...
								class316 var73 = (class316)this.field3474.get((long)var72); // L: 217
								if (var73 == null) { // L: 218
									var73 = new class316(var65); // L: 219
									this.field3474.put(var73, (long)var72); // L: 220
								}

								var73.field3498.set(var74); // L: 222
							}
