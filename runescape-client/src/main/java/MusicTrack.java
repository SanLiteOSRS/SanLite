...
public class MusicTrack extends Node {
	...
	MusicTrack(Buffer var1) {
		this.field3483 = new NodeHashTable(16); // L: 11
					...
					if (var68 == 23) { // L: 197
						...
						if (var66 == 0) { // L: 207
							...
							if (var71 > 0) { // L: 215
								...
								class319 var73 = (class319)this.field3483.get((long)var72); // L: 217
								if (var73 == null) { // L: 218
									var73 = new class319(var65); // L: 219
									this.field3483.put(var73, (long)var72); // L: 220
								}

								var73.field3520.set(var74); // L: 222
							}
