...
public class MusicTrack extends Node {
	...
	MusicTrack(Buffer var1) {
		this.field3496 = new NodeHashTable(16); // L: 11
					...
					if (var68 == 23) { // L: 197
						...
						if (var66 == 0) { // L: 207
							...
							if (var71 > 0) { // L: 215
								...
								class329 var73 = (class329)this.field3496.get((long)var72); // L: 217
								if (var73 == null) { // L: 218
									var73 = new class329(var65); // L: 219
									this.field3496.put(var73, (long)var72); // L: 220
								}

								var73.field3540.set(var74); // L: 222
							}
