...
public class MusicTrack extends Node {
	...
	MusicTrack(Buffer var1) {
		this.field3543 = new NodeHashTable(16); // L: 11
		...
		var51.method9373(1297377380); // L: 158
		var51.method9373(6); // L: 159
		...
		for (int var63 = 0; var63 < var2; ++var63) { // L: 178
			var51.method9373(1297379947); // L: 179
					...
					if (var68 == 23) { // L: 197
						...
						if (var66 == 0) { // L: 207
							...
							if (var71 > 0) { // L: 215
								...
								class332 var73 = (class332)this.field3543.get((long)var72); // L: 217
								if (var73 == null) { // L: 218
									var73 = new class332(var65); // L: 219
									this.field3543.put(var73, (long)var72); // L: 220
								}

								var73.field3586.set(var74); // L: 222
							}
