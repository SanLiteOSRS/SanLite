...
public class class5 implements class2 {
	...
	class5(class8 var1) {
		this.field10 = this.method20(); // L: 14
	} // L: 15
	...
	byte[] method19(String var1, long var2) {
		...
		this.field10.reset(); // L: 58

		try {
			this.field10.update(var4.toString().getBytes("UTF-8")); // L: 60
		} catch (UnsupportedEncodingException var6) { // L: 62
			var6.printStackTrace(); // L: 63
		}

		return this.field10.digest(); // L: 65
	}
