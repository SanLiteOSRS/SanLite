...
public class class5 implements class2 {
	...
	class5(class8 var1) {
		this.field5 = this.method22(); // L: 14
	} // L: 15

	@ObfuscatedName("am")
	boolean method19(int var1, String var2, long var3) {
		byte[] var5 = this.method21(var2, var3); // L: 18
		return method29(var5) >= var1; // L: 19
	}
	...
	byte[] method21(String var1, long var2) {
		...
		this.field5.reset(); // L: 58

		try {
			this.field5.update(var4.toString().getBytes("UTF-8")); // L: 60
		} catch (UnsupportedEncodingException var6) { // L: 62
			var6.printStackTrace(); // L: 63
		}

		return this.field5.digest(); // L: 65
	}
