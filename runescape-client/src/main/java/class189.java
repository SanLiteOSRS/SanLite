...
public class class189 {
      ...
      for(var2 = 0; var2 < Players.Players_count; ++var2) {
         ...
         if ((Players.field1221[var3] & 1) == 0) {
            if (var1 > 0) {
               ...
               if (var4 == 0) {
                  var1 = UserComparator9.method3337(var0);
                  var10000 = Players.field1221;
                  var10000[var3] = (byte)(var10000[var3] | 2);
               } else {
                  StudioGame.method4059(var0, var3);
               }
            }
         }
      }
   ...
   static final void method3595(Widget[] var0, int var1) {
      for(int var2 = 0; var2 < var0.length; ++var2) {
         Widget var3 = var0[var2];
         if (var3 != null) {
            if (var3.type == 0) {
               if (var3.children != null) {
                  method3595(var3.children, var1);
               }

               InterfaceParent var4 = (InterfaceParent)Client.interfaceParents.get((long)var3.id);
               if (var4 != null) {
                  UserComparator6.method3382(var4.group, var1);
               }
            }
