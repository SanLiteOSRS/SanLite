...
public class class189 {
	...
	static void method3743(GameShell var0) {
		int var4;
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState != 5) {
				if (Login.field1185 == -1L) {
					Login.field1185 = PlayerAppearance.method4141() + 1000L;
				}

				long var16 = PlayerAppearance.method4141();
				boolean var3;
				if (Client.archiveLoaders != null && Client.archiveLoaderArchive < Client.archiveLoaders.size()) {
					while (true) {
						...
						ArchiveLoader var18 = (ArchiveLoader)Client.archiveLoaders.get(Client.archiveLoaderArchive);
						if (!var18.isLoaded()) {
							var3 = false;
							break;
						}
				...
				if (Client.gameState == 10 || Client.gameState == 11) {
					...
					if (Login.loginIndex == 0) {
						...
						if (var4 == 1 && var32 >= var30 - 75 && var32 <= var30 + 75 && var26 >= var29 - 20 && var26 <= var29 + 20) {
							class2.openURL(WorldMapElement.method4494("secure", true) + "m=account-creation/g=oldscape/create_account_funnel.ws", true, false);
						}
							...
							if (Login.loginIndex == 2) {
								...
								while (true) {
									...
									do {
										while (true) {
											...
											if (PcmPlayer.method2592(DevicePcmPlayerProvider.field395) && AbstractWorldMapIcon.method679(DevicePcmPlayerProvider.field395) && Login.Login_password.length() < 20) {
									...
									try {
										...
										for (int var15 = 0; var15 < var14; ++var15) {
											if (!PcmPlayer.method2592(var13.charAt(var15)) || !AbstractWorldMapIcon.method679(var13.charAt(var15))) {
												Login.loginIndex = 3;
												return;
											}
										}
								...
								if (Login.loginIndex == 4) {
									...
									if (var4 == 1 && var32 >= Login.loginBoxX + 180 - 34 && var32 <= Login.loginBoxX + 34 + 180 && var26 >= 351 && var26 <= 363) {
										class2.openURL(WorldMapElement.method4494("secure", true) + "m=totp-authenticator/disableTOTPRequest", true, false);
									}
									...
									var8 = 321;
									if (var4 == 1 && var32 >= var27 - 75 && var32 <= var27 + 75 && var26 >= var8 - 20 && var26 <= var8 + 20) {
										ClientPacket.method3713();
										return;
									}

									var27 = Login.loginBoxX + 180 + 80;
									if (var4 == 1 && var32 >= var27 - 75 && var32 <= var27 + 75 && var26 >= var8 - 20 && var26 <= var8 + 20) {
										UserComparator3.method3519(true);
									}
									...
									if (WorldMapManager.field319 != null) {
										...
										if (var4 == 1 && var32 >= WorldMapManager.field319.lowX - var20 && var32 <= var20 + WorldMapManager.field319.lowX && var26 >= var29 - 15 && var26 < var29) {
											class2.openURL(WorldMapElement.method4494("secure", true) + "m=weblogin/g=oldscape/cant_log_in", true, false);
										}
									}
									...
									if (Login.loginIndex == 7) {
										...
										var8 = 321;
										if (var4 == 1 && var32 >= var27 - 75 && var32 <= var27 + 75 && var26 >= var8 - 20 && var26 <= var8 + 20) {
											class2.openURL(WorldMapElement.method4494("secure", true) + "m=dob/set_dob.ws", true, false);
	...
	static final void method3746(PacketBuffer var0, int var1, Player var2, int var3) {
		byte var4 = -1;
		int var5;
		int var8;
		int var9;
		...
		if ((var3 & 128) != 0) {
			...
			PlayerType var6 = (PlayerType)WorldMapIcon_1.findEnumerated(class51.PlayerType_values(), var0.method5583());
			...
			if (var2.username != null && var2.appearance != null) {
				...
				if (!var10 && Client.field745 == 0 && !var2.isHidden) {
					...
					var0.method5646(Players.field1238.array, 0, var8);
					Players.field1238.offset = 0;
					String var11 = AbstractFont.escapeBrackets(class222.method4221(class4.method90(Players.field1238)));
		...
		if ((var3 & 2048) != 0) {
			Players.field1228[var1] = var0.method5584();
		}

		if ((var3 & 32) != 0) {
			var2.field934 = var0.method5592();
		...
		if ((var3 & 256) != 0) {
			var2.field966 = var0.method5584();
			var2.field979 = var0.method5584();
			var2.field967 = var0.method5584();
			var2.field969 = var0.method5615();
			var2.field925 = var0.readUnsignedShort() + Client.cycle;
			var2.field971 = var0.method5591() + Client.cycle;
			var2.field972 = var0.method5592();
			if (var2.field606) {
		...
		if ((var3 & 1024) != 0) {
			var2.spotAnimation = var0.method5592();
			var5 = var0.readInt();
		...
		if ((var3 & 1) != 0) {
			...
			if (var13 > 0) {
				for (var17 = 0; var17 < var13; ++var17) {
					...
					if (var9 != 32767) {
						var19 = var0.readUShortSmart();
						var15 = var0.method5566();
						var12 = var9 > 0 ? var0.method5641() : var15;
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						if (var7.length() > 500) {
							...
							var6.packetBuffer.method5579(var15);
