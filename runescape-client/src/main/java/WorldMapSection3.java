...
public class WorldMapSection3 implements WorldMapSection {
	...
	public int[] getBorderTileLengths(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) {
			...
			int[] var4 = new int[]{this.field382 * 64 - this.field383 * 64 + var2 + (this.field386 * 8 - this.field384 * 8), var3 + (this.field380 * 64 - this.field381 * 64) + (this.field387 * 8 - this.field385 * 8)};
			return var4;
		}
	}
	...
	public Coord coord(int var1, int var2) {
		if (!this.containsPosition(var1, var2)) {
			...
			int var4 = this.field381 * 64 - this.field380 * 64 + var2 + (this.field385 * 8 - this.field387 * 8);
	...
	static boolean loadWorlds() {
		try {
			if (VertexNormal.World_request == null) {
				VertexNormal.World_request = WorldMapLabelSize.urlRequester.request(new URL(HorizontalAlignment.field3489));
