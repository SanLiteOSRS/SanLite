...
public class PlatformInfo extends Node {
	...
	PlatformInfo(int var1, boolean var2, int var3, int var4, int var5, int var6, int var7, boolean var8, int var9, int var10, int var11, int var12, String var13, String var14, String var15, String var16, int var17, int var18, int var19, int var20, String var21, String var22, int[] var23, int var24, String var25, String var26) {
		...
		this.field4517 = var1; // L: 68
		this.field4518 = var2; // L: 69
		this.field4519 = var3; // L: 70
		this.field4529 = var4; // L: 71
		this.field4521 = var5; // L: 72
		this.field4522 = var6; // L: 73
		this.field4523 = var7; // L: 74
		this.field4524 = var8; // L: 75
		this.field4525 = var9; // L: 76
		this.field4526 = var10; // L: 77
		this.field4527 = var11; // L: 78
		this.field4513 = var12; // L: 79
	...
	public void write(Buffer var1) {
		...
		var1.writeByte(this.field4517); // L: 98
		var1.writeByte(this.field4518 ? 1 : 0); // L: 99
		var1.writeShort(this.field4519); // L: 100
		var1.writeByte(this.field4529); // L: 101
		var1.writeByte(this.field4521); // L: 102
		var1.writeByte(this.field4522); // L: 103
		var1.writeByte(this.field4523); // L: 104
		var1.writeByte(this.field4524 ? 1 : 0); // L: 105
		var1.writeShort(this.field4525); // L: 106
		var1.writeByte(this.field4526); // L: 107
		var1.writeMedium(this.field4527); // L: 108
		var1.writeShort(this.field4513); // L: 109
