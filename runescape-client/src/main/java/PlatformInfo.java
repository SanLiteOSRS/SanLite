...
public class PlatformInfo extends Node {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
		...
		if (var2 == 1) {
			...
			var8.packetBuffer.method6930(PlayerComposition.baseY * 64 + var1);
			var8.packetBuffer.writeShort(WorldMapSectionType.baseX * 64 + var0);
			...
			var8.packetBuffer.method6931(WorldMapSectionType.baseX * 64 + var0);
			var8.packetBuffer.method6930(PlayerComposition.baseY * 64 + var1);
			...
			var8.packetBuffer.method7029(PlayerComposition.baseY * 64 + var1);
			var8.packetBuffer.method7029(WorldMapSectionType.baseX * 64 + var0);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 4) {
			Client.mouseCrossX = var6;
			Client.mouseCrossY = var7;
			...
			var8.packetBuffer.method6931(PlayerComposition.baseY * 64 + var1);
			var8.packetBuffer.method6931(WorldMapSectionType.baseX * 64 + var0);
			var8.packetBuffer.method7026(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.method7029(var3);
			Client.packetWriter.addNode(var8);
									...
									label638: {
										if (var2 != 57) {
											...
											if (var2 == 1001) {
												...
												var8.packetBuffer.method6930(var3);
												var8.packetBuffer.method6930(PlayerComposition.baseY * 64 + var1);
												var8.packetBuffer.method6930(WorldMapSectionType.baseX * 64 + var0);
												var8.packetBuffer.method7066(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
												Client.packetWriter.addNode(var8);
												break label638;
											}
											...
											if (var2 != 1007) {
												if (var2 == 1012 || var2 == 1009 || var2 == 1010 || var2 == 1011 || var2 == 1008) {
