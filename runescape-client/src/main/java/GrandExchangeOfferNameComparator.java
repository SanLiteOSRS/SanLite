...
final class GrandExchangeOfferNameComparator implements Comparator {
   ...
   static int method150(int var0, Script var1, boolean var2) {
      if (var0 == ScriptOpcodes.CHAT_GETFILTER_PUBLIC) {
         ...
         WorldMapIcon_0.privateChatMode = class270.valueOf(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
         if (WorldMapIcon_0.privateChatMode == null) {
            WorldMapIcon_0.privateChatMode = class309.field3788;
         }

         Client.tradeChatMode = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 2];
         PacketBufferNode var18 = MenuAction.method1994(ClientPacket.field2200, Client.packetWriter.isaacCipher);
         ...
         Client.packetWriter.method2177(var18);
         return 1;
      } else {
         String var3;
         int var4;
         if (var0 == ScriptOpcodes.CHAT_SENDABUSEREPORT) {
            ...
            PacketBufferNode var6 = MenuAction.method1994(ClientPacket.field2223, Client.packetWriter.isaacCipher);
            ...
            Client.packetWriter.method2177(var6);
            return 1;
         } else {
            int var10;
            if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYTYPEANDLINE) {
               ...
               Message var15 = class169.method3446(var10, var4);
               if (var15 != null) {
               ...
               var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
               Message var16 = class227.method4039(var10);
               if (var16 != null) {
               ...
               PacketBufferNode var8 = MenuAction.method1994(ClientPacket.field2282, Client.packetWriter.isaacCipher);
               ...
               PacketBufferNode var11 = MenuAction.method1994(ClientPacket.field2210, Client.packetWriter.isaacCipher);
               ...
               Client.packetWriter.method2177(var11);
               return 1;
               ...
               if (var0 == ScriptOpcodes.CHAT_GETFILTER_TRADE) {
                  ...
                  var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                  Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = BoundaryObject.method3218(var10);
                  return 1;
               } else if (var0 == ScriptOpcodes.CHAT_GETNEXTUID) {
                  var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                  Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = FaceNormal.method3220(var10);
                  return 1;
               } else if (var0 == ScriptOpcodes.CHAT_GETPREVUID) {
                  var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                  Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = Language.method3608(var10);
                  return 1;
   ...
   static final void method149(Actor var0) {
      ...
      if (var0.movementSequence != -1) {
         var1 = Widget.getSequenceDefinition(var0.movementSequence);
      ...
      if (var0.spotAnimation != -1 && Client.cycle >= var0.field958) {
         ...
         int var3 = HealthBarUpdate.getSpotAnimationDefinition(var0.spotAnimation).sequence;
         if (var3 != -1) {
            SequenceDefinition var2 = Widget.getSequenceDefinition(var3);
      ...
      if (var0.sequence != -1 && var0.sequenceDelay <= 1) {
         var1 = Widget.getSequenceDefinition(var0.sequence);
   ...
   static void method146() {
      WorldMapData_1.method683(World.menuWidth / 2 + MilliClock.menuX, class96.menuY);
   }
   ...
   static final void method147(int var0, int var1, int var2, boolean var3) {
      if (Projectile.loadInterface(var0)) {
         ItemContainer.resizeWidget(Widget.Widget_interfaceComponents[var0], -1, var1, var2, var3);
      }
   }
