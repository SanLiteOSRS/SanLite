...
final class GrandExchangeOfferNameComparator implements Comparator {
	...
	public static PacketBufferNode method5784(int var0, String var1, Language var2, int var3) {
		PacketBufferNode var4 = DecorativeObject.getPacketBufferNode(ClientPacket.field2973, Client.packetWriter.isaacCipher); // L: 17
		...
		Nameable.method6525(var4.packetBuffer, var1); // L: 167
