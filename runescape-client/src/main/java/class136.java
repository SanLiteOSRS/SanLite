...
public class class136 extends DualNode {
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) { // L: 1576
			...
			class466.archive5 = FriendSystem.newArchive(0, false, true, true, false); // L: 1592
			...
			byte var41 = 0; // L: 1619
			var18 = var41 + class466.archive5.percentage() * 4 / 100; // L: 1620
			...
			if (var18 != 100) { // L: 1641
				...
				method3070(class466.archive5, "Animations"); // L: 1646
				...
				if (Client.titleLoadingStage == 50) { // L: 1691
					...
					if (Client.titleLoadingStage == 60) { // L: 1717
						...
						if (!MouseRecorder.archive2.isFullyLoaded()) { // L: 1749
							...
							FriendLoginUpdate.method7785(MouseRecorder.archive2, class466.archive5, Actor.field1223); // L: 1776
