...
public abstract class class116 extends Node {
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.field1145 >= Client.cycle) {
			...
			var3 = var0.field1148 * 128 + var0.field1109 * -159121408;
			var4 = var0.field1126 * 128 + var0.field1109 * -159121408;
			...
			if (var0.pathLength == 0) {
				...
				label399: {
					...
					var11 = var0.x;
					var3 = var0.y;
					var4 = var0.pathX[var0.pathLength - 1] * 128 + var0.field1109 * -159121408;
					int var5 = var0.pathY[var0.pathLength - 1] * 128 + var0.field1109 * -159121408;
					if (var11 < var4) {
						if (var3 < var5) {
		...
		if (var0.x < 128 || var0.y < 128 || var0.x >= 13184 || var0.y >= 13184) {
			...
			var0.field1145 = 0;
			var0.field1165 = 0;
			var0.x = var0.pathX[0] * 128 + var0.field1109 * -159121408;
			var0.y = var0.pathY[0] * 128 + var0.field1109 * -159121408;
			var0.method2137();
		}
