...
public class PacketWriter {
	...
	public static final SpritePixels getItemSprite(int var0, int var1, int var2, int var3, int var4, boolean var5) {
		...
		ItemComposition var9 = FileSystem.ItemComposition_get(var0); // L: 365
		if (var1 > 1 && var9.countobj != null) { // L: 366
			...
			if (var10 != -1) { // L: 371
				var9 = FileSystem.ItemComposition_get(var10);
			}
		}
		...
		if (var19 == null) { // L: 374
			...
			if (var4 == 1 || var4 == 2 && var9.isStackable == 1) { // L: 413
				class146.ItemComposition_fontPlain11.draw(class301.method5583(var1), 0, 9, 16776960, 1); // L: 414
			}
