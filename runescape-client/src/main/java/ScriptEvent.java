...
public class ScriptEvent extends Node {
	...
	static void method1274(int var0, int var1, int var2, ObjectDefinition var3, int var4) {
		...
		var5.field1060 = (var6 + var1) * 128;
		var5.field1053 = (var7 + var2) * 128;
	...
	public static final Sprite getItemSprite(int var0, int var1, int var2, int var3, int var4, boolean var5) {
		...
		if (var21 == null) {
			...
			var21.method2997(0, var9.yan2d, var9.zan2d, var9.xan2d, var9.offsetX2d, var21.height / 2 + var17 + var9.offsetY2d, var18 + var9.offsetY2d);
			if (var9.notedId != -1) {
				var22.drawTransBgAt(0, 0);
			}
