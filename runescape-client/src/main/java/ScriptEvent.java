...
public class ScriptEvent extends Node {
	...
	static final void method2366(int var0, int var1) {
		if (Client.field513 == 2) { // L: 5131
			FriendSystem.worldToScreen((Client.field525 - HealthBarDefinition.baseX * 64 << 7) + Client.field523 * 4096, (Client.field613 - WorldMapScaleHandler.baseY * 64 << 7) + Client.field524 * 4096, Client.field522 * 4); // L: 5132
