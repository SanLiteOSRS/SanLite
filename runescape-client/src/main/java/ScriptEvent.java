...
public class ScriptEvent extends Node {
	...
	static WorldMapSprite method2063(byte[] var0) {
		return var0 == null ? new WorldMapSprite() : new WorldMapSprite(class155.method3172(var0).pixels); // L: 19 20
	}
