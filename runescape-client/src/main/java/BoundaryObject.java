...
public final class BoundaryObject {
   ...
   static int method3218(int var0) {
      ...
      while(true) {
         if (var1.bitsRemaining(Client.packetWriter.serverPacketLength) >= 27) {
            ...
            if (var2 != 32767) {
               ...
               int var7 = Client.field749[var1.readBits(3)];
               if (var3) {
                  var4.orientation = var4.field918 = var7;
               }
               ...
               var4.field971 = var4.definition.field3473;
               if (var4.field971 == 0) {
                  var4.field918 = 0;
               }
   ...
   public static void method3215(int var0, int var1, int var2, boolean var3) {
      PacketBufferNode var4 = MenuAction.method1994(ClientPacket.field2255, Client.packetWriter.isaacCipher);
