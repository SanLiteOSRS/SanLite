...
public class class149 {
	...
	public static double[] method3135(double var0, double var2, int var4) {
		...
		for (int var8 = 0; var7 <= var4; ++var8) {
			var6[var8] = Varps.method5536((double)var7, var0, var2); // L: 21
			++var7; // L: 20
		}
	...
	@ObfuscatedName("f")
	@ObfuscatedSignature(
		descriptor = "(Loo;FFFI)F",
		garbageValue = "146848499"
	)
	static float method3136(class390 var0, float var1, float var2, float var3) {
		float var4 = class273.method5265(var0.field4424, var0.field4426, var1); // L: 116
		if (Math.abs(var4) < class114.field1399) { // L: 117
			return var1;
		} else {
			float var5 = class273.method5265(var0.field4424, var0.field4426, var2); // L: 118
			if (Math.abs(var5) < class114.field1399) { // L: 119
				return var2;
			} else {
				...
				do {
					...
					float var16 = class114.field1401 * Math.abs(var2) + var3 * 0.5F; // L: 147
					...
					if (var18) { // L: 150
						if (Math.abs(var8) >= var16 && Math.abs(var4) > Math.abs(var5)) { // L: 151
							...
							var12 = var8; // L: 169
							var8 = var7; // L: 170
							if (2.0F * var9 < var17 * 3.0F * var10 - Math.abs(var10 * var16) && var9 < Math.abs(var10 * 0.5F * var12)) { // L: 171
						...
						var5 = class273.method5265(var0.field4424, var0.field4426, var2); // L: 184
