		...
		if (var0 == ScriptOpcodes.OC_NAME) {
			...
			if (var0 == ScriptOpcodes.OC_OP) {
				...
				if (var0 == ScriptOpcodes.OC_CERT) {
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = GroundObject.foundItemIdCount;
					return 1;
					...
					if (class133.foundItemIds != null && RouteStrategy.foundItemIndex < GroundObject.foundItemIdCount) {
