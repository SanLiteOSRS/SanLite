...
public class Skills {
	...
	static void resumePauseWidget(int var0, int var1) {
		PacketBufferNode var2 = DecorativeObject.getPacketBufferNode(ClientPacket.field2967, Client.packetWriter.isaacCipher); // L: 9801
	...
	static final void Clan_joinChat(String var0) {
		if (!var0.equals("")) { // L: 12447
			PacketBufferNode var1 = DecorativeObject.getPacketBufferNode(ClientPacket.field2970, Client.packetWriter.isaacCipher); // L: 12449
