...
public class class153 extends class143 {
	...
	void vmethod3531(Buffer var1) {
		...
		this.field1688 = var1.readStringCp1252NullTerminated(); // L: 327
	} // L: 328
	...
	void vmethod3529(ClanSettings var1) {
		var1.method3355(this.field1689, this.field1688); // L: 331
	} // L: 332
	...
	static void changeWorldSelectSorting(int var0, int var1) {
		...
		ModeWhere.sortWorlds(World.World_worlds, 0, World.World_worlds.length - 1, World.World_sortOption1, World.World_sortOption2); // L: 78
	} // L: 79
}
