...
public class class346 implements Iterator {
	...
	public static final SpritePixels getItemSprite(int var0, int var1, int var2, int var3, int var4, boolean var5) {
		...
		ItemComposition var9 = EnumComposition.ItemComposition_get(var0); // L: 373
		if (var1 > 1 && var9.countobj != null) { // L: 374
			...
			if (var10 != -1) { // L: 379
				var9 = EnumComposition.ItemComposition_get(var10);
			}
		}
		...
		if (var19 == null) { // L: 382
			...
			if (var4 == 1 || var4 == 2 && var9.isStackable == 1) { // L: 421
				ItemComposition.ItemComposition_fontPlain11.draw(HitSplatDefinition.method3632(var1), 0, 9, 16776960, 1); // L: 422
			}
