...
public class SecureRandomCallable implements Callable {
	...
	static final void logOut() {
		...
		class221.Ignored_cached.method7382(); // L: 2982
		SoundSystem.method780(); // L: 2983
		class175.method3379(); // L: 2984
		class250.method4933(); // L: 2985
		ParamComposition.ParamComposition_cached.clear(); // L: 2987
		WorldMapElement.WorldMapElement_cachedSprites.clear(); // L: 2990
		PlayerComposition.PlayerComposition_cachedModels.clear(); // L: 2993
