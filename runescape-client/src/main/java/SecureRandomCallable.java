...
public class SecureRandomCallable implements Callable {
	...
	public static class439 method2201(int var0) {
		class439 var1 = (class439)class439.DBRowType_cache.get((long)var0); // L: 24
		if (var1 != null) { // L: 25
			return var1;
		} else {
			byte[] var2 = class439.field4718.takeFile(38, var0); // L: 26
			var1 = new class439(); // L: 27
			if (var2 != null) { // L: 28
				var1.method7830(new Buffer(var2));
			}

			var1.method7829(); // L: 29
			class439.DBRowType_cache.put(var1, (long)var0); // L: 30
			return var1; // L: 31
		}
	}
