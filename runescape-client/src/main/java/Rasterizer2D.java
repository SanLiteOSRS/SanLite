...
public class Rasterizer2D extends DualNode {
	...
	@ObfuscatedName("ex")
	protected static void method9393(int[] var0, int var1, int var2, float[] var3) {
	...
	public static void Rasterizer2D_drawRectangle(int var0, int var1, int var2, int var3, int var4) {
		method9408(var0, var1, var2, var4); // L: 388
		method9408(var0, var3 + var1 - 1, var2, var4); // L: 389
		method9410(var0, var1, var3, var4); // L: 390
		method9410(var0 + var2 - 1, var1, var3, var4); // L: 391
	} // L: 392
	...
	@ObfuscatedName("ec")
	public static void method9408(int var0, int var1, int var2, int var3) {
	...
	public static void Rasterizer2D_drawLine(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var3 == 0) { // L: 477
			if (var2 >= 0) { // L: 478
				method9408(var0, var1, var2 + 1, var4);
			} else {
				method9408(var0 + var2, var1, -var2 + 1, var4); // L: 479
			}

		} else if (var2 == 0) { // L: 482
			if (var3 >= 0) { // L: 483
				method9410(var0, var1, var3 + 1, var4);
			} else {
				method9410(var0, var3 + var1, -var3 + 1, var4); // L: 484
			}
	...
	public static void method9415() {
		if (field5132 != null) { // L: 546
			...
			if (Rasterizer2D_xClipStart == 0 && Rasterizer2D_xClipEnd == Rasterizer2D_width && Rasterizer2D_yClipStart == 0 && Rasterizer2D_yClipEnd == Rasterizer2D_height) { // L: 547
				var0 = field5132.length; // L: 548
				var1 = var0 - (var0 & 7); // L: 549

				for (var2 = 0; var2 < var1; field5132[var2++] = 0.0F) { // L: 550 551 559
					field5132[var2++] = 0.0F; // L: 552
					field5132[var2++] = 0.0F; // L: 553
					field5132[var2++] = 0.0F; // L: 554
					field5132[var2++] = 0.0F; // L: 555
					field5132[var2++] = 0.0F; // L: 556
					field5132[var2++] = 0.0F; // L: 557
					field5132[var2++] = 0.0F; // L: 558
				}

				while (var2 < var0) {
					field5132[var2++] = 0.0F; // L: 561
				}
			} else {
				...
				for (int var7 = -var1; var7 < 0; ++var7) { // L: 572
					...
					if (var4 > 0) { // L: 573
						...
						do {
							++var0;
							field5132[var0] = 0.0F; // L: 576
							++var0;
							field5132[var0] = 0.0F; // L: 577
							++var0;
							field5132[var0] = 0.0F; // L: 578
							++var0;
							field5132[var0] = 0.0F; // L: 579
							++var0;
							field5132[var0] = 0.0F; // L: 580
							++var0;
							field5132[var0] = 0.0F; // L: 581
							++var0;
							field5132[var0] = 0.0F; // L: 582
							++var0;
							field5132[var0] = 0.0F; // L: 583
							--var6; // L: 584
						} while(var6 > 0);
					}
	...
	public static void method9412() {
		if (field5132 != null) { // L: 598
			int var0 = field5132.length; // L: 599

			for (int var1 = 0; var1 < var0; ++var1) { // L: 600 601 614
				if (var1 % Rasterizer2D_width < Rasterizer2D_width / 2 && field5132[var1] > 0.0F) { // L: 602
					float var3 = field5132[var1]; // L: 604
