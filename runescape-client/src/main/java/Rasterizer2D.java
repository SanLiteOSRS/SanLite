...
public class Rasterizer2D extends DualNode {
	...
	protected static int Rasterizer2D_yClipEnd;
	@ObfuscatedName("bl")
	...
	public static void Rasterizer2D_drawRectangle(int var0, int var1, int var2, int var3, int var4) {
		method8986(var0, var1, var2, var4); // L: 383
		method8986(var0, var3 + var1 - 1, var2, var4); // L: 384
		method8970(var0, var1, var3, var4); // L: 385
		method8970(var0 + var2 - 1, var1, var3, var4); // L: 386
	} // L: 387
	...
	@ObfuscatedName("ea")
	public static void method8986(int var0, int var1, int var2, int var3) {
	...
	@ObfuscatedName("ej")
	public static void method8970(int var0, int var1, int var2, int var3) {
	...
	public static void Rasterizer2D_drawLine(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var3 == 0) { // L: 472
			if (var2 >= 0) { // L: 473
				method8986(var0, var1, var2 + 1, var4);
			} else {
				method8986(var0 + var2, var1, -var2 + 1, var4); // L: 474
			}

		} else if (var2 == 0) { // L: 477
			if (var3 >= 0) { // L: 478
				method8970(var0, var1, var3 + 1, var4);
			} else {
				method8970(var0, var3 + var1, -var3 + 1, var4); // L: 479
			}
