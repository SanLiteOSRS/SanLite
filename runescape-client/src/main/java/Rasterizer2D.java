...
public class Rasterizer2D extends DualNode {
	...
	public static void Rasterizer2D_drawRectangle(int var0, int var1, int var2, int var3, int var4) {
		method7671(var0, var1, var2, var4);
		method7671(var0, var3 + var1 - 1, var2, var4);
		method7655(var0, var1, var3, var4);
		method7655(var0 + var2 - 1, var1, var3, var4);
	}
	...
	@ObfuscatedName("ep")
	public static void method7671(int var0, int var1, int var2, int var3) {
	...
	@ObfuscatedName("et")
	public static void method7655(int var0, int var1, int var2, int var3) {
	...
	public static void Rasterizer2D_drawLine(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var3 == 0) {
			if (var2 >= 0) {
				method7671(var0, var1, var2 + 1, var4);
			} else {
				method7671(var0 + var2, var1, -var2 + 1, var4);
			}

		} else if (var2 == 0) {
			if (var3 >= 0) {
				method7655(var0, var1, var3 + 1, var4);
			} else {
				method7655(var0, var3 + var1, -var3 + 1, var4);
			}
