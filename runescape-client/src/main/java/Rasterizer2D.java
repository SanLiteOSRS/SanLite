...
public class Rasterizer2D extends DualNode {
	...
	@ObfuscatedName("dr")
	protected static void method9581(int[] var0, int var1, int var2, float[] var3) {
	...
	static void drawCircle(int var0, int var1, int var2, int var3) {
		if (var2 == 0) { // L: 87
			...
			for (var11 -= var9; var6 < var5; var10 += var9++ + var9) { // L: 122 123 136
				...
				for (var15 = var12; var15 <= var13; ++var15) { // L: 133
					Rasterizer2D_pixels[var14++] = var3;
				}
	...
	public static void Rasterizer2D_drawRectangle(int var0, int var1, int var2, int var3, int var4) {
		method9555(var0, var1, var2, var4); // L: 388
		method9555(var0, var3 + var1 - 1, var2, var4); // L: 389
		method9557(var0, var1, var3, var4); // L: 390
		method9557(var0 + var2 - 1, var1, var3, var4); // L: 391
	} // L: 392
	...
	@ObfuscatedName("ek")
	public static void method9555(int var0, int var1, int var2, int var3) {
	...
	@ObfuscatedName("ez")
	public static void method9557(int var0, int var1, int var2, int var3) {
	...
	public static void Rasterizer2D_drawLine(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var3 == 0) { // L: 477
			if (var2 >= 0) { // L: 478
				method9555(var0, var1, var2 + 1, var4);
			} else {
				method9555(var0 + var2, var1, -var2 + 1, var4); // L: 479
			}

		} else if (var2 == 0) { // L: 482
			if (var3 >= 0) { // L: 483
				method9557(var0, var1, var3 + 1, var4);
			} else {
				method9557(var0, var3 + var1, -var3 + 1, var4); // L: 484
			}
	...
	public static void method9547() {
		if (field5209 != null) { // L: 546
			...
			if (Rasterizer2D_xClipStart == 0 && Rasterizer2D_xClipEnd == Rasterizer2D_width && Rasterizer2D_yClipStart == 0 && Rasterizer2D_yClipEnd == Rasterizer2D_height) { // L: 547
				var0 = field5209.length; // L: 548
				var1 = var0 - (var0 & 7); // L: 549

				for (var2 = 0; var2 < var1; field5209[var2++] = 0.0F) { // L: 550 551 559
					field5209[var2++] = 0.0F; // L: 552
					field5209[var2++] = 0.0F; // L: 553
					field5209[var2++] = 0.0F; // L: 554
					field5209[var2++] = 0.0F; // L: 555
					field5209[var2++] = 0.0F; // L: 556
					field5209[var2++] = 0.0F; // L: 557
					field5209[var2++] = 0.0F; // L: 558
				}

				while (var2 < var0) { // L: 561
					field5209[var2++] = 0.0F;
				}
			} else {
				...
				for (int var7 = -var1; var7 < 0; ++var7) { // L: 572
					...
					if (var4 > 0) { // L: 573
						...
						do {
							++var0;
							field5209[var0] = 0.0F; // L: 576
							++var0;
							field5209[var0] = 0.0F; // L: 577
							++var0;
							field5209[var0] = 0.0F; // L: 578
							++var0;
							field5209[var0] = 0.0F; // L: 579
							++var0;
							field5209[var0] = 0.0F; // L: 580
							++var0;
							field5209[var0] = 0.0F; // L: 581
							++var0;
							field5209[var0] = 0.0F; // L: 582
							++var0;
							field5209[var0] = 0.0F; // L: 583
							--var6; // L: 584
						} while(var6 > 0);
					}
	...
	public static void method9539() {
		if (field5209 != null) { // L: 598
			int var0 = field5209.length; // L: 599

			for (int var1 = 0; var1 < var0; ++var1) { // L: 600 601 614
				if (var1 % Rasterizer2D_width < Rasterizer2D_width / 2 && field5209[var1] > 0.0F) { // L: 602
					float var3 = field5209[var1]; // L: 604
					float var4 = 75.0F; // L: 606
					float var5 = 10000.0F; // L: 607
					float var6 = 750000.0F / (10000.0F - var3 * 9925.0F); // L: 608
					float var2 = (var6 - 75.0F) / 9925.0F; // L: 609
					int var7 = (int)(255.0F * var2); // L: 611
					Rasterizer2D_pixels[var1] = var7 << 16 | var7 << 8 | var7; // L: 612
				}
			}
