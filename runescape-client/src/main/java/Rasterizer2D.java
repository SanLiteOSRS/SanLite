...
public class Rasterizer2D extends DualNode {
	...
	public static void Rasterizer2D_drawRectangle(int var0, int var1, int var2, int var3, int var4) {
		method8089(var0, var1, var2, var4);
		method8089(var0, var3 + var1 - 1, var2, var4);
		method8083(var0, var1, var3, var4);
		method8083(var0 + var2 - 1, var1, var3, var4);
	}
	...
	@ObfuscatedName("df")
	public static void method8089(int var0, int var1, int var2, int var3) {
	...
	@ObfuscatedName("dt")
	public static void method8083(int var0, int var1, int var2, int var3) {
	...
	public static void Rasterizer2D_drawLine(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var3 == 0) {
			if (var2 >= 0) {
				method8089(var0, var1, var2 + 1, var4);
			} else {
				method8089(var0 + var2, var1, -var2 + 1, var4);
			}

		} else if (var2 == 0) {
			if (var3 >= 0) {
				method8083(var0, var1, var3 + 1, var4);
			} else {
				method8083(var0, var3 + var1, -var3 + 1, var4);
			}
