...
public class Rasterizer2D extends DualNode {
	...
	public static void Rasterizer2D_drawRectangle(int var0, int var1, int var2, int var3, int var4) {
		method6223(var0, var1, var2, var4);
		method6223(var0, var3 + var1 - 1, var2, var4);
		method6232(var0, var1, var3, var4);
		method6232(var0 + var2 - 1, var1, var3, var4);
	}
	...
	@ObfuscatedName("dg")
	public static void method6223(int var0, int var1, int var2, int var3) {
	...
	@ObfuscatedName("da")
	public static void method6232(int var0, int var1, int var2, int var3) {
	...
	public static void Rasterizer2D_drawLine(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var3 == 0) {
			if (var2 >= 0) {
				method6223(var0, var1, var2 + 1, var4);
			} else {
				method6223(var0 + var2, var1, -var2 + 1, var4);
			}

		} else if (var2 == 0) {
			if (var3 >= 0) {
				method6232(var0, var1, var3 + 1, var4);
			} else {
				method6232(var0, var3 + var1, -var3 + 1, var4);
			}
