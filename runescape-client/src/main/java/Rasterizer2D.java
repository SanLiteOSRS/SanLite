...
public class Rasterizer2D extends DualNode {
	...
	public static void Rasterizer2D_drawRectangle(int var0, int var1, int var2, int var3, int var4) {
		method7967(var0, var1, var2, var4); // L: 383
		method7967(var0, var3 + var1 - 1, var2, var4); // L: 384
		method7975(var0, var1, var3, var4); // L: 385
		method7975(var0 + var2 - 1, var1, var3, var4); // L: 386
	} // L: 387
	...
	public static void Rasterizer2D_drawLine(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var3 == 0) { // L: 472
			if (var2 >= 0) { // L: 473
				...
				method7967(var0 + var2, var1, -var2 + 1, var4); // L: 474
			}
			...
			if (var3 >= 0) { // L: 478
				...
				method7975(var0, var3 + var1, -var3 + 1, var4); // L: 479
			}
