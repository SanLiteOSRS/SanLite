...
public class Rasterizer2D extends DualNode {
	...
	public static void Rasterizer2D_drawRectangle(int var0, int var1, int var2, int var3, int var4) {
		method7838(var0, var1, var2, var4); // L: 383
		method7838(var0, var3 + var1 - 1, var2, var4); // L: 384
		method7840(var0, var1, var3, var4); // L: 385
		method7840(var0 + var2 - 1, var1, var3, var4); // L: 386
	} // L: 387
	...
	@ObfuscatedName("em")
	public static void method7838(int var0, int var1, int var2, int var3) {
	...
	@ObfuscatedName("ej")
	public static void method7840(int var0, int var1, int var2, int var3) {
	...
	public static void Rasterizer2D_drawLine(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var3 == 0) { // L: 472
			if (var2 >= 0) { // L: 473
				method7838(var0, var1, var2 + 1, var4);
			} else {
				method7838(var0 + var2, var1, -var2 + 1, var4); // L: 474
			}

		} else if (var2 == 0) { // L: 477
			if (var3 >= 0) { // L: 478
				method7840(var0, var1, var3 + 1, var4);
			} else {
				method7840(var0, var3 + var1, -var3 + 1, var4); // L: 479
			}
