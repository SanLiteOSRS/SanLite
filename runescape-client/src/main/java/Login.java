...
public class Login {
	...
	static final void method1932(PacketBuffer var0, int var1, Player var2, int var3) {
		...
		if ((var3 & 8192) != 0) {
			var2.field1167 = Client.cycle + var0.method7714();
			var2.field1168 = Client.cycle + var0.method7713();
			var2.field1169 = var0.method7708();
			var2.field1114 = var0.method7708();
			var2.field1171 = var0.method7885();
			var2.field1122 = (byte)var0.method7773();
		}

		if ((var3 & 256) != 0) {
			var4 = var0.method7885();
		}
		...
		if ((var3 & 1) != 0) {
			...
			if (var2.username != null && var2.appearance != null) {
				...
				if (!var10 && Client.field618 == 0 && !var2.isHidden) {
					...
					var0.method7814(Players.field1273.array, 0, var8);
					Players.field1273.offset = 0;
		...
		if ((var3 & 4096) != 0) {
			var2.spotAnimation = var0.method7713();
			var5 = var0.method7705();
		...
		if ((var3 & 128) != 0) {
			var5 = var0.method7742();
			byte[] var17 = new byte[var5];
			Buffer var13 = new Buffer(var17);
			var0.method7814(var17, 0, var5);
			Players.field1276[var1] = var13;
			var2.read(var13);
		}

		if ((var3 & 512) != 0) {
			var2.field1129 = var0.method7707();
			var2.field1160 = var0.readByte();
			var2.field1132 = var0.method7885();
			var2.field1161 = var0.method7708();
			var2.field1143 = var0.method7714() + Client.cycle;
			var2.field1163 = var0.method7715() + Client.cycle;
			var2.field1135 = var0.method7713();
			if (var2.field1070) {
		...
		int var14;
		if ((var3 & 8) != 0) {
			var5 = var0.method7715();
			if (var5 == 65535) {
				var5 = -1;
			}

			var14 = var0.method7742();
		...
		if ((var3 & 16384) != 0) {
			...
			var15[var1] = (class193)MusicPatchPcmStream.findEnumerated(var21, var0.method7708());
		}

		if ((var3 & 32) != 0) {
			var2.targetIndex = var0.method7713();
			...
			if (var14 > 0) {
				for (var19 = 0; var19 < var14; ++var19) {
					...
					if (var9 != 32767) {
						...
						var12 = var9 > 0 ? var0.method7773() : var16;
