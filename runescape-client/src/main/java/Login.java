...
public class Login {
	...
	public static void method1944(AbstractArchive var0, AbstractArchive var1, boolean var2, Font var3) {
		WorldMapID.ItemComposition_archive = var0;
		GameEngine.ItemComposition_modelArchive = var1;
		HealthBar.ItemComposition_inMembersWorld = var2;
		ArchiveLoader.ItemComposition_fileCount = WorldMapID.ItemComposition_archive.getGroupFileCount(10);
		class239.ItemComposition_fontPlain11 = var3;
	}
