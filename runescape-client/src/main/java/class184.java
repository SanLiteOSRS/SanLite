...
public class class184 implements WorldMapSection {
	...
	public int[] getBorderTileLengths(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) {
			...
			int[] var4 = new int[]{this.field2098 * 64 - this.field2092 * 64 + var2 + (this.field2100 * 8 - this.field2096 * 8), var3 + (this.field2095 * 64 - this.field2093 * 64) + (this.field2099 * 8 - this.field2097 * 8)};
			return var4;
		}
	}
	...
	public Coord coord(int var1, int var2) {
		if (!this.containsPosition(var1, var2)) {
			...
			int var4 = this.field2093 * 64 - this.field2095 * 64 + var2 + (this.field2097 * 8 - this.field2099 * 8);
