...
public class class184 implements WorldMapSection {
	...
	public int[] getBorderTileLengths(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) {
			...
			int[] var4 = new int[]{this.field2094 * 64 - this.field2095 * 64 + var2 + (this.field2092 * 8 - this.field2084 * 8), var3 + (this.field2089 * 64 - this.field2087 * 64) + (this.field2088 * 8 - this.field2091 * 8)};
			return var4;
		}
	}
	...
	public Coord coord(int var1, int var2) {
		if (!this.containsPosition(var1, var2)) {
			...
			int var4 = this.field2087 * 64 - this.field2089 * 64 + var2 + (this.field2091 * 8 - this.field2088 * 8);
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						Client.field650 = 3;
						Client.field543 = var2 ? PacketWriter.scriptDotWidget.id : class9.scriptActiveWidget.id;
						return 1;
					} else {
						boolean var11;
