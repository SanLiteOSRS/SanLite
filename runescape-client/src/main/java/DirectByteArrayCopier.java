...
public class DirectByteArrayCopier extends AbstractByteArrayCopier {
	...
	public static SpritePixels[] method5541(AbstractArchive var0, String var1, String var2) {
		...
		return NameableContainer.method6853(var0, var3, var4);
	}
	...
	static final void method5546() {
		...
		if (!var0) {
			...
			for (var1 = 0; var1 < WorldMapSectionType.regionLandArchives.length; ++var1) {
				...
				if (var15 != null) {
					var3 = (class123.regions[var1] >> 8) * 64 - ApproximateRouteStrategy.baseX * 64;
					var4 = (class123.regions[var1] & 255) * 64 - class250.baseY * 64;
			...
			if (!var0) {
				...
				if (!Client.isInInstance) {
					...
					for (var2 = 0; var2 < var1; ++var2) {
						var3 = (class123.regions[var2] >> 8) * 64 - ApproximateRouteStrategy.baseX * 64;
						var4 = (class123.regions[var2] & 255) * 64 - class250.baseY * 64;
					...
					for (var2 = 0; var2 < var1; ++var2) {
						...
						if (var13 != null) {
							var4 = (class123.regions[var2] >> 8) * 64 - ApproximateRouteStrategy.baseX * 64;
							var5 = (class123.regions[var2] & 255) * 64 - class250.baseY * 64;
							MouseHandler.playPcmPlayers();
	...
	static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
			...
			boolean var11 = false;
			if (var1 == 0) {
				var7 = FriendSystem.scene.getWallObjectTag(var0, var2, var3);
			}

			if (var1 == 1) {
				var7 = FriendSystem.scene.getDecorativeObjectTag(var0, var2, var3);
			}
			...
			if (var1 == 3) {
				var7 = FriendSystem.scene.getGroundObjectTag(var0, var2, var3);
			}
			...
			if (var7 != 0L) {
				...
				if (var1 == 0) {
					FriendSystem.scene.removeWallObject(var0, var2, var3);
				...
				if (var1 == 1) {
					FriendSystem.scene.removeDecorativeObject(var0, var2, var3);
				}
				...
				if (var1 == 3) {
					FriendSystem.scene.removeGroundObject(var0, var2, var3);
					var13 = class116.getObjectDefinition(var38);
			...
			if (var4 >= 0) {
				...
				if (var6 == 22) {
					...
					if (var6 >= 12) {
						...
						var41.newWallObject(var0, var2, var3, var23, (Renderable)var36, (Renderable)null, Tiles.field988[var5], 0, var26, var28);
						if (var15.interactType != 0) {
						...
						var41.newWallObject(var0, var2, var3, var23, (Renderable)var36, (Renderable)null, Tiles.field989[var5], 0, var26, var28);
						if (var15.interactType != 0) {
							var14.method3838(var2, var3, var6, var5, var15.boolean1);
						}
					} else {
						...
						if (var6 == 2) {
							...
							var41.newWallObject(var0, var2, var3, var23, (Renderable)var37, (Renderable)var31, Tiles.field988[var5], Tiles.field988[var29], var26, var28);
							if (var15.interactType != 0) {
								var14.method3838(var2, var3, var6, var5, var15.boolean1);
							}
						} else if (var6 == 3) {
							...
							var41.newDecorativeObject(var0, var2, var3, var23, (Renderable)var36, (Renderable)null, Tiles.field988[var5], 0, 0, 0, var26, var28);
						} else {
							long var30;
							Object var32;
							if (var6 == 5) {
								...
								var41.newDecorativeObject(var0, var2, var3, var23, (Renderable)var32, (Renderable)null, Tiles.field988[var5], 0, var29 * Tiles.field990[var5], var29 * Tiles.field991[var5], var26, var28);
							} else if (var6 == 6) {
								var29 = 8;
								var30 = var41.getWallObjectTag(var0, var2, var3);
								if (0L != var30) {
								...
								var41.newDecorativeObject(var0, var2, var3, var23, (Renderable)var32, (Renderable)null, 256, var5, var29 * Tiles.field1000[var5], var29 * Tiles.field993[var5], var26, var28);
							} else if (var6 == 7) {
								int var35 = var5 + 2 & 3;
								if (var15.animationId == -1 && var15.transforms == null) {
								...
								var41.newDecorativeObject(var0, var2, var3, var23, (Renderable)var32, (Renderable)var33, 256, var5, var29 * Tiles.field1000[var5], var29 * Tiles.field993[var5], var26, var28);
							}
						}
					}
				} else {
