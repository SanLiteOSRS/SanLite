...
public final class ItemLayer {
	...
	static int method4039(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.OC_NAME) { // L: 3400
			...
			Interpreter.Interpreter_stringStack[++VarbitComposition.Interpreter_stringStackSize - 1] = UserComparator3.ItemComposition_get(var3).name; // L: 3402
			return 1; // L: 3403
		} else {
			int var4;
			...
			if (var0 == ScriptOpcodes.OC_OP) { // L: 3405
				...
				var5 = UserComparator3.ItemComposition_get(var3); // L: 3409
				...
				var5 = UserComparator3.ItemComposition_get(var3); // L: 3418
				...
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = UserComparator3.ItemComposition_get(var3).price; // L: 3425
				return 1; // L: 3426
				...
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = UserComparator3.ItemComposition_get(var3).isStackable == 1 ? 1 : 0; // L: 3430
				return 1; // L: 3431
			} else {
				...
				if (var0 == ScriptOpcodes.OC_CERT) { // L: 3433
					...
					var7 = UserComparator3.ItemComposition_get(var3); // L: 3435
					...
					var7 = UserComparator3.ItemComposition_get(var3); // L: 3442
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = UserComparator3.ItemComposition_get(var3).isMembersOnly ? 1 : 0; // L: 3449
					return 1; // L: 3450
					...
					var7 = UserComparator3.ItemComposition_get(var3); // L: 3454
					...
					var7 = UserComparator3.ItemComposition_get(var3); // L: 3461
					...
					if (var0 == ScriptOpcodes.OC_FINDRESET) { // L: 3478
						...
						var4 = UserComparator3.ItemComposition_get(var3).getShiftClickIndex(); // L: 3484
						if (var4 == -1) { // L: 3485
