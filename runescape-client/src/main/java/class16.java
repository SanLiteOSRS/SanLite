...
public class class16 implements ThreadFactory {
	@ObfuscatedName("ay")
	final ThreadGroup field69;
	@ObfuscatedName("an")
	final AtomicInteger field67;
	// $FF: synthetic field
	@ObfuscatedSignature(
		descriptor = "Lap;"
	)
	...
	class16(class14 var1) {
		...
		this.field67 = new AtomicInteger(1); // L: 66
		SecurityManager var2 = System.getSecurityManager(); // L: 69
		this.field69 = var2 != null ? var2.getThreadGroup() : Thread.currentThread().getThreadGroup(); // L: 70
	} // L: 71

	public Thread newThread(Runnable var1) {
		Thread var2 = new Thread(this.field69, var1, this.this$0.field59 + "-rest-request-" + this.field67.getAndIncrement(), 0L); // L: 75
