...
public class class27 {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.hintArrowType == 2) { // L: 4903
			ReflectionCheck.worldToScreen((Client.field539 - AbstractArchive.baseX * 64 << 7) + Client.field542 * 4096, Client.field543 * 64 + (Client.field607 - class148.baseY * 64 << 7), Client.field541 * 4); // L: 4904
