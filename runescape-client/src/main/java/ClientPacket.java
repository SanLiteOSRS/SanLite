...
public class ClientPacket implements class304 {
	...
	static final ClientPacket field3158;
	@ObfuscatedName("bm")
	@ObfuscatedSignature(
		descriptor = "Llq;"
	)
	...
	static final ClientPacket field3168;
	@ObfuscatedName("bz")
	@ObfuscatedSignature(
		descriptor = "Llq;"
	)
	...
	static final ClientPacket field3193;
	@ObfuscatedName("ca")
	@ObfuscatedSignature(
		descriptor = "Llq;"
	)
	...
	static final ClientPacket field3211;
	@ObfuscatedName("do")
	@ObfuscatedSignature(
		descriptor = "Llq;"
	)
	...
	static final ClientPacket field3218;
	@ObfuscatedName("dp")
	@ObfuscatedSignature(
		descriptor = "Llq;"
	)
	...
	static {
		field3209 = new ClientPacket(0, 5); // L: 5
		field3126 = new ClientPacket(1, 3); // L: 6
		field3127 = new ClientPacket(2, 3); // L: 7
		field3198 = new ClientPacket(3, 0); // L: 8
		field3129 = new ClientPacket(4, -1); // L: 9
		field3130 = new ClientPacket(5, 8); // L: 10
		field3142 = new ClientPacket(6, 11); // L: 11
		field3132 = new ClientPacket(7, 0); // L: 12
		field3133 = new ClientPacket(8, -1); // L: 13
		field3134 = new ClientPacket(9, 4); // L: 14
		field3135 = new ClientPacket(10, -1); // L: 15
		field3179 = new ClientPacket(11, -1); // L: 16
		field3223 = new ClientPacket(12, 9); // L: 17
		field3161 = new ClientPacket(13, 3); // L: 18
		field3139 = new ClientPacket(14, 16); // L: 19
		field3195 = new ClientPacket(15, 3); // L: 20
		field3141 = new ClientPacket(16, 11); // L: 21
		field3150 = new ClientPacket(17, 8); // L: 22
		field3143 = new ClientPacket(18, 3); // L: 23
		field3156 = new ClientPacket(19, 8); // L: 24
		field3145 = new ClientPacket(20, 8); // L: 25
		field3159 = new ClientPacket(21, 8); // L: 26
		field3147 = new ClientPacket(22, 7); // L: 27
		field3136 = new ClientPacket(23, 3); // L: 28
		field3154 = new ClientPacket(24, -1); // L: 29
		field3213 = new ClientPacket(25, -2); // L: 30
		field3151 = new ClientPacket(26, 1); // L: 31
		field3152 = new ClientPacket(27, 8); // L: 32
		field3153 = new ClientPacket(28, 0); // L: 33
		field3174 = new ClientPacket(29, 3); // L: 34
		field3155 = new ClientPacket(30, 7); // L: 35
		field3207 = new ClientPacket(31, 8); // L: 36
		field3157 = new ClientPacket(32, -2); // L: 37
		field3158 = new ClientPacket(33, 2); // L: 38
		field3224 = new ClientPacket(34, 3); // L: 39
		field3214 = new ClientPacket(35, 0);
		field3146 = new ClientPacket(36, 16); // L: 41
		field3162 = new ClientPacket(37, 7); // L: 42
		field3163 = new ClientPacket(38, 15); // L: 43
		field3164 = new ClientPacket(39, 6); // L: 44
		field3165 = new ClientPacket(40, 7); // L: 45
		field3217 = new ClientPacket(41, 3); // L: 46
		field3221 = new ClientPacket(42, -1); // L: 47
		field3168 = new ClientPacket(43, -1); // L: 48
		field3169 = new ClientPacket(44, -1); // L: 49
		field3170 = new ClientPacket(45, 15); // L: 50
		field3171 = new ClientPacket(46, 2); // L: 51
		field3185 = new ClientPacket(47, 4); // L: 52
		field3173 = new ClientPacket(48, -1); // L: 53
		field3140 = new ClientPacket(49, 8); // L: 54
		field3175 = new ClientPacket(50, 7); // L: 55
		field3149 = new ClientPacket(51, 3); // L: 56
		field3177 = new ClientPacket(52, -1); // L: 57
		field3178 = new ClientPacket(53, 4); // L: 58
		field3160 = new ClientPacket(54, -1); // L: 59
		field3180 = new ClientPacket(55, 2); // L: 60
		field3181 = new ClientPacket(56, 3); // L: 61
		field3182 = new ClientPacket(57, 4); // L: 62
		field3183 = new ClientPacket(58, -1); // L: 63
		field3184 = new ClientPacket(59, 2); // L: 64
		field3166 = new ClientPacket(60, -1); // L: 65
		field3186 = new ClientPacket(61, 15); // L: 66
		field3187 = new ClientPacket(62, 7); // L: 67
		field3138 = new ClientPacket(63, 4); // L: 68
		field3189 = new ClientPacket(64, 3); // L: 69
		field3190 = new ClientPacket(65, 1); // L: 70
		field3199 = new ClientPacket(66, -1); // L: 71
		field3204 = new ClientPacket(67, -1); // L: 72
		field3193 = new ClientPacket(68, 2); // L: 73
		field3194 = new ClientPacket(69, 6); // L: 74
		field3201 = new ClientPacket(70, 8); // L: 75
		field3196 = new ClientPacket(71, 1); // L: 76
		field3197 = new ClientPacket(72, -1); // L: 77
		field3137 = new ClientPacket(73, 11); // L: 78
		field3144 = new ClientPacket(74, 11); // L: 79
		field3200 = new ClientPacket(75, 13); // L: 80
		field3203 = new ClientPacket(76, 6); // L: 81
		field3202 = new ClientPacket(77, -2); // L: 82
		field3192 = new ClientPacket(78, -1); // L: 83
		field3125 = new ClientPacket(79, 8); // L: 84
		field3205 = new ClientPacket(80, 7); // L: 85
		field3206 = new ClientPacket(81, -1); // L: 86
		field3172 = new ClientPacket(82, 15); // L: 87
		field3208 = new ClientPacket(83, 0); // L: 88
		field3191 = new ClientPacket(84, 3); // L: 89
		field3210 = new ClientPacket(85, -1); // L: 90
		field3211 = new ClientPacket(86, -1); // L: 91
		field3212 = new ClientPacket(87, -1); // L: 92
		field3148 = new ClientPacket(88, 7); // L: 93
		field3188 = new ClientPacket(89, -1); // L: 94
		field3215 = new ClientPacket(90, 2); // L: 95
		field3216 = new ClientPacket(91, 4); // L: 96
		field3167 = new ClientPacket(92, 22); // L: 97
		field3218 = new ClientPacket(93, 7); // L: 98
		field3219 = new ClientPacket(94, 7); // L: 99
		field3220 = new ClientPacket(95, 3); // L: 100
		field3128 = new ClientPacket(96, 10); // L: 101
		field3222 = new ClientPacket(97, 7); // L: 102
	}
	...
	public static boolean isNumber(CharSequence var0) {
		return Script.method2228(var0, 10, true); // L: 40
	}
}
