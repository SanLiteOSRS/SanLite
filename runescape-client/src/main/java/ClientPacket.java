	...
	static void method3713() {
		...
		if (Login.Login_username.length() == 0) {
			...
			if (var1 == 0L) {
				...
				byte var3;
				try {
					URL var15 = new URL(WorldMapElement.method4494("services", false) + "m=accountappeal/login.ws");
					...
					var17.write("data2=" + class312.method5953(var14) + "&dest=" + class312.method5953("passwordchoice.ws"));
					var17.flush();
