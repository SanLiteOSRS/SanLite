...
public class ClientPacket implements class190 {
	...
	static final void method3686(Actor var0) {
		...
		if (var0.pathLength == 0) {
			...
			if (var0.sequence != -1 && var0.sequenceDelay == 0) {
				SequenceDefinition var1 = SpotAnimationDefinition.SequenceDefinition_get(var0.sequence);
	...
	static void widgetDefaultMenuAction(int var0, int var1, int var2, int var3, String var4) {
		Widget var5 = GrandExchangeOfferUnitPriceComparator.getWidgetChild(var1, var2);
		if (var5 != null) {
			if (var5.onOp != null) {
			...
			if (var11) {
				int var8 = ScriptEvent.getWidgetClickMask(var5);
				int var9 = var0 - 1;
				boolean var7 = (var8 >> var9 + 1 & 1) != 0;
				if (var7) {
					PacketBufferNode var10;
					if (var0 == 1) {
						var10 = FaceNormal.getPacketBufferNode(field2264, Client.packetWriter.isaacCipher);
					...
					if (var0 == 2) {
						var10 = FaceNormal.getPacketBufferNode(field2280, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 3) {
						var10 = FaceNormal.getPacketBufferNode(field2278, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 4) {
						var10 = FaceNormal.getPacketBufferNode(field2226, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 5) {
						var10 = FaceNormal.getPacketBufferNode(field2269, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 6) {
						var10 = FaceNormal.getPacketBufferNode(field2230, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 7) {
						var10 = FaceNormal.getPacketBufferNode(field2256, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 8) {
						var10 = FaceNormal.getPacketBufferNode(field2262, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 9) {
						var10 = FaceNormal.getPacketBufferNode(field2223, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 10) {
						var10 = FaceNormal.getPacketBufferNode(field2255, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
