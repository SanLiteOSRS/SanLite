...
public class FontName {
	...
	static int method7231(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.CHAT_GETFILTER_PUBLIC) { // L: 3525
			...
			PacketBufferNode var13 = DecorativeObject.getPacketBufferNode(ClientPacket.field3052, Client.packetWriter.isaacCipher); // L: 3536
			...
			if (var0 == ScriptOpcodes.CHAT_SENDABUSEREPORT) { // L: 3543
				...
				var6 = DecorativeObject.getPacketBufferNode(ClientPacket.field3039, Client.packetWriter.isaacCipher); // L: 3549
				...
				if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYTYPEANDLINE) { // L: 3557
					...
					if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYUID) { // L: 3580
						...
						if (var0 == ScriptOpcodes.CHAT_SENDPUBLIC) { // L: 3606
							...
							var12 = DecorativeObject.getPacketBufferNode(ClientPacket.field2953, Client.packetWriter.isaacCipher); // L: 3618
							...
							Nameable.method6525(var12.packetBuffer, var11); // L: 3622
							...
							if (var0 == ScriptOpcodes.CHAT_GETFILTER_TRADE) { // L: 3643
								...
								return 1; // L: 3686
							} else if (var0 == ScriptOpcodes.CHAT_GETHISTORYEX_BYTYPEANDLINE) { // L: 3688
								...
								return 1; // L: 3713
							} else if (var0 == ScriptOpcodes.CHAT_GETHISTORYEX_BYUID) { // L: 3715
