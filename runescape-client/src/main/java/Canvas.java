		...
		if (var0 == ScriptOpcodes.CLIENTCLOCK) {
			...
			if (var0 == ScriptOpcodes.INV_GETOBJ) {
				...
				if (var0 == ScriptOpcodes.COORD) {
					...
					var4 = GrandExchangeOfferNameComparator.baseX * 64 + (MouseHandler.localPlayer.x >> 7);
					var5 = NPC.baseY * 64 + (MouseHandler.localPlayer.y >> 7);
			...
			if (class227.field2676 == var0) {
				...
				if (var17 != null) {
					...
					if (var29 != null) {
						...
						var17.model0 = var29;
						var17.field982 = var13 * 128 + var19 * 64;
						var17.field989 = var14 * 128 + var20 * 64;
