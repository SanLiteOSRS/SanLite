...
public final class Canvas extends java.awt.Canvas {
	...
	static boolean method467(int var0) {
		for (int var1 = 0; var1 < Client.field842; ++var1) {
			if (Client.field844[var1] == var0) {
				return true;
			}
		}
	...
	static String method468(String var0) {
		PlayerType[] var1 = class249.PlayerType_values();

		for (int var2 = 0; var2 < var1.length; ++var2) {
			PlayerType var3 = var1[var2];
			if (var3.modIcon != -1 && var0.startsWith(class169.method3495(var3.modIcon))) {
