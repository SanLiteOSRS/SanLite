...
public class ObjectDefinition extends DualNode {
	...
	public final boolean method4684(int var1) {
		if (this.models != null) {
	...
	public final Entity getEntity(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
		...
		if (this.nonFlatShading) {
			var9 = ((ModelData)var9).method2895();
		}
		...
		if (this.clipType * 65536 >= 0) {
			if (var9 instanceof Model) {
				...
				var9 = ((ModelData)var9).method2896(var3, var4, var5, var6, true, this.clipType * 65536);
			}
		}
	...
	public int getIntParam(int var1, int var2) {
		return FriendsList.method5251(this.params, var1, var2);
	}
