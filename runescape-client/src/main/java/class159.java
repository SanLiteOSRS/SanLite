...
public class class159 extends class135 {
	...
	void vmethod3254(Buffer var1) {
		this.field1756 = var1.readInt(); // L: 310
		this.field1757 = var1.readLong(); // L: 311
	} // L: 312
	...
	void vmethod3248(ClanSettings var1) {
		var1.method3091(this.field1756, this.field1757); // L: 315
	} // L: 316
	...
	static Script getScript(int var0) {
		...
		if (var1 != null) { // L: 27
			...
			byte[] var2 = class188.archive12.takeFile(var0, 0); // L: 28
			if (var2 == null) { // L: 29
				return null; // L: 30
			} else {
				var1 = GameEngine.newScript(var2); // L: 32
