...
public final class class43 {
	...
	static int method877(int var0, Script var1, boolean var2) {
		...
		if (var0 == 6600) {
			...
			UserComparator4.getWorldMap().method6375(var3, var9, var5, true);
			return 1;
		} else {
			WorldMapArea var11;
					...
					if (var0 == ScriptOpcodes.WORLDMAP_GETCONFIGORIGIN) {
						...
						if (var0 == 6618) {
							...
							if (var0 == 6619) {
								...
								Language.method3758(var3, var12, false);
								return 1;
							} else if (var0 == 6620) {
								Interpreter.Interpreter_intStackSize -= 2;
								var3 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
								var12 = new Coord(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
								Language.method3758(var3, var12, true);
								return 1;
								...
								if (var0 == ScriptOpcodes.WORLDMAP_PERPETUALFLASH) {
									...
									if (var0 == ScriptOpcodes.WORLDMAP_DISABLEELEMENT) {
										...
										var3 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
										var12 = new Coord(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
										var7 = UserComparator4.getWorldMap().method6419(var3, var12);
										if (var7 == null) {
											Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = -1;
										} else {
											Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var7.packed();
