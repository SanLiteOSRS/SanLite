...
public class class168 {
	...
	class168(int var1) {
		ItemComposition var2 = FileSystem.ItemComposition_get(var1); // L: 12
	...
	static final void method3251(int var0, int var1, boolean var2) {
		if (Client.currentClanChannels[var0] != null) { // L: 12490
			if (var1 >= 0 && var1 < Client.currentClanChannels[var0].method3005()) { // L: 12491
				...
				PacketBufferNode var4 = DecorativeObject.getPacketBufferNode(ClientPacket.field2993, Client.packetWriter.isaacCipher); // L: 12493
