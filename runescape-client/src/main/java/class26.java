...
public class class26 extends class14 {
	...
	void vmethod339(Buffer var1) {
		if (var1.readUnsignedByte() != 255) {
			--var1.offset;
			this.field218 = var1.readLong();
		}

		this.field217 = var1.readStringCp1252NullTerminatedOrNull();
	...
	void vmethod338(class11 var1) {
		var1.method117(this.field218, this.field217, this.field216);
	}
	...
	static void method334() {
		Login.loginIndex = 24;
		class44.setLoginResponseString("The game servers are currently being updated.", "Please wait a few minutes and try again.", "");
	}
