...
public class class28 {
	...
	public static final SpritePixels getItemSprite(int var0, int var1, int var2, int var3, int var4, boolean var5) {
		...
		ItemComposition var9 = UserComparator3.ItemComposition_get(var0); // L: 373
		if (var1 > 1 && var9.countobj != null) { // L: 374
			...
			if (var10 != -1) { // L: 379
				var9 = UserComparator3.ItemComposition_get(var10);
			}
		}
		...
		if (var19 == null) { // L: 382
			...
			if (var4 == 1 || var4 == 2 && var9.isStackable == 1) { // L: 421
				class296.ItemComposition_fontPlain11.draw(ModeWhere.method6242(var1), 0, 9, 16776960, 1); // L: 422
			}
