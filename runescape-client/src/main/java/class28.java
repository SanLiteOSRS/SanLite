...
public class class28 {
	...
	static void findItemDefinitions(String var0, boolean var1) {
		...
		for (int var4 = 0; var4 < ItemContainer.ItemComposition_fileCount; ++var4) { // L: 12579
			ItemComposition var9 = FileSystem.ItemComposition_get(var4); // L: 12580
		...
		for (int var5 = 0; var5 < UserComparator9.foundItemIdCount; ++var5) { // L: 12600
			var8[var5] = FileSystem.ItemComposition_get(var2[var5]).name;
		}
