		...
		if (var5 != 0L) { // L: 5913
			...
			if (var15.mapSceneId != -1) { // L: 5927
				...
				if (var16 != null) { // L: 5929
					...
					int var18 = (var15.sizeY * 4 - var16.subHeight * 531611920) / 2; // L: 5931
		...
		if (var5 != 0L) { // L: 5997
			...
			if (var19.mapSceneId != -1) { // L: 6003
				...
				if (var26 != null) { // L: 6005
					...
					var14 = (var19.sizeY * 4 - var26.subHeight * 531611920) / 2; // L: 6007
		...
		if (0L != var5) { // L: 6035
			...
			if (var23.mapSceneId != -1) { // L: 6038
				...
				if (var24 != null) { // L: 6040
					...
					int var25 = (var23.sizeY * 4 - var24.subHeight * 531611920) / 2; // L: 6042
