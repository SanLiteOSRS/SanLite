...
public final class Tiles {
   ...
   static int[][][] field483;
   @ObfuscatedName("z")
   static final int[] field479 = new int[]{1, 2, 4, 8};
   @ObfuscatedName("a")
   static final int[] field480 = new int[]{16, 32, 64, 128};
   @ObfuscatedName("w")
   static final int[] field481 = new int[]{1, 0, -1, 0};
   @ObfuscatedName("l")
   static final int[] field482 = new int[]{0, -1, 0, 1};
   @ObfuscatedName("h")
   static final int[] field478 = new int[]{1, -1, -1, 1};
   @ObfuscatedName("v")
   static final int[] field484 = new int[]{-1, -1, 1, 1};
   @ObfuscatedName("m")
   @ObfuscatedGetter(
      intValue = 1482528019
   )
   static int field477 = (int)(Math.random() * 17.0D) - 8;
   @ObfuscatedName("o")
   @ObfuscatedGetter(
      intValue = 1522928569
   )
   static int field486 = (int)(Math.random() * 33.0D) - 16;
   ...
   static int method1060(int var0, int var1) {
      ...
      if (var2 == null) {
         ...
         if (var2.texture >= 0) {
            ...
            var8 = WorldMapIcon_0.method204(var2.hue, var2.saturation, var2.lightness);
            var6 = 96;
            if (var8 == -2) {
               var5 = 12345678;
            } else if (var8 == -1) {
   ...
   public static void method1090(AbstractArchive var0) {
   ...
   static final void method1074() {
      PacketBufferNode var0 = MenuAction.method1994(ClientPacket.field2263, Client.packetWriter.isaacCipher);
   ...
   static void method1088(byte[] var0, int var1) {
      if (Client.field863 == null) {
         Client.field863 = new byte[24];
      }

      class300.method5630(var0, var1, Client.field863, 0, 24);
   }
}
