	...
	static final void drawInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		for (int var9 = 0; var9 < var0.length; ++var9) {
			...
			if (var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.clickedWidget)) {
				...
				if (!var10.isIf3 || !Renderable.isComponentHidden(var10)) {
					...
					if (!var10.isIf3 || var15 < var17 && var16 < var18) {
						if (var10.contentType != 0) {
							if (var10.contentType == 1336) {
								if (Client.displayFps) {
									var13 += 15;
									MusicPatchNode2.fontPlain12.drawRightAligned("Fps:" + GameEngine.fps, var12 + var10.width, var13, 16776960, -1);
									var13 += 15;
						...
						if (var10.type == 0) {
							if (!var10.isIf3 && Renderable.isComponentHidden(var10) && var10 != WorldMapSection1.mousedOverWidgetIf1) {
								continue;
							}
									...
									if (var10.type == 4) {
										...
										if (var39 == null) {
											...
											if (var10.isIf3 && var10.itemId != -1) {
												ItemComposition var47 = KitDefinition.ItemDefinition_get(var10.itemId);
												var44 = var47.name;
												if (var44 == null) {
													var44 = "null";
												}
