			...
			if (var0 == ScriptOpcodes.APPEND) {
				...
				if (var0 == ScriptOpcodes.FROMDATE) {
					...
					if (var0 == ScriptOpcodes.TOSTRING) {
						...
						Interpreter.Interpreter_stringStackSize -= 2;
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = ServerPacket.method3810(Nameable.compareStrings(Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize], Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize + 1], NPCComposition.clientLanguage));
						return 1;
					} else {
						int var5;
						byte[] var13;
