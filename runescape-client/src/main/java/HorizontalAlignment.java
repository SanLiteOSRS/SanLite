			...
			if (Client.titleLoadingStage == 45) {
				...
				if (Client.titleLoadingStage == 50) {
					...
					if (!FloorOverlayDefinition.archive2.isFullyLoaded()) {
						...
						WallObject.Widget_modelsArchive = var10;
						...
						FontName.Ignored_cached = new class426(Login.field917, 47, FriendSystem.clientLanguage, FloorOverlayDefinition.archive2);
					...
					if (Message.mapSceneSprites == null) {
						Message.mapSceneSprites = DecorativeObject.method4516(WorldMapData_1.archive8, PendingSpawn.spriteIds.mapScenes, 0);
					} else {
						++var23;
					}

					if (Bounds.headIconPkSprites == null) {
						Bounds.headIconPkSprites = NameableContainer.method6853(WorldMapData_1.archive8, PendingSpawn.spriteIds.headIconsPk, 0);
					} else {
						++var23;
					}

					if (DynamicObject.headIconPrayerSprites == null) {
						DynamicObject.headIconPrayerSprites = NameableContainer.method6853(WorldMapData_1.archive8, PendingSpawn.spriteIds.field4318, 0);
					} else {
						++var23;
					}

					if (VarpDefinition.headIconHintSprites == null) {
						VarpDefinition.headIconHintSprites = NameableContainer.method6853(WorldMapData_1.archive8, PendingSpawn.spriteIds.field4319, 0);
					} else {
						++var23;
					}

					if (class17.mapMarkerSprites == null) {
						class17.mapMarkerSprites = NameableContainer.method6853(WorldMapData_1.archive8, PendingSpawn.spriteIds.field4320, 0);
					} else {
						++var23;
					}

					if (Client.crossSprites == null) {
						Client.crossSprites = NameableContainer.method6853(WorldMapData_1.archive8, PendingSpawn.spriteIds.field4321, 0);
					} else {
						++var23;
					}

					if (class142.mapDotSprites == null) {
						class142.mapDotSprites = NameableContainer.method6853(WorldMapData_1.archive8, PendingSpawn.spriteIds.field4317, 0);
					} else {
						++var23;
					}

					if (class268.scrollBarSprites == null) {
						class268.scrollBarSprites = DecorativeObject.method4516(WorldMapData_1.archive8, PendingSpawn.spriteIds.field4314, 0);
					} else {
						++var23;
					}

					if (UserComparator8.modIconSprites == null) {
						UserComparator8.modIconSprites = DecorativeObject.method4516(WorldMapData_1.archive8, PendingSpawn.spriteIds.field4324, 0);
					} else {
						++var23;
					}
					...
					if (!class132.archive9.isFullyLoaded()) {
						...
						Rasterizer3D.method3998(class33.textureProvider);
						Rasterizer3D.method3999(Interpreter.clientPreferences.method2266());
