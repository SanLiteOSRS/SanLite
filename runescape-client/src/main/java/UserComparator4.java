...
public class UserComparator4 implements Comparator {
	...
	@ObfuscatedName("fv")
	@ObfuscatedSignature(
		signature = "(Lil;Ljava/lang/String;B)V",
		garbageValue = "0"
	)
	...
	static final void method3465(class194 var0) {
		...
		if (class194.field2342 == var0) {
			...
			if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104) {
				var10 = var7 + 1;
				if (PlayerComposition.localPlayer.pathX[0] >= var4 - var10 && PlayerComposition.localPlayer.pathX[0] <= var10 + var4 && PlayerComposition.localPlayer.pathY[0] >= var5 - var10 && PlayerComposition.localPlayer.pathY[0] <= var5 + var10 && Timer.clientPreferences.areaSoundEffectsVolume != 0 && var8 > 0 && Client.soundEffectCount < 50) {
		...
		if (class194.field2349 == var0) {
			...
			if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
				var3 = var3 * 128 + 64;
				var4 = var4 * 128 + 64;
				GraphicsObject var42 = new GraphicsObject(var5, GameObject.Client_plane, var3, var4, SecureRandomFuture.getTileHeight(var3, var4, GameObject.Client_plane) - var7, var6, Client.cycle);
			...
			if (class194.field2346 == var0) {
				...
				if (var9 >= 0 && var10 >= 0 && var9 < 104 && var10 < 104 && var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104 && var41 != 65535) {
					...
					var3 = var3 * 128 + 64;
					var4 = var4 * 128 + 64;
					Projectile var15 = new Projectile(var41, GameObject.Client_plane, var9, var10, SecureRandomFuture.getTileHeight(var9, var10, GameObject.Client_plane) - var2, var6 + Client.cycle, var11 + Client.cycle, var13, var5, var7, var14);
					var15.setDestination(var3, var4, SecureRandomFuture.getTileHeight(var3, var4, GameObject.Client_plane) - var14, var6 + Client.cycle);
				...
				if (class194.field2345 == var0) {
					...
					if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104) {
						...
						Client.groundItems[GameObject.Client_plane][var4][var5].addFirst(var32);
					...
					if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104) {
						NodeDeque var31 = Client.groundItems[GameObject.Client_plane][var4][var5];
						if (var31 != null) {
					...
					if (var8 >= 0 && var9 >= 0 && var8 < 103 && var9 < 103) {
						if (var5 == 0) {
							BoundaryObject var35 = ArchiveLoader.scene.method3197(GameObject.Client_plane, var8, var9);
							if (var35 != null) {
								var11 = Occluder.Entity_unpackID(var35.tag);
								if (var3 == 2) {
									var35.entity1 = new DynamicObject(var11, 2, var4 + 4, GameObject.Client_plane, var8, var9, var6, false, var35.entity1);
									var35.entity2 = new DynamicObject(var11, 2, var4 + 1 & 3, GameObject.Client_plane, var8, var9, var6, false, var35.entity2);
								} else {
									var35.entity1 = new DynamicObject(var11, var3, var4, GameObject.Client_plane, var8, var9, var6, false, var35.entity1);
								}
							}
						}

						if (var5 == 1) {
							WallDecoration var43 = ArchiveLoader.scene.method3234(GameObject.Client_plane, var8, var9);
							if (var43 != null) {
								var11 = Occluder.Entity_unpackID(var43.tag);
								if (var3 != 4 && var3 != 5) {
									if (var3 == 6) {
										var43.entity1 = new DynamicObject(var11, 4, var4 + 4, GameObject.Client_plane, var8, var9, var6, false, var43.entity1);
									} else if (var3 == 7) {
										var43.entity1 = new DynamicObject(var11, 4, (var4 + 2 & 3) + 4, GameObject.Client_plane, var8, var9, var6, false, var43.entity1);
									} else if (var3 == 8) {
										var43.entity1 = new DynamicObject(var11, 4, var4 + 4, GameObject.Client_plane, var8, var9, var6, false, var43.entity1);
										var43.entity2 = new DynamicObject(var11, 4, (var4 + 2 & 3) + 4, GameObject.Client_plane, var8, var9, var6, false, var43.entity2);
									}
								} else {
									var43.entity1 = new DynamicObject(var11, 4, var4, GameObject.Client_plane, var8, var9, var6, false, var43.entity1);
								}
							}
						}

						if (var5 == 2) {
							GameObject var44 = ArchiveLoader.scene.method3183(GameObject.Client_plane, var8, var9);
							if (var3 == 11) {
								var3 = 10;
							}

							if (var44 != null) {
								var44.entity = new DynamicObject(Occluder.Entity_unpackID(var44.tag), var3, var4, GameObject.Client_plane, var8, var9, var6, false, var44.entity);
							}
						}

						if (var5 == 3) {
							FloorDecoration var45 = ArchiveLoader.scene.getFloorDecoration(GameObject.Client_plane, var8, var9);
							if (var45 != null) {
								var45.entity = new DynamicObject(Occluder.Entity_unpackID(var45.tag), 22, var4, GameObject.Client_plane, var8, var9, var6, false, var45.entity);
							}
						}
					}
					...
					if (class194.field2344 == var0) {
						...
						int var36 = var1.readUnsignedShort();
						...
						if (var17 != null) {
							ObjectComposition var18 = WorldMapDecoration.getObjectDefinition(var14);
							int var19;
							int var20;
							if (var5 != 1 && var5 != 3) {
								var19 = var18.sizeX;
							...
							if (var29 != null) {
								ArchiveLoader.updatePendingSpawn(GameObject.Client_plane, var10, var11, var6, -1, 0, 0, var36 + 1, var8 + 1);
								var17.animationCycleStart = var36 + Client.cycle;
