...
public class class287 {
	...
	static final void method5475(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7, int var8) {
		...
		if (var2 == 19) { // L: 8884
			...
			var14.packetBuffer.method8657(GameEngine.baseX * 64 + var0); // L: 8895
		...
		if (var2 == 7) { // L: 8907
			...
			if (var15 != null) { // L: 8909
				...
				var10.packetBuffer.method8657(class124.field1479); // L: 8918
		...
		if (var2 == 4) { // L: 8959
			...
			var14.packetBuffer.method8657(var3); // L: 8970
			var14.packetBuffer.writeIntME(Client.field712.method4074(82) ? 1 : 0); // L: 8971
		...
		if (var2 == 25) { // L: 8986
			...
			if (var2 == 13) { // L: 9015
				...
				if (var15 != null) { // L: 9017
					...
					var10.packetBuffer.writeIntME(Client.field712.method4074(82) ? 1 : 0); // L: 9027
			...
			if (var2 == 21) { // L: 9031
				...
				var14.packetBuffer.method8657(var3); // L: 9041
			...
			if (var2 == 22) { // L: 9062
				...
				var14.packetBuffer.method8657(GameEngine.baseX * 64 + var0); // L: 9073
			...
			if (var2 == 17) { // L: 9077
				...
				var14.packetBuffer.method8657(GameEngine.baseX * 64 + var0); // L: 9085
				var14.packetBuffer.writeInt(class18.selectedSpellWidget); // L: 9086
				var14.packetBuffer.method8657(Client.selectedSpellChildIndex); // L: 9087
				var14.packetBuffer.method8657(Client.selectedSpellItemId); // L: 9088
				var14.packetBuffer.method8659(var3); // L: 9089
				var14.packetBuffer.writeShort(class178.baseY * 64 + var1); // L: 9090
				var14.packetBuffer.writeIntME(Client.field712.method4074(82) ? 1 : 0); // L: 9091
			...
			if (var2 == 10) { // L: 9159
				...
				if (var15 != null) { // L: 9161
					...
					var10.packetBuffer.writeIntME(Client.field712.method4074(82) ? 1 : 0); // L: 9170
					var10.packetBuffer.method8657(var3); // L: 9171
			...
			if (var2 == 5) { // L: 9197
				...
				var14.packetBuffer.method8657(GameEngine.baseX * 64 + var0); // L: 9208
				var14.packetBuffer.writeIntME(Client.field712.method4074(82) ? 1 : 0); // L: 9209
			...
			if (var2 == 44) { // L: 9228
				...
				if (var9 != null) { // L: 9230
					...
					var10.packetBuffer.writeIntME(Client.field712.method4074(82) ? 1 : 0); // L: 9240
			...
			if (var2 == 8) { // L: 9261
				...
				if (var15 != null) { // L: 9263
					...
					var10.packetBuffer.method8657(Client.selectedSpellChildIndex); // L: 9271
					var10.packetBuffer.method8658(var3); // L: 9272
					var10.packetBuffer.writeShort(Client.selectedSpellItemId); // L: 9273
					var10.packetBuffer.writeIntME(Client.field712.method4074(82) ? 1 : 0); // L: 9274
			...
			if (var2 == 16) { // L: 9324
				...
				var14.packetBuffer.method8657(GameEngine.baseX * 64 + var0); // L: 9335
				...
				var14.packetBuffer.method8657(var3); // L: 9339
			...
			if (var2 == 1002) { // L: 9342
				...
				var14.packetBuffer.method8657(var3); // L: 9349
			...
			if (var2 == 15) { // L: 9352
				...
				if (var9 != null) { // L: 9354
					...
					var10.packetBuffer.writeIntME(Client.field712.method4074(82) ? 1 : 0); // L: 9362
					var10.packetBuffer.method8659(Client.selectedSpellChildIndex); // L: 9363
					var10.packetBuffer.method8657(Client.selectedSpellItemId); // L: 9364
			...
			if (var2 == 1004) { // L: 9402
				...
				var14.packetBuffer.method8657(GameEngine.baseX * 64 + var0); // L: 9411
			...
			if (var2 == 1) { // L: 9414
				...
				var14.packetBuffer.writeIntME(Client.field712.method4074(82) ? 1 : 0); // L: 9424
			...
			if (var2 == 3) { // L: 9432
				...
				var14.packetBuffer.method8657(class178.baseY * 64 + var1); // L: 9444
			...
			if (var2 == 14) { // L: 9491
				...
				if (var9 != null) { // L: 9493
					...
					var10.packetBuffer.writeIntME(Client.field712.method4074(82) ? 1 : 0); // L: 9502
					var10.packetBuffer.method8658(class31.field164); // L: 9503
					var10.packetBuffer.method8719(Interpreter.field844); // L: 9504
					var10.packetBuffer.method8657(class124.field1479); // L: 9505
