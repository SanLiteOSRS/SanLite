...
public class UserComparator7 extends AbstractUserComparator {
	...
	static Script newScript(byte[] var0) {
		...
		if (var6 > 0) {
			...
			for (var7 = 0; var7 < var6; ++var7) {
				...
				IterableNodeHashTable var9 = new IterableNodeHashTable(var8 > 0 ? class297.method5378(var8) : 1);
	...
	static int method3513(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.GETWINDOWMODE) {
			Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class39.getWindowedMode();
			return 1;
		} else {
			int var3;
			if (var0 == ScriptOpcodes.SETWINDOWMODE) {
				...
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = Tile.clientPreferences.windowMode;
				return 1;
				...
				var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
				if (var3 == 1 || var3 == 2) {
					Tile.clientPreferences.windowMode = var3;
