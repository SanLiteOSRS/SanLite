		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState != 5) {
				if (-1L == Login.field922) {
					Login.field922 = DirectByteArrayCopier.method5318() + 1000L;
				}

				long var23 = DirectByteArrayCopier.method5318();
				boolean var44;
	...
	static final void method2463(class255 var0) {
		...
		if (class255.field2946 == var0) {
			...
			if (var4 >= 0 && var5 >= 0 && var4 < 103 && var5 < 103) {
				if (var9 == 0) {
					WallObject var36 = Decimator.scene.method4002(SoundSystem.Client_plane, var4, var5);
					if (var36 != null) {
				...
				if (var9 == 1) {
					DecorativeObject var42 = Decimator.scene.method3919(SoundSystem.Client_plane, var4, var5);
					if (var42 != null) {
				...
				if (var9 == 3) {
					GroundObject var44 = Decimator.scene.getGroundObject(SoundSystem.Client_plane, var4, var5);
					if (var44 != null) {
			...
			var5 = var1.method7414();
			var6 = var1.method7408();
			...
			if (class255.field2947 == var0) {
				var2 = var1.method7414();
				var3 = var1.method7400();
				var4 = var1.method7562();
				var5 = var1.readUnsignedShort();
				var6 = var1.method7398();
				var7 = (var6 >> 4 & 7) + class33.field243;
				var8 = (var6 & 7) + Canvas.field157;
				var9 = var1.method7398();
				var10 = var9 >> 2;
				var11 = var9 & 3;
				var12 = Client.field565[var10];
				byte var13 = var1.method7400();
				byte var14 = var1.method7400();
				...
				if (var17 != null) {
					...
					if (var29 != null) {
						...
						var17.model0 = var29;
						var17.field1075 = var7 * 128 + var19 * 64;
						var17.field1077 = var8 * 128 + var20 * 64;
			...
			if (class255.field2941 == var0) {
				...
				var38 = var1.method7408();
				var4 = var1.method7467();
				...
				var2 = var1.readUnsignedShort();
				var38 = var1.method7398();
				var4 = var38 >> 2;
				var5 = var38 & 3;
				var6 = Client.field565[var4];
				var7 = var1.method7398();
				...
				var2 = var1.method7467();
				var38 = (var2 >> 4 & 7) + class33.field243;
				var4 = (var2 & 7) + Canvas.field157;
				var5 = var1.method7467();
				var6 = var1.method7414();
				var7 = var1.method7562();
				if (var38 >= 0 && var4 >= 0 && var38 < 104 && var4 < 104) {
					var38 = var38 * 128 + 64;
					var4 = var4 * 128 + 64;
				...
				if (class255.field2950 == var0) {
					...
					var38 = var2 >> 4 & 15;
					var4 = var2 & 7;
					var5 = var1.method7408();
					var6 = var1.method7467();
					var7 = var1.method7467();
					var8 = (var7 >> 4 & 7) + class33.field243;
					var9 = (var7 & 7) + Canvas.field157;
					if (var8 >= 0 && var9 >= 0 && var8 < 104 && var9 < 104) {
						var10 = var38 + 1;
				...
				if (class255.field2944 == var0) {
					var2 = var1.method7398();
					var38 = (var2 >> 4 & 7) + class33.field243;
					var4 = (var2 & 7) + Canvas.field157;
					var5 = var1.method7399();
					var6 = var5 >> 2;
					var7 = var5 & 3;
					...
					if (class255.field2948 == var0) {
						byte var37 = var1.method7365();
						var3 = var1.method7365();
						var4 = var1.method7562();
						var5 = var1.method7409();
						var6 = var1.method7562();
						var7 = var1.method7399() * 4;
						var8 = var1.method7467();
						var9 = var1.method7562();
						var10 = var1.method7467() * 4;
						var11 = var1.method7399();
						var12 = (var11 >> 4 & 7) + class33.field243;
						int var39 = (var11 & 7) + Canvas.field157;
						int var40 = var1.method7399();
						var2 = var37 + var12;
						var38 = var3 + var39;
					...
					var2 = var1.method7562();
					var38 = var1.method7467();
					var4 = (var38 >> 4 & 7) + class33.field243;
					var5 = (var38 & 7) + Canvas.field157;
