...
public class class42 implements WorldMapSection {
   ...
   public static File method731(String var0) {
      if (!class169.field2034) {
         throw new RuntimeException("");
      } else {
         File var1 = (File)class169.field2035.get(var0);
         if (var1 != null) {
            return var1;
         } else {
            File var2 = new File(class169.field2033, var0);
            ...
            try {
               ...
               if (!var4.exists()) {
                  ...
                  var3.seek(0L);
                  var3.close();
                  class169.field2035.put(var0, var2);
                  return var2;
               }
