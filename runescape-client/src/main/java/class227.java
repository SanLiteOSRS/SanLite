...
public final class class227 {
   ...
   static Message method4039(int var0) {
   ...
   static final void method4040(String var0) {
      if (!var0.equals("")) {
         PacketBufferNode var1 = MenuAction.method1994(ClientPacket.field2263, Client.packetWriter.isaacCipher);
