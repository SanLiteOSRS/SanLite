...
public abstract class class227 extends Rasterizer2D {
	...
	class227(class243 var1) {
		this.field2528 = false; // L: 8
		this.field2527 = false; // L: 9
		this.field2533 = Rasterizer3D.Rasterizer3D_colorPalette; // L: 18
		this.field2534 = var1; // L: 19
	} // L: 20

	@ObfuscatedName("at")
	void method4470(int[] var1, int var2, int var3, float[] var4) {
		Rasterizer2D.method9246(var1, var2, var3, var4); // L: 23
	} // L: 24
	...
	void method4494(int var1, int var2, int var3, int var4, int var5, int var6, float var7, float var8, float var9, int var10, int var11, int var12, byte var13, byte var14, byte var15, byte var16) {
		var10 = method4471(var10, var13, var14, var15, var16); // L: 51
		var11 = method4471(var11, var13, var14, var15, var16); // L: 52
		var12 = method4471(var12, var13, var14, var15, var16); // L: 53
		this.vmethod4984(var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12); // L: 54
	} // L: 55
	...
	void method4472(int var1, int var2, int var3, int var4, int var5, int var6, float var7, float var8, float var9, int var10, byte var11, byte var12, byte var13, byte var14) {
		int var15 = method4471(var10, var11, var12, var13, var14); // L: 58
		var10 = this.field2533[var15]; // L: 59
		this.vmethod4976(var1, var2, var3, var4, var5, var6, var7, var8, var9, var10); // L: 60
	} // L: 61
