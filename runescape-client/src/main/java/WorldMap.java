...
public class WorldMap {
   ...
   int field3995 = 0;
   @ObfuscatedName("bo")
   final int[] field3963 = new int[]{1008, 1009, 1010, 1011, 1012};
   @ObfuscatedName("bn")
   List field3980;
   @ObfuscatedName("bp")
   @Export("iconIterator")
   ...
   public void method6185(int var1, int var2, boolean var3, boolean var4) {
      long var5 = SequenceDefinition.currentTimeMs();
      ...
      if (this.currentMapArea != null) {
         ...
         if (this.mouseCoord != null && var3) {
            ...
            if (var8 && KeyHandler.KeyHandler_pressedKeys[82] && KeyHandler.KeyHandler_pressedKeys[81]) {
               ...
               if (var9) {
                  PacketBufferNode var12 = MenuAction.method1994(ClientPacket.field2230, Client.packetWriter.isaacCipher);
                  var12.packetBuffer.writeIntME(this.mouseCoord.packed());
                  Client.packetWriter.method2177(var12);
                  this.field3986 = 0L;
               }
            }
         }
   ...
   final void setWorldMapPosition(int var1, int var2, boolean var3) {
      ...
      SequenceDefinition.currentTimeMs();
      if (var3) {
         this.method6330();
      }
   ...
   public void draw(int var1, int var2, int var3, int var4, int var5) {
      ...
      if (var7 < 100) {
         ...
         if (!this.elementsDisabled) {
            ...
            this.worldMapManager.method612(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2, var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1, var2 + var4, this.field3993, this.flashingElements, this.flashCycle, this.cyclesPerFlash, var10);
         }
   ...
   public void method6223(int var1) {
      if (var1 >= 1) {
   ...
   public void flashCategory(int var1) {
      ...
      for(int var2 = 0; var2 < WorldMapElement.WorldMapElement_count; ++var2) {
         if (WorldMapData_0.getWorldMapElement(var2) != null && WorldMapData_0.getWorldMapElement(var2).category == var1) {
            this.flashingElements.add(WorldMapData_0.getWorldMapElement(var2).objectId);
         }
      }
   ...
   public void setCategoryDisabled(int var1, boolean var2) {
      ...
      for(int var3 = 0; var3 < WorldMapElement.WorldMapElement_count; ++var3) {
         if (WorldMapData_0.getWorldMapElement(var3) != null && WorldMapData_0.getWorldMapElement(var3).category == var1) {
            int var4 = WorldMapData_0.getWorldMapElement(var3).objectId;
            if (!var2) {
   ...
   public void method6236(int var1, int var2, int var3, int var4, int var5, int var6) {
      if (this.cacheLoader.getIsLoaded()) {
         ...
         if (!var9.isEmpty()) {
            ...
            do {
               ...
               WorldMapElement var12 = WorldMapData_0.getWorldMapElement(var11.getElement());
               var13 = false;

               for(int var14 = this.field3963.length - 1; var14 >= 0; --var14) {
                  if (var12.strings[var14] != null) {
                     WorldMapData_0.insertMenuItemNoShift(var12.strings[var14], var12.string1, this.field3963[var14], var11.getElement(), var11.coord1.packed(), var11.coord2.packed());
                     var13 = true;
                  }
               }
            } while(!var13);
