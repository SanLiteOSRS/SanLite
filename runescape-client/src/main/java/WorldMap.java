...
public class WorldMap {
	...
	public void init(AbstractArchive var1, AbstractArchive var2, AbstractArchive var3, Font var4, HashMap var5, IndexedSprite[] var6) {
		...
		int var7 = this.WorldMap_archive.getGroupId(WorldMapCacheName.field3049.name); // L: 116
	...
	public void onCycle(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
		if (this.cacheLoader.isLoaded()) { // L: 140
			...
			if (var3) { // L: 145
				...
				List var10 = this.worldMapManager.method5319(this.centerTileX - var8 / 2 - 1, this.centerTileY - var9 / 2 - 1, var8 / 2 + this.centerTileX + 1, var9 / 2 + this.centerTileY + 1, var4, var5, var6, var7, var1, var2); // L: 150
				...
				ScriptEvent var14;
				WorldMapEvent var15;
				for (var12 = var10.iterator(); var12.hasNext(); Clock.runScriptEvent(var14)) { // L: 152 165
					...
					if (this.field4880.contains(var13)) { // L: 159
				...
				var12 = this.field4880.iterator(); // L: 168
				...
				while (var12.hasNext()) {
					...
					if (!var11.contains(var13)) { // L: 171
						...
						Clock.runScriptEvent(var14); // L: 176
					}
				}

				this.field4880 = var11; // L: 180
			}
		}
	} // L: 141 146 181
	...
	public void method8389(int var1, int var2, boolean var3, boolean var4) {
		long var5;
		label40: {
			var5 = WallObject.method5027(); // L: 184
			this.method8434(var1, var2, var4, var5); // L: 185
			if (!this.hasTarget() && (var4 || var3)) { // L: 187
				boolean var7 = Client.clickedWidget != null; // L: 190
				if (!var7) { // L: 192
					if (var4) { // L: 193
						this.field4871 = var1; // L: 194
						this.field4866 = var2; // L: 195
						this.field4837 = this.centerTileX; // L: 196
						this.field4864 = this.centerTileY; // L: 197
					}

					if (this.field4837 != -1) { // L: 199
						int var8 = var1 - this.field4871; // L: 200
						int var9 = var2 - this.field4866; // L: 201
						this.setWorldMapPosition(this.field4837 - (int)((float)var8 / this.zoomTarget), (int)((float)var9 / this.zoomTarget) + this.field4864, false); // L: 202
					}
					break label40;
				}
			}

			this.method8394(); // L: 207
		}

		if (var4) { // L: 209
			this.field4867 = var5; // L: 210
			this.field4868 = var1; // L: 211
			this.field4869 = var2; // L: 212
		}
	...
	void method8434(int var1, int var2, boolean var3, long var4) {
		if (this.currentMapArea != null) { // L: 217
			...
			if (this.mouseCoord != null && var3) { // L: 221
				class211 var8 = class350.method6624(); // L: 222
				int var10;
				int var11;
				if (RouteStrategy.method4214() && var8.method4134(82) && var8.method4134(81)) { // L: 223
					int var14 = this.mouseCoord.x; // L: 224
					var10 = this.mouseCoord.y; // L: 225
					var11 = this.mouseCoord.plane; // L: 226
					PacketBufferNode var12 = ObjectComposition.getPacketBufferNode(ClientPacket.field3182, Client.packetWriter.isaacCipher); // L: 229
					var12.packetBuffer.method9000(var10); // L: 230
					var12.packetBuffer.writeByte(var11); // L: 231
					var12.packetBuffer.method8949(var14); // L: 232
					var12.packetBuffer.method8961(0); // L: 233
					Client.packetWriter.addNode(var12); // L: 234
				} else {
					boolean var9 = true; // L: 238
					if (this.field4870) { // L: 239
						var10 = var1 - this.field4868; // L: 240
						var11 = var2 - this.field4869; // L: 241
						if (var4 - this.field4867 > 500L || var10 < -25 || var10 > 25 || var11 < -25 || var11 > 25) { // L: 242
							var9 = false; // L: 243
						}
					}

					if (var9) { // L: 246
						PacketBufferNode var13 = ObjectComposition.getPacketBufferNode(ClientPacket.field3106, Client.packetWriter.isaacCipher); // L: 247
						var13.packetBuffer.method8919(this.mouseCoord.packed()); // L: 248
						Client.packetWriter.addNode(var13); // L: 249
						this.field4867 = 0L; // L: 250
					}
				}
			}
		} else {
	...
	@Export("smoothZoom")
	void smoothZoom() {
		if (class30.field152 != null) { // L: 259
	...
	void scrollToTarget() {
		if (this.hasTarget()) { // L: 272
			...
			if (this.centerTileX == this.worldMapTargetX && this.centerTileY == this.worldMapTargetY) { // L: 284
	...
	final void setWorldMapPosition(int var1, int var2, boolean var3) {
		...
		WallObject.method5027(); // L: 293
		if (var3) {
			this.method8394(); // L: 294
		}
	...
	final void method8394() {
		this.field4866 = -1; // L: 298
		this.field4871 = -1; // L: 299
		this.field4864 = -1; // L: 300
		this.field4837 = -1; // L: 301
	} // L: 302
	...
	public void method8401(int var1, int var2, int var3, boolean var4) {
		...
		if (var5 != this.field4844 || var4) { // L: 329
			this.field4844 = var5; // L: 330
	...
	public void draw(int var1, int var2, int var3, int var4, int var5) {
		...
		if (var7 < 100) { // L: 410
			...
			if (!this.elementsDisabled) { // L: 433
				...
				if (var5 - this.field4876 > 100) { // L: 435
					this.field4876 = var5; // L: 436
					var10 = true; // L: 437
				}

				this.worldMapManager.drawElements(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2, var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1, var2 + var4, this.field4874, this.flashingElements, this.flashCycle, this.cyclesPerFlash, var10); // L: 439
			}

			this.method8406(var1, var2, var3, var4, var8, var9); // L: 441
			if (RouteStrategy.method4214() && this.showCoord && this.mouseCoord != null) { // L: 442
	...
	void method8406(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (class30.field152 != null) { // L: 461
			...
			if (this.method8500(var8, var9, var13, var14, var3, var4)) { // L: 472
				...
				class30.field152.method6878(this.minCachedTileX, this.minCachedTileY, this.sprite, (float)this.cachedPixelsPerTile / var10); // L: 480
				this.field4887 = Client.field698; // L: 481
			...
			if (1.0F == var10) { // L: 486
				this.sprite.method9417(var13, var14, 192); // L: 487
			} else {
				this.sprite.method9398(var13, var14, (int)((float)var8 * var10), (int)(var10 * (float)var9), 192); // L: 490
			}
		}
	...
	public void flashCategory(int var1) {
		...
		for (int var2 = 0; var2 < class11.WorldMapElement_count; ++var2) { // L: 661
			if (class147.WorldMapElement_get(var2) != null && class147.WorldMapElement_get(var2).category == var1) { // L: 662 665
				this.flashingElements.add(class147.WorldMapElement_get(var2).objectId); // L: 666
			}
		}
	...
	public void setCategoryDisabled(int var1, boolean var2) {
		...
		for (int var3 = 0; var3 < class11.WorldMapElement_count; ++var3) { // L: 696
			if (class147.WorldMapElement_get(var3) != null && class147.WorldMapElement_get(var3).category == var1) { // L: 697 700
				int var4 = class147.WorldMapElement_get(var3).objectId; // L: 701
				if (!var2) { // L: 702
	...
	void method8438() {
		this.field4874.clear(); // L: 726
		this.field4874.addAll(this.enabledElements); // L: 727
		this.field4874.addAll(this.enabledElementIds); // L: 728
	} // L: 729
	...
	public void addElementMenuOptions(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (this.cacheLoader.isLoaded()) { // L: 732
			...
			List var9 = this.worldMapManager.method5319(this.centerTileX - var7 / 2 - 1, this.centerTileY - var8 / 2 - 1, var7 / 2 + this.centerTileX + 1, var8 / 2 + this.centerTileY + 1, var1, var2, var3, var4, var5, var6); // L: 737
			if (!var9.isEmpty()) { // L: 738
				...
				do {
					...
					WorldMapElement var12 = class147.WorldMapElement_get(var11.getElement()); // L: 744
					var13 = false; // L: 745

					for (int var14 = this.menuOpcodes.length - 1; var14 >= 0; --var14) { // L: 746
						if (var12.menuActions[var14] != null) { // L: 747
							class138.insertMenuItemNoShift(var12.menuActions[var14], var12.menuTargetName, this.menuOpcodes[var14], var11.getElement(), var11.coord1.packed(), var11.coord2.packed()); // L: 748
							var13 = true; // L: 749
						}
					}
				} while(!var13); // L: 752
	...
	public void worldMapMenuAction(int var1, int var2, Coord var3, Coord var4) {
		...
		Clock.runScriptEvent(var5); // L: 825
	} // L: 826
	...
	public AbstractWorldMapIcon iconStart() {
		if (!this.cacheLoader.isLoaded()) { // L: 829
			...
			this.field4878 = new LinkedList(); // L: 836
			Iterator var2 = var1.values().iterator(); // L: 837

			while (var2.hasNext()) {
				List var3 = (List)var2.next(); // L: 838
				this.field4878.addAll(var3); // L: 840
			}

			this.iconIterator = this.field4878.iterator(); // L: 843
