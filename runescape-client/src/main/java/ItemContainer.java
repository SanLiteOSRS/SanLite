...
public class ItemContainer extends Node {
   ...
   static void load() {
      ...
      if (Client.titleLoadingStage == 0) {
         ...
         PlayerType.method4048(22050, !Client.isLowDetail, 2);
         ...
         if (Client.titleLoadingStage == 50) {
            ...
            if (Client.titleLoadingStage == 70) {
               if (!HealthBarUpdate.archive2.isFullyLoaded()) {
                  ...
                  CollisionMap.setFloorUnderlayDefinitionArchive(HealthBarUpdate.archive2);
                  ...
                  WorldMapArea.setNpcDefinitionArchives(HealthBarUpdate.archive2, class51.archive7);
                  ...
                  Tiles.method1090(HealthBarUpdate.archive2);
                  UserComparator10.method3348(UserComparator8.archive3, class51.archive7, class2.archive8, WorldMapID.archive13);
                  KeyHandler.method772(HealthBarUpdate.archive2);
