...
public class ClanSettings {
	...
	public ClanSettings(Buffer var1) {
		this.field1744 = 0; // L: 14
		this.name = null; // L: 15
		this.field1737 = 0; // L: 16
		this.currentOwner = -1; // L: 29
		this.field1751 = -1; // L: 30
		this.method3259(var1); // L: 43
	} // L: 44
	...
	public int method3243(int var1, int var2, int var3) {
		...
		return (this.field1739[var1] & var4) >>> var2; // L: 86
	}
	...
	public int[] getSortedMembers() {
		if (this.sortedMembers == null) { // L: 97
			...
			class522.method9132(var1, this.sortedMembers); // L: 105
		}
	...
	void method3246(long var1, String var3, int var4) {
		...
		if (var1 > 0L != this.useHashes) { // L: 112
			...
			this.field1739[this.memberCount] = 0; // L: 124
			this.field1748[this.memberCount] = var4; // L: 125
			this.field1736[this.memberCount] = false; // L: 126
	...
	void method3290(int var1) {
		if (var1 >= 0 && var1 < this.memberCount) { // L: 132
			...
			if (this.memberCount == 0) { // L: 135
				...
				this.field1739 = null; // L: 139
				this.field1748 = null; // L: 140
				this.field1736 = null; // L: 141
				this.currentOwner = -1; // L: 142
				this.field1751 = -1; // L: 143
			} else {
				System.arraycopy(this.memberRanks, var1 + 1, this.memberRanks, var1, this.memberCount - var1); // L: 146
				System.arraycopy(this.field1739, var1 + 1, this.field1739, var1, this.memberCount - var1); // L: 147
				System.arraycopy(this.field1748, var1 + 1, this.field1748, var1, this.memberCount - var1); // L: 148
				System.arraycopy(this.field1736, var1 + 1, this.field1736, var1, this.memberCount - var1); // L: 149
	...
	void updateOwner() {
		if (this.memberCount == 0) { // L: 157
			...
			this.field1751 = -1; // L: 159
		} else {
			this.currentOwner = -1; // L: 162
			this.field1751 = -1; // L: 163
			int var1 = 0; // L: 164
			...
			for (int var3 = 1; var3 < this.memberCount; ++var3) { // L: 166
				if (this.memberRanks[var3] > var2) { // L: 167
					if (var2 == 125) {
						this.field1751 = var1; // L: 168
					}

					var1 = var3; // L: 169
					var2 = this.memberRanks[var3]; // L: 170
				} else if (this.field1751 == -1 && this.memberRanks[var3] == 125) { // L: 172
					this.field1751 = var3; // L: 173
				}
			}
	...
	int method3307(int var1, byte var2) {
		if (var2 != 126 && var2 != 127) { // L: 203
			if (this.currentOwner == var1 && (this.field1751 == -1 || this.memberRanks[this.field1751] < 125)) { // L: 204
				return -1;
	...
	boolean method3281(int var1) {
		if (this.currentOwner != var1 && this.memberRanks[var1] != 126) { // L: 212
			...
			this.field1751 = this.currentOwner; // L: 214
	...
	int method3253(int var1, boolean var2) {
		if (this.field1736[var1] == var2) { // L: 221
			return -1;
		} else {
			this.field1736[var1] = var2; // L: 222
			return var1; // L: 223
		}
	}
	...
	int method3254(int var1, int var2, int var3, int var4) {
		...
		var2 <<= var3; // L: 230
		var2 &= var7; // L: 231
		int var8 = this.field1739[var1]; // L: 232
		if ((var8 & var7) == var2) {
			return -1; // L: 233
		} else {
			var8 &= ~var7; // L: 234
			this.field1739[var1] = var8 | var2; // L: 235
			return var1; // L: 236
		}
	}
	...
	boolean method3257(int var1, long var2) {
		if (this.parameters != null) { // L: 282
			...
			if (var4 != null) { // L: 284
				if (var4 instanceof class490) { // L: 285
					class490 var5 = (class490)var4; // L: 286
					if (var5.field4947 == var2) { // L: 287
						return false;
					}

					var5.field4947 = var2; // L: 288
					return true; // L: 289
				}
		...
		this.parameters.put(new class490(var2), (long)var1); // L: 295
		return true; // L: 296
	}
	...
	void method3259(Buffer var1) {
		...
		if (var2 >= 1 && var2 <= 6) { // L: 324
			...
			this.field1744 = var1.readInt(); // L: 336
			this.field1737 = var1.readInt(); // L: 337
			if (var2 <= 3 && this.field1737 != 0) { // L: 338
			...
			this.field1752 = var1.readByte(); // L: 346
			this.field1740 = var1.readByte(); // L: 347
			this.field1749 = var1.readByte(); // L: 348
			this.field1741 = var1.readByte(); // L: 349
			int var4;
			if (this.memberCount > 0) { // L: 350
				...
				if (this.field1739 == null || this.field1739.length < this.memberCount) { // L: 354
					this.field1739 = new int[this.memberCount];
				}

				if (this.field1748 == null || this.field1748.length < this.memberCount) { // L: 355
					this.field1748 = new int[this.memberCount];
				}

				if (this.field1736 == null || this.field1736.length < this.memberCount) { // L: 356
				...
				for (var4 = 0; var4 < this.memberCount; ++var4) { // L: 357
					...
					if (var2 >= 5) { // L: 362
						...
						this.field1748[var4] = 0; // L: 363
					}

					if (var2 >= 6) { // L: 364
						this.field1736[var4] = var1.readUnsignedByte() == 1;
					} else {
						this.field1736[var4] = false; // L: 365
					}
				}
			...
			if (var2 >= 3) { // L: 377
				...
				if (var4 > 0) { // L: 379
					this.parameters = new IterableNodeHashTable(var4 < 16 ? class193.method3722(var4) : 16); // L: 380
					...
					while (var4-- > 0) { // L: 381
						...
						if (var7 == 0) { // L: 385
							...
							this.parameters.put(new class490(var10), (long)var6); // L: 391
