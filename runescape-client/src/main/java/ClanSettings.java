			...
			if (Client.titleLoadingStage == 45) { // L: 1612
				...
				if (Client.titleLoadingStage == 60) { // L: 1654
					...
					if (!class356.archive2.isFullyLoaded()) { // L: 1673
						...
						ItemComposition.ItemComposition_archive = var23; // L: 1697
						ItemComposition.ItemComposition_modelArchive = var4; // L: 1698
						class82.ItemComposition_inMembersWorld = var24; // L: 1699
						ItemContainer.ItemComposition_fileCount = ItemComposition.ItemComposition_archive.getGroupFileCount(10); // L: 1700
						class146.ItemComposition_fontPlain11 = var25; // L: 1701
						...
						class221.Ignored_cached = new class428(ApproximateRouteStrategy.field473, 47, class263.clientLanguage, class356.archive2); // L: 1742
					...
					if (UserComparator4.headIconPkSprites == null) { // L: 1765
						...
						if (!Nameable.method6514(var2, var3, 0)) { // L: 1770
							var1 = null; // L: 1771
						} else {
					...
					if (ChatChannel.headIconPrayerSprites == null) { // L: 1798
						...
						if (!Nameable.method6514(var2, var3, 0)) { // L: 1803
							var1 = null; // L: 1804
						} else {
					...
					if (class21.headIconHintSprites == null) { // L: 1831
						...
						if (!Nameable.method6514(var2, var3, 0)) { // L: 1836
							var1 = null; // L: 1837
						} else {
					...
					if (class146.mapMarkerSprites == null) { // L: 1864
						...
						if (!Nameable.method6514(var2, var3, 0)) { // L: 1869
							var1 = null; // L: 1870
						} else {
					...
					if (Projectile.crossSprites == null) { // L: 1897
						...
						if (!Nameable.method6514(var2, var3, 0)) { // L: 1902
							var1 = null; // L: 1903
						} else {
					...
					if (DecorativeObject.mapDotSprites == null) { // L: 1930
						var2 = class305.archive8; // L: 1932
						var3 = class28.spriteIds.field4375; // L: 1933
						if (!Nameable.method6514(var2, var3, 0)) { // L: 1935
							var1 = null; // L: 1936
						} else {
						...
						DecorativeObject.mapDotSprites = var1; // L: 1960
					} else {
						++var19; // L: 1962
					}
