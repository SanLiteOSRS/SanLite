...
public class ClanSettings {
	...
	@ObfuscatedName("ab")
	@ObfuscatedGetter(
		longValue = 3953615371570262875L
	)
	long field1705;
	@ObfuscatedName("at")
	@ObfuscatedGetter(
	...
	public ClanSettings(Buffer var1) {
		this.field1693 = 0; // L: 14
		this.name = null; // L: 15
		this.field1703 = 0; // L: 16
		this.currentOwner = -1; // L: 29
		this.field1690 = -1; // L: 30
		this.method3208(var1); // L: 43
	} // L: 44

	@ObfuscatedName("ay")
	@ObfuscatedSignature(
		descriptor = "(II)V",
		garbageValue = "989944122"
	)
	void method3190(int var1) {
		...
		if (this.field1691 != null) { // L: 57
			System.arraycopy(this.field1691, 0, this.field1691 = new int[var1], 0, this.memberCount);
		} else {
			this.field1691 = new int[var1]; // L: 58
		}

		if (this.field1694 != null) { // L: 59
			System.arraycopy(this.field1694, 0, this.field1694 = new int[var1], 0, this.memberCount);
		} else {
			this.field1694 = new int[var1]; // L: 60
		}

		if (this.field1707 != null) { // L: 61
			System.arraycopy(this.field1707, 0, this.field1707 = new boolean[var1], 0, this.memberCount);
		} else {
			this.field1707 = new boolean[var1]; // L: 62
		}
	...
	@ObfuscatedSignature(
		...
		garbageValue = "-2097319698"
	)
	public int method3230(String var1) {
	...
	@ObfuscatedSignature(
		descriptor = "(IIII)I",
		garbageValue = "-309943666"
	)
	public int method3193(int var1, int var2, int var3) {
		int var4 = var3 == 31 ? -1 : (1 << var3 + 1) - 1; // L: 85
		return (this.field1691[var1] & var4) >>> var2; // L: 86
	}

	@ObfuscatedName("at")
	@ObfuscatedSignature(
		descriptor = "(II)Ljava/lang/Integer;",
		garbageValue = "1868328431"
	)
	...
	public int[] getSortedMembers() {
		if (this.sortedMembers == null) { // L: 97
			...
			class260.method5397(var1, var3, 0, var1.length - 1); // L: 107
		}
	...
	@ObfuscatedSignature(
		...
		garbageValue = "-713476155"
	)
	void method3201(long var1, String var3, int var4) {
		...
		if (var1 > 0L != this.useHashes) { // L: 115
			...
			if (var1 > 0L && (this.memberHashes == null || this.memberCount >= this.memberHashes.length) || var3 != null && (this.memberNames == null || this.memberCount >= this.memberNames.length)) { // L: 117
				this.method3190(this.memberCount + 5);
			}
			...
			this.field1691[this.memberCount] = 0; // L: 127
			this.field1694[this.memberCount] = var4; // L: 128
			this.field1707[this.memberCount] = false; // L: 129
	...
	@ObfuscatedSignature(
		descriptor = "(II)V",
		garbageValue = "1336627456"
	)
	void method3197(int var1) {
		if (var1 >= 0 && var1 < this.memberCount) { // L: 135
			...
			if (this.memberCount == 0) { // L: 138
				...
				this.field1691 = null; // L: 142
				this.field1694 = null; // L: 143
				this.field1707 = null; // L: 144
				this.currentOwner = -1; // L: 145
				this.field1690 = -1; // L: 146
			} else {
				System.arraycopy(this.memberRanks, var1 + 1, this.memberRanks, var1, this.memberCount - var1); // L: 149
				System.arraycopy(this.field1691, var1 + 1, this.field1691, var1, this.memberCount - var1); // L: 150
				System.arraycopy(this.field1694, var1 + 1, this.field1694, var1, this.memberCount - var1); // L: 151
				System.arraycopy(this.field1707, var1 + 1, this.field1707, var1, this.memberCount - var1); // L: 152
	...
	void updateOwner() {
		if (this.memberCount == 0) { // L: 160
			...
			for (int var3 = 1; var3 < this.memberCount; ++var3) { // L: 169
				...
				} else if (this.field1690 == -1 && this.memberRanks[var3] == 125) { // L: 175
					this.field1690 = var3; // L: 176
				}
			}
	...
	void method3224(long var1, String var3) {
		...
		if (var1 > 0L != this.useHashes) { // L: 185
			...
			if (var1 > 0L && (this.bannedMemberHashes == null || this.bannedMemberCount >= this.bannedMemberHashes.length) || var3 != null && (this.bannedMemberNames == null || this.bannedMemberCount >= this.bannedMemberNames.length)) { // L: 187
				this.method3250(this.bannedMemberCount + 5);
			}
	...
	@ObfuscatedSignature(
		descriptor = "(II)V",
		garbageValue = "1633546511"
	)
	void method3199(int var1) {
	...
	@ObfuscatedSignature(
		descriptor = "(IBI)I",
		garbageValue = "-1372681400"
	)
	int method3200(int var1, byte var2) {
		if (var2 != 126 && var2 != 127) { // L: 206
			if (this.currentOwner == var1 && (this.field1690 == -1 || this.memberRanks[this.field1690] < 125)) { // L: 207
				return -1;
	...
	int method3202(int var1, boolean var2) {
		if (this.field1707[var1] == var2) { // L: 224
			return -1;
		} else {
			this.field1707[var1] = var2; // L: 225
			return var1; // L: 226
		}
	}
	...
	@ObfuscatedSignature(
		descriptor = "(IIIII)I",
		garbageValue = "1576550093"
	)
	int method3203(int var1, int var2, int var3, int var4) {
		int var5 = (1 << var3) - 1; // L: 230
		int var6 = var4 == 31 ? -1 : (1 << var4 + 1) - 1; // L: 231
		int var7 = var6 ^ var5; // L: 232
		var2 <<= var3; // L: 233
		var2 &= var7; // L: 234
		int var8 = this.field1691[var1]; // L: 235
		if ((var8 & var7) == var2) {
			return -1; // L: 236
		} else {
			var8 &= ~var7; // L: 237
			this.field1691[var1] = var8 | var2; // L: 238
			return var1; // L: 239
		}
	}
	...
	boolean method3198(int var1, int var2) {
	...
	@ObfuscatedSignature(
		descriptor = "(IIIII)Z",
		garbageValue = "687852788"
	)
	boolean method3229(int var1, int var2, int var3, int var4) {
	...
	@ObfuscatedName("ao")
	boolean method3206(int var1, long var2) {
		if (this.parameters != null) { // L: 285
			...
			if (var4 != null) { // L: 287
				if (var4 instanceof class458) { // L: 288
					...
					if (var5.field4757 == var2) { // L: 290
						return false;
					}

					var5.field4757 = var2; // L: 291
					return true; // L: 292
				}
	...
	@ObfuscatedSignature(
		...
		garbageValue = "-1896147688"
	)
	boolean method3222(int var1, String var2) {
		if (var2 == null) { // L: 303
			var2 = "";
	...
	@ObfuscatedSignature(
		descriptor = "(Ltc;I)V",
		garbageValue = "1382756700"
	)
	void method3208(Buffer var1) {
		...
		if (var2 >= 1 && var2 <= 6) { // L: 327
			...
			this.field1693 = var1.readInt(); // L: 339
			this.field1703 = var1.readInt(); // L: 340
			if (var2 <= 3 && this.field1703 != 0) {
				this.field1703 += 16912800;
			}
			...
			this.field1698 = var1.readByte(); // L: 349
			this.field1699 = var1.readByte(); // L: 350
			this.field1700 = var1.readByte(); // L: 351
			this.field1701 = var1.readByte(); // L: 352
			int var4;
			if (this.memberCount > 0) { // L: 353
				...
				if (this.field1691 == null || this.field1691.length < this.memberCount) { // L: 357
					this.field1691 = new int[this.memberCount];
				}

				if (this.field1694 == null || this.field1694.length < this.memberCount) { // L: 358
					this.field1694 = new int[this.memberCount];
				}

				if (this.field1707 == null || this.field1707.length < this.memberCount) { // L: 359
					this.field1707 = new boolean[this.memberCount];
				}
				...
				for (var4 = 0; var4 < this.memberCount; ++var4) { // L: 360
					...
					if (var2 >= 2) { // L: 364
						this.field1691[var4] = var1.readInt();
					}

					if (var2 >= 5) { // L: 365
						this.field1694[var4] = var1.readUnsignedShort();
					} else {
						this.field1694[var4] = 0; // L: 366
					}

					if (var2 >= 6) { // L: 367
						this.field1707[var4] = var1.readUnsignedByte() == 1;
					} else {
						this.field1707[var4] = false; // L: 368
					}
				}
			...
			if (var2 >= 3) { // L: 380
				...
				if (var4 > 0) { // L: 382
					this.parameters = new IterableNodeHashTable(var4 < 16 ? class298.method5751(var4) : 16); // L: 383
	...
	@ObfuscatedSignature(
		descriptor = "([FI)V",
		garbageValue = "428447526"
	)
	static void method3251(float[] var0) {
		var0[1] = 1.0F - var0[1]; // L: 332
		if (var0[0] < 0.0F) { // L: 333
			var0[0] = 0.0F;
		}

		if (var0[1] < 0.0F) { // L: 334
			var0[1] = 0.0F;
		}

		if (var0[0] > 1.0F || var0[1] > 1.0F) { // L: 335
			float var1 = (float)(1.0D + (double)(var0[0] * (var0[0] - 2.0F + var0[1])) + (double)var0[1] * ((double)var0[1] - 2.0D)); // L: 336
			if (var1 + class125.field1468 > 0.0F) { // L: 337
				KitDefinition.method3616(var0); // L: 338
			}
		}

		var0[1] = 1.0F - var0[1]; // L: 341
	} // L: 342
}
