		...
		for (int var1 = 0; var1 < Client.npcCount; ++var1) { // L: 5102
			...
			if (var2 != null && var2.isVisible() && var2.definition.isVisible == var0 && var2.definition.transformIsVisible()) { // L: 5104
				...
				if (var3 >= 0 && var3 < 104 && var4 >= 0 && var4 < 104) { // L: 5107
					if (var2.field1155 * -1321988096 == 1 && (var2.x & 127) == 64 && (var2.y & 127) == 64) { // L: 5108
					...
					class36.scene.drawEntity(Clock.Client_plane, var2.x, var2.y, Renderable.getTileHeight(var2.field1155 * 1292107776 - 64 + var2.x, var2.field1155 * 1292107776 - 64 + var2.y, Clock.Client_plane), var2.field1155 * 1292107776 - 64 + 60, var2, var2.rotation, var5, var2.isWalking); // L: 5114
				}
			}
		}
