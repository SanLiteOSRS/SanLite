			...
			try {
				...
				if (ServerPacket.field3150 == var1.serverPacket) { // L: 6177
					...
					if (hintArrowType >= 2 && hintArrowType <= 6) { // L: 6180
						...
						hintArrowHeight = var3.readUnsignedByte() * 2; // L: 6204
					}
				...
				if (ServerPacket.field3078 == var1.serverPacket) { // L: 6998
					...
					UrlRequester.field1355 = var3.readUnsignedByte() * 128; // L: 7002
					...
					if (UserComparator6.field1398 >= 100) { // L: 7006
						...
						ApproximateRouteStrategy.cameraZ = UrlRequester.field1355 * 16384 + 64; // L: 7008
