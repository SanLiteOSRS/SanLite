...
public final class Client extends GameShell implements Usernamed {
   ...
   static int field838 = -1;
   @ObfuscatedName("cb")
   @ObfuscatedGetter(
      intValue = 519692055
   )
   static int field637 = -1;
   @ObfuscatedName("ch")
   @ObfuscatedGetter(
      longValue = -2755527832911265383L
   )
   static long field889 = -1L;
   @ObfuscatedName("cn")
   static boolean field639 = true;
   @ObfuscatedName("cr")
   @Export("displayFps")
   ...
   static {
      ...
      field749 = new int[]{768, 1024, 1280, 512, 1536, 256, 0, 1792};
   ...
   protected final void resizeGame() {
      field836 = SequenceDefinition.currentTimeMs() + 500L;
      this.resizeJS();
      if (rootInterface != -1) {
   ...
   protected final void setUp() {
      ...
      WorldMapRectangle.port1 = gameBuild == 0 ? 'ꩊ' : worldId + '鱀';
      FloorDecoration.port2 = gameBuild == 0 ? 443 : worldId + '썐';
      ...
      class293.masterDisk = new ArchiveDisk(255, class167.dat2File, class167.idx255File, 500000);
      AccessFile var4 = null;
      ClientPreferences var5 = new ClientPreferences();

      try {
         var4 = TaskHandler.getPreferencesFile("", WorldMapRectangle.studioGame.name, false);
         ...
         if (gameState == 20) {
            ...
            if (!var46) {
               ...
               if (!var46) {
                  ...
                  Tiles.field476 = new int[104];
                  class3.field26 = new int[104];
                  Buddy.field3590 = new int[104];
                  class49.field394 = new int[104];
                  ...
                  if (WorldMapID.client.hasFrame()) {
                     var47 = MenuAction.method1994(ClientPacket.field2189, packetWriter.isaacCipher);
                     var47.packetBuffer.writeInt(1057001181);
                     packetWriter.method2177(var47);
                  }
                  ...
                  Tiles.field476 = null;
                  class3.field26 = null;
                  Buddy.field3590 = null;
                  class49.field394 = null;
                  MenuAction.field1129 = null;
                  var47 = MenuAction.method1994(ClientPacket.field2261, packetWriter.isaacCipher);
                  packetWriter.method2177(var47);
                  GameShell.clock.mark();
   ...
   protected final void draw(boolean var1) {
      ...
      if ((gameState == 10 || gameState == 20 || gameState == 30) && 0L != field836 && SequenceDefinition.currentTimeMs() > field836) {
   ...
   protected final void kill0() {
      ...
      try {
         ...
         for(int var4 = 0; var4 < class167.idxCount; ++var4) {
            WorldMapSection1.idxFiles[var4].close();
         }
   ...
   public final void init() {
      try {
         if (this.checkHost()) {
            ...
            for(int var1 = 0; var1 <= 19; ++var1) {
               ...
               if (var2 != null) {
                  ...
                  case 7:
                     ...
                     ServerBuild[] var5 = Fonts.ServerBuild_values();
                     var6 = 0;
                  ...
                  case 9:
                     ...
                     break;
                  case 10:
                     WorldMapRectangle.studioGame = (StudioGame)FriendSystem.findEnumerated(WorldMapSprite.method402(), Integer.parseInt(var2));
                     if (StudioGame.oldscape == WorldMapRectangle.studioGame) {
            ...
            try {
               class167.idxCount = 21;
               InterfaceParent.field543 = var9;
               ...
               Login.field1181 = new String[]{".jagex_cache_" + InterfaceParent.field543, ".file_store_" + InterfaceParent.field543};

               label133:
               for(int var10 = 0; var10 < 4; ++var10) {
                  class167.field2023 = class4.method71("oldschool", var8, var10);
                  if (!class167.field2023.exists()) {
                     class167.field2023.mkdirs();
                  }

                  File[] var11 = class167.field2023.listFiles();
                  if (var11 == null) {
                     break;
                  }
                  ...
                  while(true) {
                     ...
                     if (!GameShell.method1004(var19, false)) {
                        break;
                     }
               ...
               File var17 = class167.field2023;
               class169.field2033 = var17;
               if (!class169.field2033.exists()) {
                  throw new RuntimeException("");
               }

               class169.field2034 = true;
               SoundSystem.method2417();
               class167.dat2File = new BufferedFile(new AccessFile(class42.method731("main_file_cache.dat2"), "rw", 1048576000L), 5200, 0);
               class167.idx255File = new BufferedFile(new AccessFile(class42.method731("main_file_cache.idx255"), "rw", 1048576L), 6000, 0);
               WorldMapSection1.idxFiles = new BufferedFile[class167.idxCount];

               for(var4 = 0; var4 < class167.idxCount; ++var4) {
            ...
            GZipDecompressor.RunException_clientType = clientType;
            this.startThread(765, 503, 182);
         }
      } catch (RuntimeException var16) {
         throw class195.method3630(var16, "client.init(" + ')');
      }
   }
         ...
         if (--field681 + 1 <= 0) {
            try {
               ...
               if (js5ConnectState == 2) {
                  ...
                  ++js5ConnectState;
                  Coord.field2511 = SequenceDefinition.currentTimeMs();
               }
               ...
               if (js5ConnectState == 3) {
                  if (js5Socket.available() > 0 || !useBufferedSocket && gameState <= 5) {
                     ...
                     ++js5ConnectState;
                  } else if (SequenceDefinition.currentTimeMs() - Coord.field2511 > 30000L) {
                     this.js5Error(-2);
                     return;
                  }
               }
               ...
               if (js5ConnectState == 4) {
                  class83.method1996(js5Socket, gameState > 20);
      ...
      try {
         ...
         if (loginState == 3) {
            ...
            if (var12) {
               ...
               if (var13 != 0) {
                  GrandExchangeOfferOwnWorldComparator.method1234(var13);
                  return;
               }
         ...
         if (loginState == 6 && ((AbstractSocket)var1).available() > 0) {
            ...
            if (var33 == 21 && gameState == 20) {
               ...
               if (var33 != 29) {
                  GrandExchangeOfferOwnWorldComparator.method1234(var33);
                  return;
               }
               ...
               if (loginState == 16) {
                  ...
                  if (field658 > 2000) {
                     if (field659 < 1) {
                        ...
                        GrandExchangeOfferOwnWorldComparator.method1234(-3);
                     }
                  }
               }
            } else {
         ...
         if (field659 < 1) {
            ...
            GrandExchangeOfferOwnWorldComparator.method1234(-2);
         }
      }
   }
   ...
   final void doCycleLoggedIn() {
      ...
      if (field672) {
         ...
         if (!isMenuOpen) {
            LoginScreenAnimation.resetMenuEntries();
         }
         ...
         if (gameState == 30) {
            ...
            while(GraphicsObject.method1948()) {
               var14 = MenuAction.method1994(ClientPacket.field2285, packetWriter.isaacCipher);
               var14.packetBuffer.writeByte(0);
               var2 = var14.packetBuffer.offset;
               InterfaceParent.method1128(var14.packetBuffer);
               var14.packetBuffer.writeLengthByte(var14.packetBuffer.offset - var2);
               packetWriter.method2177(var14);
            }

            if (timer.field3560) {
               var14 = MenuAction.method1994(ClientPacket.field2195, packetWriter.isaacCipher);
               var14.packetBuffer.writeByte(0);
               var2 = var14.packetBuffer.offset;
               ...
               if (!field783) {
                  ...
                  for(var7 = 0; var7 < Language.mouseRecorder.index && (var15 == null || var15.packetBuffer.offset - var3 < 246); ++var7) {
                     ...
                     if (var9 != field838 || var8 != field637) {
                        if (var15 == null) {
                           var15 = MenuAction.method1994(ClientPacket.field2219, packetWriter.isaacCipher);
            ...
            if (MouseHandler.MouseHandler_lastButton == 1 || !FriendSystem.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) {
               ...
               var5 = (int)var16;
               var18 = MenuAction.method1994(ClientPacket.field2226, packetWriter.isaacCipher);
               var18.packetBuffer.writeShort((var5 << 1) + (MouseHandler.MouseHandler_lastButton == 2 ? 1 : 0));
               var18.packetBuffer.writeShort(var4);
               var18.packetBuffer.writeShort(var3);
               packetWriter.method2177(var18);
            }

            if (KeyHandler.field380 > 0) {
               var14 = MenuAction.method1994(ClientPacket.field2252, packetWriter.isaacCipher);
               var14.packetBuffer.writeShort(0);
               var2 = var14.packetBuffer.offset;
               long var19 = SequenceDefinition.currentTimeMs();
            ...
            if (field708 && field712 <= 0) {
               field712 = 20;
               field708 = false;
               var14 = MenuAction.method1994(ClientPacket.field2224, packetWriter.isaacCipher);
               var14.packetBuffer.method5432(camAngleX);
               var14.packetBuffer.writeShortLE(camAngleY);
               packetWriter.method2177(var14);
            }

            if (class3.field21 && !field639) {
               field639 = true;
               var14 = MenuAction.method1994(ClientPacket.field2258, packetWriter.isaacCipher);
            ...
            if (gameState == 30) {
               ...
               if (packetWriter.field1293 > 750) {
                  ...
                  if (Actor.field978 != null) {
                     ++field729;
                     if (field729 >= 15) {
                        FriendSystem.method1822(Actor.field978);
                        Actor.field978 = null;
                     }
                  }
                  ...
                  while(FontName.method5231() && field677 < 128) {
                                       ...
                                       do {
                                          ...
                                          if (var44 == null) {
                                             ...
                                             if (class188.dragInventoryWidget != null) {
                                                FriendSystem.method1822(class188.dragInventoryWidget);
                                                ++itemDragDuration;
                                                if (MouseHandler.MouseHandler_currentButton == 0) {
                                                   if (field867) {
                                                      if (class188.dragInventoryWidget == class222.field2730 && dragItemSlotSource != dragItemSlotDestination) {
                                                         ...
                                                         PacketBufferNode var26 = MenuAction.method1994(ClientPacket.field2265, packetWriter.isaacCipher);
                                             ...
                                             if (Scene.method3049()) {
                                                ...
                                                var18 = MenuAction.method1994(ClientPacket.field2281, packetWriter.isaacCipher);
                                             ...
                                             if (var33 != class65.mousedOverWidgetIf1) {
                                                if (var33 != null) {
                                                   FriendSystem.method1822(var33);
                                                }

                                                if (class65.mousedOverWidgetIf1 != null) {
                                                   FriendSystem.method1822(class65.mousedOverWidgetIf1);
                                                }
                                             }

                                             if (var38 != WorldMapDecoration.field198 && field774 == field848) {
                                                if (var38 != null) {
                                                   FriendSystem.method1822(var38);
                                                }

                                                if (WorldMapDecoration.field198 != null) {
                                                   FriendSystem.method1822(WorldMapDecoration.field198);
                                                }
                                             }
                                             ...
                                             if (var4 > 15000 && var5 > 15000) {
                                                ...
                                                var18 = MenuAction.method1994(ClientPacket.field2234, packetWriter.isaacCipher);
                                                packetWriter.method2177(var18);
                                             }

                                             class32.friendSystem.method1776();
                                             ++packetWriter.field1297;
                                             if (packetWriter.field1297 > 50) {
                                                var18 = MenuAction.method1994(ClientPacket.field2207, packetWriter.isaacCipher);
                                                packetWriter.method2177(var18);
                                             }
   ...
   final void drawLoggedIn() {
      if (rootInterface != -1) {
         CollisionMap.method3505(rootInterface);
      }
      ...
      if (var2 == null) {
         ...
         try {
            ...
            if (ServerPacket.field2150 == var1.serverPacket) {
               SoundSystem.method2415(var3, var1.serverPacketLength);
               var1.serverPacket = null;
               return true;
            }

            if (ServerPacket.field2139 == var1.serverPacket) {
               class167.method3438(class185.field2298);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field2155 == var1.serverPacket) {
               class32.friendSystem.method1783(var3, var1.serverPacketLength);
               field629 = cycleCntr;
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field2165 == var1.serverPacket) {
               WorldMapIcon_0.privateChatMode = class270.valueOf(var3.readUnsignedByte());
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field2108 == var1.serverPacket) {
               class167.method3438(class185.field2306);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field2124 == var1.serverPacket) {
               ...
               if (var48) {
                  Occluder.field1890 = SequenceDefinition.currentTimeMs() - var3.readLong();
            ...
            if (ServerPacket.field2175 == var1.serverPacket) {
               ...
               MouseRecorder.method1138(var5, var16);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field2179 == var1.serverPacket) {
               var16 = var3.readInt();
               var5 = var3.readInt();
               var6 = class225.method4038();
               PacketBufferNode var43 = MenuAction.method1994(ClientPacket.field2203, packetWriter.isaacCipher);
            ...
            if (ServerPacket.field2181 == var1.serverPacket) {
               ...
               WorldMapSectionType.method238(var16);
            ...
            if (ServerPacket.field2184 == var1.serverPacket) {
               class167.method3438(class185.field2302);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field2106 == var1.serverPacket) {
               ...
               if (field789 != null) {
                  FriendSystem.method1822(field789);
                  field789 = null;
               }
            ...
            if (ServerPacket.field2136 == var1.serverPacket) {
               ...
               FriendSystem.method1822(var52);
               var1.serverPacket = null;
               return true;
            }

            if (ServerPacket.field2112 == var1.serverPacket) {
               class167.method3438(class185.field2301);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field2178 == var1.serverPacket) {
               class167.method3438(class185.field2297);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field2146 == var1.serverPacket) {
               class167.method3438(class185.field2300);
               var1.serverPacket = null;
               return true;
            }

            if (ServerPacket.field2161 == var1.serverPacket) {
               class167.method3438(class185.field2304);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field2123 == var1.serverPacket) {
               class167.method3438(class185.field2303);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field2162 == var1.serverPacket) {
               ...
               if (var5 != rootInterface) {
                  rootInterface = var5;
                  this.resizeRoot(false);
                  WorldMapSectionType.method238(rootInterface);
                  class51.runWidgetOnLoadListener(rootInterface);
            ...
            if (ServerPacket.field2157 == var1.serverPacket) {
               ...
               if (rootInterface != -1) {
                  UserComparator6.method3382(rootInterface, 1);
               }
            ...
            if (ServerPacket.field2107 == var1.serverPacket) {
               ...
               if (!var32 && field737 == 0) {
                  ...
                  if (var29.modIcon * 714577229 != -1) {
                     DirectByteArrayCopier.addGameMessage(var45, AbstractWorldMapData.getModIconString(var29.modIcon * 714577229) + var38, var33);
                  } else {
            ...
            if (ServerPacket.field2149 == var1.serverPacket) {
               if (rootInterface != -1) {
                  UserComparator6.method3382(rootInterface, 0);
               }
            ...
            if (ServerPacket.field2151 == var1.serverPacket) {
               ...
               if (!var14 && field737 == 0) {
                  ...
                  if (var24.modIcon * 714577229 != -1) {
                     MilliClock.addChatMessage(9, AbstractWorldMapData.getModIconString(var24.modIcon * 714577229) + var38, var34, class266.method4892(var25));
                  } else {
                     MilliClock.addChatMessage(9, var38, var34, class266.method4892(var25));
                  }
               }
            ...
            if (ServerPacket.field2100 == var1.serverPacket) {
               class167.method3438(class185.field2305);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field2105 == var1.serverPacket) {
               class167.method3438(class185.field2299);
               var1.serverPacket = null;
               return true;
            }
   ...
   final boolean shouldLeftClickOpenMenu() {
      int var1 = Player.method1225();
      return (field900 == 1 && menuOptionsCount > 2 || ClientPacket.method3556(var1)) && !menuShiftClick[var1];
   }
   ...
   final void openMenu(int var1, int var2) {
      WorldMapData_1.method683(var1, var2);
   ...
   final void resizeRoot(boolean var1) {
      GrandExchangeOfferNameComparator.method147(rootInterface, KitDefinition.canvasWidth, class30.canvasHeight, var1);
   }
   ...
   final void method1615() {
      FriendSystem.method1822(clickedWidget);
         ...
         if (MouseHandler.MouseHandler_currentButton == 0) {
            if (isDraggingWidget) {
               ...
               if (draggedOnWidget != null && AbstractByteArrayCopier.method3871(clickedWidget) != null) {
                  PacketBufferNode var9 = MenuAction.method1994(ClientPacket.field2213, packetWriter.isaacCipher);
   ...
   static final void method1659(int var0, int var1, int var2, int var3, int var4, int var5, int var6, Scene var7, CollisionMap var8) {
      ...
      if (var6 == 22) {
         ...
         if (var6 >= 12) {
            ...
            if (var9.interactType != 0) {
               var8.method3493(var2, var3, var10, var11, var9.boolean1);
            }
            ...
            if (var6 == 2) {
               ...
               if (var6 == 5) {
                  ...
                  if (0L != var30) {
                     var29 = class215.getObjectDefinition(BoundaryObject.method3214(var30)).int2;
                  }
                  ...
                  var30 = var7.getBoundaryObjectTag(var0, var2, var3);
                  if (var30 != 0L) {
                     var29 = class215.getObjectDefinition(BoundaryObject.method3214(var30)).int2 / 2;
                  }
   ...
   static void aar(byte[] var0, int var1) {
      if (field863 == null) {
         field863 = new byte[24];
      }

      class300.method5630(var0, var1, field863, 0, 24);
   }
   ...
   static String abr(String var0) {
      ...
      for(int var2 = 0; var2 < var1.length; ++var2) {
         ...
         if (var3.modIcon * 714577229 != -1 && var0.startsWith(AbstractWorldMapData.getModIconString(var3.modIcon * 714577229))) {
   ...
   static void aaq(String var0) {
      ...
      try {
         ...
         if (var0.length() == 0) {
            ...
            var3 = var3 + "; Expires=" + MusicPatchPcmStream.method3831(SequenceDefinition.currentTimeMs() + 94608000000L) + "; Max-Age=" + 94608000L;
         }
   ...
   static void abs() {
      packetWriter.method2177(MenuAction.method1994(ClientPacket.field2222, packetWriter.isaacCipher));
      oculusOrbState = 0;
   }
   ...
   static void aad(Buffer var0) {
      if (field863 != null) {
         var0.writeBytes(field863, 0, field863.length);
      } else {
         byte[] var2 = new byte[24];

         try {
            class167.randomDat.seek(0L);
            class167.randomDat.readFully(var2);
   ...
   public static void abp(int var0, int var1, int var2, boolean var3) {
      PacketBufferNode var4 = MenuAction.method1994(ClientPacket.field2255, packetWriter.isaacCipher);
   ...
   static String abl(String var0) {
      ...
      for(int var2 = 0; var2 < var1.length; ++var2) {
         PlayerType var3 = var1[var2];
         if (var3.modIcon * -474359768 != -1 && var0.startsWith(AbstractWorldMapData.getModIconString(var3.modIcon * 714577229))) {
   ...
   static String abu(String var0) {
      ...
      for(int var2 = 0; var2 < var1.length; ++var2) {
         PlayerType var3 = var1[var2];
         if (var3.modIcon * 1421818761 != -1 && var0.startsWith(AbstractWorldMapData.getModIconString(var3.modIcon * 714577229))) {
   ...
   static String abw(String var0) {
      ...
      for(int var2 = 0; var2 < var1.length; ++var2) {
         PlayerType var3 = var1[var2];
         if (var3.modIcon * 869307039 != -1 && var0.startsWith(AbstractWorldMapData.getModIconString(var3.modIcon * 714577229))) {
            var0 = var0.substring(6 + Integer.toString(var3.modIcon * 714577229).length());
            break;
         }
      }
