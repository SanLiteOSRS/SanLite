		...
		if (var2 == null) { // L: 6343
			...
			try {
				...
				if (ServerPacket.field3339 == var1.serverPacket) { // L: 6974
					...
					Players.field1374 = var3.readUnsignedByte() * 128; // L: 6978
					...
					var7 = Players.field1374 * 16384 + 64; // L: 6984
				...
				if (ServerPacket.field3302 == var1.serverPacket) { // L: 7798
					...
					Players.field1374 = var3.readUnsignedByte() * 128; // L: 7802
					...
					var9 = Players.field1374 * 16384 + 64; // L: 7810
				...
				if (ServerPacket.field3308 == var1.serverPacket) { // L: 7832
					...
					Players.field1374 = var3.readUnsignedByte() * 128; // L: 7836
					...
					if (MouseHandler.field252 >= 100) { // L: 7841
						NPCComposition.cameraX = Players.field1374 * 16384 + 64; // L: 7842
