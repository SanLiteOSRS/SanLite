...
public final class Client extends GameEngine implements Usernamed, OAuthApi
{
								...
								if (var8 == class194.NetCache_responseArchiveBuffer.offset) {
									if (16711935L == class271.NetCache_currentResponse.key) {
										...
										if (var10 != class271.NetCache_currentResponse.crc) {
											...
											NetCache.field3998 = (byte)((int)(Math.random() * 255.0D + 1.0D));
											var1 = false;
											break label243;
										}
		...
		try {
			...
			if (loginState == 5) {
				...
				if (randomDatData != null) {
					var18.writeBytes(randomDatData, 0, randomDatData.length);
				} else {
				...
				var40.packetBuffer.method7721(ApproximateRouteStrategy.archive20.hash);
				var40.packetBuffer.writeIntME(class291.archive14.hash);
				var40.packetBuffer.writeInt(class145.archive8.hash);
				var40.packetBuffer.writeIntME(class10.archive2.hash);
				var40.packetBuffer.writeIntME(ObjectSound.archive19.hash);
				var40.packetBuffer.method7721(0);
				var40.packetBuffer.method7723(class182.archive4.hash);
				var40.packetBuffer.writeInt(WorldMapDecorationType.archive9.hash);
				var40.packetBuffer.writeIntME(JagexCache.archive10.hash);
				var40.packetBuffer.writeInt(class166.archive13.hash);
				var40.packetBuffer.method7721(WorldMapRectangle.archive18.hash);
				var40.packetBuffer.method7721(class28.archive15.hash);
				var40.packetBuffer.method7723(LoginScreenAnimation.archive7.hash);
				var40.packetBuffer.method7723(class16.archive6.hash);
				var40.packetBuffer.writeInt(Players.archive5.hash);
				var40.packetBuffer.method7721(BufferedNetSocket.archive3.hash);
				var40.packetBuffer.method7723(UserComparator8.archive1.hash);
				var40.packetBuffer.method7721(class54.archive17.hash);
				var40.packetBuffer.writeIntME(KeyHandler.archive0.hash);
			...
			if (loginState == 9 && this.field541.method43()) {
				...
				var33.packetBuffer.method7668(this.field496);
				packetWriter.addNode(var33);
				packetWriter.flush();
				this.field496 = null;
				ModeWhere.method6099(6);
			...
			if (loginState == 13) {
				...
				if (loginState == 15 && ((AbstractSocket)var1).available() >= class391.field4372) {
					...
					packetWriter.serverPacket = var37[var23];
				...
				if (loginState == 16) {
					...
					if (loginState == 19) {
						...
						if (((AbstractSocket)var1).available() >= packetWriter.serverPacketLength) {
							((AbstractSocket)var1).read(var2.array, 0, packetWriter.serverPacketLength);
							var2.offset = 0;
							var44 = packetWriter.serverPacketLength;
							timer.method6566();
		...
		if (hadNetworkError) {
			...
			if (gameState == 30) {
				...
				while (WorldMapID.method4360()) {
					var14 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2963, packetWriter.isaacCipher);
					var14.packetBuffer.writeByte(0);
					var2 = var14.packetBuffer.offset;
					class151.performReflectionCheck(var14.packetBuffer);
					var14.packetBuffer.method7774(var14.packetBuffer.offset - var2);
					packetWriter.addNode(var14);
				}

				if (timer.field4179) {
					var14 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2935, packetWriter.isaacCipher);
					var14.packetBuffer.writeByte(0);
					var2 = var14.packetBuffer.offset;
					...
					if (!field490) {
						...
						for (var7 = 0; var7 < class120.mouseRecorder.index && (var15 == null || var15.packetBuffer.offset - var3 < 246); ++var7) {
							...
							if (var9 != field508 || var8 != field509) {
								if (var15 == null) {
									var15 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2965, packetWriter.isaacCipher);
						...
						if (var15 != null) {
							var15.packetBuffer.method7774(var15.packetBuffer.offset - var3);
				...
				if (MouseHandler.MouseHandler_lastButton == 1 || !GameBuild.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) {
					...
					var5 = (int)var16;
					var18 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2976, packetWriter.isaacCipher);
				...
				if (KeyHandler.field118 > 0) {
					var14 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2899, packetWriter.isaacCipher);
					...
					for (var5 = 0; var5 < KeyHandler.field118; ++var5) {
						...
						var14.packetBuffer.method7680((int)var21);
					}
				...
				if (field589 && field588 <= 0) {
					field588 = 20;
					field589 = false;
					var14 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2990, packetWriter.isaacCipher);
					var14.packetBuffer.method7711(camAngleY);
				...
				if (Varcs.hasFocus && !hadFocus) {
					hadFocus = true;
					var14 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2978, packetWriter.isaacCipher);
				...
				if (Interpreter.FriendsChatManager_inFriendsChat) {
					if (ClientPacket.friendsChatManager != null) {
						ClientPacket.friendsChatManager.sort();
					}

					ModeWhere.method6102();
					Interpreter.FriendsChatManager_inFriendsChat = false;
				}
				...
				if (field714 != class18.Client_plane) {
					...
					for (var6 = 0; var6 < 104; ++var6) {
						for (var7 = 0; var7 < 104; ++var7) {
							long var23 = ArchiveLoader.scene.getGroundObjectTag(class18.Client_plane, var6, var7);
							if (0L != var23) {
				...
				if (gameState == 30) {
					...
					class136.method2923();
					++packetWriter.field1322;
					if (packetWriter.field1322 > 750) {
						ClanChannelMember.method2868();
					} else {
						class92.method2362();
						...
						if (class113.method2651() && KeyHandler.KeyHandler_pressedKeys[82] && KeyHandler.KeyHandler_pressedKeys[81] && mouseWheelRotation != 0) {
							...
							if (var3 != GrandExchangeEvents.localPlayer.plane) {
								StructComposition.method3619(GrandExchangeEvents.localPlayer.pathX[0] + GrandExchangeOfferOwnWorldComparator.baseX * 64, GrandExchangeEvents.localPlayer.pathY[0] + VarcInt.baseY * 64, var3, false);
							}
												...
												while (true) {
													do {
														...
														if (var37 == null) {
															this.menu();
															if (ScriptFrame.worldMap != null) {
																ScriptFrame.worldMap.method7327(class18.Client_plane, GrandExchangeOfferOwnWorldComparator.baseX * 64 + (GrandExchangeEvents.localPlayer.x >> 7), VarcInt.baseY * 64 + (GrandExchangeEvents.localPlayer.y >> 7), false);
																...
																if (MouseHandler.MouseHandler_currentButton == 0) {
																	if (field767) {
																		if (class142.dragInventoryWidget == GrandExchangeEvent.hoveredItemContainer && dragItemSlotSource != dragItemSlotDestination) {
																			...
																			var40 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2996, packetWriter.isaacCipher);
																			var40.packetBuffer.method7712(dragItemSlotDestination);
																			var40.packetBuffer.method7710(dragItemSlotSource);
																			var40.packetBuffer.method7721(class142.dragInventoryWidget.id);
																			var40.packetBuffer.method7804(var30);
																			packetWriter.addNode(var40);
																		}
															...
															if (Scene.shouldSendWalk()) {
																...
																var40 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2911, packetWriter.isaacCipher);
																var40.packetBuffer.writeByte(5);
																var40.packetBuffer.method7710(GrandExchangeOfferOwnWorldComparator.baseX * 64 + var3);
																var40.packetBuffer.writeShort(VarcInt.baseY * 64 + var4);
																var40.packetBuffer.method7703(KeyHandler.KeyHandler_pressedKeys[82] ? (KeyHandler.KeyHandler_pressedKeys[81] ? 2 : 1) : 0);
																packetWriter.addNode(var40);
																Scene.method4771();
															...
															if (var3 > 15000 && var4 > 15000) {
																...
																var18 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2979, packetWriter.isaacCipher);
																packetWriter.addNode(var18);
															}
															...
															if (packetWriter.pendingWrites > 50) {
																var18 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2950, packetWriter.isaacCipher);
																packetWriter.addNode(var18);
															}
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) {
			if (mouseCrossColor == 1) {
				class11.crossSprites[mouseCrossState * 20 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}

			if (mouseCrossColor == 2) {
				class11.crossSprites[mouseCrossState * 20 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}
		}
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3108 == var1.serverPacket) {
					FriendsChatMember.method6700(class263.field3007);
				...
				if (ServerPacket.field3071 == var1.serverPacket) {
					var20 = var3.method7714();
					var5 = var3.method7715();
					var6 = var3.method7827();
				...
				if (ServerPacket.field3090 == var1.serverPacket) {
					FriendsChatMember.method6700(class263.field3011);
					var1.serverPacket = null;
					return true;
				}

				if (ServerPacket.field3055 == var1.serverPacket) {
					class29.field181 = var3.method7875();
					PlayerComposition.field3307 = var3.method7742();
					var1.serverPacket = null;
					return true;
				}

				if (ServerPacket.field3024 == var1.serverPacket) {
					var20 = var3.method7837();
					var5 = var3.readShort();
				...
				if (ServerPacket.field3104 == var1.serverPacket) {
					isCameraLocked = true;
					field754 = false;
					class286.field3274 = var3.readUnsignedByte() * 128;
					class54.field447 = var3.readUnsignedByte() * 16384;
					...
					if (ArchiveDisk.field4309 >= 100) {
						WorldMapLabelSize.cameraX = class286.field3274 * 16384 + 64;
				...
				if (ServerPacket.field3066 == var1.serverPacket) {
					FriendsChatMember.method6700(class263.field3009);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3122 == var1.serverPacket) {
					...
					if (var22 >= 0 && var8 >= 0 && var22 < 103 && var8 < 103) {
						if (var24 == 0) {
							WallObject var69 = ArchiveLoader.scene.method4754(class18.Client_plane, var22, var8);
							if (var69 != null) {
							...
							DecorativeObject var68 = ArchiveLoader.scene.method4860(class18.Client_plane, var22, var8);
							if (var68 != null) {
							...
							GroundObject var67 = ArchiveLoader.scene.getGroundObject(class18.Client_plane, var22, var8);
							if (var67 != null) {
				...
				if (ServerPacket.field3119 == var1.serverPacket) {
					publicChatMode = var3.method7742();
					tradeChatMode = var3.method7875();
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3080 == var1.serverPacket) {
					HorizontalAlignment.field1885 = new class391(DirectByteArrayCopier.Ignored_cached);
					var1.serverPacket = null;
					return true;
				}

				if (ServerPacket.field3036 == var1.serverPacket) {
					FriendsChatMember.method6700(class263.field3012);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3107 == var1.serverPacket) {
					if (var1.serverPacketLength == 0) {
						ClientPacket.friendsChatManager = null;
					} else {
						if (ClientPacket.friendsChatManager == null) {
							ClientPacket.friendsChatManager = new FriendsChatManager(class122.loginType, class127.client);
						}

						ClientPacket.friendsChatManager.readUpdate(var3);
					}
				...
				if (ServerPacket.field3032 == var1.serverPacket) {
					FriendsChatMember.method6700(class263.field3013);
					var1.serverPacket = null;
					return true;
				}

				if (ServerPacket.field3037 == var1.serverPacket) {
					var20 = var3.method7705();
				...
				if (ServerPacket.field3063 == var1.serverPacket) {
					FriendsChatMember.method6700(class263.field3004);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3096 == var1.serverPacket) {
					FriendsChatMember.method6700(class263.field3005);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3093 == var1.serverPacket) {
					FriendsChatMember.method6700(class263.field3015);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3054 == var1.serverPacket) {
					...
					if (!var60.isIf3) {
						...
						var80 = class19.ItemComposition_get(var20);
						var60.modelType = 4;
						var60.modelId = var20;
				...
				if (ServerPacket.field3102 == var1.serverPacket) {
					...
					PacketBufferNode var59 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2983, packetWriter.isaacCipher);
					var59.packetBuffer.method7723(var20);
					var59.packetBuffer.method7721(var5);
					var59.packetBuffer.method7703(GameEngine.fps);
					var59.packetBuffer.method7703(var6);
				...
				if (ServerPacket.field3041 == var1.serverPacket) {
					...
					while (var3.offset < var1.serverPacketLength) {
						...
						FriendsChatMember.method6700(var71);
					}
				...
				if (ServerPacket.field3089 == var1.serverPacket) {
					if (ClientPacket.friendsChatManager != null) {
						ClientPacket.friendsChatManager.method6661(var3);
					}
				...
				if (ServerPacket.field3046 == var1.serverPacket) {
					FriendsChatMember.method6700(class263.field3008);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3047 == var1.serverPacket) {
					var20 = var3.method7715();
					var5 = var3.method7714();
					var6 = var3.method7714();
					var22 = var3.method7837();
				...
				if (ServerPacket.field3078 == var1.serverPacket) {
					isCameraLocked = true;
					field754 = false;
					class154.field1691 = var3.readUnsignedByte() * 16384;
					class67.field881 = var3.readUnsignedByte() * 128;
					...
					if (class386.field4337 >= 100) {
						...
						var5 = class67.field881 * 16384 + 64;
						...
						class147.cameraPitch = (int)(Math.atan2((double)var8, (double)var62) * 325.9490051269531D) & 2047;
						class21.cameraYaw = (int)(Math.atan2((double)var22, (double)var61) * -325.9490051269531D) & 2047;
				...
				if (ServerPacket.field3064 == var1.serverPacket) {
					FriendsChatMember.method6700(class263.field3006);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3049 == var1.serverPacket) {
					...
					class445 var50 = DirectByteArrayCopier.Ignored_cached.method7115(var3);
				...
				if (ServerPacket.field3126 == var1.serverPacket) {
					...
					var24 = var3.method7715();
					var13 = var3.method7875() * 4;
					byte var10 = var3.method7707();
					var15 = var3.method7713();
					int var17 = var3.readUnsignedByte();
					var33 = var3.method7742() * 4;
				...
				if (ServerPacket.field3118 == var1.serverPacket) {
					class143.method3072();
					var20 = var3.method7742();
					var5 = var3.method7773();
					var6 = var3.method7837();
				...
				Widget.RunException_sendStackTrace("" + (var1.serverPacket != null ? var1.serverPacket.id : -1) + "," + (var1.field1325 != null ? var1.field1325.id : -1) + "," + (var1.field1313 != null ? var1.field1313.id : -1) + "," + var1.serverPacketLength, (Throwable)null);
				ItemLayer.logOut();
			} catch (IOException var48) {
				ClanChannelMember.method2868();
			} catch (Exception var49) {
				var21 = "" + (var1.serverPacket != null ? var1.serverPacket.id : -1) + "," + (var1.field1325 != null ? var1.field1325.id : -1) + "," + (var1.field1313 != null ? var1.field1313.id : -1) + "," + var1.serverPacketLength + "," + (GrandExchangeEvents.localPlayer.pathX[0] + GrandExchangeOfferOwnWorldComparator.baseX * 64) + "," + (GrandExchangeEvents.localPlayer.pathY[0] + VarcInt.baseY * 64) + ",";
	...
	final void method1164() {
		...
		if (field687 && field696) {
			...
			if (class124.widgetDragDuration > clickedWidget.dragThreshold && (var3 > var5 || var3 < -var5 || var4 > var5 || var4 < -var5)) {
			...
			if (MouseHandler.MouseHandler_currentButton == 0) {
				if (isDraggingWidget) {
					...
					if (draggedOnWidget != null) {
						...
						if (var13 != null) {
							PacketBufferNode var12 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2919, packetWriter.isaacCipher);
							var12.packetBuffer.method7723(clickedWidget.id);
							var12.packetBuffer.writeShort(clickedWidget.childIndex);
							var12.packetBuffer.method7711(clickedWidget.itemId);
							var12.packetBuffer.writeShort(draggedOnWidget.childIndex);
							var12.packetBuffer.method7712(draggedOnWidget.itemId);
							var12.packetBuffer.method7723(draggedOnWidget.id);
