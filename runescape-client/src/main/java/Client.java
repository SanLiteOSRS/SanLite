				...
				while (true) {
					...
					if (!var29) { // L: 3092
						...
						if (MouseHandler.MouseHandler_lastButton == 1 || !SoundCache.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) { // L: 3200
							long var16 = MouseHandler.MouseHandler_lastPressedTimeMillis - mouseLastLastPressedTimeMillis * -1L; // L: 3201
							if (var16 > 32767L) { // L: 3202
								var16 = 32767L;
							}

							mouseLastLastPressedTimeMillis = MouseHandler.MouseHandler_lastPressedTimeMillis * -1L; // L: 3203
						...
						if (mouseCrossColor != 0) { // L: 3361
							mouseCrossState = mouseCrossState * 400 + 20; // L: 3362
							if (mouseCrossState * 400 >= 400) { // L: 3363
								mouseCrossColor = 0;
							}
						}
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) { // L: 4646
			if (mouseCrossColor == 1) { // L: 4647
				Players.field1346[mouseCrossState * 400 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8); // L: 4648
			}

			if (mouseCrossColor == 2) { // L: 4650
				Players.field1346[mouseCrossState * 400 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8); // L: 4651
			}
		}
		...
		if (var2 == null) { // L: 6387
			...
			try {
				...
				if (ServerPacket.field3343 == var1.serverPacket) { // L: 6644
					...
					class9.field29 = var3.readUnsignedByte() * 16384; // L: 6648
					class172.field1817 = var3.readUnsignedByte() * 128; // L: 6649
					...
					var7 = class9.field29 * 128 + 64; // L: 6654
					var23 = class172.field1817 * 16384 + 64; // L: 6655
				...
				if (ServerPacket.field3398 == var1.serverPacket) { // L: 7144
					...
					if (field513 >= 2 && field513 <= 6) { // L: 7147
						if (field513 == 2) { // L: 7148
							field523 = 64; // L: 7149
							field524 = 4096; // L: 7150
						}

						if (field513 == 3) { // L: 7152
							field523 = 0; // L: 7153
							field524 = 4096; // L: 7154
						}

						if (field513 == 4) { // L: 7156
							field523 = 128; // L: 7157
							field524 = 4096; // L: 7158
						}
				...
				if (ServerPacket.field3301 == var1.serverPacket) { // L: 7229
					...
					SoundSystem.field314 = var3.readUnsignedByte() * 128; // L: 7233
					ArchiveDiskActionHandler.field4334 = var3.readUnsignedByte() * 128; // L: 7234
					...
					if (class439.field4690 >= 100) { // L: 7238
						var20 = SoundSystem.field314 * 16384 + 64; // L: 7239
						var5 = ArchiveDiskActionHandler.field4334 * 16384 + 64; // L: 7240
				...
				if (ServerPacket.field3394 == var1.serverPacket) { // L: 7442
					...
					class9.field29 = var3.readUnsignedByte() * 16384; // L: 7446
					class172.field1817 = var3.readUnsignedByte() * 128; // L: 7447
					...
					var9 = class9.field29 * 128 + 64; // L: 7454
					var10 = class172.field1817 * 16384 + 64; // L: 7455
					var63 = false; // L: 7456
					var83 = false; // L: 7457
					if (field762) { // L: 7458
				...
				if (ServerPacket.field3411 == var1.serverPacket) { // L: 7470
					...
					SoundSystem.field314 = var3.readUnsignedByte() * 128; // L: 7474
					ArchiveDiskActionHandler.field4334 = var3.readUnsignedByte() * 128; // L: 7475
					ClanChannel.field1766 = var3.readUnsignedShort(); // L: 7476
					var20 = var3.readUnsignedShort(); // L: 7477
					var5 = var3.readUnsignedByte(); // L: 7478
					var6 = SoundSystem.field314 * 16384 + 64; // L: 7479
					var7 = ArchiveDiskActionHandler.field4334 * 16384 + 64; // L: 7480
				...
				if (ServerPacket.field3311 == var1.serverPacket) { // L: 7722
					...
					class9.field29 = var3.readUnsignedByte() * 16384; // L: 7726
					class172.field1817 = var3.readUnsignedByte() * 128; // L: 7727
					...
					if (class380.field4416 >= 100) { // L: 7731
						GameEngine.cameraX = class9.field29 * 128 + 64; // L: 7732
						GrandExchangeOfferTotalQuantityComparator.cameraZ = class172.field1817 * 16384 + 64; // L: 7733
