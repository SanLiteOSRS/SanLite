...
public final class Client extends GameEngine implements Usernamed, OAuthApi {
	...
	static {
		...
		Widget_cachedModels = new EvictingDualNodeHashTable(64); // L: 680
		Widget_cachedFonts = new EvictingDualNodeHashTable(64); // L: 681
		field618 = -1; // L: 684
		field782 = -1; // L: 690
	...
	protected final void setUp() {
		...
		DecorativeObject.setWindowedMode(Player.clientPreferences.method2411()); // L: 969
	...
	protected final void draw(boolean var1) {
		...
		if ((gameState == 10 || gameState == 20 || gameState == 30) && 0L != field678 && Language.method6232() > field678) { // L: 1091 1092
			DecorativeObject.setWindowedMode(SceneTilePaint.getWindowedMode()); // L: 1093
		}
	...
	boolean isOtlTokenRequesterInitialized() {
		return this.otlTokenRequester != null; // L: 902
	}
	...
	void requestOtlToken(String var1) throws IOException {
		...
		if (var6 != null) { // L: 917
			this.otlTokenRequest = var6.request(var5.method75(), var3, var4, ""); // L: 918
		} else {
	...
	void method1193(String var1) throws MalformedURLException, IOException {
		...
		OtlTokenRequester var5 = this.otlTokenRequester; // L: 936
		if (var5 != null) { // L: 937
	...
	final void doCycleLoggedOut() {
		...
		try {
			if (loginState == 0) { // L: 1909
				...
				if (class29.secureRandom != null) { // L: 1915
					...
					if (field639.method8184()) { // L: 1923
						try {
							this.requestOtlToken(WorldMapManager.field2773); // L: 1925
			...
			if (loginState == 21) { // L: 1939
				if (this.otlTokenRequest != null) { // L: 1940
					if (!this.otlTokenRequest.isDone()) { // L: 1941
						return; // L: 1942
					}

					if (this.otlTokenRequest.isCancelled()) { // L: 1944
						class12.getLoginError(65); // L: 1945
						this.otlTokenRequest = null; // L: 1946
						return; // L: 1947
					}

					try {
						OtlTokenResponse var3 = (OtlTokenResponse)this.otlTokenRequest.get(); // L: 1950
						if (!var3.isSuccess()) { // L: 1951
							class12.getLoginError(65); // L: 1952
							this.otlTokenRequest = null; // L: 1953
							return; // L: 1954
						}

						AccessFile.field4662 = var3.getAccessToken(); // L: 1956
						WorldMapManager.field2773 = var3.getRefreshToken(); // L: 1957
						this.otlTokenRequest = null; // L: 1958
					} catch (Exception var28) { // L: 1960
						Clock.RunException_sendStackTrace((String)null, var28); // L: 1961
						class12.getLoginError(65); // L: 1962
						this.otlTokenRequest = null; // L: 1963
						return; // L: 1964
					}
				} else {
			...
			if (loginState == 20) { // L: 2003
				if (this.field515 != null) { // L: 2004
					...
					try {
						com.jagex.oldscape.pub.OtlTokenResponse var33 = (com.jagex.oldscape.pub.OtlTokenResponse)this.field515.get(); // L: 2014
			...
			if (loginState == 5) { // L: 2121
				...
				var44.packetBuffer.method7916(HealthBar.archive17.hash); // L: 2254
				var44.packetBuffer.method7972(UserComparator10.archive4.hash); // L: 2255
				var44.packetBuffer.method7971(NameableContainer.archive13.hash); // L: 2256
				var44.packetBuffer.writeInt(class283.field3325.hash); // L: 2257
				var44.packetBuffer.method7971(0); // L: 2258
				var44.packetBuffer.method7971(UserComparator10.archive19.hash); // L: 2259
				...
				var44.packetBuffer.method7971(class119.archive2.hash); // L: 2262
				var44.packetBuffer.method7972(ChatChannel.archive8.hash); // L: 2263
				var44.packetBuffer.method7916(class301.archive7.hash); // L: 2264
				var44.packetBuffer.method7916(Huffman.archive20.hash); // L: 2265
				...
				var44.packetBuffer.method7972(class14.archive6.hash); // L: 2268
				var44.packetBuffer.writeInt(class14.archive14.hash); // L: 2269
				var44.packetBuffer.method7971(class434.archive9.hash); // L: 2270
				var44.packetBuffer.writeInt(FaceNormal.archive11.hash); // L: 2271
				var44.packetBuffer.method7971(class19.archive15.hash); // L: 2272
				var44.packetBuffer.method7916(class102.archive12.hash); // L: 2273
				var44.packetBuffer.method7972(class67.archive18.hash); // L: 2274
			...
			if (loginState == 7 && ((AbstractSocket)var1).available() >= 2) { // L: 2322 2323
				...
				class455.field4809 = var2.readUnsignedShort(); // L: 2326
				class142.method3196(8); // L: 2327
			}

			if (loginState == 8 && ((AbstractSocket)var1).available() >= class455.field4809) { // L: 2330 2331
				var2.offset = 0; // L: 2332
				((AbstractSocket)var1).read(var2.array, var2.offset, class455.field4809); // L: 2333
			...
			if (loginState == 9 && this.field721.method51()) { // L: 2346 2347
				...
				var36.packetBuffer.method8116(this.field542); // L: 2367
			...
			if (loginState == 13) { // L: 2393
				...
				if (loginState == 15 && ((AbstractSocket)var1).available() >= class9.field31) { // L: 2405 2406
					...
					this.accountHash = var2.readLong(); // L: 2441
		...
		if (hadNetworkError) { // L: 2916
			...
			if (gameState == 30) { // L: 2925
				...
				while (class153.method3318()) { // L: 2926
					...
					var14.packetBuffer.method7920(var14.packetBuffer.offset - var2); // L: 2931
					packetWriter.addNode(var14); // L: 2932
				}

				if (timer.field4265) { // L: 2934
					var14 = class120.getPacketBufferNode(ClientPacket.field3021, packetWriter.isaacCipher); // L: 2936
					var14.packetBuffer.writeByte(0); // L: 2937
					var2 = var14.packetBuffer.offset; // L: 2938
					timer.write(var14.packetBuffer); // L: 2939
					var14.packetBuffer.method7920(var14.packetBuffer.offset - var2); // L: 2940
				...
				synchronized(class268.mouseRecorder.lock) { // L: 2945
					if (!field587) { // L: 2946
						...
						if (var15 != null) { // L: 3014
							var15.packetBuffer.method7920(var15.packetBuffer.offset - var3); // L: 3015
				...
				if (MouseHandler.MouseHandler_lastButton == 1 || !Renderable.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) { // L: 3034
					...
					var18 = class120.getPacketBufferNode(ClientPacket.field3039, packetWriter.isaacCipher); // L: 3045
				...
				if (KeyHandler.field141 > 0) { // L: 3051
					...
					for (var5 = 0; var5 < KeyHandler.field141; ++var5) { // L: 3056
						...
						var14.packetBuffer.method7983((int)var21); // L: 3060
						var14.packetBuffer.method8136(KeyHandler.field140[var5]); // L: 3061
					}
				...
				if (field543 && field630 <= 0) { // L: 3068
					...
					var14.packetBuffer.writeIntME(camAngleY); // L: 3074
				...
				if (gameState == 30) { // L: 3101
					...
					if (packetWriter.field1349 > 750) { // L: 3128
						...
						if (mouseCrossColor != 0) { // L: 3153
							mouseCrossState = mouseCrossState * 400 + 400; // L: 3154
							if (mouseCrossState * 20 >= 400) { // L: 3155
								mouseCrossColor = 0;
							}
						}
						...
						if (Decimator.method1091() && KeyHandler.KeyHandler_pressedKeys[82] && KeyHandler.KeyHandler_pressedKeys[81] && mouseWheelRotation != 0) { // L: 3185
							...
							if (var3 != class67.localPlayer.plane) { // L: 3189
								...
								var18 = class120.getPacketBufferNode(ClientPacket.field3008, packetWriter.isaacCipher); // L: 3194
								var18.packetBuffer.method7952(var3); // L: 3195
								var18.packetBuffer.writeShort(var5); // L: 3196
								var18.packetBuffer.method7971(0); // L: 3197
								var18.packetBuffer.method7961(var4); // L: 3198
												...
												while (true) {
													do {
														...
														if (var36 == null) { // L: 3232
															...
															if (Nameable.dragInventoryWidget != null) { // L: 3245
																class403.invalidateWidget(Nameable.dragInventoryWidget); // L: 3246
																++itemDragDuration; // L: 3247
																if (MouseHandler.MouseHandler_currentButton == 0) { // L: 3248
																	if (field763) { // L: 3249
																		if (Nameable.dragInventoryWidget == SceneTilePaint.hoveredItemContainer && dragItemSlotSource != dragItemSlotDestination) { // L: 3250
																			Widget var38 = Nameable.dragInventoryWidget; // L: 3251
																			byte var29 = 0; // L: 3252
																			...
																			PacketBufferNode var26 = class120.getPacketBufferNode(ClientPacket.field2947, packetWriter.isaacCipher); // L: 3286
																			var26.packetBuffer.method8004(var29); // L: 3287
																			var26.packetBuffer.writeIntME(dragItemSlotSource); // L: 3288
																			var26.packetBuffer.method7916(Nameable.dragInventoryWidget.id); // L: 3289
																			var26.packetBuffer.method7961(dragItemSlotDestination); // L: 3290
																	...
																	Nameable.dragInventoryWidget = null; // L: 3304
															...
															if (Scene.shouldSendWalk()) { // L: 3314
																...
																PacketBufferNode var39 = class120.getPacketBufferNode(ClientPacket.field3033, packetWriter.isaacCipher); // L: 3318
																var39.packetBuffer.writeByte(5); // L: 3319
																var39.packetBuffer.method7962(class128.baseX * 64 + var3); // L: 3320
																var39.packetBuffer.writeShort(WorldMapData_1.baseY * 64 + var4); // L: 3321
																var39.packetBuffer.method7952(KeyHandler.KeyHandler_pressedKeys[82] ? (KeyHandler.KeyHandler_pressedKeys[81] ? 2 : 1) : 0); // L: 3322
															...
															if (var3 > 15000 && var5 > 15000) { // L: 3376
																...
																var18 = class120.getPacketBufferNode(ClientPacket.field2957, packetWriter.isaacCipher); // L: 3380
															...
															if (packetWriter.pendingWrites > 50) { // L: 3385
																var18 = class120.getPacketBufferNode(ClientPacket.field2986, packetWriter.isaacCipher); // L: 3387
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) { // L: 4316
			if (mouseCrossColor == 1) { // L: 4317
				SpotAnimationDefinition.crossSprites[mouseCrossState * 20 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8); // L: 4318
			}

			if (mouseCrossColor == 2) { // L: 4320
				SpotAnimationDefinition.crossSprites[mouseCrossState * 20 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8); // L: 4321
			}
		}
	...
	boolean method1206(PacketWriter var1, int var2) {
		if (var1.serverPacketLength == 0) { // L: 5920
			class145.friendsChatManager = null; // L: 5921
		} else {
			if (class145.friendsChatManager == null) { // L: 5924
				class145.friendsChatManager = new FriendsChatManager(Players.loginType, IgnoreList.client); // L: 5925
			}

			class145.friendsChatManager.method6823(var1.packetBuffer, var2); // L: 5927
		}
	...
	boolean method1207(PacketWriter var1) {
		if (class145.friendsChatManager != null) { // L: 5935
			class145.friendsChatManager.method6806(var1.packetBuffer); // L: 5936
		}
	...
	final boolean method1447(PacketWriter var1) {
		...
		if (var2 == null) { // L: 5947
			...
			try {
				...
				int var10;
				int var20;
				if (ServerPacket.field3170 == var1.serverPacket) { // L: 5988
					...
					for (var8 = 0; var8 < var7; ++var8) { // L: 6003
						var9 = var3.method7955(); // L: 6004
						if (var9 == 255) { // L: 6005
							var9 = var3.method7973();
						}

						var10 = var3.method7964(); // L: 6006
				...
				if (ServerPacket.field3174 == var1.serverPacket) { // L: 6026
				...
				if (ServerPacket.field3136 == var1.serverPacket) { // L: 6039
				...
				if (ServerPacket.field3119 == var1.serverPacket) { // L: 6045
					var20 = var3.method7964(); // L: 6046
					var5 = var3.method8135(); // L: 6047
				...
				if (ServerPacket.field3166 == var1.serverPacket) { // L: 6057
					byte var66 = var3.method7970(); // L: 6073
					int var18 = var3.method7955(); // L: 6074
					var12 = var3.method7965(); // L: 6075
					var11 = var3.readShort(); // L: 6076
					var21 = var3.method8101(); // L: 6077
					...
					var15 = var3.method7964(); // L: 6083
					var13 = var3.method8023() * 4; // L: 6084
					var14 = var3.readUnsignedByte() * 4; // L: 6085
					int var17 = var3.method7955(); // L: 6086
					var16 = var3.method7965(); // L: 6087
				...
				String var50;
				if (ServerPacket.field3130 == var1.serverPacket) { // L: 6102
				...
				if (ServerPacket.field3132 == var1.serverPacket) { // L: 6109
					...
					PlayerType var80 = (PlayerType)Varps.findEnumerated(class437.PlayerType_values(), var3.readUnsignedByte()); // L: 6114
					var30 = var27 + (var25 << 32); // L: 6115
					boolean var69 = false; // L: 6116

					for (var15 = 0; var15 < 100; ++var15) { // L: 6117
						if (var30 == field785[var15]) { // L: 6118
							var69 = true; // L: 6119
							break; // L: 6120
						}
					}
					...
					if (!var69 && field617 == 0) { // L: 6126
						field785[field729] = var30; // L: 6127
						field729 = (field729 + 1) % 100; // L: 6128
				...
				Widget var33;
				if (ServerPacket.field3107 == var1.serverPacket) { // L: 6142
					var20 = var3.method7964(); // L: 6143
					var5 = var3.method7974(); // L: 6144
					var21 = var3.method7964(); // L: 6145
					var7 = var3.method8143(); // L: 6146
				...
				String var64;
				if (ServerPacket.field3149 == var1.serverPacket) { // L: 6162
				...
				if (ServerPacket.field3163 == var1.serverPacket) { // L: 6171
					tradeChatMode = var3.method8023(); // L: 6172
					publicChatMode = var3.method8023(); // L: 6173
					var1.serverPacket = null; // L: 6174
					return true; // L: 6175
				}

				if (ServerPacket.field3150 == var1.serverPacket) { // L: 6177
				...
				if (ServerPacket.field3087 == var1.serverPacket) { // L: 6225
					class392.field4456 = var3.method7954(); // L: 6226
					ItemComposition.field2163 = var3.method7955(); // L: 6227
				...
				if (ServerPacket.field3131 == var1.serverPacket) { // L: 6242
					...
					PlayerType var84 = (PlayerType)Varps.findEnumerated(class437.PlayerType_values(), var3.readUnsignedByte()); // L: 6247
					...
					if (var89 == null) { // L: 6253
						...
						while (true) {
							...
							if (field785[var15] == var39) { // L: 6258
								var68 = true; // L: 6259
								break; // L: 6260
							}
					...
					if (!var68) { // L: 6267
						field785[field729] = var39; // L: 6268
						field729 = (field729 + 1) % 100; // L: 6269
				...
				if (ServerPacket.field3161 == var1.serverPacket) { // L: 6278
					ItemComposition.field2163 = var3.method7954(); // L: 6279
				...
				Widget var71;
				if (ServerPacket.field3110 == var1.serverPacket) { // L: 6289
					var20 = var3.method8135(); // L: 6290
				...
				if (ServerPacket.field3104 == var1.serverPacket) { // L: 6327
					class114.loadRegions(true, var1.packetBuffer); // L: 6328
					var1.serverPacket = null; // L: 6329
					return true; // L: 6330
				}

				if (ServerPacket.field3088 == var1.serverPacket) { // L: 6332
					var20 = var3.method8143(); // L: 6333
				...
				if (ServerPacket.field3112 == var1.serverPacket) { // L: 6339
					var20 = var3.method7965(); // L: 6340
					if (var20 == 65535) { // L: 6341
						var20 = -1;
					}

					var5 = var3.method8101(); // L: 6342
				...
				if (ServerPacket.field3165 == var1.serverPacket) { // L: 6352
				...
				if (ServerPacket.field3108 == var1.serverPacket) { // L: 6357
					...
					var5 = var3.method7973(); // L: 6360
					var21 = var3.method8135(); // L: 6361
					...
					if (!var91.isIf3) { // L: 6363
						...
						var81 = UserComparator3.ItemComposition_get(var20); // L: 6369
						...
						var81 = UserComparator3.ItemComposition_get(var20); // L: 6380
				...
				if (ServerPacket.field3158 == var1.serverPacket) { // L: 6408
				...
				if (ServerPacket.field3128 == var1.serverPacket) { // L: 6437
				...
				if (ServerPacket.field3091 == var1.serverPacket) { // L: 6443
					if (class29.field182 == null) { // L: 6444
						class29.field182 = new class393(class150.Ignored_cached);
					}

					class452 var55 = class150.Ignored_cached.method7271(var3); // L: 6445
				...
				if (ServerPacket.field3137 == var1.serverPacket) { // L: 6486
					var20 = var3.method7965(); // L: 6491
					Player var92;
				...
				if (ServerPacket.field3113 == var1.serverPacket) { // L: 6516
					...
					var5 = var3.method7965(); // L: 6519
					if (var5 == 65535) { // L: 6520
						var5 = -1;
					}

					var21 = var3.method7973(); // L: 6521
					var7 = var3.method7973(); // L: 6522
				...
				if (ServerPacket.field3116 == var1.serverPacket) { // L: 6555
					isCameraLocked = true; // L: 6556
					field544 = false; // L: 6557
					class119.field1479 = var3.readUnsignedByte() * 128; // L: 6558
					MusicPatchNode.field3301 = var3.readUnsignedByte() * 128; // L: 6559
					...
					if (class93.field1270 >= 100) { // L: 6563
						...
						var5 = MusicPatchNode.field3301 * 16384 + 64; // L: 6565
				...
				if (ServerPacket.field3160 == var1.serverPacket) { // L: 6593
				...
				if (ServerPacket.field3129 == var1.serverPacket) { // L: 6604
				...
				if (ServerPacket.field3124 == var1.serverPacket) { // L: 6623
					...
					class392.field4456 = var3.method7955(); // L: 6625
				...
				if (ServerPacket.field3177 == var1.serverPacket) { // L: 6642
					var20 = var3.readInt(); // L: 6643
					var5 = var3.method8143(); // L: 6644
				...
				if (ServerPacket.field3102 == var1.serverPacket) { // L: 6684
					var20 = var3.method7967(); // L: 6685
					var5 = var3.readInt(); // L: 6686
					var21 = var3.method7967(); // L: 6687
				...
				if (ServerPacket.field3096 == var1.serverPacket) { // L: 6701
				...
				if (ServerPacket.field3100 == var1.serverPacket) { // L: 6713
				...
				if (ServerPacket.field3109 == var1.serverPacket) { // L: 6778
					var20 = var3.method8135(); // L: 6779
					var5 = var3.method7964(); // L: 6780
				...
				if (ServerPacket.field3134 == var1.serverPacket) { // L: 6790
				...
				if (ServerPacket.field3159 == var1.serverPacket) { // L: 6795
				...
				String var46;
				if (ServerPacket.field3164 == var1.serverPacket) { // L: 6813
					...
					PlayerType var43 = (PlayerType)Varps.findEnumerated(class437.PlayerType_values(), var3.readUnsignedByte()); // L: 6817
					long var44 = (var23 << 32) + var25; // L: 6818
					boolean var65 = false; // L: 6819

					for (var13 = 0; var13 < 100; ++var13) { // L: 6820
						if (field785[var13] == var44) { // L: 6821
							var65 = true; // L: 6822
							break; // L: 6823
						}
					}
					...
					if (!var65 && field617 == 0) { // L: 6827
						field785[field729] = var44; // L: 6828
						field729 = (field729 + 1) % 100; // L: 6829
				...
				if (ServerPacket.field3079 == var1.serverPacket) { // L: 6840
				...
				if (ServerPacket.field3169 == var1.serverPacket) { // L: 6864
					var5 = var3.method7965(); // L: 6868
					var21 = var3.method8023(); // L: 6869
					var20 = var3.method7965(); // L: 6870
				...
				if (ServerPacket.field3152 == var1.serverPacket) { // L: 6912
					...
					if (var93 == null) { // L: 6919
						...
						for (var13 = 0; var13 < 100; ++var13) { // L: 6921
							if (var27 == field785[var13]) { // L: 6922
								var62 = true; // L: 6923
								break; // L: 6924
							}
						}
					...
					if (!var62) { // L: 6928
						field785[field729] = var27; // L: 6929
						field729 = (field729 + 1) % 100; // L: 6930
				...
				if (ServerPacket.field3162 == var1.serverPacket) { // L: 6953
				...
				if (ServerPacket.field3117 == var1.serverPacket) { // L: 6961
				...
				if (ServerPacket.field3085 == var1.serverPacket) { // L: 6975
					var20 = var3.method8143(); // L: 6976
					var5 = var3.method7973(); // L: 6977
					var21 = var3.method7955(); // L: 6978
				...
				if (ServerPacket.field3103 == var1.serverPacket) { // L: 6985
					...
					var20 = var3.method8135(); // L: 6987
					var5 = var3.method7955(); // L: 6988
					var21 = var3.method7955(); // L: 6989
				...
				if (ServerPacket.field3078 == var1.serverPacket) { // L: 6998
					isCameraLocked = true; // L: 6999
					field544 = false; // L: 7000
					SceneTilePaint.field2638 = var3.readUnsignedByte() * 128; // L: 7001
					...
					if (UserComparator6.field1398 >= 100) { // L: 7006
						TaskHandler.cameraX = SceneTilePaint.field2638 * 16384 + 64; // L: 7007
				...
				if (ServerPacket.field3095 == var1.serverPacket) { // L: 7037
				...
				if (ServerPacket.field3135 == var1.serverPacket) { // L: 7069
					var21 = var3.method7964(); // L: 7074
					var20 = var3.method7965(); // L: 7075
					var90 = npcs[var20]; // L: 7076
					var5 = var3.method7973(); // L: 7077
				...
				if (ServerPacket.field3142 == var1.serverPacket) { // L: 7094
					var20 = var3.method7964(); // L: 7095
				...
				if (ServerPacket.field3106 == var1.serverPacket) { // L: 7110
					var11 = var3.readUnsignedShort(); // L: 7119
					var9 = var3.method7964(); // L: 7120
					var21 = var3.method8101(); // L: 7121
					var20 = var21 >> 16; // L: 7122
					var5 = var21 >> 8 & 255; // L: 7123
					var7 = var20 + (var21 >> 4 & 7); // L: 7124
					var8 = var5 + (var21 & 7); // L: 7125
					var10 = var3.method8023(); // L: 7126
				...
				if (ServerPacket.field3086 == var1.serverPacket) { // L: 7136
					var20 = var3.method7973(); // L: 7137
					var5 = var3.method8143(); // L: 7138
				...
				if (ServerPacket.field3076 == var1.serverPacket) { // L: 7170
				...
				if (ServerPacket.field3171 == var1.serverPacket) { // L: 7175
					var21 = var3.method8101(); // L: 7186
					var20 = var21 >> 16; // L: 7187
					var5 = var21 >> 8 & 255; // L: 7188
					var7 = var20 + (var21 >> 4 & 7); // L: 7189
					var8 = var5 + (var21 & 7); // L: 7190
					var13 = var3.method8143(); // L: 7191
					var9 = var3.method8023(); // L: 7192
					var10 = var9 >> 2; // L: 7193
					var11 = var9 & 3; // L: 7194
					var12 = field564[var10]; // L: 7195
					if (var7 >= 0 && var8 >= 0 && var7 < 103 && var8 < 103) { // L: 7196
						if (var12 == 0) { // L: 7197
							WallObject var87 = MusicPatchNode.scene.method4281(Tiles.Client_plane, var7, var8); // L: 7198
							...
							DecorativeObject var86 = MusicPatchNode.scene.method4282(Tiles.Client_plane, var7, var8); // L: 7209
							...
							GroundObject var85 = MusicPatchNode.scene.getGroundObject(Tiles.Client_plane, var7, var8); // L: 7237
				...
				if (ServerPacket.field3122 == var1.serverPacket) { // L: 7246
					var20 = var3.method7964(); // L: 7247
					byte var54 = var3.method7975(); // L: 7248
				...
				if (ServerPacket.field3153 == var1.serverPacket) { // L: 7269
					class29.field182 = new class393(class150.Ignored_cached); // L: 7270
					var1.serverPacket = null; // L: 7271
					return true; // L: 7272
				}

				if (ServerPacket.field3071 == var1.serverPacket) { // L: 7274
					var20 = var3.method7973(); // L: 7275
					var5 = var3.method8135(); // L: 7276
				...
				if (ServerPacket.field3080 == var1.serverPacket) { // L: 7295
					var20 = var3.method7964(); // L: 7296
					var5 = var3.method8135(); // L: 7297
				...
				if (ServerPacket.field3157 == var1.serverPacket) { // L: 7310
				...
				if (ServerPacket.field3147 == var1.serverPacket) { // L: 7321
					...
					PacketBufferNode var42 = class120.getPacketBufferNode(ClientPacket.field3022, packetWriter.isaacCipher); // L: 7326
					...
					var42.packetBuffer.method8004(var21); // L: 7330
	...
	final void menu() {
		...
		while (!var1) { // L: 8188
			...
			for (var2 = 0; var2 < menuOptionsCount - 1; ++var2) { // L: 8190
				if (menuOpcodes[var2] < 1000 && menuOpcodes[var2 + 1] > 1000) { // L: 8191
					...
					var5 = field615[var2]; // L: 8210
					field615[var2] = field615[var2 + 1]; // L: 8211
					field615[var2 + 1] = var5; // L: 8212
		...
		if (Nameable.dragInventoryWidget == null) { // L: 8221
			if (clickedWidget == null) { // L: 8222
					...
					if (isMenuOpen) { // L: 8224
						...
						if (var20 == 1 || !Renderable.mouseCam && var20 == 4) { // L: 8233
							...
							if (var21 != -1 && var21 >= 0) { // L: 8244 8245
								...
								int var12 = field615[var21]; // L: 8250
								String var13 = menuActions[var21]; // L: 8251
								String var14 = menuTargets[var21]; // L: 8252
								class17.method273(var8, var17, var10, var11, var12, var13, var14, MouseHandler.MouseHandler_lastPressedX, MouseHandler.MouseHandler_lastPressedY); // L: 8253
							}
						...
						if ((var20 == 1 || !Renderable.mouseCam && var20 == 4) && menuOptionsCount > 0 && var2 >= 0) { // L: 8308 8310
							...
							var21 = field615[var2]; // L: 8315
							String var16 = menuActions[var2]; // L: 8316
							String var9 = menuTargets[var2]; // L: 8317
							class17.method273(var3, var4, var5, var22, var21, var16, var9, MouseHandler.MouseHandler_lastPressedX, MouseHandler.MouseHandler_lastPressedY); // L: 8318
						}
				...
				if (Nameable.dragInventoryWidget != null && !field763 && menuOptionsCount > 0 && !this.shouldLeftClickOpenMenu()) { // L: 8276 8277
					NPCComposition.method3663(draggedWidgetX, draggedWidgetY); // L: 8278
				}

				field763 = false; // L: 8281
				itemDragDuration = 0; // L: 8282
				if (Nameable.dragInventoryWidget != null) { // L: 8283
					class403.invalidateWidget(Nameable.dragInventoryWidget);
				}

				Nameable.dragInventoryWidget = SpotAnimationDefinition.getWidget(var5); // L: 8284
				...
				if (var2 >= 0) { // L: 8288
					...
					class146.tempMenuAction.field880 = field615[var2]; // L: 8294
					class146.tempMenuAction.field879 = menuActions[var2]; // L: 8295
					class146.tempMenuAction.action = menuTargets[var2]; // L: 8296
				}

				class403.invalidateWidget(Nameable.dragInventoryWidget); // L: 8298
			}
		}
	} // L: 8299
	...
	final boolean shouldLeftClickOpenMenu() {
		...
		return (field520 && menuOptionsCount > 2 || class1.method15(var1)) && !menuShiftClick[var1]; // L: 8327
	}
			...
			if (MouseHandler.MouseHandler_currentButton == 0) { // L: 11433
				if (isDraggingWidget) { // L: 11434
					...
					if (draggedOnWidget != null && HitSplatDefinition.method3782(clickedWidget) != null) { // L: 11444
						PacketBufferNode var9 = class120.getPacketBufferNode(ClientPacket.field2950, packetWriter.isaacCipher); // L: 11446
						var9.packetBuffer.writeIntME(clickedWidget.childIndex); // L: 11447
						var9.packetBuffer.method7961(draggedOnWidget.itemId); // L: 11448
						var9.packetBuffer.writeIntME(clickedWidget.itemId); // L: 11449
						var9.packetBuffer.method7971(draggedOnWidget.id); // L: 11450
						var9.packetBuffer.method7961(draggedOnWidget.childIndex); // L: 11451
						var9.packetBuffer.method7971(clickedWidget.id); // L: 11452
	...
	public void setOtlTokenRequester(OtlTokenRequester var1) {
		if (var1 != null) { // L: 870
			this.otlTokenRequester = var1; // L: 873
