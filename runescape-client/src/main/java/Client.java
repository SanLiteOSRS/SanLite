...
public final class Client extends GameEngine implements Usernamed, OAuthApi {
	...
	static {
		...
		field620 = new int[]{768, 1024, 1280, 512, 1536, 256, 0, 1792}; // L: 431
	...
	protected final void draw(boolean var1) {
		...
		if (var2 && field734 && SecureRandomCallable.pcmPlayer0 != null) { // L: 1061 1062
	...
	boolean isOtlTokenRequesterInitialized() {
		return this.otlTokenRequester != null; // L: 856
	}
	...
	void requestOtlToken(String var1) throws IOException {
		...
		if (var6 != null) { // L: 871
			this.otlTokenRequest = var6.request(var5.method67(), var3, var4, ""); // L: 872
		} else {
	...
	void method1229(String var1) throws MalformedURLException, IOException {
		...
		OtlTokenRequester var5 = this.otlTokenRequester; // L: 890
		if (var5 != null) { // L: 891
	...
	final void doCycleLoggedOut() {
		...
		try {
			if (loginState == 0) { // L: 2080
				...
				if (secureRandom != null) { // L: 2086
					...
					if (field517.method7790()) { // L: 2094
						try {
							this.requestOtlToken(ModelData0.field2661); // L: 2096
			...
			if (loginState == 21) { // L: 2110
				if (this.otlTokenRequest != null) { // L: 2111
					if (!this.otlTokenRequest.isDone()) { // L: 2112
						return; // L: 2113
					}

					if (this.otlTokenRequest.isCancelled()) { // L: 2115
						PcmPlayer.getLoginError(65); // L: 2116
						this.otlTokenRequest = null; // L: 2117
						return; // L: 2118
					}

					try {
						OtlTokenResponse var3 = (OtlTokenResponse)this.otlTokenRequest.get(); // L: 2121
						if (!var3.isSuccess()) { // L: 2122
							PcmPlayer.getLoginError(65); // L: 2123
							this.otlTokenRequest = null; // L: 2124
							return; // L: 2125
						}
						...
						this.otlTokenRequest = null; // L: 2134
						return; // L: 2135
					}
				} else {
			...
			if (loginState == 13) { // L: 2533
				...
				if (loginState == 15 && ((AbstractSocket)var1).available() >= Varcs.field1329) { // L: 2545 2546
					...
					this.accountHash = var2.readLong(); // L: 2581
				...
				if (loginState == 16) { // L: 2604
					if (((AbstractSocket)var1).available() >= packetWriter.serverPacketLength) { // L: 2605
						...
						var27 = DecorativeObject.getPacketBufferNode(ClientPacket.field3054, packetWriter.isaacCipher); // L: 2721
						...
						PcmPlayer.friendsChatManager = null; // L: 2727
					...
					if (loginState == 17 && ((AbstractSocket)var1).available() >= 2) { // L: 2742 2743
						...
						Nameable.field4323 = var2.readUnsignedShort(); // L: 2747
						Canvas.method347(18); // L: 2748
					}

					if (loginState == 18 && ((AbstractSocket)var1).available() >= Nameable.field4323) { // L: 2751 2752
						var2.offset = 0; // L: 2753
						((AbstractSocket)var1).read(var2.array, 0, Nameable.field4323); // L: 2754
				...
				while (true) {
					...
					if (!var30) { // L: 3095
						...
						if (timer.field4235) { // L: 3103
							var14 = DecorativeObject.getPacketBufferNode(ClientPacket.field3009, packetWriter.isaacCipher); // L: 3105
								...
								for (var7 = 0; var7 < Varcs.mouseRecorder.index && (var31 == null || var31.packetBuffer.offset - var3 < 246); ++var7) { // L: 3123 3124
									...
									if (var9 != field492 || var8 != field681) { // L: 3132
										if (var31 == null) { // L: 3135
											var31 = DecorativeObject.getPacketBufferNode(ClientPacket.field2952, packetWriter.isaacCipher); // L: 3136
						...
						if (MouseHandler.MouseHandler_lastButton == 1 || !Login.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) { // L: 3203
							long var16 = MouseHandler.MouseHandler_lastPressedTimeMillis - mouseLastLastPressedTimeMillis * -1L; // L: 3204
							if (var16 > 32767L) { // L: 3205
								var16 = 32767L;
							}

							mouseLastLastPressedTimeMillis = MouseHandler.MouseHandler_lastPressedTimeMillis * -1L; // L: 3206
							...
							var18 = DecorativeObject.getPacketBufferNode(ClientPacket.field3051, packetWriter.isaacCipher); // L: 3214
						...
						if (KeyHandler.field139 > 0) { // L: 3220
							var14 = DecorativeObject.getPacketBufferNode(ClientPacket.field2949, packetWriter.isaacCipher); // L: 3221
						...
						if (field557 && field576 <= 0) { // L: 3237
							...
							var14 = DecorativeObject.getPacketBufferNode(ClientPacket.field3035, packetWriter.isaacCipher); // L: 3241
						...
						if (WorldMapArea.hasFocus && !hadFocus) { // L: 3246
							...
							var14 = DecorativeObject.getPacketBufferNode(ClientPacket.field3038, packetWriter.isaacCipher); // L: 3249
						...
						if (!WorldMapArea.hasFocus && hadFocus) { // L: 3253
							...
							var14 = DecorativeObject.getPacketBufferNode(ClientPacket.field3038, packetWriter.isaacCipher); // L: 3256
						...
						if (field734 && !Coord.method5370()) { // L: 3326
						...
						if (mouseCrossColor != 0) { // L: 3374
							mouseCrossState = mouseCrossState * 400 + 20; // L: 3375
							if (mouseCrossState * 400 >= 400) { // L: 3376
								mouseCrossColor = 0;
							}
						}
						...
						if (var35 && KeyHandler.KeyHandler_pressedKeys[82] && KeyHandler.KeyHandler_pressedKeys[81] && mouseWheelRotation != 0) { // L: 3424
							...
							if (var4 != ModelData0.localPlayer.plane) { // L: 3428
								class123.method2781(ModelData0.localPlayer.pathX[0] + SecureRandomCallable.baseX * 64, ModelData0.localPlayer.pathY[0] + GrandExchangeOfferOwnWorldComparator.baseY * 64, var4, false); // L: 3429
							}
													...
													do {
														...
														if (var49 == null) { // L: 3461
															...
															if (ServerPacket.worldMap != null) { // L: 3473
																ServerPacket.worldMap.method7033(class128.Client_plane, SecureRandomCallable.baseX * 64 + (ModelData0.localPlayer.x >> 7), GrandExchangeOfferOwnWorldComparator.baseY * 64 + (ModelData0.localPlayer.y >> 7), false); // L: 3474
																...
																if (MouseHandler.MouseHandler_currentButton == 0) { // L: 3482
																	if (field604) { // L: 3483
																		if (Canvas.dragInventoryWidget == class155.hoveredItemContainer && dragItemSlotSource != dragItemSlotDestination) { // L: 3484
																			...
																			PacketBufferNode var26 = DecorativeObject.getPacketBufferNode(ClientPacket.field3042, packetWriter.isaacCipher); // L: 3520
															...
															if (Scene.shouldSendWalk()) { // L: 3558
																...
																var18 = DecorativeObject.getPacketBufferNode(ClientPacket.field2957, packetWriter.isaacCipher); // L: 3562
																...
																var18.packetBuffer.method7641(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var5); // L: 3565
																var18.packetBuffer.writeShort(SecureRandomCallable.baseX * 64 + var4); // L: 3566
															...
															if (oculusOrbState == 0) { // L: 3592
																...
																if (var38 >= 0 || var39 != 0) { // L: 3652
																	var6 = KeyHandler.KeyHandler_pressedKeys[81] ? oculusOrbSlowedSpeed : oculusOrbNormalSpeed; // L: 3653
																	var6 *= 16; // L: 3654
															...
															if (MouseHandler.MouseHandler_currentButton == 4 && Login.mouseCam) { // L: 3685
																...
																mouseCamClickedY = var4 != -1 && var4 != 1 ? (MouseHandler.MouseHandler_y + mouseCamClickedY) / 2 : MouseHandler.MouseHandler_y; // L: 3688
																var5 = mouseCamClickedX - MouseHandler.MouseHandler_x; // L: 3689
																camAngleDY = var5 * 2; // L: 3690
																mouseCamClickedX = var5 != -1 && var5 != 1 ? (mouseCamClickedX + MouseHandler.MouseHandler_x) / 2 : MouseHandler.MouseHandler_x; // L: 3691
															} else {
															...
															if (var4 > 15000 && var5 > 15000) { // L: 3732
																...
																var18 = DecorativeObject.getPacketBufferNode(ClientPacket.field3027, packetWriter.isaacCipher); // L: 3738
															...
															if (packetWriter.pendingWrites > 50) { // L: 3743
																var18 = DecorativeObject.getPacketBufferNode(ClientPacket.field2982, packetWriter.isaacCipher); // L: 3745
					...
					var31 = DecorativeObject.getPacketBufferNode(ClientPacket.field3047, packetWriter.isaacCipher); // L: 3096
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) { // L: 4420
			if (mouseCrossColor == 1) { // L: 4421
				Projectile.crossSprites[mouseCrossState * 400 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8); // L: 4422
			}

			if (mouseCrossColor == 2) { // L: 4424
				Projectile.crossSprites[mouseCrossState * 400 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8); // L: 4425
			}
		}
		...
		for (ObjectSound var19 = (ObjectSound)ObjectSound.objectSounds.last(); var19 != null; var19 = (ObjectSound)ObjectSound.objectSounds.previous()) { // L: 4505
			if (var19.soundEffectId != -1 || var19.soundEffectIds != null) { // L: 4506
				var6 = 0; // L: 4507
				if (var2 > var19.maxX * 128) { // L: 4508
					var6 += var2 - var19.maxX * 128;
				} else if (var2 < var19.x * 16384) {
					var6 += var19.x * 16384 - var2; // L: 4509
				}

				if (var3 > var19.maxY * 128) { // L: 4510
					var6 += var3 - var19.maxY * 128;
				} else if (var3 < var19.y * 16384) { // L: 4511
		...
		if (var2 == null) { // L: 6123
			...
			try {
				...
				if (ServerPacket.field3141 == var1.serverPacket) { // L: 6164
					UserComparator8.field1378 = new class392(class221.Ignored_cached); // L: 6165
				...
				if (ServerPacket.field3103 == var1.serverPacket) { // L: 6215
					...
					if (var66 == null) { // L: 6226
						...
						while (true) {
							...
							if (field717[var15] == var11) { // L: 6231
								var64 = true; // L: 6232
								break; // L: 6233
							}
					...
					if (!var64) { // L: 6240
						field717[field718] = var11; // L: 6241
						field718 = (field718 + 1) % 100; // L: 6242
				...
				if (ServerPacket.field3174 == var1.serverPacket) { // L: 6262
					...
					if (!var55.isIf3) { // L: 6268
						...
						var81 = FileSystem.ItemComposition_get(var67); // L: 6274
						...
						var81 = FileSystem.ItemComposition_get(var67); // L: 6285
				...
				if (ServerPacket.field3186 == var1.serverPacket) { // L: 6426
					...
					PacketBufferNode var58 = DecorativeObject.getPacketBufferNode(ClientPacket.field3053, packetWriter.isaacCipher); // L: 6431
				...
				if (ServerPacket.field3084 == var1.serverPacket) { // L: 6482
					if (PcmPlayer.friendsChatManager != null) { // L: 6483
						PcmPlayer.friendsChatManager.method6463(var3); // L: 6484
					}
				...
				if (ServerPacket.field3116 == var1.serverPacket) { // L: 6530
					...
					class447 var51 = class221.Ignored_cached.method6920(var3); // L: 6532
				...
				if (ServerPacket.field3086 == var1.serverPacket) { // L: 6610
					...
					for (var13 = 0; var13 < 100; ++var13) { // L: 6617
						if (var36 == field717[var13]) { // L: 6618
							var87 = true; // L: 6619
							break; // L: 6620
						}
					}
					...
					if (!var87 && field606 == 0) { // L: 6624
						field717[field718] = var36; // L: 6625
						field718 = (field718 + 1) % 100; // L: 6626
				...
				if (ServerPacket.field3119 == var1.serverPacket) { // L: 6650
					...
					class267.field3206 = var3.readUnsignedByte() * 128; // L: 6653
					AbstractWorldMapData.field2851 = var3.readUnsignedByte() * 16384; // L: 6654
					...
					if (PacketBufferNode.field3083 >= 100) { // L: 6658
						var67 = class267.field3206 * 16384 + 64; // L: 6659
				...
				if (ServerPacket.field3123 == var1.serverPacket) { // L: 6694
					...
					if (var54 != null) { // L: 6703
						...
						var54.field1151 = var5 >> 16; // L: 6705
				...
				if (ServerPacket.field3172 == var1.serverPacket) { // L: 6740
					...
					if (var56 != null) { // L: 6754
						...
						var56.field1151 = var6 >> 16; // L: 6756
				...
				if (ServerPacket.field3124 == var1.serverPacket) { // L: 7170
					...
					if (var27 >= 0 && var28 >= 0 && var27 < 103 && var28 < 103) { // L: 7191
						if (var38 == 0) { // L: 7192
							WallObject var65 = class175.scene.method4147(class128.Client_plane, var27, var28); // L: 7193
							...
							DecorativeObject var63 = class175.scene.method4049(class128.Client_plane, var27, var28); // L: 7204
							...
							GroundObject var62 = class175.scene.getGroundObject(class128.Client_plane, var27, var28); // L: 7232
				...
				if (ServerPacket.field3108 == var1.serverPacket) { // L: 7314
					...
					for (var15 = 0; var15 < 100; ++var15) { // L: 7322
						if (field717[var15] == var44) { // L: 7323
							var88 = true; // L: 7324
							break; // L: 7325
						}
					}
					...
					if (!var88 && field606 == 0) { // L: 7331
						field717[field718] = var44; // L: 7332
						field718 = (field718 + 1) % 100; // L: 7333
				...
				if (ServerPacket.field3185 == var1.serverPacket) { // L: 7357
					...
					if (var12 == null) { // L: 7364
						...
						for (var13 = 0; var13 < 100; ++var13) { // L: 7366
							if (field717[var13] == var41) { // L: 7367
								var30 = true; // L: 7368
								break; // L: 7369
							}
						}
					...
					if (!var30) { // L: 7373
						field717[field718] = var41; // L: 7374
						field718 = (field718 + 1) % 100; // L: 7375
				...
				if (ServerPacket.field3101 == var1.serverPacket) { // L: 7383
					if (var1.serverPacketLength == 0) { // L: 7384
						PcmPlayer.friendsChatManager = null; // L: 7385
					} else {
						if (PcmPlayer.friendsChatManager == null) { // L: 7388
							PcmPlayer.friendsChatManager = new FriendsChatManager(class391.loginType, class82.client); // L: 7389
						}

						PcmPlayer.friendsChatManager.readUpdate(var3); // L: 7391
					}
				...
				if (ServerPacket.field3129 == var1.serverPacket) { // L: 7445
					...
					Players.field1317 = var3.readUnsignedByte() * 128; // L: 7448
					TileItem.field1292 = var3.readUnsignedByte() * 128; // L: 7449
					...
					if (HitSplatDefinition.field2077 >= 100) { // L: 7453
						class343.cameraX = Players.field1317 * 16384 + 64; // L: 7454
						FaceNormal.cameraZ = TileItem.field1292 * 16384 + 64; // L: 7455
				...
				if (ServerPacket.field3160 == var1.serverPacket) { // L: 7461
					...
					if (hintArrowType >= 2 && hintArrowType <= 6) { // L: 7464
						if (hintArrowType == 2) { // L: 7465
							hintArrowSubX = 4096; // L: 7466
							hintArrowSubY = 4096; // L: 7467
						}

						if (hintArrowType == 3) { // L: 7469
							hintArrowSubX = 0; // L: 7470
							hintArrowSubY = 4096; // L: 7471
						}

						if (hintArrowType == 4) { // L: 7473
							hintArrowSubX = 8192; // L: 7474
							hintArrowSubY = 4096; // L: 7475
						}

						if (hintArrowType == 5) { // L: 7477
							hintArrowSubX = 4096; // L: 7478
							hintArrowSubY = 0; // L: 7479
						}

						if (hintArrowType == 6) { // L: 7481
							hintArrowSubX = 4096; // L: 7482
							hintArrowSubY = 8192; // L: 7483
						}

						hintArrowType = 2; // L: 7485
						hintArrowX = var3.readUnsignedShort(); // L: 7486
						hintArrowY = var3.readUnsignedShort(); // L: 7487
						hintArrowHeight = var3.readUnsignedByte() * 2; // L: 7488
					}
				...
				ArchiveDiskActionHandler.RunException_sendStackTrace("" + (var1.serverPacket != null ? var1.serverPacket.id : -1) + "," + (var1.field1340 != null ? var1.field1340.id : -1) + "," + (var1.field1345 != null ? var1.field1345.id : -1) + "," + var1.serverPacketLength, (Throwable)null); // L: 7530
				SecureRandomCallable.logOut(); // L: 7531
			} catch (IOException var46) { // L: 7533
				class129.method2812(); // L: 7534
			} catch (Exception var47) {
				var21 = "" + (var1.serverPacket != null ? var1.serverPacket.id : -1) + "," + (var1.field1340 != null ? var1.field1340.id : -1) + "," + (var1.field1345 != null ? var1.field1345.id : -1) + "," + var1.serverPacketLength + "," + (ModelData0.localPlayer.pathX[0] + SecureRandomCallable.baseX * 64) + "," + (ModelData0.localPlayer.pathY[0] + GrandExchangeOfferOwnWorldComparator.baseY * 64) + ","; // L: 7537
				...
				if (isDraggingWidget) { // L: 11841
					...
					if (draggedOnWidget != null) { // L: 11851
						...
						if (var18 != null) { // L: 11874
							PacketBufferNode var19 = DecorativeObject.getPacketBufferNode(ClientPacket.field3029, packetWriter.isaacCipher); // L: 11876
	...
	public void setOtlTokenRequester(OtlTokenRequester var1) {
		if (var1 != null) { // L: 824
			this.otlTokenRequester = var1; // L: 827
			class126.method2799(10); // L: 828
		}
	} // L: 825 829

	public long getAccountHash() {
		return this.accountHash; // L: 848
	}
			...
			if (!var0.healthBars.method5986()) { // L: 5052
				...
				for (HealthBar var78 = (HealthBar)var0.healthBars.last(); var78 != null; var78 = (HealthBar)var0.healthBars.previous()) { // L: 5057
					...
					if (var80 == null) { // L: 5059
						...
						SpritePixels var81 = var13.method3360(); // L: 5061
						SpritePixels var82 = var13.method3359(); // L: 5062
						int var17 = 0; // L: 5064
						int var83;
