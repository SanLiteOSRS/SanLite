...
public final class Client extends GameEngine implements Usernamed, OAuthTokens {
	...
	protected final void setUp() {
		...
		Nameable.field3948 = class260.field3030;
					...
					if (gameState == 20) {
						...
						for (var50 = 0; var50 < WorldMapData_0.regionLandArchives.length; ++var50) {
							if (class262.regionMapArchiveIds[var50] != -1 && WorldMapData_0.regionLandArchives[var50] == null) {
								WorldMapData_0.regionLandArchives[var50] = ObjectComposition.archive7.takeFile(class262.regionMapArchiveIds[var50], 0);
							...
							if (UserComparator6.regionLandArchiveIds[var50] != -1 && class16.regionMapArchives[var50] == null) {
								class16.regionMapArchives[var50] = ObjectComposition.archive7.takeFileEncrypted(UserComparator6.regionLandArchiveIds[var50], 0, class244.xteaKeys[var50]);
						...
						if (!var81) {
							...
							for (var50 = 0; var50 < WorldMapData_0.regionLandArchives.length; ++var50) {
								...
								if (var3 != null) {
									var52 = (class87.regions[var50] >> 8) * 64 - FloorOverlayDefinition.baseX * 64;
									var53 = (class87.regions[var50] & 255) * 64 - class320.baseY * 64;
									if (isInInstance) {
										var52 = 10;
										var53 = 10;
									}
									...
									while (true) {
										...
										if (var54 >= var50) {
											for (var54 = 0; var54 < var50; ++var54) {
												var52 = (class87.regions[var54] >> 8) * 64 - FloorOverlayDefinition.baseX * 64;
												var53 = (class87.regions[var54] & 255) * 64 - class320.baseY * 64;
											...
											while (true) {
												...
												if (var4 != null) {
													var53 = (class87.regions[var54] >> 8) * 64 - FloorOverlayDefinition.baseX * 64;
													var56 = (class87.regions[var54] & 255) * 64 - class320.baseY * 64;
													class1.playPcmPlayers();
									...
									for (var10 = var56 - 1; var10 <= var7 + 1; ++var10) {
										for (var11 = var8 - 1; var11 <= var57 + 1; ++var11) {
											if (var10 < var56 || var10 > var7 || var11 < var8 || var11 > var57) {
												ObjectComposition.archive7.loadRegionFromName("m" + var10 + "_" + var11);
												ObjectComposition.archive7.loadRegionFromName("l" + var10 + "_" + var11);
											}
										}
									}
								}
	...
	protected final void kill0() {
		...
		if (FriendsChatManager.pcmPlayer1 != null) {
			FriendsChatManager.pcmPlayer1.shutdown();
		}
	...
	public final void init() {
		try {
			if (this.checkHost()) {
				...
				RunException.clientType = field523;
				if (field487 == -1) {
					field487 = 0;
				}
	...
	final void doCycleLoggedOut() {
		...
		try {
			...
			if (field635 == 3) {
				...
				if (FriendsChatManager.pcmPlayer1 != null) {
					FriendsChatManager.pcmPlayer1.method710();
				}
			...
			if (field635 == 5) {
				...
				var5.packetBuffer.writeByte(field523);
				...
				var5.packetBuffer.writeIntME(class81.archive10.hash);
				var5.packetBuffer.method6860(WorldMapRectangle.archive3.hash);
				var5.packetBuffer.method6860(class260.archive5.hash);
				var5.packetBuffer.writeIntME(ReflectionCheck.field444.hash);
				...
				while (true) {
					...
					if (!var31) {
						...
						synchronized(class184.mouseRecorder.lock) {
							if (!field659) {
								...
								if (var4 >= class184.mouseRecorder.index) {
									...
									class81 var46 = class184.mouseRecorder;
									var46.index -= var4;
						...
						if (PlatformInfo.field4073) {
							if (class78.friendsChatManager != null) {
								class78.friendsChatManager.sort();
							}
						...
						for (var1 = 0; var1 < soundEffectCount; ++var1) {
							...
							if (queuedSoundEffectDelays[var1] >= -10) {
								...
								if (var34 == null) {
									var10000 = null;
									var34 = SoundEffect.readSoundEffect(ReflectionCheck.field444, soundEffectIds[var1], 0);
									if (var34 == null) {
										continue;
									}
						...
						if (FriendsChatManager.field3934 != null) {
							++field727;
							if (field727 >= 15) {
								Actor.invalidateWidget(FriendsChatManager.field3934);
								FriendsChatManager.field3934 = null;
							}
						}
						...
						if (Player.method2094() && KeyHandler.KeyHandler_pressedKeys[82] && KeyHandler.KeyHandler_pressedKeys[81] && mouseWheelRotation != 0) {
							...
							if (var3 != class129.localPlayer.plane) {
								var4 = class129.localPlayer.pathX[0] + FloorOverlayDefinition.baseX * 64;
								var5 = class129.localPlayer.pathY[0] + class320.baseY * 64;
												...
												while (true) {
													do {
														...
														if (var43 == null) {
															this.menu();
															if (class65.worldMap != null) {
																class65.worldMap.method6361(class391.Client_plane, FloorOverlayDefinition.baseX * 64 + (class129.localPlayer.x >> 7), class320.baseY * 64 + (class129.localPlayer.y >> 7), false);
															...
															if (Scene.shouldSendWalk()) {
																...
																var44.packetBuffer.method6951(FloorOverlayDefinition.baseX * 64 + var3);
																var44.packetBuffer.method6852(class320.baseY * 64 + var4);
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) {
			if (mouseCrossColor == 1) {
				class13.crossSprites[mouseCrossState * 400 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}

			if (mouseCrossColor == 2) {
				class13.crossSprites[mouseCrossState * 400 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}
		}
		...
		for (ObjectSound var14 = (ObjectSound)ObjectSound.objectSounds.last(); var14 != null; var14 = (ObjectSound)ObjectSound.objectSounds.previous()) {
			if (var14.soundEffectId != -1 || var14.soundEffectIds != null) {
				int var6 = 0;
				if (var2 > var14.field806 * 16384) {
					var6 += var2 - var14.field806 * 16384;
				} else if (var2 < var14.x * 16384) {
					var6 += var14.x * 16384 - var2;
				}

				if (var3 > var14.field801 * 16384) {
					var6 += var3 - var14.field801 * 16384;
			...
			try {
				...
				if (ServerPacket.field2794 == var1.serverPacket) {
					...
					if (hintArrowType >= 2 && hintArrowType <= 6) {
						...
						field737 = var3.readUnsignedByte() * 2;
					}
				...
				if (ServerPacket.field2819 == var1.serverPacket) {
					isCameraLocked = true;
					class114.field1376 = var3.readUnsignedByte() * 16384;
					class229.field2624 = var3.readUnsignedByte() * 128;
					...
					if (Projectile.field923 >= 100) {
						...
						var5 = class229.field2624 * 16384 + 64;
				...
				if (ServerPacket.field2815 == var1.serverPacket) {
					isCameraLocked = true;
					class114.field1372 = var3.readUnsignedByte() * 16384;
					ScriptFrame.field447 = var3.readUnsignedByte() * 128;
					...
					if (class112.field1361 >= 100) {
						...
						DevicePcmPlayerProvider.cameraZ = ScriptFrame.field447 * 16384 + 64;
				...
				if (ServerPacket.field2816 == var1.serverPacket) {
					if (var1.serverPacketLength == 0) {
						class78.friendsChatManager = null;
					} else {
						if (class78.friendsChatManager == null) {
							class78.friendsChatManager = new FriendsChatManager(SoundCache.loginType, ArchiveDiskActionHandler.client);
						}

						class78.friendsChatManager.readUpdate(var3);
					}
				...
				if (ServerPacket.field2826 == var1.serverPacket) {
					if (class78.friendsChatManager != null) {
						class78.friendsChatManager.method5877(var3);
					}
				...
				class4.RunException_sendStackTrace("" + (var1.serverPacket != null ? var1.serverPacket.id : -1) + "," + (var1.field1289 != null ? var1.field1289.id : -1) + "," + (var1.field1290 != null ? var1.field1290.id : -1) + "," + var1.serverPacketLength, (Throwable)null);
				class16.logOut();
			} catch (IOException var44) {
				class245.method4590();
			} catch (Exception var45) {
				var20 = "" + (var1.serverPacket != null ? var1.serverPacket.id : -1) + "," + (var1.field1289 != null ? var1.field1289.id : -1) + "," + (var1.field1290 != null ? var1.field1290.id : -1) + "," + var1.serverPacketLength + "," + (class129.localPlayer.pathX[0] + FloorOverlayDefinition.baseX * 64) + "," + (class129.localPlayer.pathY[0] + class320.baseY * 64) + ",";
		...
		if (class16.field82 != null) {
			...
			for (int var0 = 0; var0 < players.length; ++var0) {
				if (players[var0] != null) {
					class16.field82.method5364(FloorOverlayDefinition.baseX * 64 + (players[var0].x >> 7), class320.baseY * 64 + (players[var0].y >> 7));
				}
			}
		}
