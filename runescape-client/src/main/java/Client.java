...
public final class Client extends GameEngine implements Usernamed, OAuthApi {
	...
	protected final void resizeGame() {
		field764 = DirectByteArrayCopier.method5318() + 500L;
		this.resizeJS();
		if (rootInterface != -1) {
	...
	protected final void draw(boolean var1) {
		...
		if ((gameState == 10 || gameState == 20 || gameState == 30) && 0L != field764 && DirectByteArrayCopier.method5318() > field764) {
	...
	void doCycleJs5() {
		if (gameState != 1000) {
			long var2 = DirectByteArrayCopier.method5318();
								...
								if (var8 == NetCache.NetCache_responseArchiveBuffer.offset) {
									if (class19.NetCache_currentResponse.key == 16711935L) {
										...
										if (var10 != class19.NetCache_currentResponse.crc) {
											...
											NetCache.field3929 = (byte)((int)(Math.random() * 255.0D + 1.0D));
											var1 = false;
											break label241;
										}
			...
			if (--field526 + 1 <= 0) {
				try {
					...
					if (js5ConnectState == 2) {
						...
						++js5ConnectState;
						UserComparator8.field1347 = DirectByteArrayCopier.method5318();
					}
					...
					if (js5ConnectState == 3) {
						if (WorldMapCacheName.js5Socket.available() > 0 || !useBufferedSocket && gameState <= 5) {
							...
							++js5ConnectState;
						} else if (DirectByteArrayCopier.method5318() - UserComparator8.field1347 > 30000L) {
							this.js5Error(-2);
							return;
						}
					}
							...
							if (var3 == null) {
								while (true) {
									...
									if (var3 == null) {
										...
										NetCache.NetCache_loadTime = 0;
										NetCache.field3911 = DirectByteArrayCopier.method5318();
	...
	final void doCycleLoggedOut() {
		...
		try {
				...
				if (class142.secureRandom != null) {
					...
					if (field534.method7628()) {
						try {
							...
							GroundObject.RunException_sendStackTrace((String)null, var25);
			...
			if (loginState == 20) {
				if (this.field539 != null) {
					...
					try {
						...
						GroundObject.RunException_sendStackTrace((String)null, var24);
						class221.getLoginError(65);
						this.field539 = null;
						return;
					}
					...
					if (this.field537.method273()) {
						GroundObject.RunException_sendStackTrace(this.field537.method272(), (Throwable)null);
						class221.getLoginError(65);
						this.field537 = null;
						return;
					}
					...
					if (var27.method294() != 200) {
						GroundObject.RunException_sendStackTrace("Response code: " + var27.method294() + "Response body: " + var27.method295(), (Throwable)null);
						class221.getLoginError(65);
						this.field537 = null;
						return;
					}
			...
			if (loginState == 5) {
				...
				var38.packetBuffer.method7450(class252.archive11.hash);
				var38.packetBuffer.writeInt(SoundCache.archive14.hash);
				var38.packetBuffer.method7450(Clock.archive17.hash);
				var38.packetBuffer.method7450(FontName.archive15.hash);
				var38.packetBuffer.method7486(WorldMapRegion.archive19.hash);
				var38.packetBuffer.method7450(class7.archive0.hash);
				var38.packetBuffer.method7486(0);
				var38.packetBuffer.method7486(WorldMapLabelSize.archive6.hash);
				var38.packetBuffer.method7486(class403.archive4.hash);
				var38.packetBuffer.writeIntME(Tile.archive3.hash);
				var38.packetBuffer.method7450(WorldMapLabelSize.archive7.hash);
				var38.packetBuffer.method7486(archive5.hash);
				var38.packetBuffer.writeIntME(Message.archive8.hash);
				var38.packetBuffer.method7450(archive1.hash);
				var38.packetBuffer.writeInt(UrlRequest.archive18.hash);
				var38.packetBuffer.method7486(class148.archive12.hash);
				var38.packetBuffer.writeIntME(Varcs.archive20.hash);
				...
				var38.packetBuffer.method7486(class9.archive9.hash);
			...
			if (loginState == 9 && this.field528.method43()) {
				...
				var30.packetBuffer.method7361(this.field542);
				packetWriter.addNode(var30);
				packetWriter.flush();
				this.field542 = null;
				WorldMapLabelSize.method4321(6);
			...
			if (loginState == 13) {
				...
				if (loginState == 15 && ((AbstractSocket)var1).available() >= class134.field1572) {
					...
					packetWriter.serverPacket = var34[var21];
				...
				if (loginState == 16) {
					...
					if (loginState != 19) {
						...
						if (((AbstractSocket)var1).available() >= packetWriter.serverPacketLength) {
							((AbstractSocket)var1).read(var2.array, 0, packetWriter.serverPacketLength);
							var2.offset = 0;
							var42 = packetWriter.serverPacketLength;
							timer.method6235();
							packetWriter.clearBuffer();
							packetWriter.packetBuffer.offset = 0;
							packetWriter.serverPacket = null;
							packetWriter.field1325 = null;
							packetWriter.field1326 = null;
							packetWriter.field1327 = null;
							packetWriter.serverPacketLength = 0;
							packetWriter.field1323 = 0;
							rebootTimer = 0;
		...
		if (hadNetworkError) {
			...
			if (gameState == 30) {
				...
				while (Language.method5810()) {
					var14 = class135.getPacketBufferNode(ClientPacket.field2896, packetWriter.isaacCipher);
					var14.packetBuffer.writeByte(0);
					var2 = var14.packetBuffer.offset;
					Coord.performReflectionCheck(var14.packetBuffer);
					var14.packetBuffer.method7504(var14.packetBuffer.offset - var2);
					packetWriter.addNode(var14);
				}

				if (timer.field4087) {
					var14 = class135.getPacketBufferNode(ClientPacket.field2915, packetWriter.isaacCipher);
					var14.packetBuffer.writeByte(0);
					var2 = var14.packetBuffer.offset;
					...
					if (!field592) {
						...
						for (var7 = 0; var7 < PacketWriter.mouseRecorder.index && (var15 == null || var15.packetBuffer.offset - var3 < 246); ++var7) {
							...
							if (var9 != field508 || var8 != field509) {
								if (var15 == null) {
									var15 = class135.getPacketBufferNode(ClientPacket.field2838, packetWriter.isaacCipher);
						...
						if (var15 != null) {
							var15.packetBuffer.method7504(var15.packetBuffer.offset - var3);
				...
				if (MouseHandler.MouseHandler_lastButton == 1 || !class370.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) {
					...
					var5 = (int)var16;
					PacketBufferNode var18 = class135.getPacketBufferNode(ClientPacket.field2908, packetWriter.isaacCipher);
				...
				if (KeyHandler.field139 > 0) {
					var14 = class135.getPacketBufferNode(ClientPacket.field2882, packetWriter.isaacCipher);
					var14.packetBuffer.writeShort(0);
					var2 = var14.packetBuffer.offset;
					long var19 = DirectByteArrayCopier.method5318();
					...
					for (var5 = 0; var5 < KeyHandler.field139; ++var5) {
						...
						field685 = var19;
						var14.packetBuffer.method7458(KeyHandler.field135[var5]);
				...
				if (field589 && field677 <= 0) {
					field677 = 20;
					field589 = false;
					var14 = class135.getPacketBufferNode(ClientPacket.field2836, packetWriter.isaacCipher);
					var14.packetBuffer.method7394(camAngleX);
					var14.packetBuffer.method7405(camAngleY);
					packetWriter.addNode(var14);
				}

				if (class297.hasFocus && !hadFocus) {
					hadFocus = true;
					var14 = class135.getPacketBufferNode(ClientPacket.field2930, packetWriter.isaacCipher);
				...
				if (gameState == 30) {
					for (PendingSpawn var30 = (PendingSpawn)pendingSpawns.last(); var30 != null; var30 = (PendingSpawn)pendingSpawns.previous()) {
						...
						if (var30.hitpoints == 0) {
							if (var30.objectId < 0 || WorldMapSectionType.method4717(var30.objectId, var30.field1100)) {
								GroundObject.addPendingSpawnToScene(var30.plane, var30.type, var30.x, var30.y, var30.objectId, var30.field1106, var30.field1100);
								var30.remove();
							}
						} else {
							if (var30.delay > 0) {
							...
							if (var30.delay == 0 && var30.x >= 1 && var30.y >= 1 && var30.x <= 102 && var30.y <= 102 && (var30.id < 0 || WorldMapSectionType.method4717(var30.id, var30.field1103))) {
								GroundObject.addPendingSpawnToScene(var30.plane, var30.type, var30.x, var30.y, var30.id, var30.orientation, var30.field1103);
								var30.delay = -1;
					...
					++packetWriter.field1323;
					if (packetWriter.field1323 > 750) {
						class17.method258();
					} else {
						...
						if (class133.method2807() && KeyHandler.KeyHandler_pressedKeys[82] && KeyHandler.KeyHandler_pressedKeys[81] && mouseWheelRotation != 0) {
							...
							if (var3 != WorldMapSprite.localPlayer.plane) {
								DevicePcmPlayerProvider.method361(WorldMapSprite.localPlayer.pathX[0] + Canvas.baseX * 64, WorldMapSprite.localPlayer.pathY[0] + class118.baseY * 64, var3, false);
							}
												...
												while (true) {
													do {
														...
														if (var42 == null) {
															this.menu();
															if (Huffman.worldMap != null) {
																Huffman.worldMap.method6894(SoundSystem.Client_plane, Canvas.baseX * 64 + (WorldMapSprite.localPlayer.x >> 7), class118.baseY * 64 + (WorldMapSprite.localPlayer.y >> 7), false);
																...
																if (MouseHandler.MouseHandler_currentButton == 0) {
																	if (field616) {
																		if (NPC.hoveredItemContainer == class20.dragInventoryWidget && dragItemSlotDestination != dragItemSlotSource) {
																			...
																			var41 = class135.getPacketBufferNode(ClientPacket.field2856, packetWriter.isaacCipher);
																			var41.packetBuffer.method7405(dragItemSlotDestination);
																			var41.packetBuffer.method7405(dragItemSlotSource);
																			var41.packetBuffer.writeInt(class20.dragInventoryWidget.id);
																			var41.packetBuffer.method7403(var29);
															...
															if (Scene.shouldSendWalk()) {
																...
																var41 = class135.getPacketBufferNode(ClientPacket.field2861, packetWriter.isaacCipher);
																var41.packetBuffer.writeByte(5);
																var41.packetBuffer.method7403(KeyHandler.KeyHandler_pressedKeys[82] ? (KeyHandler.KeyHandler_pressedKeys[81] ? 2 : 1) : 0);
																var41.packetBuffer.method7555(Canvas.baseX * 64 + var3);
																var41.packetBuffer.method7555(class118.baseY * 64 + var4);
																packetWriter.addNode(var41);
																Scene.method3936();
															...
															if (var3 > 15000 && var4 > 15000) {
																...
																var41 = class135.getPacketBufferNode(ClientPacket.field2903, packetWriter.isaacCipher);
																packetWriter.addNode(var41);
															}
															...
															if (packetWriter.pendingWrites > 50) {
																var41 = class135.getPacketBufferNode(ClientPacket.field2837, packetWriter.isaacCipher);
																packetWriter.addNode(var41);
															}
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) {
			if (mouseCrossColor == 1) {
				WorldMapData_1.crossSprites[mouseCrossState * 400 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}

			if (mouseCrossColor == 2) {
				WorldMapData_1.crossSprites[mouseCrossState * 400 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}
		}
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field2977 == var1.serverPacket) {
					var17 = var3.method7399();
					var18 = var3.readStringCp1252NullTerminated();
					var6 = var3.method7398();
					if (var17 >= 1 && var17 <= 8) {
				...
				if (ServerPacket.field3034 == var1.serverPacket) {
					var17 = var3.readInt();
					var5 = var3.method7408();
					var6 = var3.method7414();
				...
				if (ServerPacket.field3056 == var1.serverPacket) {
					class221.field2680 = new class375(FloorOverlayDefinition.Ignored_cached);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field2998 == var1.serverPacket) {
					class33.field243 = var3.method7399();
				...
				if (ServerPacket.field2967 == var1.serverPacket) {
					var17 = var3.method7416();
					var5 = var3.method7418();
					var6 = var3.method7408();
					if (var6 == 65535) {
						var6 = -1;
					}

					var25 = var3.method7414();
					if (var25 == 65535) {
						var25 = -1;
					}
				...
				if (ServerPacket.field3045 == var1.serverPacket) {
					var17 = var3.method7562();
					var5 = var3.method7416();
					var6 = var17 >> 10 & 31;
					var25 = var17 >> 5 & 31;
					var8 = var17 & 31;
				...
				if (ServerPacket.field2976 == var1.serverPacket) {
					publicChatMode = var3.method7399();
					tradeChatMode = var3.method7399();
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3025 == var1.serverPacket) {
					...
					if (var72) {
						class140.field1626 = DirectByteArrayCopier.method5318() - var3.readLong();
				...
				if (ServerPacket.field2968 == var1.serverPacket) {
					...
					Canvas.field157 = var3.method7398();
				...
				if (ServerPacket.field3036 == var1.serverPacket) {
					isCameraLocked = true;
					field755 = false;
					class7.field33 = var3.readUnsignedByte() * 128;
					class21.field119 = var3.readUnsignedByte() * 128;
					class334.field4057 = var3.readUnsignedShort();
					WorldMapSectionType.field2723 = var3.readUnsignedByte();
					DecorativeObject.field2573 = var3.readUnsignedByte();
					if (DecorativeObject.field2573 >= 100) {
						var17 = class7.field33 * 16384 + 64;
						var5 = class21.field119 * 16384 + 64;
						...
						class7.cameraPitch = (int)(Math.atan2((double)var8, (double)var39) * 325.9490051269531D) & 2047;
						class7.cameraYaw = (int)(Math.atan2((double)var25, (double)var28) * -325.9490051269531D) & 2047;
				...
				if (ServerPacket.field3020 == var1.serverPacket) {
					if (class67.friendsChatManager != null) {
						class67.friendsChatManager.method6299(var3);
					}
				...
				if (ServerPacket.field2973 == var1.serverPacket) {
					...
					for (var8 = 0; var8 < var25; ++var8) {
						var28 = var3.method7414();
						var39 = var3.method7467();
						if (var39 == 255) {
				...
				if (ServerPacket.field3023 == var1.serverPacket) {
					...
					PacketBufferNode var52 = class135.getPacketBufferNode(ClientPacket.field2890, packetWriter.isaacCipher);
					var52.packetBuffer.method7486(var17);
					var52.packetBuffer.method7486(var5);
					var52.packetBuffer.method7458(var6);
					var52.packetBuffer.method7370(GameEngine.fps);
				...
				if (ServerPacket.field2987 == var1.serverPacket) {
					if (var1.serverPacketLength == 0) {
						class67.friendsChatManager = null;
					} else {
						if (class67.friendsChatManager == null) {
							class67.friendsChatManager = new FriendsChatManager(VarcInt.loginType, class414.client);
						}

						class67.friendsChatManager.readUpdate(var3);
					}
				...
				if (ServerPacket.field3007 == var1.serverPacket) {
					...
					class428 var47 = FloorOverlayDefinition.Ignored_cached.method6784(var3);
				...
				if (ServerPacket.field3035 == var1.serverPacket) {
					isCameraLocked = true;
					field755 = false;
					Message.field478 = var3.readUnsignedByte() * 128;
					class12.field75 = var3.readUnsignedByte() * 128;
					...
					if (class4.field17 >= 100) {
						class414.cameraX = Message.field478 * 16384 + 64;
						GrandExchangeOfferOwnWorldComparator.cameraZ = class12.field75 * 16384 + 64;
				...
				if (ServerPacket.field3031 == var1.serverPacket) {
					rebootTimer = var3.method7408() * 30;
					field705 = cycleCntr;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3037 == var1.serverPacket) {
					class33.field243 = var3.method7467();
					Canvas.field157 = var3.method7399();
					var1.serverPacket = null;
					return true;
				}
				...
				GroundObject.RunException_sendStackTrace("" + (var1.serverPacket != null ? var1.serverPacket.id : -1) + "," + (var1.field1326 != null ? var1.field1326.id : -1) + "," + (var1.field1327 != null ? var1.field1327.id : -1) + "," + var1.serverPacketLength, (Throwable)null);
				class133.logOut();
			} catch (IOException var44) {
				class17.method258();
			} catch (Exception var45) {
				var18 = "" + (var1.serverPacket != null ? var1.serverPacket.id : -1) + "," + (var1.field1326 != null ? var1.field1326.id : -1) + "," + (var1.field1327 != null ? var1.field1327.id : -1) + "," + var1.serverPacketLength + "," + (WorldMapSprite.localPlayer.pathX[0] + Canvas.baseX * 64) + "," + (WorldMapSprite.localPlayer.pathY[0] + class118.baseY * 64) + ",";

				for (var6 = 0; var6 < var1.serverPacketLength && var6 < 50; ++var6) {
					var18 = var18 + var3.array[var6] + ",";
				}

				GroundObject.RunException_sendStackTrace(var18, var45);
				class133.logOut();
			}
	...
	final void method1149() {
		...
		if (field648 && field682) {
			...
			if (var1 + clickedWidget.width > field606 + clickedWidgetParent.width) {
			...
			if (var2 + clickedWidget.height > field561 + clickedWidgetParent.height) {
			...
			if (ByteArrayPool.widgetDragDuration > clickedWidget.dragThreshold && (var3 > var5 || var3 < -var5 || var4 > var5 || var4 < -var5)) {
				isDraggingWidget = true;
			}

			int var6 = var1 - field606 + clickedWidgetParent.scrollX;
			int var7 = var2 - field561 + clickedWidgetParent.scrollY;
			ScriptEvent var8;
			...
			if (MouseHandler.MouseHandler_currentButton == 0) {
				if (isDraggingWidget) {
					...
					if (draggedOnWidget != null) {
						...
						if (var13 != null) {
							PacketBufferNode var12 = class135.getPacketBufferNode(ClientPacket.field2847, packetWriter.isaacCipher);
							var12.packetBuffer.method7555(draggedOnWidget.childIndex);
							var12.packetBuffer.writeInt(clickedWidget.id);
							var12.packetBuffer.method7394(draggedOnWidget.itemId);
							var12.packetBuffer.method7555(clickedWidget.itemId);
							var12.packetBuffer.method7486(draggedOnWidget.id);
			...
			if (ByteArrayPool.widgetDragDuration > 1) {
				clickedWidget = null;
			}
		...
		try {
			if (this.checkHost()) {
				...
				try {
					...
					GroundObject.RunException_sendStackTrace((String)null, var11);
				}
