	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) {
			if (mouseCrossColor == 1) {
				class299.crossSprites[mouseCrossState * 400 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}

			if (mouseCrossColor == 2) {
				class299.crossSprites[mouseCrossState * 400 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}
		}
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field2187 == var1.serverPacket) {
					isCameraLocked = true;
					HealthBar.field1145 = var3.readUnsignedByte() * 128;
					WorldMapRectangle.field217 = var3.readUnsignedByte() * 128;
				...
				if (ServerPacket.field2166 == var1.serverPacket) {
					isCameraLocked = true;
					field925 = var3.readUnsignedByte() * 128;
					Strings.field2759 = var3.readUnsignedByte() * 16384;
				...
				WorldMapDecorationType.RunException_sendStackTrace("" + (var1.serverPacket != null ? var1.serverPacket.id : -1) + "," + (var1.field1329 != null ? var1.field1329.id : -1) + "," + (var1.field1339 != null ? var1.field1339.id : -1) + "," + var1.serverPacketLength, (Throwable)null);
				Huffman.logOut();
