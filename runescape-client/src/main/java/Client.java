		...
		if (var2 == null) { // L: 6343
			...
			try {
				...
				if (ServerPacket.field3346 == var1.serverPacket) { // L: 7393
					...
					var61 = var3.readUnsignedByte() == 1; // L: 7395
					var89 = class92.getWidget(var68); // L: 7396
					class160.method3278(var89, VarbitComposition.localPlayer.appearance, var61); // L: 7397
				...
				if (ServerPacket.field3255 == var1.serverPacket) { // L: 7515
					...
					var61 = var3.readUnsignedByte() == 1; // L: 7517
					var94 = ""; // L: 7518
