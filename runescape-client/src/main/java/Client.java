													...
													do {
														...
														if (var42 == null) { // L: 3461
															...
															if (field745) { // L: 3582
																...
																var4 = class457.field4811 * 128 + 64; // L: 3584
																var5 = NPC.field1261 * 16384 + 64; // L: 3585
																...
																var4 = WorldMapLabelSize.field2673 * 16384 + 64; // L: 3588
																var5 = LoginScreenAnimation.field1233 * 16384 + 64; // L: 3589
		...
		if (var2 == null) { // L: 6183
			...
			try {
				...
				if (ServerPacket.field3112 == var1.serverPacket) { // L: 6830
					...
					WorldMapLabelSize.field2673 = var3.readUnsignedByte() * 128; // L: 6833
					LoginScreenAnimation.field1233 = var3.readUnsignedByte() * 128; // L: 6834
					...
					if (ScriptFrame.field459 >= 100) { // L: 6838
						var20 = WorldMapLabelSize.field2673 * 16384 + 64; // L: 6839
						var5 = LoginScreenAnimation.field1233 * 16384 + 64; // L: 6840
				...
				if (ServerPacket.field3123 == var1.serverPacket) { // L: 7010
					...
					class457.field4811 = var3.readUnsignedByte() * 16384; // L: 7013
					NPC.field1261 = var3.readUnsignedByte() * 128; // L: 7014
					...
					if (SoundCache.field325 >= 100) { // L: 7018
						WorldMapLabelSize.cameraX = class457.field4811 * 128 + 64; // L: 7019
						Widget.cameraZ = NPC.field1261 * 16384 + 64; // L: 7020
