		...
		try {
			...
			if (loginState == 21) { // L: 2122
				if (this.otlTokenRequest != null) { // L: 2123
					...
					try {
						RefreshAccessTokenResponse var3 = (RefreshAccessTokenResponse)this.otlTokenRequest.get(); // L: 2133
			...
			if (loginState == 20) { // L: 2186
				if (this.field534 != null) { // L: 2187
					...
					try {
						OtlTokenResponse var28 = (OtlTokenResponse)this.field534.get(); // L: 2197
				...
				while (true) {
					...
					if (!var29) { // L: 3098
						...
						if (MouseHandler.MouseHandler_lastButton == 1 || !class82.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) { // L: 3206
							long var16 = MouseHandler.MouseHandler_lastPressedTimeMillis - mouseLastLastPressedTimeMillis * -1L; // L: 3207
							if (var16 > 32767L) { // L: 3208
								var16 = 32767L;
							}

							mouseLastLastPressedTimeMillis = MouseHandler.MouseHandler_lastPressedTimeMillis * -1L; // L: 3209
						...
						if (mouseCrossColor != 0) { // L: 3417
							mouseCrossState = mouseCrossState * 400 + 400; // L: 3418
							if (mouseCrossState * 20 >= 400) { // L: 3419
								mouseCrossColor = 0;
							}
						}
															...
															while (true) {
																...
																if (var53 == null) { // L: 3515
																		...
																		if (MouseHandler.MouseHandler_currentButton == 0) { // L: 3524
																			if (field616) { // L: 3525
																				if (VerticalAlignment.dragInventoryWidget == class168.hoveredItemContainer && dragItemSlotSource != dragItemSlotDestination) { // L: 3526
																					...
																					if (var54.itemIds[dragItemSlotDestination] <= 0) { // L: 3530
																						var34 = 0;
																					}
																	...
																	if (field758) { // L: 3739
																		...
																		var4 = class11.field62 * 16384 + 64; // L: 3760
																		...
																		var3 = class4.field11 * 128 + 64; // L: 3763
																		var4 = BuddyRankComparator.field1431 * 16384 + 64; // L: 3764
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) { // L: 4498
			if (mouseCrossColor == 1) { // L: 4499
				class199.crossSprites[mouseCrossState * 20 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8); // L: 4500
			}

			if (mouseCrossColor == 2) { // L: 4502
				class199.crossSprites[mouseCrossState * 20 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8); // L: 4503
			}
		}
		...
		if (var2 == null) { // L: 6191
			...
			try {
				...
				if (ServerPacket.field3193 == var1.serverPacket) { // L: 6720
					...
					class11.field62 = var3.readUnsignedByte() * 128; // L: 6724
					...
					if (UrlRequest.field1398 >= 100) { // L: 6728
						...
						class313.cameraZ = class11.field62 * 16384 + 64; // L: 6730
				...
				if (ServerPacket.field3164 == var1.serverPacket) { // L: 7535
					...
					class4.field11 = var3.readUnsignedByte() * 16384; // L: 7538
					BuddyRankComparator.field1431 = var3.readUnsignedByte() * 128; // L: 7539
					...
					if (HealthBarDefinition.field1912 >= 100) { // L: 7543
						var20 = class4.field11 * 128 + 64; // L: 7544
						var5 = BuddyRankComparator.field1431 * 16384 + 64; // L: 7545
	...
	static void method1227(Font var0, Font var1) {
		...
		if (DirectByteArrayCopier.worldSelectBackSprites != null) { // L: 1700
			...
			if (GameObject.worldSelectLeftSprite != null && Login.worldSelectPage > 0) { // L: 1721
				GameObject.worldSelectLeftSprite.drawAt(8, class10.canvasHeight / 2 - GameObject.worldSelectLeftSprite.subHeight / 2); // L: 1722
			}

			if (DevicePcmPlayerProvider.worldSelectRightSprite != null && Login.worldSelectPage < Login.worldSelectPagesCount) { // L: 1724
				DevicePcmPlayerProvider.worldSelectRightSprite.drawAt(GameEngine.canvasWidth - DevicePcmPlayerProvider.worldSelectRightSprite.subWidth - 8, class10.canvasHeight / 2 - DevicePcmPlayerProvider.worldSelectRightSprite.subHeight / 2); // L: 1725
			}
