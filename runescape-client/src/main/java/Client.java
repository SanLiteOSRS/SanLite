...
public final class Client extends GameEngine implements Usernamed, OAuthApi, class312 {
	...
	static {
		...
		field615 = new class411(8, class409.field4549); // L: 707
	...
	final void doCycleLoggedOut() {
		...
		try {
			...
			if (loginState == 5) { // L: 2333
				...
				var35.packetBuffer.writeInt(class466.archive5.hash); // L: 2445
																			...
																			do {
																				...
																				if (var51 == null) { // L: 3549
																					...
																					if (field691) { // L: 3641
																						...
																						if (!field764) { // L: 3643
																							var3 = class126.field1469 * 128 + 64; // L: 3644
																						...
																						if (!field725) { // L: 3660
																							...
																							var4 = class137.field1605 * 16384 + 64; // L: 3662
	...
	final void drawLoggedIn() {
		...
		for (ObjectSound var14 = (ObjectSound)ObjectSound.objectSounds.last(); var14 != null; var14 = (ObjectSound)ObjectSound.objectSounds.previous()) { // L: 4701
			if (var14.soundEffectId != -1 || var14.soundEffectIds != null) { // L: 4702
				...
				if (var3 > var14.maxY * 16384) { // L: 4706
					var6 += var3 - var14.maxY * 16384;
				} else if (var3 < var14.y * 16384) { // L: 4707
		...
		if (var2 == null) { // L: 6411
			...
			try {
				...
				if (ServerPacket.field3334 == var1.serverPacket) { // L: 6720
					...
					if (hintArrowType >= 2 && hintArrowType <= 6) { // L: 6723
						if (hintArrowType == 2) { // L: 6724
							field530 = 4096; // L: 6725
							field531 = 4096; // L: 6726
						}

						if (hintArrowType == 3) { // L: 6728
							field530 = 0; // L: 6729
							field531 = 4096; // L: 6730
						}

						if (hintArrowType == 4) { // L: 6732
							field530 = 8192; // L: 6733
							field531 = 4096; // L: 6734
						}

						if (hintArrowType == 5) { // L: 6736
							field530 = 4096; // L: 6737
							field531 = 0; // L: 6738
						}

						if (hintArrowType == 6) { // L: 6740
							field530 = 4096; // L: 6741
							field531 = 8192; // L: 6742
						}

						hintArrowType = 2; // L: 6744
						field527 = var3.readUnsignedShort(); // L: 6745
						field697 = var3.readUnsignedShort(); // L: 6746
						field529 = var3.readUnsignedByte() * 2; // L: 6747
					}
				...
				if (ServerPacket.field3328 == var1.serverPacket) { // L: 7158
					...
					class126.field1469 = var3.readUnsignedByte() * 16384; // L: 7162
					...
					var74 = class126.field1469 * 128 + 64; // L: 7168
				...
				if (ServerPacket.field3303 == var1.serverPacket) { // L: 7244
					...
					class137.field1605 = var3.readUnsignedByte() * 128; // L: 7249
					...
					if (class209.field2322 >= 100) { // L: 7253
						...
						var5 = class137.field1605 * 16384 + 64; // L: 7255
				...
				if (ServerPacket.field3299 == var1.serverPacket) { // L: 7419
					...
					class137.field1605 = var3.readUnsignedByte() * 128; // L: 7424
					...
					var74 = class137.field1605 * 16384 + 64; // L: 7429
				...
				if (ServerPacket.field3230 == var1.serverPacket) { // L: 7468
					...
					class126.field1469 = var3.readUnsignedByte() * 16384; // L: 7472
					...
					var29 = class126.field1469 * 128 + 64; // L: 7480
				...
				if (ServerPacket.field3307 == var1.serverPacket) { // L: 7761
					...
					class126.field1469 = var3.readUnsignedByte() * 16384; // L: 7765
					...
					if (LoginScreenAnimation.field1255 >= 100) { // L: 7770
						class208.cameraX = class126.field1469 * 128 + 64; // L: 7771
