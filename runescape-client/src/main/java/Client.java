		...
		try {
			...
			if (loginState == 21) { // L: 2300
				if (this.otlTokenRequest != null) { // L: 2301
					...
					try {
						OtlTokenResponse var3 = (OtlTokenResponse)this.otlTokenRequest.get(); // L: 2311
			...
			if (loginState == 20) { // L: 2364
				if (this.field541 != null) { // L: 2365
					...
					try {
						com.jagex.oldscape.pub.OtlTokenResponse var26 = (com.jagex.oldscape.pub.OtlTokenResponse)this.field541.get(); // L: 2375
				...
				while (true) {
					...
					if (!var30) { // L: 3274
						...
						if (MouseHandler.MouseHandler_lastButton == 1 || !FriendsChatMember.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) { // L: 3382
							long var16 = MouseHandler.MouseHandler_lastPressedTimeMillis - mouseLastLastPressedTimeMillis * -1L; // L: 3383
							if (var16 > 32767L) { // L: 3384
								var16 = 32767L;
							}

							mouseLastLastPressedTimeMillis = MouseHandler.MouseHandler_lastPressedTimeMillis * -1L; // L: 3385
																			...
																			do {
																				...
																				if (var45 == null) { // L: 3608
																					...
																					if (field767) { // L: 3870
																						...
																						var4 = Occluder.field2636 * 16384 + 64; // L: 3872
		...
		if (var2 == null) { // L: 6404
			...
			try {
				...
				if (ServerPacket.field3196 == var1.serverPacket) { // L: 6615
					...
					Occluder.field2636 = var3.readUnsignedByte() * 128; // L: 6618
					...
					if (UserComparator7.field1444 >= 100) { // L: 6623
						ClanSettings.cameraX = Occluder.field2636 * 16384 + 64; // L: 6624
