	...
	static final void method6700(class263 var0) {
		...
		if (class263.field3012 == var0) {
			...
			if (class263.field3009 == var0) {
				var2 = var1.method7875();
				var3 = (var2 >> 4 & 7) + PlayerComposition.field3307;
				var4 = (var2 & 7) + class29.field181;
				var5 = var1.method7714();
				if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
				...
				if (class263.field3004 == var0) {
					...
					byte var38 = var1.method7707();
					byte var39 = var1.readByte();
					var6 = var1.method7715();
					byte var40 = var1.method7707();
					var8 = var1.method7714();
					var9 = var1.method7773();
					var10 = var9 >> 2;
					var11 = var9 & 3;
					var12 = Client.field748[var10];
					var13 = var1.method7773();
					var14 = (var13 >> 4 & 7) + PlayerComposition.field3307;
					int var15 = (var13 & 7) + class29.field181;
					int var16 = var1.method7714();
					Player var17;
					...
					if (var17 != null) {
						...
						if (var29 != null) {
							...
							var17.model0 = var29;
							var17.field1080 = var14 * 128 + var19 * 64;
							var17.field1082 = var15 * 128 + var20 * 64;
				...
				if (class263.field3007 == var0) {
					...
					var4 = (var3 >> 4 & 7) + PlayerComposition.field3307;
					var5 = (var3 & 7) + class29.field181;
					var6 = var1.method7713();
					var7 = var1.method7713();
					if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104) {
					...
					var2 = var1.method7773();
					var3 = var1.readUnsignedShort();
					var4 = var1.method7715();
					var5 = var1.method7875();
					...
					var3 = (var2 >> 4 & 7) + PlayerComposition.field3307;
					var4 = (var2 & 7) + class29.field181;
					var5 = var1.method7742();
					var6 = var5 >> 2;
					var7 = var5 & 3;
					var8 = Client.field748[var6];
					var9 = var1.method7714();
					if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
					...
					var2 = var1.method7875() * 4;
					var3 = var1.method7714();
					var4 = var1.method7717();
					var5 = var1.method7773();
					var6 = (var5 >> 4 & 7) + PlayerComposition.field3307;
					var7 = (var5 & 7) + class29.field181;
					var8 = var1.method7714();
					byte var41 = var1.method7708();
					var10 = var1.method7742();
					byte var42 = var1.method7885();
					var12 = var1.readUnsignedByte() * 4;
					var13 = var1.method7773();
					var14 = var1.method7714();
					var9 = var41 + var6;
					var11 = var42 + var7;
					...
					if (class263.field3008 == var0) {
						var2 = var1.method7714();
						var3 = var1.readUnsignedByte();
						var4 = (var3 >> 4 & 7) + PlayerComposition.field3307;
						var5 = (var3 & 7) + class29.field181;
						var6 = var1.method7714();
						if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104) {
							var31 = new TileItem();
							var31.id = var2;
							var31.quantity = var6;
					...
					if (var8 >= 0 && var9 >= 0 && var8 < 103 && var9 < 103) {
						...
						if (var6 == 1) {
							DecorativeObject var43 = ArchiveLoader.scene.method4860(class18.Client_plane, var8, var9);
							if (var43 != null) {
						...
						if (var6 == 3) {
							GroundObject var45 = ArchiveLoader.scene.getGroundObject(class18.Client_plane, var8, var9);
							if (var45 != null) {
	...
	static final void addSceneMenuOptions(int var0, int var1, int var2, int var3) {
		...
		for (var8 = 0; var8 < StructComposition.method3618(); ++var8) {
			...
			if (var25 != var6) {
				...
				var15 = var15;
				int var29 = GroundObject.method4592(ViewportMouse.ViewportMouse_entityTags[var8]);
				...
				if (var29 == 3) {
					...
					if (var37 != null) {
						for (TileItem var36 = (TileItem)var37.first(); var36 != null; var36 = (TileItem)var37.next()) {
							ItemComposition var40 = class19.ItemComposition_get(var36.id);
							if (Client.isItemSelected == 1) {
