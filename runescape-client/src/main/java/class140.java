...
public class class140 extends class139 {
	...
	void vmethod3461(Buffer var1) {
		this.field1647 = var1.readUnsignedShort(); // L: 184
		this.field1646 = var1.readUnsignedByte() == 1; // L: 185
	} // L: 186
	...
	void vmethod3458(ClanSettings var1) {
		var1.method3313(this.field1647, this.field1646); // L: 189
	} // L: 190
	...
	public static int method3220(int var0) {
		return class295.field3369[var0]; // L: 37
	}
}
