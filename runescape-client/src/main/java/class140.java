...
public class class140 extends class143 {
	...
	void vmethod3531(Buffer var1) {
		this.field1620 = var1.readUnsignedShort(); // L: 166
		this.field1621 = var1.readInt(); // L: 167
		this.field1623 = var1.readUnsignedByte(); // L: 168
		this.field1622 = var1.readUnsignedByte(); // L: 169
	} // L: 170
	...
	void vmethod3529(ClanSettings var1) {
		var1.method3390(this.field1620, this.field1621, this.field1623, this.field1622); // L: 173
	} // L: 174
}
