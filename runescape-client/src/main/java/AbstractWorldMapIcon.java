...
public abstract class AbstractWorldMapIcon {
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			class120.archive3 = UserComparator5.newArchive(0, false, true, true);
			Language.archive4 = UserComparator5.newArchive(1, false, true, true);
			ItemLayer.archive2 = UserComparator5.newArchive(2, true, false, true);
			Decimator.archive5 = UserComparator5.newArchive(3, false, true, true);
			InvDefinition.field1520 = UserComparator5.newArchive(4, false, true, true);
			Skeleton.archive7 = UserComparator5.newArchive(5, true, true, true);
			class108.archive6 = UserComparator5.newArchive(6, true, true, true);
			class74.archive9 = UserComparator5.newArchive(7, false, true, true);
			class270.archive8 = UserComparator5.newArchive(8, false, true, true);
			class126.field1453 = UserComparator5.newArchive(9, false, true, true);
			...
			FriendsChatMember.archive20 = UserComparator5.newArchive(20, false, true, true);
				...
				if (Client.titleLoadingStage == 50) {
					...
					if (Client.titleLoadingStage == 60) {
						...
						if (!ItemLayer.archive2.isFullyLoaded()) {
							...
							method3719(ItemLayer.archive2, class74.archive9, Client.isMembersWorld, GrandExchangeOfferOwnWorldComparator.fontPlain11);
							Archive var6 = ItemLayer.archive2;
							Archive var7 = class120.archive3;
							Archive var8 = Language.archive4;
							...
							UrlRequest.method2141(ItemLayer.archive2, class74.archive9);
							FriendSystem.method1452(ItemLayer.archive2);
							World.method1403(ItemLayer.archive2);
							class137.method2686(Decimator.archive5, class74.archive9, class270.archive8, ClanChannel.archive13);
							...
							class99.field1271 = new class371(class68.field975, 54, GrandExchangeOfferWorldComparator.clientLanguage, ItemLayer.archive2);
							GrandExchangeOfferUnitPriceComparator.HitSplatDefinition_cachedSprites = new class371(class68.field975, 47, GrandExchangeOfferWorldComparator.clientLanguage, ItemLayer.archive2);
						...
						if (!class126.field1453.isFullyLoaded()) {
							Login.Login_loadingText = "Loading textures - " + "0%";
							Login.Login_loadingPercent = 90;
						} else {
							WorldMapSprite.textureProvider = new TextureProvider(class126.field1453, class270.archive8, 20, Decimator.clientPreferences.field1117, Client.isLowDetail ? 64 : 128);
						...
						class6.mouseRecorder = new class68();
						...
						if (!Decimator.archive5.isFullyLoaded()) {
							Login.Login_loadingText = "Loading interfaces - " + Decimator.archive5.loadPercent() * 4 / 5 + "%";
						...
						if (!Decimator.archive19.tryLoadGroupByName(WorldMapCacheName.field2117.name)) {
							...
							if (PcmPlayer.worldMap == null) {
								...
								PcmPlayer.worldMap.init(Decimator.archive19, class15.archive18, FriendsChatMember.archive20, TaskHandler.fontBold12, Client.fontsMap, NetFileRequest.mapSceneSprites);
							}
			...
			byte var11 = 0;
			var21 = var11 + class120.archive3.percentage() * 4 / 100;
			var21 += Language.archive4.percentage() * 4 / 100;
			var21 += ItemLayer.archive2.percentage() * 2 / 100;
			var21 += Decimator.archive5.percentage() * 2 / 100;
			var21 += InvDefinition.field1520.percentage() * 6 / 100;
			var21 += Skeleton.archive7.percentage() * 4 / 100;
			var21 += class108.archive6.percentage() * 2 / 100;
			var21 += class74.archive9.percentage() * 56 / 100;
			var21 += class270.archive8.percentage() * 2 / 100;
			var21 += class126.field1453.percentage() * 2 / 100;
			...
			var21 += FriendsChatMember.archive20.percentage() / 100;
			...
			if (var21 != 100) {
				...
				UserComparator4.method2143(class120.archive3, "Animations");
				UserComparator4.method2143(Language.archive4, "Skeletons");
				UserComparator4.method2143(InvDefinition.field1520, "Sound FX");
				UserComparator4.method2143(Skeleton.archive7, "Maps");
				UserComparator4.method2143(class108.archive6, "Music Tracks");
				UserComparator4.method2143(class74.archive9, "Models");
				...
				UserComparator4.method2143(FriendsChatMember.archive20, "World Map Ground");
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (!Client.isCameraLocked) {
			...
			if (Client.oculusOrbState == 1 && Client.staffModLevel >= 2 && Client.cycle % 50 == 0 && (KeyHandler.oculusOrbFocalPointX >> 7 != MouseHandler.localPlayer.x >> 7 || ArchiveDiskAction.oculusOrbFocalPointY >> 7 != MouseHandler.localPlayer.y >> 7)) {
				...
				var18 = GrandExchangeOfferNameComparator.baseX * 64 + (KeyHandler.oculusOrbFocalPointX >> 7);
				var19 = NPC.baseY * 64 + (ArchiveDiskAction.oculusOrbFocalPointY >> 7);
		...
		if (Client.hintArrowType == 2) {
			FriendLoginUpdate.worldToScreen(Client.hintArrowSubX * 64 + (Client.hintArrowX - GrandExchangeOfferNameComparator.baseX * 64 << 7), Client.hintArrowSubY * 64 + (Client.hintArrowY - NPC.baseY * 64 << 7), Client.hintArrowHeight * 4);
		...
		Client.field521 = 0;
		var13 = GrandExchangeOfferNameComparator.baseX * 64 + (MouseHandler.localPlayer.x >> 7);
		var14 = NPC.baseY * 64 + (MouseHandler.localPlayer.y >> 7);
