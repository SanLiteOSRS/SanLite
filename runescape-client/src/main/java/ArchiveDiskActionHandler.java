		...
		if (!var0) { // L: 5750
			...
			for (var1 = 0; var1 < Actor.regionLandArchives.length; ++var1) { // L: 5756
				...
				if (var15 != null) { // L: 5758
					var3 = (Client.regions[var1] >> 8) * 64 - class28.baseX * 64; // L: 5759
					var4 = (Client.regions[var1] & 255) * 64 - WorldMapLabelSize.baseY * 64; // L: 5760
			...
			if (!var0) { // L: 5768
				...
				if (!Client.isInInstance) { // L: 5788
					...
					for (var2 = 0; var2 < var1; ++var2) { // L: 5789
						var3 = (Client.regions[var2] >> 8) * 64 - class28.baseX * 64; // L: 5790
						var4 = (Client.regions[var2] & 255) * 64 - WorldMapLabelSize.baseY * 64; // L: 5791
					...
					for (var2 = 0; var2 < var1; ++var2) { // L: 5798
						var3 = (Client.regions[var2] >> 8) * 64 - class28.baseX * 64; // L: 5799
						var4 = (Client.regions[var2] & 255) * 64 - WorldMapLabelSize.baseY * 64; // L: 5800
					...
					for (var2 = 0; var2 < var1; ++var2) { // L: 5808
						...
						if (var13 != null) { // L: 5810
							var4 = (Client.regions[var2] >> 8) * 64 - class28.baseX * 64; // L: 5811
							var5 = (Client.regions[var2] & 255) * 64 - WorldMapLabelSize.baseY * 64; // L: 5812
