...
public enum class192 implements Enumerated {
	...
	public static void method3762(String var0, String var1, int var2, int var3) throws IOException {
	...
	static void method3761(int var0, int var1) {
		int[] var2 = new int[9];
		...
		for (int var3 = 0; var3 < var2.length; ++var3) {
			...
			var5 = PcmPlayer.method2590(var5, var1);
