...
public class WorldMapDecoration {
	...
	static final void drawModelComponents(Widget[] var0, int var1) {
		for (int var2 = 0; var2 < var0.length; ++var2) {
			...
			if (var3 != null && var3.parentId == var1 && (!var3.isIf3 || !Renderable.isComponentHidden(var3))) {
				int var5;
				if (var3.type == 0) {
					if (!var3.isIf3 && Renderable.isComponentHidden(var3) && var3 != WorldMapSection1.mousedOverWidgetIf1) {
						continue;
					}
