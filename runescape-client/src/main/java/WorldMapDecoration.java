      ...
      if (Login.worldSelectOpen) {
         ...
         if (Client.gameState != 5) {
            if (Login.field1179 == -1L) {
               Login.field1179 = SequenceDefinition.currentTimeMs() + 1000L;
            }

            long var12 = SequenceDefinition.currentTimeMs();
            boolean var16;
