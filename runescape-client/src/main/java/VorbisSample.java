...
public class VorbisSample extends Node {
	...
	void read(byte[] var1) {
		...
		if (this.end < 0) { // L: 94
			...
			this.field387 = true; // L: 96
		}

		int var3 = var2.readInt(); // L: 98
		this.field410 = new byte[var3][]; // L: 99
	...
	float[] method1067(int var1) {
		VorbisSample_setData(this.field410[var1], 0); // L: 182
		readBit(); // L: 183
		int var2 = readBits(FaceNormal.iLog(VorbisSample_mapping.length - 1)); // L: 184
		...
		for (var17 = 0; var17 < var14.submaps; ++var17) { // L: 228
			...
			float[] var44 = field404; // L: 230
			var42.method873(var44, var4 >> 1, var45); // L: 231
		}
		...
		if (!var15) { // L: 234
			...
			VorbisSample_floors[var18].method762(field404, var4 >> 1); // L: 237
		}
		...
		if (var15) { // L: 240
			...
			float[] var40 = var3 ? field391 : field384; // L: 250
			float[] var22 = var3 ? field409 : field406; // L: 251
			float[] var23 = var3 ? field405 : field407; // L: 252
			int[] var24 = var3 ? field390 : field411; // L: 253
			...
			var25 = FaceNormal.iLog(var4 - 1); // L: 274
			...
			for (var46 = var11; var46 < var12; ++var46) { // L: 349
				...
				var10000 = field404; // L: 351
				var10000[var46] *= (float)Math.sin(1.5707963267948966D * (double)var27 * (double)var27);
			}
		}

		float[] var41 = null; // L: 354
		if (this.field401 > 0) { // L: 355
			var18 = var4 + this.field401 >> 2; // L: 356
			var41 = new float[var18]; // L: 357
			int var43;
			if (!this.field403) { // L: 358
				for (var19 = 0; var19 < this.field402; ++var19) { // L: 359
					var43 = var19 + (this.field401 >> 1); // L: 360
					var41[var19] += this.field399[var43]; // L: 361
				}
			}
			...
			if (!var15) { // L: 364
				for (var19 = var8; var19 < var4 >> 1; ++var19) { // L: 365
					...
					var41[var43] += field404[var19]; // L: 367
				}
			}
		}

		float[] var54 = this.field399; // L: 371
		this.field399 = field404; // L: 372
		field404 = var54; // L: 373
		this.field401 = var4; // L: 374
		this.field402 = var12 - (var4 >> 1); // L: 375
		this.field403 = var15; // L: 376
		return var41; // L: 377
	}
	...
	RawSound toRawSound(int[] var1) {
		if (var1 != null && var1[0] <= 0) { // L: 405
			...
			if (this.samples == null) { // L: 406
				this.field401 = 0; // L: 407
				this.field399 = new float[VorbisSample_blockSize1]; // L: 408
				this.samples = new byte[this.sampleCount]; // L: 409
				this.field414 = 0; // L: 410
				this.field415 = 0; // L: 411
			}

			for (; this.field415 < this.field410.length; ++this.field415) { // L: 413 428
				if (var1 != null && var1[0] <= 0) { // L: 414
					return null;
				}

				float[] var2 = this.method1067(this.field415); // L: 415
				if (var2 != null) { // L: 416
					int var3 = this.field414; // L: 417
					...
					this.field414 = var3; // L: 426
				}
			}

			this.field399 = null; // L: 430
			byte[] var7 = this.samples; // L: 431
			this.samples = null; // L: 432
			return new RawSound(this.sampleRate, var7, this.start, this.end, this.field387); // L: 433
		}
	}
	...
	static void method1085(byte[] var0) {
		...
		field404 = new float[VorbisSample_blockSize1]; // L: 117
		...
		for (var1 = 0; var1 < 2; ++var1) { // L: 118
			...
			int var10 = FaceNormal.iLog(var5 - 1); // L: 139
			...
			if (var1 != 0) { // L: 141
				field391 = var12; // L: 142
				field409 = var13; // L: 143
				field405 = var14; // L: 144
				field390 = var15; // L: 145
			} else {
				field384 = var12; // L: 148
				field406 = var13; // L: 149
				field407 = var14; // L: 150
				field411 = var15; // L: 151
			}
		}
