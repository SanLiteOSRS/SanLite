...
public class VorbisSample extends Node {
	...
	float[] method1061(int var1) {
		VorbisSample_setData(this.field410[var1], 0); // L: 198
		readBit(); // L: 199
		int var2 = readBits(class4.iLog(VorbisSample_mapping.length - 1)); // L: 200
		...
		for (var17 = 0; var17 < var14.submaps; ++var17) { // L: 244
			...
			var42.method879(var44, var4 >> 1, var45); // L: 247
		}
		...
		if (!var15) { // L: 250
			...
			VorbisSample_floors[var18].method784(field383, var4 >> 1); // L: 253
		}
		...
		if (var15) { // L: 256
			...
			float[] var40 = var3 ? field403 : field400; // L: 266
			float[] var22 = var3 ? field379 : field401; // L: 267
			float[] var23 = var3 ? field405 : field402; // L: 268
			int[] var24 = var3 ? field407 : field385; // L: 269
			...
			var25 = class4.iLog(var4 - 1); // L: 290
		...
		if (this.field409 > 0) { // L: 371
			var18 = var4 + this.field409 >> 2; // L: 372
			var41 = new float[var18]; // L: 373
			int var43;
			if (!this.field392) { // L: 374
				for (var19 = 0; var19 < this.field397; ++var19) { // L: 375
					var43 = var19 + (this.field409 >> 1); // L: 376
					var41[var19] += this.field395[var43]; // L: 377
				}
			}
		...
		float[] var54 = this.field395; // L: 387
		this.field395 = field383; // L: 388
		field383 = var54; // L: 389
		this.field409 = var4; // L: 390
		this.field397 = var12 - (var4 >> 1); // L: 391
		this.field392 = var15; // L: 392
		return var41; // L: 393
	}
	...
	RawSound toRawSound(int[] var1) {
		if (var1 != null && var1[0] <= 0) { // L: 421
			...
			if (this.samples == null) { // L: 422
				this.field409 = 0; // L: 423
				this.field395 = new float[VorbisSample_blockSize1]; // L: 424
				this.samples = new byte[this.sampleCount]; // L: 425
				this.field406 = 0; // L: 426
				this.field378 = 0; // L: 427
			}

			for (; this.field378 < this.field410.length; ++this.field378) { // L: 429 444
				if (var1 != null && var1[0] <= 0) { // L: 430
					return null;
				}

				float[] var2 = this.method1061(this.field378); // L: 431
				if (var2 != null) { // L: 432
					int var3 = this.field406; // L: 433
					...
					this.field406 = var3; // L: 442
				}
			}

			this.field395 = null; // L: 446
			byte[] var7 = this.samples; // L: 447
			this.samples = null; // L: 448
			return new RawSound(this.sampleRate, var7, this.start, this.end, this.field382); // L: 449
		}
	}
	...
	static void method1060(byte[] var0) {
		...
		for (var1 = 0; var1 < 2; ++var1) { // L: 118
			...
			int var10 = class4.iLog(var5 - 1); // L: 139
			...
			if (var1 != 0) { // L: 157
				field403 = var18; // L: 158
				field379 = var19; // L: 159
				field405 = var20; // L: 160
				field407 = var21; // L: 161
			} else {
				field400 = var18; // L: 164
				field401 = var19; // L: 165
				field402 = var20; // L: 166
				field385 = var21; // L: 167
			}
		}
