...
public class VorbisSample extends Node {
	...
	void read(byte[] var1) {
		...
		if (this.end < 0) { // L: 94
			...
			this.field367 = true; // L: 96
		}

		int var3 = var2.readInt(); // L: 98
		this.field379 = new byte[var3][]; // L: 99
	...
	float[] method1073(int var1) {
		VorbisSample_setData(this.field379[var1], 0); // L: 198
		readBit(); // L: 199
		int var2 = readBits(Client.iLog(VorbisSample_mapping.length - 1)); // L: 200
		...
		for (var17 = 0; var17 < var14.submaps; ++var17) { // L: 244
			...
			float[] var44 = field363; // L: 246
			var42.method858(var44, var4 >> 1, var45); // L: 247
		}
		...
		if (!var15) { // L: 250
			...
			VorbisSample_floors[var18].method741(field363, var4 >> 1); // L: 253
		}
		...
		if (var15) { // L: 256
			...
			float[] var40 = var3 ? field388 : field389; // L: 266
			float[] var22 = var3 ? field364 : field386; // L: 267
			float[] var23 = var3 ? field390 : field387; // L: 268
			int[] var24 = var3 ? field392 : field391; // L: 269
			...
			var25 = Client.iLog(var4 - 1); // L: 290
			...
			for (var46 = var11; var46 < var12; ++var46) { // L: 365
				...
				var10000 = field363; // L: 367
				var10000[var46] *= (float)Math.sin(1.5707963267948966D * (double)var27 * (double)var27);
			}
		}

		float[] var41 = null; // L: 370
		if (this.field371 > 0) { // L: 371
			var18 = var4 + this.field371 >> 2; // L: 372
			var41 = new float[var18]; // L: 373
			int var43;
			if (!this.field383) { // L: 374
				for (var19 = 0; var19 < this.field382; ++var19) { // L: 375
					var43 = var19 + (this.field371 >> 1); // L: 376
					var41[var19] += this.field380[var43]; // L: 377
				}
			}
			...
			if (!var15) { // L: 380
				for (var19 = var8; var19 < var4 >> 1; ++var19) { // L: 381
					...
					var41[var43] += field363[var19]; // L: 383
				}
			}
		}

		float[] var54 = this.field380; // L: 387
		this.field380 = field363; // L: 388
		field363 = var54; // L: 389
		this.field371 = var4; // L: 390
		this.field382 = var12 - (var4 >> 1); // L: 391
		this.field383 = var15; // L: 392
		return var41; // L: 393
	}
	...
	RawSound toRawSound(int[] var1) {
		if (var1 != null && var1[0] <= 0) { // L: 421
			...
			if (this.samples == null) { // L: 422
				this.field371 = 0; // L: 423
				this.field380 = new float[VorbisSample_blockSize1]; // L: 424
				this.samples = new byte[this.sampleCount]; // L: 425
				this.field394 = 0; // L: 426
				this.field395 = 0; // L: 427
			}

			for (; this.field395 < this.field379.length; ++this.field395) { // L: 429 444
				if (var1 != null && var1[0] <= 0) { // L: 430
					return null;
				}

				float[] var2 = this.method1073(this.field395); // L: 431
				if (var2 != null) { // L: 432
					int var3 = this.field394; // L: 433
					...
					if (var1 != null) { // L: 441
						var1[0] -= var3 - this.field394;
					}

					this.field394 = var3; // L: 442
				}
			}

			this.field380 = null; // L: 446
			byte[] var7 = this.samples; // L: 447
			this.samples = null; // L: 448
			return new RawSound(this.sampleRate, var7, this.start, this.end, this.field367); // L: 449
		}
	}
	...
	static void method1072(byte[] var0) {
		...
		field363 = new float[VorbisSample_blockSize1]; // L: 117
		...
		for (var1 = 0; var1 < 2; ++var1) { // L: 118
			...
			int var10 = Client.iLog(var5 - 1); // L: 139
			...
			if (var1 != 0) { // L: 157
				field388 = var18; // L: 158
				field364 = var19; // L: 159
				field390 = var20; // L: 160
				field392 = var21; // L: 161
			} else {
				field389 = var18; // L: 164
				field386 = var19; // L: 165
				field387 = var20; // L: 166
				field391 = var21; // L: 167
			}
		}
