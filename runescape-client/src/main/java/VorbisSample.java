...
public class VorbisSample extends Node {
	...
	void read(byte[] var1) {
		...
		this.field366 = new byte[var3][]; // L: 99
	...
	float[] method970(int var1) {
		VorbisSample_setData(this.field366[var1], 0); // L: 198
		readBit(); // L: 199
		int var2 = readBits(ViewportMouse.iLog(VorbisSample_mapping.length - 1)); // L: 200
		...
		for (var17 = 0; var17 < var14.submaps; ++var17) { // L: 244
			...
			float[] var44 = field384; // L: 246
			var42.method760(var44, var4 >> 1, var45); // L: 247
		}
		...
		if (!var15) { // L: 250
			...
			VorbisSample_floors[var18].method658(field384, var4 >> 1); // L: 253
		}
		...
		if (var15) { // L: 256
			...
			float[] var40 = var3 ? field388 : field385; // L: 266
			float[] var22 = var3 ? field389 : field369; // L: 267
			float[] var23 = var3 ? field379 : field386; // L: 268
			...
			var25 = ViewportMouse.iLog(var4 - 1); // L: 290
			...
			for (var46 = var11; var46 < var12; ++var46) { // L: 365
				...
				var10000 = field384; // L: 367
				var10000[var46] *= (float)Math.sin(1.5707963267948966D * (double)var27 * (double)var27);
			}
		}

		float[] var41 = null; // L: 370
		if (this.field390 > 0) { // L: 371
			var18 = var4 + this.field390 >> 2; // L: 372
			var41 = new float[var18]; // L: 373
			int var43;
			if (!this.field394) { // L: 374
				for (var19 = 0; var19 < this.field382; ++var19) { // L: 375
					var43 = var19 + (this.field390 >> 1); // L: 376
			...
			if (!var15) { // L: 380
				for (var19 = var8; var19 < var4 >> 1; ++var19) { // L: 381
					...
					var41[var43] += field384[var19]; // L: 383
				}
			}
		}

		float[] var54 = this.field380; // L: 387
		this.field380 = field384; // L: 388
		field384 = var54; // L: 389
		this.field390 = var4; // L: 390
		this.field382 = var12 - (var4 >> 1); // L: 391
		this.field394 = var15; // L: 392
		return var41; // L: 393
	}
	...
	RawSound toRawSound(int[] var1) {
		if (var1 != null && var1[0] <= 0) { // L: 421
			...
			if (this.samples == null) { // L: 422
				this.field390 = 0; // L: 423
				this.field380 = new float[VorbisSample_blockSize1]; // L: 424
				this.samples = new byte[this.sampleCount]; // L: 425
				this.field373 = 0; // L: 426
				this.field395 = 0; // L: 427
			}

			for (; this.field395 < this.field366.length; ++this.field395) { // L: 429 444
				if (var1 != null && var1[0] <= 0) { // L: 430
					return null;
				}

				float[] var2 = this.method970(this.field395); // L: 431
				if (var2 != null) { // L: 432
					int var3 = this.field373; // L: 433
	...
	static void method964(byte[] var0) {
		...
		field384 = new float[VorbisSample_blockSize1]; // L: 117
		...
		for (var1 = 0; var1 < 2; ++var1) { // L: 118
			...
			int var10 = ViewportMouse.iLog(var5 - 1); // L: 139
			...
			if (var1 != 0) { // L: 157
				...
				field389 = var19; // L: 159
				field379 = var20; // L: 160
				field392 = var21; // L: 161
			} else {
				field385 = var18; // L: 164
				field369 = var19; // L: 165
