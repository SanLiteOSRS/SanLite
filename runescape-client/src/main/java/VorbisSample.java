...
public class VorbisSample extends Node {
	...
	void read(byte[] var1) {
		...
		if (this.end < 0) { // L: 94
			...
			this.field399 = true; // L: 96
		}

		int var3 = var2.readInt(); // L: 98
		this.field423 = new byte[var3][]; // L: 99
	...
	float[] method1123(int var1) {
		VorbisSample_setData(this.field423[var1], 0); // L: 182
		readBit(); // L: 183
		int var2 = readBits(Player.iLog(VorbisSample_mapping.length - 1)); // L: 184
		...
		for (var17 = 0; var17 < var14.submaps; ++var17) { // L: 228
			...
			float[] var44 = field416; // L: 230
			var42.method895(var44, var4 >> 1, var45); // L: 231
		}
		...
		if (!var15) { // L: 234
			...
			VorbisSample_floors[var18].method776(field416, var4 >> 1); // L: 237
		}
		...
		if (var15) { // L: 240
			...
			float[] var40 = var3 ? field420 : field417; // L: 250
			float[] var22 = var3 ? field422 : field418; // L: 251
			float[] var23 = var3 ? field398 : field419; // L: 252
			int[] var24 = var3 ? field424 : field413; // L: 253
			...
			var25 = Player.iLog(var4 - 1); // L: 274
			...
			for (var46 = var11; var46 < var12; ++var46) { // L: 349
				...
				var10000 = field416; // L: 351
				var10000[var46] *= (float)Math.sin(1.5707963267948966D * (double)var27 * (double)var27);
			}
		}

		float[] var41 = null; // L: 354
		if (this.field427 > 0) { // L: 355
			var18 = var4 + this.field427 >> 2; // L: 356
			var41 = new float[var18]; // L: 357
			int var43;
			if (!this.field415) { // L: 358
				for (var19 = 0; var19 < this.field414; ++var19) { // L: 359
					var43 = var19 + (this.field427 >> 1); // L: 360
					var41[var19] += this.field412[var43]; // L: 361
				}
			}
			...
			if (!var15) { // L: 364
				for (var19 = var8; var19 < var4 >> 1; ++var19) { // L: 365
					...
					var41[var43] += field416[var19]; // L: 367
				}
			}
		}

		float[] var54 = this.field412; // L: 371
		this.field412 = field416; // L: 372
		field416 = var54; // L: 373
		this.field427 = var4; // L: 374
		this.field414 = var12 - (var4 >> 1); // L: 375
		this.field415 = var15; // L: 376
		return var41; // L: 377
	}
	...
	RawSound toRawSound(int[] var1) {
		if (var1 != null && var1[0] <= 0) { // L: 405
			...
			if (this.samples == null) { // L: 406
				this.field427 = 0; // L: 407
				this.field412 = new float[VorbisSample_blockSize1]; // L: 408
				this.samples = new byte[this.sampleCount]; // L: 409
				this.field410 = 0; // L: 410
				this.field425 = 0; // L: 411
			}

			for (; this.field425 < this.field423.length; ++this.field425) { // L: 413 428
				if (var1 != null && var1[0] <= 0) { // L: 414
					return null;
				}

				float[] var2 = this.method1123(this.field425); // L: 415
				if (var2 != null) { // L: 416
					int var3 = this.field410; // L: 417
					...
					this.field410 = var3; // L: 426
				}
			}

			this.field412 = null; // L: 430
			byte[] var7 = this.samples; // L: 431
			this.samples = null; // L: 432
			return new RawSound(this.sampleRate, var7, this.start, this.end, this.field399); // L: 433
		}
	}
	...
	static void method1098(byte[] var0) {
		...
		field416 = new float[VorbisSample_blockSize1]; // L: 117
		...
		for (var1 = 0; var1 < 2; ++var1) { // L: 118
			...
			int var10 = Player.iLog(var5 - 1); // L: 139
			...
			if (var1 != 0) { // L: 141
				field420 = var12; // L: 142
				field422 = var13; // L: 143
				field398 = var14; // L: 144
				field424 = var15; // L: 145
			} else {
				field417 = var12; // L: 148
				field418 = var13; // L: 149
				field419 = var14; // L: 150
				field413 = var15; // L: 151
			}
		}
