...
public class VorbisSample extends Node {
	...
	void read(byte[] var1) {
		...
		if (this.end < 0) { // L: 94
			...
			this.field381 = true; // L: 96
		}

		int var3 = var2.readInt(); // L: 98
		this.field397 = new byte[var3][]; // L: 99
	...
	float[] method1087(int var1) {
		VorbisSample_setData(this.field397[var1], 0); // L: 198
		readBit(); // L: 199
		int var2 = readBits(LoginPacket.iLog(VorbisSample_mapping.length - 1)); // L: 200
		...
		for (var17 = 0; var17 < var14.submaps; ++var17) { // L: 244
			...
			float[] var44 = field398; // L: 246
			var42.method894(var44, var4 >> 1, var45); // L: 247
		}
		...
		if (!var15) { // L: 250
			...
			VorbisSample_floors[var18].method794(field398, var4 >> 1); // L: 253
		}
		...
		if (var15) { // L: 256
			...
			float[] var40 = var3 ? field391 : field409; // L: 266
			float[] var22 = var3 ? field403 : field400; // L: 267
			float[] var23 = var3 ? field404 : field401; // L: 268
			int[] var24 = var3 ? field406 : field405; // L: 269
			...
			var25 = LoginPacket.iLog(var4 - 1); // L: 290
			...
			for (var46 = var11; var46 < var12; ++var46) { // L: 365
				...
				var10000 = field398; // L: 367
				var10000[var46] *= (float)Math.sin(1.5707963267948966D * (double)var27 * (double)var27);
			}
		}

		float[] var41 = null; // L: 370
		if (this.field395 > 0) { // L: 371
			var18 = var4 + this.field395 >> 2; // L: 372
			var41 = new float[var18]; // L: 373
			int var43;
			if (!this.field385) { // L: 374
				for (var19 = 0; var19 < this.field396; ++var19) { // L: 375
					var43 = var19 + (this.field395 >> 1); // L: 376
					var41[var19] += this.field394[var43]; // L: 377
				}
			}
			...
			if (!var15) { // L: 380
				for (var19 = var8; var19 < var4 >> 1; ++var19) { // L: 381
					...
					var41[var43] += field398[var19]; // L: 383
				}
			}
		}

		float[] var54 = this.field394; // L: 387
		this.field394 = field398; // L: 388
		field398 = var54; // L: 389
		this.field395 = var4; // L: 390
		this.field396 = var12 - (var4 >> 1); // L: 391
		this.field385 = var15; // L: 392
		return var41; // L: 393
	}
	...
	RawSound toRawSound(int[] var1) {
		if (var1 != null && var1[0] <= 0) { // L: 421
			...
			if (this.samples == null) { // L: 422
				this.field395 = 0; // L: 423
				this.field394 = new float[VorbisSample_blockSize1]; // L: 424
				this.samples = new byte[this.sampleCount]; // L: 425
				this.field392 = 0; // L: 426
				this.field388 = 0; // L: 427
			}

			for (; this.field388 < this.field397.length; ++this.field388) { // L: 429 444
				if (var1 != null && var1[0] <= 0) { // L: 430
					return null;
				}

				float[] var2 = this.method1087(this.field388); // L: 431
				if (var2 != null) { // L: 432
					int var3 = this.field392; // L: 433
					...
					this.field392 = var3; // L: 442
				}
			}

			this.field394 = null; // L: 446
			byte[] var7 = this.samples; // L: 447
			this.samples = null; // L: 448
			return new RawSound(this.sampleRate, var7, this.start, this.end, this.field381); // L: 449
		}
	}
	...
	static void method1086(byte[] var0) {
		...
		field398 = new float[VorbisSample_blockSize1]; // L: 117
		...
		for (var1 = 0; var1 < 2; ++var1) { // L: 118
			...
			int var10 = LoginPacket.iLog(var5 - 1); // L: 139
			...
			if (var1 != 0) { // L: 157
				field391 = var18; // L: 158
				field403 = var19; // L: 159
				field404 = var20; // L: 160
				field406 = var21; // L: 161
			} else {
				field409 = var18; // L: 164
				field400 = var19; // L: 165
				field401 = var20; // L: 166
				field405 = var21; // L: 167
			}
		}
