...
public class VorbisSample extends Node {
	...
	float[] method2474(int var1) {
		...
		for (var17 = 0; var17 < var14.submaps; ++var17) {
			...
			var18.method2635(var19, var4 >> 1, var45);
		}
		...
		if (!var15) {
			...
			VorbisSample_floors[var40].method2517(field1349, var4 >> 1);
		}
	...
	RawSound toRawSound(int[] var1) {
		if (var1 != null && var1[0] <= 0) {
			...
			for (; this.field1360 < this.field1350.length; ++this.field1360) {
				...
				float[] var2 = this.method2474(this.field1360);
				if (var2 != null) {
	...
	@ObfuscatedName("l")
	static void method2473(byte[] var0) {
		...
		for (var1 = 0; var1 < 2; ++var1) {
			...
			for (int var11 = 0; var11 < var5; ++var11) {
				var14[var11] = UserComparator3.method3518(var11, var10);
			}
	...
	static boolean method2476(AbstractArchive var0) {
		if (!field1348) {
