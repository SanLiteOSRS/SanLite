...
public enum class312 implements Enumerated {
	...
	public static String method5953(CharSequence var0) {
	...
	static final void loadTerrain(Buffer var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		...
		if (var2 >= 0 && var2 < 104 && var3 >= 0 && var3 < 104) {
			...
			while (true) {
				...
				if (var7 == 0) {
					if (var1 == 0) {
						Tiles.Tiles_heights[0][var2][var3] = -SpotAnimationDefinition.method4529(var2 + 932731 + var4, var5 + 556238 + var3) * 8;
					} else {
