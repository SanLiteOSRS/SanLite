	...
	static final void drawActor2d(Actor var0, int var1, int var2, int var3, int var4, int var5) {
		if (var0 != null && var0.isVisible()) {
			...
			if (!var0.healthBars.method5014()) {
				...
				for (HealthBar var90 = (HealthBar)var0.healthBars.last(); var90 != null; var90 = (HealthBar)var0.healthBars.previous()) {
					...
					if (var91 == null) {
						...
						SpritePixels var94 = var76.getBackSprite();
						SpritePixels var77 = var76.getFrontSprite();
						var16 = 0;
			...
			if (var1 < var75) {
				...
				NPCComposition var92 = ((NPC)var0).definition;
				...
				if (var99 - var96 <= Client.cycle) {
					if (var95 == null) {
						...
						if (Client.viewportTempX > -1) {
							...
							int var41 = 0;
							int var42 = 0;
							SpritePixels var102 = var95.method4755();
							int var43;
							if (var102 != null) {
