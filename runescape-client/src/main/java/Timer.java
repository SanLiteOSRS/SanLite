...
public class Timer {
   ...
   public void method4897() {
      this.field3566 = SequenceDefinition.currentTimeMs();
   }
   ...
   public void method4898() {
      if (-1L != this.field3566) {
         this.field3562 = SequenceDefinition.currentTimeMs() - this.field3566;
         this.field3566 = -1L;
      }
   ...
   public void method4899(int var1) {
      this.field3558 = SequenceDefinition.currentTimeMs();
      this.field3564 = var1;
   }
   ...
   public void method4900() {
      if (this.field3558 != -1L) {
         this.field3561 = SequenceDefinition.currentTimeMs() - this.field3558;
         this.field3558 = -1L;
      }
