...
public class Archive extends AbstractArchive {
	...
	void loadRegionFromGroup(int var1) {
		Tile.method2974(this.index, var1);
	}
	...
	int groupLoadPercent(int var1) {
		if (super.groups[var1] != null) {
			...
			return this.validGroups[var1] ? 100 : PcmPlayer.method2591(this.index, var1);
		}
	}
	...
	public int percentage() {
		if (this.field3145) {
			...
			int var1 = PcmPlayer.method2591(255, this.index);
			if (var1 >= 100) {
				var1 = 99;
			}
	...
	public void write(int var1, byte[] var2, boolean var3, boolean var4) {
		if (var3) {
			...
			if (var4) {
				super.groups[var1] = MusicPatchPcmStream.method4012(var2, false);
			}
		}
	...
	public void load(ArchiveDisk var1, int var2, byte[] var3, boolean var4) {
		...
		if (var1 == this.masterDisk) {
			...
			if (var4) {
				super.groups[var2] = MusicPatchPcmStream.method4012(var3, false);
			}
		}
	...
	public boolean method4364(int var1) {
