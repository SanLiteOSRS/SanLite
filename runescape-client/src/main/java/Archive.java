...
public class Archive extends AbstractArchive {
	...
	void loadGroup(int var1) {
		if (this.archiveDisk != null && this.validGroups != null && this.validGroups[var1]) {
			...
			NameableContainer.requestNetFile(this, this.index, var1, super.groupCrcs[var1], (byte)2, true);
		}
	...
	void loadIndex(int var1, int var2) {
		...
		if (this.masterDisk != null) {
			...
			NameableContainer.requestNetFile(this, 255, this.index, this.indexCrc, (byte)0, true);
		}
		...
		if (var1 == this.masterDisk) {
			...
			if (var3 == null || var3.length <= 2) {
				...
				if (this.field3688 || var4) {
					NameableContainer.requestNetFile(this, this.index, var2, super.groupCrcs[var2], (byte)2, var4);
				}
