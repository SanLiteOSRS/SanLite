...
public class WorldMapScaleHandler {
	...
	void method3819(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		if (var7 != 0 && this.pixelsPerTile != 0 && this.tileTemplates != null) {
			var8 = this.method3820(var8, var7);
			var7 = this.method3847(var7);
	...
	static int method3857(int var0, Script var1, boolean var2) {
		if (var0 == 7100) {
			...
			if (var0 == 7106) {
				...
				Interpreter.Interpreter_intStack[++ChatChannel.Interpreter_intStackSize - 1] = GameEngine.method717() ? 1 : 0;
				return 1;
			} else if (var0 == 7110) {
	...
	static void method3856() {
		for (int var0 = 0; var0 < Client.menuOptionsCount; ++var0) {
			if (class160.method3253(Client.menuOpcodes[var0])) {
