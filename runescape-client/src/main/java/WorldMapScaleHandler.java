...
public class WorldMapScaleHandler {
	...
	@ObfuscatedSignature(
		...
		garbageValue = "1623922997"
	)
	void method5601(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		if (var7 != 0 && this.pixelsPerTile != 0 && this.tileTemplates != null) { // L: 14
			var8 = this.method5602(var8, var7); // L: 15
			var7 = this.method5629(var7); // L: 16
	...
	int method5602(int var1, int var2) {
		if (var2 == 9) { // L: 21
			var1 = var1 + 1 & 3;
		}
	...
	@ObfuscatedSignature(
		descriptor = "(II)I",
		garbageValue = "581822605"
	)
	int method5629(int var1) {
	...
	@ObfuscatedSignature(
		...
		garbageValue = "-1398058551"
	)
	@Export("encodeStringCp1252")
	public static int encodeStringCp1252(CharSequence var0, int var1, int var2, byte[] var3, int var4) {
		int var5 = var2 - var1; // L: 117

		for (int var6 = 0; var6 < var5; ++var6) { // L: 118
			char var7 = var0.charAt(var6 + var1); // L: 119
			if (var7 > 0 && var7 < 128 || var7 >= 160 && var7 <= 255) { // L: 120
				var3[var6 + var4] = (byte)var7;
			} else if (var7 == 8364) { // L: 121
				var3[var6 + var4] = -128;
			} else if (var7 == 8218) { // L: 122
				var3[var6 + var4] = -126;
			} else if (var7 == 402) { // L: 123
				var3[var6 + var4] = -125;
			} else if (var7 == 8222) { // L: 124
				var3[var6 + var4] = -124;
			} else if (var7 == 8230) { // L: 125
				var3[var6 + var4] = -123;
			} else if (var7 == 8224) { // L: 126
				var3[var6 + var4] = -122;
			} else if (var7 == 8225) { // L: 127
				var3[var6 + var4] = -121;
			} else if (var7 == 710) {
				var3[var6 + var4] = -120; // L: 128
			} else if (var7 == 8240) { // L: 129
				var3[var6 + var4] = -119;
			} else if (var7 == 352) { // L: 130
				var3[var6 + var4] = -118;
			} else if (var7 == 8249) { // L: 131
				var3[var6 + var4] = -117;
			} else if (var7 == 338) { // L: 132
				var3[var6 + var4] = -116;
			} else if (var7 == 381) { // L: 133
				var3[var6 + var4] = -114;
			} else if (var7 == 8216) { // L: 134
				var3[var6 + var4] = -111;
			} else if (var7 == 8217) { // L: 135
				var3[var6 + var4] = -110;
			} else if (var7 == 8220) { // L: 136
				var3[var6 + var4] = -109;
			} else if (var7 == 8221) { // L: 137
				var3[var6 + var4] = -108;
			} else if (var7 == 8226) { // L: 138
				var3[var6 + var4] = -107;
			} else if (var7 == 8211) { // L: 139
				var3[var6 + var4] = -106;
			} else if (var7 == 8212) { // L: 140
				var3[var6 + var4] = -105;
			} else if (var7 == 732) { // L: 141
				var3[var6 + var4] = -104;
			} else if (var7 == 8482) { // L: 142
				var3[var6 + var4] = -103;
			} else if (var7 == 353) { // L: 143
				var3[var6 + var4] = -102;
			} else if (var7 == 8250) { // L: 144
				var3[var6 + var4] = -101;
			} else if (var7 == 339) {
				var3[var6 + var4] = -100;
			} else if (var7 == 382) {
				var3[var6 + var4] = -98;
			} else if (var7 == 376) { // L: 147
				var3[var6 + var4] = -97;
			} else {
				var3[var6 + var4] = 63;
			}
	...
	@ObfuscatedName("ad")
	@ObfuscatedSignature(
		descriptor = "(Ljava/util/PriorityQueue;B)V",
		garbageValue = "119"
	)
	public static void method5604(PriorityQueue var0) {
		if (var0 != null) { // L: 145
			if (class304.field3389 != null) { // L: 148
				class304.field3389.set(true); // L: 149
			}

			class304.field3389 = new AtomicBoolean(false); // L: 151
			AtomicBoolean var1 = class304.field3389; // L: 152
			if (class304.field3390 == null) { // L: 153
				int var2 = Runtime.getRuntime().availableProcessors(); // L: 154
				class304.field3390 = new ThreadPoolExecutor(0, var2, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue(), new class305()); // L: 155
			}

			class304.field3390.submit(new class309(var0, var1)); // L: 162
		}
	} // L: 146 172
	...
	@ObfuscatedSignature(
		...
		garbageValue = "615916147"
	)
	static int method5611(int var0, Script var1, boolean var2) {
		if (var0 == 7463) { // L: 5073
			boolean var3 = Interpreter.Interpreter_intStack[--class336.Interpreter_intStackSize] == 1; // L: 5074
			class36.method680(var3); // L: 5075
			return 1; // L: 5076
		} else {
			return 2; // L: 5078
		}
