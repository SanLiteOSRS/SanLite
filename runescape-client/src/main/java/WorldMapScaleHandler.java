...
public class WorldMapScaleHandler {
	...
	void method5623(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		if (var7 != 0 && this.pixelsPerTile != 0 && this.tileTemplates != null) { // L: 14
			var8 = this.method5596(var8, var7); // L: 15
			var7 = this.method5590(var7); // L: 16
	...
	int method5596(int var1, int var2) {
		if (var2 == 9) { // L: 21
			var1 = var1 + 1 & 3;
		}
	...
	static void method5627(String var0, String var1, String var2) {
		PcmPlayer.method838(7); // L: 1058
		class318.setLoginResponseString(var0, var1, var2); // L: 1059
	} // L: 1060
}
