...
public final class Tile extends Node {
   ...
   static final void method2800(Widget[] var0, int var1) {
      for(int var2 = 0; var2 < var0.length; ++var2) {
         ...
         if (var3 != null && var3.parentId == var1 && (!var3.isIf3 || !WorldMapRectangle.isComponentHidden(var3))) {
            if (var3.type == 0) {
               ...
               method2800(var0, var3.id);
               if (var3.children != null) {
                  method2800(var3.children, var3.id);
               }

               InterfaceParent var4 = (InterfaceParent)Client.interfaceParents.get((long)var3.id);
               if (var4 != null) {
                  CollisionMap.method3505(var4.group);
               }
            }
            ...
            if (var3.type == 6) {
               ...
               if (var3.sequenceId != -1 || var3.sequenceId2 != -1) {
                  ...
                  if (var5 != -1) {
                     SequenceDefinition var6 = Widget.getSequenceDefinition(var5);

                     for(var3.modelFrameCycle += Client.field879; var3.modelFrameCycle > var6.frameLengths[var3.modelFrame]; FriendSystem.method1822(var3)) {
