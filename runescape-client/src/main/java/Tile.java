...
public final class Tile extends Node {
	...
	static void method2974(int var0, int var1) {
	...
	static void updateGameState(int var0) {
		if (var0 != Client.gameState) {
			...
			if (var0 != 5 && var0 != 10) {
				if (var0 == 20) {
					AttackOption.method2171(WorldMapID.archive10, GrandExchangeOfferUnitPriceComparator.archive8, true, Client.gameState == 11 ? 4 : 0);
				} else if (var0 == 11) {
					AttackOption.method2171(WorldMapID.archive10, GrandExchangeOfferUnitPriceComparator.archive8, false, 4);
				} else {
					Coord.method4091();
				}
			} else {
				AttackOption.method2171(WorldMapID.archive10, GrandExchangeOfferUnitPriceComparator.archive8, true, 0);
			}
