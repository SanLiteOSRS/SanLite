...
public class BufferedFile {
	...
	@ObfuscatedName("aj")
	@ObfuscatedGetter(
		longValue = -8005799789559438705L
	)
	...
	@ObfuscatedName("ae")
	@ObfuscatedGetter(
		longValue = -2653529926966607603L
	)
	@Export("offset")
	long offset;
	@ObfuscatedName("aa")
	@ObfuscatedGetter(
		longValue = -9033013771531036075L
	)
	@Export("fileLength")
	long fileLength;
	@ObfuscatedName("au")
	@ObfuscatedGetter(
		longValue = -3170888771294590305L
	)
	@Export("length")
	long length;
	@ObfuscatedName("an")
	@ObfuscatedGetter(
		longValue = -4960639015589933655L
	)
	@Export("fileOffset")
	long fileOffset;
	...
	void flush() throws IOException {
		if (-1L != this.writeBufferOffset) { // L: 203
			...
			this.fileOffset += (long)(this.writeBufferLength * -1208132891) * 958911213L; // L: 209
			...
			} else if ((long)this.readBufferLength + this.readBufferOffset > this.writeBufferOffset && (long)this.readBufferLength + this.readBufferOffset <= this.writeBufferOffset + (long)this.writeBufferLength) { // L: 222
	...
	static void method9180(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13) {
		var1 = var1 * 128 + 64; // L: 8401
		var2 = var2 * 128 + 64; // L: 8402
		var3 = var3 * 128 + 64; // L: 8403
		var4 = var4 * 128 + 64; // L: 8404
		Projectile var14 = new Projectile(var6, var0, var1, var2, class19.getTileHeight(var1, var2, var0) - var7, var9 + Client.cycle, var10 + Client.cycle, var11, var12, var13, var5, var8); // L: 8405
		var14.setDestination(var3, var4, class19.getTileHeight(var3, var4, var0) - var8, var9 + Client.cycle); // L: 8406
		Client.projectiles.addFirst(var14); // L: 8407
	} // L: 8408
}
