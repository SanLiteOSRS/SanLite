...
public class BufferedFile {
	...
	@ObfuscatedName("s")
	@ObfuscatedGetter(
		longValue = -1713604666211513627L
	)
	...
	@ObfuscatedName("i")
	@ObfuscatedGetter(
		longValue = 8570253542353991833L
	)
	...
	@ObfuscatedName("l")
	@ObfuscatedGetter(
		longValue = -3938799566274924245L
	)
	@Export("offset")
	long offset;
	@ObfuscatedName("k")
	@ObfuscatedGetter(
		longValue = -696543125861879049L
	)
	@Export("fileLength")
	long fileLength;
	@ObfuscatedName("c")
	@ObfuscatedGetter(
		longValue = 6796938297702318749L
	)
	@Export("length")
	long length;
	@ObfuscatedName("r")
	@ObfuscatedGetter(
		longValue = 1653772896461010051L
	)
	@Export("fileOffset")
	long fileOffset;
	...
	public void read(byte[] var1, int var2, int var3) throws IOException {
		try {
			...
			if (this.writeBufferOffset != -1L && this.offset >= this.writeBufferOffset && (long)var3 + this.offset <= this.writeBufferOffset + (long)this.writeBufferLength) { // L: 48
	...
	void flush() throws IOException {
		if (-1L != this.writeBufferOffset) { // L: 203
			...
			this.fileOffset += (long)(this.writeBufferLength * 1674953927) * -690242313L; // L: 209
