...
public class BufferedFile {
	...
	@ObfuscatedName("u")
	@ObfuscatedGetter(
		longValue = 5580912383959342363L
	)
	...
	@ObfuscatedName("z")
	@ObfuscatedGetter(
		longValue = -7566205741911140621L
	)
	...
	@ObfuscatedName("h")
	@ObfuscatedGetter(
		longValue = 9157510801637660763L
	)
	@Export("offset")
	long offset;
	@ObfuscatedName("a")
	@ObfuscatedGetter(
		longValue = -7743626329981743035L
	)
	@Export("fileLength")
	long fileLength;
	@ObfuscatedName("d")
	@ObfuscatedGetter(
		longValue = 1708470049103739879L
	)
	@Export("length")
	long length;
	@ObfuscatedName("n")
	@ObfuscatedGetter(
		longValue = 8038850996362597015L
	)
	@Export("fileOffset")
	long fileOffset;
	...
	public void write(byte[] var1, int var2, int var3) throws IOException {
		try {
			...
			if (this.writeBufferOffset != -1L && (long)var3 + this.offset > (long)this.writeBuffer.length + this.writeBufferOffset) { // L: 150
	...
	void flush() throws IOException {
		if (this.writeBufferOffset != -1L) { // L: 203
			...
			this.fileOffset += (long)(this.writeBufferLength * 1441748175) * 1263612463L; // L: 209
