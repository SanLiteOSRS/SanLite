...
public class BufferedFile {
	...
	@ObfuscatedName("aw")
	@ObfuscatedGetter(
		longValue = 4217700400936276559L
	)
	...
	@ObfuscatedName("av")
	@ObfuscatedGetter(
		longValue = 2670638303352278857L
	)
	...
	@ObfuscatedName("au")
	@ObfuscatedGetter(
		longValue = -1072877327171380061L
	)
	@Export("offset")
	long offset;
	@ObfuscatedName("az")
	@ObfuscatedGetter(
		longValue = -7553726531009097737L
	)
	@Export("fileLength")
	long fileLength;
	@ObfuscatedName("ab")
	@ObfuscatedGetter(
		longValue = 1455814456515414905L
	)
	@Export("length")
	long length;
	@ObfuscatedName("ao")
	@ObfuscatedGetter(
		longValue = -984951727125102751L
	)
	@Export("fileOffset")
	long fileOffset;
	...
	void flush() throws IOException {
		if (this.writeBufferOffset != -1L) { // L: 203
			...
			this.fileOffset += 1441811533L * (long)(this.writeBufferLength * -2075669371); // L: 209
			...
			if ((long)this.writeBufferLength + this.writeBufferOffset > this.readBufferOffset && this.writeBufferOffset + (long)this.writeBufferLength <= this.readBufferOffset + (long)this.readBufferLength) { // L: 219
