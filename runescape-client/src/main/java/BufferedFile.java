...
public class BufferedFile {
	...
	@ObfuscatedName("ad")
	@ObfuscatedGetter(
		longValue = 4593231514598027063L
	)
	@Export("offset")
	long offset;
	@ObfuscatedName("al")
	@ObfuscatedGetter(
		longValue = 9154017168134544831L
	)
	@Export("fileLength")
	long fileLength;
	@ObfuscatedName("as")
	@ObfuscatedGetter(
		longValue = 744568363063564321L
	)
	@Export("length")
	long length;
	@ObfuscatedName("ag")
	@ObfuscatedGetter(
		longValue = -7803352169320853855L
	)
	@Export("fileOffset")
	long fileOffset;
	...
	void flush() throws IOException {
		if (this.writeBufferOffset != -1L) { // L: 203
			...
			this.fileOffset += (long)(this.writeBufferLength * -1308767795) * -6534395L; // L: 209
			...
			if (this.writeBufferOffset + (long)this.writeBufferLength > this.readBufferOffset && (long)this.writeBufferLength + this.writeBufferOffset <= (long)this.readBufferLength + this.readBufferOffset) { // L: 219
