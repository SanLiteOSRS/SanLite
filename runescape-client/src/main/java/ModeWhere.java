...
public enum ModeWhere implements Enumerated {
	...
	static void drawTitle(Font var0, Font var1, Font var2) {
		Login.xPadding = (class68.canvasWidth - 765) / 2;
		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState == 20) {
				class304.titleboxSprite.drawAt(Login.loginBoxX + 180 - class304.titleboxSprite.subWidth / 2, 271 - class304.titleboxSprite.subHeight * -1478377216 / 2);
				var16 = 201;
