...
public enum ModeWhere implements MouseWheel {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
		...
		if (var2 == 1) { // L: 8924
			...
			var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2981, Client.packetWriter.isaacCipher); // L: 9298
			var8.packetBuffer.writeInt(class20.selectedItemWidget); // L: 9299
			var8.packetBuffer.method7550(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 9300
			var8.packetBuffer.method7551(SecureRandomCallable.baseX * 64 + var0); // L: 9301
			...
			var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3057, Client.packetWriter.isaacCipher); // L: 9106
			var8.packetBuffer.method7551(SecureRandomCallable.baseX * 64 + var0); // L: 9107
			var8.packetBuffer.writeShort(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 9108
			...
			var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2990, Client.packetWriter.isaacCipher); // L: 8945
			var8.packetBuffer.method7596(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8946
			var8.packetBuffer.method7550(var3); // L: 8947
			var8.packetBuffer.method7641(SecureRandomCallable.baseX * 64 + var0); // L: 8948
			var8.packetBuffer.method7551(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 8949
			...
			var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3049, Client.packetWriter.isaacCipher); // L: 9561
			var8.packetBuffer.method7641(var3); // L: 9562
			var8.packetBuffer.method7596(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 9563
			var8.packetBuffer.method7550(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 9564
			var8.packetBuffer.method7550(SecureRandomCallable.baseX * 64 + var0); // L: 9565
			...
			var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3041, Client.packetWriter.isaacCipher); // L: 9021
			var8.packetBuffer.method7641(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 9022
			var8.packetBuffer.method7687(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 9023
			var8.packetBuffer.writeShort(SecureRandomCallable.baseX * 64 + var0); // L: 9024
			...
			var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2999, Client.packetWriter.isaacCipher); // L: 9167
			var8.packetBuffer.writeShort(var3); // L: 9168
			var8.packetBuffer.writeShort(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 9169
			var8.packetBuffer.writeShort(SecureRandomCallable.baseX * 64 + var0); // L: 9170
			...
			if (var2 == 7) {
				...
				if (var13 != null) { // L: 9573
					...
					var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field2985, Client.packetWriter.isaacCipher); // L: 9581
				...
				if (var13 != null) { // L: 9636
					...
					var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field2984, Client.packetWriter.isaacCipher); // L: 9643
				...
				if (var13 != null) { // L: 9592
					...
					var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field3004, Client.packetWriter.isaacCipher); // L: 9600
				...
				if (var13 != null) { // L: 9392
					...
					var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field3030, Client.packetWriter.isaacCipher); // L: 9400
				...
				if (var13 != null) { // L: 9276
					...
					var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field3036, Client.packetWriter.isaacCipher); // L: 9284
				...
				if (var13 != null) { // L: 8954
					...
					var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field2977, Client.packetWriter.isaacCipher); // L: 8962
				...
				if (var13 != null) { // L: 9376
					...
					var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field3046, Client.packetWriter.isaacCipher); // L: 9384
				...
				if (var2 == 14) {
					...
					if (var15 != null) { // L: 9436
						...
						var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field3007, Client.packetWriter.isaacCipher); // L: 9444
					...
					if (var15 != null) { // L: 9480
						...
						var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field3022, Client.packetWriter.isaacCipher); // L: 9487
					...
					var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2996, Client.packetWriter.isaacCipher); // L: 9527
					var8.packetBuffer.method7641(SecureRandomCallable.baseX * 64 + var0); // L: 9528
					var8.packetBuffer.method7550(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 9529
					...
					var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3010, Client.packetWriter.isaacCipher); // L: 9357
					...
					var8.packetBuffer.method7641(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 9362
					var8.packetBuffer.writeInt(ArchiveDiskActionHandler.selectedSpellWidget); // L: 9363
					var8.packetBuffer.writeShort(SecureRandomCallable.baseX * 64 + var0); // L: 9364
					...
					var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3013, Client.packetWriter.isaacCipher); // L: 9063
					var8.packetBuffer.method7550(SecureRandomCallable.baseX * 64 + var0); // L: 9064
					var8.packetBuffer.method7551(var3); // L: 9065
					var8.packetBuffer.method7641(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 9066
					...
					var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2987, Client.packetWriter.isaacCipher); // L: 9695
					var8.packetBuffer.method7542(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 9696
					var8.packetBuffer.method7550(SecureRandomCallable.baseX * 64 + var0); // L: 9697
					var8.packetBuffer.method7641(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 9698
					...
					var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2997, Client.packetWriter.isaacCipher); // L: 9256
					var8.packetBuffer.writeShort(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 9257
					var8.packetBuffer.method7596(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 9258
					var8.packetBuffer.method7551(SecureRandomCallable.baseX * 64 + var0); // L: 9259
					...
					var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2976, Client.packetWriter.isaacCipher); // L: 9195
					var8.packetBuffer.method7596(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 9196
					var8.packetBuffer.method7550(SecureRandomCallable.baseX * 64 + var0); // L: 9197
					var8.packetBuffer.writeShort(var3); // L: 9198
					var8.packetBuffer.writeShort(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 9199
					...
					var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2978, Client.packetWriter.isaacCipher); // L: 8990
					var8.packetBuffer.method7687(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8991
					var8.packetBuffer.method7550(var3); // L: 8992
					var8.packetBuffer.method7551(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 8993
					var8.packetBuffer.method7641(SecureRandomCallable.baseX * 64 + var0); // L: 8994
					...
					if (var2 == 24) {
						...
						if (var16 != null) { // L: 9467
							...
							if (var12) { // L: 9470
								var11 = DecorativeObject.getPacketBufferNode(ClientPacket.field3014, Client.packetWriter.isaacCipher); // L: 9472
						...
						if (var2 == 26) {
							...
							Widget var14;
							if (var2 == 28) {
								var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3014, Client.packetWriter.isaacCipher); // L: 9498
								...
								var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3014, Client.packetWriter.isaacCipher); // L: 9072
								...
								var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2992, Client.packetWriter.isaacCipher); // L: 8970
								...
								var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3025, Client.packetWriter.isaacCipher); // L: 9204
								...
								var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2971, Client.packetWriter.isaacCipher); // L: 9150
								...
								var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3045, Client.packetWriter.isaacCipher); // L: 9510
								...
								var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3050, Client.packetWriter.isaacCipher); // L: 9408
								...
								var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3028, Client.packetWriter.isaacCipher); // L: 9619
								...
								var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2979, Client.packetWriter.isaacCipher); // L: 9030
								...
								if (var2 == 38) {
									...
									Client.selectedItemName = class166.colorStartTag(16748608) + FileSystem.ItemComposition_get(var3).name + class166.colorStartTag(16777215); // L: 9461
								...
								if (var2 == 39) {
									var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3024, Client.packetWriter.isaacCipher); // L: 9320
									...
									var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3008, Client.packetWriter.isaacCipher); // L: 9654
									...
									var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field3018, Client.packetWriter.isaacCipher); // L: 9608
									...
									var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2961, Client.packetWriter.isaacCipher); // L: 9265
									...
									var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2966, Client.packetWriter.isaacCipher); // L: 9331
									...
									if (var15 != null) { // L: 9673
										...
										var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field2965, Client.packetWriter.isaacCipher); // L: 9681
									...
									if (var15 != null) { // L: 9134
										...
										var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field2975, Client.packetWriter.isaacCipher); // L: 9142
									...
									if (var15 != null) { // L: 8999
										...
										var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field3003, Client.packetWriter.isaacCipher); // L: 9007
									...
									if (var15 != null) { // L: 9118
										...
										var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field2962, Client.packetWriter.isaacCipher); // L: 9126
									...
									if (var15 != null) { // L: 9041
										...
										var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field2995, Client.packetWriter.isaacCipher); // L: 9049
									...
									if (var15 != null) { // L: 9704
										...
										var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field2969, Client.packetWriter.isaacCipher); // L: 9712
									...
									if (var15 != null) { // L: 9539
										...
										var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field2980, Client.packetWriter.isaacCipher); // L: 9547
									...
									if (var15 != null) { // L: 9217
										...
										var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field3019, Client.packetWriter.isaacCipher); // L: 9225
										...
										if (var2 != 57) {
											if (var2 == 58) {
												...
												if (var16 != null) { // L: 9236
													var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field2963, Client.packetWriter.isaacCipher); // L: 9238
											...
											if (var2 == 1001) {
												...
												var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2994, Client.packetWriter.isaacCipher); // L: 9092
												var8.packetBuffer.writeShort(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var1); // L: 9093
												var8.packetBuffer.writeShort(var3); // L: 9094
												var8.packetBuffer.method7641(SecureRandomCallable.baseX * 64 + var0); // L: 9095
											...
											if (var2 == 1002) {
												...
												var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2950, Client.packetWriter.isaacCipher); // L: 9314
											...
											if (var2 == 1003) {
												...
												if (var13 != null) { // L: 9423
													...
													if (var17 != null) { // L: 9426
														var11 = DecorativeObject.getPacketBufferNode(ClientPacket.field3016, Client.packetWriter.isaacCipher); // L: 9428
											...
											if (var2 == 1004) {
												...
												var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2986, Client.packetWriter.isaacCipher); // L: 9346
											...
											if (var2 == 1005) {
												...
												if (var16 != null && var16.itemQuantities[var0] >= 100000) { // L: 8926
													WorldMapEvent.addGameMessage(27, "", var16.itemQuantities[var0] + " x " + FileSystem.ItemComposition_get(var3).name);
												} else {
													var9 = DecorativeObject.getPacketBufferNode(ClientPacket.field2986, Client.packetWriter.isaacCipher); // L: 8929
