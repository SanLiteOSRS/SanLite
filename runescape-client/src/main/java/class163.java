...
public class class163 extends class166 {
	...
	public static void method3318(AbstractArchive var0, AbstractArchive var1, boolean var2, Font var3) {
		SoundCache.ItemComposition_archive = var0;
		AttackOption.ItemComposition_modelArchive = var1;
		DevicePcmPlayerProvider.ItemComposition_inMembersWorld = var2;
		class293.ItemComposition_fileCount = SoundCache.ItemComposition_archive.getGroupFileCount(10);
		ParamComposition.ItemComposition_fontPlain11 = var3;
	}
	...
	static final void method3315(PendingSpawn var0) {
		...
		int var5 = 0;
		if (var0.type == 0) {
			var1 = ArchiveLoader.scene.getWallObjectTag(var0.plane, var0.x, var0.y);
		}

		if (var0.type == 1) {
			var1 = ArchiveLoader.scene.getDecorativeObjectTag(var0.plane, var0.x, var0.y);
		}
		...
		if (var0.type == 3) {
			var1 = ArchiveLoader.scene.getGroundObjectTag(var0.plane, var0.x, var0.y);
		}
