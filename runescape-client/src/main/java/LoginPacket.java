...
public class LoginPacket implements class224 {
	...
	static {
		...
		field2801 = new LoginPacket(15, 4);
		field2802 = new LoginPacket(16, -2);
		field2803 = new LoginPacket(18, -2);
		field2804 = new LoginPacket(19, -2);
		field2809 = new LoginPacket(27, 0);
	...
	public static class269[] method4510() {
		return new class269[]{class269.field3532, class269.field3533, class269.field3535, class269.field3534};
	}
}
