	...
	static final void method3673(Scene var0, CollisionMap[] var1) {
		...
		for (var2 = 0; var2 < 4; ++var2) {
			...
			for (var11 = 0; var11 < 104; ++var11) {
				VarbitComposition.Tiles_hue[var11] = 0;
			...
			for (var11 = -5; var11 < 109; ++var11) {
				for (var12 = 0; var12 < 104; ++var12) {
					...
					if (var13 >= 0 && var13 < 104) {
						...
						if (var14 > 0) {
							FloorUnderlayDefinition var43 = WorldMapElement.method4405(var14 - 1);
							var10000 = VarbitComposition.Tiles_hue;
					...
					if (var14 >= 0 && var14 < 104) {
						...
						if (var15 > 0) {
							FloorUnderlayDefinition var44 = WorldMapElement.method4405(var15 - 1);
							var10000 = VarbitComposition.Tiles_hue;
				...
				if (var11 >= 1 && var11 < 103) {
					...
					for (var17 = -5; var17 < 109; ++var17) {
						...
						if (var18 >= 0 && var18 < 104) {
							var12 += VarbitComposition.Tiles_hue[var18];
						...
						if (var19 >= 0 && var19 < 104) {
							var12 -= VarbitComposition.Tiles_hue[var19];
