			...
			if (var18 == null) {
				...
				if (var9) {
					if (-1L != this.field3016) {
						var18 = (Model)Widget_cachedModels.get(this.field3016);
					}
				...
				if (var18 == null) {
					...
					for (var13 = 0; var13 < 5; ++var13) {
						if (this.bodyColors[var13] < class11.field54[var13].length) {
							var20.recolor(Nameable.field3948[var13], class11.field54[var13][this.bodyColors[var13]]);
						}
			...
			if (var1) {
				...
				for (var5 = 0; var5 < 5; ++var5) {
					if (this.bodyColors[var5] < class11.field54[var5].length) {
						var8.recolor(Nameable.field3948[var5], class11.field54[var5][this.bodyColors[var5]]);
					}
