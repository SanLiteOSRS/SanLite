...
public class PlayerComposition {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.hintArrowType == 2) { // L: 4928
			class514.worldToScreen(Client.field512 * 64 + (Client.field509 - class187.baseX * 64 << 7), Client.field513 * 64 + (Client.field510 - class101.baseY * 64 << 7), Client.field511 * 4); // L: 4929
