		...
		if (this.npcTransformId != -1) { // L: 138
			...
			if (var18 == null) { // L: 156
				...
				for (int var10 = 0; var10 < 12; ++var10) { // L: 158
					...
					if (var11 >= 512 && !UserComparator3.ItemComposition_get(var11 - 512).hasNoValidModel(this.isFemale)) { // L: 163 164
						var9 = true;
					}
				}
				...
				if (var9) { // L: 167
					if (-1L != this.field3364) { // L: 168
						var18 = (Model)PlayerComposition_cachedModels.get(this.field3364);
					}
				...
				if (var18 == null) { // L: 171
					...
					for (int var12 = 0; var12 < 12; ++var12) { // L: 174
						...
						if (var13 >= 512) { // L: 180
							ItemComposition var22 = UserComparator3.ItemComposition_get(var13 - 512); // L: 181
							ModelData var15 = var22.method3887(this.isFemale); // L: 182
							if (var15 != null) { // L: 183
								if (this.field3365 != null) { // L: 184
									class168 var16 = this.field3365[var12]; // L: 185
									if (var16 != null) { // L: 186
										int var17;
										if (var16.field1835 != null && var22.recolorFrom != null && var16.field1835.length == var22.recolorTo.length) { // L: 187
											for (var17 = 0; var17 < var22.recolorFrom.length; ++var17) { // L: 188
												var15.recolor(var22.recolorTo[var17], var16.field1835[var17]); // L: 189
											}
										}

										if (var16.field1833 != null && var22.retextureFrom != null && var22.retextureTo.length == var16.field1833.length) { // L: 192
											for (var17 = 0; var17 < var22.retextureFrom.length; ++var17) { // L: 193
												var15.retexture(var22.retextureTo[var17], var16.field1833[var17]); // L: 194
											}
										}
									}
								}
	...
	ModelData getModelData() {
		if (this.npcTransformId != -1) { // L: 222
			...
			for (int var2 = 0; var2 < 12; ++var2) { // L: 226
				...
				if (var3 >= 512 && !UserComparator3.ItemComposition_get(var3 - 512).method3833(this.isFemale)) { // L: 231 232
					var1 = true;
				}
			}
			...
			if (var1) { // L: 235
				...
				for (int var4 = 0; var4 < 12; ++var4) { // L: 238
					...
					if (var5 >= 512) { // L: 244
						var6 = UserComparator3.ItemComposition_get(var5 - 512).method3845(this.isFemale); // L: 245
						if (var6 != null) { // L: 246
							var7[var3++] = var6;
						}
					}
