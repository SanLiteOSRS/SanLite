			...
			if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFEREMPTY) {
				...
				if (var0 == ScriptOpcodes.TRADINGPOST_SORTBY_NAME) {
					...
					if (WorldMapSectionType.grandExchangeEvents != null) {
						WorldMapSectionType.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_nameComparator, var13);
					}
					...
					var13 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
					if (WorldMapSectionType.grandExchangeEvents != null) {
						WorldMapSectionType.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_priceComparator, var13);
					}
					...
					if (WorldMapSectionType.grandExchangeEvents != null) {
						...
						WorldMapSectionType.grandExchangeEvents.sort(Client.GrandExchangeEvents_worldComparator, var13);
					}
					...
					var13 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
					if (WorldMapSectionType.grandExchangeEvents != null) {
						WorldMapSectionType.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_ageComparator, var13);
					}
					...
					var13 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
					if (WorldMapSectionType.grandExchangeEvents != null) {
						WorldMapSectionType.grandExchangeEvents.sort(GrandExchangeEvents.GrandExchangeEvents_quantityComparator, var13);
					}
					...
					if (var0 == ScriptOpcodes.TRADINGPOST_GETOFFERWORLD) {
						var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
						var11 = (GrandExchangeEvent)WorldMapSectionType.grandExchangeEvents.events.get(var3);
						...
						var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
						var11 = (GrandExchangeEvent)WorldMapSectionType.grandExchangeEvents.events.get(var3);
						long var5 = Tiles.currentTimeMillis() - class9.field57 - var11.age;
