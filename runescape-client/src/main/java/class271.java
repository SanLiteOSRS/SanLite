				...
				if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYTYPEANDLINE) { // L: 3529
					...
					if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYUID) { // L: 3552
						...
						if (var0 == ScriptOpcodes.CHAT_SENDPUBLIC) { // L: 3578
							...
							var12 = DecorativeObject.method4664(var7, var8, clientLanguage, -1); // L: 3581
							...
							var12 = class120.getPacketBufferNode(ClientPacket.field2978, Client.packetWriter.isaacCipher); // L: 3590
							...
							var6 = DecorativeObject.method4664(var7, var8, clientLanguage, var9); // L: 3604
