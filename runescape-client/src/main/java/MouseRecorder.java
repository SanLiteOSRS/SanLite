...
public class MouseRecorder implements Runnable {
	...
	public void run() {
		for (; this.isRunning; class236.method4165(50L)) {
	...
	static final void updateItemPile(int var0, int var1) {
		...
		if (var2 == null) {
			...
			for (var6 = (TileItem)var2.last(); var6 != null; var6 = (TileItem)var2.previous()) {
				ItemComposition var7 = SecureRandomCallable.ItemDefinition_get(var6.id);
			...
			if (var5 == null) {
				...
				ArchiveLoader.scene.newGroundItemPile(GameObject.Client_plane, var0, var1, SecureRandomFuture.getTileHeight(var0 * 128 + 64, var1 * 128 + 64, GameObject.Client_plane), var5, var9, var12, var11);
			}
		}
	}
	...
	static final void closeInterface(InterfaceParent var0, boolean var1) {
		...
		Widget var4 = CollisionMap.getWidget(var3);
		if (var4 != null) {
