...
public class Interpreter {
	...
	public static void method1876(String var0, String var1, int var2, int var3) throws IOException {
		...
		while (var18 < 4) {
			...
			if (var7 == null && var18 == 0) {
				label271:
				for (int var20 = 0; var20 < class121.cacheSubPaths.length; ++var20) {
			...
			if (var9) {
				WallObject.method4277(new File(var7), (File)null);
			}
		...
		try {
			...
			if (var4.exists()) {
				...
				label222:
				for (int var27 = 0; var27 < class121.cacheSubPaths.length; ++var27) {
	...
	static final void drawScrollBar(int var0, int var1, int var2, int var3, int var4) {
		...
		Rasterizer2D.method7655(var0, var6 + var1 + 16, var5, Client.field562);
		Rasterizer2D.method7655(var0 + 1, var6 + var1 + 16, var5, Client.field562);
		Rasterizer2D.method7671(var0, var6 + var1 + 16, 16, Client.field562);
		Rasterizer2D.method7671(var0, var6 + var1 + 17, 16, Client.field562);
		Rasterizer2D.method7655(var0 + 15, var6 + var1 + 16, var5, Client.field569);
		Rasterizer2D.method7655(var0 + 14, var6 + var1 + 17, var5 - 1, Client.field569);
		Rasterizer2D.method7671(var0, var5 + var6 + var1 + 15, 16, Client.field569);
		Rasterizer2D.method7671(var0 + 1, var5 + var6 + var1 + 14, 15, Client.field569);
	}
