...
public class Texture extends Node {
	...
	Texture(Buffer var1) {
		...
		this.field2470 = var1.readUnsignedByte() == 1; // L: 30
		...
		if (var2 >= 1 && var2 <= 4) { // L: 32
			...
			if (var2 > 1) { // L: 37
				this.field2465 = new int[var2 - 1]; // L: 38

				for (var3 = 0; var3 < var2 - 1; ++var3) { // L: 39
					this.field2465[var3] = var1.readUnsignedByte();
				}
			}

			if (var2 > 1) { // L: 41
				this.field2463 = new int[var2 - 1]; // L: 42

				for (var3 = 0; var3 < var2 - 1; ++var3) { // L: 43
					this.field2463[var3] = var1.readUnsignedByte();
				}
			}

			this.field2468 = new int[var2]; // L: 45

			for (var3 = 0; var3 < var2; ++var3) { // L: 46
				this.field2468[var3] = var1.readInt();
			}
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) { // L: 58
			IndexedSprite var7 = GroundObject.method4310(var4, this.fileIds[var6]); // L: 59
			var7.normalize(); // L: 60
			byte[] var8 = var7.pixels; // L: 61
			int[] var9 = var7.palette; // L: 62
			int var10 = this.field2468[var6]; // L: 63
			...
			if (var6 == 0) { // L: 79
				...
				var11 = this.field2465[var6 - 1]; // L: 80
			}
