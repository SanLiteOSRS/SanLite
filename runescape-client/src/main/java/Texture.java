...
public class Texture extends Node {
	...
	Texture(Buffer var1) {
		...
		this.field2365 = var1.readUnsignedByte() == 1; // L: 30
		...
		if (var2 >= 1 && var2 <= 4) { // L: 32
			...
			if (var2 > 1) { // L: 37
				this.field2362 = new int[var2 - 1]; // L: 38
			...
			if (var2 > 1) { // L: 41
				this.field2368 = new int[var2 - 1]; // L: 42
			...
			this.field2367 = new int[var2]; // L: 45
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) { // L: 58
			IndexedSprite var7 = class407.method7641(var4, this.fileIds[var6]); // L: 59
			var7.normalize(); // L: 60
			byte[] var8 = var7.pixels; // L: 61
			int[] var9 = var7.palette; // L: 62
			int var10 = this.field2367[var6]; // L: 63
			...
			if (var6 == 0) { // L: 79
				...
				var11 = this.field2362[var6 - 1]; // L: 80
			}
