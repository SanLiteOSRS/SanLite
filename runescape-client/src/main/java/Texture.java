...
public class Texture extends Node {
	...
	Texture(Buffer var1) {
		...
		this.field2501 = var1.readUnsignedByte() == 1; // L: 30
		...
		if (var2 >= 1 && var2 <= 4) { // L: 32
			...
			if (var2 > 1) { // L: 37
				this.field2507 = new int[var2 - 1]; // L: 38
			...
			if (var2 > 1) { // L: 41
				this.field2506 = new int[var2 - 1]; // L: 42
			...
			this.field2509 = new int[var2]; // L: 45

			for (var3 = 0; var3 < var2; ++var3) { // L: 46
				this.field2509[var3] = var1.readInt();
			}
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) { // L: 58
			...
			IndexedSprite var7;
			if (!class406.method7415(var4, var8)) { // L: 62
				var7 = null; // L: 63
			} else {
				IndexedSprite var10 = new IndexedSprite(); // L: 68
				var10.width = class159.SpriteBuffer_spriteWidth; // L: 69
				var10.height = class500.SpriteBuffer_spriteHeight; // L: 70
				var10.xOffset = class326.SpriteBuffer_xOffsets[0]; // L: 71
				var10.yOffset = ModelData0.SpriteBuffer_yOffsets[0]; // L: 72
				var10.subWidth = class59.SpriteBuffer_spriteWidths[0]; // L: 73
				var10.subHeight = class544.SpriteBuffer_spriteHeights[0]; // L: 74
				var10.palette = class372.SpriteBuffer_spritePalette; // L: 75
				var10.pixels = class414.SpriteBuffer_pixels[0]; // L: 76
				class407.method7453(); // L: 77
				var7 = var10; // L: 80
			}
			...
			int var12 = this.field2509[var6]; // L: 86
			...
			if (var6 == 0) { // L: 102
				...
				var13 = this.field2507[var6 - 1]; // L: 103
			}
