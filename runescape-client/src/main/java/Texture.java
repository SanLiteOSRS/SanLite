...
public class Texture extends Node {
	...
	Texture(Buffer var1) {
		...
		this.field2511 = var1.readUnsignedByte() == 1;
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) {
			...
			if (var10 == null) {
				...
				WorldMapArea.SpriteBuffer_decode(var10);
				var9 = true;
			}
			...
			if (!var9) {
				...
				var7 = HorizontalAlignment.method3492();
			}

			var7.normalize();
			var10 = var7.pixels;
			int[] var11 = var7.palette;
			int var12 = this.field2508[var6];
