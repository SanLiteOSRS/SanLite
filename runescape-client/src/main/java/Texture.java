...
public class Texture extends Node {
	...
	Texture(Buffer var1) {
		...
		this.field2282 = var1.readUnsignedByte() == 1; // L: 30
		...
		if (var2 >= 1 && var2 <= 4) { // L: 32
			...
			if (var2 > 1) { // L: 37
				this.field2284 = new int[var2 - 1]; // L: 38
			...
			if (var2 > 1) { // L: 41
				this.field2285 = new int[var2 - 1]; // L: 42
			...
			this.field2288 = new int[var2]; // L: 45
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) { // L: 58
			...
			if (var10 == null) { // L: 65
				...
				class83.SpriteBuffer_decode(var10); // L: 69
				var9 = true; // L: 70
			}
			...
			if (!var9) { // L: 72
				...
				var7 = SoundCache.method777(); // L: 76
			}

			var7.normalize(); // L: 79
			var10 = var7.pixels; // L: 80
			int[] var11 = var7.palette; // L: 81
			int var12 = this.field2288[var6]; // L: 82
			...
			if (var6 == 0) { // L: 98
				...
				var13 = this.field2284[var6 - 1]; // L: 99
			}
