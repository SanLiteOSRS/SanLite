...
public class Texture extends Node {
	...
	Texture(Buffer var1) {
		...
		this.field2569 = var1.readUnsignedByte() == 1; // L: 30
		...
		if (var2 >= 1 && var2 <= 4) { // L: 32
			...
			if (var2 > 1) { // L: 37
				this.field2564 = new int[var2 - 1]; // L: 38

				for (var3 = 0; var3 < var2 - 1; ++var3) { // L: 39
					this.field2564[var3] = var1.readUnsignedByte();
				}
			}

			if (var2 > 1) { // L: 41
				this.field2565 = new int[var2 - 1]; // L: 42

				for (var3 = 0; var3 < var2 - 1; ++var3) { // L: 43
					this.field2565[var3] = var1.readUnsignedByte();
				}
			}

			this.field2566 = new int[var2]; // L: 45

			for (var3 = 0; var3 < var2; ++var3) { // L: 46
				this.field2566[var3] = var1.readInt();
			}
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) { // L: 58
			...
			if (var10 == null) { // L: 65
				...
				class483.SpriteBuffer_decode(var10); // L: 69
				var9 = true; // L: 70
			}
			...
			if (!var9) { // L: 72
				...
				var7 = class208.method3917(); // L: 76
			}

			var7.normalize(); // L: 79
			var10 = var7.pixels; // L: 80
			int[] var11 = var7.palette; // L: 81
			int var12 = this.field2566[var6]; // L: 82
			...
			if (var6 == 0) { // L: 98
				...
				var13 = this.field2564[var6 - 1]; // L: 99
			}
