...
public class Script extends DualNode {
   ...
   IterableNodeHashTable[] method2142(int var1) {
   ...
   static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
         ...
         if (0L != var7) {
            ...
            int var14 = BoundaryObject.method3214(var7);
            int var15 = var12 & 31;
            int var16 = var12 >> 6 & 3;
            ...
            if (var1 == 2) {
               Player.scene.method3029(var0, var2, var3);
               var13 = class215.getObjectDefinition(var14);
               ...
               if (var13.interactType != 0) {
                  Client.collisionMaps[var0].method3498(var2, var3, var13.sizeX, var13.sizeY, var16, var13.boolean1);
               }
            }
         ...
         if (var4 >= 0) {
            ...
            Client.method1659(var0, var12, var2, var3, var4, var5, var6, Player.scene, Client.collisionMaps[var0]);
         }
      }
