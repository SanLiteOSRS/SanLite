...
public class VorbisCodebook {
	...
	VorbisCodebook() {
		...
		if (var1) {
			...
			for (var3 = VorbisSample.readBits(5) + 1; var2 < this.entries; ++var3) {
				int var4 = VorbisSample.readBits(class143.iLog(this.entries - var2));
		...
		if (var2 > 0) {
			...
			this.field353 = new int[var7];

			int var8;
			for (var8 = 0; var8 < var7; ++var8) {
				this.field353[var8] = VorbisSample.readBits(var5);
			}

			this.field350 = new float[this.entries][this.dimensions];
			float var9;
			int var10;
			int var11;
			if (var2 == 1) {
				for (var8 = 0; var8 < this.entries; ++var8) {
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) {
						...
						float var13 = (float)this.field353[var12] * var16 + var15 + var9;
						this.field350[var8][var11] = var13;
						if (var6) {
							var9 = var13;
						}
				...
				for (var8 = 0; var8 < this.entries; ++var8) {
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) {
						float var17 = (float)this.field353[var10] * var16 + var15 + var9;
						this.field350[var8][var11] = var17;
						if (var6) {
							var9 = var17;
						}
	...
	@ObfuscatedName("f")
	float[] method989() {
		return this.field350[this.method988()];
	}
