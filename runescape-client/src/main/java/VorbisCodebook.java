...
public class VorbisCodebook {
	...
	VorbisCodebook() {
		...
		if (var1) { // L: 46
			...
			for (var3 = VorbisSample.readBits(5) + 1; var2 < this.entries; ++var3) { // L: 48 49 52
				int var4 = VorbisSample.readBits(FaceNormal.iLog(this.entries - var2)); // L: 50
		...
		if (var2 > 0) { // L: 64
			...
			this.field379 = new int[var7]; // L: 72

			int var8;
			for (var8 = 0; var8 < var7; ++var8) { // L: 73
				this.field379[var8] = VorbisSample.readBits(var5);
			}

			this.field377 = new float[this.entries][this.dimensions]; // L: 74
			float var9;
			int var10;
			int var11;
			if (var2 == 1) { // L: 75
				for (var8 = 0; var8 < this.entries; ++var8) { // L: 76
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) { // L: 79
						...
						float var13 = (float)this.field379[var12] * var16 + var15 + var9; // L: 81
						this.field377[var8][var11] = var13; // L: 82
						if (var6) { // L: 83
							var9 = var13;
						}
				...
				for (var8 = 0; var8 < this.entries; ++var8) { // L: 89
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) { // L: 92
						float var17 = (float)this.field379[var10] * var16 + var15 + var9; // L: 93
						this.field377[var8][var11] = var17; // L: 94
						if (var6) { // L: 95
							var9 = var17;
						}
	...
	@ObfuscatedName("s")
	float[] method1056() {
		return this.field377[this.method1053()]; // L: 176
	}
