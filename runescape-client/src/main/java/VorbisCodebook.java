...
public class VorbisCodebook {
	...
	VorbisCodebook() {
		...
		if (var1) { // L: 27
			...
			for (var3 = VorbisSample.readBits(5) + 1; var2 < this.entries; ++var3) { // L: 29 30 33
				int var4 = VorbisSample.readBits(class263.iLog(this.entries - var2)); // L: 31
		...
		if (var2 > 0) { // L: 45
			...
			this.field362 = new int[var7]; // L: 53
			...
			this.field364 = new float[this.entries][this.dimensions]; // L: 55
			float var9;
			int var10;
			int var11;
			if (var2 == 1) { // L: 56
				for (var8 = 0; var8 < this.entries; ++var8) { // L: 57
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) { // L: 60
						...
						float var13 = (float)this.field362[var12] * var16 + var15 + var9; // L: 62
						this.field364[var8][var11] = var13; // L: 63
						if (var6) { // L: 64
							var9 = var13;
						}
				...
				for (var8 = 0; var8 < this.entries; ++var8) { // L: 70
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) { // L: 73
						float var17 = (float)this.field362[var10] * var16 + var15 + var9; // L: 74
						this.field364[var8][var11] = var17; // L: 75
						if (var6) { // L: 76
							var9 = var17;
						}
	...
	@ObfuscatedName("u")
	float[] method970() {
		return this.field364[this.method973()]; // L: 157
	}
	...
	static int mapType1QuantValues(int var0, int var1) {
		int var2;
		for (var2 = (int)Math.pow((double)var0, 1.0D / (double)var1) + 1; GrandExchangeOfferOwnWorldComparator.method1103(var2, var1) > var0; --var2) { // L: 16 17
		}
