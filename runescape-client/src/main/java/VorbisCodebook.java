...
public class VorbisCodebook {
	...
	VorbisCodebook() {
		...
		if (var1) {
			...
			for (var3 = VorbisSample.readBits(5) + 1; var2 < this.entries; ++var3) {
				int var4 = VorbisSample.readBits(Coord.iLog(this.entries - var2));
		...
		if (var2 > 0) {
			...
			for (var8 = 0; var8 < var7; ++var8) {
				this.field1359[var8] = VorbisSample.readBits(var5);
			}

			this.field1358 = new float[this.entries][this.dimensions];
			float var9;
			int var10;
			int var11;
			if (var2 == 1) {
				for (var8 = 0; var8 < this.entries; ++var8) {
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) {
						...
						float var13 = (float)this.field1359[var12] * var16 + var15 + var9;
						this.field1358[var8][var11] = var13;
						if (var6) {
							var9 = var13;
						}
				...
				for (var8 = 0; var8 < this.entries; ++var8) {
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) {
						float var17 = (float)this.field1359[var10] * var16 + var15 + var9;
						this.field1358[var8][var11] = var17;
						if (var6) {
							var9 = var17;
						}
	...
	@ObfuscatedName("c")
	float[] method2511() {
		return this.field1358[this.method2510()];
	}
	...
	static int mapType1QuantValues(int var0, int var1) {
		int var2;
		for (var2 = (int)Math.pow((double)var0, 1.0D / (double)var1) + 1; class39.method644(var2, var1) > var0; --var2) {
		}
