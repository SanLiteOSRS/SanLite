...
public class class343 {
	...
	static int method6445(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) { // L: 1454
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				PacketBufferNode var14 = class120.getPacketBufferNode(ClientPacket.field2942, Client.packetWriter.isaacCipher); // L: 1475
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					...
					var12 = class120.getPacketBufferNode(ClientPacket.field3009, Client.packetWriter.isaacCipher); // L: 1483
					...
					var12 = class120.getPacketBufferNode(ClientPacket.field2972, Client.packetWriter.isaacCipher); // L: 1492
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						var12 = class120.getPacketBufferNode(ClientPacket.field2966, Client.packetWriter.isaacCipher); // L: 1542
						...
						if (var11.length() > 500) { // L: 1552
							...
							PacketBufferNode var6 = class120.getPacketBufferNode(ClientPacket.field3003, Client.packetWriter.isaacCipher); // L: 1554
	...
	static void method6444() {
		...
		PacketBufferNode var2 = class120.getPacketBufferNode(ClientPacket.field2956, Client.packetWriter.isaacCipher); // L: 2672
