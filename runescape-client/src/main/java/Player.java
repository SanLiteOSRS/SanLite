...
public final class Player extends Actor {
			...
			if (var3 == null) {
				...
				if (!this.isUnanimated && this.model0 != null) {
					...
					if (Client.cycle >= this.animationCycleStart && Client.cycle < this.animationCycleEnd) {
						var4 = this.model0;
						var4.offsetBy(this.field1087 * 4096 - super.x, this.tileHeight2 - this.tileHeight, this.field1070 * 4096 - super.y);
						...
						var4.offsetBy(super.x - this.field1087 * 4096, this.tileHeight - this.tileHeight2, super.y - this.field1070 * 4096);
					}
				}
	...
	void updateIsInFriendsChat() {
		this.isInFriendsChat = class264.friendsChatManager != null && class264.friendsChatManager.contains(this.username) ? TriBool.TriBool_true : TriBool.TriBool_false;
	}
	...
	static void drawTitle(Font var0, Font var1, Font var2) {
		...
		if (Login.worldSelectOpen) {
			if (BoundaryObject.worldSelectBackSprites == null) {
				BoundaryObject.worldSelectBackSprites = Script.SpriteBuffer_getSpritePixelsByName(class176.archive8, "sl_back", "");
			}
