			...
			if (var3 == null) {
				...
				if (!this.isUnanimated && this.model0 != null) {
					...
					if (Client.cycle >= this.animationCycleStart && Client.cycle < this.animationCycleEnd) {
						var4 = this.model0;
						var4.offsetBy(this.field662 * 4096 - super.x, this.tileHeight2 - this.tileHeight, this.field657 * 4096 - super.y);
						...
						var4.offsetBy(super.x - this.field662 * 4096, this.tileHeight - this.tileHeight2, super.y - this.field657 * 4096);
					}
				}
