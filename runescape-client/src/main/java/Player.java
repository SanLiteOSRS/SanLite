...
public final class Player extends Actor {
	...
	final void read(Buffer var1) {
		...
		if (this == class129.localPlayer) {
			RunException.field4411 = this.username.getName();
		}
			...
			if (var3 == null) {
				...
				if (!this.isUnanimated && this.model0 != null) {
					...
					if (Client.cycle >= this.animationCycleStart && Client.cycle < this.animationCycleEnd) {
						var4 = this.model0;
						var4.offsetBy(this.field1058 * 4096 - super.x, this.tileHeight2 - this.tileHeight, this.field1060 * 4096 - super.y);
						...
						var4.offsetBy(super.x - this.field1058 * 4096, this.tileHeight - this.tileHeight2, super.y - this.field1060 * 4096);
					}
				}
	...
	void updateIsInFriendsChat() {
		this.isInFriendsChat = class78.friendsChatManager != null && class78.friendsChatManager.contains(this.username) ? TriBool.TriBool_true : TriBool.TriBool_false;
	}
