...
public final class Player extends Actor {
		...
		for (int var5 = 0; var5 < 12; ++var5) {
			...
			if (var6 == 0) { // L: 66
				...
				if (var4[var5] >= 512) { // L: 76
					var8 = FileSystem.ItemComposition_get(var4[var5] - 512).team; // L: 77
					if (var8 != 0) { // L: 78
						this.team = var8;
					}
				}
		...
		if (this.appearance == null) { // L: 194
			...
			if (var3 == null) { // L: 198
				...
				if (!this.isUnanimated && super.spotAnimation != -1 && super.spotAnimationFrame != -1) { // L: 201
					...
					if (var4 != null) { // L: 203
						var4.offsetBy(0, -super.field1151, 0); // L: 204
				...
				if (!this.isUnanimated && this.model0 != null) { // L: 209
					...
					if (Client.cycle >= this.animationCycleStart && Client.cycle < this.animationCycleEnd) { // L: 211
						...
						var4.offsetBy(this.field1104 * 4096 - super.x, this.tileHeight2 - this.tileHeight, this.field1106 * 4096 - super.y); // L: 213
						...
						var4.offsetBy(super.x - this.field1104 * 4096, this.tileHeight - this.tileHeight2, super.y - this.field1106 * 4096); // L: 236
					}
				}
	...
	void updateIsInFriendsChat() {
		this.isInFriendsChat = PcmPlayer.friendsChatManager != null && PcmPlayer.friendsChatManager.contains(this.username) ? TriBool.TriBool_true : TriBool.TriBool_false; // L: 160
	} // L: 161
	...
	static final void updatePlayer(PacketBuffer var0) {
		...
		var2.pathX[0] = var5 - SecureRandomCallable.baseX * 64; // L: 45
		var2.x = (var2.pathX[0] << 7) + (var2.transformedSize() << 6); // L: 46
		var2.pathY[0] = var6 - GrandExchangeOfferOwnWorldComparator.baseY * 64; // L: 47
