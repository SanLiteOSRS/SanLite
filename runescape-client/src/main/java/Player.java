...
public final class Player extends Actor {
   ...
   protected final Model getModel() {
      if (this.appearance == null) {
         ...
         SequenceDefinition var1 = super.sequence != -1 && super.sequenceDelay == 0 ? Widget.getSequenceDefinition(super.sequence) : null;
         SequenceDefinition var2 = super.movementSequence != -1 && !this.isUnanimated && (super.readySequence != super.movementSequence || var1 == null) ? Widget.getSequenceDefinition(super.movementSequence) : null;
         ...
         if (var3 == null) {
            ...
            if (!this.isUnanimated && super.spotAnimation != -1 && super.spotAnimationFrame != -1) {
               var4 = HealthBarUpdate.getSpotAnimationDefinition(super.spotAnimation).getModel(super.spotAnimationFrame);
               if (var4 != null) {
   ...
   final void method1190(int var1, int var2, byte var3) {
      if (super.sequence != -1 && Widget.getSequenceDefinition(super.sequence).field3505 == 1) {
         super.sequence = -1;
      }
                     ...
                     if (var14 >= 128) {
                        ...
                        if (var9 == 1) {
                           ...
                           while(true) {
                              ...
                              if (var10.vmethod3531(1, var16, var17, var11)) {
                                 class173.field2073 = var16;
                                 class173.field2070 = var17;
                                 var35 = true;
                                 break;
                           ...
                           while(true) {
                              ...
                              var25 = var16 - var11.xInset;
                              var26 = var17 - var11.yInset;
                              if (var10.vmethod3531(2, var16, var17, var11)) {
                                 class173.field2073 = var16;
                                 class173.field2070 = var17;
                                 var35 = true;
                                 break;
                                    ...
                                    do {
                                       do {
                                          ...
                                          do {
                                             ...
                                             var25 = var16 - var11.xInset;
                                             var26 = var17 - var11.yInset;
                                             if (var10.vmethod3531(var9, var16, var17, var11)) {
                                                class173.field2073 = var16;
                                                class173.field2070 = var17;
                                                var35 = true;
                                                break label940;
