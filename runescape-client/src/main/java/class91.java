		...
		if (Client.minimapState == 0 || Client.minimapState == 3) {
			if (!Client.isMenuOpen && (MouseHandler.MouseHandler_lastButton == 1 || !class370.mouseCam && MouseHandler.MouseHandler_lastButton == 4)) {
				...
				if (var3.contains(var4, var5)) {
					...
					var13.packetBuffer.method7403(KeyHandler.KeyHandler_pressedKeys[82] ? (KeyHandler.KeyHandler_pressedKeys[81] ? 2 : 1) : 0);
					var13.packetBuffer.method7555(Canvas.baseX * 64 + var11);
					var13.packetBuffer.method7555(class118.baseY * 64 + var12);
