			...
			try {
				...
				while (true) {
					...
					if (var6 == 4) { // L: 10488
						...
						if (var11 != -1 && (!UserComparator3.ItemComposition_get(var11).isMembersOnly || Client.isMembersWorld)) { // L: 10493
					...
					if (var6 == 10) { // L: 10508
						...
						if (var11 != -1 && (!UserComparator3.ItemComposition_get(var11).isMembersOnly || Client.isMembersWorld)) { // L: 10513
