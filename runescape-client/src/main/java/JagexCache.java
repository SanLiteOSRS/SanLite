	...
	static final void method3158(PacketBuffer var0) {
		for (int var1 = 0; var1 < Client.field565; ++var1) { // L: 8174
			...
			if ((var4 & 16) != 0) { // L: 8182
				...
				var7 = var3.x - (var5 - SecureRandomCallable.baseX * 64 - SecureRandomCallable.baseX * 64) * 64; // L: 8188
				var8 = var3.y - (var6 - GrandExchangeOfferOwnWorldComparator.baseY * 64 - GrandExchangeOfferOwnWorldComparator.baseY * 64) * 64; // L: 8189
