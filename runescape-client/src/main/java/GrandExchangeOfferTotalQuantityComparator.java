...
final class GrandExchangeOfferTotalQuantityComparator implements Comparator {
   ...
   static final void method98(Scene var0, CollisionMap[] var1) {
         ...
         for(var3 = 0; var3 < 104; ++var3) {
            for(var4 = 0; var4 < 104; ++var4) {
               if ((Tiles.Tiles_renderFlags[var2][var3][var4] & 1) == 1) {
                  ...
                  if (var5 >= 0) {
                     var1[var5].method3494(var3, var4);
                  }
               }
            }
         }
      ...
      for(var2 = 0; var2 < 4; ++var2) {
         ...
         for(var11 = 0; var11 < 104; ++var11) {
            Tiles.field476[var11] = 0;
            class3.field26[var11] = 0;
            Buddy.field3590[var11] = 0;
            class49.field394[var11] = 0;
         ...
         for(var11 = -5; var11 < 109; ++var11) {
            for(var12 = 0; var12 < 104; ++var12) {
               ...
               if (var13 >= 0 && var13 < 104) {
                  ...
                  if (var14 > 0) {
                     FloorUnderlayDefinition var45 = StudioGame.method4057(var14 - 1);
                     var10000 = Tiles.field476;
                     var10000[var12] += var45.hue;
                     var10000 = class3.field26;
                     var10000[var12] += var45.saturation;
                     var10000 = Buddy.field3590;
                     var10000[var12] += var45.lightness;
                     var10000 = class49.field394;
               ...
               if (var14 >= 0 && var14 < 104) {
                  ...
                  if (var15 > 0) {
                     FloorUnderlayDefinition var46 = StudioGame.method4057(var15 - 1);
                     var10000 = Tiles.field476;
            ...
            if (var11 >= 1 && var11 < 103) {
               ...
               for(var17 = -5; var17 < 109; ++var17) {
                  ...
                  if (var18 >= 0 && var18 < 104) {
                     var12 += Tiles.field476[var18];
                     var13 += class3.field26[var18];
                     var14 += Buddy.field3590[var18];
                     var15 += class49.field394[var18];
                     var16 += MenuAction.field1129[var18];
                  }

                  var19 = var17 - 5;
                  if (var19 >= 0 && var19 < 104) {
                     var12 -= Tiles.field476[var19];
                     var13 -= class3.field26[var19];
                     var14 -= Buddy.field3590[var19];
                     var15 -= class49.field394[var19];
   ...
   static final int method101(int var0, int var1) {
      int var2 = User.method4969(var0 + '넵', var1 + 91923, 4) - 128 + (User.method4969(var0 + 10294, '鎽' + var1, 2) - 128 >> 1) + (User.method4969(var0, var1, 1) - 128 >> 2);
