	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		for (var18 = 0; var18 < 5; ++var18) {
			if (Client.field753[var18]) {
				var19 = (int)(Math.random() * (double)(Client.field754[var18] * 2 + 1) - (double)Client.field754[var18] + Math.sin((double)Client.field757[var18] * ((double)Client.field500[var18] / 100.0D)) * (double)Client.field733[var18]);
				if (var18 == 0) {
