...
public class class119 implements MouseWheel {
		...
		if (var0 != 7500 && var0 != 7508) { // L: 4472
			if (var0 != 7501) { // L: 4494
				...
				if (var0 == 7502) { // L: 4503
					...
					class439 var26 = SecureRandomCallable.method2201(var3); // L: 4511
					class437 var27 = class229.method5021(var20); // L: 4512
					int[] var28 = var27.field4706[var7]; // L: 4513
					int var12 = 0; // L: 4514
					...
					Object[] var14 = var26.method7827(var7); // L: 4523
					if (var14 == null && var27.field4707 != null) { // L: 4524 4525
					...
					class439 var25 = SecureRandomCallable.method2201(var3); // L: 4555
					class437 var9 = class229.method5021(var20); // L: 4556
					int[] var10 = var9.field4706[var7]; // L: 4557
					Object[] var11 = var25.method7827(var7); // L: 4558
					if (var11 == null && var9.field4707 != null) { // L: 4559 4560
						var11 = var9.field4707[var7]; // L: 4561
					}
					...
					return 1; // L: 4566
				} else if (var0 != 7504 && var0 != 7509) { // L: 4568
					if (var0 == 7505) { // L: 4585
						var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]; // L: 4586
						class439 var24 = SecureRandomCallable.method2201(var3); // L: 4587
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var24.field4713; // L: 4588
						return 1; // L: 4589
					} else if (var0 == 7506) { // L: 4591
						...
						return 1; // L: 4598
					} else if (var0 != 7507 && var0 != 7510) { // L: 4600
						return 2; // L: 4627
					} else {
	...
	static final void method2909() {
		int var0 = SceneTilePaint.field2638 * 16384 + 64; // L: 3701
		...
		var1 = MusicPatchNode.field3301 * 16384 + 64; // L: 3706
