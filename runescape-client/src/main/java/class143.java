...
public abstract class class143 extends Node {
	...
	public static void ByteArrayPool_release(byte[] var0) {
		synchronized(ByteArrayPool.field4614) { // L: 124
			if (var0.length == 100 && ByteArrayPool.ByteArrayPool_smallCount < ByteArrayPool.field4611) { // L: 125
				ByteArrayPool.ByteArrayPool_small[++ByteArrayPool.ByteArrayPool_smallCount - 1] = var0; // L: 126
			} else if (var0.length == 5000 && ByteArrayPool.ByteArrayPool_mediumCount < ByteArrayPool.field4620) { // L: 129
				ByteArrayPool.ByteArrayPool_medium[++ByteArrayPool.ByteArrayPool_mediumCount - 1] = var0; // L: 130
			} else if (var0.length == 10000 && ByteArrayPool.ByteArrayPool_largeCount < ByteArrayPool.field4621) { // L: 133
				ByteArrayPool.ByteArrayPool_large[++ByteArrayPool.ByteArrayPool_largeCount - 1] = var0; // L: 134
			} else if (var0.length == 30000 && ByteArrayPool.field4618 < ByteArrayPool.field4622) { // L: 137
				ByteArrayPool.field4626[++ByteArrayPool.field4618 - 1] = var0; // L: 138
			} else {
				if (class155.ByteArrayPool_arrays != null) { // L: 141
					for (int var2 = 0; var2 < class208.ByteArrayPool_alternativeSizes.length; ++var2) { // L: 142
						if (var0.length == class208.ByteArrayPool_alternativeSizes[var2] && FileSystem.ByteArrayPool_altSizeArrayCounts[var2] < class155.ByteArrayPool_arrays[var2].length) { // L: 143
							class155.ByteArrayPool_arrays[var2][FileSystem.ByteArrayPool_altSizeArrayCounts[var2]++] = var0; // L: 144
							return; // L: 145
						}
					}
				}
