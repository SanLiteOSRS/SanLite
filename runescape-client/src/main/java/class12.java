...
class class12 extends SSLSocket {
	...
	static final void method158(int var0, int var1) {
		if (Client.hintArrowType == 2) {
			VarbitComposition.worldToScreen(Client.hintArrowSubX * 64 + (Client.hintArrowX - GrandExchangeOfferOwnWorldComparator.baseX * 64 << 7), (Client.hintArrowY - VarcInt.baseY * 64 << 7) + Client.hintArrowSubY * 4096, Client.hintArrowHeight * 4);
				...
				if (var4.isInteractable) {
					if (!var4.isFollower || Client.followerIndex == var1) {
						...
						if (var4.combatLevel != 0 && var0.field1182 != 0) {
							var6 = var0.field1182 != -1 ? var0.field1182 : var4.combatLevel;
	...
	static void findItemDefinitions(String var0, boolean var1) {
		...
		for (int var4 = 0; var4 < class293.ItemComposition_fileCount; ++var4) {
			ItemComposition var9 = class19.ItemComposition_get(var4);
		...
		for (int var5 = 0; var5 < Script.foundItemIdCount; ++var5) {
			var8[var5] = class19.ItemComposition_get(var2[var5]).name;
		}
