...
public class class247 {
	...
	static final void method4584(int var0, int var1, int var2, int var3, int var4, int var5, Scene var6, CollisionMap var7) {
			...
			if (var5 == 22) {
				...
				if (var5 != 10 && var5 != 11) {
					...
					if (var5 >= 12) {
						...
						var6.method3166(var0, var1, var2, var16, 1, 1, (Entity)var22, 0, var19, var21);
						...
						if (var8.interactType != 0 && var7 != null) {
							var7.method3634(var1, var2, var5, var4, var8.boolean1);
						}

						if (var8.int2 != 16) {
							var6.method3280(var0, var1, var2, var8.int2);
						}
					...
					if (var22 != null && var6.method3166(var0, var1, var2, var16, var9, var10, (Entity)var22, var5 == 11 ? 256 : 0, var19, var21) && var8.clipped) {
						var23 = 15;
						if (var22 instanceof Model) {
							var23 = ((Model)var22).method2980() / 4;
							if (var23 > 30) {
								var23 = 30;
							}
						}
