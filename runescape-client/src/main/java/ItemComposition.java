...
public class ItemComposition extends DualNode {
	...
	public final ModelData getModelData(int var1) {
		...
		if (this.countobj != null && var1 > 1) { // L: 293
			...
			if (var2 != -1) { // L: 298
				return FileSystem.ItemComposition_get(var2).getModelData(1);
			}
		}
	...
	public final Model getModel(int var1) {
		if (this.countobj != null && var1 > 1) { // L: 317
			...
			if (var2 != -1) { // L: 322
				return FileSystem.ItemComposition_get(var2).getModel(1);
			}
		}
		...
		if (var5 != null) { // L: 325
			...
			if (var6 == null) { // L: 327
				...
				var5 = var6.toModel(this.ambient + 64, this.contrast * 5 + 768, -50, -10, -50); // L: 339
	...
	public ItemComposition getCountObj(int var1) {
		if (this.countobj != null && var1 > 1) { // L: 346
			...
			if (var2 != -1) { // L: 351
				return FileSystem.ItemComposition_get(var2);
			}
		}
	...
	public final boolean hasNoValidModel(boolean var1) {
		...
		if (var2 == -1) { // L: 439
			...
			if (!ItemComposition_modelArchive.tryLoadFile(var2, 0)) { // L: 441
				var5 = false;
			}

			if (var3 != -1 && !ItemComposition_modelArchive.tryLoadFile(var3, 0)) { // L: 442
				var5 = false;
			}

			if (var4 != -1 && !ItemComposition_modelArchive.tryLoadFile(var4, 0)) { // L: 443
				var5 = false;
			}
	...
	public final ModelData method3630(boolean var1) {
		...
		if (var2 == -1) { // L: 456
			...
			ModelData var5 = ModelData.ModelData_get(ItemComposition_modelArchive, var2, 0); // L: 457
			if (var3 != -1) { // L: 458
				ModelData var6 = ModelData.ModelData_get(ItemComposition_modelArchive, var3, 0); // L: 459
				if (var4 != -1) { // L: 460
					ModelData var7 = ModelData.ModelData_get(ItemComposition_modelArchive, var4, 0); // L: 461
	...
	public final boolean method3631(boolean var1) {
		...
		if (var2 == -1) { // L: 492
			...
			if (!ItemComposition_modelArchive.tryLoadFile(var2, 0)) { // L: 494
				var4 = false;
			}

			if (var3 != -1 && !ItemComposition_modelArchive.tryLoadFile(var3, 0)) { // L: 495
				var4 = false;
			}
	...
	public final ModelData method3632(boolean var1) {
		...
		if (var2 == -1) { // L: 506
			...
			ModelData var4 = ModelData.ModelData_get(ItemComposition_modelArchive, var2, 0); // L: 507
			if (var3 != -1) { // L: 508
				ModelData var5 = ModelData.ModelData_get(ItemComposition_modelArchive, var3, 0); // L: 509
