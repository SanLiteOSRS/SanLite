	...
	static final void method3448() {
		...
		if (!var0) {
			...
			for (var1 = 0; var1 < class28.regionLandArchives.length; ++var1) {
				...
				if (var2 != null) {
					var57 = (class129.regions[var1] >> 8) * 64 - WorldMapSectionType.baseX * 64;
					var4 = (class129.regions[var1] & 255) * 64 - PlayerComposition.baseY * 64;
			...
			if (!var0) {
				...
				if (!Client.isInInstance) {
					...
					for (var49 = 0; var49 < var1; ++var49) {
						var57 = (class129.regions[var49] >> 8) * 64 - WorldMapSectionType.baseX * 64;
						var4 = (class129.regions[var49] & 255) * 64 - PlayerComposition.baseY * 64;
					...
					for (var49 = 0; var49 < var1; ++var49) {
						...
						if (var3 != null) {
							var4 = (class129.regions[var49] >> 8) * 64 - WorldMapSectionType.baseX * 64;
							var5 = (class129.regions[var49] & 255) * 64 - PlayerComposition.baseY * 64;
							class356.playPcmPlayers();
				...
				NameableContainer.updateGameState(30);
				class356.playPcmPlayers();
