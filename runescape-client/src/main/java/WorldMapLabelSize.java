	...
	static void readPlayerUpdate(PacketBuffer var0, int var1) {
		...
		if (var3 == 0) {
			if (var2) {
				...
				Players.Players_regions[var1] = (var4.plane << 28) + (class250.baseY * 64 + var4.pathY[0] >> 13) + (ApproximateRouteStrategy.baseX * 64 + var4.pathX[0] >> 13 << 14);
				if (var4.field1160 != -1) {
			...
			if (var3 == 1) {
				...
				if (var5 == 0) {
					...
					var8 = var6 >> 14 & 16383;
					var9 = var6 & 16383;
					var10 = (ApproximateRouteStrategy.baseX * 64 + var8 + var4.pathX[0] & 16383) - ApproximateRouteStrategy.baseX * 64;
					var11 = (class250.baseY * 64 + var9 + var4.pathY[0] & 16383) - class250.baseY * 64;
					if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) {
						var4.resetPath(var10, var11);
						var4.field1109 = false;
					} else if (var2) {
				...
				for (int var15 = 0; var15 < var0.width; ++var15) {
					...
					if (var1 >= var16 && var2 >= var7 && var1 < var16 + 32 && var2 < var7 + 32) {
						...
						if (var0.itemIds[var13] > 0) {
							ItemComposition var8 = class67.ItemComposition_get(var0.itemIds[var13] - 1);
