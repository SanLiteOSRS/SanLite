...
public class ArchiveLoader {
	...
	boolean isLoaded() {
		...
		for (int var1 = 0; var1 < this.groupCount; ++var1) {
			if (!this.archive.method4383(var1) || this.archive.method4364(var1)) {
				++this.loadedCount;
			}
		}
	...
	static final void method1242(String var0, int var1) {
		...
		var2.packetBuffer.method5578(var1);
					...
					if (var9.contentType == 1337) {
						...
						if (!Client.isMenuOpen && var33) {
							if (var9.contentType == 1400) {
								...
								class80.method2150(var9, var17 - var10, var18 - var11);
							}
						}
							...
							for (int var20 = 0; var20 < var9.field2623.length; ++var20) {
								...
								if (!var21 && var9.field2623[var20] != null) {
									for (var23 = 0; var23 < var9.field2623[var20].length; ++var23) {
										...
										if (Frames.method3353(var9.field2623[var20][var23]) || var24) {
											var21 = true;
								...
								if (var22) {
									if (var20 < 10) {
										class287.method5334(var20 + 1, var9.id, var9.childIndex, var9.itemId, "");
									} else if (var20 == 10) {
										InterfaceParent.Widget_runOnTargetLeave();
										class51.method973(var9.id, var9.childIndex, UserComparator5.method3504(class195.getWidgetClickMask(var9)), var9.itemId);
										Client.selectedSpellActionName = SoundCache.method2619(var9);
						...
						if (var9.isIf3) {
							...
							if (var9.contentType == 1400) {
								Login.worldMap.method6367(var17, var18, var33 & var34, var33 & var21);
							}

							if (Client.clickedWidget != null && var9 != Client.clickedWidget && var33 && TextureProvider.method2884(class195.getWidgetClickMask(var9))) {
