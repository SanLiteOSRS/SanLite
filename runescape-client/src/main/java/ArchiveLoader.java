...
public class ArchiveLoader {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		Nameable.method6523(HorizontalAlignment.oculusOrbFocalPointX, class140.field1666, class28.oculusOrbFocalPointY, var4, var31, class10.method94(var4), var3); // L: 4651
		int var7;
		int var8;
		int var9;
		int var10;
		...
		if (Client.hintArrowType == 2) { // L: 4875
			AbstractWorldMapIcon.worldToScreen(Client.hintArrowSubX * 64 + (Client.hintArrowX - SecureRandomCallable.baseX * 64 << 7), Client.hintArrowSubY * 64 + (Client.hintArrowY - GrandExchangeOfferOwnWorldComparator.baseY * 64 << 7), Client.hintArrowHeight * 4); // L: 4876
