...
public class WorldMapSection0 implements WorldMapSection {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
		...
		if (var2 == 1) {
			...
			var8.packetBuffer.method5752(class182.baseX * 64 + var0);
			var8.packetBuffer.method5837(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.method5863(AbstractUserComparator.selectedItemWidget);
			var8.packetBuffer.method5752(SecureRandomFuture.baseY * 64 + var1);
			...
			var8.packetBuffer.writeShort(class182.baseX * 64 + var0);
			...
			var8.packetBuffer.method5753(var3);
			var8.packetBuffer.writeShort(SecureRandomFuture.baseY * 64 + var1);
			...
			var8.packetBuffer.method5753(SecureRandomFuture.baseY * 64 + var1);
			...
			var8.packetBuffer.method5837(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.method5898(SecureRandomFuture.baseY * 64 + var1);
			var8.packetBuffer.method5753(var3);
			var8.packetBuffer.method5898(class182.baseX * 64 + var0);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 5) {
			Client.mouseCrossX = var6;
			Client.mouseCrossY = var7;
			...
			var8.packetBuffer.method5753(class182.baseX * 64 + var0);
			var8.packetBuffer.method5837(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.method5898(var3);
			var8.packetBuffer.method5752(SecureRandomFuture.baseY * 64 + var1);
			Client.packetWriter.addNode(var8);
			...
			if (var2 == 7) {
				...
				if (var2 == 14) {
					...
					var8.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					var8.packetBuffer.method5898(var3);
					var8.packetBuffer.method5863(ItemContainer.selectedSpellWidget);
					var8.packetBuffer.writeShort(SecureRandomFuture.baseY * 64 + var1);
					Client.packetWriter.addNode(var8);
				} else if (var2 == 18) {
					Client.mouseCrossX = var6;
					...
					if (Client.isMenuOpen) {
						...
						UserComparator3.scene.menuOpen(ItemLayer.Client_plane, var0, var1, true);
					}
				} else {
					...
					if (var2 == 24) {
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								var8.packetBuffer.method5863(var1);
										...
										if (var2 != 57) {
											if (var2 == 58) {
												...
												if (var16 != null) {
													...
													var9.packetBuffer.method5863(ItemContainer.selectedSpellWidget);
