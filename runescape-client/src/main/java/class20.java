...
public class class20 implements Callable {
	...
	static final void method302(PendingSpawn var0) {
		...
		if (var0.type == 0) { // L: 7696
			var1 = MusicPatchNode.scene.getWallObjectTag(var0.plane, var0.x, var0.y);
		}

		if (var0.type == 1) { // L: 7697
			var1 = MusicPatchNode.scene.getDecorativeObjectTag(var0.plane, var0.x, var0.y);
		}
		...
		if (var0.type == 3) { // L: 7699
			var1 = MusicPatchNode.scene.getGroundObjectTag(var0.plane, var0.x, var0.y);
		}
		...
		if (Client.currentClanChannels[var0] != null) { // L: 11990
			if (var1 >= 0 && var1 < Client.currentClanChannels[var0].method3265()) { // L: 11991
				...
				if (var2.rank == -1) { // L: 11993
					PacketBufferNode var3 = class120.getPacketBufferNode(ClientPacket.field2955, Client.packetWriter.isaacCipher); // L: 11994
