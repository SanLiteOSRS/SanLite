	...
	static int method2637(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) {
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				PacketBufferNode var14 = class135.getPacketBufferNode(ClientPacket.field2893, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					var7 = Interpreter.Interpreter_stringStack[--BufferedNetSocket.Interpreter_stringStackSize];
					var12 = class135.getPacketBufferNode(ClientPacket.field2894, Client.packetWriter.isaacCipher);
					...
					var7 = Interpreter.Interpreter_stringStack[--BufferedNetSocket.Interpreter_stringStackSize];
					var12 = class135.getPacketBufferNode(ClientPacket.field2853, Client.packetWriter.isaacCipher);
					var12.packetBuffer.writeByte(var7.length() + 1);
					var12.packetBuffer.writeStringCp1252NullTerminated(var7);
					Client.packetWriter.addNode(var12);
					return 1;
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
						var12 = class135.getPacketBufferNode(ClientPacket.field2906, Client.packetWriter.isaacCipher);
						...
						if (var4.length() > 500) {
							...
							var6.packetBuffer.method7458(var10);
						...
						Client.field666 = 3;
						Client.field667 = var2 ? class16.scriptDotWidget.id : Interpreter.scriptActiveWidget.id;
						return 1;
					} else {
						boolean var11;
