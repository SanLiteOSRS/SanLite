...
public class class422 {
	...
	static final void updatePlayer(PacketBuffer var0) {
		...
		Player var2 = MusicPatchNode.localPlayer = Client.players[var1] = new Player(); // L: 39
