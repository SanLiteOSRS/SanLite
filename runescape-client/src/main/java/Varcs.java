...
public class Varcs {
	...
	static final void updateInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		for (int var8 = 0; var8 < var0.length; ++var8) {
			...
			if (var9 != null && var9.parentId == var1 && (var9.method5637() || WorldMapSection2.getWidgetFlags(var9) != 0 || var9 == Client.field664)) {
				if (var9.isIf3) {
						...
						if (var9.noClickThrough) {
							if (MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14 && MouseHandler.MouseHandler_y < var15) {
								for (var27 = (ScriptEvent)Client.scriptEvents.last(); var27 != null; var27 = (ScriptEvent)Client.scriptEvents.previous()) {
									if (var27.field1041) {
										var27.remove();
										var27.widget.field3483 = false;
									}
								}

								if (class136.widgetDragDuration == 0) {
									Client.clickedWidget = null;
									Client.field664 = null;
								}
							...
							for (var27 = (ScriptEvent)Client.scriptEvents.last(); var27 != null; var27 = (ScriptEvent)Client.scriptEvents.previous()) {
								if (var27.field1041 && var27.widget.onScroll == var27.args) {
									var27.remove();
								}
							}
						}
					...
					if (var9.contentType == 1337) {
						...
						if (var9.isIf3) {
							...
							if (var9.hasListener) {
								...
								if (Client.clickedWidget != null || GroundObject.dragInventoryWidget != null || Client.isMenuOpen) {
									var21 = false;
									var36 = false;
									var35 = false;
								}

								if (!var9.field3484 && var21) {
									var9.field3484 = true;
								...
								if (var9.field3484 && var36 && var9.onClickRepeat != null) {
									var37 = new ScriptEvent();
									var37.field1041 = true;
									var37.widget = var9;
								...
								if (var9.field3484 && !var36) {
									var9.field3484 = false;
								...
								if (var9.field3483 && var35 && var9.onMouseRepeat != null) {
									var37 = new ScriptEvent();
									var37.field1041 = true;
									var37.widget = var9;
									var37.mouseX = MouseHandler.MouseHandler_x - var26;
