					...
					if (var17 <= var9) { // L: 181
						...
						for (int var18 = var5; var18 < var6; ++var18) { // L: 187
							...
							if (Character.isISOControl(var10)) { // L: 191
								var11 = false; // L: 192
							} else if (ClanSettings.isAlphaNumeric(var10)) { // L: 195
								var11 = true; // L: 196
							} else {
								char[] var12 = class444.field4794; // L: 200
								int var13 = 0;
							...
							if (var11) { // L: 221
								char var16 = class26.method369(var10); // L: 222
								if (var16 != 0) { // L: 223
					...
					if (var17 <= var9) { // L: 69
						...
						for (int var18 = var5; var18 < var6; ++var18) { // L: 75
							...
							if (Character.isISOControl(var10)) { // L: 79
								var11 = false; // L: 80
							} else if (ClanSettings.isAlphaNumeric(var10)) { // L: 83
								var11 = true; // L: 84
							} else {
								char[] var12 = class444.field4794; // L: 88
								int var13 = 0;
							...
							if (var11) { // L: 109
								char var16 = class26.method369(var10); // L: 110
								if (var16 != 0) { // L: 111
