...
class class11 implements TlsAuthentication {
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			RouteStrategy.decimator = new Decimator(22050, PcmPlayer.field279 * 22050);
			...
			if (Client.titleLoadingStage == 50) {
				...
				if (var25 < var26) {
					...
					Login.Login_loadingPercent = 50;
					NameableContainer.updateGameState(5);
				...
				if (Client.titleLoadingStage == 70) {
					...
					if (class21.headIconPkSprites == null) {
						...
						if (!VarbitComposition.SpriteBuffer_loadSpritesFromArchive(var2, var3, 0)) {
							var1 = null;
						} else {
