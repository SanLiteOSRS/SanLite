...
class class11 implements TlsAuthentication {
	...
	static void method113() {
		...
		PacketBufferNode var5 = class120.getPacketBufferNode(ClientPacket.field2956, Client.packetWriter.isaacCipher); // L: 2630
		...
		class145.friendsChatManager = null; // L: 2636
