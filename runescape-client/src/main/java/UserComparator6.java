...
public class UserComparator6 extends AbstractUserComparator {
	...
	static final void method2611(int var0, int var1) {
		if (Client.hintArrowType == 2) { // L: 4949
			Bounds.worldToScreen(Client.hintArrowSubX * 64 + (Client.hintArrowX - Decimator.baseX * 64 << 7), Client.hintArrowSubY * 64 + (Client.hintArrowY - class7.baseY * 64 << 7), Client.hintArrowHeight * 4); // L: 4950
