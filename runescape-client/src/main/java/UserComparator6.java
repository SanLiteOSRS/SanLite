...
public class UserComparator6 extends AbstractUserComparator {
	...
	public static class435 method2626(int var0) {
		class435 var1 = (class435)class435.PlayerComposition_cachedModels.get((long)var0); // L: 23
		if (var1 != null) { // L: 24
			return var1;
		} else {
			...
			class435.PlayerComposition_cachedModels.put(var1, (long)var0); // L: 29
			return var1; // L: 30
		}
	}
	...
	static int method2628(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.OC_NAME) { // L: 3438
			...
			Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = EnumComposition.ItemComposition_get(var3).name; // L: 3440
			return 1; // L: 3441
		} else {
			int var4;
			...
			if (var0 == ScriptOpcodes.OC_OP) { // L: 3443
				...
				var5 = EnumComposition.ItemComposition_get(var3); // L: 3447
				...
				var5 = EnumComposition.ItemComposition_get(var3); // L: 3456
				...
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = EnumComposition.ItemComposition_get(var3).price; // L: 3463
				return 1; // L: 3464
				...
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = EnumComposition.ItemComposition_get(var3).isStackable == 1 ? 1 : 0; // L: 3468
				return 1; // L: 3469
			} else {
				...
				if (var0 == ScriptOpcodes.OC_CERT) { // L: 3471
					...
					var7 = EnumComposition.ItemComposition_get(var3); // L: 3473
					...
					var7 = EnumComposition.ItemComposition_get(var3); // L: 3480
					...
					Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = EnumComposition.ItemComposition_get(var3).isMembersOnly ? 1 : 0; // L: 3487
					return 1; // L: 3488
					...
					var7 = EnumComposition.ItemComposition_get(var3); // L: 3492
					...
					var7 = EnumComposition.ItemComposition_get(var3); // L: 3499
					...
					if (var0 == ScriptOpcodes.OC_FINDRESET) { // L: 3516
						...
						var4 = EnumComposition.ItemComposition_get(var3).getShiftClickIndex(); // L: 3522
						if (var4 == -1) { // L: 3523
