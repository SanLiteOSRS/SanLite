...
public class UserComparator8 extends AbstractUserComparator {
	...
	static int method2569(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.OC_NAME) {
			...
			Interpreter.Interpreter_stringStack[++ChatChannel.Interpreter_stringStackSize - 1] = class67.ItemComposition_get(var3).name;
			return 1;
		} else {
			int var4;
			...
			if (var0 == ScriptOpcodes.OC_OP) {
				...
				var5 = class67.ItemComposition_get(var3);
				...
				var3 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize];
				Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = class67.ItemComposition_get(var3).price;
				return 1;
			} else if (var0 == ScriptOpcodes.OC_STACKABLE) {
				var3 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize];
				Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = class67.ItemComposition_get(var3).isStackable == 1 ? 1 : 0;
				return 1;
			} else {
				ItemComposition var7;
				if (var0 == ScriptOpcodes.OC_CERT) {
					var3 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize];
					var7 = class67.ItemComposition_get(var3);
					...
					var3 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize];
					Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = class67.ItemComposition_get(var3).isMembersOnly ? 1 : 0;
					return 1;
					...
					if (var0 == ScriptOpcodes.OC_FINDRESET) {
						...
						var3 = Interpreter.Interpreter_intStack[--class295.Interpreter_intStackSize];
						var4 = class67.ItemComposition_get(var3).getShiftClickIndex();
						if (var4 == -1) {
