...
final class class4 implements class0 {
	...
	static int method63(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.FRIEND_COUNT) {
			if (ModeWhere.friendSystem.loadingProgress == 0) {
				Interpreter.Interpreter_intStack[++UrlRequester.Interpreter_intStackSize - 1] = -2;
			} else if (ModeWhere.friendSystem.loadingProgress == 1) {
			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					Interpreter.Interpreter_intStack[++UrlRequester.Interpreter_intStackSize - 1] = ClientPreferences.clanChat != null ? ClientPreferences.clanChat.rank : 0;
					return 1;
