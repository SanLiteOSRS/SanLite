...
public final class class4 {
	...
	public static void RunException_sendStackTrace(String var0, Throwable var1) {
		if (var1 != null) {
			...
			try {
				...
				URL var3 = new URL(RunException.RunException_applet.getCodeBase(), "clienterror.ws?c=" + RunException.RunException_revision + "&u=" + RunException.field4411 + "&v1=" + TaskHandler.javaVendor + "&v2=" + TaskHandler.javaVersion + "&ct=" + RunException.clientType + "&e=" + var2);
	...
	static final void method21(Actor var0) {
		if (var0.field1140 == Client.cycle || var0.sequence == -1 || var0.sequenceDelay != 0 || var0.sequenceFrameCycle + 1 > class17.SequenceDefinition_get(var0.sequence).frameLengths[var0.sequenceFrame]) {
			...
			int var3 = var0.field1135 * 128 + var0.field1137 * 64;
			int var4 = var0.field1141 * 128 + var0.field1137 * 64;
			int var5 = var0.field1121 * 128 + var0.field1137 * 64;
			int var6 = var0.field1110 * 128 + var0.field1137 * 64;
