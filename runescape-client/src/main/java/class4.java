				...
				try {
					...
					while (true) {
						...
						if (var29 >= 100) {
							...
							String var31 = WorldMapDecorationType.method4217(Interpreter.Interpreter_stringStack, WorldMapDecoration.Interpreter_stringStackSize, var11);
