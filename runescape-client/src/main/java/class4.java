...
public final class class4 {
	...
	static Widget field11;

	@ObfuscatedName("ad")
	@ObfuscatedSignature(
		descriptor = "(Lpj;Lpj;Lpj;B)V",
		garbageValue = "-90"
	)
	@Export("drawTitle")
	static void drawTitle(Font var0, Font var1, Font var2) {
		Login.xPadding = (VarbitComposition.canvasWidth - 765) / 2; // L: 1431
		Login.loginBoxX = Login.xPadding + 202; // L: 1432
		class324.loginBoxCenter = Login.loginBoxX + 180; // L: 1433
		if (Login.worldSelectOpen) { // L: 1434
			Tiles.method2233(var0, var1); // L: 1435
		} else {
			class372.leftTitleSprite.drawAt(Login.xPadding, 0); // L: 1438
			class391.rightTitleSprite.drawAt(Login.xPadding + 382, 0); // L: 1439
			Login.logoSprite.drawAt(Login.xPadding + 382 - Login.logoSprite.subWidth / 2, 18); // L: 1440
			int var4;
			if (Client.gameState == 0 || Client.gameState == 5) { // L: 1441
				...
				Rasterizer2D.Rasterizer2D_fillRectangle(Login.Login_loadingPercent * 3 + (Login.loginBoxX + 180 - 150), var4 + 2, 300 - Login.Login_loadingPercent * 3, 30, 0); // L: 1448
			...
			if (Client.gameState == 20) { // L: 1451
				...
				if (Login.loginIndex != 4 && Login.loginIndex != 10) { // L: 1461
					...
					for (var5 = class182.method3637(); var0.stringWidth(var5) > var24; var5 = var5.substring(0, var5.length() - 1)) { // L: 1464 1465 1466
					}

					var0.draw(AbstractFont.escapeBrackets(var5), Login.loginBoxX + 180 - 70, var23, 16777215, 0); // L: 1468
					var23 += 15; // L: 1469

					for (var6 = StudioGame.method6664(Login.Login_password); var0.stringWidth(var6) > var24; var6 = var6.substring(1)) { // L: 1470 1471 1472
					}
			...
			if (Client.gameState == 10 || Client.gameState == 11 || Client.gameState == 50) { // L: 1478
				...
				if (Login.loginIndex == 0) { // L: 1480
					...
					var17 = 321; // L: 1502
					class308.field3453.drawAt(var4 - 73, var17 - 20); // L: 1503
					var0.drawCentered("Continue", var4, var17 + 5, 16777215, 0); // L: 1504
					var4 = Login.loginBoxX + 180 + 80; // L: 1505
					class308.field3453.drawAt(var4 - 73, var17 - 20); // L: 1506
					var0.drawCentered("Cancel", var4, var17 + 5, 16777215, 0); // L: 1507
				} else {
					int var7;
					if (Login.loginIndex == 2) { // L: 1509
						var22 = 201; // L: 1510
						var0.drawCentered(Login.Login_response1, class324.loginBoxCenter, var22, 16776960, 0); // L: 1511
						var23 = var22 + 15; // L: 1512
						var0.drawCentered(Login.Login_response2, class324.loginBoxCenter, var23, 16776960, 0); // L: 1513
						var23 += 15; // L: 1514
						var0.drawCentered(Login.Login_response3, class324.loginBoxCenter, var23, 16776960, 0); // L: 1515
						var23 += 15; // L: 1516
						var23 += 7; // L: 1517
						var0.draw("Login: ", class324.loginBoxCenter - 110, var23, 16777215, 0); // L: 1518
						var24 = 200; // L: 1519

						for (var5 = class182.method3637(); var0.stringWidth(var5) > var24; var5 = var5.substring(1)) { // L: 1520 1521 1522
						}

						var0.draw(AbstractFont.escapeBrackets(var5) + (Login.currentLoginField == 0 & Client.cycle % 40 < 20 ? class17.colorStartTag(16776960) + "|" : ""), class324.loginBoxCenter - 70, var23, 16777215, 0); // L: 1524
						var23 += 15; // L: 1525

						for (var6 = StudioGame.method6664(Login.Login_password); var0.stringWidth(var6) > var24; var6 = var6.substring(1)) { // L: 1526 1527 1528
						}

						var0.draw("Password: " + var6 + (Login.currentLoginField == 1 & Client.cycle % 40 < 20 ? class17.colorStartTag(16776960) + "|" : ""), class324.loginBoxCenter - 108, var23, 16777215, 0); // L: 1530
						var23 += 15; // L: 1531
						var22 = 277; // L: 1532
						var7 = class324.loginBoxCenter + -117; // L: 1533
						boolean var9 = Client.Login_isUsernameRemembered; // L: 1535
						boolean var10 = Login.field914; // L: 1536
						IndexedSprite var20 = var9 ? (var10 ? Buffer.field5063 : MenuAction.field907) : (var10 ? class218.field2401 : FloorUnderlayDefinition.field2095); // L: 1538
						...
						var7 = class324.loginBoxCenter + 24; // L: 1544
						boolean var13 = ScriptFrame.clientPreferences.method2505(); // L: 1546
						boolean var14 = Login.field940; // L: 1547
						IndexedSprite var12 = var13 ? (var14 ? Buffer.field5063 : MenuAction.field907) : (var14 ? class218.field2401 : FloorUnderlayDefinition.field2095); // L: 1549
						...
						int var15 = class324.loginBoxCenter - 80; // L: 1556
						short var16 = 321; // L: 1557
						class308.field3453.drawAt(var15 - 73, var16 - 20); // L: 1558
						var0.drawCentered("Login", var15, var16 + 5, 16777215, 0); // L: 1559
						var15 = class324.loginBoxCenter + 80; // L: 1560
						class308.field3453.drawAt(var15 - 73, var16 - 20); // L: 1561
						var0.drawCentered("Cancel", var15, var16 + 5, 16777215, 0); // L: 1562
						var22 = 357; // L: 1563
						switch(Login.field927) { // L: 1564
						case 2:
							class324.field3542 = "Having trouble logging in?"; // L: 1569
							break;
						default:
							class324.field3542 = "Can't login? Click here."; // L: 1566
						}

						class305.field3405 = new Bounds(class324.loginBoxCenter, var22, var1.stringWidth(class324.field3542), 11); // L: 1572
						class372.field4350 = new Bounds(class324.loginBoxCenter, var22, var1.stringWidth("Still having trouble logging in?"), 11); // L: 1573
						var1.drawCentered(class324.field3542, class324.loginBoxCenter, var22, 16777215, 0); // L: 1574
						...
						var17 = 276; // L: 1585
						class308.field3453.drawAt(var4 - 73, var17 - 20); // L: 1586
						var2.drawCentered("Try again", var4, var17 + 5, 16777215, 0); // L: 1587
						var4 = Login.loginBoxX + 180; // L: 1588
						var17 = 326; // L: 1589
						class308.field3453.drawAt(var4 - 73, var17 - 20); // L: 1590
						...
						if (Login.loginIndex == 4) { // L: 1593
							...
							var23 += 15; // L: 1601
							var0.draw("PIN: " + StudioGame.method6664(class165.otp) + (Client.cycle % 40 < 20 ? class17.colorStartTag(16776960) + "|" : ""), Login.loginBoxX + 180 - 108, var23, 16777215, 0); // L: 1602
							var23 -= 8; // L: 1603
							...
							var4 = 180 + Login.loginBoxX - 9 + var0.stringWidth("for 30 days: ") + 15; // L: 1607
							var27 = var23 - var0.ascent; // L: 1608
							IndexedSprite var25;
							if (Login.field917) { // L: 1610
								var25 = MenuAction.field907; // L: 1611
							} else {
								var25 = FloorUnderlayDefinition.field2095; // L: 1614
							}
							...
							var8 = 321; // L: 1619
							class308.field3453.drawAt(var7 - 73, var8 - 20); // L: 1620
							var0.drawCentered("Continue", var7, var8 + 5, 16777215, 0); // L: 1621
							var7 = Login.loginBoxX + 180 + 80; // L: 1622
							class308.field3453.drawAt(var7 - 73, var8 - 20); // L: 1623
							...
							for (var5 = class182.method3637(); var0.stringWidth(var5) > var24; var5 = var5.substring(1)) { // L: 1639 1640 1641
							}

							var0.draw(AbstractFont.escapeBrackets(var5) + (Client.cycle % 40 < 20 ? class17.colorStartTag(16776960) + "|" : ""), Login.loginBoxX + 180 - 34, var23, 16777215, 0); // L: 1643
							var23 += 15; // L: 1644
							int var19 = Login.loginBoxX + 180 - 80; // L: 1645
							short var26 = 321; // L: 1646
							class308.field3453.drawAt(var19 - 73, var26 - 20); // L: 1647
							var0.drawCentered("Recover", var19, var26 + 5, 16777215, 0); // L: 1648
							var19 = Login.loginBoxX + 180 + 80; // L: 1649
							class308.field3453.drawAt(var19 - 73, var26 - 20); // L: 1650
							var0.drawCentered("Back", var19, var26 + 5, 16777215, 0); // L: 1651
							var26 = 356; // L: 1652
							var1.drawCentered("Still having trouble logging in?", class324.loginBoxCenter, var26, 268435455, 0); // L: 1653
							...
							var17 = 321; // L: 1664
							class308.field3453.drawAt(var4 - 73, var17 - 20); // L: 1665
							var0.drawCentered("Back", var4, var17 + 5, 16777215, 0); // L: 1666
						} else if (Login.loginIndex == 7) { // L: 1668
							if (class496.field5021 && !Client.onMobile) { // L: 1669
								var22 = 201; // L: 1670
								var0.drawCentered(Login.Login_response1, class324.loginBoxCenter, var22, 16776960, 0); // L: 1671
								var23 = var22 + 15; // L: 1672
								var0.drawCentered(Login.Login_response2, class324.loginBoxCenter, var23, 16776960, 0); // L: 1673
								var23 += 15; // L: 1674
								var0.drawCentered(Login.Login_response3, class324.loginBoxCenter, var23, 16776960, 0); // L: 1675
								var4 = class324.loginBoxCenter - 150; // L: 1676
								var23 += 10; // L: 1677

								for (var27 = 0; var27 < 8; ++var27) { // L: 1678
									class308.field3453.method9508(var4, var23, 30, 40); // L: 1679
									boolean var28 = var27 == Login.field918 & Client.cycle % 40 < 20; // L: 1680
									var0.draw((Login.field936[var27] == null ? "" : Login.field936[var27]) + (var28 ? class17.colorStartTag(16776960) + "|" : ""), var4 + 10, var23 + 27, 16777215, 0); // L: 1681
								...
								var27 = class324.loginBoxCenter - 80; // L: 1690
								short var29 = 321; // L: 1691
								class308.field3453.drawAt(var27 - 73, var29 - 20); // L: 1692
								var0.drawCentered("Submit", var27, var29 + 5, 16777215, 0); // L: 1693
								var27 = class324.loginBoxCenter + 80; // L: 1694
								class308.field3453.drawAt(var27 - 73, var29 - 20); // L: 1695
							...
							var17 = 321; // L: 1724
							class308.field3453.drawAt(var4 - 73, var17 - 20); // L: 1725
							var0.drawCentered("Privacy Policy", var4, var17 + 5, 16777215, 0); // L: 1726
							var4 = Login.loginBoxX + 180 + 80; // L: 1727
							class308.field3453.drawAt(var4 - 73, var17 - 20); // L: 1728
							...
							var17 = 311; // L: 1739
							class308.field3453.drawAt(var4 - 73, var17 - 20); // L: 1740
							...
							class134.field1588.drawAt(var23 - 109, var4); // L: 1748
							if (Login.field937.isEmpty()) { // L: 1749
								class135.field1595.drawAt(var23 - 48, var4 + 18); // L: 1750
							} else {
								class135.field1595.drawAt(var23 - 48, var4 + 5); // L: 1753
								var0.drawCentered(Login.field937, var23, var4 + 68 - 15, 16776960, 0); // L: 1754
							}
						} else if (Login.loginIndex == 12) { // L: 1757
							var23 = class324.loginBoxCenter; // L: 1758
							var24 = 216; // L: 1759
							...
							var23 = class324.loginBoxCenter - 80; // L: 1767
							var24 = 311; // L: 1768
							class308.field3453.drawAt(var23 - 73, var24 - 20); // L: 1769
							var0.drawCentered("Accept", var23, var24 + 5, 16777215, 0); // L: 1770
							var23 = class324.loginBoxCenter + 80; // L: 1771
							class308.field3453.drawAt(var23 - 73, var24 - 20); // L: 1772
							...
							var22 = 311; // L: 1781
							class308.field3453.drawAt(var4 - 73, var22 - 20); // L: 1782
							...
							var5 = ""; // L: 1788
							var6 = ""; // L: 1789
							switch(Login.field938) { // L: 1790
							case 0:
								var18 = "Your account has been involved"; // L: 1807
								var5 = "in serious rule breaking."; // L: 1808
								var6 = ""; // L: 1809
								break; // L: 1810
							case 1:
								var18 = "Your account has been locked due to"; // L: 1793
								var5 = "suspicious activity."; // L: 1794
								var6 = "Please recover your account."; // L: 1795
								break;
							case 2:
								var18 = "The unpaid balance on your account needs"; // L: 1800
								var5 = "to be resolved before you can play."; // L: 1801
								var6 = Strings.field3969; // L: 1802
								break; // L: 1803
							default:
								ScriptFrame.Login_promptCredentials(false); // L: 1814
							}
							...
							var8 = 276; // L: 1824
							class308.field3453.drawAt(var7 - 73, var8 - 20); // L: 1825
							if (Login.field938 == 1) { // L: 1826
							...
							var8 = 326; // L: 1833
							class308.field3453.drawAt(var7 - 73, var8 - 20); // L: 1834
							...
							var17 = 301; // L: 1846
							class308.field3453.drawAt(var4 - 73, var17 - 20); // L: 1847
							...
							var17 = 276; // L: 1875
							class308.field3453.drawAt(var4 - 73, var17 - 20); // L: 1876
							var2.drawCentered("Download Launcher", var4, var17 + 5, 16777215, 0); // L: 1877
							var4 = Login.loginBoxX + 180; // L: 1878
							var17 = 326; // L: 1879
							class308.field3453.drawAt(var4 - 73, var17 - 20); // L: 1880
			...
			if (Client.gameState >= 10) { // L: 1884
				...
				Rasterizer2D.Rasterizer2D_setClip(Login.xPadding, 0, Login.xPadding + 765, class370.canvasHeight); // L: 1887
				ModelData0.loginScreenRunesAnimation.draw(Login.xPadding - 22, Client.cycle); // L: 1888
				ModelData0.loginScreenRunesAnimation.draw(Login.xPadding + 22 + 765 - 128, Client.cycle); // L: 1889
				Rasterizer2D.Rasterizer2D_setClipArray(var21); // L: 1890
			}

			Message.title_muteSprite[ScriptFrame.clientPreferences.method2507() ? 1 : 0].drawAt(Login.xPadding + 765 - 40, 463); // L: 1892
			if (Client.gameState > 5 && WorldMapElement.clientLanguage == Language.Language_EN) { // L: 1893
				if (class485.field4965 != null) { // L: 1894
					var23 = Login.xPadding + 5; // L: 1895
					var24 = 463; // L: 1896
					byte var31 = 100; // L: 1897
					byte var30 = 35; // L: 1898
					class485.field4965.drawAt(var23, var24); // L: 1899
					var0.drawCentered("World" + " " + Client.worldId, var31 / 2 + var23, var30 / 2 + var24 - 2, 16777215, 0); // L: 1900
					if (World.World_request != null) { // L: 1901
					...
					class485.field4965 = UserComparator4.SpriteBuffer_getIndexedSpriteByName(Nameable.field4637, "sl_button", ""); // L: 1905
				}
			}
