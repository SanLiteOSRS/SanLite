...
final class class4 implements class0 {
   ...
   public static File method71(String var0, String var1, int var2) {
      String var3 = var2 == 0 ? "" : "" + var2;
      class290.field3635 = new File(FontName.userHomeDirectory, "jagex_cl_" + var0 + "_" + var1 + var3 + ".dat");
      String var4 = null;
      String var5 = null;
      boolean var6 = false;
      File var22;
      if (class290.field3635.exists()) {
         try {
            AccessFile var7 = new AccessFile(class290.field3635, "rw", 10000L);
         ...
         if (var4 != null) {
            ...
            if (!GameShell.method1004(var22, true)) {
               var4 = null;
            }
         }
      }
      ...
      if (var4 == null && var2 == 0) {
         ...
         for(int var15 = 0; var15 < Login.field1181.length; ++var15) {
            for(int var16 = 0; var16 < GrandExchangeEvent.field47.length; ++var16) {
               ...
               if (var17.exists() && GameShell.method1004(new File(var17, "test.dat"), true)) {
                  var4 = var17.toString();
                  var6 = true;
                  break label123;
               }
