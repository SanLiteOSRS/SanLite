...
public enum class7 implements Enumerated {
		...
		if (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var1][var2] & 2) != 0 || (Tiles.Tiles_renderFlags[var0][var1][var2] & 16) == 0) {
			...
			if (var5 == 22) {
				...
				if (var5 >= 12) {
					...
					var6.method3160(var0, var1, var2, var16, 1, 1, (Renderable)var34, 0, var19, var21);
					...
					var6.newBoundaryObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field512[var4], 0, var19, var21);
					if (var4 == 0) {
						if (var8.clipped) {
					...
					var6.newBoundaryObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field513[var4], 0, var19, var21);
					if (var8.clipped) {
						if (var4 == 0) {
							Tiles.field511[var0][var1][var2 + 1] = 50;
						} else if (var4 == 1) {
					...
					if (var5 == 2) {
						...
						var6.newBoundaryObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)var30, Tiles.field512[var4], Tiles.field512[var28], var19, var21);
						if (var8.modelClipped) {
							if (var4 == 0) {
								var10000 = GrandExchangeOfferWorldComparator.field52[var0][var1];
								var10000[var2] |= 585;
						...
						var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field512[var4], 0, 0, 0, var19, var21);
					} else {
						long var31;
						Object var33;
						if (var5 == 5) {
							...
							if (var31 != 0L) {
								var28 = WorldMapDecoration.getObjectDefinition(Occluder.Entity_unpackID(var31)).int2;
							}
							...
							var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var33, (Renderable)null, Tiles.field512[var4], 0, var28 * Tiles.field518[var4], var28 * Tiles.field515[var4], var19, var21);
						} else if (var5 == 6) {
							var28 = 8;
							var31 = var6.getBoundaryObjectTag(var0, var1, var2);
							if (var31 != 0L) {
								var28 = WorldMapDecoration.getObjectDefinition(Occluder.Entity_unpackID(var31)).int2 / 2;
							}
							...
							var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var33, (Renderable)null, 256, var4, var28 * Tiles.field509[var4], var28 * Tiles.field517[var4], var19, var21);
						} else if (var5 == 7) {
							var23 = var4 + 2 & 3;
							if (var8.animationId == -1 && var8.transforms == null) {
							...
							var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var33, (Renderable)var26, 256, var4, var28 * Tiles.field509[var4], var28 * Tiles.field517[var4], var19, var21);
						}
					}
				}
			} else {
				...
				if (var34 != null && var6.method3160(var0, var1, var2, var16, var9, var10, (Renderable)var34, var5 == 11 ? 256 : 0, var19, var21) && var8.clipped) {
					var23 = 15;
					...
					for (var24 = 0; var24 <= var9; ++var24) {
						for (int var25 = 0; var25 <= var10; ++var25) {
							if (var23 > Tiles.field511[var0][var24 + var1][var25 + var2]) {
								Tiles.field511[var0][var24 + var1][var25 + var2] = (byte)var23;
							}
						}
					}
				}
	...
	static void method83() {
		...
		if (Login.Login_username.length() == 0) {
			GameEngine.setLoginResponseString("Please enter your username.", "If you created your account after November", "2010, this will be the creation email address.");
		} else {
			long var1;
			try {
			...
			switch(var0) {
			case 2:
				GameEngine.setLoginResponseString(Strings.field3053, Strings.field3054, Strings.field3055);
				Login.loginIndex = 6;
				break;
			case 3:
				GameEngine.setLoginResponseString("", "Error connecting to server.", "");
				break;
			case 4:
				GameEngine.setLoginResponseString("The part of the website you are trying", "to connect to is offline at the moment.", "Please try again later.");
				break;
			case 5:
				GameEngine.setLoginResponseString("Sorry, there was an error trying to", "log you in to this part of the website.", "Please try again later.");
				break;
			case 6:
				GameEngine.setLoginResponseString("", "Error connecting to server.", "");
				break;
			case 7:
				GameEngine.setLoginResponseString("You must enter a valid login to proceed. For accounts", "created after 24th November 2010, please use your", "email address. Otherwise please use your username.");
			}
