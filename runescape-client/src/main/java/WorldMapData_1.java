...
public class WorldMapData_1 extends AbstractWorldMapData {
	...
	static void method4706(boolean var0) {
		...
		if (!class118.method2721()) { // L: 1075
			var1 = 12; // L: 1076
		} else if (class82.client.method1128() || class82.client.isOtlTokenRequesterInitialized()) { // L: 1078
			var1 = 10; // L: 1079
		}
	...
	static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) { // L: 7922
			...
			if (var7 != 0L) { // L: 7932
				...
				if (var1 == 0) { // L: 7937
					class175.scene.removeWallObject(var0, var2, var3); // L: 7938
				...
				if (var1 == 3) { // L: 7949
					class175.scene.removeGroundObject(var0, var2, var3); // L: 7950
