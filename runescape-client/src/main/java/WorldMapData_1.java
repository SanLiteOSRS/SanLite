	...
	static final void addSceneMenuOptions(int var0, int var1, int var2, int var3) {
		...
		for (var8 = 0; var8 < WorldMapSection2.method372(); ++var8) {
			...
			if (var9 != var6) {
				...
				if (var25 == 2 && UserComparator3.scene.getObjectFlags(ItemLayer.Client_plane, var24, var13, var9) >= 0) {
					ObjectComposition var17 = Canvas.getObjectDefinition(var16);
				...
				if (var25 == 3) {
					NodeDeque var32 = Client.groundItems[ItemLayer.Client_plane][var24][var13];
					if (var32 != null) {
						for (TileItem var36 = (TileItem)var32.first(); var36 != null; var36 = (TileItem)var32.next()) {
							ItemComposition var34 = KitDefinition.ItemDefinition_get(var36.id);
							if (Client.isItemSelected == 1) {
