			...
			if (0L != var7) {
				...
				if (var1 == 0) {
					...
					if (var13.interactType != 0) {
						Client.collisionMaps[var0].method3639(var2, var3, var40, var41, var13.boolean1);
					}
				}
				...
				if (var1 == 3) {
					...
					if (var13.interactType == 1) {
						Client.collisionMaps[var0].method3642(var2, var3);
					}
				}
			}
			...
			if (var4 >= 0) {
				...
				if (var6 == 22) {
					...
					if (var6 >= 12) {
						...
						var42.method3166(var0, var2, var3, var23, 1, 1, (Entity)var29, 0, var26, var28);
						...
						if (var15.interactType != 0) {
							var14.method3634(var2, var3, var6, var5, var15.boolean1);
						}
					} else if (var6 == 1) {
						if (var15.animationId == -1 && var15.transforms == null) {
					...
					if (var29 != null) {
						var42.method3166(var0, var2, var3, var23, var16, var17, (Entity)var29, var6 == 11 ? 256 : 0, var26, var28);
					}
