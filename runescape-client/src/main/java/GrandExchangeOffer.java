...
public class GrandExchangeOffer {
   ...
   static final void updateNpcs(boolean var0, PacketBuffer var1) {
      Client.field899 = 0;
      Client.field861 = 0;
      GrandExchangeOfferUnitPriceComparator.method137();
      ...
      for(int var1 = 0; var1 < Client.field861; ++var1) {
         ...
         if ((var4 & 32) != 0) {
            ...
            if (var5 == var3.sequence && var5 != -1) {
               var7 = Widget.getSequenceDefinition(var5).field3492;
               if (var7 == 1) {
            ...
            } else if (var5 == -1 || var3.sequence == -1 || Widget.getSequenceDefinition(var5).field3508 >= Widget.getSequenceDefinition(var3.sequence).field3508) {
               var3.sequence = var5;
               var3.sequenceFrame = 0;
               var3.sequenceFrameCycle = 0;
               var3.sequenceDelay = var6;
         ...
         if ((var4 & 4) != 0) {
            ...
            var3.field971 = var3.definition.field3473;
         ...
         if ((var4 & 8) != 0) {
            ...
            var3.field958 = (var5 & '\uffff') + Client.cycle;
