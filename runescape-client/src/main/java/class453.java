...
public class class453 implements class342 {
	...
	static {
		field4834 = new class453(0, 0, Integer.class, new class450()); // L: 10
		field4828 = new class453(2, 1, Long.class, new class452()); // L: 24
	...
	public Object method8257(Buffer var1) {
		return this.field4829.vmethod8273(var1); // L: 100
	}
	...
	public static VarbitComposition method8258(int var0) {
		...
		if (var1 != null) { // L: 33
			...
			byte[] var2 = GrandExchangeOfferTotalQuantityComparator.VarbitDefinition_archive.takeFile(14, var0); // L: 34
	...
	static Script method8261(int var0, int var1) {
		...
		if (var2 != null) { // L: 53
			...
			int var4 = class188.archive12.getGroupId(var3); // L: 57
			if (var4 == -1) { // L: 58
				return null; // L: 59
			} else {
				byte[] var5 = class188.archive12.takeFileFlat(var4); // L: 61
				if (var5 != null) { // L: 62
					if (var5.length <= 1) { // L: 63
						return null; // L: 64
					}

					var2 = GameEngine.newScript(var5); // L: 66
					if (var2 != null) { // L: 67
	...
	public static class453 method8255(Class var0) {
		class453[] var1 = method8268(); // L: 70

		for (int var2 = 0; var2 < var1.length; ++var2) { // L: 71
			class453 var3 = var1[var2]; // L: 72
	...
	public static void method8265(Object var0, Buffer var1) {
		...
		class453 var4 = method8255(var3); // L: 86
		if (var4 == null) {
			throw new IllegalArgumentException(); // L: 87
		} else {
			class449 var2 = var4.field4829; // L: 88
			var2.vmethod8274(var0, var1); // L: 91
		}
	} // L: 92
	...
	static boolean method8254() {
		return (Client.drawPlayerNames & 8) != 0; // L: 4957
	}
	...
	static void resumePauseWidget(int var0, int var1) {
		PacketBufferNode var2 = FloorUnderlayDefinition.getPacketBufferNode(ClientPacket.field3066, Client.packetWriter.isaacCipher); // L: 9776
		var2.packetBuffer.writeIntME(var1); // L: 9777
		var2.packetBuffer.writeInt(var0); // L: 9778
		Client.packetWriter.addNode(var2); // L: 9779
	} // L: 9780
}
