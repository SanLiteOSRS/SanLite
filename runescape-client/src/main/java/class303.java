		...
		if (var0 == ScriptOpcodes.FRIEND_COUNT) { // L: 2322
			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					if (class145.friendsChatManager != null) { // L: 2390
						Interpreter.Interpreter_stringStack[++VarbitComposition.Interpreter_stringStackSize - 1] = class145.friendsChatManager.name; // L: 2391
					} else {
					...
					if (class145.friendsChatManager != null) { // L: 2397
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class145.friendsChatManager.getSize(); // L: 2398
					} else {
					...
					if (class145.friendsChatManager != null && var3 < class145.friendsChatManager.getSize()) { // L: 2405
						Interpreter.Interpreter_stringStack[++VarbitComposition.Interpreter_stringStackSize - 1] = class145.friendsChatManager.get(var3).getUsername().getName(); // L: 2406
					} else {
					...
					if (class145.friendsChatManager != null && var3 < class145.friendsChatManager.getSize()) { // L: 2413
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = ((Buddy)class145.friendsChatManager.get(var3)).getWorld(); // L: 2414
					} else {
					...
					if (class145.friendsChatManager != null && var3 < class145.friendsChatManager.getSize()) { // L: 2421
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = ((Buddy)class145.friendsChatManager.get(var3)).rank; // L: 2422
					} else {
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class145.friendsChatManager != null ? class145.friendsChatManager.minKick : 0; // L: 2428
					return 1; // L: 2429
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class145.friendsChatManager != null ? class145.friendsChatManager.rank : 0; // L: 2437
					return 1; // L: 2438
					...
					if (class145.friendsChatManager != null && var3 < class145.friendsChatManager.getSize() && class145.friendsChatManager.get(var3).getUsername().equals(class67.localPlayer.username)) { // L: 2475
					...
					if (class145.friendsChatManager != null && class145.friendsChatManager.owner != null) { // L: 2482
						Interpreter.Interpreter_stringStack[++VarbitComposition.Interpreter_stringStackSize - 1] = class145.friendsChatManager.owner; // L: 2483
					} else {
					...
					if (class145.friendsChatManager != null && var3 < class145.friendsChatManager.getSize() && ((FriendsChatMember)class145.friendsChatManager.get(var3)).isFriend()) { // L: 2490
					...
					if (var0 == 3628) {
						...
						if (var0 == 3629) {
							...
							if (class145.friendsChatManager != null) { // L: 2581
								class145.friendsChatManager.removeComparator(); // L: 2582
							}

							return 1; // L: 2584
						} else if (var0 == 3645) {
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1; // L: 2587
							if (class145.friendsChatManager != null) { // L: 2588
								class145.friendsChatManager.addComparator(new UserComparator1(var7)); // L: 2589
							}

							return 1; // L: 2591
						} else if (var0 == 3646) {
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1; // L: 2594
							if (class145.friendsChatManager != null) { // L: 2595
								class145.friendsChatManager.addComparator(new UserComparator2(var7)); // L: 2596
							}

							return 1; // L: 2598
						} else if (var0 == 3647) {
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1; // L: 2601
							if (class145.friendsChatManager != null) { // L: 2602
								class145.friendsChatManager.addComparator(new UserComparator3(var7)); // L: 2603
							}

							return 1; // L: 2605
						} else if (var0 == 3648) {
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1; // L: 2608
							if (class145.friendsChatManager != null) { // L: 2609
								class145.friendsChatManager.addComparator(new UserComparator4(var7)); // L: 2610
							}

							return 1; // L: 2612
						} else if (var0 == 3649) {
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1; // L: 2615
							if (class145.friendsChatManager != null) { // L: 2616
								class145.friendsChatManager.addComparator(new UserComparator5(var7)); // L: 2617
							}

							return 1; // L: 2619
						} else if (var0 == 3650) {
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1; // L: 2622
							if (class145.friendsChatManager != null) { // L: 2623
								class145.friendsChatManager.addComparator(new UserComparator6(var7)); // L: 2624
							}

							return 1; // L: 2626
						} else if (var0 == 3651) {
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1; // L: 2629
							if (class145.friendsChatManager != null) { // L: 2630
								class145.friendsChatManager.addComparator(new UserComparator7(var7)); // L: 2631
							}

							return 1; // L: 2633
						} else if (var0 == 3652) {
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1; // L: 2636
							if (class145.friendsChatManager != null) { // L: 2637
								class145.friendsChatManager.addComparator(new UserComparator8(var7)); // L: 2638
							}

							return 1; // L: 2640
						} else if (var0 == 3653) {
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1; // L: 2643
							if (class145.friendsChatManager != null) { // L: 2644
								class145.friendsChatManager.addComparator(new UserComparator9(var7)); // L: 2645
							}

							return 1; // L: 2647
						} else if (var0 == 3654) {
							var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1; // L: 2650
							if (class145.friendsChatManager != null) { // L: 2651
								class145.friendsChatManager.addComparator(new UserComparator10(var7)); // L: 2652
							}

							return 1; // L: 2654
						} else if (var0 == 3655) {
							if (class145.friendsChatManager != null) { // L: 2657
								class145.friendsChatManager.sort(); // L: 2658
							}
							...
							if (class145.friendsChatManager != null) { // L: 2669
								class145.friendsChatManager.addComparator(new BuddyRankComparator(var7)); // L: 2670
							}
					...
					if (class145.friendsChatManager != null && var3 < class145.friendsChatManager.getSize() && ((FriendsChatMember)class145.friendsChatManager.get(var3)).isIgnored()) { // L: 2498
