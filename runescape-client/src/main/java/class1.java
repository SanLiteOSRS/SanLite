...
final class class1 implements class0 {
   ...
   static final void method18() {
      ...
      TileItem.method2048();
      GrandExchangeOfferUnitPriceComparator.method130();
      class51.method846();
   ...
   static final void calculateActorPosition(Actor var0, int var1) {
      if (var0.field941 > Client.cycle) {
         ...
         if (var0.field965 >= Client.cycle) {
            if (var0.field965 == Client.cycle || var0.sequence == -1 || var0.sequenceDelay != 0 || var0.sequenceFrameCycle + 1 > Widget.getSequenceDefinition(var0.sequence).frameLengths[var0.sequenceFrame]) {
            ...
            var0.field918 = var0.orientation;
         } else {
            ...
            if (var0.pathLength == 0) {
               ...
               label301: {
                  if (var0.sequence != -1 && var0.sequenceDelay == 0) {
                     SequenceDefinition var11 = Widget.getSequenceDefinition(var0.sequence);
                  ...
                  if (var4 - var2 <= 256 && var4 - var2 >= -256 && var5 - var3 <= 256 && var5 - var3 >= -256) {
                     var7 = var0.orientation - var0.field918 & 2047;
                     if (var7 > 1024) {
                        var7 -= 2048;
                     }
                     ...
                     if (var10) {
                        if (var0.field918 != var0.orientation && var0.targetIndex == -1 && var0.field971 != 0) {
                           var9 = 2;
                        }
