...
public class class1 implements Callable {
	...
	public static HealthBarDefinition method12(int var0) {
		HealthBarDefinition var1 = (HealthBarDefinition)HealthBarDefinition.field1667.get((long)var0);
		if (var1 != null) {
			return var1;
		} else {
			...
			HealthBarDefinition.field1667.put(var1, (long)var0);
			return var1;
		}
	}
	...
	static final void playPcmPlayers() {
		if (FriendsChatManager.pcmPlayer1 != null) {
			FriendsChatManager.pcmPlayer1.run();
		}
	...
	static final void method14(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		var5 = Nameable.method5968(var5, var6);
		...
		if (Client.oculusOrbState == 1 && Client.staffModLevel >= 2 && Client.cycle % 50 == 0 && (WorldMapID.oculusOrbFocalPointX >> 7 != class129.localPlayer.x >> 7 || WorldMapRectangle.oculusOrbFocalPointY >> 7 != class129.localPlayer.y >> 7)) {
			...
			var13 = FloorOverlayDefinition.baseX * 64 + (WorldMapID.oculusOrbFocalPointX >> 7);
			var14 = class320.baseY * 64 + (WorldMapRectangle.oculusOrbFocalPointY >> 7);
