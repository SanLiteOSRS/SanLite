					...
					try {
						...
						try {
							...
							while (true) {
								if (var13 < 0) {
									...
									GroundObject.RunException_sendStackTrace(var27.toString(), var31);
									var30 = false;
									break;
								}
						...
						if (var30) {
							...
							if (!var9 && var2 > 0 && var10 >= var2) {
								GroundObject.RunException_sendStackTrace("Warning: Script " + var4.field960 + " finished at op count " + var10 + " of max " + var1, (Throwable)null);
							}
