...
public class class121 extends class103 {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
		...
		if (var2 == 1) {
			...
			var8.packetBuffer.method6786(NPC.baseY * 64 + var1);
			...
			var8.packetBuffer.method6786(GrandExchangeOfferNameComparator.baseX * 64 + var0);
			...
			var8.packetBuffer.method6776(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.method6693(NPC.baseY * 64 + var1);
			var8.packetBuffer.method6693(GrandExchangeOfferNameComparator.baseX * 64 + var0);
			var8.packetBuffer.method6693(var3);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 4) {
			Client.mouseCrossX = var6;
			...
			var8.packetBuffer.method6692(NPC.baseY * 64 + var1);
			var8.packetBuffer.method6692(GrandExchangeOfferNameComparator.baseX * 64 + var0);
			var8.packetBuffer.writeShort(var3);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 5) {
			Client.mouseCrossX = var6;
