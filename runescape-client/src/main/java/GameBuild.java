...
public class GameBuild {
	...
	static void findItemDefinitions(String var0, boolean var1) {
		...
		for (int var4 = 0; var4 < ItemComposition.ItemComposition_fileCount; ++var4) { // L: 12086
			ItemComposition var9 = UserComparator3.ItemComposition_get(var4); // L: 12087
		...
		for (int var5 = 0; var5 < UserComparator4.foundItemIdCount; ++var5) { // L: 12107
			var8[var5] = UserComparator3.ItemComposition_get(var2[var5]).name;
		}
