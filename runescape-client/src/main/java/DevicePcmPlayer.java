...
public class DevicePcmPlayer extends PcmPlayer {
	...
	@Export("init")
	public void init() {
		this.format = new AudioFormat((float)(class472.field4892 * 722468864), 16, PcmPlayer.PcmPlayer_stereo ? 2 : 1, true, false); // L: 22
	...
	public void open(int var1) throws LineUnavailableException {
		try {
			...
			if (class90.method2322(var1) != 1) { // L: 36
				this.open(class193.method3722(var1)); // L: 37
			} else {
				this.line = null; // L: 40
				throw var3; // L: 41
			}
