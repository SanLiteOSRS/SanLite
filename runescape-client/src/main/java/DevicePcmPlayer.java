...
public class DevicePcmPlayer extends PcmPlayer {
	...
	@Export("init")
	protected void init() {
		this.format = new AudioFormat((float)PcmPlayer.field279, 16, PcmPlayer.PcmPlayer_stereo ? 2 : 1, true, false); // L: 22
	...
	protected void open(int var1) throws LineUnavailableException {
		try {
			...
			if (BuddyRankComparator.method2894(var1) != 1) { // L: 36
				this.open(class298.method5751(var1)); // L: 37
			} else {
				this.line = null; // L: 40
				throw var3; // L: 41
			}
