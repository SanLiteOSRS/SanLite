...
public class DevicePcmPlayer extends PcmPlayer {
	...
	@Export("init")
	protected void init() {
		this.format = new AudioFormat((float)PcmPlayer.field271, 16, PcmPlayer.PcmPlayer_stereo ? 2 : 1, true, false); // L: 22
	...
	protected void open(int var1) throws LineUnavailableException {
		try {
			...
			if (class139.method3174(var1) != 1) { // L: 36
				this.open(Calendar.method6620(var1)); // L: 37
			} else {
				this.line = null; // L: 40
				throw var3; // L: 41
			}
