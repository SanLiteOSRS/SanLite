...
public abstract class class165 {
	...
	public String method3295() {
		return this.field1793; // L: 336
	}

	@ObfuscatedName("u")
	@ObfuscatedSignature(
		descriptor = "(I)[Lgl;",
		garbageValue = "-1890926612"
	)
	public static class192[] method3305() {
		return new class192[]{class192.field2201, class192.field2195, class192.field2197, class192.field2194}; // L: 14
	}
}
