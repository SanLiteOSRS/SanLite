		...
		if (class127.field1570 != null) { // L: 12698
			...
			for (int var0 = 0; var0 < Client.players.length; ++var0) { // L: 12701
				if (Client.players[var0] != null) { // L: 12702
					class127.field1570.method5848(SecureRandomCallable.baseX * 64 + (Client.players[var0].x >> 7), GrandExchangeOfferOwnWorldComparator.baseY * 64 + (Client.players[var0].y >> 7)); // L: 12703
				}
			}
		}
