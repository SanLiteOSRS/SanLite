...
public final class class268 {
	...
	static {
		...
		java.util.Calendar.getInstance(method5197("Europe/London"));
	}
	...
	static TimeZone method5197(String var0) {
		synchronized(field3142) {
			TimeZone var2 = (TimeZone)field3142.get(var0);
			if (var2 == null) {
				var2 = TimeZone.getTimeZone(var0);
				field3142.put(var0, var2);
			}
	...
	static void resumePauseWidget(int var0, int var1) {
		PacketBufferNode var2 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2952, Client.packetWriter.isaacCipher);
		var2.packetBuffer.writeIntME(var0);
		var2.packetBuffer.method7710(var1);
	...
	static final void drawInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		for (int var9 = 0; var9 < var0.length; ++var9) {
			...
			if (var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.clickedWidget)) {
				...
				if (!var10.isIf3 || !class1.isComponentHidden(var10)) {
					...
					if (var10 == Client.clickedWidget) {
						if (var1 != -1412584499 && !var10.isScrollBar) {
							class307.field3585 = var0;
							class93.field1252 = var6;
							ItemContainer.field1013 = var7;
							continue;
						}

						if (Client.isDraggingWidget && Client.field696) {
							var15 = MouseHandler.MouseHandler_x;
							var16 = MouseHandler.MouseHandler_y;
							var15 -= Client.widgetClickX;
							var16 -= Client.widgetClickY;
							if (var15 < Client.field773) {
					...
					if (!var10.isIf3 || var15 < var17 && var16 < var18) {
						if (var10.contentType != 0) {
							if (var10.contentType == 1336) {
								if (class131.clientPreferences.method2236()) {
									var13 += 15;
									class13.fontPlain12.drawRightAligned("Fps:" + GameEngine.fps, var12 + var10.width, var13, 16776960, -1);
									var13 += 15;
							...
							if (var10.contentType == 1337) {
								...
								SequenceDefinition.drawEntities(var12, var13, var10.width, var10.height);
								Client.field715[var10.rootIndex] = true;
								Rasterizer2D.Rasterizer2D_setClip(var2, var3, var4, var5);
								continue;
							}

							if (var10.contentType == 1338) {
								ArchiveDiskActionHandler.drawMinimap(var10, var12, var13, var11);
								Rasterizer2D.Rasterizer2D_setClip(var2, var3, var4, var5);
								continue;
							}

							if (var10.contentType == 1339) {
								PacketWriter.drawCompass(var10, var12, var13, var11);
								Rasterizer2D.Rasterizer2D_setClip(var2, var3, var4, var5);
								continue;
							}
							...
							if (var10.contentType == 1402) {
								class341.loginScreenRunesAnimation.draw(var12, Client.cycle);
							}
						}

						if (var10.type == 0) {
							if (!var10.isIf3 && class1.isComponentHidden(var10) && var10 != DevicePcmPlayerProvider.mousedOverWidgetIf1) {
								continue;
							}
							...
							if (var30 != null) {
								class131.drawWidgets(var30.group, var15, var16, var17, var18, var12, var13, var11);
							}

							Rasterizer2D.Rasterizer2D_setClip(var2, var3, var4, var5);
							Rasterizer3D.Rasterizer3D_setClipFromRasterizer2D();
						} else if (var10.type == 11) {
							if (class1.isComponentHidden(var10) && var10 != DevicePcmPlayerProvider.mousedOverWidgetIf1) {
								continue;
							}
						...
						if (Client.isResizable || Client.field717[var11] || Client.gameDrawingMode > 1) {
							...
							if (var10.type != 1) {
								...
								if (var10.type == 2) {
									...
									for (var20 = 0; var20 < var10.rawHeight; ++var20) {
										for (var21 = 0; var21 < var10.rawWidth; ++var21) {
											...
											if (var10.itemIds[var19] <= 0) {
												...
												if (var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3 && var23 < var5 || var10 == class142.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
													SpritePixels var35;
													if (Client.isItemSelected == 1 && var19 == class432.selectedItemSlot && var10.id == TaskHandler.selectedItemWidget) {
														var35 = class135.getItemSprite(var26, var10.itemQuantities[var19], 2, 0, 2, false);
													} else {
														var35 = class135.getItemSprite(var26, var10.itemQuantities[var19], 1, 3153952, 2, false);
													}

													if (var35 != null) {
														if (var10 == class142.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
															...
															if (var1 != -1) {
																...
																if (var25 + var23 < Rasterizer2D.Rasterizer2D_yClipStart && var28.scrollY > 0) {
																	var29 = (Rasterizer2D.Rasterizer2D_yClipStart - var23 - var25) * Client.field556 / 3;
																	if (var29 > Client.field556 * 10) {
																...
																if (var25 + var23 + 32 > Rasterizer2D.Rasterizer2D_yClipEnd && var28.scrollY < var28.scrollHeight - var28.height) {
																	var29 = (var25 + var23 + 32 - Rasterizer2D.Rasterizer2D_yClipEnd) * Client.field556 / 3;
																	if (var29 > Client.field556 * 10) {
																		var29 = Client.field556 * 10;
																	}
									...
									if (Skills.runCs1(var10)) {
										var19 = var10.color2;
										if (var10 == DevicePcmPlayerProvider.mousedOverWidgetIf1 && var10.mouseOverColor2 != 0) {
											var19 = var10.mouseOverColor2;
										}
									} else {
										var19 = var10.color;
										if (var10 == DevicePcmPlayerProvider.mousedOverWidgetIf1 && var10.mouseOverColor != 0) {
											var19 = var10.mouseOverColor;
										}
									}

									if (var10.fill) {
										switch(var10.fillMode.field4699) {
										case 1:
									...
									if (var10.type == 4) {
										...
										if (var39 == null) {
											...
											if (var10.isIf3 && var10.itemId != -1) {
												ItemComposition var45 = class19.ItemComposition_get(var10.itemId);
												var44 = var45.name;
												if (var44 == null) {
													var44 = "null";
												}
										...
										SpritePixels var40;
										if (!var10.isIf3) {
											var40 = var10.getSprite(Skills.runCs1(var10), VerticalAlignment.urlRequester);
											if (var40 != null) {
											...
											if (var10.itemId != -1) {
												...
												var40 = var10.getSprite(false, VerticalAlignment.urlRequester);
											}
										...
										if (var10.type == 6) {
											boolean var36 = Skills.runCs1(var10);
											if (var36) {
											...
											var22 = 0;
											if (var10.itemId != -1) {
												var33 = class19.ItemComposition_get(var10.itemId);
												if (var33 != null) {
												...
												if (var10.modelId == 0) {
													...
													var41 = GrandExchangeEvents.localPlayer.getModel();
												}
											} else if (var20 == -1) {
											...
											Rasterizer3D.method4631(var10.width / 2 + var12, var10.height / 2 + var13);
											...
											if (var41 != null) {
												if (!var10.isIf3) {
													...
													if (var10.modelOrthog) {
														...
														var41.method5003(0, var10.modelAngleY, var10.modelAngleZ, var10.modelAngleX, var10.modelOffsetX, var23 + var22 + var10.modelOffsetY, var24 + var10.modelOffsetY);
													}
												}
											}
												...
												for (var21 = 0; var21 < var10.rawHeight; ++var21) {
													for (var22 = 0; var22 < var10.rawWidth; ++var22) {
														if (var10.itemIds[var20] > 0) {
															var33 = class19.ItemComposition_get(var10.itemIds[var20] - 1);
															String var34;
															if (var33.isStackable != 1 && var10.itemQuantities[var20] == 1) {
																var34 = UserComparator9.colorStartTag(16748608) + var33.name + "</col>";
															} else {
											...
											if (var10.type == 8 && var10 == GrandExchangeOfferOwnWorldComparator.field486 && Client.field657 == Client.field656) {
												var19 = 0;
												var20 = 0;
												...
												String var43;
												for (var32 = class431.method7592(var32, var10); var32.length() > 0; var20 = var20 + var31.ascent + 1) {
												...
												for (var32 = class431.method7592(var32, var10); var32.length() > 0; var26 = var26 + var31.ascent + 1) {
											...
											if (var10.type == 9) {
												...
												if (var10.lineWid == 1) {
													...
													class9.method74(var19, var20, var21, var22, var10.color, var10.lineWid);
												}
											}
										}
									}
