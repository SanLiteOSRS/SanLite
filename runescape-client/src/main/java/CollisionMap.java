...
public class CollisionMap {
	...
	static final void method4176() {
		Client.field691 = 0; // L: 5469
		int var0 = class154.baseX * 64 + (class155.localPlayer.x >> 7); // L: 5470
		int var1 = class365.baseY * 64 + (class155.localPlayer.y >> 7); // L: 5471
		if (var0 >= 3053 && var0 <= 3156 && var1 >= 3056 && var1 <= 3136) { // L: 5472
			Client.field691 = 1;
		}

		if (var0 >= 3072 && var0 <= 3118 && var1 >= 9492 && var1 <= 9535) { // L: 5473
			Client.field691 = 1;
		}

		if (Client.field691 == 1 && var0 >= 3139 && var0 <= 3199 && var1 >= 3008 && var1 <= 3062) { // L: 5474
			Client.field691 = 0;
		}
	...
	static void method4157() {
		if (Client.oculusOrbState == 1) { // L: 12700
			Client.field529 = true; // L: 12701
		}
