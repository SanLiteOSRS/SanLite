...
public class CollisionMap {
	...
	public static SpritePixels[] method4206(AbstractArchive var0, String var1, String var2) {
		if (!var0.isValidFileName(var1, var2)) { // L: 176
			return null;
		} else {
			int var3 = var0.getGroupId(var1); // L: 177
			int var4 = var0.getFileId(var3, var2); // L: 178
			return WorldMapScaleHandler.method5597(var0, var3, var4); // L: 179
		}
	}
}
