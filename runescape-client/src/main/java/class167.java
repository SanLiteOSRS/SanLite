...
public class class167 {
   ...
   static int method3425(char var0, Language var1) {
      int var2 = var0 << 4;
      ...
      if (class185.field2300 == var0) {
         ...
         if (var7 >= 0 && var8 >= 0 && var7 < 103 && var8 < 103) {
            if (var5 == 0) {
               ...
               if (var10 != null) {
                  var42 = BoundaryObject.method3214(var10.tag);
                  if (var3 == 2) {
            ...
            if (var5 == 1) {
               ...
               if (var39 != null) {
                  var42 = BoundaryObject.method3214(var39.tag);
                  if (var3 != 4 && var3 != 5) {
                     if (var3 == 6) {
            ...
            if (var5 == 2) {
               ...
               if (var40 != null) {
                  var40.entity = new DynamicObject(BoundaryObject.method3214(var40.tag), var3, var4, ItemContainer.plane, var7, var8, var9, false, var40.entity);
               }
            }
            ...
            if (var5 == 3) {
               ...
               if (var41 != null) {
                  var41.entity = new DynamicObject(BoundaryObject.method3214(var41.tag), 22, var4, ItemContainer.plane, var7, var8, var9, false, var41.entity);
               }
            }
         }
         ...
         if (class185.field2306 == var0) {
            ...
            if (var7 >= 0 && var8 >= 0 && var7 < 104 && var8 < 104) {
               StudioGame.method4058(ItemContainer.plane, var7, var8, var5, -1, var3, var4, 0, -1);
            }
               ...
               if (class185.field2303 == var0) {
                  ...
                  if (class185.field2298 == var0) {
                     ...
                     if (var17 != null) {
                        ...
                        if (var29 != null) {
                           StudioGame.method4058(ItemContainer.plane, var36, var16, var33, -1, 0, 0, var6 + 1, var3 + 1);
                  ...
                  if (class185.field2305 == var0) {
                     ...
                     if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
                        StudioGame.method4058(ItemContainer.plane, var3, var4, var8, var9, var6, var7, 0, -1);
                     }
