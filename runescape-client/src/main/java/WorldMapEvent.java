...
public class WorldMapEvent {
	...
	static final void drawObject(int var0, int var1, int var2, int var3, int var4) {
		long var5 = class175.scene.getWallObjectTag(var0, var1, var2); // L: 5990
		int var7;
		int var8;
		int var9;
		int var10;
		...
		var5 = class175.scene.getGroundObjectTag(var0, var1, var2); // L: 6104
		if (var5 != 0L) { // L: 6105
				...
				if (var14 == 3) { // L: 10018
					...
					if (var32 != null) { // L: 10020
						for (TileItem var31 = (TileItem)var32.first(); var31 != null; var31 = (TileItem)var32.next()) { // L: 10021 10022 10055
							ItemComposition var35 = FileSystem.ItemComposition_get(var31.id); // L: 10023
