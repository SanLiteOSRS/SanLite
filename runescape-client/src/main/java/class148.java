...
public class class148 extends class129 {
	...
	static final void drawObject(int var0, int var1, int var2, int var3, int var4) {
		long var5 = MusicPatchNode.scene.getWallObjectTag(var0, var1, var2); // L: 5766
		int var7;
		int var8;
		int var9;
		int var10;
		...
		var5 = MusicPatchNode.scene.getGroundObjectTag(var0, var1, var2); // L: 5904
		if (var5 != 0L) { // L: 5905
	...
	static final void Clan_leaveChat() {
		PacketBufferNode var0 = class120.getPacketBufferNode(ClientPacket.field2948, Client.packetWriter.isaacCipher); // L: 11970
