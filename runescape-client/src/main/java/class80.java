...
public class class80 {
	...
	public static void method2147(int var0) {
	...
	static final void method2150(Widget var0, int var1, int var2) {
		...
		if (var0.buttonType == 2 && !Client.isSpellSelected) {
			var3 = SoundCache.method2619(var0);
			if (var3 != null) {
					...
					if (var1 >= var6 && var2 >= var7 && var1 < var6 + 32 && var2 < var7 + 32) {
						...
						if (var0.itemIds[var19] > 0) {
							label325: {
								...
								var10 = -1;
								if (Client.shiftClickDrop && class222.method4219()) {
