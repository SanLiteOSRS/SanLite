...
public abstract class GameEngine extends Applet implements Runnable, FocusListener, WindowListener {
	...
	final void resizeCanvas() {
		...
		if (var1 != null) {
			...
			class68.canvasWidth = Math.min(this.contentWidth, this.maxCanvasWidth);
			Client.canvasHeight = Math.min(this.contentHeight, this.maxCanvasHeight);
			this.canvasX = (this.contentWidth - class68.canvasWidth) / 2;
			this.canvasY = 0;
			this.canvas.setSize(class68.canvasWidth, Client.canvasHeight);
			class263.rasterProvider = new RasterProvider(class68.canvasWidth, Client.canvasHeight, this.canvas);
			if (var1 == this.frame) {
	...
	void clearBackground() {
		...
		int var3 = this.contentWidth - class68.canvasWidth - var1;
	...
	final synchronized void addCanvas() {
		...
		class68.canvasWidth = Math.max(var1.getWidth(), this.field110);
		Client.canvasHeight = Math.max(var1.getHeight(), this.field107);
		Insets var2;
		if (this.frame != null) {
			var2 = this.frame.getInsets();
			class68.canvasWidth -= var2.right + var2.left;
		...
		this.fullRedraw = true;
		if (class263.rasterProvider != null && class68.canvasWidth == class263.rasterProvider.width && Client.canvasHeight == class263.rasterProvider.height) {
	...
	protected final void drawInitial(int var1, String var2, boolean var3) {
		try {
			...
			if (var3) {
				...
				var4.fillRect(0, 0, class68.canvasWidth, Client.canvasHeight);
			}
			...
			try {
				...
				var4.drawImage(class54.field794, class68.canvasWidth / 2 - 152, Client.canvasHeight / 2 - 18, (ImageObserver)null);
			} catch (Exception var9) {
				int var7 = class68.canvasWidth / 2 - 152;
	...
	public final synchronized void paint(Graphics var1) {
		if (this == gameEngine && !isKilled) {
			...
			if (UrlRequester.method2125() - this.field120 > 1000L) {
				...
				if (var2 == null || var2.width >= class68.canvasWidth && var2.height >= Client.canvasHeight) {
