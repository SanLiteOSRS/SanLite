...
public abstract class RouteStrategy {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
		...
		if (var2 == 1) {
			...
			var8.packetBuffer.writeIntME(WorldMapEvent.selectedItemId);
			var8.packetBuffer.writeIntME(class41.baseY * 64 + var1);
			var8.packetBuffer.writeIntME(ChatChannel.selectedItemSlot);
			var8.packetBuffer.method5761(NetFileRequest.baseX * 64 + var0);
			var8.packetBuffer.writeInt(WorldMapLabelSize.selectedItemWidget);
			var8.packetBuffer.writeShort(var3);
			var8.packetBuffer.method5570(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			...
			var8.packetBuffer.writeShort(class41.baseY * 64 + var1);
			var8.packetBuffer.method5761(var3);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 4) {
			Client.mouseCrossX = var6;
			Client.mouseCrossY = var7;
			...
			var8.packetBuffer.method5761(class41.baseY * 64 + var1);
			var8.packetBuffer.method5569(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.method5739(var3);
			var8.packetBuffer.writeIntME(NetFileRequest.baseX * 64 + var0);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 6) {
			Client.mouseCrossX = var6;
			Client.mouseCrossY = var7;
			...
			if (var2 == 7) {
				...
				if (var13 != null) {
					...
					var9.packetBuffer.method5761(var3);
				...
				if (var13 != null) {
					...
					var9.packetBuffer.method5761(Client.selectedSpellChildIndex);
				...
				if (var13 != null) {
					...
					var9.packetBuffer.method5570(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					Client.packetWriter.addNode(var9);
				}
			} else if (var2 == 10) {
				var13 = Client.npcs[var3];
				...
				if (var2 == 14) {
					...
					if (var15 != null) {
						...
						var9.packetBuffer.method5569(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
						var9.packetBuffer.method5588(WorldMapLabelSize.selectedItemWidget);
						var9.packetBuffer.method5761(ChatChannel.selectedItemSlot);
						var9.packetBuffer.method5739(var3);
						var9.packetBuffer.writeShort(WorldMapEvent.selectedItemId);
						Client.packetWriter.addNode(var9);
					}
					...
					var8.packetBuffer.method5761(class41.baseY * 64 + var1);
					var8.packetBuffer.method5761(NetFileRequest.baseX * 64 + var0);
					var8.packetBuffer.method5761(Client.selectedSpellChildIndex);
					var8.packetBuffer.writeIntME(var3);
					var8.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					...
					if (var2 == 24) {
						...
						if (var2 == 25) {
							...
							if (var16 != null) {
								...
								class194.selectSpell(var1, var0, ServerPacket.method3667(FaceNormal.getWidgetClickMask(var16)), var16.itemId);
								Client.isItemSelected = 0;
								Client.selectedSpellActionName = StudioGame.method4183(var16);
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								var8.packetBuffer.method5761(var0);
										...
										if (var2 != 57) {
											if (var2 == 58) {
												...
												if (var16 != null) {
													...
													var9.packetBuffer.writeIntME(Client.field836);
													var9.packetBuffer.method5761(Client.selectedSpellChildIndex);
