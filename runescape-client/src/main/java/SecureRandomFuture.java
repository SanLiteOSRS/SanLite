...
public class SecureRandomFuture {
         ...
         if (var0 == ScriptOpcodes.CC_SETDRAGGABLE) {
            ...
            if (var0 != ScriptOpcodes.CC_SETOPKEY) {
               ...
               if (var0 == ScriptOpcodes.CC_SETOPTKEY) {
                  ...
                  class80.method1982(var4, var5, var9, var10);
                  return 1;
                  ...
                  if (var11 >= 0 && var11 <= 9) {
                     FontName.method5232(var4, var11, var6, var7);
                     return 1;
                  } else {
                  ...
                  FontName.method5232(var4, var5, var6, var7);
                  return 1;
               } else if (var0 == ScriptOpcodes.CC_SETOPKEYIGNOREHELD) {
                  --Interpreter.Interpreter_intStackSize;
                  var11 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize] - 1;
                  if (var11 >= 0 && var11 <= 9) {
                     class30.method534(var4, var11);
                     return 1;
                  } else {
                     throw new RuntimeException();
                  }
               ...
               if (var7 >= 0 && var7 <= 9) {
                  class80.method1982(var4, var7, var8, var9);
                  return 1;
               } else {
                  throw new RuntimeException();
               }
   ...
   static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
      ...
      if (var2 == 1) {
         ...
         var8 = MenuAction.method1994(ClientPacket.field2270, Client.packetWriter.isaacCipher);
         ...
         Client.packetWriter.method2177(var8);
      } else if (var2 == 2) {
         Client.mouseCrossX = var6;
         Client.mouseCrossY = var7;
         Client.mouseCrossColor = 2;
         ...
         Client.destinationX = var0;
         Client.destinationY = var1;
         var8 = MenuAction.method1994(ClientPacket.field2277, Client.packetWriter.isaacCipher);
         ...
         Client.destinationX = var0;
         Client.destinationY = var1;
         var8 = MenuAction.method1994(ClientPacket.field2212, Client.packetWriter.isaacCipher);
         ...
         Client.destinationX = var0;
         Client.destinationY = var1;
         var8 = MenuAction.method1994(ClientPacket.field2264, Client.packetWriter.isaacCipher);
         var8.packetBuffer.method5433(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
         var8.packetBuffer.writeShort(var3);
         var8.packetBuffer.writeShort(RouteStrategy.baseY * 64 + var1);
         var8.packetBuffer.writeShort(PacketWriter.baseX * 64 + var0);
         ...
         Client.destinationX = var0;
         Client.destinationY = var1;
         var8 = MenuAction.method1994(ClientPacket.field2274, Client.packetWriter.isaacCipher);
         var8.packetBuffer.method5432(PacketWriter.baseX * 64 + var0);
         var8.packetBuffer.method5443(var3);
         var8.packetBuffer.method5432(RouteStrategy.baseY * 64 + var1);
         var8.packetBuffer.method5433(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
         ...
         Client.destinationX = var0;
         Client.destinationY = var1;
         var8 = MenuAction.method1994(ClientPacket.field2248, Client.packetWriter.isaacCipher);
         var8.packetBuffer.method5433(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
         ...
         if (var2 == 7) {
            ...
            if (var13 != null) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var9 = MenuAction.method1994(ClientPacket.field2208, Client.packetWriter.isaacCipher);
               ...
               Client.packetWriter.method2177(var9);
            }
         } else if (var2 == 8) {
            var13 = Client.npcs[var3];
            if (var13 != null) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var9 = MenuAction.method1994(ClientPacket.field2271, Client.packetWriter.isaacCipher);
               var9.packetBuffer.method5432(var3);
               var9.packetBuffer.method5545(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
            ...
            if (var13 != null) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var9 = MenuAction.method1994(ClientPacket.field2256, Client.packetWriter.isaacCipher);
               var9.packetBuffer.method5545(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
            ...
            if (var13 != null) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var9 = MenuAction.method1994(ClientPacket.field2186, Client.packetWriter.isaacCipher);
            ...
            if (var13 != null) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var9 = MenuAction.method1994(ClientPacket.field2218, Client.packetWriter.isaacCipher);
               var9.packetBuffer.method5432(var3);
               var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               Client.packetWriter.method2177(var9);
            }
            ...
            if (var13 != null) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var9 = MenuAction.method1994(ClientPacket.field2196, Client.packetWriter.isaacCipher);
            ...
            if (var13 != null) {
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var9 = MenuAction.method1994(ClientPacket.field2216, Client.packetWriter.isaacCipher);
               var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               var9.packetBuffer.method5443(var3);
               Client.packetWriter.method2177(var9);
            }
            ...
            if (var2 == 14) {
               ...
               if (var15 != null) {
                  ...
                  Client.destinationX = var0;
                  Client.destinationY = var1;
                  var9 = MenuAction.method1994(ClientPacket.field2242, Client.packetWriter.isaacCipher);
               ...
               if (var15 != null) {
                  ...
                  Client.destinationX = var0;
                  Client.destinationY = var1;
                  var9 = MenuAction.method1994(ClientPacket.field2240, Client.packetWriter.isaacCipher);
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var8 = MenuAction.method1994(ClientPacket.field2251, Client.packetWriter.isaacCipher);
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var8 = MenuAction.method1994(ClientPacket.field2217, Client.packetWriter.isaacCipher);
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var8 = MenuAction.method1994(ClientPacket.field2190, Client.packetWriter.isaacCipher);
               var8.packetBuffer.method5432(RouteStrategy.baseY * 64 + var1);
               var8.packetBuffer.writeShortLE(var3);
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var8 = MenuAction.method1994(ClientPacket.field2259, Client.packetWriter.isaacCipher);
               var8.packetBuffer.method5432(var3);
               var8.packetBuffer.method5443(PacketWriter.baseX * 64 + var0);
               var8.packetBuffer.writeShort(RouteStrategy.baseY * 64 + var1);
               var8.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var8 = MenuAction.method1994(ClientPacket.field2191, Client.packetWriter.isaacCipher);
               var8.packetBuffer.writeShortLE(RouteStrategy.baseY * 64 + var1);
               var8.packetBuffer.method5435(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               var8.packetBuffer.writeShortLE(PacketWriter.baseX * 64 + var0);
               var8.packetBuffer.writeShortLE(var3);
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var8 = MenuAction.method1994(ClientPacket.field2214, Client.packetWriter.isaacCipher);
               var8.packetBuffer.method5443(RouteStrategy.baseY * 64 + var1);
               var8.packetBuffer.writeShortLE(var3);
               var8.packetBuffer.writeShort(PacketWriter.baseX * 64 + var0);
               var8.packetBuffer.method5435(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               ...
               Client.destinationX = var0;
               Client.destinationY = var1;
               var8 = MenuAction.method1994(ClientPacket.field2236, Client.packetWriter.isaacCipher);
               var8.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
               var8.packetBuffer.method5432(var3);
               var8.packetBuffer.method5443(RouteStrategy.baseY * 64 + var1);
               var8.packetBuffer.writeShort(PacketWriter.baseX * 64 + var0);
               ...
               if (var2 == 24) {
                  ...
                  if (var12) {
                     var10 = MenuAction.method1994(ClientPacket.field2254, Client.packetWriter.isaacCipher);
                     var10.packetBuffer.writeInt(var1);
                     Client.packetWriter.method2177(var10);
                  }
               } else {
                  if (var2 == 25) {
                     var16 = ModelData0.getWidgetChild(var1, var0);
                     if (var16 != null) {
                        WorldMapRegion.method528();
                  ...
                  if (var2 == 26) {
                     ...
                     Widget var14;
                     if (var2 == 28) {
                        var8 = MenuAction.method1994(ClientPacket.field2254, Client.packetWriter.isaacCipher);
                        ...
                        if (Client.field789 == null) {
                           GameShell.method867(var1, var0);
                           Client.field789 = ModelData0.getWidgetChild(var1, var0);
                           FriendSystem.method1822(Client.field789);
                        }
                     } else if (var2 == 31) {
                        var8 = MenuAction.method1994(ClientPacket.field2229, Client.packetWriter.isaacCipher);
                        ...
                        var8 = MenuAction.method1994(ClientPacket.field2187, Client.packetWriter.isaacCipher);
                        var8.packetBuffer.writeIntME(NetCache.field3162);
                        var8.packetBuffer.writeInt(var1);
                        ...
                        var8 = MenuAction.method1994(ClientPacket.field2235, Client.packetWriter.isaacCipher);
                        var8.packetBuffer.writeShortLE(var3);
                        var8.packetBuffer.writeIntME(var1);
                        var8.packetBuffer.writeShort(var0);
                        Client.packetWriter.method2177(var8);
                        ...
                        var8 = MenuAction.method1994(ClientPacket.field2283, Client.packetWriter.isaacCipher);
                        var8.packetBuffer.method5443(var3);
                        ...
                        var8 = MenuAction.method1994(ClientPacket.field2257, Client.packetWriter.isaacCipher);
                        ...
                        var8 = MenuAction.method1994(ClientPacket.field2188, Client.packetWriter.isaacCipher);
                        var8.packetBuffer.method5432(var3);
                        var8.packetBuffer.writeInt(var1);
                        var8.packetBuffer.method5432(var0);
                        Client.packetWriter.method2177(var8);
                        ...
                        var8 = MenuAction.method1994(ClientPacket.field2243, Client.packetWriter.isaacCipher);
                        var8.packetBuffer.writeInt(var1);
                        var8.packetBuffer.writeShort(var0);
                        var8.packetBuffer.writeShort(var3);
                        Client.packetWriter.method2177(var8);
                        ...
                        if (var2 == 39) {
                           var8 = MenuAction.method1994(ClientPacket.field2231, Client.packetWriter.isaacCipher);
                           var8.packetBuffer.method5432(var3);
                           var8.packetBuffer.writeIntLE16(var1);
                           var8.packetBuffer.writeShortLE(var0);
                           Client.packetWriter.method2177(var8);
                           ...
                           var8 = MenuAction.method1994(ClientPacket.field2211, Client.packetWriter.isaacCipher);
                           var8.packetBuffer.writeIntLE16(var1);
                           var8.packetBuffer.writeShortLE(var0);
                           var8.packetBuffer.method5443(var3);
                           Client.packetWriter.method2177(var8);
                           ...
                           var8 = MenuAction.method1994(ClientPacket.field2250, Client.packetWriter.isaacCipher);
                           var8.packetBuffer.writeIntLE(var1);
                           ...
                           var8 = MenuAction.method1994(ClientPacket.field2193, Client.packetWriter.isaacCipher);
                           var8.packetBuffer.writeInt(var1);
                           var8.packetBuffer.method5443(var0);
                           var8.packetBuffer.writeShort(var3);
                           Client.packetWriter.method2177(var8);
                           ...
                           var8 = MenuAction.method1994(ClientPacket.field2268, Client.packetWriter.isaacCipher);
                           var8.packetBuffer.writeShort(var3);
                           var8.packetBuffer.writeIntME(var1);
                           var8.packetBuffer.writeShort(var0);
                           Client.packetWriter.method2177(var8);
                           ...
                           if (var15 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var9 = MenuAction.method1994(ClientPacket.field2272, Client.packetWriter.isaacCipher);
                              var9.packetBuffer.writeShort(var3);
                              var9.packetBuffer.method5545(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              Client.packetWriter.method2177(var9);
                           }
                           ...
                           if (var15 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var9 = MenuAction.method1994(ClientPacket.field2241, Client.packetWriter.isaacCipher);
                              var9.packetBuffer.method5433(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              var9.packetBuffer.method5443(var3);
                              Client.packetWriter.method2177(var9);
                           }
                           ...
                           if (var15 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var9 = MenuAction.method1994(ClientPacket.field2247, Client.packetWriter.isaacCipher);
                              var9.packetBuffer.method5443(var3);
                              var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              Client.packetWriter.method2177(var9);
                           }
                           ...
                           if (var15 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var9 = MenuAction.method1994(ClientPacket.field2279, Client.packetWriter.isaacCipher);
                              var9.packetBuffer.method5432(var3);
                              var9.packetBuffer.method5545(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              Client.packetWriter.method2177(var9);
                           }
                           ...
                           if (var15 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var9 = MenuAction.method1994(ClientPacket.field2262, Client.packetWriter.isaacCipher);
                              var9.packetBuffer.method5433(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              var9.packetBuffer.method5443(var3);
                              Client.packetWriter.method2177(var9);
                           }
                           ...
                           if (var15 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var9 = MenuAction.method1994(ClientPacket.field2249, Client.packetWriter.isaacCipher);
                              var9.packetBuffer.method5443(var3);
                              var9.packetBuffer.method5435(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              Client.packetWriter.method2177(var9);
                           }
                           ...
                           if (var15 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var9 = MenuAction.method1994(ClientPacket.field2260, Client.packetWriter.isaacCipher);
                              var9.packetBuffer.method5435(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              var9.packetBuffer.writeShortLE(var3);
                              Client.packetWriter.method2177(var9);
                           }
                           ...
                           if (var15 != null) {
                              ...
                              Client.destinationX = var0;
                              Client.destinationY = var1;
                              var9 = MenuAction.method1994(ClientPacket.field2273, Client.packetWriter.isaacCipher);
                              var9.packetBuffer.method5545(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                              var9.packetBuffer.method5432(var3);
                              Client.packetWriter.method2177(var9);
                           }
                           ...
                           label758: {
                              if (var2 != 57) {
                                 if (var2 == 58) {
                                    var16 = ModelData0.getWidgetChild(var1, var0);
                                    if (var16 != null) {
                                       var9 = MenuAction.method1994(ClientPacket.field2246, Client.packetWriter.isaacCipher);
                                 ...
                                 if (var2 == 1001) {
                                    ...
                                    Client.destinationX = var0;
                                    Client.destinationY = var1;
                                    var8 = MenuAction.method1994(ClientPacket.field2287, Client.packetWriter.isaacCipher);
                                    var8.packetBuffer.writeShort(var3);
                                    var8.packetBuffer.method5433(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
                                    var8.packetBuffer.method5443(PacketWriter.baseX * 64 + var0);
                                    var8.packetBuffer.method5432(RouteStrategy.baseY * 64 + var1);
                                 ...
                                 if (var2 == 1002) {
                                    ...
                                    Client.mouseCrossColor = 2;
                                    Client.mouseCrossState = 0;
                                    var8 = MenuAction.method1994(ClientPacket.field2239, Client.packetWriter.isaacCipher);
                                    var8.packetBuffer.method5443(var3);
                                    Client.packetWriter.method2177(var8);
                                    break label758;
                                 }
                                 ...
                                 if (var2 == 1003) {
                                    ...
                                    if (var13 != null) {
                                       ...
                                       if (var17 != null) {
                                          var10 = MenuAction.method1994(ClientPacket.field2215, Client.packetWriter.isaacCipher);
                                 ...
                                 if (var2 == 1004) {
                                    ...
                                    Client.mouseCrossColor = 2;
                                    Client.mouseCrossState = 0;
                                    var8 = MenuAction.method1994(ClientPacket.field2209, Client.packetWriter.isaacCipher);
                                    var8.packetBuffer.writeShortLE(var3);
                                    Client.packetWriter.method2177(var8);
                                    break label758;
                                 }
      ...
      if (Client.isItemSelected != 0) {
         Client.isItemSelected = 0;
         FriendSystem.method1822(WorldMapElement.getWidget(FontName.selectedItemWidget));
      }
