				...
				if (var3 != 0) { // L: 138
					...
					if (var3 != 0) { // L: 160
						...
						for (var3 = 0; var3 < Players.Players_pendingUpdateCount; ++var3) { // L: 173
							...
							int var15;
							if ((var6 & 1) != 0) { // L: 197
								var8 = var0.method7964(); // L: 198
								PlayerType var9 = (PlayerType)Varps.findEnumerated(class437.PlayerType_values(), var0.method7955()); // L: 199
								boolean var10 = var0.method7955() == 1; // L: 200
								...
								if (var16 > 0) { // L: 252
									for (var23 = 0; var23 < var16; ++var23) { // L: 253
										...
										if (var12 != 32767) { // L: 256
											...
											var19 = var0.method8023(); // L: 258
											var15 = var12 > 0 ? var0.method7954() : var19; // L: 259
							...
							if ((var6 & 16) != 0) { // L: 275
								var5.field1163 = var0.method8143(); // L: 276
							...
							if ((var6 & 2) != 0) { // L: 306
								var5.targetIndex = var0.method7965(); // L: 307
							...
							if ((var6 & 2048) != 0) { // L: 310
								var5.field1188 = Client.cycle + var0.method7965(); // L: 311
								var5.field1158 = Client.cycle + var0.method8143(); // L: 312
								var5.field1190 = var0.method7960(); // L: 313
								var5.field1191 = var0.readByte(); // L: 314
								var5.field1169 = var0.method7960(); // L: 315
								var5.field1194 = (byte)var0.method8023(); // L: 316
							}

							if ((var6 & 4) != 0) { // L: 318
								var8 = var0.method8023(); // L: 319
								byte[] var21 = new byte[var8]; // L: 320
								Buffer var26 = new Buffer(var21); // L: 321
								var0.method7976(var21, 0, var8); // L: 322
							...
							if ((var6 & 64) != 0) { // L: 339
								var8 = var0.method7964(); // L: 340
								if (var8 == 65535) { // L: 341
									var8 = -1;
								}

								var16 = var0.method7955(); // L: 342
