...
public class SecureRandomFuture {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
				...
				if (Client.cycle >= var4.cycleStart) {
					if (var4.targetIndex > 0) {
						...
						if (var31 != null && var31.x >= 0 && var31.x < 13312 && var31.y >= 0 && var31.y < 13312) {
							var4.setDestination(var31.x, var31.y, getTileHeight(var31.x, var31.y, var4.plane) - var4.endHeight, Client.cycle);
						}
					}
		...
		if (!Client.isCameraLocked) {
			...
			if (Client.oculusOrbState == 1 && Client.staffModLevel >= 2 && Client.cycle % 50 == 0 && (oculusOrbFocalPointX >> 7 != PlayerComposition.localPlayer.x >> 7 || Decimator.oculusOrbFocalPointY >> 7 != PlayerComposition.localPlayer.y >> 7)) {
				var15 = PlayerComposition.localPlayer.plane;
				...
				label692: {
					...
					if (Skeleton.cameraPitch < 310) {
						if (Client.oculusOrbState == 1) {
							...
							var7 = PlayerComposition.localPlayer.x >> 7;
							var8 = PlayerComposition.localPlayer.y >> 7;
						}
					...
					if (PlayerComposition.localPlayer.x >= 0 && PlayerComposition.localPlayer.y >= 0 && PlayerComposition.localPlayer.x < 13312 && PlayerComposition.localPlayer.y < 13312) {
						if ((Tiles.Tiles_renderFlags[GameObject.Client_plane][PlayerComposition.localPlayer.x >> 7][PlayerComposition.localPlayer.y >> 7] & 4) != 0) {
							var6 = GameObject.Client_plane;
						}
		...
		for (var30 = 0; var30 < var16 + Client.npcCount; ++var30) {
			Object var19;
			if (var30 < var16) {
				var19 = Client.players[var29[var30]];
				...
				if (var19 == PlayerComposition.localPlayer) {
					var15 = var30;
					continue;
				}
			} else {
				var19 = Client.npcs[Client.npcIndices[var30 - var16]];
			}

			AbstractWorldMapIcon.drawActor2d((Actor)var19, var30, var0, var1, var2, var3);
		}

		if (Client.renderSelf && var15 != -1) {
			AbstractWorldMapIcon.drawActor2d(PlayerComposition.localPlayer, var15, var0, var1, var2, var3);
		}
		...
		for (var30 = 0; var30 < Client.overheadTextCount; ++var30) {
			int var32 = Client.overheadTextXs[var30];
			...
			while (var23) {
				...
				for (int var24 = 0; var24 < var30; ++var24) {
					if (var20 + 2 > Client.overheadTextYs[var24] - Client.overheadTextAscents[var24] && var20 - var22 < Client.overheadTextYs[var24] + 2 && var32 - var21 < Client.overheadTextXOffsets[var24] + Client.overheadTextXs[var24] && var32 + var21 > Client.overheadTextXs[var24] - Client.overheadTextXOffsets[var24] && Client.overheadTextYs[var24] - Client.overheadTextAscents[var24] < var20) {
			...
			String var33 = Client.overheadText[var30];
			if (Client.chatEffects == 0) {
				...
				if (Client.overheadTextEffects[var30] == 0) {
					GrandExchangeOfferTotalQuantityComparator.fontBold12.drawCentered(var33, var0 + Client.viewportTempX, Client.viewportTempY + var1, var25, 0);
				}

				if (Client.overheadTextEffects[var30] == 1) {
					GrandExchangeOfferTotalQuantityComparator.fontBold12.drawCenteredWave(var33, var0 + Client.viewportTempX, Client.viewportTempY + var1, var25, 0, Client.viewportDrawCount);
				}

				if (Client.overheadTextEffects[var30] == 2) {
					GrandExchangeOfferTotalQuantityComparator.fontBold12.drawCenteredWave2(var33, var0 + Client.viewportTempX, Client.viewportTempY + var1, var25, 0, Client.viewportDrawCount);
				}

				if (Client.overheadTextEffects[var30] == 3) {
					GrandExchangeOfferTotalQuantityComparator.fontBold12.drawCenteredShake(var33, var0 + Client.viewportTempX, Client.viewportTempY + var1, var25, 0, Client.viewportDrawCount, 150 - Client.overheadTextCyclesRemaining[var30]);
				}

				if (Client.overheadTextEffects[var30] == 4) {
					var26 = (150 - Client.overheadTextCyclesRemaining[var30]) * (GrandExchangeOfferTotalQuantityComparator.fontBold12.stringWidth(var33) + 100) / 150;
					Rasterizer2D.Rasterizer2D_expandClip(var0 + Client.viewportTempX - 50, var1, var0 + Client.viewportTempX + 50, var3 + var1);
					GrandExchangeOfferTotalQuantityComparator.fontBold12.draw(var33, var0 + Client.viewportTempX + 50 - var26, Client.viewportTempY + var1, var25, 0);
					Rasterizer2D.Rasterizer2D_setClip(var0, var1, var0 + var2, var3 + var1);
				}
				...
				if (Client.overheadTextEffects[var30] == 5) {
					...
					GrandExchangeOfferTotalQuantityComparator.fontBold12.drawCentered(var33, var0 + Client.viewportTempX, var27 + Client.viewportTempY + var1, var25, 0);
					Rasterizer2D.Rasterizer2D_setClip(var0, var1, var0 + var2, var3 + var1);
				}
			} else {
				GrandExchangeOfferTotalQuantityComparator.fontBold12.drawCentered(var33, var0 + Client.viewportTempX, Client.viewportTempY + var1, 16776960, 0);
			}
		}

		if (Client.hintArrowType == 2) {
			GrandExchangeOffer.worldToScreen(Client.hintArrowSubX * 64 + (Client.hintArrowX - NetFileRequest.baseX * 64 << 7), Client.hintArrowSubY * 64 + (Client.hintArrowY - class41.baseY * 64 << 7), Client.field820 * 4);
