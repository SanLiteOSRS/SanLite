      ...
      if (Login.worldSelectOpen) {
         ...
         if (SoundCache.worldSelectBackSprites != null) {
            ...
            do {
               var27 = var34;
               var38 = var35;
               if (var34 * (var35 - 1) >= World.worldsCount) {
                  --var35;
               }

               if (var35 * (var34 - 1) >= World.worldsCount) {
                  --var34;
               }
            ...
            int var11 = (var34 + World.worldsCount - 1) / var34;
            ...
            for(var17 = var34 * var43; var17 < World.worldsCount && var43 - Login.worldSelectPage < var35; ++var17) {
               ...
               if (MouseHandler.MouseHandler_x >= var40 && MouseHandler.MouseHandler_y >= var12 && MouseHandler.MouseHandler_x < var40 + var23 && MouseHandler.MouseHandler_y < var12 + var49 && var19) {
                  ...
                  SoundCache.worldSelectBackSprites[var21].drawAtTransOverlay(var40, var12, 128, 16777215);
                  var42 = true;
               } else {
