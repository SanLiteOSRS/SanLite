...
public class Decimator {
	...
	static void method1108(int var0, int var1) {
		long var2 = (long)((var0 << 16) + var1); // L: 134
		NetFileRequest var4 = (NetFileRequest)NetCache.NetCache_pendingWrites.get(var2); // L: 135
		if (var4 != null) { // L: 136
			NetCache.NetCache_pendingWritesQueue.addLast(var4); // L: 137
		}
	} // L: 138
	...
	static final void method1109() {
		if (UserComparator8.FriendsChatManager_inFriendsChat) { // L: 3901
			if (MenuAction.friendsChatManager != null) { // L: 3902
				MenuAction.friendsChatManager.sort(); // L: 3903
			}

			HealthBar.method2478(); // L: 3905
			UserComparator8.FriendsChatManager_inFriendsChat = false; // L: 3906
		}
