...
public class Decimator {
			...
			if (Client.titleLoadingStage == 60) {
				...
				if (Client.titleLoadingStage == 70) {
					if (!FriendLoginUpdate.archive2.isFullyLoaded()) {
						...
						DecorativeObject.method4296(FriendLoginUpdate.archive2, WorldMapLabelSize.archive7);
						...
						FloorOverlayDefinition.Ignored_cached = new class409(HorizontalAlignment.field1846, 47, class122.clientLanguage, FriendLoginUpdate.archive2);
					...
					if (class10.mapSceneSprites == null) {
						...
						if (!class125.SpriteBuffer_loadSpritesFromArchive(var2, var3, 0)) {
							var1 = null;
						} else {
					...
					if (ObjectSound.headIconPkSprites == null) {
						ObjectSound.headIconPkSprites = NameableContainer.method6415(Message.archive8, class140.spriteIds.headIconsPk, 0);
					} else {
						++var18;
					}

					if (class4.headIconPrayerSprites == null) {
						class4.headIconPrayerSprites = NameableContainer.method6415(Message.archive8, class140.spriteIds.field4213, 0);
					} else {
						++var18;
					}

					if (SequenceDefinition.headIconHintSprites == null) {
						SequenceDefinition.headIconHintSprites = NameableContainer.method6415(Message.archive8, class140.spriteIds.field4209, 0);
					} else {
						++var18;
					}

					if (Varcs.mapMarkerSprites == null) {
						Varcs.mapMarkerSprites = NameableContainer.method6415(Message.archive8, class140.spriteIds.field4215, 0);
					} else {
						++var18;
					}

					if (WorldMapData_1.crossSprites == null) {
						WorldMapData_1.crossSprites = NameableContainer.method6415(Message.archive8, class140.spriteIds.field4216, 0);
					} else {
						++var18;
					}

					if (Huffman.mapDotSprites == null) {
						Huffman.mapDotSprites = NameableContainer.method6415(Message.archive8, class140.spriteIds.field4214, 0);
					} else {
						++var18;
					}
	...
	static final void loadRegions(boolean var0, PacketBuffer var1) {
		...
		if (!Client.isInInstance) {
			var2 = var1.method7408();
			var3 = var1.method7408();
			...
			var3 = var1.method7562();
			boolean var15 = var1.method7398() == 1;
