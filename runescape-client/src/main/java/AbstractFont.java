...
public abstract class AbstractFont extends Rasterizer2D {
				...
				if (var13 != 32 && var13 != 160) { // L: 91
					for (var8 = 0; var8 < 256; ++var8) { // L: 92
						if (var8 != 32 && var8 != 160) { // L: 93
							this.kerning[var8 + (var13 << 8)] = (byte)method7142(var11, var12, var4, this.advances, var10, var13, var8); // L: 94
						}
					}
				}
			}
	...
	public int charWidth(char var1) {
		...
		return this.advances[class18.charToByteCp1252(var1) & 255]; // L: 125
	}
		...
		if (var1 == null) { // L: 129
			...
			for (int var5 = 0; var5 < var1.length(); ++var5) { // L: 133
				...
				if (var6 == '<') { // L: 135
						...
						if (var7.equals("lt")) { // L: 142
							...
							if (!var7.equals("gt")) { // L: 143
								if (var7.startsWith("img=")) { // L: 144
									try {
										int var8 = GrandExchangeEvent.method6573(var7.substring(4)); // L: 146
					...
					if (var2 == -1) { // L: 156
						var4 += this.advances[(char)(class18.charToByteCp1252(var6) & 255)]; // L: 157
				...
				if (var15 == '<') { // L: 179
					...
					if (var15 == '>' && var10 != -1) { // L: 183
						...
						if (var16.equals("br")) { // L: 189
							...
							try {
								int var17 = GrandExchangeEvent.method6573(var16.substring(4)); // L: 209
	...
	public Bounds method7149(int var1, int var2, String var3, int var4, int var5) {
	...
	public class451 method7155(class379 var1, int var2, int var3, int var4, int var5, int var6) {
		if (!var1.method7246()) { // L: 353
			this.reset(var4, var5); // L: 354
			var3 -= this.ascent; // L: 355

			for (int var7 = 0; var7 < var1.method7247(); ++var7) { // L: 356
				class377 var8 = var1.method7251(var7); // L: 357
				if (var6 != -1 && var8.field4378 > var6) { // L: 358 359
					return new class451(var8.field4379, var8.field4378); // L: 360
				}

				char var9 = var8.field4380; // L: 363
				if (var9 != '\n') { // L: 364
					if (var1.method7245(var7)) { // L: 365
						var9 = '*'; // L: 366
					}
					...
					if (var9 != '\t') { // L: 368
						...
						int var10 = var2 + var8.field4379; // L: 370
						int var11 = var3 + var8.field4378; // L: 371
	...
	void decodeTag(String var1) {
		try {
			if (var1.startsWith("col=")) { // L: 441
				AbstractFont_color = class319.method6300(var1.substring(4), 16);
			} else if (var1.equals("/col")) { // L: 442
				AbstractFont_color = AbstractFont_previousColor;
			} else if (var1.startsWith("str=")) { // L: 443
				AbstractFont_strike = class319.method6300(var1.substring(4), 16);
				...
				AbstractFont_underline = class319.method6300(var1.substring(2), 16);
				...
				AbstractFont_shadow = class319.method6300(var1.substring(5), 16);
	...
	void draw0(String var1, int var2, int var3) {
		...
		for (int var6 = 0; var6 < var1.length(); ++var6) { // L: 473
			if (var1.charAt(var6) != 0) { // L: 474
				char var7 = (char)(class18.charToByteCp1252(var1.charAt(var6)) & 255); // L: 475
				if (var7 == '<') { // L: 476
					var4 = var6; // L: 477
				} else {
					int var9;
						...
						if (var8.equals("lt")) { // L: 483
							...
							if (!var8.equals("gt")) { // L: 484
								if (var8.startsWith("img=")) { // L: 485
									try {
										var9 = GrandExchangeEvent.method6573(var8.substring(4)); // L: 487
					...
					if (var4 == -1) { // L: 502
						...
						if (AbstractFont_strike != -1) { // L: 524
							Rasterizer2D.method8986(var2, var3 + (int)((double)this.ascent * 0.7D), var13, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) { // L: 525
							Rasterizer2D.method8986(var2, var3 + this.ascent + 1, var13, AbstractFont_underline);
						}
	...
	void drawWithOffsets0(String var1, int var2, int var3, int[] var4, int[] var5) {
		...
		for (int var9 = 0; var9 < var1.length(); ++var9) { // L: 537
			if (var1.charAt(var9) != 0) { // L: 538
				char var10 = (char)(class18.charToByteCp1252(var1.charAt(var9)) & 255); // L: 539
				if (var10 == '<') { // L: 540
					var6 = var9; // L: 541
				} else {
					int var12;
							...
							if (!var11.equals("gt")) { // L: 548
								if (var11.startsWith("img=")) { // L: 549
									try {
										...
										++var8; // L: 557
										var14 = GrandExchangeEvent.method6573(var11.substring(4)); // L: 558
					...
					if (var6 == -1) { // L: 573
						...
						if (AbstractFont_strike != -1) { // L: 602
							Rasterizer2D.method8986(var2, var3 + (int)((double)this.ascent * 0.7D), var18, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) { // L: 603
							Rasterizer2D.method8986(var2, var3 + this.ascent, var18, AbstractFont_underline);
						}
	...
	@ObfuscatedName("ar")
	static int method7142(byte[][] var0, byte[][] var1, int[] var2, int[] var3, int[] var4, int var5, int var6) {
