...
public abstract class AbstractFont extends Rasterizer2D {
				...
				if (var13 != 32 && var13 != 160) { // L: 90
					for (var8 = 0; var8 < 256; ++var8) { // L: 91
						if (var8 != 32 && var8 != 160) { // L: 92
							this.kerning[var8 + (var13 << 8)] = (byte)method6410(var11, var12, var4, this.advances, var10, var13, var8); // L: 93
						}
					}
				}
			}
	...
	int charWidth(char var1) {
		...
		return this.advances[Calendar.charToByteCp1252(var1) & 255]; // L: 124
	}
		...
		if (var1 == null) { // L: 128
			...
			for (int var5 = 0; var5 < var1.length(); ++var5) { // L: 132
				...
				if (var6 == '<') { // L: 134
						...
						if (var7.equals("lt")) { // L: 141
							...
							if (!var7.equals("gt")) { // L: 142
								if (var7.startsWith("img=")) { // L: 143
									try {
										int var8 = class121.method2824(var7.substring(4)); // L: 145
					...
					if (var2 == -1) { // L: 155
						var4 += this.advances[(char)(Calendar.charToByteCp1252(var6) & 255)]; // L: 156
				...
				if (var15 == '<') { // L: 178
					...
					if (var15 == '>' && var10 != -1) { // L: 182
						...
						if (var16.equals("br")) { // L: 188
							...
							try {
								int var17 = class121.method2824(var16.substring(4)); // L: 208
	...
	@ObfuscatedName("y")
	@ObfuscatedSignature(
		descriptor = "(IILjava/lang/String;II)Lnz;"
	)
	public Bounds method6408(int var1, int var2, String var3, int var4, int var5) {
	...
	void decodeTag(String var1) {
		try {
			...
			if (var1.startsWith("col=")) { // L: 407
				...
				var2 = Strings.method5775(var3, 16, true); // L: 411
				...
				var2 = Strings.method5775(var3, 16, true); // L: 420
				...
				var2 = Strings.method5775(var3, 16, true); // L: 430
				...
				var2 = Strings.method5775(var3, 16, true); // L: 440
	...
	void draw0(String var1, int var2, int var3) {
		...
		for (int var6 = 0; var6 < var1.length(); ++var6) { // L: 467
			if (var1.charAt(var6) != 0) { // L: 468
				char var7 = (char)(Calendar.charToByteCp1252(var1.charAt(var6)) & 255); // L: 469
				if (var7 == '<') { // L: 470
					var4 = var6; // L: 471
				} else {
					int var9;
						...
						if (var8.equals("lt")) { // L: 477
							...
							if (!var8.equals("gt")) { // L: 478
								if (var8.startsWith("img=")) { // L: 479
									try {
										var9 = class121.method2824(var8.substring(4)); // L: 481
					...
					if (var4 == -1) { // L: 496
						...
						if (AbstractFont_strike != -1) { // L: 518
							Rasterizer2D.method8058(var2, var3 + (int)((double)this.ascent * 0.7D), var13, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) { // L: 519
							Rasterizer2D.method8058(var2, var3 + this.ascent + 1, var13, AbstractFont_underline);
						}
	...
	void drawWithOffsets0(String var1, int var2, int var3, int[] var4, int[] var5) {
		...
		for (int var9 = 0; var9 < var1.length(); ++var9) { // L: 531
			if (var1.charAt(var9) != 0) { // L: 532
				char var10 = (char)(Calendar.charToByteCp1252(var1.charAt(var9)) & 255); // L: 533
				if (var10 == '<') { // L: 534
					var6 = var9; // L: 535
				} else {
					int var12;
							...
							if (!var11.equals("gt")) { // L: 542
								if (var11.startsWith("img=")) { // L: 543
									try {
										...
										++var8; // L: 551
										var14 = class121.method2824(var11.substring(4)); // L: 552
					...
					if (var6 == -1) { // L: 567
						...
						if (AbstractFont_strike != -1) { // L: 596
							Rasterizer2D.method8058(var2, var3 + (int)((double)this.ascent * 0.7D), var18, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) { // L: 597
							Rasterizer2D.method8058(var2, var3 + this.ascent, var18, AbstractFont_underline);
						}
	...
	@ObfuscatedName("d")
	static int method6410(byte[][] var0, byte[][] var1, int[] var2, int[] var3, int[] var4, int var5, int var6) {
