...
public abstract class AbstractFont extends Rasterizer2D {
				...
				if (var13 != 32 && var13 != 160) { // L: 92
					for (var8 = 0; var8 < 256; ++var8) { // L: 93
						if (var8 != 32 && var8 != 160) { // L: 94
							this.kerning[var8 + (var13 << 8)] = (byte)method7652(var11, var12, var4, this.advances, var10, var13, var8); // L: 95
						}
					}
				}
			}
	...
	public int charWidth(char var1) {
		...
		return this.advances[PacketBufferNode.charToByteCp1252(var1) & 255]; // L: 126
	}
		...
		if (var1 == null) { // L: 130
			...
			for (int var5 = 0; var5 < var1.length(); ++var5) { // L: 134
				...
				if (var6 == '<') { // L: 136
						...
						if (var7.equals("lt")) { // L: 143
							...
							if (!var7.equals("gt")) { // L: 144
								if (var7.startsWith("img=")) { // L: 145
									try {
										int var8 = KitDefinition.method3778(var7.substring(4)); // L: 147
					...
					if (var2 == -1) { // L: 157
						var4 += this.advances[(char)(PacketBufferNode.charToByteCp1252(var6) & 255)]; // L: 158
				...
				if (var15 == '<') { // L: 180
					...
					if (var15 == '>' && var10 != -1) { // L: 184
						...
						if (var16.equals("br")) { // L: 190
							...
							try {
								int var17 = KitDefinition.method3778(var16.substring(4)); // L: 210
	...
	@ObfuscatedName("ar")
	@ObfuscatedSignature(
		descriptor = "(IILjava/lang/String;II)Lrz;"
	)
	public Bounds method7662(int var1, int var2, String var3, int var4, int var5) {
	...
	public int drawLines(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
		return this.method7665(var1, var2, var3, var4, var5, var6, var7, 256, var8, var9, var10); // L: 319
	}

	@ObfuscatedName("aa")
	public int method7665(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
		if (var1 == null) { // L: 323
			return 0;
		} else {
			if (var8 == 255) { // L: 324
	...
	@ObfuscatedName("aq")
	@ObfuscatedSignature(
		descriptor = "(Lqs;IIIII)Ltd;"
	)
	public class505 method7700(class418 var1, int var2, int var3, int var4, int var5, int var6) {
		if (!var1.method7783()) { // L: 360
			this.reset(var4, var5); // L: 361
			var3 -= this.ascent; // L: 362

			for (int var7 = 0; var7 < var1.method7766(); ++var7) { // L: 363
				class416 var8 = var1.method7762(var7); // L: 364
				if (var6 != -1 && var8.field4605 > var6) { // L: 365 366
					return new class505(var8.field4606, var8.field4605); // L: 367
				}

				char var9 = var8.field4607; // L: 370
				if (var9 != '\n') { // L: 371
					if (var1.method7764(var7)) { // L: 372
						var9 = '*'; // L: 373
					}
					...
					if (var9 != '\t') { // L: 375
						...
						int var10 = var2 + var8.field4606; // L: 377
						int var11 = var3 + var8.field4605; // L: 378
		...
		return var1.method7768(); // L: 389
	}

	@ObfuscatedName("am")
	public void method7667(String var1, int var2, int var3, int var4, int var5, int var6, int[] var7) {
		if (var1 != null) { // L: 393
			this.reset(var4, var5); // L: 394
			int[] var8 = null; // L: 395
			if (var7 != null) { // L: 396
				var8 = this.method7671(var7, var1.length());
			}
			...
			this.method7677(var1, var2 - this.stringWidth(var1) / 2, var3, var8, (int[])null, var9); // L: 399
		}
	} // L: 400

	@ObfuscatedName("ac")
	public void method7668(String var1, int var2, int var3, int var4, int var5, int var6, int[] var7) {
		if (var1 != null) { // L: 403
			...
			this.method7677(var1, var2 - this.stringWidth(var1) / 2, var3, var8, var9, var10); // L: 413
		}
	} // L: 414

	@ObfuscatedName("ae")
	public void method7669(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int[] var8) {
		if (var1 != null) { // L: 417
			this.reset(var4, var5); // L: 418
			int[] var9 = null; // L: 419
			if (var8 != null) { // L: 420
				var9 = this.method7671(var8, var1.length());
			}
			...
			this.method7677(var1, var2 - this.stringWidth(var1) / 2, var3, var9, (int[])null, var12); // L: 425
		}
	} // L: 426

	@ObfuscatedName("ak")
	public void method7749(String var1, int var2, int var3, int var4, int var5, int[] var6) {
		if (var1 != null) { // L: 429
			this.reset(var4, var5); // L: 430
			int[] var7 = null; // L: 431
			if (var6 != null) { // L: 432
				var7 = this.method7671(var6, var1.length());
			}

			this.method7677(var1, var2 - this.stringWidth(var1) / 2, var3, var7, (int[])null, (int[])null); // L: 433
		}
	} // L: 434

	@ObfuscatedName("bp")
	public void method7670(String var1, int var2, int var3, int var4, int var5, int[] var6) {
		if (var1 != null) { // L: 437
			...
			this.method7677(var1, var2, var3, var7, (int[])null, (int[])null); // L: 441
		}
	} // L: 442

	@ObfuscatedName("bz")
	int[] method7671(int[] var1, int var2) {
		if (var2 == 0) { // L: 445
			return null;
		} else {
	...
	public void drawRandomAlphaAndSpacing(String var1, int var2, int var3, int var4, int var5, int var6) {
		if (var1 != null) { // L: 455
			...
			this.method7677(var1, var2, var3, (int[])null, var7, (int[])null); // L: 465
		}
	} // L: 466
	...
	void decodeTag(String var1) {
		try {
			...
			if (var1.startsWith("col=")) { // L: 480
				...
				var2 = class442.method8005(var3, 16, true); // L: 484
				...
				var2 = class442.method8005(var3, 16, true); // L: 493
				...
				var2 = class442.method8005(var3, 16, true); // L: 503
				...
				var2 = class442.method8005(var3, 16, true); // L: 513
	...
	void draw0(String var1, int var2, int var3) {
		...
		for (int var6 = 0; var6 < var1.length(); ++var6) { // L: 540
			if (var1.charAt(var6) != 0) { // L: 541
				char var7 = (char)(PacketBufferNode.charToByteCp1252(var1.charAt(var6)) & 255); // L: 542
				if (var7 == '<') { // L: 543
					var4 = var6; // L: 544
				} else {
					int var9;
						...
						if (var8.equals("lt")) { // L: 550
							...
							if (!var8.equals("gt")) { // L: 551
								if (var8.startsWith("img=")) { // L: 552
									try {
										var9 = KitDefinition.method3778(var8.substring(4)); // L: 554
					...
					if (var4 == -1) { // L: 569
						...
						if (AbstractFont_strike != -1) { // L: 591
							Rasterizer2D.method9581(var2, var3 + (int)((double)this.ascent * 0.7D), var13, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) { // L: 592
							Rasterizer2D.method9581(var2, var3 + this.ascent + 1, var13, AbstractFont_underline);
						}
	...
	@ObfuscatedName("bo")
	void method7677(String var1, int var2, int var3, int[] var4, int[] var5, int[] var6) {
		...
		for (int var10 = 0; var10 < var1.length(); ++var10) { // L: 604
			if (var1.charAt(var10) != 0) { // L: 605
				char var11 = (char)(PacketBufferNode.charToByteCp1252(var1.charAt(var10)) & 255); // L: 606
				if (var11 == '<') { // L: 607
					var7 = var10; // L: 608
				} else {
					int var13;
							...
							if (!var12.equals("gt")) { // L: 615
								if (var12.startsWith("img=")) { // L: 616
									try {
										...
										++var9; // L: 624
										var15 = KitDefinition.method3778(var12.substring(4)); // L: 625
					...
					if (var7 == -1) { // L: 640
						...
						if (AbstractFont_strike != -1) { // L: 672
							Rasterizer2D.method9581(var2, var3 + (int)((double)this.ascent * 0.7D), var17, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) { // L: 673
							Rasterizer2D.method9581(var2, var3 + this.ascent, var17, AbstractFont_underline);
						}
	...
	@ObfuscatedName("aw")
	static int method7652(byte[][] var0, byte[][] var1, int[] var2, int[] var3, int[] var4, int var5, int var6) {
