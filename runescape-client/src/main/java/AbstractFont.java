...
public abstract class AbstractFont extends Rasterizer2D {
				...
				if (var13 != 32 && var13 != 160) { // L: 92
					for (var8 = 0; var8 < 256; ++var8) { // L: 93
						if (var8 != 32 && var8 != 160) { // L: 94
							this.kerning[var8 + (var13 << 8)] = (byte)method7952(var11, var12, var4, this.advances, var10, var13, var8); // L: 95
						}
					}
				}
			}
	...
	public int charWidth(char var1) {
		...
		return this.advances[class226.charToByteCp1252(var1) & 255]; // L: 126
	}
		...
		if (var1 == null) { // L: 130
			...
			for (int var5 = 0; var5 < var1.length(); ++var5) { // L: 134
				...
				if (var6 == '<') { // L: 136
						...
						if (var7.equals("lt")) { // L: 143
							...
							if (!var7.equals("gt")) { // L: 144
								if (var7.startsWith("img=")) { // L: 145
									try {
										int var8 = class129.method3066(var7.substring(4)); // L: 147
					...
					if (var2 == -1) { // L: 157
						var4 += this.advances[(char)(class226.charToByteCp1252(var6) & 255)]; // L: 158
				...
				if (var15 == '<') { // L: 180
					...
					if (var15 == '>' && var10 != -1) { // L: 184
						...
						if (var16.equals("br")) { // L: 190
							...
							try {
								int var17 = class129.method3066(var16.substring(4)); // L: 210
	...
	public int drawLines(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
		return this.method7867(var1, var2, var3, var4, var5, var6, var7, 256, var8, var9, var10); // L: 319
	}

	@ObfuscatedName("ac")
	public int method7867(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
		if (var1 == null) { // L: 323
			return 0;
		} else {
			if (var8 == 255) { // L: 324
	...
	public class504 method7849(class417 var1, int var2, int var3, int var4, int var5, int var6) {
		if (!var1.method7956()) { // L: 360
			this.reset(var4, var5); // L: 361
			var3 -= this.ascent; // L: 362

			for (int var7 = 0; var7 < var1.method7957(); ++var7) { // L: 363
				class415 var8 = var1.method7971(var7); // L: 364
				if (var6 != -1 && var8.field4585 > var6) { // L: 365 366
					return new class504(var8.field4584, var8.field4585); // L: 367
				}

				char var9 = var8.field4583; // L: 370
				if (var9 != '\n') { // L: 371
					if (var1.method7955(var7)) { // L: 372
						var9 = '*'; // L: 373
					}
					...
					if (var9 != '\t') { // L: 375
						...
						int var10 = var2 + var8.field4584; // L: 377
						int var11 = var3 + var8.field4585; // L: 378
	...
	public void method7850(String var1, int var2, int var3, int var4, int var5, int var6, int[] var7) {
		if (var1 != null) { // L: 393
			...
			this.method7935(var1, var2 - this.stringWidth(var1) / 2, var3, var8, (int[])null, var9); // L: 399
		}
	} // L: 400
	...
	public void method7883(String var1, int var2, int var3, int var4, int var5, int var6, int[] var7) {
		if (var1 != null) { // L: 403
			...
			this.method7935(var1, var2 - this.stringWidth(var1) / 2, var3, var8, var9, var10); // L: 413
		}
	} // L: 414
	...
	public void method7852(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int[] var8) {
		if (var1 != null) { // L: 417
			...
			this.method7935(var1, var2 - this.stringWidth(var1) / 2, var3, var9, (int[])null, var12); // L: 425
		}
	} // L: 426
	...
	public void method7917(String var1, int var2, int var3, int var4, int var5, int[] var6) {
		if (var1 != null) { // L: 429
			...
			this.method7935(var1, var2 - this.stringWidth(var1) / 2, var3, var7, (int[])null, (int[])null); // L: 433
		}
	} // L: 434
	...
	public void method7854(String var1, int var2, int var3, int var4, int var5, int[] var6) {
		if (var1 != null) { // L: 437
			...
			this.method7935(var1, var2, var3, var7, (int[])null, (int[])null); // L: 441
		}
	} // L: 442
	...
	public void drawRandomAlphaAndSpacing(String var1, int var2, int var3, int var4, int var5, int var6) {
		if (var1 != null) { // L: 455
			...
			this.method7935(var1, var2, var3, (int[])null, var7, (int[])null); // L: 465
		}
	} // L: 466
	...
	void draw0(String var1, int var2, int var3) {
		...
		for (int var6 = 0; var6 < var1.length(); ++var6) { // L: 512
			if (var1.charAt(var6) != 0) { // L: 513
				char var7 = (char)(class226.charToByteCp1252(var1.charAt(var6)) & 255); // L: 514
				if (var7 == '<') { // L: 515
					var4 = var6; // L: 516
				} else {
					int var9;
						...
						if (var8.equals("lt")) { // L: 522
							...
							if (!var8.equals("gt")) { // L: 523
								if (var8.startsWith("img=")) { // L: 524
									try {
										var9 = class129.method3066(var8.substring(4)); // L: 526
					...
					if (var4 == -1) { // L: 541
						...
						if (AbstractFont_strike != -1) { // L: 563
							Rasterizer2D.method9794(var2, var3 + (int)((double)this.ascent * 0.7D), var13, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) { // L: 564
							Rasterizer2D.method9794(var2, var3 + this.ascent + 1, var13, AbstractFont_underline);
						}
	...
	void method7935(String var1, int var2, int var3, int[] var4, int[] var5, int[] var6) {
		...
		for (int var10 = 0; var10 < var1.length(); ++var10) { // L: 576
			if (var1.charAt(var10) != 0) { // L: 577
				char var11 = (char)(class226.charToByteCp1252(var1.charAt(var10)) & 255); // L: 578
				if (var11 == '<') { // L: 579
					var7 = var10; // L: 580
				} else {
					int var13;
							...
							if (!var12.equals("gt")) { // L: 587
								if (var12.startsWith("img=")) { // L: 588
									try {
										...
										++var9; // L: 596
										var15 = class129.method3066(var12.substring(4)); // L: 597
					...
					if (var7 == -1) { // L: 612
						...
						if (AbstractFont_strike != -1) { // L: 644
							Rasterizer2D.method9794(var2, var3 + (int)((double)this.ascent * 0.7D), var17, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) { // L: 645
							Rasterizer2D.method9794(var2, var3 + this.ascent, var17, AbstractFont_underline);
						}
