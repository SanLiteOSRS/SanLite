...
public final class WorldMapSprite {
	...
	static final void method474(class185 var0) {
		...
		if (class185.field2300 == var0) {
			...
			var6 = var1.method5641();
			var7 = var6 >> 2;
			var8 = var6 & 3;
			var37 = Client.field692[var7];
			if (var4 >= 0 && var5 >= 0 && var4 < 103 && var5 < 103) {
				if (var37 == 0) {
					BoundaryObject var10 = WorldMapArea.scene.method3178(Player.Client_plane, var4, var5);
					if (var10 != null) {
				...
				if (var37 == 1) {
					WallDecoration var38 = WorldMapArea.scene.method3292(Player.Client_plane, var4, var5);
					if (var38 != null) {
				...
				if (var37 == 2) {
					GameObject var39 = WorldMapArea.scene.method3180(Player.Client_plane, var4, var5);
					if (var7 == 11) {
						var7 = 10;
					}
			...
			var3 = var1.method5592();
			var4 = var1.method5592();
			...
			if (class185.field2298 == var0) {
				var2 = var1.method5594();
				var3 = var1.method5566();
				var4 = var1.method5566() * 4;
				var5 = var1.method5591();
				var6 = var1.readUnsignedByte();
				var7 = (var6 >> 4 & 7) + SpriteMask.field2501;
				var8 = (var6 & 7) + GrandExchangeOffer.field61;
				var37 = var1.method5583() * 4;
				var32 = var1.method5591();
				byte var41 = var1.method5615();
				byte var42 = var1.method5615();
				var13 = var1.method5641();
				int var43 = var1.method5591();
				var11 = var41 + var7;
				var12 = var42 + var8;
				...
				if (class185.field2292 == var0) {
					...
					if (class185.field2291 == var0) {
						var2 = var1.method5592();
						var3 = var1.readUnsignedShort();
						var4 = var1.method5566();
						var5 = var4 >> 2;
						var6 = var4 & 3;
						var7 = Client.field692[var5];
						var8 = var1.readUnsignedShort();
						byte var9 = var1.method5707();
						var32 = var1.method5641();
						var11 = (var32 >> 4 & 7) + SpriteMask.field2501;
						var12 = (var32 & 7) + GrandExchangeOffer.field61;
						var13 = var1.method5590();
						byte var14 = var1.method5584();
						byte var34 = var1.readByte();
						byte var16 = var1.method5615();
						Player var17;
					...
					if (class185.field2299 == var0) {
						...
						var5 = var1.method5592();
						var6 = var1.method5583();
						var7 = var6 >> 2;
						var8 = var6 & 3;
						var37 = Client.field692[var7];
						...
						var2 = var1.method5591();
						var3 = var1.method5592();
						var4 = var1.readUnsignedByte();
						var5 = (var4 >> 4 & 7) + SpriteMask.field2501;
						var6 = (var4 & 7) + GrandExchangeOffer.field61;
						var7 = var1.method5591();
						if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
