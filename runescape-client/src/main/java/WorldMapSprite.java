						...
						if (class262.field3019 == var0) { // L: 7591
							...
							if (class262.field3024 == var0) { // L: 7607
								...
								if (var17 != null) { // L: 7626
									...
									if (var29 != null) { // L: 7647
										...
										var17.field1095 = var3 * 128 + var19 * 64; // L: 7652
										var17.field1108 = var4 * 128 + var20 * 64; // L: 7653
							...
							if (class262.field3015 == var0) { // L: 7672
								...
								if (var8 >= 0 && var9 >= 0 && var8 < 103 && var9 < 103) { // L: 7681
									if (var5 == 0) { // L: 7682
										WallObject var33 = class356.scene.method4333(PacketWriter.Client_plane, var8, var9); // L: 7683
									...
									if (var5 == 1) { // L: 7693
										DecorativeObject var42 = class356.scene.method4178(PacketWriter.Client_plane, var8, var9); // L: 7694
									...
									if (var5 == 3) { // L: 7711
										GroundObject var44 = class356.scene.getGroundObject(PacketWriter.Client_plane, var8, var9); // L: 7712
