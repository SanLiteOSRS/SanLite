...
public class class114 extends class116 {
	...
	static final void method2481() {
		...
		HealthBarDefinition.field1667.clear();
		...
		Widget.field3047.clear();
		Widget.archive0.clear();
		((TextureProvider)Rasterizer3D.Rasterizer3D_textureLoader).clear();
		Script.Script_cached.clear();
		WorldMapRectangle.archive3.clearFiles();
		MenuAction.archive4.clearFiles();
		class260.archive5.clearFiles();
		ReflectionCheck.field444.clearFiles();
		ObjectComposition.archive7.clearFiles();
		class276.archive6.clearFiles();
		class135.archive9.clearFiles();
		World.archive8.clearFiles();
		VarcInt.field1645.clearFiles();
