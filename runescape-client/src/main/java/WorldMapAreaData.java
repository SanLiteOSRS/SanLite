			...
			if (0L != var8) { // L: 8526
				...
				if (var14 != null && var14.hasSound()) { // L: 8535
					...
					for (ObjectSound var47 = (ObjectSound)ObjectSound.objectSounds.last(); var47 != null; var47 = (ObjectSound)ObjectSound.objectSounds.previous()) {
						if (var0 == var47.plane && var15 == var47.x * 16384 && var16 == var47.y * 16384 && var19 == var47.maxX * 128 && var20 == var47.maxY * 16384 && var21 == var47.soundEffectId && var22 == var47.field824) { // L: 8556
