		...
		if (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var1][var2] & 2) != 0 || (Tiles.Tiles_renderFlags[var0][var1][var2] & 16) == 0) { // L: 346 347 348
			...
			if (var5 == 22) { // L: 391
				if (!Client.isLowDetail || var8.int1 != 0 || var8.interactType == 1 || var8.boolean2) { // L: 392
					...
					var6.newGroundObject(var0, var1, var2, var16, (Renderable)var29, var19, var21); // L: 396
				...
				if (var5 != 10 && var5 != 11) { // L: 400
					...
					if (var5 >= 12) { // L: 421
						...
						var6.newWallObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)null, Tiles.field1013[var4], 0, var19, var21); // L: 434
						if (var4 == 0) { // L: 435
						...
						var6.newWallObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)null, Tiles.field1005[var4], 0, var19, var21); // L: 471
						...
						if (var5 == 2) { // L: 481
							...
							var6.newWallObject(var0, var1, var2, var16, (Renderable)var30, (Renderable)var24, Tiles.field1013[var4], Tiles.field1013[var22], var19, var21); // L: 493
							...
							var6.newWallObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)null, Tiles.field1005[var4], 0, var19, var21); // L: 520
							...
							var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)null, Tiles.field1013[var4], 0, 0, 0, var19, var21); // L: 543
						} else {
							long var23;
							Object var25;
							if (var5 == 5) { // L: 546
								var22 = 16; // L: 547
								var23 = var6.getWallObjectTag(var0, var1, var2); // L: 548
								if (0L != var23) { // L: 549
								...
								var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, Tiles.field1013[var4], 0, var22 * Tiles.field1006[var4], var22 * Tiles.field1000[var4], var19, var21); // L: 553
							} else if (var5 == 6) { // L: 556
								var22 = 8; // L: 557
								var23 = var6.getWallObjectTag(var0, var1, var2); // L: 558
								if (0L != var23) { // L: 559
								...
								var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, 256, var4, var22 * Tiles.field1003[var4], var22 * Tiles.field1009[var4], var19, var21); // L: 563
								...
								var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)null, 256, var28, 0, 0, var19, var21); // L: 571
							} else if (var5 == 8) { // L: 574
								var22 = 8; // L: 575
								var23 = var6.getWallObjectTag(var0, var1, var2); // L: 576
								if (0L != var23) { // L: 577
									var22 = PlayerComposition.getObjectDefinition(class156.Entity_unpackID(var23)).int2 / 2;
								}
								...
								var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)var26, 256, var4, var22 * Tiles.field1003[var4], var22 * Tiles.field1009[var4], var19, var21); // L: 589
							}
						}
					}
				} else {
