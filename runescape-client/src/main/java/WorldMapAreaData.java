...
public class WorldMapAreaData extends WorldMapArea {
   ...
   static void method654() {
      Client.packetWriter.method2186();
   ...
   static void revalidateWidgetScroll(Widget[] var0, Widget var1, boolean var2) {
      ...
      ItemContainer.resizeWidget(var0, var1.id, var3, var4, var2);
      if (var1.children != null) {
         ItemContainer.resizeWidget(var1.children, var1.id, var3, var4, var2);
      }

      InterfaceParent var5 = (InterfaceParent)Client.interfaceParents.get((long)var1.id);
      if (var5 != null) {
         GrandExchangeOfferNameComparator.method147(var5.group, var3, var4, var2);
      }
