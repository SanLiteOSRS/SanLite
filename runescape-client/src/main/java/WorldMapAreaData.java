...
public class WorldMapAreaData extends WorldMapArea {
	...
	@ObfuscatedSignature(
		descriptor = "(I)[Lhz;",
		garbageValue = "1997634831"
	)
	static VerticalAlignment[] method5634() {
		return new VerticalAlignment[]{VerticalAlignment.field2056, VerticalAlignment.field2058, VerticalAlignment.VerticalAlignment_centered}; // L: 14
	}
}
