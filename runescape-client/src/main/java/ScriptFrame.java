...
public class ScriptFrame {
	...
	static int method1218(int var0, Script var1, boolean var2) {
		if (var0 < 1000) {
			...
			return class185.method3721(var0, var1, var2);
		} else if (var0 < 1300) {
			return TaskHandler.method3558(var0, var1, var2);
		} else if (var0 < 1400) {
			return PacketBufferNode.method3733(var0, var1, var2);
		} else if (var0 < 1500) {
			return class42.method873(var0, var1, var2);
		} else if (var0 < 1600) {
			return class185.method3722(var0, var1, var2);
		} else if (var0 < 1700) {
			return WorldMapRegion.method574(var0, var1, var2);
		} else if (var0 < 1800) {
			return AbstractByteArrayCopier.method4041(var0, var1, var2);
		} else if (var0 < 1900) {
			...
			return PacketWriter.method2379(var0, var1, var2);
		} else if (var0 < 2700) {
			return class49.method938(var0, var1, var2);
		} else if (var0 < 2800) {
			return class2.method32(var0, var1, var2);
		} else if (var0 < 2900) {
			return SoundCache.method2626(var0, var1, var2);
		} else if (var0 < 3000) {
			return GameShell.method1142(var0, var1, var2);
		} else if (var0 < 3200) {
			return class189.method3745(var0, var1, var2);
		} else if (var0 < 3300) {
			...
			return class216.method4143(var0, var1, var2);
		} else if (var0 < 4100) {
			...
			return GraphicsDefaults.method5945(var0, var1, var2);
		} else if (var0 < 6300) {
			return MouseHandler.method1176(var0, var1, var2);
		} else if (var0 < 6600) {
			return ArchiveDiskAction.method4243(var0, var1, var2);
		} else {
	...
	static int compareWorlds(World var0, World var1, int var2, boolean var3) {
		if (var2 == 1) {
			...
			return var0.method1838() ? (var1.method1838() ? 0 : 1) : (var1.method1838() ? -1 : 0);
		} else if (var2 == 5) {
			return var0.method1870() ? (var1.method1870() ? 0 : 1) : (var1.method1870() ? -1 : 0);
		} else if (var2 == 6) {
