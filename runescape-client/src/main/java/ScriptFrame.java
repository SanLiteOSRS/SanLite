				...
				if (var0 == ScriptOpcodes.WORLDLIST_SPECIFIC) {
					...
					if (var0 == ScriptOpcodes.SETFOLLOWEROPSLOWPRIORITY) {
						...
						if (var0 == ScriptOpcodes.NC_PARAM) {
							...
							var5 = class151.getParamDefinition(var4);
							if (var5.isString()) {
								Interpreter.Interpreter_stringStack[++class122.Interpreter_stringStackSize - 1] = class19.ItemComposition_get(var3).getStringParam(var4, var5.defaultStr);
							} else {
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class19.ItemComposition_get(var3).getIntParam(var4, var5.defaultInt);
							}
	...
	static final void drawActor2d(Actor var0, int var1, int var2, int var3, int var4, int var5) {
		if (var0 != null && var0.isVisible()) {
			...
			if (var1 < var75) {
				...
				if (var88.headIconPk != -1 || var88.headIconPrayer != -1) {
					...
					if (Client.viewportTempX > -1) {
						...
						if (var88.headIconPrayer != -1) {
							var76 += 25;
							DecorativeObject.headIconPrayerSprites[var88.headIconPrayer].drawTransBgAt(var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - var76);
						}
					}
				}
				...
				if (var89.headIconPrayer >= 0 && var89.headIconPrayer < DecorativeObject.headIconPrayerSprites.length) {
					class93.method2376(var0, var0.defaultHeight + 15);
					if (Client.viewportTempX > -1) {
						DecorativeObject.headIconPrayerSprites[var89.headIconPrayer].drawTransBgAt(var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - 30);
					}
				}
