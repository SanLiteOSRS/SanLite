...
public class Animation {
	...
	static {
		field2525 = new int[500]; // L: 8
		field2516 = new int[500]; // L: 9
		field2517 = new int[500]; // L: 10
		field2518 = new int[500]; // L: 11
	}
	...
	Animation(byte[] var1, Skeleton var2) {
		...
		for (var8 = 0; var8 < var5; ++var8) { // L: 29
			...
			if (var9 > 0) { // L: 31
				if (this.skeleton.transformTypes[var8] != 0) { // L: 32
					for (int var10 = var8 - 1; var10 > var6; --var10) { // L: 33
						if (this.skeleton.transformTypes[var10] == 0) { // L: 34
							field2525[var7] = var10; // L: 35
							field2516[var7] = 0; // L: 36
							field2517[var7] = 0; // L: 37
							field2518[var7] = 0; // L: 38
							++var7; // L: 39
							break;
						}
					}
				...
				if ((var9 & 1) != 0) { // L: 47
					...
					field2516[var7] = var11; // L: 48
				}

				if ((var9 & 2) != 0) { // L: 49
					field2517[var7] = var4.readShortSmart();
				} else {
					field2517[var7] = var11; // L: 50
				}

				if ((var9 & 4) != 0) { // L: 51
					field2518[var7] = var4.readShortSmart();
				} else {
					field2518[var7] = var11; // L: 52
				}
		...
		if (var1.length != var4.offset) { // L: 58
			...
			for (var8 = 0; var8 < var7; ++var8) { // L: 66
				this.transformSkeletonLabels[var8] = field2525[var8]; // L: 67
				this.transformXs[var8] = field2516[var8]; // L: 68
				this.transformYs[var8] = field2517[var8]; // L: 69
				this.transformZs[var8] = field2518[var8]; // L: 70
			}
