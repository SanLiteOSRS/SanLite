...
public class class272 {
		...
		while (true) {
			if (var1.bitsRemaining(Client.packetWriter.serverPacketLength) >= 27) { // L: 7872
				...
				if (var2 != 32767) { // L: 7874
					...
					var4.field1131 = var4.definition.size; // L: 7942
	...
	static final void drawScrollBar(int var0, int var1, int var2, int var3, int var4) {
		...
		Rasterizer2D.method8235(var0, var6 + var1 + 16, var5, Client.field727); // L: 10444
		Rasterizer2D.method8235(var0 + 1, var6 + var1 + 16, var5, Client.field727); // L: 10445
		Rasterizer2D.method8233(var0, var6 + var1 + 16, 16, Client.field727); // L: 10446
		Rasterizer2D.method8233(var0, var6 + var1 + 17, 16, Client.field727); // L: 10447
		Rasterizer2D.method8235(var0 + 15, var6 + var1 + 16, var5, Client.field568); // L: 10448
		Rasterizer2D.method8235(var0 + 14, var6 + var1 + 17, var5 - 1, Client.field568); // L: 10449
		Rasterizer2D.method8233(var0, var6 + var5 + var1 + 15, 16, Client.field568); // L: 10450
		Rasterizer2D.method8233(var0 + 1, var5 + var6 + var1 + 14, 15, Client.field568); // L: 10451
	} // L: 10452
}
