...
public class Huffman {
	...
	@ObfuscatedName("u")
	@ObfuscatedSignature(
		descriptor = "(Lqw;[II)[Ljava/lang/Object;",
		garbageValue = "-111213447"
	)
	static Object[] method5486(Buffer var0, int[] var1) {
		...
		for (int var4 = 0; var4 < var2; ++var4) { // L: 32
			for (int var5 = 0; var5 < var1.length; ++var5) { // L: 33
				...
				class433 var7 = AbstractWorldMapIcon.method5044(var1[var5]); // L: 35
				var3[var6] = var7.method7602(var0); // L: 36
			}
		}
