...
public final class KeyHandler implements KeyListener, FocusListener {
	...
	static {
		...
		field417 = 0;
		field418 = 0;
		field419 = new char[128];
		field420 = new int[128];
		field421 = new int[128];
		field422 = 0;
		field423 = 0;
		field424 = 0;
		field399 = 0;
	...
	public final synchronized void keyPressed(KeyEvent var1) {
		if (KeyHandler_instance != null) {
			...
			if (field418 >= 0 && var2 >= 0) {
				field409[field418] = var2;
				field418 = field418 + 1 & 127;
	...
	public final void keyTyped(KeyEvent var1) {
		if (KeyHandler_instance != null) {
			...
			if (var2 != 0 && var2 != '\uffff' && FriendsChatMember.method5146(var2)) {
				int var3 = field424 + 1 & 127;
				if (var3 != field423) {
					field420[field424] = -1;
					field419[field424] = var2;
					field424 = var3;
				}
			}
		}
	...
	static void resizeInterface(Widget[] var0, int var1, int var2, int var3, boolean var4) {
		for (int var5 = 0; var5 < var0.length; ++var5) {
			...
			if (var6 != null && var6.parentId == var1) {
				MouseRecorder.alignWidgetSize(var6, var2, var3, var4);
				DirectByteArrayCopier.alignWidgetPosition(var6, var2, var3);
