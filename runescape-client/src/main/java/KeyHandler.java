...
public class KeyHandler {
	...
	static void method398(int var0) {
		for (IntegerNode var1 = (IntegerNode)Client.widgetFlags.first(); var1 != null; var1 = (IntegerNode)Client.widgetFlags.next()) { // L: 12766
			if ((long)var0 == (var1.key >> 48 & 65535L)) { // L: 12767
				var1.remove(); // L: 12768
			}
		}
