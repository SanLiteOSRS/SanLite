...
public class KeyHandler {
	...
	static void changeWorldSelectSorting(int var0, int var1) {
		...
		class16.sortWorlds(class20.World_worlds, 0, class20.World_worlds.length - 1, World.World_sortOption1, World.World_sortOption2); // L: 77
	} // L: 78

	@ObfuscatedName("an")
	@ObfuscatedSignature(
		descriptor = "(II)Lhb;",
		garbageValue = "2000215081"
	)
	...
	@ObfuscatedSignature(
		...
		garbageValue = "-180684941"
	)
	public static void method414(Widget var0, int var1, int var2) {
		PlayerComposition var3 = var0.field3666; // L: 995
		boolean var4 = var2 != var3.field3543; // L: 996
		var3.field3543 = var2; // L: 997
		if (var4) { // L: 998
			int var5;
			int var7;
			if (var3.field3543 == var1) { // L: 999
				for (var5 = 0; var5 < PlayerComposition.equipmentIndices.length; ++var5) { // L: 1000
					var7 = PlayerComposition.equipmentIndices[var5]; // L: 1001
					if (var3.equipment[var7] > 0 && var3.equipment[var7] < 512) { // L: 1002
						var3.equipment[var7] = var3.field3547[var7]; // L: 1003
					}
				}
			} else {
				label74: {
					if (var3.equipment[0] >= 512) { // L: 1009
						boolean var8;
						if (var3.equipment[0] < 512) { // L: 1012
							var8 = false; // L: 1017
						} else {
							ItemComposition var6 = class230.ItemComposition_get(var3.equipment[0] - 512); // L: 1013
							var8 = var6.maleModel1 != class208.field2299.field2307 && var6.maleModel2 != class208.field2299.field2307; // L: 1014
						}
					...
					var3.equipment[class208.field2299.field2307] = 1; // L: 1021
				}

				for (var5 = 0; var5 < 7; ++var5) { // L: 1023
					var7 = PlayerComposition.equipmentIndices[var5]; // L: 1024
					if (var3.equipment[var7] > 0 && var3.equipment[var7] < 512) { // L: 1025
						Script.method2114(var2, var3.equipment, var5); // L: 1026
					}
				}
			}
		}

		var3.method6140(); // L: 1031
	} // L: 1032
}
