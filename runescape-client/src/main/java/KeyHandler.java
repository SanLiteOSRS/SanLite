...
public final class KeyHandler implements KeyListener, FocusListener {
   ...
   @ObfuscatedName("cr")
   static char[] field377 = new char[128];
   @ObfuscatedName("cl")
   static int[] field376 = new int[128];
   @ObfuscatedName("cg")
   ...
   public static void method772(AbstractArchive var0) {
      ...
      for(int var1 = 0; var1 < Client.npcCount; ++var1) {
         ...
         if (var2 != null && var2.isVisible() && var2.definition.isVisible == var0 && var2.definition.transformIsVisible()) {
            ...
            if (var3 >= 0 && var3 < 104 && var4 >= 0 && var4 < 104) {
               ...
               Player.scene.drawEntity(ItemContainer.plane, var2.x, var2.y, GrandExchangeOfferTotalQuantityComparator.getTileHeight(var2.size * -178253824 - 64 + var2.x, var2.size * -178253824 - 64 + var2.y, ItemContainer.plane), var2.size * -178253824 - 64 + 60, var2, var2.field918, var5, var2.field919);
            }
         }
      }
   ...
   static final void method787(boolean var0) {
      ...
      ++Client.packetWriter.field1297;
      if (Client.packetWriter.field1297 >= 50 || var0) {
         Client.packetWriter.field1297 = 0;
         if (!Client.field672 && Client.packetWriter.getSocket() != null) {
            PacketBufferNode var1 = MenuAction.method1994(ClientPacket.field2207, Client.packetWriter.isaacCipher);
            Client.packetWriter.method2177(var1);

            try {
               Client.packetWriter.method2176();
