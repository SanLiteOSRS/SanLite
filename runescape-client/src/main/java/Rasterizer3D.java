...
public class Rasterizer3D extends Rasterizer2D {
	@ObfuscatedName("v")
	static boolean field2562;
	@ObfuscatedName("c")
	static boolean field2558;
	@ObfuscatedName("i")
	...
	static {
		...
		field2573 = new int[512];
		field2571 = new int[2048];
		Rasterizer3D_sine = new int[2048];
		Rasterizer3D_cosine = new int[2048];

		int var0;
		for (var0 = 1; var0 < 512; ++var0) {
			field2573[var0] = 32768 / var0;
		}

		for (var0 = 1; var0 < 2048; ++var0) {
			field2571[var0] = 65536 / var0;
		}
	...
	static final void Rasterizer3D_setClip(int var0, int var1, int var2, int var3) {
		...
		if (Rasterizer3D_rowOffsets.length < Rasterizer3D_clipHeight) {
			Rasterizer3D_rowOffsets = new int[class67.method1909(Rasterizer3D_clipHeight)];
		}
	...
	@ObfuscatedName("f")
	public static final void method4631(int var0, int var1) {
	...
	@ObfuscatedName("q")
	public static void method4673(int var0, int var1, int var2) {
		field2562 = var0 < 0 || var0 > Rasterizer3D_clipWidth || var1 < 0 || var1 > Rasterizer3D_clipWidth || var2 < 0 || var2 > Rasterizer3D_clipWidth;
	}

	@ObfuscatedName("o")
	static final void method4613(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		int var9 = var4 - var3;
		int var10 = var1 - var0;
		int var11 = var5 - var3;
		int var12 = var2 - var0;
	...
	@ObfuscatedName("r")
	static final void method4614(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, byte var9, byte var10, byte var11, byte var12) {
		var6 = method4615(var6, var9, var10, var11, var12);
		var7 = method4615(var7, var9, var10, var11, var12);
		var8 = method4615(var8, var9, var10, var11, var12);
		method4613(var0, var1, var2, var3, var4, var5, var6, var7, var8);
	}

	@ObfuscatedName("p")
	static int method4615(int var0, byte var1, byte var2, byte var3, byte var4) {
		int var5 = var0 >> 10 & 63;
		int var6 = var0 >> 7 & 7;
		int var7 = var0 & 127;
		int var8 = var4 & 255;
	...
	@ObfuscatedName("k")
	public static final void method4617(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		int var7 = 0;
		if (var0 != var1) {
	...
	@ObfuscatedName("d")
	static final void method4618(int var0, int var1, int var2, int var3, int var4, int var5, int var6, byte var7, byte var8, byte var9, byte var10) {
		int var11 = method4615(var6, var7, var8, var9, var10);
		var6 = Rasterizer3D_colorPalette[var11];
		method4617(var0, var1, var2, var3, var4, var5, var6);
	}
	...
	@ObfuscatedName("u")
	static final void method4620(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
		int[] var19 = Rasterizer3D_textureLoader.getTexturePixels(var18);
		int var20;
		if (var19 == null) {
			var20 = Rasterizer3D_textureLoader.getAverageTextureRGB(var18);
			method4613(var0, var1, var2, var3, var4, var5, method4648(var20, var6), method4648(var20, var7), method4648(var20, var8));
		} else {
			Rasterizer3D_isLowDetailTexture = Rasterizer3D_textureLoader.isLowDetail(var18);
			field2558 = Rasterizer3D_textureLoader.vmethod5096(var18);
			var20 = var4 - var3;
			int var21 = var1 - var0;
			int var22 = var5 - var3;
			int var23 = var2 - var0;
	...
	@ObfuscatedName("a")
	static final int method4648(int var0, int var1) {
	...
	@ObfuscatedName("y")
	static final int method4626(int var0, int var1, int var2, int var3) {
		return var0 * var2 + var3 * var1 >> 16;
	}

	@ObfuscatedName("j")
	static final int method4663(int var0, int var1, int var2, int var3) {
		return var2 * var1 - var3 * var0 >> 16;
	}

	@ObfuscatedName("e")
	static final int method4627(int var0, int var1, int var2, int var3) {
		return var0 * var2 - var3 * var1 >> 16;
	}

	@ObfuscatedName("z")
	static final int method4628(int var0, int var1, int var2, int var3) {
		return var3 * var0 + var2 * var1 >> 16;
	}

	@ObfuscatedName("h")
	static final int method4656(int var0, int var1, int var2, int var3) {
		return var0 * var2 + var3 * var1 >> 16;
	}

	@ObfuscatedName("ae")
	static final int method4630(int var0, int var1, int var2, int var3) {
		return var2 * var1 - var3 * var0 >> 16;
	}
}
