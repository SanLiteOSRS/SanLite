...
public class Rasterizer3D {
	...
	public static class244 field2536;
	@ObfuscatedName("az")
	@ObfuscatedSignature(
		descriptor = "Lid;"
	)
	...
	static {
		...
		field2536 = new class244(); // L: 27
		field2538 = new class243(field2536); // L: 28
		field2539 = new class245(field2536); // L: 29
		field2537 = field2538; // L: 30
	} // L: 31

	@ObfuscatedName("au")
	public static void method4390(boolean var0) {
		if (var0 && Rasterizer2D.field5184 != null) { // L: 38
			field2537 = field2539; // L: 39
		} else {
			field2537 = field2538; // L: 42
		}
	...
	public static void method4376(TextureLoader var0) {
		field2536.Rasterizer3D_textureLoader = var0; // L: 47
	} // L: 48
	...
	@ObfuscatedName("ai")
	static int method4380() {
		return field2536.field2810; // L: 112
	}

	@ObfuscatedName("az")
	static int method4381() {
		return field2536.field2825; // L: 116
	}

	@ObfuscatedName("ap")
	static int method4382() {
		return field2536.field2819; // L: 120
	}

	@ObfuscatedName("aa")
	static int method4379() {
		return field2536.field2827; // L: 124
	}

	@ObfuscatedName("af")
	static int method4384() {
		return field2536.field2829; // L: 128
	}

	@ObfuscatedName("ad")
	static int method4385() {
		return field2536.field2828; // L: 132
	}

	@ObfuscatedName("aq")
	public static int method4386() {
		return field2536.field2815; // L: 136
	}

	@ObfuscatedName("al")
	static int method4387() {
		return field2536.field2824; // L: 140
	}

	@ObfuscatedName("an")
	public static void method4388(int[] var0, int var1, int var2, float[] var3) {
		if (var3 == null && field2537 == field2539) { // L: 144
			field2537 = field2538; // L: 145
		}

		field2537.method4482(var0, var1, var2, var3); // L: 147
	} // L: 148
	...
	static void Rasterizer3D_setClip(int var0, int var1, int var2, int var3) {
		field2536.field2824 = var2 - var0; // L: 155
		field2536.field2822 = var3 - var1; // L: 156
		method4391(); // L: 157
		if (field2536.Rasterizer3D_rowOffsets.length < field2536.field2822) { // L: 158
			field2536.Rasterizer3D_rowOffsets = new int[WorldMapIcon_1.method5088(field2536.field2822)]; // L: 159
		}

		int var4 = var0 + Rasterizer2D.Rasterizer2D_width * var1; // L: 161

		for (int var5 = 0; var5 < field2536.field2822; ++var5) { // L: 162
			field2536.Rasterizer3D_rowOffsets[var5] = var4; // L: 163
	...
	static void method4398(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8, int var9, int var10, int var11) {
		field2537.vmethod5020(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11); // L: 184
	} // L: 185
	...
	public static void method4455(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8, int var9) {
		field2537.vmethod4972(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9); // L: 188
	} // L: 189
	...
	static void method4396(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18, int var19, int var20, int var21) {
		field2537.vmethod4967(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15, var16, var17, var18, var19, var20, var21); // L: 192
	} // L: 193
	...
	static void method4397(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18, int var19, int var20, int var21) {
		field2537.vmethod4981(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15, var16, var17, var18, var19, var20, var21); // L: 196
	} // L: 197
	...
	static void method4447(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8, int var9, int var10, int var11, byte var12, byte var13, byte var14, byte var15) {
		field2537.method4485(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15); // L: 200
	} // L: 201
	...
	static void method4453(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8, int var9, byte var10, byte var11, byte var12, byte var13) {
		field2537.method4481(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13); // L: 204
	} // L: 205
}
