	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.field1179 >= Client.cycle) {
			...
			if (var0.pathLength == 0) {
				...
				label409: {
					...
					var11 = var0.x;
					var3 = var0.y;
					var4 = var0.pathX[var0.pathLength - 1] * 128 + var0.field1145 * 64;
					int var5 = var0.pathY[var0.pathLength - 1] * 128 + var0.field1145 * 64;
					if (var11 < var4) {
						if (var3 < var5) {
		...
		if (var0.field1192 != 0) {
			...
			if (var11 != 0) {
				...
				boolean var14;
				if (var11 > 1024) {
					var0.rotation -= var0.field1183 ? var11 : var0.field1192;
					var14 = true;
