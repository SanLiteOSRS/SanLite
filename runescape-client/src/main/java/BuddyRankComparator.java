...
public class BuddyRankComparator extends AbstractUserComparator {
	...
	public static PacketBufferNode method2887(int var0, String var1, Language var2, int var3) {
		PacketBufferNode var4 = UserComparator9.getPacketBufferNode(ClientPacket.field3072, Client.packetWriter.isaacCipher); // L: 17
		...
		ClanChannel.method3325(var4.packetBuffer, var1); // L: 167
		if (var0 == class320.field3705.rsOrdinal()) { // L: 168
			var4.packetBuffer.writeByte(var3); // L: 169
		}

		var4.packetBuffer.method8642(var4.packetBuffer.offset - var5); // L: 171
		return var4; // L: 172
	}
	...
	static String method2886() {
		StringBuilder var0 = new StringBuilder(); // L: 93

		Message var2;
		for (Iterator var1 = Messages.Messages_hashTable.iterator(); var1.hasNext(); var0.append(var2.text).append('\n')) { // L: 94 100
			var2 = (Message)var1.next(); // L: 95
			if (var2.sender != null && !var2.sender.isEmpty()) { // L: 97
				var0.append(var2.sender).append(':'); // L: 98
			}
		}

		return var0.toString(); // L: 103
	}
}
