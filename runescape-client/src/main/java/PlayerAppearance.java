...
public class PlayerAppearance {
	...
	public void method4103(int var1, boolean var2) {
			...
			if (var8 == null) {
				...
				if (var8 == null) {
					...
					for (int var12 = 0; var12 < 12; ++var12) {
						...
						if (var13 >= 512) {
							var14 = class222.ItemDefinition_get(var13 - 512).method4737(this.isFemale);
							if (var14 != null) {
								var16[var11++] = var14;
							}
						}
	...
	ModelData getModelData() {
		if (this.npcTransformId != -1) {
			...
			for (int var2 = 0; var2 < 12; ++var2) {
				...
				if (var3 >= 256 && var3 < 512 && !BufferedSource.KitDefinition_get(var3 - 256).method4549()) {
					var1 = true;
				}

				if (var3 >= 512 && !class222.ItemDefinition_get(var3 - 512).method4738(this.isFemale)) {
					var1 = true;
				}
			}
			...
			if (var1) {
				...
				for (int var4 = 0; var4 < 12; ++var4) {
					...
					if (var5 >= 512) {
						var6 = class222.ItemDefinition_get(var5 - 512).method4739(this.isFemale);
						if (var6 != null) {
							var7[var3++] = var6;
						}
					}
	...
	public static final synchronized long method4141() {
	...
	public static IndexedSprite[] method4107(AbstractArchive var0, String var1, String var2) {
	...
	public static void method4138(int var0) {
		if (var0 != -1) {
