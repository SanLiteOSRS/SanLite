	...
	public void decode(AbstractArchive var1) {
		...
		while (true) {
			...
			case 1:
				...
				break;
			case 2:
				this.compass = var3.method8028(); // L: 33
				this.field4408 = var3.method8028(); // L: 34
				this.mapScenes = var3.method8028(); // L: 35
				this.headIconsPk = var3.method8028(); // L: 36
				this.field4411 = var3.method8028(); // L: 37
				this.field4417 = var3.method8028(); // L: 38
				this.field4407 = var3.method8028(); // L: 39
				this.field4413 = var3.method8028(); // L: 40
				this.field4414 = var3.method8028(); // L: 41
				this.field4416 = var3.method8028(); // L: 42
				this.field4415 = var3.method8028(); // L: 43
			}
		}
	}
