			...
			if (Client.minimapState != 2 && Client.minimapState != 5) {
				...
				if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
					...
					if (Client.hintArrowType == 2) {
						var10 = Client.hintArrowX * 4 - WorldMapSectionType.baseX * 256 + 2 - class67.localPlayer.x / 32;
						var11 = Client.hintArrowY * 4 - PlayerComposition.baseY * 256 + 2 - class67.localPlayer.y / 32;
