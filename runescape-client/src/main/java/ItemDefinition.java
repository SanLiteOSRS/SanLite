...
public class ItemDefinition extends DualNode {
   ...
   public final ModelData method4553(int var1) {
      ...
      ModelData var4 = ModelData.method2703(Frames.ItemDefinition_modelArchive, this.model, 0);
      if (var4 == null) {
         return null;
      } else {
         if (this.resizeX != 128 || this.resizeY != 128 || this.resizeZ != 128) {
            var4.method2719(this.resizeX, this.resizeY, this.resizeZ);
         }
   ...
   public final Model getModel(int var1) {
      ...
      if (var5 != null) {
         ...
         ModelData var6 = ModelData.method2703(Frames.ItemDefinition_modelArchive, this.model, 0);
         if (var6 == null) {
            return null;
         } else {
            if (this.resizeX != 128 || this.resizeY != 128 || this.resizeZ != 128) {
               var6.method2719(this.resizeX, this.resizeY, this.resizeZ);
            }
   ...
   public final ModelData method4557(boolean var1) {
      ...
      if (var2 == -1) {
         ...
         ModelData var5 = ModelData.method2703(Frames.ItemDefinition_modelArchive, var2, 0);
         if (var3 != -1) {
            ModelData var6 = ModelData.method2703(Frames.ItemDefinition_modelArchive, var3, 0);
            if (var4 != -1) {
               ModelData var7 = ModelData.method2703(Frames.ItemDefinition_modelArchive, var4, 0);
         ...
         if (!var1 && this.maleOffset != 0) {
            var5.method2715(0, this.maleOffset, 0);
         }

         if (var1 && this.femaleOffset != 0) {
            var5.method2715(0, this.femaleOffset, 0);
         }
   ...
   public final ModelData method4559(boolean var1) {
      ...
      if (var2 == -1) {
         ...
         ModelData var4 = ModelData.method2703(Frames.ItemDefinition_modelArchive, var2, 0);
         if (var3 != -1) {
            ModelData var5 = ModelData.method2703(Frames.ItemDefinition_modelArchive, var3, 0);
