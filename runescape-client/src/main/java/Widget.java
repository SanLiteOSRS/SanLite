...
public class Widget extends Node {
	...
	public static EvictingDualNodeHashTable field3047;
	@ObfuscatedName("h")
	@ObfuscatedSignature(
		descriptor = "Lim;"
	)
	...
	static {
		...
		field3047 = new EvictingDualNodeHashTable(20);
		...
		if (var5 == 0) {
			...
			if (var7 == null) {
				...
				if (var5 == 4) {
					...
					var7 = var8.toModel(var9.field1896 + 64, var9.field1919 + 768, -50, -10, -50);
				}
