   ...
   public Font getFont() {
      ...
      if (this.fontId == -1) {
         ...
         if (var1 != null) {
            ...
            var1 = class169.SpriteBuffer_getFont(WorldMapSprite.Widget_spritesArchive, Widget_fontsArchive, this.fontId, 0);
            if (var1 != null) {
   ...
   public Model getModel(SequenceDefinition var1, int var2, boolean var3, PlayerAppearance var4) {
      ...
      if (var5 == 0) {
         ...
         if (var7 == null) {
            ModelData var8;
            if (var5 == 1) {
               var8 = ModelData.method2703(Huffman.Widget_modelsArchive, var6, 0);
               if (var8 == null) {
                  field2579 = true;
                  return null;
               }
