...
public class Widget extends Node {
	...
	static EvictingDualNodeHashTable field2953;
	@ObfuscatedName("q")
	@ObfuscatedSignature(
		descriptor = "Lhw;"
	)
	...
	static {
		...
		field2953 = new EvictingDualNodeHashTable(20);
		...
		if (var5 == 0) {
			...
			if (var7 == null) {
				...
				if (var5 == 4) {
					...
					var7 = var8.toModel(var9.field1792 + 64, var9.field1831 + 768, -50, -10, -50);
				}
