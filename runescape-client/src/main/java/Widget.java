...
public class Widget extends Node {
	...
	public Widget() {
		...
		this.fillMode = class450.SOLID; // L: 90
	...
	public Model getModel(SequenceDefinition var1, int var2, boolean var3, PlayerComposition var4) {
		...
		if (var5 == 0) { // L: 675
			...
			if (var7 == null) { // L: 678
				...
				if (var5 == 4) { // L: 705
					ItemComposition var9 = FileSystem.ItemComposition_get(var6); // L: 706
					...
					var7 = var8.toModel(var9.ambient + 64, var9.contrast * 5 + 768, -50, -10, -50); // L: 712
				}
	...
	public SpriteMask getSpriteMask(boolean var1) {
		...
		int var2 = var1 ? this.spriteId : this.spriteId2; // L: 724
		if (var2 == -1) { // L: 725
			return null;
		} else {
	...
	static void setWindowedMode(int var0) {
		...
		if (Client.gameState >= 25) { // L: 4354
			PacketBufferNode var1 = DecorativeObject.getPacketBufferNode(ClientPacket.field3054, Client.packetWriter.isaacCipher); // L: 4356
