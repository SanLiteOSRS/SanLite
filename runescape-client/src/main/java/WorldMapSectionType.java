...
public enum WorldMapSectionType implements Enumerated {
	...
	static WorldMapSprite method3540(byte[] var0) {
		return var0 == null ? new WorldMapSprite() : new WorldMapSprite(WorldMapAreaData.convertJpgToSprite(var0).pixels);
	}
	...
	static WorldMapSectionType[] method3537() {
		return new WorldMapSectionType[]{WORLDMAPSECTIONTYPE1, WORLDMAPSECTIONTYPE3, WORLDMAPSECTIONTYPE0, WORLDMAPSECTIONTYPE2};
	}
}
