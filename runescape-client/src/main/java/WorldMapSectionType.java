...
public enum WorldMapSectionType implements class371 {
	...
	public static long method5445(int var0) {
		return ViewportMouse.ViewportMouse_entityTags[var0]; // L: 44
	}
	...
	static String method5444(String var0, Widget var1) {
		if (var0.indexOf("%") != -1) { // L: 11005
			for (int var2 = 1; var2 <= 5; ++var2) { // L: 11006
				while (true) {
					int var3 = var0.indexOf("%" + var2); // L: 11008
					if (var3 == -1) { // L: 11009
						break;
					}

					var0 = var0.substring(0, var3) + class176.method3493(UserComparator9.method2900(var1, var2 - 1)) + var0.substring(var3 + 2); // L: 11010
				}
			}
		}
