...
public enum WorldMapSectionType implements Enumerated {
               ...
               if (!var10.isIf3 || var15 < var17 && var16 < var18) {
                  if (var10.contentType != 0) {
                     ...
                     if (var10.contentType == 1337) {
                        Client.field735 = var12;
                        Client.field785 = var13;
                  ...
                  if (Client.isResizable || Client.field830[var11] || Client.gameDrawingMode > 1) {
                     if (var10.type == 0 && !var10.isIf3 && var10.scrollHeight > var10.height) {
                        HitSplatDefinition.method4478(var12 + var10.width, var13, var10.scrollY, var10.height, var10.scrollHeight);
                     }
                                    ...
                                    if (var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3 && var23 < var5 || var10 == class188.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
                                       ...
                                       if (var27 != null) {
                                          if (var10 == class188.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
                                             ...
                                             var27.method6010(var22 + var24, var23 + var25, 128);
                                             if (var1 != -1) {
                           ...
                           if (var10.type == 4) {
                              ...
                              if (var39 == null) {
                                 ...
                                 if (var10.isIf3 && var10.itemId != -1) {
                                    ...
                                    if ((var47.isStackable == 1 || var10.itemQuantity != 1) && var10.itemQuantity != -1) {
                                       var45 = class16.colorStartTag(16748608) + var45 + "</col>" + " " + 'x' + Frames.method3226(var10.itemQuantity);
                                    }
                                 }

                                 if (var10 == Client.field789) {
                                    var45 = "Please wait...";
                                    var20 = var10.color;
                                 }
                              ...
                              if (var10.type == 6) {
                                 ...
                                 if (var10.itemId != -1) {
                                    ...
                                    SequenceDefinition var46 = Widget.getSequenceDefinition(var20);
                                       ...
                                       for(var22 = 0; var22 < var10.rawWidth; ++var22) {
                                          if (var10.itemIds[var20] > 0) {
                                             ...
                                             if (var33.isStackable != 1 && var10.itemQuantities[var20] == 1) {
                                                ...
                                                var31 = class16.colorStartTag(16748608) + var33.name + "</col>" + " " + 'x' + Frames.method3226(var10.itemQuantities[var20]);
                                             }
   ...
   static final void method238(int var0) {
