...
public enum WorldMapSectionType implements class352 {
	...
	static WorldMapSectionType[] method5187() {
		return new WorldMapSectionType[]{WORLDMAPSECTIONTYPE0, WORLDMAPSECTIONTYPE1, WORLDMAPSECTIONTYPE3, WORLDMAPSECTIONTYPE2}; // L: 17
	}
	...
	static class129 method5191(int var0) {
		class129 var1 = (class129)SpriteMask.findEnumerated(class208.method4080(), var0); // L: 92
		if (var1 == null) {
			var1 = class129.field1557; // L: 93
		}
