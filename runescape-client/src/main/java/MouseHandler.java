...
public class MouseHandler implements MouseListener, MouseMotionListener, FocusListener {
	...
	public final synchronized void mousePressed(MouseEvent var1) {
		if (MouseHandler_instance != null) {
			...
			MouseHandler_lastPressedTimeMillisVolatile = PlayerAppearance.method4141();
	...
	static int method1176(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.VIEWPORT_SETFOV) {
			...
			Client.field881 = (short)Buddy.method5245(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize]);
			if (Client.field881 <= 0) {
				Client.field881 = 256;
			}

			Client.field882 = (short)Buddy.method5245(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
