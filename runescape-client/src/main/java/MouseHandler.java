...
public class MouseHandler implements MouseListener, MouseMotionListener, FocusListener {
	...
	public final synchronized void mousePressed(MouseEvent var1) {
		if (MouseHandler_instance != null) {
			...
			MouseHandler_lastPressedTimeMillisVolatile = DirectByteArrayCopier.method5318();
	...
	static final void method615() {
		...
		if (!var0) {
			...
			for (var1 = 0; var1 < Friend.regionLandArchives.length; ++var1) {
				...
				if (var15 != null) {
					var3 = (WorldMapLabel.regions[var1] >> 8) * 64 - Canvas.baseX * 64;
					var4 = (WorldMapLabel.regions[var1] & 255) * 64 - class118.baseY * 64;
			...
			if (!var0) {
				...
				if (!Client.isInInstance) {
					...
					for (var2 = 0; var2 < var1; ++var2) {
						var3 = (WorldMapLabel.regions[var2] >> 8) * 64 - Canvas.baseX * 64;
						var4 = (WorldMapLabel.regions[var2] & 255) * 64 - class118.baseY * 64;
					...
					for (var2 = 0; var2 < var1; ++var2) {
						...
						if (var13 != null) {
							var4 = (WorldMapLabel.regions[var2] >> 8) * 64 - Canvas.baseX * 64;
							var5 = (WorldMapLabel.regions[var2] & 255) * 64 - class118.baseY * 64;
							class122.playPcmPlayers();
