...
public class MusicPatch extends Node {
	...
	MusicPatch(byte[] var1) {
		this.field3479 = new ArrayList(8); // L: 21
		this.rawSounds = new class53[128]; // L: 31
		this.field3478 = new short[128]; // L: 32
		this.field3483 = new byte[128]; // L: 33
		this.field3480 = new byte[128]; // L: 34
		this.field3485 = new MusicPatchNode2[128]; // L: 35
		this.field3482 = new byte[128]; // L: 36
		this.field3484 = new int[128]; // L: 37
		...
		for (var14 = 0; var14 < var37.length; ++var14) { // L: 79
			...
			if (var40 > 0) { // L: 84
				var15.field3411 = new byte[var40 * 2 + 2]; // L: 85
				var15.field3411[1] = 64; // L: 86
			}
		}
		...
		for (var20 = 0; var20 < 128; ++var20) { // L: 100
			...
			this.field3478[var20] = (short)var19; // L: 102
		}
		...
		for (var23 = 0; var23 < 128; ++var23) { // L: 112
			...
			var48 = this.field3478; // L: 118
			var48[var23] = (short)(var48[var23] + ((var22 - 1 & 2) << 14));
			this.field3484[var23] = var22; // L: 119
			--var20; // L: 120
		}
		...
		for (var24 = 0; var24 < 128; ++var24) { // L: 125
			if (this.field3484[var24] != 0) { // L: 126
				if (var20 == 0) { // L: 127
				...
				this.field3482[var24] = (byte)var23; // L: 132
				--var20; // L: 133
			}
		}
		...
		for (int var25 = 0; var25 < 128; ++var25) { // L: 138
			if (this.field3484[var25] != 0) { // L: 139
				if (var20 == 0) { // L: 140
				...
				this.field3480[var25] = (byte)var24; // L: 145
				--var20; // L: 146
			}
		}
		...
		for (var26 = 0; var26 < 128; ++var26) { // L: 151
			if (this.field3484[var26] != 0) { // L: 152
				if (var20 == 0) { // L: 153
				...
				this.field3485[var26] = var38; // L: 158
				--var20; // L: 159
			}
		}
		...
		for (var27 = 0; var27 < 128; ++var27) { // L: 164
			if (var20 == 0) { // L: 165
				...
				if (this.field3484[var27] > 0) { // L: 168
					var26 = var2.readUnsignedByte() + 1;
				}
			}

			this.field3483[var27] = (byte)var26; // L: 170
			--var20; // L: 171
		}

		this.field3481 = var2.readUnsignedByte() + 1; // L: 173

		int var29;
		MusicPatchNode2 var39;
		for (var27 = 0; var27 < var12; ++var27) { // L: 174
			var39 = var37[var27]; // L: 175
			if (var39.field3406 != null) { // L: 176
				for (var29 = 1; var29 < var39.field3406.length; var29 += 2) { // L: 177
					var39.field3406[var29] = var2.readByte();
				}
			}

			if (var39.field3411 != null) { // L: 179
				for (var29 = 3; var29 < var39.field3411.length - 2; var29 += 2) { // L: 180
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 199
			...
			if (var39.field3406 != null) { // L: 201
				var19 = 0; // L: 202

				for (var29 = 2; var29 < var39.field3406.length; var29 += 2) { // L: 203
					var19 = var19 + 1 + var2.readUnsignedByte(); // L: 204
					var39.field3406[var29] = (byte)var19; // L: 205
				}
			}
		}
		...
		if (var42 != null) { // L: 209
			...
			for (var29 = 2; var29 < var42.length; var29 += 2) { // L: 219 220 231
				...
				for (var33 = var47; var33 < var30; ++var33) { // L: 224
					var34 = HorizontalAlignment.method3687(var32, var30 - var47); // L: 225
					this.field3483[var33] = (byte)(var34 * this.field3483[var33] + 32 >> 6); // L: 226
		...
		if (var16 != null) { // L: 236
			...
			for (var29 = 0; var29 < var47; ++var29) { // L: 245
				var45 = var44 + (this.field3480[var29] & 255); // L: 246
				if (var45 < 0) { // L: 247
					var45 = 0;
				}
				...
				this.field3480[var29] = (byte)var45; // L: 249
			}
			...
			for (var29 = 2; var29 < var16.length; var29 += 2) { // L: 251 252 266
				...
				for (var33 = var47; var33 < var30; ++var33) { // L: 256
					var34 = HorizontalAlignment.method3687(var32, var30 - var47); // L: 257
					int var35 = var34 + (this.field3480[var33] & 255); // L: 258
					if (var35 < 0) { // L: 259
						var35 = 0;
					}
					...
					this.field3480[var33] = (byte)var35; // L: 261
			...
			for (var45 = var47; var45 < 128; ++var45) { // L: 268
				var46 = var44 + (this.field3480[var45] & 255); // L: 269
				if (var46 < 0) { // L: 270
					var46 = 0;
				}
				...
				this.field3480[var45] = (byte)var46; // L: 272
			}
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 277
			...
			if (var39.field3406 != null) { // L: 279
				var39.field3412 = var2.readUnsignedByte();
			}

			if (var39.field3411 != null) { // L: 280
				var39.field3407 = var2.readUnsignedByte();
			}

			if (var39.field3405 > 0) { // L: 281
		...
		for (int var6 = var2.nextSetBit(0); var6 != -1; var6 = var2.nextSetBit(var7)) { // L: 298 299 328
			...
			for (int var8 = var6; var8 < var7; ++var8) { // L: 301
				if (var2.get(var8)) { // L: 302
					int var9 = this.field3484[var8]; // L: 303
					if (var9 != 0) { // L: 304
						if (var4 != var9) { // L: 305
							var4 = var9--; // L: 306 307
							if ((var9 & 1) == 0) { // L: 308
								var5 = new class53(var1.method892(var9 >> 2)); // L: 309
							} else {
								var5 = var1.method874(var9 >> 2); // L: 312
							}

							if (var5.method1096()) { // L: 314
								var3 = false; // L: 315
							} else {
								this.field3479.add(this.field3479.size(), var5); // L: 318
							}
						}

						if (!var5.method1096()) { // L: 321
							this.rawSounds[var8] = var5; // L: 322
							this.field3484[var8] = 0; // L: 323
						}
					}
				}
			}
	...
	public static String method6201(CharSequence var0) {
		int var2 = var0.length(); // L: 189
		char[] var3 = new char[var2]; // L: 191

		for (int var4 = 0; var4 < var2; ++var4) { // L: 192
			var3[var4] = '*';
		}

		String var1 = new String(var3); // L: 193
		return var1; // L: 195
	}
}
