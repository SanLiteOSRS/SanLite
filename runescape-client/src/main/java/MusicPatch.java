...
public class MusicPatch extends Node {
   ...
   @ObfuscatedName("i")
   short[] field2457 = new short[128];
   @ObfuscatedName("k")
   byte[] field2462 = new byte[128];
   @ObfuscatedName("u")
   byte[] field2463 = new byte[128];
   @ObfuscatedName("n")
   @ObfuscatedSignature(
      signature = "[Lgf;"
   )
   MusicPatchNode2[] field2460 = new MusicPatchNode2[128];
   @ObfuscatedName("t")
   byte[] field2461 = new byte[128];
   @ObfuscatedName("q")
   int[] field2455 = new int[128];
