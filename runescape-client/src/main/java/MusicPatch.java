...
public class MusicPatch extends Node {
	...
	MusicPatch(byte[] var1) {
		...
		this.field3418 = new short[128]; // L: 28
		this.field3410 = new byte[128]; // L: 29
		this.field3411 = new byte[128]; // L: 30
		this.field3408 = new MusicPatchNode2[128]; // L: 31
		this.field3413 = new byte[128]; // L: 32
		this.field3414 = new int[128]; // L: 33
		...
		int var9;
		for (var9 = 0; var2.array[var9 + var2.offset] != 0; ++var9) { // L: 51
		}
		...
		for (var14 = 0; var14 < var39.length; ++var14) { // L: 75
			...
			if (var42 > 0) { // L: 80
				var15.field3351 = new byte[var42 * 2 + 2]; // L: 81
				var15.field3351[1] = 64; // L: 82
			}
		}
		...
		for (var20 = 0; var20 < 128; ++var20) { // L: 96
			...
			this.field3418[var20] = (short)var19; // L: 98
		}
		...
		for (var23 = 0; var23 < 128; ++var23) { // L: 108
			...
			var50 = this.field3418; // L: 114
			var50[var23] = (short)(var50[var23] + ((var22 - 1 & 2) << 14));
			this.field3414[var23] = var22; // L: 115
			--var20; // L: 116
		}
		...
		for (var24 = 0; var24 < 128; ++var24) { // L: 121
			if (this.field3414[var24] != 0) { // L: 122
				if (var20 == 0) { // L: 123
				...
				this.field3413[var24] = (byte)var23; // L: 128
				--var20; // L: 129
			}
		}
		...
		for (int var25 = 0; var25 < 128; ++var25) { // L: 134
			if (this.field3414[var25] != 0) { // L: 135
				if (var20 == 0) { // L: 136
				...
				this.field3411[var25] = (byte)var24; // L: 141
				--var20; // L: 142
			}
		}
		...
		for (var26 = 0; var26 < 128; ++var26) { // L: 147
			if (this.field3414[var26] != 0) { // L: 148
				if (var20 == 0) { // L: 149
				...
				this.field3408[var26] = var40; // L: 154
				--var20; // L: 155
			}
		}
		...
		for (var27 = 0; var27 < 128; ++var27) { // L: 160
			if (var20 == 0) { // L: 161
				...
				if (this.field3414[var27] > 0) { // L: 164
					var26 = var2.readUnsignedByte() + 1;
				}
			}

			this.field3410[var27] = (byte)var26; // L: 166
			--var20; // L: 167
		}

		this.field3412 = var2.readUnsignedByte() + 1; // L: 169

		int var29;
		MusicPatchNode2 var41;
		for (var27 = 0; var27 < var12; ++var27) { // L: 170
			var41 = var39[var27]; // L: 171
			if (var41.field3353 != null) { // L: 172
				for (var29 = 1; var29 < var41.field3353.length; var29 += 2) { // L: 173
					var41.field3353[var29] = var2.readByte();
				}
			}

			if (var41.field3351 != null) { // L: 175
				for (var29 = 3; var29 < var41.field3351.length - 2; var29 += 2) { // L: 176
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 185
			...
			if (var41.field3351 != null) { // L: 187
				var19 = 0; // L: 188

				for (var29 = 2; var29 < var41.field3351.length; var29 += 2) { // L: 189
					var19 = 1 + var19 + var2.readUnsignedByte(); // L: 190
					var41.field3351[var29] = (byte)var19; // L: 191
				}
			}
		}
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 195
			...
			if (var41.field3353 != null) { // L: 197
				var19 = 0; // L: 198

				for (var29 = 2; var29 < var41.field3353.length; var29 += 2) { // L: 199
					var19 = 1 + var19 + var2.readUnsignedByte(); // L: 200
					var41.field3353[var29] = (byte)var19; // L: 201
				}
			}
		}
		...
		if (var44 != null) { // L: 205
			...
			for (var29 = 2; var29 < var44.length; var29 += 2) { // L: 215 216 233
				...
				for (var33 = var49; var33 < var30; ++var33) { // L: 220
					...
					this.field3410[var33] = (byte)(var34 * this.field3410[var33] + 32 >> 6); // L: 228
			...
			for (var47 = var49; var47 < 128; ++var47) { // L: 235
				this.field3410[var47] = (byte)(var28 * this.field3410[var47] + 32 >> 6);
			}
		...
		if (var16 != null) { // L: 238
			...
			for (var29 = 0; var29 < var49; ++var29) { // L: 247
				var47 = var46 + (this.field3411[var29] & 255); // L: 248
				if (var47 < 0) { // L: 249
					var47 = 0;
				}
				...
				this.field3411[var29] = (byte)var47; // L: 251
			}
			...
			for (var29 = 2; var29 < var16.length; var29 += 2) { // L: 253 254 274
				...
				for (var33 = var49; var33 < var30; ++var33) { // L: 258
					...
					int var37 = var34 + (this.field3411[var33] & 255); // L: 266
					if (var37 < 0) { // L: 267
						var37 = 0;
					}
					...
					this.field3411[var33] = (byte)var37; // L: 269
			...
			for (var47 = var49; var47 < 128; ++var47) { // L: 276
				var48 = var46 + (this.field3411[var47] & 255); // L: 277
				if (var48 < 0) { // L: 278
					var48 = 0;
				}
				...
				this.field3411[var47] = (byte)var48; // L: 280
			}
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 285
			...
			if (var41.field3353 != null) { // L: 287
				var41.field3346 = var2.readUnsignedByte();
			}

			if (var41.field3351 != null) { // L: 288
				var41.field3347 = var2.readUnsignedByte();
			}

			if (var41.field3345 > 0) { // L: 289
	...
	boolean method5779(SoundCache var1, byte[] var2, int[] var3) {
		...
		for (int var7 = 0; var7 < 128; ++var7) { // L: 306
			if (var2 == null || var2[var7] != 0) { // L: 307
				int var8 = this.field3414[var7]; // L: 308
				if (var8 != 0) { // L: 309
					if (var5 != var8) { // L: 310
						var5 = var8--; // L: 311 312
						if ((var8 & 1) == 0) { // L: 313
	...
	public static boolean method5789(char var0) {
		if (var0 >= ' ' && var0 < 127 || var0 > 127 && var0 < 160 || var0 > 160 && var0 <= 255) { // L: 45
			...
			if (var0 != 0) { // L: 46
				char[] var1 = class362.cp1252AsciiExtension; // L: 48
