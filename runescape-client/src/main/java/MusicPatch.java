...
public class MusicPatch extends Node {
	...
	MusicPatch(byte[] var1) {
		...
		this.field3249 = new short[128]; // L: 22
		this.field3252 = new byte[128]; // L: 23
		this.field3251 = new byte[128]; // L: 24
		this.field3255 = new MusicPatchNode2[128]; // L: 25
		this.field3253 = new byte[128]; // L: 26
		this.field3247 = new int[128]; // L: 27
		...
		for (var14 = 0; var14 < var39.length; ++var14) { // L: 69
			...
			if (var42 > 0) { // L: 74
				var15.field3195 = new byte[var42 * 2 + 2]; // L: 75
				var15.field3195[1] = 64; // L: 76
			}
		}
		...
		for (var20 = 0; var20 < 128; ++var20) { // L: 90
			...
			this.field3249[var20] = (short)var19; // L: 92
		}
		...
		for (var23 = 0; var23 < 128; ++var23) { // L: 102
			...
			var50 = this.field3249; // L: 108
			var50[var23] = (short)(var50[var23] + ((var22 - 1 & 2) << 14));
			this.field3247[var23] = var22; // L: 109
			--var20; // L: 110
		}
		...
		for (var24 = 0; var24 < 128; ++var24) { // L: 115
			if (this.field3247[var24] != 0) { // L: 116
				if (var20 == 0) { // L: 117
				...
				this.field3253[var24] = (byte)var23; // L: 122
				--var20; // L: 123
			}
		}
		...
		for (int var25 = 0; var25 < 128; ++var25) { // L: 128
			if (this.field3247[var25] != 0) { // L: 129
				if (var20 == 0) { // L: 130
		...
		for (var26 = 0; var26 < 128; ++var26) { // L: 141
			if (this.field3247[var26] != 0) { // L: 142
				if (var20 == 0) { // L: 143
				...
				this.field3255[var26] = var40; // L: 148
				--var20; // L: 149
			}
		}
		...
		for (var27 = 0; var27 < 128; ++var27) { // L: 154
			if (var20 == 0) { // L: 155
				...
				if (this.field3247[var27] > 0) { // L: 158
					var26 = var2.readUnsignedByte() + 1;
				}
			}

			this.field3252[var27] = (byte)var26; // L: 160
			--var20; // L: 161
		}

		this.field3248 = var2.readUnsignedByte() + 1; // L: 163

		int var29;
		MusicPatchNode2 var41;
		for (var27 = 0; var27 < var12; ++var27) { // L: 164
			var41 = var39[var27]; // L: 165
			if (var41.field3189 != null) { // L: 166
				for (var29 = 1; var29 < var41.field3189.length; var29 += 2) { // L: 167
					var41.field3189[var29] = var2.readByte();
				}
			}

			if (var41.field3195 != null) { // L: 169
				for (var29 = 3; var29 < var41.field3195.length - 2; var29 += 2) { // L: 170
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 189
			...
			if (var41.field3189 != null) { // L: 191
				var19 = 0; // L: 192

				for (var29 = 2; var29 < var41.field3189.length; var29 += 2) { // L: 193
					var19 = var19 + 1 + var2.readUnsignedByte(); // L: 194
					var41.field3189[var29] = (byte)var19; // L: 195
				}
			}
		}
		...
		if (var44 != null) { // L: 199
			...
			for (var29 = 2; var29 < var44.length; var29 += 2) { // L: 209 210 227
				...
				for (var33 = var49; var33 < var30; ++var33) { // L: 214
					...
					this.field3252[var33] = (byte)(var34 * this.field3252[var33] + 32 >> 6); // L: 222
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 279
			...
			if (var41.field3189 != null) { // L: 281
				var41.field3191 = var2.readUnsignedByte();
			}

			if (var41.field3195 != null) { // L: 282
				var41.field3192 = var2.readUnsignedByte();
			}

			if (var41.field3190 > 0) { // L: 283
	...
	boolean method5369(SoundCache var1, byte[] var2, int[] var3) {
		...
		for (int var7 = 0; var7 < 128; ++var7) { // L: 300
			if (var2 == null || var2[var7] != 0) { // L: 301
				int var8 = this.field3247[var7]; // L: 302
				if (var8 != 0) { // L: 303
					if (var8 != var5) { // L: 304
						var5 = var8--; // L: 305 306
						if ((var8 & 1) == 0) { // L: 307
