...
public class MusicPatch extends Node {
	...
	MusicPatch(byte[] var1) {
		...
		this.field2533 = new short[128];
		this.field2534 = new byte[128];
		this.field2539 = new byte[128];
		this.field2536 = new MusicPatchNode2[128];
		this.field2537 = new byte[128];
		this.field2538 = new int[128];
		...
		for (var14 = 0; var14 < var39.length; ++var14) {
			...
			if (var16 > 0) {
				var40.field2470 = new byte[var16 * 2];
			}

			var16 = var2.readUnsignedByte();
			if (var16 > 0) {
				var40.field2467 = new byte[var16 * 2 + 2];
				var40.field2467[1] = 64;
			}
		}
		...
		for (var20 = 0; var20 < 128; ++var20) {
			...
			this.field2533[var20] = (short)var19;
		}
		...
		for (var24 = 0; var24 < 128; ++var24) {
			if (this.field2538[var24] != 0) {
				...
				this.field2537[var24] = (byte)var23;
				--var20;
			}
		}
		...
		for (int var25 = 0; var25 < 128; ++var25) {
			if (this.field2538[var25] != 0) {
				...
				this.field2539[var25] = (byte)var24;
				--var20;
			}
		}
		...
		for (var27 = 0; var27 < 128; ++var27) {
			if (var20 == 0) {
				...
				if (this.field2538[var27] > 0) {
					var26 = var2.readUnsignedByte() + 1;
				}
			}

			this.field2534[var27] = (byte)var26;
			--var20;
		}

		this.field2532 = var2.readUnsignedByte() + 1;

		MusicPatchNode2 var28;
		int var29;
		for (var27 = 0; var27 < var12; ++var27) {
			var28 = var39[var27];
			if (var28.field2470 != null) {
				for (var29 = 1; var29 < var28.field2470.length; var29 += 2) {
					var28.field2470[var29] = var2.readByte();
				}
			}

			if (var28.field2467 != null) {
				for (var29 = 3; var29 < var28.field2467.length - 2; var29 += 2) {
		...
		for (var27 = 0; var27 < var12; ++var27) {
			...
			if (var28.field2470 != null) {
				...
				for (var29 = 2; var29 < var28.field2470.length; var29 += 2) {
					var19 = var19 + 1 + var2.readUnsignedByte();
					var28.field2470[var29] = (byte)var19;
				}
			}
		}
		...
		if (var47 != null) {
			...
			for (var29 = 0; var29 < var46; ++var29) {
				this.field2534[var29] = (byte)(var43 * this.field2534[var29] + 32 >> 6);
			}
			...
			for (var29 = 2; var29 < var47.length; var29 += 2) {
				...
				for (var33 = var46; var33 < var30; ++var33) {
					...
					this.field2534[var33] = (byte)(var34 * this.field2534[var33] + 32 >> 6);
					var32 += var31 - var43;
				}
			...
			for (var44 = var46; var44 < 128; ++var44) {
				this.field2534[var44] = (byte)(var43 * this.field2534[var44] + 32 >> 6);
			}
		...
		if (var41 != null) {
			...
			for (var29 = 0; var29 < var46; ++var29) {
				var44 = var49 + (this.field2539[var29] & 255);
				if (var44 < 0) {
					var44 = 0;
				}
				...
				this.field2539[var29] = (byte)var44;
			}
			...
			for (var29 = 2; var29 < var41.length; var29 += 2) {
				...
				for (var33 = var46; var33 < var30; ++var33) {
					...
					int var37 = var34 + (this.field2539[var33] & 255);
					if (var37 < 0) {
						var37 = 0;
					}
					...
					this.field2539[var33] = (byte)var37;
					var32 += var45 - var49;
				}
			...
			for (var44 = var46; var44 < 128; ++var44) {
				var45 = var49 + (this.field2539[var44] & 255);
				if (var45 < 0) {
					var45 = 0;
				}
				...
				this.field2539[var44] = (byte)var45;
			}
		...
		for (var27 = 0; var27 < var12; ++var27) {
			...
			if (var28.field2474 > 0) {
				var28.field2473 = var2.readUnsignedByte();
			}
		}
		...
		for (var27 = 0; var27 < var12; ++var27) {
			...
			if (var28.field2473 > 0) {
				var28.field2468 = var2.readUnsignedByte();
			}
		}
