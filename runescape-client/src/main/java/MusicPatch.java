...
public class MusicPatch extends Node {
	...
	MusicPatch(byte[] var1) {
		this.field3471 = new ArrayList(8); // L: 21
		this.rawSounds = new class53[128]; // L: 25
		this.field3465 = new short[128]; // L: 26
		this.field3467 = new byte[128]; // L: 27
		this.field3472 = new byte[128]; // L: 28
		this.field3469 = new MusicPatchNode2[128]; // L: 29
		this.field3468 = new byte[128]; // L: 30
		this.field3473 = new int[128]; // L: 31
		...
		for (var14 = 0; var14 < var37.length; ++var14) { // L: 73
			...
			if (var40 > 0) { // L: 78
				var15.field3380 = new byte[var40 * 2 + 2]; // L: 79
				var15.field3380[1] = 64; // L: 80
			}
		}
		...
		for (var20 = 0; var20 < 128; ++var20) { // L: 94
			...
			this.field3465[var20] = (short)var19; // L: 96
		}
		...
		for (var23 = 0; var23 < 128; ++var23) { // L: 106
			...
			var48 = this.field3465; // L: 112
			var48[var23] = (short)(var48[var23] + ((var22 - 1 & 2) << 14));
			this.field3473[var23] = var22; // L: 113
			--var20; // L: 114
		}
		...
		for (var24 = 0; var24 < 128; ++var24) { // L: 119
			if (this.field3473[var24] != 0) { // L: 120
				if (var20 == 0) { // L: 121
				...
				this.field3468[var24] = (byte)var23; // L: 126
				--var20; // L: 127
			}
		}
		...
		for (int var25 = 0; var25 < 128; ++var25) { // L: 132
			if (this.field3473[var25] != 0) { // L: 133
				if (var20 == 0) { // L: 134
				...
				this.field3472[var25] = (byte)var24; // L: 139
				--var20; // L: 140
			}
		}
		...
		for (var26 = 0; var26 < 128; ++var26) { // L: 145
			if (this.field3473[var26] != 0) { // L: 146
				if (var20 == 0) { // L: 147
				...
				this.field3469[var26] = var38; // L: 152
				--var20; // L: 153
			}
		}
		...
		for (var27 = 0; var27 < 128; ++var27) { // L: 158
			if (var20 == 0) { // L: 159
				...
				if (this.field3473[var27] > 0) { // L: 162
					var26 = var2.readUnsignedByte() + 1;
				}
			}

			this.field3467[var27] = (byte)var26; // L: 164
			--var20; // L: 165
		}

		this.field3470 = var2.readUnsignedByte() + 1; // L: 167

		int var29;
		MusicPatchNode2 var39;
		for (var27 = 0; var27 < var12; ++var27) { // L: 168
			var39 = var37[var27]; // L: 169
			if (var39.field3381 != null) { // L: 170
				for (var29 = 1; var29 < var39.field3381.length; var29 += 2) { // L: 171
					var39.field3381[var29] = var2.readByte();
				}
			}

			if (var39.field3380 != null) { // L: 173
				for (var29 = 3; var29 < var39.field3380.length - 2; var29 += 2) { // L: 174
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 183
			...
			if (var39.field3380 != null) { // L: 185
				var19 = 0; // L: 186

				for (var29 = 2; var29 < var39.field3380.length; var29 += 2) { // L: 187
					var19 = 1 + var19 + var2.readUnsignedByte(); // L: 188
					var39.field3380[var29] = (byte)var19; // L: 189
				}
			}
		}
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 193
			...
			if (var39.field3381 != null) { // L: 195
				var19 = 0; // L: 196

				for (var29 = 2; var29 < var39.field3381.length; var29 += 2) { // L: 197
					var19 = var19 + 1 + var2.readUnsignedByte(); // L: 198
					var39.field3381[var29] = (byte)var19; // L: 199
				}
			}
		}
		...
		if (var42 != null) { // L: 203
			...
			for (var29 = 2; var29 < var42.length; var29 += 2) { // L: 213 214 225
				...
				for (var33 = var47; var33 < var30; ++var33) { // L: 218
					var34 = class228.method4502(var32, var30 - var47); // L: 219
					this.field3467[var33] = (byte)(var34 * this.field3467[var33] + 32 >> 6); // L: 220
		...
		if (var16 != null) { // L: 230
			...
			for (var29 = 0; var29 < var47; ++var29) { // L: 239
				var45 = var44 + (this.field3472[var29] & 255); // L: 240
				if (var45 < 0) { // L: 241
					var45 = 0;
				}
				...
				this.field3472[var29] = (byte)var45; // L: 243
			}
			...
			for (var29 = 2; var29 < var16.length; var29 += 2) { // L: 245 246 260
				...
				for (var33 = var47; var33 < var30; ++var33) { // L: 250
					var34 = class228.method4502(var32, var30 - var47); // L: 251
					int var35 = var34 + (this.field3472[var33] & 255); // L: 252
					if (var35 < 0) { // L: 253
						var35 = 0;
					}
					...
					this.field3472[var33] = (byte)var35; // L: 255
			...
			for (var45 = var47; var45 < 128; ++var45) { // L: 262
				var46 = var44 + (this.field3472[var45] & 255); // L: 263
				if (var46 < 0) { // L: 264
					var46 = 0;
				}
				...
				this.field3472[var45] = (byte)var46; // L: 266
			}
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 271
			...
			if (var39.field3381 != null) { // L: 273
				var39.field3383 = var2.readUnsignedByte();
			}

			if (var39.field3380 != null) { // L: 274
				var39.field3385 = var2.readUnsignedByte();
			}

			if (var39.field3382 > 0) { // L: 275
		...
		for (int var6 = var2.nextSetBit(0); var6 != -1; var6 = var2.nextSetBit(var7)) { // L: 292 293 322
			...
			for (int var8 = var6; var8 < var7; ++var8) { // L: 295
				if (var2.get(var8)) { // L: 296
					int var9 = this.field3473[var8]; // L: 297
					if (var9 != 0) { // L: 298
						if (var9 != var4) { // L: 299
							var4 = var9--; // L: 300 301
							if ((var9 & 1) == 0) { // L: 302
								var5 = new class53(var1.method860(var9 >> 2)); // L: 303
							} else {
								var5 = var1.method868(var9 >> 2); // L: 306
							}

							if (var5.method1092()) { // L: 308
								var3 = false; // L: 309
							} else {
								this.field3471.add(this.field3471.size(), var5); // L: 312
							}
						}

						if (!var5.method1092()) { // L: 315
							this.rawSounds[var8] = var5; // L: 316
							this.field3473[var8] = 0; // L: 317
						}
					}
				}
			}
