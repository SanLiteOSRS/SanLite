...
public class MusicPatch extends Node {
	...
	MusicPatch(byte[] var1) {
		...
		this.field3343 = new short[128]; // L: 22
		this.field3344 = new byte[128]; // L: 23
		this.field3345 = new byte[128]; // L: 24
		this.field3346 = new MusicPatchNode2[128]; // L: 25
		this.field3347 = new byte[128]; // L: 26
		this.field3348 = new int[128]; // L: 27
		...
		for (var14 = 0; var14 < var37.length; ++var14) { // L: 69
			...
			if (var40 > 0) { // L: 74
				var15.field3286 = new byte[var40 * 2 + 2]; // L: 75
				var15.field3286[1] = 64; // L: 76
			}
		}
		...
		for (var20 = 0; var20 < 128; ++var20) { // L: 90
			...
			this.field3343[var20] = (short)var19; // L: 92
		}
		...
		for (var23 = 0; var23 < 128; ++var23) { // L: 102
			...
			var48 = this.field3343; // L: 108
			var48[var23] = (short)(var48[var23] + ((var22 - 1 & 2) << 14));
			this.field3348[var23] = var22; // L: 109
			--var20; // L: 110
		}
		...
		for (var24 = 0; var24 < 128; ++var24) { // L: 115
			if (this.field3348[var24] != 0) { // L: 116
				if (var20 == 0) { // L: 117
				...
				this.field3347[var24] = (byte)var23; // L: 122
				--var20; // L: 123
			}
		}
		...
		for (int var25 = 0; var25 < 128; ++var25) { // L: 128
			if (this.field3348[var25] != 0) { // L: 129
				if (var20 == 0) { // L: 130
				...
				this.field3345[var25] = (byte)var24; // L: 135
				--var20; // L: 136
			}
		}
		...
		for (var26 = 0; var26 < 128; ++var26) { // L: 141
			if (this.field3348[var26] != 0) { // L: 142
				if (var20 == 0) { // L: 143
				...
				this.field3346[var26] = var38; // L: 148
				--var20; // L: 149
			}
		}
		...
		for (var27 = 0; var27 < 128; ++var27) { // L: 154
			if (var20 == 0) { // L: 155
				...
				if (this.field3348[var27] > 0) { // L: 158
					var26 = var2.readUnsignedByte() + 1;
				}
			}

			this.field3344[var27] = (byte)var26; // L: 160
			--var20; // L: 161
		}

		this.field3350 = var2.readUnsignedByte() + 1; // L: 163

		int var29;
		MusicPatchNode2 var39;
		for (var27 = 0; var27 < var12; ++var27) { // L: 164
			var39 = var37[var27]; // L: 165
			if (var39.field3288 != null) { // L: 166
				for (var29 = 1; var29 < var39.field3288.length; var29 += 2) { // L: 167
					var39.field3288[var29] = var2.readByte();
				}
			}

			if (var39.field3286 != null) { // L: 169
				for (var29 = 3; var29 < var39.field3286.length - 2; var29 += 2) { // L: 170
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 179
			...
			if (var39.field3286 != null) { // L: 181
				var19 = 0; // L: 182

				for (var29 = 2; var29 < var39.field3286.length; var29 += 2) { // L: 183
					var19 = 1 + var19 + var2.readUnsignedByte(); // L: 184
					var39.field3286[var29] = (byte)var19; // L: 185
				}
			}
		}
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 189
			...
			if (var39.field3288 != null) { // L: 191
				var19 = 0; // L: 192

				for (var29 = 2; var29 < var39.field3288.length; var29 += 2) { // L: 193
					var19 = 1 + var19 + var2.readUnsignedByte(); // L: 194
					var39.field3288[var29] = (byte)var19; // L: 195
				}
			}
		}
		...
		if (var42 != null) { // L: 199
			...
			for (var29 = 2; var29 < var42.length; var29 += 2) { // L: 209 210 221
				...
				for (var33 = var47; var33 < var30; ++var33) { // L: 214
					var34 = class270.method5371(var32, var30 - var47); // L: 215
					this.field3344[var33] = (byte)(var34 * this.field3344[var33] + 32 >> 6); // L: 216
		...
		if (var16 != null) { // L: 226
			...
			for (var29 = 0; var29 < var47; ++var29) { // L: 235
				var45 = var44 + (this.field3345[var29] & 255); // L: 236
				if (var45 < 0) { // L: 237
					var45 = 0;
				}
				...
				this.field3345[var29] = (byte)var45; // L: 239
			}
			...
			for (var29 = 2; var29 < var16.length; var29 += 2) { // L: 241 242 256
				...
				for (var33 = var47; var33 < var30; ++var33) { // L: 246
					var34 = class270.method5371(var32, var30 - var47); // L: 247
					int var35 = var34 + (this.field3345[var33] & 255); // L: 248
					if (var35 < 0) { // L: 249
						var35 = 0;
					}
					...
					this.field3345[var33] = (byte)var35; // L: 251
			...
			for (var45 = var47; var45 < 128; ++var45) { // L: 258
				var46 = var44 + (this.field3345[var45] & 255); // L: 259
				if (var46 < 0) { // L: 260
					var46 = 0;
				}
				...
				this.field3345[var45] = (byte)var46; // L: 262
			}
		...
		for (var27 = 0; var27 < var12; ++var27) { // L: 267
			...
			if (var39.field3288 != null) { // L: 269
				var39.field3283 = var2.readUnsignedByte();
			}

			if (var39.field3286 != null) { // L: 270
				var39.field3284 = var2.readUnsignedByte();
			}

			if (var39.field3282 > 0) { // L: 271
	...
	boolean method5630(SoundCache var1, byte[] var2, int[] var3) {
		...
		for (int var7 = 0; var7 < 128; ++var7) { // L: 288
			if (var2 == null || var2[var7] != 0) { // L: 289
				int var8 = this.field3348[var7]; // L: 290
				if (var8 != 0) { // L: 291
					if (var5 != var8) { // L: 292
						var5 = var8--; // L: 293 294
						if ((var8 & 1) == 0) { // L: 295
