...
public class class151 extends class136 {
	...
	class151(class139 var1) {
		this.this$0 = var1;
		this.field1767 = -1L; // L: 93
		this.field1760 = null; // L: 94
		this.field1761 = 0; // L: 95
	} // L: 97
	...
	void vmethod3349(Buffer var1) {
		if (var1.readUnsignedByte() != 255) { // L: 100
			--var1.offset; // L: 101
			this.field1767 = var1.readLong(); // L: 102
		}

		this.field1760 = var1.readStringCp1252NullTerminatedOrNull(); // L: 104
		this.field1761 = var1.readUnsignedShort(); // L: 105
	} // L: 106
	...
	void vmethod3350(ClanSettings var1) {
		var1.method3210(this.field1767, this.field1760, this.field1761); // L: 109
	} // L: 110
