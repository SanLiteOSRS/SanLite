		...
		if (var5 != null) { // L: 9809
			...
			if (var8) { // L: 9820
				if (MenuAction.method1880(UrlRequester.getWidgetFlags(var5), var0 - 1)) { // L: 9821
					...
					if (var0 == 1) { // L: 9824
						var7 = DecorativeObject.getPacketBufferNode(ClientPacket.field3006, Client.packetWriter.isaacCipher); // L: 9826
					...
					if (var0 == 2) { // L: 9832
						var7 = DecorativeObject.getPacketBufferNode(ClientPacket.field3032, Client.packetWriter.isaacCipher); // L: 9834
					...
					if (var0 == 3) { // L: 9840
						var7 = DecorativeObject.getPacketBufferNode(ClientPacket.field3011, Client.packetWriter.isaacCipher); // L: 9842
					...
					if (var0 == 4) { // L: 9848
						var7 = DecorativeObject.getPacketBufferNode(ClientPacket.field2956, Client.packetWriter.isaacCipher); // L: 9850
					...
					if (var0 == 5) { // L: 9856
						var7 = DecorativeObject.getPacketBufferNode(ClientPacket.field2960, Client.packetWriter.isaacCipher); // L: 9858
					...
					if (var0 == 6) { // L: 9864
						var7 = DecorativeObject.getPacketBufferNode(ClientPacket.field2968, Client.packetWriter.isaacCipher); // L: 9866
					...
					if (var0 == 7) { // L: 9872
						var7 = DecorativeObject.getPacketBufferNode(ClientPacket.field3002, Client.packetWriter.isaacCipher); // L: 9874
					...
					if (var0 == 8) { // L: 9880
						var7 = DecorativeObject.getPacketBufferNode(ClientPacket.field2989, Client.packetWriter.isaacCipher); // L: 9882
					...
					if (var0 == 9) { // L: 9888
						var7 = DecorativeObject.getPacketBufferNode(ClientPacket.field3015, Client.packetWriter.isaacCipher); // L: 9890
					...
					if (var0 == 10) { // L: 9896
						var7 = DecorativeObject.getPacketBufferNode(ClientPacket.field3043, Client.packetWriter.isaacCipher); // L: 9898
