...
public class TaskHandler implements Runnable {
	...
	static final void method3430() {
		if (class142.FriendsChatManager_inFriendsChat) { // L: 3556
			if (class145.friendsChatManager != null) { // L: 3557
				class145.friendsChatManager.sort(); // L: 3558
			}
			...
			class142.FriendsChatManager_inFriendsChat = false; // L: 3566
		}
	...
	static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) { // L: 7712
			...
			if (var1 == 0) { // L: 7718
				var7 = MusicPatchNode.scene.getWallObjectTag(var0, var2, var3);
			}

			if (var1 == 1) { // L: 7719
				var7 = MusicPatchNode.scene.getDecorativeObjectTag(var0, var2, var3);
			}
			...
			if (var1 == 3) { // L: 7721
				var7 = MusicPatchNode.scene.getGroundObjectTag(var0, var2, var3);
			}
			...
			if (var7 != 0L) { // L: 7722
				...
				if (var1 == 0) { // L: 7727
					MusicPatchNode.scene.removeWallObject(var0, var2, var3); // L: 7728
				...
				if (var1 == 1) { // L: 7732
					MusicPatchNode.scene.removeDecorativeObject(var0, var2, var3);
				}
				...
				if (var1 == 3) { // L: 7739
					MusicPatchNode.scene.removeGroundObject(var0, var2, var3); // L: 7740
				...
				for (int var17 = 0; var17 < var0.width; ++var17) { // L: 10607
					...
					if (var1 >= var6 && var2 >= var7 && var1 < var6 + 32 && var2 < var7 + 32) { // L: 10614
						...
						if (var0.itemIds[var15] > 0) { // L: 10617
							label359: {
								ItemComposition var8 = UserComparator3.ItemComposition_get(var0.itemIds[var15] - 1); // L: 10618
								boolean var9;
								int var10;
			...
			if (Client.isSpellSelected) { // L: 10704
				...
				for (var4 = 4; var4 >= 0; --var4) { // L: 10740
					...
					if (var5 != null) { // L: 10759
						class399.method7298(var5, var0.dataText, 57, var4 + 1, var0.childIndex, var0.id, var0.itemId, var0.prioritizeMenuEntry); // L: 10760
					}
				}
