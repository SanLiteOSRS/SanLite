...
public class TaskHandler implements Runnable {
   ...
   public static boolean method3423(CharSequence var0) {
   ...
   public static AccessFile getPreferencesFile(String var0, String var1, boolean var2) {
      File var3 = new File(class167.field2023, "preferences" + var0 + ".dat");
      if (var3.exists()) {
         try {
      ...
      String var4 = "";
      if (InterfaceParent.field543 == 33) {
         var4 = "_rc";
      } else if (InterfaceParent.field543 == 34) {
         var4 = "_wip";
      }
