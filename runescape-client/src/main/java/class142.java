...
public abstract class class142 extends Node {
	...
	static final void method2952(PacketBuffer var0) {
		for (int var1 = 0; var1 < Client.field548; ++var1) {
			...
			if ((var4 & 32) != 0) {
				var3.definition = UserComparator10.getNpcDefinition(var0.method7408());
			...
			if ((var4 & 512) != 0) {
				var3.field1135 = var0.method7416();
			}
			...
			if (HealthBarUpdate.field1178 && (var4 & 1024) != 0 || !HealthBarUpdate.field1178 && (var4 & 16) != 0) {
				...
				var3.field1147 = var0.method7365();
				var3.field1156 = var0.method7400();
				var3.field1157 = var0.method7408() + Client.cycle;
				var3.field1158 = var0.method7562() + Client.cycle;
			...
			if ((var4 & 256) != 0) {
				var3.field1162 = Client.cycle + var0.method7562();
				var3.field1163 = Client.cycle + var0.readUnsignedShort();
				var3.field1164 = var0.method7401();
				var3.field1155 = var0.method7400();
				var3.field1166 = var0.readByte();
				var3.field1167 = (byte)var0.method7399();
			}

			if ((var4 & 64) != 0) {
				var3.targetIndex = var0.method7408();
			...
			if ((var4 & 1) != 0) {
				...
				if (var6 > 0) {
					for (var7 = 0; var7 < var6; ++var7) {
						...
						if (var9 != 32767) {
							var10 = var0.readUShortSmart();
							var11 = var0.method7398();
							int var12 = var9 > 0 ? var0.method7467() : var11;
			...
			if ((var4 & 8) != 0) {
				...
				var6 = var0.method7562();
				if (HealthBarUpdate.field1178) {
					var3.field1139 = var0.readUnsignedByte() == 1;
				}

				var7 = var3.x - (var5 - Canvas.baseX * 64 - Canvas.baseX * 64) * 64;
				var8 = var3.y - (var6 - class118.baseY * 64 - class118.baseY * 64) * 64;
				if (var7 != 0 || var8 != 0) {
