...
public class class142 extends class145 {
	...
	void vmethod3414(Buffer var1) {
		this.field1640 = var1.readUnsignedShort(); // L: 166
		this.field1637 = var1.readInt(); // L: 167
		this.field1638 = var1.readUnsignedByte(); // L: 168
	...
	void vmethod3415(ClanSettings var1) {
		var1.method3250(this.field1640, this.field1637, this.field1638, this.field1639); // L: 173
	} // L: 174
