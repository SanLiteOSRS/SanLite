...
public class class142 extends class128 {
	...
	static final void method3050(int var0, int var1, int var2, int var3, int var4, int var5, int var6, Scene var7, CollisionMap var8) {
		...
		if (var6 == 22) { // L: 994
			...
			var7.newGroundObject(var0, var2, var3, var17, (Renderable)var30, var20, var22); // L: 998
			...
			if (var6 >= 12) { // L: 1010
				...
				var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1007[var5], 0, var20, var22); // L: 1022
				...
				var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1011[var5], 0, var20, var22); // L: 1030
				...
				if (var6 == 2) { // L: 1034
					...
					var7.newWallObject(var0, var2, var3, var17, (Renderable)var31, (Renderable)var25, Tiles.field1007[var5], Tiles.field1007[var23], var20, var22); // L: 1046
					...
					var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1011[var5], 0, var20, var22); // L: 1054
					...
					var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1007[var5], 0, 0, 0, var20, var22); // L: 1070
				} else {
					long var24;
					Object var26;
					if (var6 == 5) { // L: 1073
						var23 = 16; // L: 1074
						var24 = var7.getWallObjectTag(var0, var2, var3); // L: 1075
						if (0L != var24) { // L: 1076
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)null, Tiles.field1007[var5], 0, var23 * Tiles.field1003[var5], var23 * Tiles.field1005[var5], var20, var22); // L: 1080
					} else if (var6 == 6) { // L: 1083
						var23 = 8; // L: 1084
						var24 = var7.getWallObjectTag(var0, var2, var3); // L: 1085
						if (var24 != 0L) { // L: 1086
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)null, 256, var5, var23 * Tiles.field1006[var5], var23 * Tiles.field1002[var5], var20, var22); // L: 1090
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, 256, var29, 0, 0, var20, var22); // L: 1098
					} else if (var6 == 8) { // L: 1101
						var23 = 8; // L: 1102
						var24 = var7.getWallObjectTag(var0, var2, var3); // L: 1103
						if (var24 != 0L) { // L: 1104
							var23 = class162.getObjectDefinition(Decimator.Entity_unpackID(var24)).int2 / 2;
						}
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)var27, 256, var5, var23 * Tiles.field1006[var5], var23 * Tiles.field1002[var5], var20, var22); // L: 1116
					}
				}
			}
		} else {
