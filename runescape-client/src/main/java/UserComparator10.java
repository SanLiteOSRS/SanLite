		...
		if (var0.length == 100 && ByteArrayPool.ByteArrayPool_smallCount < ByteArrayPool.field4159) {
			...
			if (WallObject.ByteArrayPool_arrays != null) {
				for (int var1 = 0; var1 < FloorOverlayDefinition.ByteArrayPool_alternativeSizes.length; ++var1) {
					if (var0.length == FloorOverlayDefinition.ByteArrayPool_alternativeSizes[var1] && class128.ByteArrayPool_altSizeArrayCounts[var1] < WallObject.ByteArrayPool_arrays[var1].length) {
						WallObject.ByteArrayPool_arrays[var1][class128.ByteArrayPool_altSizeArrayCounts[var1]++] = var0;
						return;
					}
				}
			}
