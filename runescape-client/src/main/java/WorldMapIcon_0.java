...
public class WorldMapIcon_0 extends AbstractWorldMapIcon {
   ...
   static class309 privateChatMode;
   @ObfuscatedName("fn")
   @ObfuscatedSignature(
      signature = "Lft;"
   )
   ...
   WorldMapIcon_0(Coord var1, Coord var2, int var3, WorldMapLabel var4) {
      ...
      this.element = var3;
      this.label = var4;
      WorldMapElement var5 = WorldMapData_0.getWorldMapElement(this.getElement());
   ...
   static int method204(int var0, int var1, int var2) {
      if (var2 > 179) {
         var1 /= 2;
      }
   ...
   static int method206(int var0, Script var1, boolean var2) {
      if (var0 == ScriptOpcodes.SOUND_SYNTH) {
         ...
         SoundCache.method2427(Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
         return 1;
      } else if (var0 == ScriptOpcodes.SOUND_JINGLE) {
         Interpreter.Interpreter_intStackSize -= 2;
         MouseRecorder.method1138(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize], Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
         return 1;
      } else {
         return 2;
      }
