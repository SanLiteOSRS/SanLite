...
public class GrandExchangeOfferOwnWorldComparator implements Comparator {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
		...
		if (var2 == 1) {
			...
			var8.packetBuffer.method5587(UserComparator8.baseX * 64 + var0);
			var8.packetBuffer.writeInt(MidiPcmStream.selectedItemWidget);
			var8.packetBuffer.method5587(HealthBar.baseY * 64 + var1);
			var8.packetBuffer.method5588(MouseRecorder.selectedItemSlot);
			...
			var8.packetBuffer.writeShortLE(UserComparator8.baseX * 64 + var0);
			var8.packetBuffer.writeShortLE(HealthBar.baseY * 64 + var1);
			var8.packetBuffer.method5587(var3);
			var8.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 4) {
			Client.mouseCrossX = var6;
			...
			var8.packetBuffer.method5588(UserComparator8.baseX * 64 + var0);
			var8.packetBuffer.method5578(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.writeShortLE(var3);
			var8.packetBuffer.method5588(HealthBar.baseY * 64 + var1);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 5) {
			Client.mouseCrossX = var6;
			Client.mouseCrossY = var7;
			...
			var8.packetBuffer.method5580(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.writeShortLE(UserComparator8.baseX * 64 + var0);
			var8.packetBuffer.writeShortLE(HealthBar.baseY * 64 + var1);
			var8.packetBuffer.writeShortLE(var3);
			Client.packetWriter.addNode(var8);
			...
			var8.packetBuffer.method5587(var3);
			var8.packetBuffer.method5587(HealthBar.baseY * 64 + var1);
			var8.packetBuffer.method5579(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			Client.packetWriter.addNode(var8);
		} else {
			...
			if (var2 == 7) {
				...
				if (var13 != null) {
					...
					var9.packetBuffer.method5580(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
				...
				if (var13 != null) {
					...
					var9.packetBuffer.method5587(var3);
					var9.packetBuffer.method5588(Client.selectedSpellChildIndex);
					var9.packetBuffer.method5599(Clock.selectedSpellWidget);
				...
				if (var13 != null) {
					...
					var9.packetBuffer.writeShortLE(var3);
					var9.packetBuffer.method5579(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					Client.packetWriter.addNode(var9);
				}
			} else if (var2 == 11) {
				var13 = Client.npcs[var3];
				...
				if (var13 != null) {
					...
					var9.packetBuffer.method5579(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					var9.packetBuffer.method5588(var3);
					Client.packetWriter.addNode(var9);
				}
			} else {
				Player var15;
				if (var2 == 14) {
					...
					if (var15 != null) {
						...
						var9.packetBuffer.method5588(var3);
						var9.packetBuffer.method5588(MouseRecorder.selectedItemSlot);
						var9.packetBuffer.writeInt(MidiPcmStream.selectedItemWidget);
						var9.packetBuffer.method5587(Occluder.selectedItemId);
						var9.packetBuffer.method5580(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
						Client.packetWriter.addNode(var9);
					}
				} else if (var2 == 15) {
					...
					if (var15 != null) {
						...
						var9.packetBuffer.method5597(Clock.selectedSpellWidget);
						var9.packetBuffer.method5579(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
						var9.packetBuffer.writeShort(var3);
					...
					var8.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					var8.packetBuffer.method5588(UserComparator8.baseX * 64 + var0);
					var8.packetBuffer.method5599(MidiPcmStream.selectedItemWidget);
					var8.packetBuffer.writeShort(HealthBar.baseY * 64 + var1);
					var8.packetBuffer.method5587(MouseRecorder.selectedItemSlot);
					var8.packetBuffer.method5587(Occluder.selectedItemId);
					Client.packetWriter.addNode(var8);
				} else if (var2 == 17) {
					Client.mouseCrossX = var6;
					Client.mouseCrossY = var7;
					...
					var8.packetBuffer.method5579(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					var8.packetBuffer.writeShortLE(UserComparator8.baseX * 64 + var0);
					var8.packetBuffer.method5588(var3);
					var8.packetBuffer.writeShortLE(HealthBar.baseY * 64 + var1);
					Client.packetWriter.addNode(var8);
				} else if (var2 == 19) {
					Client.mouseCrossX = var6;
					...
					if (var2 == 24) {
						...
						if (var2 == 25) {
							...
							if (var16 != null) {
								...
								class51.method973(var1, var0, UserComparator5.method3504(class195.getWidgetClickMask(var16)), var16.itemId);
								Client.isItemSelected = 0;
								Client.selectedSpellActionName = SoundCache.method2619(var16);
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								var8.packetBuffer.method5597(Clock.selectedSpellWidget);
								var8.packetBuffer.writeShort(var3);
								var8.packetBuffer.writeInt(var1);
								var8.packetBuffer.method5587(var0);
								var8.packetBuffer.method5587(Client.selectedSpellChildIndex);
								Client.packetWriter.addNode(var8);
								Client.field753 = 0;
								Login.field1165 = PacketBufferNode.getWidget(var1);
								Client.field665 = var0;
								...
								var8.packetBuffer.writeInt(var1);
								var8.packetBuffer.writeShortLE(var3);
								var8.packetBuffer.method5588(var0);
								Client.packetWriter.addNode(var8);
								Client.field753 = 0;
								Login.field1165 = PacketBufferNode.getWidget(var1);
								Client.field665 = var0;
								...
								var8.packetBuffer.writeShort(var3);
								var8.packetBuffer.method5599(var1);
								var8.packetBuffer.method5588(var0);
								Client.packetWriter.addNode(var8);
								Client.field753 = 0;
								Login.field1165 = PacketBufferNode.getWidget(var1);
								...
								if (var2 == 39) {
									...
									if (var15 != null) {
										...
										var9.packetBuffer.method5578(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
										var9.packetBuffer.writeShortLE(var3);
										Client.packetWriter.addNode(var9);
									}
								} else if (var2 == 47) {
									...
									label795: {
										...
										var16 = ArchiveLoader.getWidgetChild(var1, var0);
										if (var16 != null) {
											class287.method5334(var3, var1, var0, var16.itemId, var5);
										}
									}
								}
							}
	...
	static final void closeInterface(InterfaceParent var0, boolean var1) {
		...
		var0.remove();
		if (var1) {
			PlayerAppearance.method4138(var2);
		}

		class197.method3792(var2);
