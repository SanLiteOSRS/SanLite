...
public class GrandExchangeOfferOwnWorldComparator implements Comparator {
	...
	static int method1120(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.OC_NAME) { // L: 3428
			...
			Interpreter.Interpreter_stringStack[++class9.Interpreter_stringStackSize - 1] = FileSystem.ItemComposition_get(var3).name; // L: 3430
			return 1; // L: 3431
		} else {
			int var4;
			...
			if (var0 == ScriptOpcodes.OC_OP) { // L: 3433
				...
				var5 = FileSystem.ItemComposition_get(var3); // L: 3437
				...
				var5 = FileSystem.ItemComposition_get(var3); // L: 3446
				...
				Interpreter.Interpreter_intStack[++class12.Interpreter_intStackSize - 1] = FileSystem.ItemComposition_get(var3).price; // L: 3453
				return 1; // L: 3454
				...
				Interpreter.Interpreter_intStack[++class12.Interpreter_intStackSize - 1] = FileSystem.ItemComposition_get(var3).isStackable == 1 ? 1 : 0; // L: 3458
				return 1; // L: 3459
			} else {
				...
				if (var0 == ScriptOpcodes.OC_CERT) { // L: 3461
					...
					var7 = FileSystem.ItemComposition_get(var3); // L: 3463
					...
					var7 = FileSystem.ItemComposition_get(var3); // L: 3470
					...
					Interpreter.Interpreter_intStack[++class12.Interpreter_intStackSize - 1] = FileSystem.ItemComposition_get(var3).isMembersOnly ? 1 : 0; // L: 3477
					return 1; // L: 3478
					...
					var7 = FileSystem.ItemComposition_get(var3); // L: 3482
					...
					var7 = FileSystem.ItemComposition_get(var3); // L: 3489
					...
					if (var0 == ScriptOpcodes.OC_FINDRESET) { // L: 3506
						...
						var4 = FileSystem.ItemComposition_get(var3).getShiftClickIndex(); // L: 3512
						if (var4 == -1) { // L: 3513
