...
public class class39 {
	...
	static final void method616(class194 var0) {
		...
		if (class194.field2358 == var0) {
			...
			if (var17 != null) {
				ObjectComposition var18 = Canvas.getObjectDefinition(var15);
				int var19;
				int var20;
				if (var7 != 1 && var7 != 3) {
					var19 = var18.sizeX;
				...
				if (var29 != null) {
					TileItem.updatePendingSpawn(ItemLayer.Client_plane, var10, var11, var8, -1, 0, 0, var13 + 1, var4 + 1);
					var17.animationCycleStart = var13 + Client.cycle;
					var17.animationCycleEnd = var4 + Client.cycle;
					var17.model0 = var29;
					var17.field661 = var10 * 128 + var19 * 64;
					var17.field653 = var11 * 128 + var20 * 64;
		...
		if (class194.field2357 == var0) {
			...
			if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
				var5 = var5 * 128 + 64;
				var6 = var6 * 128 + 64;
				GraphicsObject var41 = new GraphicsObject(var37, ItemLayer.Client_plane, var5, var6, Language.getTileHeight(var5, var6, ItemLayer.Client_plane) - var7, var2, Client.cycle);
			...
			if (var37 >= 0 && var4 >= 0 && var37 < 104 && var4 < 104) {
				TileItem.updatePendingSpawn(ItemLayer.Client_plane, var37, var4, var9, var5, var7, var8, 0, -1);
			}
			...
			if (var37 >= 0 && var4 >= 0 && var37 < 103 && var4 < 103) {
				if (var9 == 0) {
					BoundaryObject var32 = UserComparator3.scene.method3213(ItemLayer.Client_plane, var37, var4);
					if (var32 != null) {
						var11 = Language.Entity_unpackID(var32.tag);
						if (var7 == 2) {
							var32.entity1 = new DynamicObject(var11, 2, var8 + 4, ItemLayer.Client_plane, var37, var4, var5, false, var32.entity1);
							var32.entity2 = new DynamicObject(var11, 2, var8 + 1 & 3, ItemLayer.Client_plane, var37, var4, var5, false, var32.entity2);
						} else {
							var32.entity1 = new DynamicObject(var11, var7, var8, ItemLayer.Client_plane, var37, var4, var5, false, var32.entity1);
						}
					}
				}

				if (var9 == 1) {
					WallDecoration var42 = UserComparator3.scene.method3214(ItemLayer.Client_plane, var37, var4);
					if (var42 != null) {
						var11 = Language.Entity_unpackID(var42.tag);
						if (var7 != 4 && var7 != 5) {
							if (var7 == 6) {
								var42.entity1 = new DynamicObject(var11, 4, var8 + 4, ItemLayer.Client_plane, var37, var4, var5, false, var42.entity1);
							} else if (var7 == 7) {
								var42.entity1 = new DynamicObject(var11, 4, (var8 + 2 & 3) + 4, ItemLayer.Client_plane, var37, var4, var5, false, var42.entity1);
							} else if (var7 == 8) {
								var42.entity1 = new DynamicObject(var11, 4, var8 + 4, ItemLayer.Client_plane, var37, var4, var5, false, var42.entity1);
								var42.entity2 = new DynamicObject(var11, 4, (var8 + 2 & 3) + 4, ItemLayer.Client_plane, var37, var4, var5, false, var42.entity2);
							}
						} else {
							var42.entity1 = new DynamicObject(var11, 4, var8, ItemLayer.Client_plane, var37, var4, var5, false, var42.entity1);
						}
					}
				}

				if (var9 == 2) {
					GameObject var43 = UserComparator3.scene.method3215(ItemLayer.Client_plane, var37, var4);
					if (var7 == 11) {
						var7 = 10;
					}

					if (var43 != null) {
						var43.entity = new DynamicObject(Language.Entity_unpackID(var43.tag), var7, var8, ItemLayer.Client_plane, var37, var4, var5, false, var43.entity);
					}
				}

				if (var9 == 3) {
					FloorDecoration var44 = UserComparator3.scene.getFloorDecoration(ItemLayer.Client_plane, var37, var4);
					if (var44 != null) {
						var44.entity = new DynamicObject(Language.Entity_unpackID(var44.tag), 22, var8, ItemLayer.Client_plane, var37, var4, var5, false, var44.entity);
					}
				}
			}
			...
			var8 = Client.field734[var6];
			if (var37 >= 0 && var4 >= 0 && var37 < 104 && var4 < 104) {
				TileItem.updatePendingSpawn(ItemLayer.Client_plane, var37, var4, var8, -1, var6, var7, 0, -1);
			}
			...
			if (var37 >= 0 && var4 >= 0 && var37 < 104 && var4 < 104) {
				NodeDeque var31 = Client.groundItems[ItemLayer.Client_plane][var37][var4];
				if (var31 != null) {
			...
			if (class194.field2359 == var0) {
				...
				if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104) {
					...
					var34.id = var6;
					var34.quantity = var2;
					if (Client.groundItems[ItemLayer.Client_plane][var4][var5] == null) {
						Client.groundItems[ItemLayer.Client_plane][var4][var5] = new NodeDeque();
					}

					Client.groundItems[ItemLayer.Client_plane][var4][var5].addFirst(var34);
				...
				if (var37 >= 0 && var4 >= 0 && var37 < 104 && var4 < 104 && var40 >= 0 && var5 >= 0 && var40 < 104 && var5 < 104 && var10 != 65535) {
					...
					var40 = var40 * 128 + 64;
					var5 = var5 * 128 + 64;
					Projectile var35 = new Projectile(var10, ItemLayer.Client_plane, var37, var4, Language.getTileHeight(var37, var4, ItemLayer.Client_plane) - var39, var9 + Client.cycle, var8 + Client.cycle, var13, var11, var7, var6);
					var35.setDestination(var40, var5, Language.getTileHeight(var40, var5, ItemLayer.Client_plane) - var6, var9 + Client.cycle);
				...
				var5 = var1.method5755();
				if (var37 >= 0 && var4 >= 0 && var37 < 104 && var4 < 104) {
					NodeDeque var36 = Client.groundItems[ItemLayer.Client_plane][var37][var4];
					if (var36 != null) {
						...
						if (var36.last() == null) {
							Client.groundItems[ItemLayer.Client_plane][var37][var4] = null;
						}
