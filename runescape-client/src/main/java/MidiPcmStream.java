...
public class MidiPcmStream extends PcmStream {
	...
	int method5640(MusicPatchNode var1) {
		...
		if (var2.field3345 > 0) { // L: 427
			var3 = (int)((double)var3 * Math.pow(0.5D, (double)var2.field3345 * 1.953125E-5D * (double)(var1.field3437 * 128)) + 0.5D); // L: 428
		}
		...
		if (var1.field3440 < 0 || var1.stream != null && !var1.stream.method898()) { // L: 560
			...
			if (var6.field3345 > 0) { // L: 580
				if (var6.field3352 > 0) { // L: 581
					var1.field3437 = var1.field3437 * 231489536 + (int)(128.0D * Math.pow(2.0D, var8 * (double)var6.field3352) + 0.5D) * 2082183296;
				} else {
					var1.field3437 = var1.field3437 * 231489536 + 231489536; // L: 582
				}
			}
