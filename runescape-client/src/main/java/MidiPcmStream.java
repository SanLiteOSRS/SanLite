...
public class MidiPcmStream extends PcmStream {
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) { // L: 481
			int var4 = this.midiFile.division * this.field3394 * 1000000 / (PcmPlayer.field306 * 586337296); // L: 482
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) { // L: 502
			int var2 = this.midiFile.division * this.field3394 * 1000000 / (PcmPlayer.field306 * 586337296); // L: 503
		...
		for (MusicPatchNode var2 = (MusicPatchNode)this.patchStream.queue.last(); var2 != null; var2 = (MusicPatchNode)this.patchStream.queue.previous()) { // L: 236
			if (var1 < 0 || var2.field3467 == var1) { // L: 237
				if (var2.stream != null) { // L: 238
					var2.stream.method916(PcmPlayer.field306 * 586337296 / 100); // L: 239
	...
	int method5789(MusicPatchNode var1) {
		...
		var4 = (int)((double)(var1.rawSound.sampleRate * 256) * Math.pow(2.0D, 3.255208333333333E-4D * (double)var2) / (double)(PcmPlayer.field306 * 586337296) + 0.5D); // L: 426
	...
	boolean method5798(MusicPatchNode var1, int[] var2, int var3, int var4) {
		var1.field3462 = PcmPlayer.field306 * 586337296 / 100; // L: 568
