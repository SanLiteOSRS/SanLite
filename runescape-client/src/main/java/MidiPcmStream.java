...
public class MidiPcmStream extends PcmStream {
	...
	int method5478(MusicPatchNode var1) {
		...
		if (var1.field3373 > 0 && var2.field3286 != null) { // L: 449
			...
			var5 = var2.field3286[var1.field3371 * 2 + 1]; // L: 451
			if (var1.field3371 * 2 < var2.field3286.length - 2) { // L: 452
				var6 = (var2.field3286[var1.field3371 * 2] & 255) << 8; // L: 453
				var7 = (var2.field3286[var1.field3371 * 2 + 2] & 255) << 8; // L: 454
				var5 += (var2.field3286[var1.field3371 * 2 + 3] - var5) * (var4 - var6) / (var7 - var6); // L: 455
			}
	...
	boolean method5487(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3373 < 0 || var1.stream != null && !var1.stream.method905()) { // L: 569
			...
			if (var1.field3373 >= 0 && var6.field3286 != null && (this.field3310[var1.field3361] & 1) == 0 && (var1.field3359 < 0 || var1 != this.field3317[var1.field3361][var1.field3359])) { // L: 599 600
				...
				while (var1.field3371 * 2 < var6.field3286.length - 2 && var1.field3373 > (var6.field3286[var1.field3371 * 2 + 2] & 255) << 8) { // L: 603
					var1.field3371 = var1.field3371 * 4 + 4;
				}

				if (var1.field3371 * 2 == var6.field3286.length - 2) { // L: 604
					var7 = true;
				}
			}
