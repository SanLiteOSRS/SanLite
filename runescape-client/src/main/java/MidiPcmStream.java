...
public class MidiPcmStream extends PcmStream {
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) { // L: 543
			int var4 = this.midiFile.division * this.field3422 * -727379968 / PcmPlayer.field293; // L: 544
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) { // L: 564
			int var2 = this.midiFile.division * this.field3422 * -727379968 / PcmPlayer.field293; // L: 565
	...
	int method5849(MusicPatchNode var1) {
		...
		if (var2.field3392 != null) { // L: 501
			...
			var5 = var2.field3392[var1.field3500 * 4 + 1]; // L: 503
			if (var1.field3500 * 4 < var2.field3392.length - 2) { // L: 504
				var6 = (var2.field3392[var1.field3500 * 4] & 255) << 8; // L: 505
				var7 = (var2.field3392[var1.field3500 * 4 + 2] & 255) << 8; // L: 506
				var5 += (var4 - var6) * (var2.field3392[var1.field3500 * 4 + 3] - var5) / (var7 - var6); // L: 507
			}
	...
	boolean method5816(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3501 < 0 || var1.stream != null && !var1.stream.method920()) { // L: 631
			...
			if (var6.field3392 != null) { // L: 655
				...
				while (var1.field3500 * 4 < var6.field3392.length - 2 && var1.field3505 > (var6.field3392[var1.field3500 * 4 + 2] & 255) << 8) { // L: 658
					var1.field3500 = var1.field3500 * 4 + 2;
				}

				if (var1.field3500 * 4 == var6.field3392.length - 2 && var6.field3392[var1.field3500 * 4 + 1] == 0) { // L: 659
					var7 = true;
				}
			}
