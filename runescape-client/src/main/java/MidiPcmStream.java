...
public class MidiPcmStream extends PcmStream {
   ...
   int field2391 = 1000000;
   @ObfuscatedName("k")
   int[] field2406 = new int[16];
   @ObfuscatedName("u")
   int[] field2393 = new int[16];
   @ObfuscatedName("n")
   int[] field2394 = new int[16];
   @ObfuscatedName("t")
   int[] field2395 = new int[16];
   @ObfuscatedName("q")
   int[] field2413 = new int[16];
   @ObfuscatedName("x")
   int[] field2397 = new int[16];
   @ObfuscatedName("d")
   int[] field2398 = new int[16];
   @ObfuscatedName("f")
   int[] field2399 = new int[16];
   @ObfuscatedName("c")
   int[] field2400 = new int[16];
   @ObfuscatedName("a")
   int[] field2414 = new int[16];
   @ObfuscatedName("w")
   int[] field2403 = new int[16];
   @ObfuscatedName("l")
   int[] field2408 = new int[16];
   @ObfuscatedName("h")
   int[] field2389 = new int[16];
   @ObfuscatedName("v")
   int[] field2409 = new int[16];
   @ObfuscatedName("m")
   ...
   MusicPatchNode[][] field2405 = new MusicPatchNode[16][128];
   @ObfuscatedName("av")
   @ObfuscatedSignature(
      signature = "[[Lgd;"
   )
   MusicPatchNode[][] field2402 = new MusicPatchNode[16][128];
   @ObfuscatedName("am")
   @ObfuscatedSignature(
      signature = "Lga;"
   )
      ...
      if (Client.minimapState == 0 || Client.minimapState == 3) {
         if (!Client.isMenuOpen && (MouseHandler.MouseHandler_lastButton == 1 || !FriendSystem.mouseCam && MouseHandler.MouseHandler_lastButton == 4)) {
            ...
            if (var3.contains(var4, var5)) {
               ...
               PacketBufferNode var13 = MenuAction.method1994(ClientPacket.field2237, Client.packetWriter.isaacCipher);
               ...
               Client.packetWriter.method2177(var13);
