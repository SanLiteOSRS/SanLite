...
public class MidiPcmStream extends PcmStream {
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) {
			int var4 = this.midiFile.division * this.field3180 * -727379968 / PcmPlayer.field268;
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) {
			int var2 = this.midiFile.division * this.field3180 * -727379968 / PcmPlayer.field268;
	...
	void method5303(int var1, int var2) {
		...
		this.field3195[var1] = (int)(2097152.0D * Math.pow(2.0D, 5.4931640625E-4D * (double)var2) + 0.5D);
	}
	...
	int method5246(MusicPatchNode var1) {
		...
		if (var3.field3166 > 0 && (var3.field3161 > 0 || this.field3186[var1.field3248] > 0)) {
			...
			double var6 = Math.sin(0.01227184630308513D * (double)(var1.field3237 & 511));
			var2 += (int)((double)var4 * var6);
		}

		var4 = (int)((double)(var1.rawSound.sampleRate * 256) * Math.pow(2.0D, (double)var2 * 3.255208333333333E-4D) / (double)PcmPlayer.field268 + 0.5D);
	...
	int method5244(MusicPatchNode var1) {
		...
		if (var2.field3162 > 0) {
			var3 = (int)((double)var3 * Math.pow(0.5D, 1.953125E-5D * (double)var1.field3246 * (double)var2.field3162) + 0.5D);
		}
		...
		if (var2.field3160 != null) {
			var4 = var1.field3235;
			var5 = var2.field3160[var1.field3252 * 4 + 1];
			if (var1.field3252 * 4 < var2.field3160.length - 2) {
				var6 = (var2.field3160[var1.field3252 * 4] & 255) << 8;
				var7 = (var2.field3160[var1.field3252 * 4 + 2] & 255) << 8;
				var5 += (var4 - var6) * (var2.field3160[var1.field3252 * 4 + 3] - var5) / (var7 - var6);
			}
		...
		if (var1.field3249 > 0 && var2.field3165 != null) {
			var4 = var1.field3249;
			var5 = var2.field3165[var1.field3250 * 2 + 1];
			if (var1.field3250 * 2 < var2.field3165.length - 2) {
				var6 = (var2.field3165[var1.field3250 * 2] & 255) << 8;
				var7 = (var2.field3165[var1.field3250 * 2 + 2] & 255) << 8;
				var5 += (var4 - var6) * (var2.field3165[var1.field3250 * 2 + 3] - var5) / (var7 - var6);
			}
	...
	boolean method5311(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3249 < 0 || var1.stream != null && !var1.stream.method830()) {
			...
			if (var5 > 0) {
				var5 -= (int)(16.0D * Math.pow(2.0D, (double)this.field3182[var1.field3248] * 4.921259842519685E-4D) + 0.5D);
				if (var5 < 0) {
					var5 = 0;
				}
			...
			double var8 = (double)((var1.field3251 - 60 << 8) + (var1.field3245 * var1.field3244 >> 12)) * 5.086263020833333E-6D;
			if (var6.field3162 > 0) {
				if (var6.field3164 > 0) {
			...
			if (var6.field3160 != null) {
				...
				while (var1.field3252 * 4 < var6.field3160.length - 2 && var1.field3235 > (var6.field3160[var1.field3252 * 4 + 2] & 255) << 8) {
					var1.field3252 = var1.field3252 * 4 + 2;
				}

				if (var1.field3252 * 4 == var6.field3160.length - 2 && var6.field3160[var1.field3252 * 4 + 1] == 0) {
					var7 = true;
				}
			}
			...
			if (var1.field3249 >= 0 && var6.field3165 != null && (this.field3193[var1.field3248] & 1) == 0 && (var1.field3239 < 0 || var1 != this.field3197[var1.field3248][var1.field3239])) {
				...
				while (var1.field3250 * 2 < var6.field3165.length - 2 && var1.field3249 > (var6.field3165[var1.field3250 * 2 + 2] & 255) << 8) {
					var1.field3250 = var1.field3250 * 4 + 4;
				}

				if (var1.field3250 * 2 == var6.field3165.length - 2) {
					var7 = true;
				}
			}
	...
	static void method5366(int var0, String var1) {
		...
		for (int var6 = 0; var6 < var2; ++var6) {
			...
			if (var7 != null && var7 != GrandExchangeEvents.localPlayer && var7.username != null && var7.username.equals(var5)) {
				...
				if (var0 == 1) {
					var8 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2913, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method7710(var3[var6]);
					var8.packetBuffer.method7701(0);
					Client.packetWriter.addNode(var8);
				} else if (var0 == 4) {
					var8 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2939, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method7804(0);
					var8.packetBuffer.writeShort(var3[var6]);
					Client.packetWriter.addNode(var8);
				} else if (var0 == 6) {
					var8 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2931, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method7712(var3[var6]);
					var8.packetBuffer.writeByte(0);
					Client.packetWriter.addNode(var8);
				} else if (var0 == 7) {
					var8 = WorldMapSprite.getPacketBufferNode(ClientPacket.field2923, Client.packetWriter.isaacCipher);
					var8.packetBuffer.writeShort(var3[var6]);
					var8.packetBuffer.method7701(0);
					Client.packetWriter.addNode(var8);
				}
