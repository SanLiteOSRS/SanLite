...
public class MidiPcmStream extends PcmStream {
	...
	int method3818(MusicPatchNode var1) {
		...
		if (var1.field2459 > 0 && var2.field2398 != null) {
			var4 = var1.field2459;
			var5 = var2.field2398[var1.field2448 * 2 + 1];
			if (var1.field2448 * 2 < var2.field2398.length - 2) {
				var6 = (var2.field2398[var1.field2448 * 2] & 255) << 8;
				var7 = (var2.field2398[var1.field2448 * 2 + 2] & 255) << 8;
				var5 += (var4 - var6) * (var2.field2398[var1.field2448 * 2 + 3] - var5) / (var7 - var6);
			}
	...
	boolean method3884(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field2459 < 0 || var1.stream != null && !var1.stream.method2671()) {
			...
			if (var1.field2459 >= 0 && var6.field2398 != null && (this.field2428[var1.field2452] & 1) == 0 && (var1.field2467 < 0 || var1 != this.field2435[var1.field2452][var1.field2467])) {
				...
				while (var1.field2448 * 2 < var6.field2398.length - 2 && var1.field2459 > (var6.field2398[var1.field2448 * 2 + 2] & 255) << 8) {
					var1.field2448 = var1.field2448 * 4 + 4;
				}

				if (var1.field2448 * 2 == var6.field2398.length - 2) {
					var7 = true;
				}
			}
