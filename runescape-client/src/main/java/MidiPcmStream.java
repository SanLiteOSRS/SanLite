...
public class MidiPcmStream extends PcmStream {
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) { // L: 481
			int var4 = this.midiFile.division * this.field3264 * -727379968 / PcmPlayer.field300; // L: 482
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) { // L: 502
			int var2 = this.midiFile.division * this.field3264 * -727379968 / PcmPlayer.field300; // L: 503
	...
	int method5105(MusicPatchNode var1) {
		...
		if (var2.field3232 != null) { // L: 439
			...
			var5 = var2.field3232[var1.field3315 * 2 + 1]; // L: 441
			if (var1.field3315 * 2 < var2.field3232.length - 2) { // L: 442
				var6 = (var2.field3232[var1.field3315 * 2] & 255) << 8; // L: 443
				var7 = (var2.field3232[var1.field3315 * 2 + 2] & 255) << 8; // L: 444
				var5 += (var2.field3232[var1.field3315 * 2 + 3] - var5) * (var4 - var6) / (var7 - var6); // L: 445
			}
		...
		if (var1.field3316 > 0 && var2.field3223 != null) { // L: 449
			...
			var5 = var2.field3223[var1.field3317 * 4 + 1]; // L: 451
			if (var1.field3317 * 4 < var2.field3223.length - 2) { // L: 452
				var6 = (var2.field3223[var1.field3317 * 4] & 255) << 8; // L: 453
				var7 = (var2.field3223[var1.field3317 * 4 + 2] & 255) << 8; // L: 454
				var5 += (var4 - var6) * (var2.field3223[var1.field3317 * 4 + 3] - var5) / (var7 - var6); // L: 455
			}
		...
		if (var1.field3316 < 0 || var1.stream != null && !var1.stream.method815()) { // L: 569
			...
			if (var6.field3226 > 0) { // L: 589
				if (var6.field3227 > 0) { // L: 590
					var1.field3313 = var1.field3313 * 1251753984 + (int)(128.0D * Math.pow(2.0D, (double)var6.field3227 * var8) + 0.5D) * 1251753984;
				} else {
					var1.field3313 = var1.field3313 * 1251753984 + 1310720000; // L: 591
				}
			}
			...
			if (var6.field3232 != null) { // L: 593
				...
				while (var1.field3315 * 2 < var6.field3232.length - 2 && var1.field3314 > (var6.field3232[var1.field3315 * 2 + 2] & 255) << 8) { // L: 596
					var1.field3315 = var1.field3315 * 4 + 4;
				}

				if (var1.field3315 * 2 == var6.field3232.length - 2 && var6.field3232[var1.field3315 * 2 + 1] == 0) { // L: 597
					var7 = true;
				}
			}
			...
			if (var1.field3316 >= 0 && var6.field3223 != null && (this.field3247[var1.field3308] & 1) == 0 && (var1.field3319 < 0 || var1 != this.field3255[var1.field3308][var1.field3319])) { // L: 599 600
				...
				while (var1.field3317 * 4 < var6.field3223.length - 2 && var1.field3316 > (var6.field3223[var1.field3317 * 4 + 2] & 255) << 8) { // L: 603
					var1.field3317 = var1.field3317 * 4 + 2;
				}

				if (var1.field3317 * 4 == var6.field3223.length - 2) { // L: 604
					var7 = true;
				}
			}
