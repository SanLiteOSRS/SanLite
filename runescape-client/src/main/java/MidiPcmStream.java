...
public class MidiPcmStream extends PcmStream {
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) { // L: 489
			int var4 = this.midiFile.division * this.field3409 * -727379968 / PcmPlayer.field291; // L: 490
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) { // L: 510
			int var2 = this.midiFile.division * this.field3409 * -727379968 / PcmPlayer.field291; // L: 511
	...
	int method5762(MusicPatchNode var1) {
		...
		if (var1.field3489 > 0 && var2.field3381 != null) { // L: 457
			...
			var5 = var2.field3381[var1.field3495 * 2 + 1]; // L: 459
			if (var1.field3495 * 2 < var2.field3381.length - 2) { // L: 460
				var6 = (var2.field3381[var1.field3495 * 2] & 255) << 8; // L: 461
				var7 = (var2.field3381[var1.field3495 * 2 + 2] & 255) << 8; // L: 462
				var5 += (var2.field3381[var1.field3495 * 2 + 3] - var5) * (var4 - var6) / (var7 - var6); // L: 463
			}
	...
	boolean method5771(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3489 < 0 || var1.stream != null && !var1.stream.method951()) { // L: 577
			...
			if (var1.field3489 >= 0 && var6.field3381 != null && (this.field3421[var1.field3490] & 1) == 0 && (var1.field3479 < 0 || var1 != this.field3428[var1.field3490][var1.field3479])) { // L: 607 608
				...
				while (var1.field3495 * 2 < var6.field3381.length - 2 && var1.field3489 > (var6.field3381[var1.field3495 * 2 + 2] & 255) << 8) { // L: 611
					var1.field3495 = var1.field3495 * 4 + 4;
				}

				if (var1.field3495 * 2 == var6.field3381.length - 2) { // L: 612
					var7 = true;
				}
			}
