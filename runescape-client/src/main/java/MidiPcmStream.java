...
public class MidiPcmStream extends PcmStream {
	...
	public synchronized void method3890(int var1) {
		this.field2399 = var1;
	}
	...
	public synchronized boolean loadMusicTrack(MusicTrack var1, AbstractArchive var2, SoundCache var3, int var4) {
		...
		for (ByteArrayNode var7 = (ByteArrayNode)var1.table.first(); var7 != null; var7 = (ByteArrayNode)var1.table.next()) {
			...
			if (!var9.method3982(var3, var7.byteArray, var6)) {
				var5 = false;
			}
		}
	...
	@ObfuscatedName("o")
	protected synchronized int vmethod4011() {
		return 0;
	}
	...
	public synchronized void setMusicTrack(MusicTrack var1, boolean var2) {
		...
		this.field2411 = this.midiFile.method3935(this.trackLength);
	}
	...
	public synchronized void method3847(int var1, int var2) {
		this.method3804(var1, var2);
	}
	...
	void method3804(int var1, int var2) {
		...
		if (var9 != null) {
			...
			if (var8 != null) {
				...
				if (this.field2401[var1] == 0) {
					var6.stream = RawPcmStream.method2720(var8, this.method3882(var6), this.method3823(var6), this.method3821(var6));
				} else {
					var6.stream = RawPcmStream.method2720(var8, this.method3882(var6), 0, this.method3821(var6));
					this.method3833(var6, var9.field2460[var2] < 0);
				}
	...
	void method3833(MusicPatchNode var1, boolean var2) {
	...
	void method3891(int var1, int var2, int var3) {
	}
	...
	void method3810(int var1, int var2) {
	}
	...
	void method3897(int var1, int var2) {
	...
	void method3812(int var1) {
		for (MusicPatchNode var2 = (MusicPatchNode)this.patchStream.queue.last(); var2 != null; var2 = (MusicPatchNode)this.patchStream.queue.previous()) {
			if (var1 < 0 || var2.field2425 == var1) {
				if (var2.stream != null) {
					var2.stream.method2675(PcmPlayer.PcmPlayer_sampleRate * 22050 / 100);
					if (var2.stream.method2669()) {
	...
	void method3817(int var1) {
		...
		if (var2 == 128) {
			...
			var4 = var1 >> 8 & 127;
			var5 = var1 >> 16 & 127;
			this.method3891(var3, var4, var5);
		} else if (var2 == 176) {
			var3 = var1 & 15;
			var4 = var1 >> 8 & 127;
			var5 = var1 >> 16 & 127;
			...
			if (var4 == 17) {
				this.method3818(var3, (var5 << 7) + (this.field2392[var3] & -16257));
			}

			if (var4 == 49) {
				this.method3818(var3, var5 + (this.field2392[var3] & -128));
			}

		} else if (var2 == 192) {
			var3 = var1 & 15;
			var4 = var1 >> 8 & 127;
			this.method3916(var3, var4 + this.field2393[var3]);
		} else if (var2 == 208) {
			var3 = var1 & 15;
			var4 = var1 >> 8 & 127;
			this.method3810(var3, var4);
		} else if (var2 == 224) {
			var3 = var1 & 15;
			var4 = (var1 >> 8 & 127) + (var1 >> 9 & 16256);
			this.method3897(var3, var4);
		} else {
			var2 = var1 & 255;
			if (var2 == 255) {
				this.method3814();
	...
	int method3823(MusicPatchNode var1) {
		...
		if (var2.field2364 != null) {
			var4 = var1.field2431;
			var5 = var2.field2364[var1.field2427 * 2 + 1];
			if (var1.field2427 * 2 < var2.field2364.length - 2) {
				var6 = (var2.field2364[var1.field2427 * 2] & 255) << 8;
				var7 = (var2.field2364[var1.field2427 * 2 + 2] & 255) << 8;
				var5 += (var4 - var6) * (var2.field2364[var1.field2427 * 2 + 3] - var5) / (var7 - var6);
			}
	...
	int method3821(MusicPatchNode var1) {
	...
	void method3893() {
		...
		long var3;
		for (var3 = this.field2411; var2 == this.trackLength; var3 = this.midiFile.method3935(var2)) {
	...
	boolean method3828(MusicPatchNode var1) {
		if (var1.stream == null) {
			if (var1.field2428 >= 0) {
				var1.remove();
	...
	boolean method3829(MusicPatchNode var1, int[] var2, int var3, int var4) {
		var1.field2433 = PcmPlayer.PcmPlayer_sampleRate * 22050 / 100;
		if (var1.field2428 < 0 || var1.stream != null && !var1.stream.method2742()) {
			...
			var1.stream.method2696(this.method3882(var1));
			...
			if (var6.field2364 != null) {
				...
				while (var1.field2427 * 2 < var6.field2364.length - 2 && var1.field2431 > (var6.field2364[var1.field2427 * 2 + 2] & 255) << 8) {
					var1.field2427 = var1.field2427 * 4 + 4;
				}

				if (var1.field2427 * 2 == var6.field2364.length - 2 && var6.field2364[var1.field2427 * 2 + 1] == 0) {
					var7 = true;
				}
			}
			...
			if (var7) {
				var1.stream.method2675(var1.field2433);
				if (var2 != null) {
				...
				var1.stream.method2664(var1.field2433, this.method3823(var1), this.method3821(var1));
				return false;
			}
		} else {
			var1.method3922();
