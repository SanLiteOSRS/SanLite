...
public class MidiPcmStream extends PcmStream {
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) {
			int var4 = this.midiFile.division * this.field2462 * -727379968 / class237.field3113;
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) {
			int var2 = this.midiFile.division * this.field2462 * -727379968 / class237.field3113;
	...
	int method3958(MusicPatchNode var1) {
		...
		if (var2.field2424 != null) {
			var4 = var1.field2488;
			var5 = var2.field2424[var1.field2489 * 2 + 1];
			if (var1.field2489 * 2 < var2.field2424.length - 2) {
				var6 = (var2.field2424[var1.field2489 * 2] & 255) << 8;
				var7 = (var2.field2424[var1.field2489 * 2 + 2] & 255) << 8;
				var5 += (var2.field2424[var1.field2489 * 2 + 3] - var5) * (var4 - var6) / (var7 - var6);
			}
		...
		if (var1.field2490 > 0 && var2.field2429 != null) {
			var4 = var1.field2490;
			var5 = var2.field2429[var1.field2493 * 2 + 1];
			if (var1.field2493 * 2 < var2.field2429.length - 2) {
				var6 = (var2.field2429[var1.field2493 * 2] & 255) << 8;
				var7 = (var2.field2429[var1.field2493 * 2 + 2] & 255) << 8;
				var5 += (var2.field2429[var1.field2493 * 2 + 3] - var5) * (var4 - var6) / (var7 - var6);
			}
	...
	boolean method3897(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field2490 < 0 || var1.stream != null && !var1.stream.method2690()) {
			...
			if (var6.field2424 != null) {
				...
				while (var1.field2489 * 2 < var6.field2424.length - 2 && var1.field2488 > (var6.field2424[var1.field2489 * 2 + 2] & 255) << 8) {
					var1.field2489 = var1.field2489 * 4 + 4;
				}

				if (var1.field2489 * 2 == var6.field2424.length - 2 && var6.field2424[var1.field2489 * 2 + 1] == 0) {
					var7 = true;
				}
			}
			...
			if (var1.field2490 >= 0 && var6.field2429 != null && (this.field2460[var1.field2479] & 1) == 0 && (var1.field2480 < 0 || var1 != this.field2467[var1.field2479][var1.field2480])) {
				...
				while (var1.field2493 * 2 < var6.field2429.length - 2 && var1.field2490 > (var6.field2429[var1.field2493 * 2 + 2] & 255) << 8) {
					var1.field2493 = var1.field2493 * 4 + 4;
				}

				if (var1.field2493 * 2 == var6.field2429.length - 2) {
					var7 = true;
				}
			}
