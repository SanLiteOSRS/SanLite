...
public class MidiPcmStream extends PcmStream {
	...
	int method6021(MusicPatchNode var1) {
		...
		if (var1.field3498 > 0 && var2.field3411 != null) { // L: 502
			...
			var5 = var2.field3411[var1.field3519 * 4 + 1]; // L: 504
			if (var1.field3519 * 4 < var2.field3411.length - 2) { // L: 505
				var6 = (var2.field3411[var1.field3519 * 4] & 255) << 8; // L: 506
				var7 = (var2.field3411[var1.field3519 * 4 + 2] & 255) << 8; // L: 507
				var5 += (var2.field3411[var1.field3519 * 4 + 3] - var5) * (var4 - var6) / (var7 - var6); // L: 508
			}
	...
	boolean method6042(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3498 < 0 || var1.stream != null && !var1.stream.method1008()) { // L: 622
			...
			if (var1.field3498 >= 0 && var6.field3411 != null && (this.field3450[var1.field3515] & 1) == 0 && (var1.field3502 < 0 || var1 != this.field3444[var1.field3515][var1.field3502])) { // L: 652 653
				...
				while (var1.field3519 * 4 < var6.field3411.length - 2 && var1.field3498 > (var6.field3411[var1.field3519 * 4 + 2] & 255) << 8) { // L: 656
					var1.field3519 = var1.field3519 * 4 + 2;
				}

				if (var1.field3519 * 4 == var6.field3411.length - 2) { // L: 657
					var7 = true;
				}
			}
