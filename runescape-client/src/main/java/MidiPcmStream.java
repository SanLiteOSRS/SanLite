...
public class MidiPcmStream extends PcmStream {
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) {
			int var4 = this.midiFile.division * this.field2908 * 1000000 / (class276.field3287 * 332661776);
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) {
			int var2 = this.midiFile.division * this.field2908 * 1000000 / (class276.field3287 * 332661776);
	...
	void method4636(int var1) {
		for (MusicPatchNode var2 = (MusicPatchNode)this.patchStream.queue.last(); var2 != null; var2 = (MusicPatchNode)this.patchStream.queue.previous()) {
			if (var1 < 0 || var2.field2970 == var1) {
				if (var2.stream != null) {
					var2.stream.method811(class276.field3287 * 332661776 / 100);
	...
	int method4671(MusicPatchNode var1) {
		...
		var4 = (int)((double)(var1.rawSound.sampleRate * 256) * Math.pow(2.0D, 3.255208333333333E-4D * (double)var2) / (double)(class276.field3287 * 332661776) + 0.5D);
	...
	int method4690(MusicPatchNode var1) {
		...
		if (var2.field2896 != null) {
			var4 = var1.field2987;
			var5 = var2.field2896[var1.field2980 * 4 + 1];
			if (var1.field2980 * 4 < var2.field2896.length - 2) {
				var6 = (var2.field2896[var1.field2980 * 4] & 255) << 8;
				var7 = (var2.field2896[var1.field2980 * 4 + 2] & 255) << 8;
				var5 += (var4 - var6) * (var2.field2896[var1.field2980 * 4 + 3] - var5) / (var7 - var6);
			}
		...
		if (var1.field2985 > 0 && var2.field2888 != null) {
			var4 = var1.field2985;
			var5 = var2.field2888[var1.field2981 * 4 + 1];
			if (var1.field2981 * 4 < var2.field2888.length - 2) {
				var6 = (var2.field2888[var1.field2981 * 4] & 255) << 8;
				var7 = (var2.field2888[var1.field2981 * 4 + 2] & 255) << 8;
				var5 += (var2.field2888[var1.field2981 * 4 + 3] - var5) * (var4 - var6) / (var7 - var6);
			}
	...
	boolean method4668(MusicPatchNode var1, int[] var2, int var3, int var4) {
		var1.field2982 = class276.field3287 * 332661776 / 100;
		if (var1.field2985 < 0 || var1.stream != null && !var1.stream.method860()) {
			...
			if (var6.field2896 != null) {
				...
				while (var1.field2980 * 4 < var6.field2896.length - 2 && var1.field2987 > (var6.field2896[var1.field2980 * 4 + 2] & 255) << 8) {
					var1.field2980 = var1.field2980 * 4 + 2;
				}

				if (var1.field2980 * 4 == var6.field2896.length - 2 && var6.field2896[var1.field2980 * 4 + 1] == 0) {
					var7 = true;
				}
			}
			...
			if (var1.field2985 >= 0 && var6.field2888 != null && (this.field2929[var1.field2970] & 1) == 0 && (var1.field2971 < 0 || var1 != this.field2920[var1.field2970][var1.field2971])) {
				...
				while (var1.field2981 * 4 < var6.field2888.length - 2 && var1.field2985 > (var6.field2888[var1.field2981 * 4 + 2] & 255) << 8) {
					var1.field2981 = var1.field2981 * 4 + 2;
				}

				if (var1.field2981 * 4 == var6.field2888.length - 2) {
					var7 = true;
				}
			}
