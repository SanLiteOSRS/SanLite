...
public class MidiPcmStream extends PcmStream {
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) {
			int var4 = this.midiFile.division * this.field3113 * -727379968 / PcmPlayer.field305;
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) {
			int var2 = this.midiFile.division * this.field3113 * -727379968 / PcmPlayer.field305;
	...
	void method5045(int var1, int var2) {
		...
		this.field3129[var1] = (int)(2097152.0D * Math.pow(2.0D, 5.4931640625E-4D * (double)var2) + 0.5D);
	}
	...
	int method5058(MusicPatchNode var1) {
		...
		if (var3.field3100 > 0 && (var3.field3102 > 0 || this.field3121[var1.field3181] > 0)) {
			...
			double var6 = Math.sin((double)(var1.field3188 & 511) * 0.01227184630308513D);
			var2 += (int)((double)var4 * var6);
		}

		var4 = (int)((double)(var1.rawSound.sampleRate * 256) * Math.pow(2.0D, 3.255208333333333E-4D * (double)var2) / (double)PcmPlayer.field305 + 0.5D);
	...
	int method5152(MusicPatchNode var1) {
		...
		if (var2.field3095 > 0) {
			var3 = (int)((double)var3 * Math.pow(0.5D, (double)var2.field3095 * 1.953125E-5D * (double)var1.field3182) + 0.5D);
		}
		...
		if (var2.field3094 != null) {
			var4 = var1.field3183;
			var5 = var2.field3094[var1.field3176 * 2 + 1];
			if (var1.field3176 * 2 < var2.field3094.length - 2) {
				var6 = (var2.field3094[var1.field3176 * 2] & 255) << 8;
				var7 = (var2.field3094[var1.field3176 * 2 + 2] & 255) << 8;
				var5 += (var4 - var6) * (var2.field3094[var1.field3176 * 2 + 3] - var5) / (var7 - var6);
			}
		...
		if (var1.field3186 > 0 && var2.field3099 != null) {
			var4 = var1.field3186;
			var5 = var2.field3099[var1.field3175 * 4 + 1];
			if (var1.field3175 * 4 < var2.field3099.length - 2) {
				var6 = (var2.field3099[var1.field3175 * 4] & 255) << 8;
				var7 = (var2.field3099[var1.field3175 * 4 + 2] & 255) << 8;
				var5 += (var2.field3099[var1.field3175 * 4 + 3] - var5) * (var4 - var6) / (var7 - var6);
			}
	...
	boolean method5068(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3186 < 0 || var1.stream != null && !var1.stream.method826()) {
			...
			if (var5 > 0) {
				var5 -= (int)(16.0D * Math.pow(2.0D, 4.921259842519685E-4D * (double)this.field3137[var1.field3181]) + 0.5D);
				if (var5 < 0) {
					var5 = 0;
				}
			...
			double var8 = (double)((var1.field3189 - 60 << 8) + (var1.field3177 * var1.field3187 >> 12)) * 5.086263020833333E-6D;
			if (var6.field3095 > 0) {
				if (var6.field3098 > 0) {
			...
			if (var6.field3094 != null) {
				...
				while (var1.field3176 * 2 < var6.field3094.length - 2 && var1.field3183 > (var6.field3094[var1.field3176 * 2 + 2] & 255) << 8) {
					var1.field3176 = var1.field3176 * 4 + 4;
				}

				if (var1.field3176 * 2 == var6.field3094.length - 2 && var6.field3094[var1.field3176 * 2 + 1] == 0) {
					var7 = true;
				}
			}
			...
			if (var1.field3186 >= 0 && var6.field3099 != null && (this.field3124[var1.field3181] & 1) == 0 && (var1.field3171 < 0 || var1 != this.field3131[var1.field3181][var1.field3171])) {
				...
				while (var1.field3175 * 4 < var6.field3099.length - 2 && var1.field3186 > (var6.field3099[var1.field3175 * 4 + 2] & 255) << 8) {
					var1.field3175 = var1.field3175 * 4 + 2;
				}

				if (var1.field3175 * 4 == var6.field3099.length - 2) {
					var7 = true;
				}
			}
