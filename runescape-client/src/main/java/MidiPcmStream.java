...
public class MidiPcmStream extends PcmStream {
	...
	int method6186(MusicPatchNode var1) {
		...
		if (var1.field3559 > 0 && var2.field3445 != null) { // L: 502
			...
			var5 = var2.field3445[var1.field3560 * 2 + 1]; // L: 504
			if (var1.field3560 * 2 < var2.field3445.length - 2) { // L: 505
				var6 = (var2.field3445[var1.field3560 * 2] & 255) << 8; // L: 506
				var7 = (var2.field3445[var1.field3560 * 2 + 2] & 255) << 8; // L: 507
				var5 += (var4 - var6) * (var2.field3445[var1.field3560 * 2 + 3] - var5) / (var7 - var6); // L: 508
			}
	...
	boolean method6106(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3559 < 0 || var1.stream != null && !var1.stream.method988()) { // L: 622
			...
			if (var1.field3559 >= 0 && var6.field3445 != null && (this.field3481[var1.field3557] & 1) == 0 && (var1.field3553 < 0 || var1 != this.field3488[var1.field3557][var1.field3553])) { // L: 652 653
				...
				while (var1.field3560 * 2 < var6.field3445.length - 2 && var1.field3559 > (var6.field3445[var1.field3560 * 2 + 2] & 255) << 8) { // L: 656
					var1.field3560 = var1.field3560 * 4 + 4;
				}

				if (var1.field3560 * 2 == var6.field3445.length - 2) { // L: 657
					var7 = true;
				}
			}
