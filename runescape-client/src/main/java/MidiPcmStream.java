...
public class MidiPcmStream extends PcmStream {
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) { // L: 543
			int var4 = this.midiFile.division * this.field3410 * -727379968 / PcmPlayer.field314; // L: 544
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) { // L: 564
			int var2 = this.midiFile.division * this.field3410 * -727379968 / PcmPlayer.field314; // L: 565
	...
	int method5940(MusicPatchNode var1) {
		...
		if (var2.field3381 != null) { // L: 501
			...
			var5 = var2.field3381[var1.field3498 * 2 + 1]; // L: 503
			if (var1.field3498 * 2 < var2.field3381.length - 2) { // L: 504
				var6 = (var2.field3381[var1.field3498 * 2] & 255) << 8; // L: 505
				var7 = (var2.field3381[var1.field3498 * 2 + 2] & 255) << 8; // L: 506
				var5 += (var4 - var6) * (var2.field3381[var1.field3498 * 2 + 3] - var5) / (var7 - var6); // L: 507
			}
	...
	boolean method5852(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3499 < 0 || var1.stream != null && !var1.stream.method903()) { // L: 631
			...
			if (var6.field3381 != null) { // L: 655
				...
				while (var1.field3498 * 2 < var6.field3381.length - 2 && var1.field3497 > (var6.field3381[var1.field3498 * 2 + 2] & 255) << 8) { // L: 658
					var1.field3498 = var1.field3498 * 4 + 4;
				}

				if (var1.field3498 * 2 == var6.field3381.length - 2 && var6.field3381[var1.field3498 * 2 + 1] == 0) { // L: 659
					var7 = true;
				}
			}
