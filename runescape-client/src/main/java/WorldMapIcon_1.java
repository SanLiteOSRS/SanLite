...
public class WorldMapIcon_1 extends AbstractWorldMapIcon {
   ...
   void init() {
      ...
      this.label = this.region.createMapLabel(WorldMapData_0.getWorldMapElement(this.element));
      WorldMapElement var1 = WorldMapData_0.getWorldMapElement(this.getElement());
   ...
   static void runScript(ScriptEvent var0, int var1) {
      ...
      if (DirectByteArrayCopier.isWorldMapEvent(var0.type)) {
         ...
         WorldMapElement var4 = WorldMapData_0.getWorldMapElement(class162.worldMapEvent.mapElement);
