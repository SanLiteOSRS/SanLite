...
public class WorldMapData_0 extends AbstractWorldMapData {
	...
	void init(Buffer var1) {
		...
		if (var2 != WorldMapID.field2849.value) { // L: 10
			...
			super.groupId = var1.method7652(); // L: 19
			super.fileId = var1.method7652(); // L: 20
		}
	} // L: 21
	...
	void readGeography(Buffer var1) {
		...
		super.field2814 = new byte[super.planes][64][64]; // L: 28
		super.field2808 = new byte[super.planes][64][64]; // L: 29
		super.decorations = new WorldMapDecoration[super.planes][64][64][]; // L: 30
		int var2 = var1.readUnsignedByte(); // L: 31
		if (var2 != class238.field2843.value) { // L: 32
