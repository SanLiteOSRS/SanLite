...
public class WorldMapData_0 extends AbstractWorldMapData {
	...
	@ObfuscatedSignature(
		descriptor = "(Ltc;I)V",
		garbageValue = "1690222917"
	)
	@Export("init")
	void init(Buffer var1) {
		int var2 = var1.readUnsignedByte(); // L: 9
		if (var2 != WorldMapID.field3028.value) { // L: 10
			...
			super.groupId = var1.method9095(); // L: 19
			super.fileId = var1.method9095(); // L: 20
		}
	} // L: 21
