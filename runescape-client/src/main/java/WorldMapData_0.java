...
public class WorldMapData_0 extends AbstractWorldMapData {
	...
	public static void method237() {
		try {
			File var0 = new File(ItemLayer.userHomeDirectory, "random.dat");
			int var2;
			if (var0.exists()) {
	...
	static void playSong(int var0) {
		if (var0 == -1 && !Client.field883) {
			...
			SecureRandomCallable.playMusicTrack(2, class217.archive6, var0, 0, Timer.clientPreferences.musicVolume, false);
		}
		...
		if (var3 > Client.npcCount) {
			...
			for (var4 = 0; var4 < var3; ++var4) {
				...
				if (var7 == 0) {
					...
					if (var8 == 0) {
						...
						var6.npcCycle = Client.cycle;
						var9 = var2.readBits(3);
						var6.method2102(var9, (byte)2);
						var10 = var2.readBits(3);
						var6.method2102(var10, (byte)2);
			...
			for (var14 = 0; var14 < Client.field826; ++var14) {
				...
				if ((var5 & 8) != 0) {
					...
					var16 = var1.readInt();
					var15.field979 = var16 >> 16;
					var15.field978 = (var16 & 65535) + Client.cycle;
				...
				if ((var5 & 2) != 0) {
					var16 = var1.method5582();
					var7 = var1.method5539();
					var8 = var15.x - (var16 - NetFileRequest.baseX * 64 - NetFileRequest.baseX * 64) * 64;
