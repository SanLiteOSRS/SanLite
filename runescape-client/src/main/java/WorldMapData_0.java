...
public class WorldMapData_0 extends AbstractWorldMapData {
	...
	static final void method4844(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7, int var8) {
		...
		if (var2 == 1) { // L: 8979
			...
			var9.packetBuffer.writeInt(class358.selectedSpellWidget); // L: 9733
			...
			if (var2 == 7) {
				...
				if (var14 != null) { // L: 9065
					...
					var10.packetBuffer.writeInt(ModeWhere.selectedItemWidget); // L: 9074
				...
				if (var14 != null) { // L: 9640
					...
					var10.packetBuffer.method8601(class358.selectedSpellWidget); // L: 9650
				...
				if (var2 == 14) {
					...
					if (var16 != null) { // L: 9200
						...
						var10.packetBuffer.method8601(ModeWhere.selectedItemWidget); // L: 9210
					...
					var9.packetBuffer.method8601(class358.selectedSpellWidget); // L: 9042
					...
					if (var2 == 24) {
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								var9.packetBuffer.method8601(var1); // L: 9052
								...
								var9.packetBuffer.writeInt(class358.selectedSpellWidget); // L: 9543
								...
								var9.packetBuffer.method8601(var1); // L: 9507
								...
								var9.packetBuffer.method8601(var1); // L: 9530
								...
								var9.packetBuffer.method8601(var1); // L: 9250
								...
								if (var2 == 39) {
									...
									var9.packetBuffer.writeInt(var1); // L: 9261
									...
									var9.packetBuffer.method8601(var1); // L: 9761
										...
										if (var2 != 57) {
											if (var2 == 58) {
												...
												if (var17 != null) { // L: 9099
													...
													var10.packetBuffer.method8601(class358.selectedSpellWidget); // L: 9112
