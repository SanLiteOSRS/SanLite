...
public class class463 implements class462 {
	...
	public class461 vmethod8417() {
		return class461.field4777; // L: 26
	}
	...
	public byte[] vmethod8412() throws UnsupportedEncodingException {
		return this.field4779 == null ? new byte[0] : this.field4779.toString().getBytes("UTF-8"); // L: 59 60 62
	}
	...
	void method8396(String var1) throws UnsupportedEncodingException {
		try {
			if (var1.charAt(0) == '{') { // L: 36
				this.field4779 = new JSONObject(var1); // L: 37
			} else {
				...
				this.field4779 = new JSONObject(); // L: 41
				this.field4779.put("arrayValues", var2); // L: 42
			}
