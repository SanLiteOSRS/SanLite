...
public class class298 {
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.spotAnimation >= Client.cycle) { // L: 4146
			...
			var9 = var0.field1155 * -1321988096 + var0.field1203 * 128; // L: 4148
			var4 = var0.field1155 * -1321988096 + var0.field1205 * 128; // L: 4149
			...
			if (var10) { // L: 4166
				...
				int var5 = var0.field1155 * -1321988096 + var0.field1203 * 128; // L: 4169
				int var6 = var0.field1155 * -1321988096 + var0.field1205 * 128; // L: 4170
				int var7 = var0.field1155 * -1321988096 + var0.field1173 * 128; // L: 4171
				int var8 = var0.field1155 * -1321988096 + var0.field1206 * 128; // L: 4172
		...
		if (var0.x < 128 || var0.y < 128 || var0.x >= 13184 || var0.y >= 13184) { // L: 4181
			...
			var0.x = var0.field1155 * -1321988096 + var0.pathX[0] * 128; // L: 4186
			var0.y = var0.field1155 * -1321988096 + var0.pathY[0] * 128; // L: 4187
		...
		if (Projectile.localPlayer == var0 && (var0.x < 1536 || var0.y < 1536 || var0.x >= 11776 || var0.y >= 11776)) { // L: 4190 4191
			...
			var0.x = var0.field1155 * -1321988096 + var0.pathX[0] * 128; // L: 4196
			var0.y = var0.field1155 * -1321988096 + var0.pathY[0] * 128; // L: 4197
