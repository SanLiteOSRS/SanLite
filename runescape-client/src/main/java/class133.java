...
class class133 implements Callable {
	...
	public Object call() {
		this.this$0.method3069(this.val$p, this.val$version); // L: 45
		return null; // L: 46
	}
	...
	public static boolean method3039(int var0) {
		return var0 >= WorldMapDecorationType.field3801.id && var0 <= WorldMapDecorationType.field3786.id || var0 == WorldMapDecorationType.field3799.id; // L: 43
	}
}
