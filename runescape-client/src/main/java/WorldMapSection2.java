...
public class WorldMapSection2 implements WorldMapSection {
	...
	public void expandBounds(WorldMapArea var1) {
		if (var1.regionLowX > this.field2770) { // L: 22
	...
	public boolean containsPosition(int var1, int var2) {
		return var1 >> 6 >= this.field2770 && var1 >> 6 <= this.field2775 && var2 >> 6 >= this.field2774 && var2 >> 6 <= this.field2776; // L: 38
	}
	...
	public int[] getBorderTileLengths(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) { // L: 43
			...
			int[] var4 = new int[]{this.field2770 * 64 - this.regionStartX * 64 + var2, var3 + (this.field2774 * 64 - this.regionStartY * 64)}; // L: 46 47 48
			return var4; // L: 49
		}
	}
	...
	public Coord coord(int var1, int var2) {
		if (!this.containsPosition(var1, var2)) { // L: 54
			...
			int var3 = this.regionStartX * 64 - this.field2770 * 64 + var1; // L: 57
			int var4 = this.regionStartY * 64 - this.field2774 * 64 + var2; // L: 58
	...
	public void read(Buffer var1) {
		...
		this.field2770 = var1.readUnsignedShort(); // L: 70
		this.field2774 = var1.readUnsignedShort(); // L: 71
		this.field2775 = var1.readUnsignedShort(); // L: 72
		this.field2776 = var1.readUnsignedShort(); // L: 73
		this.postRead(); // L: 74
	} // L: 75
	...
	public static GameBuild method4746(int var0) {
		GameBuild[] var1 = new GameBuild[]{GameBuild.BUILDLIVE, GameBuild.RC, GameBuild.WIP, GameBuild.LIVE}; // L: 21
