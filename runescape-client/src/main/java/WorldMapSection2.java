...
public class WorldMapSection2 implements WorldMapSection {
	...
	public int[] getBorderTileLengths(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) {
			...
			int[] var4 = new int[]{this.field1942 * 64 - this.regionStartX * 64 + var2, var3 + (this.field1938 * 64 - this.regionStartY * 64)};
			return var4;
		}
	}
	...
	public Coord coord(int var1, int var2) {
		if (!this.containsPosition(var1, var2)) {
			...
			int var4 = this.regionStartY * 64 - this.field1938 * 64 + var2;
	...
	static int method3276(int var0, Script var1, boolean var2) {
		...
		if (var0 == 6600) {
			...
			int var15 = GrandExchangeOfferNameComparator.baseX * 64 + (MouseHandler.localPlayer.x >> 7);
			int var8 = NPC.baseY * 64 + (MouseHandler.localPlayer.y >> 7);
