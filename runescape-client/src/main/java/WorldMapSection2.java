...
public class WorldMapSection2 implements WorldMapSection {
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.field1182 >= Client.cycle) { // L: 3924
			...
			if (var0.field1183 >= Client.cycle) { // L: 3925
				...
				if (var11) { // L: 3936
					...
					var5 = var0.field1178 * 128 + var0.field1190 * 373555200; // L: 3939
					int var13 = var0.field1127 * 128 + var0.field1190 * 373555200; // L: 3940
					var7 = var0.field1179 * 128 + var0.field1190 * 373555200; // L: 3941
					var8 = var0.field1181 * 128 + var0.field1190 * 373555200; // L: 3942
				...
				if (var0.pathLength == 0) { // L: 3952
					...
					label510: {
						...
						var16 = var0.x; // L: 3967
						var3 = var0.y; // L: 3968
						var4 = var0.pathX[var0.pathLength - 1] * 128 + var0.field1190 * 373555200; // L: 3969
						var5 = var0.pathY[var0.pathLength - 1] * 128 + var0.field1190 * 373555200; // L: 3970
		...
		if (var0.x < 128 || var0.y < 128 || var0.x >= 13184 || var0.y >= 13184) { // L: 4056
			...
			var0.x = var0.pathX[0] * 128 + var0.field1190 * 373555200; // L: 4061
			var0.y = var0.pathY[0] * 128 + var0.field1190 * 373555200; // L: 4062
		...
		if (ScriptFrame.localPlayer == var0 && (var0.x < 1536 || var0.y < 1536 || var0.x >= 11776 || var0.y >= 11776)) { // L: 4065 4066
			...
			var0.x = var0.pathX[0] * 128 + var0.field1190 * 373555200; // L: 4071
			var0.y = var0.pathY[0] * 128 + var0.field1190 * 373555200; // L: 4072
