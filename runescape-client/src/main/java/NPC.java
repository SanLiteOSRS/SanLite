...
public final class NPC extends Actor {
   ...
   protected final Model getModel() {
      if (this.definition == null) {
         ...
         SequenceDefinition var2 = super.movementSequence != -1 && (super.movementSequence != super.readySequence || var1 == null) ? Widget.getSequenceDefinition(super.movementSequence) : null;
         ...
         if (var3 == null) {
            ...
            if (super.spotAnimation != -1 && super.spotAnimationFrame != -1) {
               Model var4 = HealthBarUpdate.getSpotAnimationDefinition(super.spotAnimation).getModel(super.spotAnimationFrame);
               if (var4 != null) {
   ...
   static final InterfaceParent method1967(int var0, int var1, int var2) {
      ...
      WorldMapSectionType.method238(var1);
      Widget var4 = WorldMapElement.getWidget(var0);
      FriendSystem.method1822(var4);
