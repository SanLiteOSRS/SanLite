...
public final class NPC extends Actor {
		...
		if (this.definition == null) { // L: 96
			...
			if (var3 == null) { // L: 100
				...
				if (super.spotAnimation != -1 && super.spotAnimationFrame != -1) { // L: 103
					...
					if (var4 != null) { // L: 105
						var4.offsetBy(0, -super.field1143, 0); // L: 106
	...
	final void method2362(int var1, int var2, boolean var3) {
		...
		super.x = super.pathX[0] * 128 + super.field1205 * 1526988800; // L: 91
		super.y = super.pathY[0] * 128 + super.field1205 * 1526988800; // L: 92
	} // L: 93
