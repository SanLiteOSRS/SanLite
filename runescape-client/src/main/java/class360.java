...
public class class360 {
	...
	static final void method6393() {
		...
		int var0 = SecureRandomCallable.baseX * 64 + (ModelData0.localPlayer.x >> 7); // L: 5448
		int var1 = GrandExchangeOfferOwnWorldComparator.baseY * 64 + (ModelData0.localPlayer.y >> 7); // L: 5449
