...
public class HealthBar extends Node {
	...
	@Export("isEmpty")
	boolean isEmpty() {
		return this.updates.method6721(); // L: 55
	}
	...
	static final void method2478() {
		for (int var0 = 0; var0 < Players.Players_count; ++var0) { // L: 12492
			Player var1 = Client.players[Players.Players_indices[var0]]; // L: 12493
			var1.clearIsInFriendsChat(); // L: 12494
		}
