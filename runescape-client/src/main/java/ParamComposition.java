...
public class ParamComposition extends DualNode {
	...
	static int method3370(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.ENUM_STRING) {
			...
			EnumComposition var10 = NameableContainer.getEnum(var3);
			...
			if (var0 == ScriptOpcodes.ENUM_GETOUTPUTCOUNT) {
				var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
				EnumComposition var4 = NameableContainer.getEnum(var3);
			...
			EnumComposition var7 = NameableContainer.getEnum(var5);
