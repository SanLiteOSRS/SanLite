...
public class class318 {
	...
	public class318(AbstractArchive var1, String var2, String var3, int var4, boolean var5) {
		...
		this.field3507 = var1.getGroupId(var2); // L: 21
		this.field3509 = var1.getFileId(this.field3507, var3); // L: 22
		this.method6067(var1, this.field3507, this.field3509, var4, var5); // L: 23
	} // L: 24
	...
	public class318(AbstractArchive var1, int var2, int var3, int var4, boolean var5) {
		this.field3507 = -1; // L: 8
		this.field3509 = -1; // L: 9
		this.field3510 = 0; // L: 10
		this.field3511 = 0.0F; // L: 11
		this.field3512 = false; // L: 12
		this.field3515 = false; // L: 15
		this.method6067(var1, var2, var3, var4, var5); // L: 27
	} // L: 28
	...
	void method6067(AbstractArchive var1, int var2, int var3, int var4, boolean var5) {
		this.field3514 = var1; // L: 31
		this.field3507 = var2; // L: 32
		this.field3509 = var3; // L: 33
		this.field3510 = var4; // L: 34
		this.field3512 = var5; // L: 35
	} // L: 36
}
