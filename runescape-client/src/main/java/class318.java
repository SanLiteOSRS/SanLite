	...
	static final void method5839(PacketBuffer var0) {
		for (int var1 = 0; var1 < Client.field713; ++var1) {
			...
			if ((var4 & 1) != 0) {
				...
				var7 = var3.x - (var5 - WorldMapSectionType.baseX * 64 - WorldMapSectionType.baseX * 64) * 64;
				var8 = var3.y - (var6 - PlayerComposition.baseY * 64 - PlayerComposition.baseY * 64) * 64;
				if (var7 != 0 || var8 != 0) {
