...
public class AudioFilter {
   @ObfuscatedName("n")
   static float[][] field1475 = new float[2][8];
   @ObfuscatedName("t")
   @Export("coefficients")
   ...
   int[] pairs = new int[2];
   @ObfuscatedName("i")
   int[][][] field1467 = new int[2][2][4];
   @ObfuscatedName("k")
   int[][][] field1470 = new int[2][2][4];
   @ObfuscatedName("u")
   int[] field1469 = new int[2];
   ...
   @ObfuscatedName("j")
   static float method2623(float var0) {
