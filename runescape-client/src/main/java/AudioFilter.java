...
public class AudioFilter {
	...
	@ObfuscatedName("a")
	float method2810(int var1, int var2, float var3) {
	...
	@ObfuscatedName("n")
	float method2807(int var1, int var2, float var3) {
	...
	int compute(int var1, float var2) {
		...
		if (this.pairs[var1] == 0) {
			...
			var3 = this.method2810(var1, 0, var2);
			field1460[var1][0] = -2.0F * var3 * (float)Math.cos((double)this.method2807(var1, 0, var2));
			field1460[var1][1] = var3 * var3;

			float[] var10000;
			int var4;
			for (var4 = 1; var4 < this.pairs[var1]; ++var4) {
				var3 = this.method2810(var1, var4, var2);
				float var5 = -2.0F * var3 * (float)Math.cos((double)this.method2807(var1, var4, var2));
	...
	final void method2805(Buffer var1, SoundEnvelope var2) {
