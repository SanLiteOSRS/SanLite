...
public class AudioFilter {
	...
	static {
		field1512 = new float[2][8];
		coefficients = new int[2][8];
	}

	AudioFilter() {
		this.pairs = new int[2];
		this.field1509 = new int[2][2][4];
	...
	float method2813(int var1, int var2, float var3) {
		float var4 = (float)this.field1509[var1][0][var2] + var3 * (float)(this.field1509[var1][1][var2] - this.field1509[var1][0][var2]);
		var4 *= 1.2207031E-4F;
	...
	int compute(int var1, float var2) {
		...
		if (this.pairs[var1] == 0) {
			...
			var3 = this.method2806(var1, 0, var2);
			field1512[var1][0] = -2.0F * var3 * (float)Math.cos((double)this.method2813(var1, 0, var2));
			field1512[var1][1] = var3 * var3;

			float[] var10000;
			int var4;
			for (var4 = 1; var4 < this.pairs[var1]; ++var4) {
				var3 = this.method2806(var1, var4, var2);
				float var5 = -2.0F * var3 * (float)Math.cos((double)this.method2813(var1, var4, var2));
				float var6 = var3 * var3;
				field1512[var1][var4 * 2 + 1] = field1512[var1][var4 * 2 - 1] * var6;
				field1512[var1][var4 * 2] = field1512[var1][var4 * 2 - 1] * var5 + field1512[var1][var4 * 2 - 2] * var6;
		...
		if (var3 != 0) {
			...
			for (var5 = 0; var5 < 2; ++var5) {
				for (var6 = 0; var6 < this.pairs[var5]; ++var6) {
					this.field1509[var5][0][var6] = var1.readUnsignedShort();
			...
			for (var5 = 0; var5 < 2; ++var5) {
				for (var6 = 0; var6 < this.pairs[var5]; ++var6) {
					if ((var4 & 1 << var5 * 4 << var6) != 0) {
						this.field1509[var5][1][var6] = var1.readUnsignedShort();
						this.field1510[var5][1][var6] = var1.readUnsignedShort();
					} else {
						this.field1509[var5][1][var6] = this.field1509[var5][0][var6];
