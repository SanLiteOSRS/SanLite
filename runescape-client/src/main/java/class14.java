	...
	static void readPlayerUpdate(PacketBuffer var0, int var1) {
		...
		if (var3 == 0) { // L: 414
			if (var2) { // L: 415
				...
				Players.Players_regions[var1] = (var4.plane << 28) + (WorldMapLabelSize.baseY * 64 + var4.pathY[0] >> 13) + (class28.baseX * 64 + var4.pathX[0] >> 13 << 14); // L: 420
			...
			if (var3 == 1) { // L: 428
				...
				if (var5 == 0) { // L: 539
					...
					var10 = (class28.baseX * 64 + var8 + var4.pathX[0] & 16383) - class28.baseX * 64; // L: 569
					var11 = (WorldMapLabelSize.baseY * 64 + var9 + var4.pathY[0] & 16383) - WorldMapLabelSize.baseY * 64; // L: 570
									...
									if (var10.type == 4) { // L: 10345
										...
										if (var39 == null) { // L: 10347
											...
											if (var10.isIf3 && var10.itemId != -1) { // L: 10362
												ItemComposition var45 = EnumComposition.ItemComposition_get(var10.itemId); // L: 10363
										...
										if (var10.type == 6) { // L: 10414
											...
											if (var10.itemId != -1) { // L: 10421
												var33 = EnumComposition.ItemComposition_get(var10.itemId); // L: 10422
												...
												for (var21 = 0; var21 < var10.rawHeight; ++var21) { // L: 10467
													for (var22 = 0; var22 < var10.rawWidth; ++var22) { // L: 10468
														if (var10.itemIds[var20] > 0) { // L: 10469
															var33 = EnumComposition.ItemComposition_get(var10.itemIds[var20] - 1); // L: 10470
															String var34;
