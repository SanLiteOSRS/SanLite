...
public class NPCDefinition extends DualNode {
   ...
   void decodeNext(Buffer var1, int var2) {
      ...
      if (var2 == 1) {
         ...
         this.field3467 = var1.readByte() * 5;
      } else if (var2 == 102) {
      ...
      if (this.transforms != null) {
         ...
         if (var5 == null) {
            ...
            for(var9 = 0; var9 < this.models.length; ++var9) {
               var8[var9] = ModelData.method2703(NpcDefinition_modelArchive, this.models[var9], 0);
            }
            ...
            var5 = var11.toModel(this.field3466 + 64, this.field3467 + 850, -30, -50, -30);
      ...
      if (this.transforms != null) {
         ...
         if (var5) {
            ...
            for(int var3 = 0; var3 < this.field3448.length; ++var3) {
               var6[var3] = ModelData.method2703(NpcDefinition_modelArchive, this.field3448[var3], 0);
            }
