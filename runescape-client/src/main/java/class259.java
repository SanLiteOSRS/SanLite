...
public class class259 {
	...
	public static PacketBufferNode method5125(int var0, String var1, Language var2, int var3) {
		PacketBufferNode var4 = DevicePcmPlayerProvider.getPacketBufferNode(ClientPacket.field2985, Client.packetWriter.isaacCipher); // L: 17
		...
		WorldMapScaleHandler.method5045(var4.packetBuffer, var1); // L: 167
		if (var0 == class296.field3514.rsOrdinal()) { // L: 168
			var4.packetBuffer.writeByte(var3); // L: 169
		}

		var4.packetBuffer.method7761(var4.packetBuffer.offset - var5); // L: 171
		return var4; // L: 172
	}
}
