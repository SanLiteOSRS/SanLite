...
public class class259 {
	...
	static final void method5338(int var0, int var1, int var2, int var3, int var4, int var5, int var6, Scene var7, CollisionMap var8) {
		...
		if (var6 == 22) { // L: 1053
			...
			var7.newGroundObject(var0, var2, var3, var17, (Renderable)var30, var20, var22); // L: 1057
			...
			if (var6 >= 12) { // L: 1069
				...
				var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1013[var5], 0, var20, var22); // L: 1081
				...
				var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1005[var5], 0, var20, var22); // L: 1089
				...
				if (var6 == 2) { // L: 1093
					...
					var7.newWallObject(var0, var2, var3, var17, (Renderable)var31, (Renderable)var25, Tiles.field1013[var5], Tiles.field1013[var23], var20, var22); // L: 1105
					...
					var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1005[var5], 0, var20, var22); // L: 1113
					...
					var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field1013[var5], 0, 0, 0, var20, var22); // L: 1129
				} else {
					long var24;
					Object var26;
					if (var6 == 5) { // L: 1132
						var23 = 16; // L: 1133
						var24 = var7.getWallObjectTag(var0, var2, var3); // L: 1134
						if (var24 != 0L) { // L: 1135
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)null, Tiles.field1013[var5], 0, var23 * Tiles.field1006[var5], var23 * Tiles.field1000[var5], var20, var22); // L: 1139
					} else if (var6 == 6) { // L: 1142
						var23 = 8; // L: 1143
						var24 = var7.getWallObjectTag(var0, var2, var3); // L: 1144
						if (0L != var24) { // L: 1145
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)null, 256, var5, var23 * Tiles.field1003[var5], var23 * Tiles.field1009[var5], var20, var22); // L: 1149
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, 256, var29, 0, 0, var20, var22); // L: 1157
					} else if (var6 == 8) { // L: 1160
						var23 = 8; // L: 1161
						var24 = var7.getWallObjectTag(var0, var2, var3); // L: 1162
						if (0L != var24) { // L: 1163
							var23 = PlayerComposition.getObjectDefinition(class156.Entity_unpackID(var24)).int2 / 2;
						}
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)var27, 256, var5, var23 * Tiles.field1003[var5], var23 * Tiles.field1009[var5], var20, var22); // L: 1175
					}
				}
			}
		} else {
