...
public class Model extends Entity {
	...
	void calculateBoundingBox(int var1) {
		if (this.xMidOffset == -1) {
			...
			for (int var10 = 0; var10 < this.verticesCount; ++var10) {
				int var11 = Rasterizer3D.method3094(this.verticesX[var10], this.verticesZ[var10], var8, var9);
				int var12 = this.verticesY[var10];
				int var13 = Rasterizer3D.method3095(this.verticesX[var10], this.verticesZ[var10], var8, var9);
				if (var11 < var2) {
					var2 = var11;
				}
	...
	@ObfuscatedName("b")
	public final void method2997(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		field1691[0] = -1;
	...
	@ObfuscatedName("ad")
	final void method3001(int var1) {
		if (field1683[var1]) {
			...
			if (this.faceTextures != null && this.faceTextures[var1] != -1) {
				...
				Rasterizer3D.method3087(modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], field1709[this.faceColors1[var1]]);
			} else {
				Rasterizer3D.method3085(modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], this.faceColors1[var1], this.faceColors2[var1], this.faceColors3[var1]);
			}
	...
	@ObfuscatedName("ag")
	final void method3002(int var1) {
		...
		if (var4 == 3) {
			...
			if (this.faceTextures != null && this.faceTextures[var1] != -1) {
				...
				if (this.faceColors3[var1] == -1) {
					Rasterizer3D.method3140(var14, var15, var16, var11, var12, var13, this.faceColors1[var1], this.faceColors1[var1], this.faceColors1[var1], field1674[var17], field1674[var18], field1674[var19], field1702[var17], field1702[var18], field1702[var19], field1689[var17], field1689[var18], field1689[var19], this.faceTextures[var1]);
				} else {
					Rasterizer3D.method3140(var14, var15, var16, var11, var12, var13, field1700[0], field1700[1], field1700[2], field1674[var17], field1674[var18], field1674[var19], field1702[var17], field1702[var18], field1702[var19], field1689[var17], field1689[var18], field1689[var19], this.faceTextures[var1]);
				}
			} else if (this.faceColors3[var1] == -1) {
				Rasterizer3D.method3087(var14, var15, var16, var11, var12, var13, field1709[this.faceColors1[var1]]);
			} else {
				Rasterizer3D.method3085(var14, var15, var16, var11, var12, var13, field1700[0], field1700[1], field1700[2]);
			}
		}
		...
		if (var4 == 4) {
			...
			if (this.faceTextures != null && this.faceTextures[var1] != -1) {
				...
				if (this.faceColors3[var1] == -1) {
					Rasterizer3D.method3140(var14, var15, var16, var11, var12, var13, this.faceColors1[var1], this.faceColors1[var1], this.faceColors1[var1], field1674[var17], field1674[var18], field1674[var19], field1702[var17], field1702[var18], field1702[var19], field1689[var17], field1689[var18], field1689[var19], var21);
					Rasterizer3D.method3140(var14, var16, field1699[3], var11, var13, field1698[3], this.faceColors1[var1], this.faceColors1[var1], this.faceColors1[var1], field1674[var17], field1674[var18], field1674[var19], field1702[var17], field1702[var18], field1702[var19], field1689[var17], field1689[var18], field1689[var19], var21);
				} else {
					Rasterizer3D.method3140(var14, var15, var16, var11, var12, var13, field1700[0], field1700[1], field1700[2], field1674[var17], field1674[var18], field1674[var19], field1702[var17], field1702[var18], field1702[var19], field1689[var17], field1689[var18], field1689[var19], var21);
					Rasterizer3D.method3140(var14, var16, field1699[3], var11, var13, field1698[3], field1700[0], field1700[2], field1700[3], field1674[var17], field1674[var18], field1674[var19], field1702[var17], field1702[var18], field1702[var19], field1689[var17], field1689[var18], field1689[var19], var21);
				}
			} else if (this.faceColors3[var1] == -1) {
				var17 = field1709[this.faceColors1[var1]];
				Rasterizer3D.method3087(var14, var15, var16, var11, var12, var13, var17);
				Rasterizer3D.method3087(var14, var16, field1699[3], var11, var13, field1698[3], var17);
			} else {
				Rasterizer3D.method3085(var14, var15, var16, var11, var12, var13, field1700[0], field1700[1], field1700[2]);
				Rasterizer3D.method3085(var14, var16, field1699[3], var11, var13, field1698[3], field1700[0], field1700[2], field1700[3]);
			}
		}
								...
								if (field1704) {
									...
									if (!GrandExchangeOfferOwnWorldComparator.method1376()) {
										...
										if (!ViewportMouse.ViewportMouse_false0) {
											...
											int var46 = Rasterizer3D.method3098(var43, var40, var37, var36);
											var54 = Rasterizer3D.method3075(var43, var40, var37, var36);
											var43 = var46;
											var46 = Rasterizer3D.method3098(var45, var41, var37, var36);
											var55 = Rasterizer3D.method3075(var45, var41, var37, var36);
											var45 = var46;
											var46 = Rasterizer3D.method3101(var42, var54, var39, var38);
											var54 = Rasterizer3D.method3097(var42, var54, var39, var38);
											var42 = var46;
											var46 = Rasterizer3D.method3101(var44, var55, var39, var38);
											var55 = Rasterizer3D.method3097(var44, var55, var39, var38);
