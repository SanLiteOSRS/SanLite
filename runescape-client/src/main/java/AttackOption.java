...
public enum AttackOption implements MouseWheel {
	...
	static final void method2292(PacketBuffer var0) {
		for (int var1 = 0; var1 < Players.Players_pendingUpdateCount; ++var1) {
			...
			if ((var4 & 2048) != 0) {
				var3.field1153 = var0.method7400();
				var3.field1144 = var0.method7400();
				var3.field1147 = var0.readByte();
				var3.field1156 = var0.method7401();
			...
			int var13;
			if ((var4 & 32) != 0) {
				var6 = var0.method7414();
				PlayerType var7 = (PlayerType)class140.findEnumerated(MidiPcmStream.PlayerType_values(), var0.method7398());
				boolean var8 = var0.method7398() == 1;
			...
			if ((var4 & 8192) != 0) {
				...
				var3.field1166 = var0.method7365();
				var3.field1167 = (byte)var0.method7398();
			}
			...
			if ((var4 & 2) != 0) {
				...
				if (var14 > 0) {
					for (var19 = 0; var19 < var14; ++var19) {
						...
						if (var10 != 32767) {
							var20 = var0.readUShortSmart();
							var17 = var0.method7467();
							var13 = var10 > 0 ? var0.method7399() : var17;
			...
			if ((var4 & 8) != 0) {
				var3.field1138 = var0.method7408();
