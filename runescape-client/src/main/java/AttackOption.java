...
public enum AttackOption implements Enumerated {
		...
		if (var3 != null) {
			...
			try {
				...
				try {
					...
					PlayerComposition.RunException_sendStackTrace(var24.toString(), var27);
				}
			} finally {
	...
	@ObfuscatedName("x")
	@ObfuscatedSignature(
		signature = "(Lkj;B)Ljava/lang/String;",
		garbageValue = "23"
	)
	...
	static void method2138() {
		if (PlayerComposition.localPlayer.x >> 7 == Client.destinationX && PlayerComposition.localPlayer.y >> 7 == Client.destinationY) {
