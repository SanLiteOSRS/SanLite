...
public final class GraphicsObject extends Renderable {
	...
	public static HealthBarDefinition method1647(int var0) {
		HealthBarDefinition var1 = (HealthBarDefinition)HealthBarDefinition.field1579.get((long)var0);
		if (var1 != null) {
			return var1;
		} else {
			...
			HealthBarDefinition.field1579.put(var1, (long)var0);
			return var1;
		}
	}
	...
	static void drawWorldSelectScreen(Font var0, Font var1) {
		...
		if (WorldMapAreaData.worldSelectBackSprites != null) {
			...
			if (class137.worldSelectLeftSprite != null && Login.worldSelectPage > 0) {
				class137.worldSelectLeftSprite.drawAt(8, Client.canvasHeight / 2 - class137.worldSelectLeftSprite.subHeight * -1478377216 / 2);
			}

			if (BuddyRankComparator.worldSelectRightSprite != null && Login.worldSelectPage < Login.worldSelectPagesCount) {
				BuddyRankComparator.worldSelectRightSprite.drawAt(class68.canvasWidth - BuddyRankComparator.worldSelectRightSprite.subWidth - 8, Client.canvasHeight / 2 - BuddyRankComparator.worldSelectRightSprite.subHeight * -1478377216 / 2);
			}
