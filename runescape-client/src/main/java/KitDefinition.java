...
public class KitDefinition extends DualNode {
	...
	@ObfuscatedName("kr")
	@ObfuscatedSignature(
		descriptor = "(Ljava/lang/String;Lme;I)Ljava/lang/String;",
		garbageValue = "-315909130"
	)
	static String method3729(String var0, Widget var1) {
		if (var0.indexOf("%") != -1) { // L: 11002
			for (int var2 = 1; var2 <= 5; ++var2) { // L: 11003
				while (true) {
					int var3 = var0.indexOf("%" + var2); // L: 11005
					if (var3 == -1) { // L: 11006
						break;
					}

					var0 = var0.substring(0, var3) + class300.method5771(WorldMapLabelSize.method5145(var1, var2 - 1)) + var0.substring(var3 + 2); // L: 11007
				}
			}
		}
	...
	@ObfuscatedSignature(
		...
		garbageValue = "-1517425890"
	)
	@Export("Clan_joinChat")
	static final void Clan_joinChat(String var0) {
		if (!var0.equals("")) { // L: 12604
			PacketBufferNode var1 = class217.getPacketBufferNode(ClientPacket.field3159, Client.packetWriter.isaacCipher); // L: 12606
			var1.packetBuffer.writeByte(Player.stringCp1252NullTerminatedByteSize(var0)); // L: 12607
			var1.packetBuffer.writeStringCp1252NullTerminated(var0); // L: 12608
			Client.packetWriter.addNode(var1); // L: 12609
		}
	} // L: 12610
}
