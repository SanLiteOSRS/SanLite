...
public class ClientPreferences {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.hintArrowType == 2) { // L: 4563
			class82.worldToScreen((Client.hintArrowX - class128.baseX * 64 << 7) + Client.hintArrowSubX * 4096, Client.hintArrowSubY * 64 + (Client.hintArrowY - WorldMapData_1.baseY * 64 << 7), Client.hintArrowHeight * 2); // L: 4564
