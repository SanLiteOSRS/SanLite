...
public class ClientPreferences {
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.field1183 >= Client.cycle) { // L: 3857
			...
			if (var0.pathLength == 0) { // L: 3861
				...
				label700: {
					...
					var11 = var0.x; // L: 3876
					var3 = var0.y; // L: 3877
					var4 = var0.field1131 * -360448000 + var0.pathX[var0.pathLength - 1] * 128; // L: 3878
					int var5 = var0.pathY[var0.pathLength - 1] * 128 + var0.field1131 * -360448000; // L: 3879
		...
		if (var0.x < 128 || var0.y < 128 || var0.x >= 13184 || var0.y >= 13184) { // L: 3965
			...
			var0.x = var0.field1131 * -360448000 + var0.pathX[0] * 128; // L: 3970
			var0.y = var0.pathY[0] * 128 + var0.field1131 * -360448000; // L: 3971
		...
		if (class67.localPlayer == var0 && (var0.x < 1536 || var0.y < 1536 || var0.x >= 11776 || var0.y >= 11776)) { // L: 3974 3975
			...
			var0.x = var0.pathX[0] * 128 + var0.field1131 * -360448000; // L: 3980
			var0.y = var0.field1131 * -360448000 + var0.pathY[0] * 128; // L: 3981
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.hintArrowType == 2) { // L: 4563
			class82.worldToScreen(Client.hintArrowSubX * 64 + (Client.hintArrowX - class128.baseX * 64 << 7), Client.hintArrowSubY * 64 + (Client.hintArrowY - WorldMapData_1.baseY * 64 << 7), Client.hintArrowHeight * 4); // L: 4564
