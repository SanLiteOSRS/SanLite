...
public class Players {
	...
	static {
		field1323 = new byte[2048]; // L: 18
		field1314 = new class202[2048]; // L: 19
		field1315 = new Buffer[2048]; // L: 20
		...
		field1325 = new Buffer(new byte[5000]); // L: 30
	}
	...
	public static void method2587(AbstractArchive var0) {
		GrandExchangeOfferTotalQuantityComparator.VarbitDefinition_archive = var0; // L: 28
	} // L: 29
}
