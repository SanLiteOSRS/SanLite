...
public class Players {
   @ObfuscatedName("i")
   static byte[] field1221 = new byte[2048];
   @ObfuscatedName("k")
   static byte[] field1230 = new byte[2048];
   @ObfuscatedName("u")
   @ObfuscatedSignature(
      signature = "[Lky;"
   )
   static Buffer[] field1219 = new Buffer[2048];
   @ObfuscatedName("n")
   @ObfuscatedGetter(
      intValue = 1067165743
   )
   ...
   static Buffer field1233 = new Buffer(new byte[5000]);
