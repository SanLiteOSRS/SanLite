			...
			try {
				...
				while (true) {
					...
					if (var6 == 4) { // L: 10919
						...
						if (var11 != -1 && (!FileSystem.ItemComposition_get(var11).isMembersOnly || Client.isMembersWorld)) { // L: 10924
					...
					if (var6 == 10) { // L: 10939
						...
						if (var11 != -1 && (!FileSystem.ItemComposition_get(var11).isMembersOnly || Client.isMembersWorld)) { // L: 10944
