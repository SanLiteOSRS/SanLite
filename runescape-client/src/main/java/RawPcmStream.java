...
public class RawPcmStream extends PcmStream {
	...
	RawPcmStream(RawSound var1, int var2, int var3, int var4) {
		...
		this.field375 = var1.field299; // L: 54
		this.field366 = var2; // L: 55
		this.field379 = var3; // L: 56
		this.field367 = var4; // L: 57
	...
	RawPcmStream(RawSound var1, int var2, int var3) {
		...
		this.field375 = var1.field299; // L: 42
		this.field366 = var2; // L: 43
		this.field379 = var3; // L: 44
		this.field367 = 8192; // L: 45
	...
	@ObfuscatedName("m")
	void method904() {
		this.field369 = this.field379; // L: 73
		this.field368 = method961(this.field379, this.field367); // L: 74
		this.field371 = method990(this.field379, this.field367); // L: 75
	} // L: 76
	...
	protected int vmethod5753() {
		return this.field379 == 0 && this.field376 == 0 ? 0 : 1; // L: 208 209
	}

	@ObfuscatedName("u")
	@Export("fill")
	public synchronized void fill(int[] var1, int var2, int var3) {
		if (this.field379 == 0 && this.field376 == 0) { // L: 213
			...
			if (this.field365 < 0) { // L: 225
				if (this.field366 <= 0) { // L: 226
					this.method958(); // L: 228
					this.remove(); // L: 229
					return; // L: 230
				}
			...
			if (this.field365 >= var7) { // L: 233
				if (this.field366 >= 0) { // L: 234
					this.method958(); // L: 236
					this.remove(); // L: 237
					return; // L: 238
				}
			...
			if (this.numLoops < 0) { // L: 241
				if (this.field375) { // L: 242
					if (this.field366 < 0) { // L: 243
						...
						this.field366 = -this.field366; // L: 247
					}
					...
					while (true) {
						...
						this.field366 = -this.field366; // L: 253
						...
						this.field366 = -this.field366; // L: 257
					}
				} else if (this.field366 < 0) { // L: 260
					while (true) {
				...
				if (this.numLoops > 0) { // L: 275
					if (this.field375) { // L: 276
						label127: {
							if (this.field366 < 0) { // L: 277
								...
								this.field366 = -this.field366; // L: 281
							...
							do {
								...
								this.field366 = -this.field366; // L: 288
								...
								this.field366 = -this.field366; // L: 293
							} while(--this.numLoops != 0); // L: 294
						}
					} else {
						int var10;
						if (this.field366 < 0) { // L: 297
							while (true) {
	...
	public synchronized void skip(int var1) {
		if (this.field376 > 0) { // L: 345
			if (var1 >= this.field376) { // L: 346
				if (this.field379 == Integer.MIN_VALUE) { // L: 347
					this.field379 = 0; // L: 348
					this.field371 = 0; // L: 349
					this.field368 = 0; // L: 350
					this.field369 = 0; // L: 351
					this.remove(); // L: 352
					var1 = this.field376; // L: 353
				}

				this.field376 = 0; // L: 355
				this.method904(); // L: 356
			} else {
				this.field369 += this.field377 * var1; // L: 359
				this.field368 += this.field378 * var1; // L: 360
				this.field371 += this.field374 * var1; // L: 361
				this.field376 -= var1; // L: 362
			}
		}
		...
		if (this.field365 < 0) { // L: 371
			if (this.field366 <= 0) { // L: 372
				this.method958(); // L: 374
				this.remove(); // L: 375
				return; // L: 376
			}
		...
		if (this.field365 >= var5) { // L: 379
			if (this.field366 >= 0) { // L: 380
				this.method958(); // L: 382
				this.remove(); // L: 383
				return; // L: 384
			}
		...
		this.field365 += this.field366 * var1; // L: 387
		if (this.numLoops < 0) { // L: 388
			if (!this.field375) { // L: 389
				if (this.field366 < 0) { // L: 404
				...
				if (this.field375) { // L: 415
					label129: {
						...
						do {
							...
							this.field366 = -this.field366; // L: 425
							...
							this.field366 = -this.field366; // L: 429
						} while(--this.numLoops != 0); // L: 430
					}
				} else {
					label161: {
						int var7;
						if (this.field366 < 0) { // L: 433
	...
	public synchronized void method906(int var1) {
		this.method908(var1 << 6, this.method921()); // L: 83
	} // L: 84

	@ObfuscatedName("i")
	synchronized void method1011(int var1) {
		this.method908(var1, this.method921()); // L: 87
	} // L: 88

	@ObfuscatedName("o")
	synchronized void method908(int var1, int var2) {
		this.field379 = var1; // L: 91
		this.field367 = var2; // L: 92
		this.field376 = 0; // L: 93
		this.method904(); // L: 94
	} // L: 95

	@ObfuscatedName("n")
	public synchronized int method964() {
		return this.field379 == Integer.MIN_VALUE ? 0 : this.field379; // L: 98
	}

	@ObfuscatedName("k")
	public synchronized int method921() {
		return this.field367 < 0 ? -1 : this.field367; // L: 102
	}
	...
	public synchronized void method912() {
		this.field366 = (this.field366 ^ this.field366 >> 31) + (this.field366 >>> 31); // L: 113
		this.field366 = -this.field366; // L: 114
	} // L: 115

	@ObfuscatedName("l")
	void method958() {
		if (this.field376 != 0) { // L: 118
			if (this.field379 == Integer.MIN_VALUE) {
				this.field379 = 0; // L: 119
			}

			this.field376 = 0; // L: 120
	...
	public synchronized void method914(int var1, int var2) {
		this.method915(var1, var2, this.method921()); // L: 126
	} // L: 127
	...
	public synchronized void method915(int var1, int var2, int var3) {
		if (var1 == 0) { // L: 130
			...
			int var4 = method961(var2, var3); // L: 134
			int var5 = method990(var2, var3); // L: 135
			if (var4 == this.field368 && var5 == this.field371) { // L: 136
				this.field376 = 0; // L: 137
			} else {
				int var6 = var2 - this.field369; // L: 140
				if (this.field369 - var2 > var6) { // L: 141
					var6 = this.field369 - var2;
				}

				if (var4 - this.field368 > var6) { // L: 142
					var6 = var4 - this.field368;
				}

				if (this.field368 - var4 > var6) { // L: 143
					var6 = this.field368 - var4;
				}

				if (var5 - this.field371 > var6) {
					var6 = var5 - this.field371; // L: 144
				}

				if (this.field371 - var5 > var6) { // L: 145
				...
				this.field376 = var1; // L: 147
				this.field379 = var2; // L: 148
				this.field367 = var3; // L: 149
				this.field377 = (var2 - this.field369) / var1; // L: 150
				this.field378 = (var4 - this.field368) / var1; // L: 151
				this.field374 = (var5 - this.field371) / var1; // L: 152
			}
		}
	} // L: 132 138 153
	...
	public synchronized void method916(int var1) {
		if (var1 == 0) { // L: 156
			this.method1011(0); // L: 157
			this.remove(); // L: 158
		} else if (this.field368 == 0 && this.field371 == 0) { // L: 161
			this.field376 = 0; // L: 162
			this.field379 = 0; // L: 163
			this.field369 = 0; // L: 164
			this.remove(); // L: 165
		} else {
			int var2 = -this.field369; // L: 168
			if (this.field369 > var2) { // L: 169
				var2 = this.field369;
			}

			if (-this.field368 > var2) { // L: 170
				var2 = -this.field368;
			}

			if (this.field368 > var2) { // L: 171
				var2 = this.field368;
			}

			if (-this.field371 > var2) { // L: 172
				var2 = -this.field371;
			}

			if (this.field371 > var2) { // L: 173
				var2 = this.field371;
			}
			...
			this.field376 = var1; // L: 175
			this.field379 = Integer.MIN_VALUE; // L: 176
			this.field377 = -this.field369 / var1; // L: 177
			this.field378 = -this.field368 / var1; // L: 178
			this.field374 = -this.field371 / var1; // L: 179
		}
	} // L: 159 166 180

	@ObfuscatedName("an")
	public synchronized void method917(int var1) {
		if (this.field366 < 0) { // L: 183
			this.field366 = -var1;
		} else {
			this.field366 = var1; // L: 184
		}
	...
	public synchronized int method918() {
		return this.field366 < 0 ? -this.field366 : this.field366; // L: 188
	}
	...
	public boolean method976() {
		return this.field376 != 0; // L: 196
	}

	@ObfuscatedName("ak")
	int method926(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field376 > 0) { // L: 474
				int var6 = var2 + this.field376; // L: 475
				if (var6 > var4) { // L: 476
					var6 = var4;
				}

				this.field376 += var2; // L: 477
				if (this.field366 == 256 && (this.field365 & 255) == 0) { // L: 478
					if (class286.PcmPlayer_stereo) { // L: 479
						...
						var2 = method936(((RawSound)super.sound).samples, var1, this.field365, var2, this.field369, this.field377, 0, var6, var3, this); // L: 480
					}
				} else if (class286.PcmPlayer_stereo) { // L: 483
					...
					var2 = method940(0, 0, ((RawSound)super.sound).samples, var1, this.field365, var2, this.field369, this.field377, 0, var6, var3, this, this.field366, var5); // L: 484
				}

				this.field376 -= var2; // L: 486
				if (this.field376 != 0) { // L: 487
					return var2;
				}

				if (!this.method1013()) { // L: 488
					continue;
				}
			...
			if (this.field366 == 256 && (this.field365 & 255) == 0) { // L: 490
				if (class286.PcmPlayer_stereo) { // L: 491
					return method930(0, ((RawSound)super.sound).samples, var1, this.field365, var2, this.field368, this.field371, 0, var4, var3, this);
				}

				return method909(((RawSound)super.sound).samples, var1, this.field365, var2, this.field369, 0, var4, var3, this); // L: 492
			}

			if (class286.PcmPlayer_stereo) { // L: 495
			...
			return method1014(0, 0, ((RawSound)super.sound).samples, var1, this.field365, var2, this.field369, 0, var4, var3, this, this.field366, var5); // L: 496
		}
	}

	@ObfuscatedName("af")
	int vmethod1052() {
		int var1 = this.field369 * 3 >> 6; // L: 31
	...
	int method927(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field376 > 0) { // L: 501
				int var6 = var2 + this.field376; // L: 502
				if (var6 > var4) { // L: 503
					var6 = var4;
				}

				this.field376 += var2; // L: 504
				if (this.field366 == -256 && (this.field365 & 255) == 0) { // L: 505
					if (class286.PcmPlayer_stereo) { // L: 506
						...
						var2 = method938(((RawSound)super.sound).samples, var1, this.field365, var2, this.field369, this.field377, 0, var6, var3, this); // L: 507
					}
				} else if (class286.PcmPlayer_stereo) { // L: 510
					...
					var2 = method942(0, 0, ((RawSound)super.sound).samples, var1, this.field365, var2, this.field369, this.field377, 0, var6, var3, this, this.field366, var5); // L: 511
				}

				this.field376 -= var2; // L: 513
				if (this.field376 != 0) { // L: 514
					return var2;
				}

				if (!this.method1013()) { // L: 515
					continue;
				}
			...
			if (this.field366 == -256 && (this.field365 & 255) == 0) { // L: 517
				if (class286.PcmPlayer_stereo) { // L: 518
					return method931(0, ((RawSound)super.sound).samples, var1, this.field365, var2, this.field368, this.field371, 0, var4, var3, this);
				}

				return method1005(((RawSound)super.sound).samples, var1, this.field365, var2, this.field369, 0, var4, var3, this); // L: 519
			}

			if (class286.PcmPlayer_stereo) { // L: 522
			...
			return method934(0, 0, ((RawSound)super.sound).samples, var1, this.field365, var2, this.field369, 0, var4, var3, this, this.field366, var5); // L: 523
		}
	}

	@ObfuscatedName("ax")
	boolean method1013() {
		int var1 = this.field379; // L: 528
		int var2;
		int var3;
		if (var1 == Integer.MIN_VALUE) { // L: 531
			...
			var2 = method961(var1, this.field367); // L: 537
			var3 = method990(var1, this.field367); // L: 538
		}

		if (var1 == this.field369 && var2 == this.field368 && var3 == this.field371) { // L: 540
			if (this.field379 == Integer.MIN_VALUE) { // L: 570
				this.field379 = 0; // L: 571
				this.field371 = 0; // L: 572
				this.field368 = 0; // L: 573
				this.field369 = 0; // L: 574
				this.remove(); // L: 575
				return true; // L: 576
			} else {
			...
			if (this.field369 < var1) { // L: 541
				this.field377 = 1; // L: 542
				this.field376 = var1 - this.field369; // L: 543
			} else if (this.field369 > var1) { // L: 545
				this.field377 = -1; // L: 546
				this.field376 = this.field369 - var1; // L: 547
			} else {
				this.field377 = 0; // L: 549
			}

			if (this.field368 < var2) { // L: 550
				this.field378 = 1; // L: 551
				if (this.field376 == 0 || this.field376 > var2 - this.field368) { // L: 552
					this.field376 = var2 - this.field368;
				}
			} else if (this.field368 > var2) { // L: 554
				this.field378 = -1; // L: 555
				if (this.field376 == 0 || this.field376 > this.field368 - var2) { // L: 556
					this.field376 = this.field368 - var2;
				}
			} else {
				this.field378 = 0; // L: 558
			}

			if (this.field371 < var3) { // L: 559
				this.field374 = 1; // L: 560
				if (this.field376 == 0 || this.field376 > var3 - this.field371) { // L: 561
					this.field376 = var3 - this.field371;
				}
			} else if (this.field371 > var3) { // L: 563
				this.field374 = -1; // L: 564
				if (this.field376 == 0 || this.field376 > this.field371 - var3) { // L: 565
					this.field376 = this.field371 - var3;
				}
			} else {
				this.field374 = 0; // L: 567
			}
	...
	public static RawPcmStream createRawPcmStream(RawSound var0, int var1, int var2) {
		return var0.samples != null && var0.samples.length != 0 ? new RawPcmStream(var0, (int)((long)var0.sampleRate * 256L * (long)var1 / (long)(PcmPlayer.field325 * 2205000)), var2 << 6) : null; // L: 63 64
	}
	...
	static int method936(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field368 += var9.field378 * (var6 - var3); // L: 783
		var9.field371 += var9.field374 * (var6 - var3); // L: 784
	...
	static int method972(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field369 += var12.field377 * (var9 - var4); // L: 814
		var4 <<= 1; // L: 815
		var9 <<= 1; // L: 816
		...
		var12.field368 = var5 >> 2; // L: 848
		var12.field371 = var6 >> 2; // L: 849
	...
	static int method938(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field368 += var9.field378 * (var6 - var3); // L: 860
		var9.field371 += var9.field374 * (var6 - var3); // L: 861
	...
	static int method939(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field369 += var12.field377 * (var9 - var4); // L: 891
		var4 <<= 1; // L: 892
		var9 <<= 1; // L: 893
		...
		var12.field368 = var5 >> 2; // L: 925
		var12.field371 = var6 >> 2; // L: 926
	...
	static int method940(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field368 -= var11.field378 * var5; // L: 932
		var11.field371 -= var11.field374 * var5; // L: 933
		...
		var11.field368 += var11.field378 * var5; // L: 950
		var11.field371 += var11.field374 * var5; // L: 951
		var11.field369 = var6; // L: 952
	...
	static int method923(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field369 -= var5 * var13.field377; // L: 958
		...
		var5 >>= 1; // L: 984
		var13.field369 += var13.field377 * var5; // L: 985
		var13.field368 = var6; // L: 986
		var13.field371 = var7; // L: 987
	...
	static int method942(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field368 -= var11.field378 * var5; // L: 993
		var11.field371 -= var11.field374 * var5; // L: 994
		...
		var11.field368 += var11.field378 * var5; // L: 1011
		var11.field371 += var11.field374 * var5; // L: 1012
		var11.field369 = var6; // L: 1013
	...
	static int method943(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field369 -= var5 * var13.field377; // L: 1019
		...
		var5 >>= 1; // L: 1044
		var13.field369 += var13.field377 * var5; // L: 1045
		var13.field368 = var6; // L: 1046
		var13.field371 = var7; // L: 1047
