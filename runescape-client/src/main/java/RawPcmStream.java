...
public class RawPcmStream extends PcmStream {
	...
	RawPcmStream(RawSound var1, int var2, int var3, int var4) {
		...
		this.field343 = var1.field267; // L: 54
		this.field339 = var2; // L: 55
		this.field348 = var3; // L: 56
		this.field341 = var4; // L: 57
		this.field347 = 0; // L: 58
		this.method1027(); // L: 59
	} // L: 60
	...
	RawPcmStream(RawSound var1, int var2, int var3) {
		...
		this.field343 = var1.field267; // L: 42
		this.field339 = var2; // L: 43
		this.field348 = var3; // L: 44
		this.field341 = 8192; // L: 45
		this.field347 = 0; // L: 46
		this.method1027(); // L: 47
	} // L: 48

	@ObfuscatedName("aq")
	void method1027() {
		this.field352 = this.field348; // L: 73
		this.field340 = method979(this.field348, this.field341); // L: 74
		this.field344 = method915(this.field348, this.field341); // L: 75
	} // L: 76
	...
	protected int vmethod6281() {
		return this.field348 == 0 && this.field342 == 0 ? 0 : 1; // L: 208 209
	}

	@ObfuscatedName("ae")
	@Export("fill")
	public synchronized void fill(int[] var1, int var2, int var3) {
		if (this.field348 == 0 && this.field342 == 0) { // L: 213
			...
			if (this.field347 < 0) { // L: 225
				if (this.field339 <= 0) { // L: 226
					this.method929(); // L: 228
					this.remove(); // L: 229
					return; // L: 230
				}
			...
			if (this.field347 >= var7) { // L: 233
				if (this.field339 >= 0) { // L: 234
					this.method929(); // L: 236
					this.remove(); // L: 237
					return; // L: 238
				}
			...
			if (this.numLoops < 0) { // L: 241
				if (this.field343) { // L: 242
					if (this.field339 < 0) { // L: 243
						var9 = this.method1031(var1, var2, var5, var3, var4.samples[this.start]); // L: 244
						if (this.field347 >= var5) { // L: 245
							return;
						}

						this.field347 = var5 + var5 - 1 - this.field347; // L: 246
						this.field339 = -this.field339; // L: 247
					}

					while (true) {
						var9 = this.method942(var1, var9, var6, var3, var4.samples[this.end - 1]); // L: 250
						if (this.field347 < var6) { // L: 251
							return;
						}

						this.field347 = var6 + var6 - 1 - this.field347; // L: 252
						this.field339 = -this.field339; // L: 253
						var9 = this.method1031(var1, var9, var5, var3, var4.samples[this.start]); // L: 254
						if (this.field347 >= var5) { // L: 255
							return;
						}

						this.field347 = var5 + var5 - 1 - this.field347; // L: 256
						this.field339 = -this.field339; // L: 257
					}
				} else if (this.field339 < 0) { // L: 260
					while (true) {
						var9 = this.method1031(var1, var9, var5, var3, var4.samples[this.end - 1]); // L: 262
					...
					while (true) {
						var9 = this.method942(var1, var9, var6, var3, var4.samples[this.start]); // L: 269
				...
				if (this.numLoops > 0) { // L: 275
					if (this.field343) { // L: 276
						label127: {
							if (this.field339 < 0) { // L: 277
								var9 = this.method1031(var1, var2, var5, var3, var4.samples[this.start]); // L: 278
								if (this.field347 >= var5) { // L: 279
									return;
								}

								this.field347 = var5 + var5 - 1 - this.field347; // L: 280
								this.field339 = -this.field339; // L: 281
							...
							do {
								var9 = this.method942(var1, var9, var6, var3, var4.samples[this.end - 1]); // L: 285
								if (this.field347 < var6) { // L: 286
									return;
								}

								this.field347 = var6 + var6 - 1 - this.field347; // L: 287
								this.field339 = -this.field339; // L: 288
								if (--this.numLoops == 0) { // L: 289
									break;
								}

								var9 = this.method1031(var1, var9, var5, var3, var4.samples[this.start]); // L: 290
								if (this.field347 >= var5) { // L: 291
									return;
								}

								this.field347 = var5 + var5 - 1 - this.field347; // L: 292
								this.field339 = -this.field339; // L: 293
							} while(--this.numLoops != 0); // L: 294
						}
					} else {
						int var10;
						if (this.field339 < 0) { // L: 297
							while (true) {
								var9 = this.method1031(var1, var9, var5, var3, var4.samples[this.end - 1]); // L: 299
							...
							while (true) {
								var9 = this.method942(var1, var9, var6, var3, var4.samples[this.start]); // L: 313
				...
				if (this.field339 < 0) { // L: 326
					this.method1031(var1, var9, 0, var3, 0); // L: 327
					if (this.field347 < 0) { // L: 328
						this.field347 = -1; // L: 329
						this.method929(); // L: 330
						this.remove(); // L: 331
					}
				} else {
					this.method942(var1, var9, var7, var3, 0); // L: 335
					if (this.field347 >= var7) { // L: 336
						this.field347 = var7; // L: 337
						this.method929(); // L: 338
						this.remove(); // L: 339
					}
				}
	...
	public synchronized void skip(int var1) {
		if (this.field342 > 0) { // L: 345
			if (var1 >= this.field342) { // L: 346
				if (this.field348 == Integer.MIN_VALUE) { // L: 347
					this.field348 = 0; // L: 348
					this.field344 = 0; // L: 349
				...
				this.method1027(); // L: 356
			} else {
				this.field352 += this.field350 * var1; // L: 359
				this.field340 += this.field351 * var1; // L: 360
				this.field344 += this.field338 * var1; // L: 361
		...
		if (this.field347 < 0) { // L: 371
			if (this.field339 <= 0) { // L: 372
				this.method929(); // L: 374
				this.remove(); // L: 375
				return; // L: 376
			}
		...
		if (this.field347 >= var5) { // L: 379
			if (this.field339 >= 0) { // L: 380
				this.method929(); // L: 382
				this.remove(); // L: 383
				return; // L: 384
			}
		...
		this.field347 += this.field339 * var1; // L: 387
		if (this.numLoops < 0) { // L: 388
			if (!this.field343) { // L: 389
				if (this.field339 < 0) { // L: 404
				...
				if (this.field343) { // L: 415
					label129: {
						...
						do {
							...
							this.field339 = -this.field339; // L: 425
							...
							this.field339 = -this.field339; // L: 429
						} while(--this.numLoops != 0); // L: 430
					}
				} else {
					label161: {
						int var7;
						if (this.field339 < 0) { // L: 433
	...
	public synchronized void method958(int var1) {
		this.method952(var1 << 6, this.method926()); // L: 83
	} // L: 84

	@ObfuscatedName("ad")
	synchronized void method1036(int var1) {
		this.method952(var1, this.method926()); // L: 87
	} // L: 88

	@ObfuscatedName("ax")
	synchronized void method952(int var1, int var2) {
		this.field348 = var1; // L: 91
		this.field341 = var2; // L: 92
		this.field342 = 0; // L: 93
		this.method1027(); // L: 94
	} // L: 95

	@ObfuscatedName("aw")
	public synchronized int method925() {
		return this.field348 == Integer.MIN_VALUE ? 0 : this.field348; // L: 98
	}

	@ObfuscatedName("az")
	public synchronized int method926() {
		return this.field341 < 0 ? -1 : this.field341; // L: 102
	}
	...
	public synchronized void method923() {
		this.field339 = (this.field339 ^ this.field339 >> 31) + (this.field339 >>> 31); // L: 113
		this.field339 = -this.field339; // L: 114
	} // L: 115
	...
	void method929() {
		if (this.field342 != 0) { // L: 118
			if (this.field348 == Integer.MIN_VALUE) {
				this.field348 = 0; // L: 119
			}

			this.field342 = 0; // L: 120
			this.method1027(); // L: 121
		}
	...
	public synchronized void method930(int var1, int var2) {
		this.method931(var1, var2, this.method926()); // L: 126
	} // L: 127

	@ObfuscatedName("ab")
	public synchronized void method931(int var1, int var2, int var3) {
		if (var1 == 0) { // L: 130
			this.method952(var2, var3); // L: 131
		} else {
			int var4 = method979(var2, var3); // L: 134
			int var5 = method915(var2, var3); // L: 135
			if (var4 == this.field340 && var5 == this.field344) { // L: 136
				...
				if (var5 - this.field344 > var6) {
					var6 = var5 - this.field344; // L: 144
				}

				if (this.field344 - var5 > var6) { // L: 145
				...
				this.field348 = var2; // L: 148
				this.field341 = var3; // L: 149
				this.field350 = (var2 - this.field352) / var1; // L: 150
				this.field351 = (var4 - this.field340) / var1; // L: 151
				this.field338 = (var5 - this.field344) / var1; // L: 152
			}
		}
	} // L: 132 138 153
	...
	public synchronized void method1022(int var1) {
		if (var1 == 0) { // L: 156
			this.method1036(0); // L: 157
			this.remove(); // L: 158
		} else if (this.field340 == 0 && this.field344 == 0) { // L: 161
			this.field342 = 0; // L: 162
			this.field348 = 0; // L: 163
			...
			if (-this.field344 > var2) { // L: 172
				var2 = -this.field344;
			}

			if (this.field344 > var2) { // L: 173
				var2 = this.field344;
			}
			...
			this.field348 = Integer.MIN_VALUE; // L: 176
			this.field350 = -this.field352 / var1; // L: 177
			this.field351 = -this.field340 / var1; // L: 178
			this.field338 = -this.field344 / var1; // L: 179
		}
	} // L: 159 166 180

	@ObfuscatedName("bg")
	public synchronized void method933(int var1) {
		if (this.field339 < 0) { // L: 183
			this.field339 = -var1;
		} else {
			this.field339 = var1; // L: 184
		}
	...
	public synchronized int method934() {
		return this.field339 < 0 ? -this.field339 : this.field339; // L: 188
	}
	...
	int method942(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field342 > 0) { // L: 474
				...
				if (this.field339 == 256 && (this.field347 & 255) == 0) { // L: 478
					if (class462.PcmPlayer_stereo) { // L: 479
						...
						var2 = method953(((RawSound)super.sound).samples, var1, this.field347, var2, this.field352, this.field350, 0, var6, var3, this); // L: 480
					}
				} else if (class462.PcmPlayer_stereo) { // L: 483
					...
					var2 = method957(0, 0, ((RawSound)super.sound).samples, var1, this.field347, var2, this.field352, this.field350, 0, var6, var3, this, this.field339, var5); // L: 484
				}
			...
			if (this.field339 == 256 && (this.field347 & 255) == 0) { // L: 490
				if (class462.PcmPlayer_stereo) { // L: 491
					return method946(0, ((RawSound)super.sound).samples, var1, this.field347, var2, this.field340, this.field344, 0, var4, var3, this);
				}

				return method945(((RawSound)super.sound).samples, var1, this.field347, var2, this.field352, 0, var4, var3, this); // L: 492
			}

			if (class462.PcmPlayer_stereo) { // L: 495
			...
			return method949(0, 0, ((RawSound)super.sound).samples, var1, this.field347, var2, this.field352, 0, var4, var3, this, this.field339, var5); // L: 496
		}
	}
	...
	int method1031(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field342 > 0) { // L: 501
				...
				if (this.field339 == -256 && (this.field347 & 255) == 0) { // L: 505
					if (class462.PcmPlayer_stereo) { // L: 506
						...
						var2 = method927(((RawSound)super.sound).samples, var1, this.field347, var2, this.field352, this.field350, 0, var6, var3, this); // L: 507
					}
				} else if (class462.PcmPlayer_stereo) { // L: 510
					...
					var2 = method917(0, 0, ((RawSound)super.sound).samples, var1, this.field347, var2, this.field352, this.field350, 0, var6, var3, this, this.field339, var5); // L: 511
				}
			...
			if (this.field339 == -256 && (this.field347 & 255) == 0) { // L: 517
				if (class462.PcmPlayer_stereo) { // L: 518
					return method948(0, ((RawSound)super.sound).samples, var1, this.field347, var2, this.field340, this.field344, 0, var4, var3, this);
				}

				return method947(((RawSound)super.sound).samples, var1, this.field347, var2, this.field352, 0, var4, var3, this); // L: 519
			}

			if (class462.PcmPlayer_stereo) { // L: 522
			...
			return method1005(0, 0, ((RawSound)super.sound).samples, var1, this.field347, var2, this.field352, 0, var4, var3, this, this.field339, var5); // L: 523
		}
	}

	@ObfuscatedName("bp")
	boolean method944() {
		int var1 = this.field348; // L: 528
		int var2;
		int var3;
		if (var1 == Integer.MIN_VALUE) { // L: 531
			...
			var2 = method979(var1, this.field341); // L: 537
			var3 = method915(var1, this.field341); // L: 538
		}

		if (var1 == this.field352 && var2 == this.field340 && var3 == this.field344) { // L: 540
			if (this.field348 == Integer.MIN_VALUE) { // L: 570
				this.field348 = 0; // L: 571
				this.field344 = 0; // L: 572
				this.field340 = 0; // L: 573
				this.field352 = 0; // L: 574
				this.remove(); // L: 575
				return true; // L: 576
			} else {
				this.method1027(); // L: 578
				return false; // L: 579
			}
		} else {
			if (this.field352 < var1) { // L: 541
				this.field350 = 1; // L: 542
				this.field342 = var1 - this.field352; // L: 543
			} else if (this.field352 > var1) { // L: 545
				this.field350 = -1; // L: 546
				this.field342 = this.field352 - var1; // L: 547
			} else {
				this.field350 = 0; // L: 549
			}

			if (this.field340 < var2) { // L: 550
				this.field351 = 1; // L: 551
				if (this.field342 == 0 || this.field342 > var2 - this.field340) { // L: 552
					this.field342 = var2 - this.field340;
				}
			} else if (this.field340 > var2) { // L: 554
				this.field351 = -1; // L: 555
				if (this.field342 == 0 || this.field342 > this.field340 - var2) { // L: 556
					this.field342 = this.field340 - var2;
				}
			} else {
				this.field351 = 0; // L: 558
			}

			if (this.field344 < var3) { // L: 559
				this.field338 = 1; // L: 560
				if (this.field342 == 0 || this.field342 > var3 - this.field344) { // L: 561
					this.field342 = var3 - this.field344;
				}
			} else if (this.field344 > var3) { // L: 563
				this.field338 = -1; // L: 564
				if (this.field342 == 0 || this.field342 > this.field344 - var3) { // L: 565
					this.field342 = this.field344 - var3;
				}
			} else {
				this.field338 = 0; // L: 567
			}
	...
	public static RawPcmStream createRawPcmStream(RawSound var0, int var1, int var2) {
		return var0.samples != null && var0.samples.length != 0 ? new RawPcmStream(var0, (int)((long)var0.sampleRate * 256L * (long)var1 / (long)(class189.field1993 * 2205000)), var2 << 6) : null; // L: 63 64
	}
	...
	static int method953(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field340 += var9.field351 * (var6 - var3); // L: 783
		var9.field344 += var9.field338 * (var6 - var3); // L: 784
	...
	static int method982(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field352 += var12.field350 * (var9 - var4); // L: 814
		var4 <<= 1; // L: 815
		var9 <<= 1; // L: 816
	...
	static int method927(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field340 += var9.field351 * (var6 - var3); // L: 860
		var9.field344 += var9.field338 * (var6 - var3); // L: 861
	...
	static int method1010(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field352 += var12.field350 * (var9 - var4); // L: 891
		var4 <<= 1; // L: 892
		var9 <<= 1; // L: 893
	...
	static int method957(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field340 -= var11.field351 * var5; // L: 932
		var11.field344 -= var11.field338 * var5; // L: 933
		...
		var11.field340 += var11.field351 * var5; // L: 950
		var11.field344 += var11.field338 * var5; // L: 951
	...
	static int method962(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field352 -= var5 * var13.field350; // L: 958
		...
		var5 >>= 1; // L: 984
		var13.field352 += var13.field350 * var5; // L: 985
		var13.field340 = var6; // L: 986
		var13.field344 = var7; // L: 987
	...
	static int method917(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field340 -= var11.field351 * var5; // L: 993
		var11.field344 -= var11.field338 * var5; // L: 994
		...
		var11.field340 += var11.field351 * var5; // L: 1011
		var11.field344 += var11.field338 * var5; // L: 1012
	...
	static int method938(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field352 -= var5 * var13.field350; // L: 1019
		...
		var5 >>= 1; // L: 1044
		var13.field352 += var13.field350 * var5; // L: 1045
		var13.field340 = var6; // L: 1046
		var13.field344 = var7; // L: 1047
