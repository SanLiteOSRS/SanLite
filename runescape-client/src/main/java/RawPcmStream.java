...
public class RawPcmStream extends PcmStream {
	...
	RawPcmStream(RawSound var1, int var2, int var3, int var4) {
		...
		this.field343 = var1.field266; // L: 54
		this.field334 = var2; // L: 55
		this.field335 = var3; // L: 56
		this.field336 = var4; // L: 57
	...
	RawPcmStream(RawSound var1, int var2, int var3) {
		...
		this.field343 = var1.field266; // L: 42
		this.field334 = var2; // L: 43
		this.field335 = var3; // L: 44
		this.field336 = 8192; // L: 45
	...
	@ObfuscatedName("ar")
	void method847() {
		this.field333 = this.field335; // L: 73
		this.field337 = method990(this.field335, this.field336); // L: 74
		this.field339 = method1011(this.field335, this.field336); // L: 75
	} // L: 76
	...
	protected int vmethod6346() {
		return this.field335 == 0 && this.field344 == 0 ? 0 : 1; // L: 208 209
	}

	@ObfuscatedName("ao")
	@Export("fill")
	public synchronized void fill(int[] var1, int var2, int var3) {
		if (this.field335 == 0 && this.field344 == 0) { // L: 213
			...
			if (this.numLoops < 0) { // L: 241
				if (this.field343) { // L: 242
					if (this.field334 < 0) { // L: 243
						var9 = this.method870(var1, var2, var5, var3, var4.samples[this.start]); // L: 244
					...
					while (true) {
						var9 = this.method869(var1, var9, var6, var3, var4.samples[this.end - 1]); // L: 250
						...
						var9 = this.method870(var1, var9, var5, var3, var4.samples[this.start]); // L: 254
					...
					while (true) {
						var9 = this.method870(var1, var9, var5, var3, var4.samples[this.end - 1]); // L: 262
					...
					while (true) {
						var9 = this.method869(var1, var9, var6, var3, var4.samples[this.start]); // L: 269
					...
					if (this.field343) { // L: 276
						label127: {
							if (this.field334 < 0) { // L: 277
								var9 = this.method870(var1, var2, var5, var3, var4.samples[this.start]); // L: 278
							...
							do {
								var9 = this.method869(var1, var9, var6, var3, var4.samples[this.end - 1]); // L: 285
								...
								var9 = this.method870(var1, var9, var5, var3, var4.samples[this.start]); // L: 290
						...
						if (this.field334 < 0) { // L: 297
							while (true) {
								var9 = this.method870(var1, var9, var5, var3, var4.samples[this.end - 1]); // L: 299
							...
							while (true) {
								var9 = this.method869(var1, var9, var6, var3, var4.samples[this.start]); // L: 313
				...
				if (this.field334 < 0) { // L: 326
					this.method870(var1, var9, 0, var3, 0); // L: 327
					if (this.field347 < 0) { // L: 328
						this.field347 = -1; // L: 329
						this.method856(); // L: 330
						this.remove(); // L: 331
					}
				} else {
					this.method869(var1, var9, var7, var3, 0); // L: 335
					if (this.field347 >= var7) { // L: 336
						this.field347 = var7; // L: 337
						this.method856(); // L: 338
						this.remove(); // L: 339
					}
				}
	...
	public synchronized void skip(int var1) {
		if (this.field344 > 0) { // L: 345
			if (var1 >= this.field344) { // L: 346
				if (this.field335 == Integer.MIN_VALUE) { // L: 347
					...
					this.remove(); // L: 352
					var1 = this.field344; // L: 353
				}

				this.field344 = 0; // L: 355
				this.method847(); // L: 356
			} else {
				this.field333 += this.field345 * var1; // L: 359
				this.field337 += this.field338 * var1; // L: 360
				this.field339 += this.field341 * var1; // L: 361
				this.field344 -= var1; // L: 362
			}
		}
		...
		this.field347 += this.field334 * var1; // L: 387
	...
	public synchronized void method919(int var1) {
		this.method859(var1 << 6, this.method1009()); // L: 83
	} // L: 84

	@ObfuscatedName("aj")
	synchronized void method850(int var1) {
		this.method859(var1, this.method1009()); // L: 87
	} // L: 88

	@ObfuscatedName("af")
	synchronized void method859(int var1, int var2) {
		this.field335 = var1; // L: 91
		this.field336 = var2; // L: 92
		this.field344 = 0; // L: 93
		this.method847(); // L: 94
	} // L: 95
	...
	public synchronized int method1009() {
		return this.field336 < 0 ? -1 : this.field336; // L: 102
	}
	...
	@ObfuscatedName("ad")
	void method856() {
		if (this.field344 != 0) { // L: 118
			if (this.field335 == Integer.MIN_VALUE) {
				this.field335 = 0; // L: 119
			}

			this.field344 = 0; // L: 120
			this.method847(); // L: 121
		}
	...
	public synchronized void method857(int var1, int var2) {
		this.method858(var1, var2, this.method1009()); // L: 126
	} // L: 127

	@ObfuscatedName("ay")
	public synchronized void method858(int var1, int var2, int var3) {
		if (var1 == 0) { // L: 130
			this.method859(var2, var3); // L: 131
		} else {
			int var4 = method990(var2, var3); // L: 134
			int var5 = method1011(var2, var3); // L: 135
			if (var4 == this.field337 && var5 == this.field339) { // L: 136
				this.field344 = 0; // L: 137
			} else {
				...
				this.field344 = var1; // L: 147
				this.field335 = var2; // L: 148
				this.field336 = var3; // L: 149
				this.field345 = (var2 - this.field333) / var1; // L: 150
				this.field338 = (var4 - this.field337) / var1; // L: 151
				this.field341 = (var5 - this.field339) / var1; // L: 152
			}
		}
	} // L: 132 138 153
	...
	public synchronized void method951(int var1) {
		if (var1 == 0) { // L: 156
			this.method850(0); // L: 157
			this.remove(); // L: 158
		} else if (this.field337 == 0 && this.field339 == 0) { // L: 161
			this.field344 = 0; // L: 162
			...
			this.field344 = var1; // L: 175
			this.field335 = Integer.MIN_VALUE; // L: 176
			this.field345 = -this.field333 / var1; // L: 177
			this.field338 = -this.field337 / var1; // L: 178
			this.field341 = -this.field339 / var1; // L: 179
		}
	} // L: 159 166 180
	...
	public boolean method849() {
		return this.field344 != 0; // L: 196
	}

	@ObfuscatedName("by")
	int method869(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field344 > 0) { // L: 474
				int var6 = var2 + this.field344; // L: 475
				if (var6 > var4) { // L: 476
					var6 = var4;
				}

				this.field344 += var2; // L: 477
				if (this.field334 == 256 && (this.field347 & 255) == 0) { // L: 478
					if (PcmPlayer.PcmPlayer_stereo) { // L: 479
						...
						var2 = method880(((RawSound)super.sound).samples, var1, this.field347, var2, this.field333, this.field345, 0, var6, var3, this); // L: 480
					}
					...
					var2 = method920(0, 0, ((RawSound)super.sound).samples, var1, this.field347, var2, this.field333, this.field345, 0, var6, var3, this, this.field334, var5); // L: 484
				}

				this.field344 -= var2; // L: 486
				if (this.field344 != 0) { // L: 487
					return var2;
				}

				if (!this.method871()) { // L: 488
					continue;
				}
			...
			if (this.field334 == 256 && (this.field347 & 255) == 0) { // L: 490
				...
				return method872(((RawSound)super.sound).samples, var1, this.field347, var2, this.field333, 0, var4, var3, this); // L: 492
			}
			...
			return method876(0, 0, ((RawSound)super.sound).samples, var1, this.field347, var2, this.field333, 0, var4, var3, this, this.field334, var5); // L: 496
		}
	}
	...
	int method870(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field344 > 0) { // L: 501
				int var6 = var2 + this.field344; // L: 502
				if (var6 > var4) { // L: 503
					var6 = var4;
				}

				this.field344 += var2; // L: 504
				if (this.field334 == -256 && (this.field347 & 255) == 0) { // L: 505
					if (PcmPlayer.PcmPlayer_stereo) { // L: 506
						...
						var2 = method882(((RawSound)super.sound).samples, var1, this.field347, var2, this.field333, this.field345, 0, var6, var3, this); // L: 507
					}
					...
					var2 = method886(0, 0, ((RawSound)super.sound).samples, var1, this.field347, var2, this.field333, this.field345, 0, var6, var3, this, this.field334, var5); // L: 511
				}

				this.field344 -= var2; // L: 513
				if (this.field344 != 0) { // L: 514
					return var2;
				}

				if (!this.method871()) { // L: 515
					continue;
				}
			...
			if (this.field334 == -256 && (this.field347 & 255) == 0) { // L: 517
				...
				return method874(((RawSound)super.sound).samples, var1, this.field347, var2, this.field333, 0, var4, var3, this); // L: 519
			}
			...
			return method878(0, 0, ((RawSound)super.sound).samples, var1, this.field347, var2, this.field333, 0, var4, var3, this, this.field334, var5); // L: 523
		}
	}
	...
	boolean method871() {
		...
		if (var1 == Integer.MIN_VALUE) { // L: 531
			...
			var2 = method990(var1, this.field336); // L: 537
			var3 = method1011(var1, this.field336); // L: 538
		}

		if (var1 == this.field333 && var2 == this.field337 && var3 == this.field339) { // L: 540
			if (this.field335 == Integer.MIN_VALUE) { // L: 570
				...
				this.method847(); // L: 578
				return false; // L: 579
			}
		} else {
			if (this.field333 < var1) { // L: 541
				this.field345 = 1; // L: 542
				this.field344 = var1 - this.field333; // L: 543
			} else if (this.field333 > var1) { // L: 545
				this.field345 = -1; // L: 546
				this.field344 = this.field333 - var1; // L: 547
			} else {
				this.field345 = 0; // L: 549
			}

			if (this.field337 < var2) { // L: 550
				this.field338 = 1; // L: 551
				if (this.field344 == 0 || this.field344 > var2 - this.field337) { // L: 552
					this.field344 = var2 - this.field337;
				}
			} else if (this.field337 > var2) { // L: 554
				this.field338 = -1; // L: 555
				if (this.field344 == 0 || this.field344 > this.field337 - var2) { // L: 556
					this.field344 = this.field337 - var2;
				}
			} else {
				this.field338 = 0; // L: 558
			}

			if (this.field339 < var3) { // L: 559
				this.field341 = 1; // L: 560
				if (this.field344 == 0 || this.field344 > var3 - this.field339) { // L: 561
					this.field344 = var3 - this.field339;
				}
			} else if (this.field339 > var3) { // L: 563
				this.field341 = -1; // L: 564
				if (this.field344 == 0 || this.field344 > this.field339 - var3) { // L: 565
	...
	public static RawPcmStream createRawPcmStream(RawSound var0, int var1, int var2) {
		return var0.samples != null && var0.samples.length != 0 ? new RawPcmStream(var0, (int)((long)var0.sampleRate * 256L * (long)var1 / (long)(PcmPlayer.field295 * 100)), var2 << 6) : null; // L: 63 64
	}
	...
	static int method880(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field337 += var9.field338 * (var6 - var3); // L: 783
		var9.field339 += var9.field341 * (var6 - var3); // L: 784
	...
	static int method984(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field333 += var12.field345 * (var9 - var4); // L: 814
		var4 <<= 1; // L: 815
		var9 <<= 1; // L: 816
	...
	static int method882(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field337 += var9.field338 * (var6 - var3); // L: 860
		var9.field339 += var9.field341 * (var6 - var3); // L: 861
	...
	static int method888(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field333 += var12.field345 * (var9 - var4); // L: 891
		var4 <<= 1; // L: 892
		var9 <<= 1; // L: 893
	...
	static int method920(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field337 -= var11.field338 * var5; // L: 932
		var11.field339 -= var11.field341 * var5; // L: 933
		...
		var11.field337 += var11.field338 * var5; // L: 950
		var11.field339 += var11.field341 * var5; // L: 951
	...
	static int method912(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field333 -= var5 * var13.field345; // L: 958
		...
		var5 >>= 1; // L: 984
		var13.field333 += var13.field345 * var5; // L: 985
	...
	static int method886(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field337 -= var11.field338 * var5; // L: 993
		var11.field339 -= var11.field341 * var5; // L: 994
		...
		var11.field337 += var11.field338 * var5; // L: 1011
		var11.field339 += var11.field341 * var5; // L: 1012
	...
	static int method877(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field333 -= var5 * var13.field345; // L: 1019
		...
		var5 >>= 1; // L: 1044
		var13.field333 += var13.field345 * var5; // L: 1045
