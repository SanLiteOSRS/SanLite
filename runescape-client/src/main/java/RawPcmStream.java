...
public class RawPcmStream extends PcmStream {
	...
	RawPcmStream(RawSound var1, int var2, int var3, int var4) {
		...
		this.field363 = var1.field292; // L: 54
		this.field354 = var2; // L: 55
		this.field367 = var3; // L: 56
		this.field356 = var4; // L: 57
		this.field357 = 0; // L: 58
		this.method904(); // L: 59
	} // L: 60
	...
	RawPcmStream(RawSound var1, int var2, int var3) {
		...
		this.field363 = var1.field292; // L: 42
		this.field354 = var2; // L: 43
		this.field367 = var3; // L: 44
		this.field356 = 8192; // L: 45
		this.field357 = 0; // L: 46
		this.method904(); // L: 47
	} // L: 48

	@ObfuscatedName("z")
	void method904() {
		this.field362 = this.field367; // L: 73
		this.field358 = method980(this.field367, this.field356); // L: 74
		this.field355 = method878(this.field367, this.field356); // L: 75
	} // L: 76
	...
	protected int vmethod5793() {
		return this.field367 == 0 && this.field364 == 0 ? 0 : 1; // L: 208 209
	}

	@ObfuscatedName("l")
	@Export("fill")
	public synchronized void fill(int[] var1, int var2, int var3) {
		if (this.field367 == 0 && this.field364 == 0) { // L: 213
			...
			int var9 = var2; // L: 223
			var3 += var2; // L: 224
			if (this.field357 < 0) { // L: 225
				if (this.field354 <= 0) { // L: 226
			...
			if (this.field357 >= var7) { // L: 233
				if (this.field354 >= 0) { // L: 234
			...
			if (this.numLoops < 0) { // L: 241
				if (this.field363) { // L: 242
					if (this.field354 < 0) { // L: 243
						var9 = this.method963(var1, var2, var5, var3, var4.samples[this.start]); // L: 244
						if (this.field357 >= var5) { // L: 245
							return;
						}

						this.field357 = var5 + var5 - 1 - this.field357; // L: 246
						this.field354 = -this.field354; // L: 247
					}

					while (true) {
						var9 = this.method905(var1, var9, var6, var3, var4.samples[this.end - 1]); // L: 250
						if (this.field357 < var6) { // L: 251
							return;
						}

						this.field357 = var6 + var6 - 1 - this.field357; // L: 252
						this.field354 = -this.field354; // L: 253
						var9 = this.method963(var1, var9, var5, var3, var4.samples[this.start]); // L: 254
						if (this.field357 >= var5) { // L: 255
							return;
						}

						this.field357 = var5 + var5 - 1 - this.field357; // L: 256
						this.field354 = -this.field354; // L: 257
					}
				} else if (this.field354 < 0) { // L: 260
					while (true) {
						var9 = this.method963(var1, var9, var5, var3, var4.samples[this.end - 1]); // L: 262
						if (this.field357 >= var5) { // L: 263
							return;
						}

						this.field357 = var6 - 1 - (var6 - 1 - this.field357) % var8; // L: 264
					}
				} else {
					while (true) {
						var9 = this.method905(var1, var9, var6, var3, var4.samples[this.start]); // L: 269
						if (this.field357 < var6) { // L: 270
							return;
						}

						this.field357 = var5 + (this.field357 - var5) % var8; // L: 271
					}
				}
			} else {
				if (this.numLoops > 0) { // L: 275
					if (this.field363) { // L: 276
						label127: {
							if (this.field354 < 0) { // L: 277
								var9 = this.method963(var1, var2, var5, var3, var4.samples[this.start]); // L: 278
								if (this.field357 >= var5) { // L: 279
									return;
								}

								this.field357 = var5 + var5 - 1 - this.field357; // L: 280
								this.field354 = -this.field354; // L: 281
							...
							do {
								...
								if (this.field357 < var6) { // L: 286
									return;
								}

								this.field357 = var6 + var6 - 1 - this.field357; // L: 287
								this.field354 = -this.field354; // L: 288
								if (--this.numLoops == 0) { // L: 289
									break;
								}

								var9 = this.method963(var1, var9, var5, var3, var4.samples[this.start]); // L: 290
								if (this.field357 >= var5) { // L: 291
									return;
								}

								this.field357 = var5 + var5 - 1 - this.field357; // L: 292
								this.field354 = -this.field354; // L: 293
							} while(--this.numLoops != 0); // L: 294
						}
					} else {
						int var10;
						if (this.field354 < 0) { // L: 297
							while (true) {
								var9 = this.method963(var1, var9, var5, var3, var4.samples[this.end - 1]); // L: 299
								if (this.field357 >= var5) { // L: 300
									return;
								}

								var10 = (var6 - 1 - this.field357) / var8; // L: 301
								if (var10 >= this.numLoops) { // L: 302
									this.field357 += var8 * this.numLoops; // L: 303
									this.numLoops = 0; // L: 304
									break; // L: 305
								}

								this.field357 += var8 * var10; // L: 307
								this.numLoops -= var10; // L: 308
							}
						} else {
							while (true) {
								var9 = this.method905(var1, var9, var6, var3, var4.samples[this.start]); // L: 313
								if (this.field357 < var6) { // L: 314
									return;
								}

								var10 = (this.field357 - var5) / var8; // L: 315
								if (var10 >= this.numLoops) { // L: 316
									this.field357 -= var8 * this.numLoops; // L: 317
									this.numLoops = 0; // L: 318
									break; // L: 319
								}

								this.field357 -= var8 * var10; // L: 321
				...
				if (this.field354 < 0) { // L: 326
					this.method963(var1, var9, 0, var3, 0); // L: 327
					if (this.field357 < 0) { // L: 328
						this.field357 = -1; // L: 329
						this.method908(); // L: 330
						this.remove(); // L: 331
					}
				} else {
					this.method905(var1, var9, var7, var3, 0); // L: 335
					if (this.field357 >= var7) { // L: 336
						this.field357 = var7; // L: 337
	...
	public synchronized void skip(int var1) {
		if (this.field364 > 0) { // L: 345
			if (var1 >= this.field364) { // L: 346
				if (this.field367 == Integer.MIN_VALUE) { // L: 347
					this.field367 = 0; // L: 348
					this.field355 = 0; // L: 349
					this.field358 = 0; // L: 350
					this.field362 = 0; // L: 351
					this.remove(); // L: 352
					var1 = this.field364; // L: 353
				}

				this.field364 = 0; // L: 355
				this.method904(); // L: 356
			} else {
				this.field362 += this.field365 * var1; // L: 359
				this.field358 += this.field359 * var1; // L: 360
				this.field355 += this.field353 * var1; // L: 361
				this.field364 -= var1; // L: 362
			}
		}
		...
		if (this.field357 < 0) { // L: 371
			if (this.field354 <= 0) { // L: 372
		...
		if (this.field357 >= var5) { // L: 379
			if (this.field354 >= 0) { // L: 380
		...
		this.field357 += this.field354 * var1; // L: 387
		if (this.numLoops < 0) { // L: 388
			if (!this.field363) { // L: 389
				if (this.field354 < 0) { // L: 404
					if (this.field357 >= var3) { // L: 405
						return;
					}

					this.field357 = var4 - 1 - (var4 - 1 - this.field357) % var6; // L: 406
				} else {
					if (this.field357 < var4) { // L: 409
						return;
					}

					this.field357 = var3 + (this.field357 - var3) % var6; // L: 410
				}

			} else {
				if (this.field354 < 0) { // L: 390
					if (this.field357 >= var3) { // L: 391
						return;
					}

					this.field357 = var3 + var3 - 1 - this.field357; // L: 392
					this.field354 = -this.field354; // L: 393
				}

				while (this.field357 >= var4) { // L: 396
					this.field357 = var4 + var4 - 1 - this.field357; // L: 397
					this.field354 = -this.field354; // L: 398
					if (this.field357 >= var3) { // L: 399
						return;
					}

					this.field357 = var3 + var3 - 1 - this.field357; // L: 400
					this.field354 = -this.field354; // L: 401
				}

			}
		} else {
			if (this.numLoops > 0) { // L: 414
				if (this.field363) { // L: 415
					label129: {
						if (this.field354 < 0) { // L: 416
							if (this.field357 >= var3) { // L: 417
								return;
							}

							this.field357 = var3 + var3 - 1 - this.field357; // L: 418
							this.field354 = -this.field354; // L: 419
						...
						do {
							if (this.field357 < var4) { // L: 423
								return;
							}

							this.field357 = var4 + var4 - 1 - this.field357; // L: 424
							this.field354 = -this.field354; // L: 425
							if (--this.numLoops == 0) { // L: 426
								break;
							}

							if (this.field357 >= var3) { // L: 427
								return;
							}

							this.field357 = var3 + var3 - 1 - this.field357; // L: 428
							this.field354 = -this.field354; // L: 429
						} while(--this.numLoops != 0); // L: 430
					}
				} else {
					label161: {
						int var7;
						if (this.field354 < 0) { // L: 433
							if (this.field357 >= var3) { // L: 434
								return;
							}

							var7 = (var4 - 1 - this.field357) / var6; // L: 435
							if (var7 >= this.numLoops) { // L: 436
								this.field357 += var6 * this.numLoops; // L: 437
								this.numLoops = 0; // L: 438
								break label161; // L: 439
							}

							this.field357 += var6 * var7; // L: 441
							this.numLoops -= var7; // L: 442
						} else {
							if (this.field357 < var4) { // L: 445
								return;
							}

							var7 = (this.field357 - var3) / var6; // L: 446
							if (var7 >= this.numLoops) { // L: 447
								this.field357 -= var6 * this.numLoops; // L: 448
								this.numLoops = 0; // L: 449
								break label161; // L: 450
							}

							this.field357 -= var6 * var7; // L: 452
			...
			if (this.field354 < 0) { // L: 457
				if (this.field357 < 0) { // L: 458
					this.field357 = -1; // L: 459
					this.method908(); // L: 460
					this.remove(); // L: 461
				}
			} else if (this.field357 >= var5) { // L: 465
				this.field357 = var5; // L: 466
	...
	public synchronized void method885(int var1) {
		this.method896(var1 << 6, this.method933()); // L: 83
	} // L: 84

	@ObfuscatedName("b")
	synchronized void method886(int var1) {
		this.method896(var1, this.method933()); // L: 87
	} // L: 88

	@ObfuscatedName("m")
	synchronized void method896(int var1, int var2) {
		this.field367 = var1; // L: 91
		this.field356 = var2; // L: 92
		this.field364 = 0; // L: 93
		this.method904(); // L: 94
	} // L: 95

	@ObfuscatedName("t")
	public synchronized int method888() {
		return this.field367 == Integer.MIN_VALUE ? 0 : this.field367; // L: 98
	}

	@ObfuscatedName("h")
	public synchronized int method933() {
		return this.field356 < 0 ? -1 : this.field356; // L: 102
	}
	...
	public synchronized void method911() {
		this.field354 = (this.field354 ^ this.field354 >> 31) + (this.field354 >>> 31); // L: 113
		this.field354 = -this.field354; // L: 114
	} // L: 115

	@ObfuscatedName("u")
	void method908() {
		if (this.field364 != 0) { // L: 118
			if (this.field367 == Integer.MIN_VALUE) {
				this.field367 = 0; // L: 119
			}

			this.field364 = 0; // L: 120
	...
	public synchronized void method893(int var1, int var2) {
		this.method894(var1, var2, this.method933()); // L: 126
	} // L: 127

	@ObfuscatedName("a")
	public synchronized void method894(int var1, int var2, int var3) {
		if (var1 == 0) { // L: 130
			this.method896(var2, var3); // L: 131
		} else {
			int var4 = method980(var2, var3); // L: 134
			int var5 = method878(var2, var3); // L: 135
			if (var4 == this.field358 && var5 == this.field355) { // L: 136
				this.field364 = 0; // L: 137
			} else {
				int var6 = var2 - this.field362; // L: 140
				if (this.field362 - var2 > var6) { // L: 141
					var6 = this.field362 - var2;
				}

				if (var4 - this.field358 > var6) { // L: 142
					var6 = var4 - this.field358;
				}

				if (this.field358 - var4 > var6) { // L: 143
					var6 = this.field358 - var4;
				}

				if (var5 - this.field355 > var6) {
					var6 = var5 - this.field355; // L: 144
				}

				if (this.field355 - var5 > var6) { // L: 145
				...
				this.field364 = var1; // L: 147
				this.field367 = var2; // L: 148
				this.field356 = var3; // L: 149
				this.field365 = (var2 - this.field362) / var1; // L: 150
				this.field359 = (var4 - this.field358) / var1; // L: 151
				this.field353 = (var5 - this.field355) / var1; // L: 152
			}
		}
	} // L: 132 138 153
	...
	public synchronized void method895(int var1) {
		if (var1 == 0) { // L: 156
			this.method886(0); // L: 157
			this.remove(); // L: 158
		} else if (this.field358 == 0 && this.field355 == 0) { // L: 161
			this.field364 = 0; // L: 162
			this.field367 = 0; // L: 163
			this.field362 = 0; // L: 164
			this.remove(); // L: 165
		} else {
			int var2 = -this.field362; // L: 168
			if (this.field362 > var2) { // L: 169
				var2 = this.field362;
			}

			if (-this.field358 > var2) { // L: 170
				var2 = -this.field358;
			}

			if (this.field358 > var2) { // L: 171
				var2 = this.field358;
			}

			if (-this.field355 > var2) { // L: 172
				var2 = -this.field355;
			}

			if (this.field355 > var2) { // L: 173
				var2 = this.field355;
			}
			...
			this.field364 = var1; // L: 175
			this.field367 = Integer.MIN_VALUE; // L: 176
			this.field365 = -this.field362 / var1; // L: 177
			this.field359 = -this.field358 / var1; // L: 178
			this.field353 = -this.field355 / var1; // L: 179
		}
	} // L: 159 166 180

	@ObfuscatedName("d")
	public synchronized void method1014(int var1) {
		if (this.field354 < 0) { // L: 183
			this.field354 = -var1;
		} else {
			this.field354 = var1; // L: 184
		}
	...
	public synchronized int method979() {
		return this.field354 < 0 ? -this.field354 : this.field354; // L: 188
	}

	@ObfuscatedName("g")
	public boolean method898() {
		return this.field357 < 0 || this.field357 >= ((RawSound)super.sound).samples.length << 8; // L: 192
	}

	@ObfuscatedName("y")
	public boolean method899() {
		return this.field364 != 0; // L: 196
	}

	@ObfuscatedName("ax")
	int method905(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field364 > 0) { // L: 474
				int var6 = var2 + this.field364; // L: 475
				if (var6 > var4) { // L: 476
					var6 = var4;
				}

				this.field364 += var2; // L: 477
				if (this.field354 == 256 && (this.field357 & 255) == 0) { // L: 478
					if (PcmPlayer.PcmPlayer_stereo) { // L: 479
						...
						var2 = method915(((RawSound)super.sound).samples, var1, this.field357, var2, this.field362, this.field365, 0, var6, var3, this); // L: 480
					}
					...
					var2 = method919(0, 0, ((RawSound)super.sound).samples, var1, this.field357, var2, this.field362, this.field365, 0, var6, var3, this, this.field354, var5); // L: 484
				}

				this.field364 -= var2; // L: 486
				if (this.field364 != 0) { // L: 487
					return var2;
				}

				if (!this.method957()) { // L: 488
					continue;
				}
			...
			if (this.field354 == 256 && (this.field357 & 255) == 0) { // L: 490
				...
				return method917(((RawSound)super.sound).samples, var1, this.field357, var2, this.field362, 0, var4, var3, this); // L: 492
			}
			...
			return method965(0, 0, ((RawSound)super.sound).samples, var1, this.field357, var2, this.field362, 0, var4, var3, this, this.field354, var5); // L: 496
		}
	}
	...
	int method963(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field364 > 0) { // L: 501
				int var6 = var2 + this.field364; // L: 502
				if (var6 > var4) { // L: 503
					var6 = var4;
				}

				this.field364 += var2; // L: 504
				if (this.field354 == -256 && (this.field357 & 255) == 0) { // L: 505
					if (PcmPlayer.PcmPlayer_stereo) { // L: 506
						...
						var2 = method1002(((RawSound)super.sound).samples, var1, this.field357, var2, this.field362, this.field365, 0, var6, var3, this); // L: 507
					}
					...
					var2 = method921(0, 0, ((RawSound)super.sound).samples, var1, this.field357, var2, this.field362, this.field365, 0, var6, var3, this, this.field354, var5); // L: 511
				}

				this.field364 -= var2; // L: 513
				if (this.field364 != 0) { // L: 514
					return var2;
				}

				if (!this.method957()) { // L: 515
					continue;
				}
			...
			if (this.field354 == -256 && (this.field357 & 255) == 0) { // L: 517
				...
				return method909(((RawSound)super.sound).samples, var1, this.field357, var2, this.field362, 0, var4, var3, this); // L: 519
			}
			...
			return method959(0, 0, ((RawSound)super.sound).samples, var1, this.field357, var2, this.field362, 0, var4, var3, this, this.field354, var5); // L: 523
		}
	}

	@ObfuscatedName("ap")
	boolean method957() {
		int var1 = this.field367; // L: 528
		int var2;
		int var3;
		if (var1 == Integer.MIN_VALUE) { // L: 531
			...
			var2 = method980(var1, this.field356); // L: 537
			var3 = method878(var1, this.field356); // L: 538
		}

		if (var1 == this.field362 && var2 == this.field358 && var3 == this.field355) { // L: 540
			if (this.field367 == Integer.MIN_VALUE) { // L: 570
				this.field367 = 0; // L: 571
				this.field355 = 0; // L: 572
				this.field358 = 0; // L: 573
				this.field362 = 0; // L: 574
				this.remove(); // L: 575
				return true; // L: 576
			} else {
			...
			if (this.field362 < var1) { // L: 541
				this.field365 = 1; // L: 542
				this.field364 = var1 - this.field362; // L: 543
			} else if (this.field362 > var1) { // L: 545
				this.field365 = -1; // L: 546
				this.field364 = this.field362 - var1; // L: 547
			} else {
				this.field365 = 0; // L: 549
			}

			if (this.field358 < var2) { // L: 550
				this.field359 = 1; // L: 551
				if (this.field364 == 0 || this.field364 > var2 - this.field358) { // L: 552
					this.field364 = var2 - this.field358;
				}
			} else if (this.field358 > var2) { // L: 554
				this.field359 = -1; // L: 555
				if (this.field364 == 0 || this.field364 > this.field358 - var2) { // L: 556
					this.field364 = this.field358 - var2;
				}
			} else {
				this.field359 = 0; // L: 558
			}

			if (this.field355 < var3) { // L: 559
				this.field353 = 1; // L: 560
				if (this.field364 == 0 || this.field364 > var3 - this.field355) { // L: 561
					this.field364 = var3 - this.field355;
				}
			} else if (this.field355 > var3) { // L: 563
				this.field353 = -1; // L: 564
				if (this.field364 == 0 || this.field364 > this.field355 - var3) { // L: 565
					this.field364 = this.field355 - var3;
				}
			} else {
				this.field353 = 0; // L: 567
			}
	...
	@ObfuscatedName("av")
	int vmethod1026() {
		int var1 = this.field362 * 3 >> 6; // L: 31
	...
	public static RawPcmStream createRawPcmStream(RawSound var0, int var1, int var2) {
		return var0.samples != null && var0.samples.length != 0 ? new RawPcmStream(var0, (int)((long)var0.sampleRate * 256L * (long)var1 / (long)(class284.field3321 * 100)), var2 << 6) : null; // L: 63 64
	}
	...
	static int method915(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field358 += var9.field359 * (var6 - var3); // L: 783
		var9.field355 += var9.field353 * (var6 - var3); // L: 784
		...
		var9.field362 = var4 >> 2; // L: 801
		var9.field357 = var2 << 8; // L: 802
		return var3; // L: 803
	}
	...
	static int method916(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field362 += var12.field365 * (var9 - var4); // L: 814
		var4 <<= 1; // L: 815
		var9 <<= 1; // L: 816
		...
		var12.field358 = var5 >> 2; // L: 848
		var12.field355 = var6 >> 2; // L: 849
		var12.field357 = var3 << 8; // L: 850
		return var4 >> 1; // L: 851
	}
	...
	static int method1002(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field358 += var9.field359 * (var6 - var3); // L: 860
		var9.field355 += var9.field353 * (var6 - var3); // L: 861
		...
		var9.field362 = var4 >> 2; // L: 878
		var9.field357 = var2 << 8; // L: 879
		return var3; // L: 880
	}
	...
	static int method918(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field362 += var12.field365 * (var9 - var4); // L: 891
		var4 <<= 1; // L: 892
		var9 <<= 1; // L: 893
		...
		var12.field358 = var5 >> 2; // L: 925
		var12.field355 = var6 >> 2; // L: 926
		var12.field357 = var3 << 8; // L: 927
		return var4 >> 1; // L: 928
	}
	...
	static int method919(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field358 -= var11.field359 * var5; // L: 932
		var11.field355 -= var11.field353 * var5; // L: 933
		...
		var11.field358 += var11.field359 * var5; // L: 950
		var11.field355 += var11.field353 * var5; // L: 951
		var11.field362 = var6; // L: 952
		var11.field357 = var4; // L: 953
		return var5; // L: 954
	}
	...
	static int method987(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field362 -= var5 * var13.field365; // L: 958
		...
		var5 >>= 1; // L: 984
		var13.field362 += var13.field365 * var5; // L: 985
		var13.field358 = var6; // L: 986
		var13.field355 = var7; // L: 987
		var13.field357 = var4; // L: 988
		return var5; // L: 989
	}
	...
	static int method921(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field358 -= var11.field359 * var5; // L: 993
		var11.field355 -= var11.field353 * var5; // L: 994
		...
		var11.field358 += var11.field359 * var5; // L: 1011
		var11.field355 += var11.field353 * var5; // L: 1012
		var11.field362 = var6; // L: 1013
		var11.field357 = var4; // L: 1014
		return var5; // L: 1015
	}
	...
	static int method922(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field362 -= var5 * var13.field365; // L: 1019
		...
		var5 >>= 1; // L: 1044
		var13.field362 += var13.field365 * var5; // L: 1045
		var13.field358 = var6; // L: 1046
		var13.field355 = var7; // L: 1047
		var13.field357 = var4; // L: 1048
		return var5; // L: 1049
	}
}
