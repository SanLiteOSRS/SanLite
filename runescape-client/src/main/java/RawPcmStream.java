...
public class RawPcmStream extends PcmStream {
	...
	@ObfuscatedSignature(
		descriptor = "(Lap;III)V"
	)
	RawPcmStream(RawSound var1, int var2, int var3, int var4) {
		super.sound = var1; // L: 51
		this.start = var1.start; // L: 52
		this.end = var1.end; // L: 53
		this.field349 = var1.field274; // L: 54
		this.field338 = var2; // L: 55
		this.field339 = var3; // L: 56
		this.field337 = var4; // L: 57
		this.field343 = 0; // L: 58
		this.method934(); // L: 59
	} // L: 60
	...
	RawPcmStream(RawSound var1, int var2, int var3) {
		...
		this.field349 = var1.field274; // L: 42
		this.field338 = var2; // L: 43
		this.field339 = var3; // L: 44
		this.field337 = 8192; // L: 45
		this.field343 = 0; // L: 46
		this.method934(); // L: 47
	} // L: 48

	@ObfuscatedName("c")
	void method934() {
		this.field341 = this.field339; // L: 73
		this.field342 = method880(this.field339, this.field337); // L: 74
		this.field347 = method916(this.field339, this.field337); // L: 75
	} // L: 76
	...
	protected int vmethod5453() {
		return this.field339 == 0 && this.field348 == 0 ? 0 : 1; // L: 208 209
	}

	@ObfuscatedName("h")
	@Export("fill")
	public synchronized void fill(int[] var1, int var2, int var3) {
		if (this.field339 == 0 && this.field348 == 0) { // L: 213
			...
			int var9 = var2; // L: 223
			var3 += var2; // L: 224
			if (this.field343 < 0) { // L: 225
				if (this.field338 <= 0) { // L: 226
					this.method805(); // L: 228
					this.remove(); // L: 229
					return; // L: 230
				}
			...
			if (this.field343 >= var7) { // L: 233
				if (this.field338 >= 0) { // L: 234
					this.method805(); // L: 236
					this.remove(); // L: 237
					return; // L: 238
				}
			...
			if (this.numLoops < 0) { // L: 241
				if (this.field349) { // L: 242
					if (this.field338 < 0) { // L: 243
						var9 = this.method819(var1, var2, var5, var3, var4.samples[this.start]); // L: 244
						if (this.field343 >= var5) { // L: 245
							return;
						}

						this.field343 = var5 + var5 - 1 - this.field343; // L: 246
						this.field338 = -this.field338; // L: 247
					}

					while (true) {
						var9 = this.method818(var1, var9, var6, var3, var4.samples[this.end - 1]); // L: 250
						if (this.field343 < var6) { // L: 251
							return;
						}

						this.field343 = var6 + var6 - 1 - this.field343; // L: 252
						this.field338 = -this.field338; // L: 253
						var9 = this.method819(var1, var9, var5, var3, var4.samples[this.start]); // L: 254
						if (this.field343 >= var5) { // L: 255
							return;
						}

						this.field343 = var5 + var5 - 1 - this.field343; // L: 256
						this.field338 = -this.field338; // L: 257
					}
				} else if (this.field338 < 0) { // L: 260
					while (true) {
						var9 = this.method819(var1, var9, var5, var3, var4.samples[this.end - 1]); // L: 262
						if (this.field343 >= var5) { // L: 263
							return;
						}

						this.field343 = var6 - 1 - (var6 - 1 - this.field343) % var8; // L: 264
					}
				} else {
					while (true) {
						var9 = this.method818(var1, var9, var6, var3, var4.samples[this.start]); // L: 269
						if (this.field343 < var6) { // L: 270
							return;
						}

						this.field343 = var5 + (this.field343 - var5) % var8; // L: 271
					}
				}
			} else {
				if (this.numLoops > 0) { // L: 275
					if (this.field349) { // L: 276
						label127: {
							if (this.field338 < 0) { // L: 277
								var9 = this.method819(var1, var2, var5, var3, var4.samples[this.start]); // L: 278
								if (this.field343 >= var5) { // L: 279
									return;
								}

								this.field343 = var5 + var5 - 1 - this.field343; // L: 280
								this.field338 = -this.field338; // L: 281
							...
							do {
								var9 = this.method818(var1, var9, var6, var3, var4.samples[this.end - 1]); // L: 285
								if (this.field343 < var6) { // L: 286
									return;
								}

								this.field343 = var6 + var6 - 1 - this.field343; // L: 287
								this.field338 = -this.field338; // L: 288
								if (--this.numLoops == 0) { // L: 289
									break;
								}

								var9 = this.method819(var1, var9, var5, var3, var4.samples[this.start]); // L: 290
								if (this.field343 >= var5) { // L: 291
									return;
								}

								this.field343 = var5 + var5 - 1 - this.field343; // L: 292
								this.field338 = -this.field338; // L: 293
							} while(--this.numLoops != 0); // L: 294
						}
					} else {
						int var10;
						if (this.field338 < 0) { // L: 297
							while (true) {
								var9 = this.method819(var1, var9, var5, var3, var4.samples[this.end - 1]); // L: 299
								if (this.field343 >= var5) { // L: 300
									return;
								}

								var10 = (var6 - 1 - this.field343) / var8; // L: 301
								if (var10 >= this.numLoops) { // L: 302
									this.field343 += var8 * this.numLoops; // L: 303
									this.numLoops = 0; // L: 304
									break; // L: 305
								}

								this.field343 += var8 * var10; // L: 307
								this.numLoops -= var10; // L: 308
							}
						} else {
							while (true) {
								var9 = this.method818(var1, var9, var6, var3, var4.samples[this.start]); // L: 313
								if (this.field343 < var6) { // L: 314
									return;
								}

								var10 = (this.field343 - var5) / var8; // L: 315
								if (var10 >= this.numLoops) { // L: 316
									this.field343 -= var8 * this.numLoops; // L: 317
									this.numLoops = 0; // L: 318
									break; // L: 319
								}

								this.field343 -= var8 * var10; // L: 321
				...
				if (this.field338 < 0) { // L: 326
					this.method819(var1, var9, 0, var3, 0); // L: 327
					if (this.field343 < 0) { // L: 328
						this.field343 = -1; // L: 329
						this.method805(); // L: 330
						this.remove(); // L: 331
					}
				} else {
					this.method818(var1, var9, var7, var3, 0); // L: 335
					if (this.field343 >= var7) { // L: 336
						this.field343 = var7; // L: 337
						this.method805(); // L: 338
						this.remove(); // L: 339
					}
				}
	...
	public synchronized void skip(int var1) {
		if (this.field348 > 0) { // L: 345
			if (var1 >= this.field348) { // L: 346
				if (this.field339 == Integer.MIN_VALUE) { // L: 347
					this.field339 = 0; // L: 348
					this.field347 = 0; // L: 349
					this.field342 = 0; // L: 350
					this.field341 = 0; // L: 351
					this.remove(); // L: 352
					var1 = this.field348; // L: 353
				}

				this.field348 = 0; // L: 355
				this.method934(); // L: 356
			} else {
				this.field341 += this.field350 * var1; // L: 359
				this.field342 += this.field340 * var1; // L: 360
				this.field347 += this.field351 * var1; // L: 361
				this.field348 -= var1; // L: 362
			}
		}
		...
		if (this.field343 < 0) { // L: 371
			if (this.field338 <= 0) { // L: 372
				this.method805(); // L: 374
				this.remove(); // L: 375
				return; // L: 376
			}
		...
		if (this.field343 >= var5) { // L: 379
			if (this.field338 >= 0) { // L: 380
				this.method805(); // L: 382
				this.remove(); // L: 383
				return; // L: 384
			}
		...
		this.field343 += this.field338 * var1; // L: 387
		if (this.numLoops < 0) { // L: 388
			if (!this.field349) { // L: 389
				if (this.field338 < 0) { // L: 404
					if (this.field343 >= var3) { // L: 405
						return;
					}

					this.field343 = var4 - 1 - (var4 - 1 - this.field343) % var6; // L: 406
				} else {
					if (this.field343 < var4) { // L: 409
						return;
					}

					this.field343 = var3 + (this.field343 - var3) % var6; // L: 410
				}

			} else {
				if (this.field338 < 0) { // L: 390
					if (this.field343 >= var3) { // L: 391
						return;
					}

					this.field343 = var3 + var3 - 1 - this.field343; // L: 392
					this.field338 = -this.field338; // L: 393
				}

				while (this.field343 >= var4) { // L: 396
					this.field343 = var4 + var4 - 1 - this.field343; // L: 397
					this.field338 = -this.field338; // L: 398
					if (this.field343 >= var3) { // L: 399
						return;
					}

					this.field343 = var3 + var3 - 1 - this.field343; // L: 400
					this.field338 = -this.field338; // L: 401
				}

			}
		} else {
			if (this.numLoops > 0) { // L: 414
				if (this.field349) { // L: 415
					label129: {
						if (this.field338 < 0) { // L: 416
							if (this.field343 >= var3) { // L: 417
								return;
							}

							this.field343 = var3 + var3 - 1 - this.field343; // L: 418
							this.field338 = -this.field338; // L: 419
						...
						do {
							if (this.field343 < var4) { // L: 423
								return;
							}

							this.field343 = var4 + var4 - 1 - this.field343; // L: 424
							this.field338 = -this.field338; // L: 425
							if (--this.numLoops == 0) { // L: 426
								break;
							}

							if (this.field343 >= var3) { // L: 427
								return;
							}

							this.field343 = var3 + var3 - 1 - this.field343; // L: 428
							this.field338 = -this.field338; // L: 429
						} while(--this.numLoops != 0); // L: 430
					}
				} else {
					label161: {
						int var7;
						if (this.field338 < 0) { // L: 433
							if (this.field343 >= var3) { // L: 434
								return;
							}

							var7 = (var4 - 1 - this.field343) / var6; // L: 435
							if (var7 >= this.numLoops) { // L: 436
								this.field343 += var6 * this.numLoops; // L: 437
								this.numLoops = 0; // L: 438
								break label161; // L: 439
							}

							this.field343 += var6 * var7; // L: 441
							this.numLoops -= var7; // L: 442
						} else {
							if (this.field343 < var4) { // L: 445
								return;
							}

							var7 = (this.field343 - var3) / var6; // L: 446
							if (var7 >= this.numLoops) { // L: 447
								this.field343 -= var6 * this.numLoops; // L: 448
								this.numLoops = 0; // L: 449
								break label161; // L: 450
							}

							this.field343 -= var6 * var7; // L: 452
			...
			if (this.field338 < 0) { // L: 457
				if (this.field343 < 0) { // L: 458
					this.field343 = -1; // L: 459
					this.method805(); // L: 460
					this.remove(); // L: 461
				}
			} else if (this.field343 >= var5) { // L: 465
				this.field343 = var5; // L: 466
				this.method805(); // L: 467
				this.remove(); // L: 468
			}
	...
	public synchronized void method798(int var1) {
		this.method894(var1 << 6, this.method840()); // L: 83
	} // L: 84

	@ObfuscatedName("x")
	synchronized void method814(int var1) {
		this.method894(var1, this.method840()); // L: 87
	} // L: 88

	@ObfuscatedName("g")
	synchronized void method894(int var1, int var2) {
		this.field339 = var1; // L: 91
		this.field337 = var2; // L: 92
		this.field348 = 0; // L: 93
		this.method934(); // L: 94
	} // L: 95
	...
	public synchronized int method840() {
		return this.field337 < 0 ? -1 : this.field337; // L: 102
	}
	...
	public synchronized void method815() {
		this.field338 = (this.field338 ^ this.field338 >> 31) + (this.field338 >>> 31); // L: 113
		this.field338 = -this.field338; // L: 114
	} // L: 115

	@ObfuscatedName("k")
	void method805() {
		if (this.field348 != 0) { // L: 118
			if (this.field339 == Integer.MIN_VALUE) {
				this.field339 = 0; // L: 119
			}

			this.field348 = 0; // L: 120
			this.method934(); // L: 121
		}
	...
	public synchronized void method806(int var1, int var2) {
		this.method807(var1, var2, this.method840()); // L: 126
	} // L: 127

	@ObfuscatedName("t")
	public synchronized void method807(int var1, int var2, int var3) {
		if (var1 == 0) { // L: 130
			this.method894(var2, var3); // L: 131
		} else {
			int var4 = method880(var2, var3); // L: 134
			int var5 = method916(var2, var3); // L: 135
			if (var4 == this.field342 && var5 == this.field347) { // L: 136
				this.field348 = 0; // L: 137
			} else {
				int var6 = var2 - this.field341; // L: 140
				if (this.field341 - var2 > var6) { // L: 141
					var6 = this.field341 - var2;
				}

				if (var4 - this.field342 > var6) { // L: 142
					var6 = var4 - this.field342;
				}

				if (this.field342 - var4 > var6) { // L: 143
					var6 = this.field342 - var4;
				}

				if (var5 - this.field347 > var6) {
					var6 = var5 - this.field347; // L: 144
				}

				if (this.field347 - var5 > var6) { // L: 145
				...
				this.field348 = var1; // L: 147
				this.field339 = var2; // L: 148
				this.field337 = var3; // L: 149
				this.field350 = (var2 - this.field341) / var1; // L: 150
				this.field340 = (var4 - this.field342) / var1; // L: 151
				this.field351 = (var5 - this.field347) / var1; // L: 152
			}
		}
	} // L: 132 138 153
	...
	public synchronized void method823(int var1) {
		if (var1 == 0) { // L: 156
			...
			this.remove(); // L: 158
		} else if (this.field342 == 0 && this.field347 == 0) { // L: 161
			this.field348 = 0; // L: 162
			this.field339 = 0; // L: 163
			this.field341 = 0; // L: 164
			this.remove(); // L: 165
		} else {
			int var2 = -this.field341; // L: 168
			if (this.field341 > var2) { // L: 169
				var2 = this.field341;
			}

			if (-this.field342 > var2) { // L: 170
				var2 = -this.field342;
			}

			if (this.field342 > var2) { // L: 171
				var2 = this.field342;
			}

			if (-this.field347 > var2) { // L: 172
				var2 = -this.field347;
			}

			if (this.field347 > var2) { // L: 173
				var2 = this.field347;
			}
			...
			this.field348 = var1; // L: 175
			this.field339 = Integer.MIN_VALUE; // L: 176
			this.field350 = -this.field341 / var1; // L: 177
			this.field340 = -this.field342 / var1; // L: 178
			this.field351 = -this.field347 / var1; // L: 179
		}
	} // L: 159 166 180

	@ObfuscatedName("s")
	public synchronized void method809(int var1) {
		if (this.field338 < 0) { // L: 183
			this.field338 = -var1;
		} else {
			this.field338 = var1; // L: 184
		}
	...
	public synchronized int method844() {
		return this.field338 < 0 ? -this.field338 : this.field338; // L: 188
	}

	@ObfuscatedName("r")
	public boolean method859() {
		return this.field343 < 0 || this.field343 >= ((RawSound)super.sound).samples.length << 8; // L: 192
	}

	@ObfuscatedName("al")
	public boolean method908() {
		return this.field348 != 0; // L: 196
	}

	@ObfuscatedName("aw")
	int method818(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field348 > 0) { // L: 474
				int var6 = var2 + this.field348; // L: 475
				if (var6 > var4) { // L: 476
					var6 = var4;
				}

				this.field348 += var2; // L: 477
				if (this.field338 == 256 && (this.field343 & 255) == 0) { // L: 478
					if (PcmPlayer.PcmPlayer_stereo) { // L: 479
						...
						var2 = method829(((RawSound)super.sound).samples, var1, this.field343, var2, this.field341, this.field350, 0, var6, var3, this); // L: 480
					}
					...
					var2 = method833(0, 0, ((RawSound)super.sound).samples, var1, this.field343, var2, this.field341, this.field350, 0, var6, var3, this, this.field338, var5); // L: 484
				}

				this.field348 -= var2; // L: 486
				if (this.field348 != 0) { // L: 487
					return var2;
				}

				if (!this.method820()) { // L: 488
					continue;
				}
			...
			if (this.field338 == 256 && (this.field343 & 255) == 0) { // L: 490
				...
				return method821(((RawSound)super.sound).samples, var1, this.field343, var2, this.field341, 0, var4, var3, this); // L: 492
			}
			...
			return method825(0, 0, ((RawSound)super.sound).samples, var1, this.field343, var2, this.field341, 0, var4, var3, this, this.field338, var5); // L: 496
		}
	}

	@ObfuscatedName("at")
	int vmethod959() {
		int var1 = this.field341 * 3 >> 6; // L: 31
	...
	int method819(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field348 > 0) { // L: 501
				int var6 = var2 + this.field348; // L: 502
				if (var6 > var4) { // L: 503
					var6 = var4;
				}

				this.field348 += var2; // L: 504
				if (this.field338 == -256 && (this.field343 & 255) == 0) { // L: 505
					if (PcmPlayer.PcmPlayer_stereo) { // L: 506
						...
						var2 = method831(((RawSound)super.sound).samples, var1, this.field343, var2, this.field341, this.field350, 0, var6, var3, this); // L: 507
					}
					...
					var2 = method835(0, 0, ((RawSound)super.sound).samples, var1, this.field343, var2, this.field341, this.field350, 0, var6, var3, this, this.field338, var5); // L: 511
				}

				this.field348 -= var2; // L: 513
				if (this.field348 != 0) { // L: 514
					return var2;
				}

				if (!this.method820()) { // L: 515
					continue;
				}
			...
			if (this.field338 == -256 && (this.field343 & 255) == 0) { // L: 517
				...
				return method869(((RawSound)super.sound).samples, var1, this.field343, var2, this.field341, 0, var4, var3, this); // L: 519
			}
			...
			return method827(0, 0, ((RawSound)super.sound).samples, var1, this.field343, var2, this.field341, 0, var4, var3, this, this.field338, var5); // L: 523
		}
	}
	...
	boolean method820() {
		...
		if (var1 == Integer.MIN_VALUE) { // L: 531
			...
			var2 = method880(var1, this.field337); // L: 537
			var3 = method916(var1, this.field337); // L: 538
		}

		if (var1 == this.field341 && var2 == this.field342 && var3 == this.field347) { // L: 540
			if (this.field339 == Integer.MIN_VALUE) { // L: 570
				this.field339 = 0; // L: 571
				this.field347 = 0; // L: 572
				this.field342 = 0; // L: 573
				this.field341 = 0; // L: 574
				this.remove(); // L: 575
				return true; // L: 576
			} else {
				this.method934(); // L: 578
				return false; // L: 579
			}
		} else {
			if (this.field341 < var1) { // L: 541
				this.field350 = 1; // L: 542
				this.field348 = var1 - this.field341; // L: 543
			} else if (this.field341 > var1) { // L: 545
				this.field350 = -1; // L: 546
				this.field348 = this.field341 - var1; // L: 547
			} else {
				this.field350 = 0; // L: 549
			}

			if (this.field342 < var2) { // L: 550
				this.field340 = 1; // L: 551
				if (this.field348 == 0 || this.field348 > var2 - this.field342) { // L: 552
					this.field348 = var2 - this.field342;
				}
			} else if (this.field342 > var2) { // L: 554
				this.field340 = -1; // L: 555
				if (this.field348 == 0 || this.field348 > this.field342 - var2) { // L: 556
					this.field348 = this.field342 - var2;
				}
			} else {
				this.field340 = 0; // L: 558
			}

			if (this.field347 < var3) { // L: 559
				this.field351 = 1; // L: 560
				if (this.field348 == 0 || this.field348 > var3 - this.field347) { // L: 561
					this.field348 = var3 - this.field347;
				}
			} else if (this.field347 > var3) { // L: 563
				this.field351 = -1; // L: 564
				if (this.field348 == 0 || this.field348 > this.field347 - var3) { // L: 565
					this.field348 = this.field347 - var3;
				}
			} else {
				this.field351 = 0; // L: 567
			}
	...
	@ObfuscatedName("f")
	@ObfuscatedSignature(
		descriptor = "(Lap;II)Lav;"
	)
	@Export("createRawPcmStream")
	public static RawPcmStream createRawPcmStream(RawSound var0, int var1, int var2) {
		return var0.samples != null && var0.samples.length != 0 ? new RawPcmStream(var0, (int)((long)var0.sampleRate * 256L * (long)var1 / (long)(class301.field3595 * 100)), var2 << 6) : null; // L: 63 64
	}

	@ObfuscatedName("u")
	@ObfuscatedSignature(
		descriptor = "(Lap;III)Lav;"
	)
	...
	static int method821(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, RawPcmStream var8) {
		...
		var8.field343 = var2 << 8; // L: 598
		return var3; // L: 599
	}

	@ObfuscatedName("aa")
	@ObfuscatedSignature(
		descriptor = "(I[B[IIIIIIIILav;)I"
	)
	...
	static int method824(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, RawPcmStream var10) {
		...
		var10.field343 = var3 << 8; // L: 684
		return var4 >> 1; // L: 685
	}

	@ObfuscatedName("ay")
	@ObfuscatedSignature(
		descriptor = "(II[B[IIIIIIILav;II)I"
	)
	static int method825(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, RawPcmStream var10, int var11, int var12) {
		...
		var10.field343 = var4; // L: 703
		return var5; // L: 704
	}

	@ObfuscatedName("ak")
	@ObfuscatedSignature(
		descriptor = "(II[B[IIIIIIIILav;II)I"
	)
	...
	static int method828(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		...
		var11.field343 = var4; // L: 773
		return var5 >> 1; // L: 774
	}

	@ObfuscatedName("ad")
	@ObfuscatedSignature(
		descriptor = "([B[IIIIIIIILav;)I"
	)
	static int method829(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field342 += var9.field340 * (var6 - var3); // L: 783
		var9.field347 += var9.field351 * (var6 - var3); // L: 784
		...
		var9.field341 = var4 >> 2; // L: 801
		var9.field343 = var2 << 8; // L: 802
		return var3; // L: 803
	}

	@ObfuscatedName("az")
	@ObfuscatedSignature(
		descriptor = "(I[B[IIIIIIIIIILav;)I"
	)
	static int method937(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field341 += var12.field350 * (var9 - var4); // L: 814
		var4 <<= 1; // L: 815
		var9 <<= 1; // L: 816
		...
		var12.field342 = var5 >> 2; // L: 848
		var12.field347 = var6 >> 2; // L: 849
		var12.field343 = var3 << 8; // L: 850
		return var4 >> 1; // L: 851
	}
	...
	static int method831(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field342 += var9.field340 * (var6 - var3); // L: 860
		var9.field347 += var9.field351 * (var6 - var3); // L: 861
		...
		var9.field341 = var4 >> 2; // L: 878
		var9.field343 = var2 << 8; // L: 879
		return var3; // L: 880
	}
	...
	static int method832(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field341 += var12.field350 * (var9 - var4); // L: 891
		var4 <<= 1; // L: 892
		var9 <<= 1; // L: 893
		...
		var12.field342 = var5 >> 2; // L: 925
		var12.field347 = var6 >> 2; // L: 926
		var12.field343 = var3 << 8; // L: 927
		return var4 >> 1; // L: 928
	}
	...
	static int method833(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field342 -= var11.field340 * var5; // L: 932
		var11.field347 -= var11.field351 * var5; // L: 933
		...
		var11.field342 += var11.field340 * var5; // L: 950
		var11.field347 += var11.field351 * var5; // L: 951
		var11.field341 = var6; // L: 952
		var11.field343 = var4; // L: 953
		return var5; // L: 954
	}

	@ObfuscatedName("bv")
	@ObfuscatedSignature(
		descriptor = "(II[B[IIIIIIIIIILav;II)I"
	)
	static int method834(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field341 -= var5 * var13.field350; // L: 958
		...
		var5 >>= 1; // L: 984
		var13.field341 += var13.field350 * var5; // L: 985
		var13.field342 = var6; // L: 986
		var13.field347 = var7; // L: 987
		var13.field343 = var4; // L: 988
		return var5; // L: 989
	}
	...
	static int method835(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field342 -= var11.field340 * var5; // L: 993
		var11.field347 -= var11.field351 * var5; // L: 994
		...
		var11.field342 += var11.field340 * var5; // L: 1011
		var11.field347 += var11.field351 * var5; // L: 1012
		var11.field341 = var6; // L: 1013
		var11.field343 = var4; // L: 1014
		return var5; // L: 1015
	}
	...
	static int method836(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field341 -= var5 * var13.field350; // L: 1019
		...
		var5 >>= 1; // L: 1044
		var13.field341 += var13.field350 * var5; // L: 1045
		var13.field342 = var6; // L: 1046
		var13.field347 = var7; // L: 1047
		var13.field343 = var4; // L: 1048
		return var5; // L: 1049
	}
}
