...
public class RawPcmStream extends PcmStream {
	...
	RawPcmStream(RawSound var1, int var2, int var3, int var4) {
		...
		this.field368 = var1.field283; // L: 54
		this.field356 = var2; // L: 55
		this.field357 = var3; // L: 56
		this.field358 = var4; // L: 57
		this.field365 = 0; // L: 58
		this.method1007(); // L: 59
	} // L: 60
	...
	RawPcmStream(RawSound var1, int var2, int var3) {
		...
		this.field368 = var1.field283; // L: 42
		this.field356 = var2; // L: 43
		this.field357 = var3; // L: 44
		this.field358 = 8192; // L: 45
		this.field365 = 0; // L: 46
		this.method1007(); // L: 47
	} // L: 48

	@ObfuscatedName("ac")
	void method1007() {
		this.field359 = this.field357; // L: 73
		this.field367 = method945(this.field357, this.field358); // L: 74
		this.field361 = method901(this.field357, this.field358); // L: 75
	} // L: 76
	...
	protected int vmethod5973() {
		return this.field357 == 0 && this.field366 == 0 ? 0 : 1; // L: 208 209
	}

	@ObfuscatedName("aa")
	@Export("fill")
	public synchronized void fill(int[] var1, int var2, int var3) {
		if (this.field357 == 0 && this.field366 == 0) { // L: 213
			...
			int var9 = var2; // L: 223
			var3 += var2; // L: 224
			if (this.field365 < 0) { // L: 225
				if (this.field356 <= 0) { // L: 226
					this.method946(); // L: 228
					this.remove(); // L: 229
					return; // L: 230
				}
			...
			if (this.field365 >= var7) { // L: 233
				if (this.field356 >= 0) { // L: 234
					this.method946(); // L: 236
					this.remove(); // L: 237
					return; // L: 238
				}
			...
			if (this.numLoops < 0) { // L: 241
				if (this.field368) { // L: 242
					if (this.field356 < 0) { // L: 243
						var9 = this.method928(var1, var2, var5, var3, var4.samples[this.start]); // L: 244
						if (this.field365 >= var5) { // L: 245
							return;
						}

						this.field365 = var5 + var5 - 1 - this.field365; // L: 246
						this.field356 = -this.field356; // L: 247
					}

					while (true) {
						var9 = this.method949(var1, var9, var6, var3, var4.samples[this.end - 1]); // L: 250
						if (this.field365 < var6) { // L: 251
							return;
						}

						this.field365 = var6 + var6 - 1 - this.field365; // L: 252
						this.field356 = -this.field356; // L: 253
						var9 = this.method928(var1, var9, var5, var3, var4.samples[this.start]); // L: 254
						if (this.field365 >= var5) { // L: 255
							return;
						}

						this.field365 = var5 + var5 - 1 - this.field365; // L: 256
						this.field356 = -this.field356; // L: 257
					}
				} else if (this.field356 < 0) { // L: 260
					while (true) {
						var9 = this.method928(var1, var9, var5, var3, var4.samples[this.end - 1]); // L: 262
						if (this.field365 >= var5) { // L: 263
							return;
						}

						this.field365 = var6 - 1 - (var6 - 1 - this.field365) % var8; // L: 264
					}
				} else {
					while (true) {
						var9 = this.method949(var1, var9, var6, var3, var4.samples[this.start]); // L: 269
						if (this.field365 < var6) { // L: 270
							return;
						}

						this.field365 = var5 + (this.field365 - var5) % var8; // L: 271
					}
				}
			} else {
				if (this.numLoops > 0) { // L: 275
					if (this.field368) { // L: 276
						label127: {
							if (this.field356 < 0) { // L: 277
								var9 = this.method928(var1, var2, var5, var3, var4.samples[this.start]); // L: 278
								if (this.field365 >= var5) { // L: 279
									return;
								}

								this.field365 = var5 + var5 - 1 - this.field365; // L: 280
								this.field356 = -this.field356; // L: 281
							...
							do {
								var9 = this.method949(var1, var9, var6, var3, var4.samples[this.end - 1]); // L: 285
								if (this.field365 < var6) { // L: 286
									return;
								}

								this.field365 = var6 + var6 - 1 - this.field365; // L: 287
								this.field356 = -this.field356; // L: 288
								if (--this.numLoops == 0) { // L: 289
									break;
								}

								var9 = this.method928(var1, var9, var5, var3, var4.samples[this.start]); // L: 290
								if (this.field365 >= var5) { // L: 291
									return;
								}

								this.field365 = var5 + var5 - 1 - this.field365; // L: 292
								this.field356 = -this.field356; // L: 293
							} while(--this.numLoops != 0); // L: 294
						}
					} else {
						int var10;
						if (this.field356 < 0) { // L: 297
							while (true) {
								var9 = this.method928(var1, var9, var5, var3, var4.samples[this.end - 1]); // L: 299
								if (this.field365 >= var5) { // L: 300
									return;
								}

								var10 = (var6 - 1 - this.field365) / var8; // L: 301
								if (var10 >= this.numLoops) { // L: 302
									this.field365 += var8 * this.numLoops; // L: 303
									this.numLoops = 0; // L: 304
									break; // L: 305
								}

								this.field365 += var8 * var10; // L: 307
								this.numLoops -= var10; // L: 308
							}
						} else {
							while (true) {
								var9 = this.method949(var1, var9, var6, var3, var4.samples[this.start]); // L: 313
								if (this.field365 < var6) { // L: 314
									return;
								}

								var10 = (this.field365 - var5) / var8; // L: 315
								if (var10 >= this.numLoops) { // L: 316
									this.field365 -= var8 * this.numLoops; // L: 317
									this.numLoops = 0; // L: 318
									break; // L: 319
								}

								this.field365 -= var8 * var10; // L: 321
				...
				if (this.field356 < 0) { // L: 326
					this.method928(var1, var9, 0, var3, 0); // L: 327
					if (this.field365 < 0) { // L: 328
						this.field365 = -1; // L: 329
						this.method946(); // L: 330
						this.remove(); // L: 331
					}
				} else {
					this.method949(var1, var9, var7, var3, 0); // L: 335
					if (this.field365 >= var7) { // L: 336
						this.field365 = var7; // L: 337
						this.method946(); // L: 338
						this.remove(); // L: 339
					}
				}
	...
	public synchronized void skip(int var1) {
		if (this.field366 > 0) { // L: 345
			if (var1 >= this.field366) { // L: 346
				if (this.field357 == Integer.MIN_VALUE) { // L: 347
					this.field357 = 0; // L: 348
					this.field361 = 0; // L: 349
					this.field367 = 0; // L: 350
					this.field359 = 0; // L: 351
					this.remove(); // L: 352
					var1 = this.field366; // L: 353
				}

				this.field366 = 0; // L: 355
				this.method1007(); // L: 356
			} else {
				this.field359 += this.field355 * var1; // L: 359
				this.field367 += this.field360 * var1; // L: 360
				this.field361 += this.field369 * var1; // L: 361
				this.field366 -= var1; // L: 362
			}
		}
		...
		if (this.field365 < 0) { // L: 371
			if (this.field356 <= 0) { // L: 372
				this.method946(); // L: 374
				this.remove(); // L: 375
				return; // L: 376
			}
		...
		if (this.field365 >= var5) { // L: 379
			if (this.field356 >= 0) { // L: 380
				this.method946(); // L: 382
				this.remove(); // L: 383
				return; // L: 384
			}
		...
		this.field365 += this.field356 * var1; // L: 387
		if (this.numLoops < 0) { // L: 388
			if (!this.field368) { // L: 389
				if (this.field356 < 0) { // L: 404
					if (this.field365 >= var3) { // L: 405
						return;
					}

					this.field365 = var4 - 1 - (var4 - 1 - this.field365) % var6; // L: 406
				} else {
					if (this.field365 < var4) { // L: 409
						return;
					}

					this.field365 = var3 + (this.field365 - var3) % var6; // L: 410
				}

			} else {
				if (this.field356 < 0) { // L: 390
					if (this.field365 >= var3) { // L: 391
						return;
					}

					this.field365 = var3 + var3 - 1 - this.field365; // L: 392
					this.field356 = -this.field356; // L: 393
				}

				while (this.field365 >= var4) { // L: 396
					this.field365 = var4 + var4 - 1 - this.field365; // L: 397
					this.field356 = -this.field356; // L: 398
					if (this.field365 >= var3) { // L: 399
						return;
					}

					this.field365 = var3 + var3 - 1 - this.field365; // L: 400
					this.field356 = -this.field356; // L: 401
				}
			...
			if (this.numLoops > 0) { // L: 414
				if (this.field368) { // L: 415
					label129: {
						if (this.field356 < 0) { // L: 416
							if (this.field365 >= var3) { // L: 417
								return;
							}

							this.field365 = var3 + var3 - 1 - this.field365; // L: 418
							this.field356 = -this.field356; // L: 419
						...
						do {
							if (this.field365 < var4) { // L: 423
								return;
							}

							this.field365 = var4 + var4 - 1 - this.field365; // L: 424
							this.field356 = -this.field356; // L: 425
							if (--this.numLoops == 0) { // L: 426
								break;
							}

							if (this.field365 >= var3) { // L: 427
								return;
							}

							this.field365 = var3 + var3 - 1 - this.field365; // L: 428
							this.field356 = -this.field356; // L: 429
						} while(--this.numLoops != 0); // L: 430
					}
				} else {
					label161: {
						int var7;
						if (this.field356 < 0) { // L: 433
							if (this.field365 >= var3) { // L: 434
								return;
							}

							var7 = (var4 - 1 - this.field365) / var6; // L: 435
							if (var7 >= this.numLoops) { // L: 436
								this.field365 += var6 * this.numLoops; // L: 437
								this.numLoops = 0; // L: 438
								break label161; // L: 439
							}

							this.field365 += var6 * var7; // L: 441
							this.numLoops -= var7; // L: 442
						} else {
							if (this.field365 < var4) { // L: 445
								return;
							}

							var7 = (this.field365 - var3) / var6; // L: 446
							if (var7 >= this.numLoops) { // L: 447
								this.field365 -= var6 * this.numLoops; // L: 448
								this.numLoops = 0; // L: 449
								break label161; // L: 450
							}

							this.field365 -= var6 * var7; // L: 452
			...
			if (this.field356 < 0) { // L: 457
				if (this.field365 < 0) { // L: 458
					this.field365 = -1; // L: 459
					this.method946(); // L: 460
					this.remove(); // L: 461
				}
			} else if (this.field365 >= var5) { // L: 465
				this.field365 = var5; // L: 466
				this.method946(); // L: 467
				this.remove(); // L: 468
			}
	...
	public synchronized void method907(int var1) {
		this.method909(var1 << 6, this.method911()); // L: 83
	} // L: 84

	@ObfuscatedName("al")
	synchronized void method1039(int var1) {
		this.method909(var1, this.method911()); // L: 87
	} // L: 88

	@ObfuscatedName("an")
	synchronized void method909(int var1, int var2) {
		this.field357 = var1; // L: 91
		this.field358 = var2; // L: 92
		this.field366 = 0; // L: 93
		this.method1007(); // L: 94
	} // L: 95

	@ObfuscatedName("ar")
	public synchronized int method910() {
		return this.field357 == Integer.MIN_VALUE ? 0 : this.field357; // L: 98
	}

	@ObfuscatedName("ab")
	public synchronized int method911() {
		return this.field358 < 0 ? -1 : this.field358; // L: 102
	}
	...
	public synchronized void method968() {
		this.field356 = (this.field356 ^ this.field356 >> 31) + (this.field356 >>> 31); // L: 113
		this.field356 = -this.field356; // L: 114
	} // L: 115

	@ObfuscatedName("ax")
	void method946() {
		if (this.field366 != 0) { // L: 118
			if (this.field357 == Integer.MIN_VALUE) {
				this.field357 = 0; // L: 119
			}

			this.field366 = 0; // L: 120
			this.method1007(); // L: 121
		}
	...
	public synchronized void method952(int var1, int var2) {
		this.method925(var1, var2, this.method911()); // L: 126
	} // L: 127
	...
	public synchronized void method925(int var1, int var2, int var3) {
		if (var1 == 0) { // L: 130
			...
			int var4 = method945(var2, var3); // L: 134
			int var5 = method901(var2, var3); // L: 135
			if (var4 == this.field367 && var5 == this.field361) { // L: 136
				this.field366 = 0; // L: 137
			} else {
				int var6 = var2 - this.field359; // L: 140
				if (this.field359 - var2 > var6) { // L: 141
					var6 = this.field359 - var2;
				}

				if (var4 - this.field367 > var6) { // L: 142
					var6 = var4 - this.field367;
				}

				if (this.field367 - var4 > var6) { // L: 143
					var6 = this.field367 - var4;
				}

				if (var5 - this.field361 > var6) {
					var6 = var5 - this.field361; // L: 144
				}

				if (this.field361 - var5 > var6) { // L: 145
				...
				this.field366 = var1; // L: 147
				this.field357 = var2; // L: 148
				this.field358 = var3; // L: 149
				this.field355 = (var2 - this.field359) / var1; // L: 150
				this.field360 = (var4 - this.field367) / var1; // L: 151
				this.field369 = (var5 - this.field361) / var1; // L: 152
			}
		}
	} // L: 132 138 153
	...
	public synchronized void method917(int var1) {
		if (var1 == 0) { // L: 156
			this.method1039(0); // L: 157
			this.remove(); // L: 158
		} else if (this.field367 == 0 && this.field361 == 0) { // L: 161
			this.field366 = 0; // L: 162
			this.field357 = 0; // L: 163
			this.field359 = 0; // L: 164
			this.remove(); // L: 165
		} else {
			int var2 = -this.field359; // L: 168
			if (this.field359 > var2) { // L: 169
				var2 = this.field359;
			}

			if (-this.field367 > var2) { // L: 170
				var2 = -this.field367;
			}

			if (this.field367 > var2) { // L: 171
				var2 = this.field367;
			}

			if (-this.field361 > var2) { // L: 172
				var2 = -this.field361;
			}

			if (this.field361 > var2) { // L: 173
				var2 = this.field361;
			}
			...
			this.field366 = var1; // L: 175
			this.field357 = Integer.MIN_VALUE; // L: 176
			this.field355 = -this.field359 / var1; // L: 177
			this.field360 = -this.field367 / var1; // L: 178
			this.field369 = -this.field361 / var1; // L: 179
		}
	} // L: 159 166 180

	@ObfuscatedName("aj")
	public synchronized void method918(int var1) {
		if (this.field356 < 0) { // L: 183
			this.field356 = -var1;
		} else {
			this.field356 = var1; // L: 184
		}
	...
	public synchronized int method919() {
		return this.field356 < 0 ? -this.field356 : this.field356; // L: 188
	}

	@ObfuscatedName("aw")
	public boolean method920() {
		return this.field365 < 0 || this.field365 >= ((RawSound)super.sound).samples.length << 8; // L: 192
	}

	@ObfuscatedName("ak")
	public boolean method921() {
		return this.field366 != 0; // L: 196
	}

	@ObfuscatedName("bh")
	int method949(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field366 > 0) { // L: 474
				int var6 = var2 + this.field366; // L: 475
				if (var6 > var4) { // L: 476
					var6 = var4;
				}

				this.field366 += var2; // L: 477
				if (this.field356 == 256 && (this.field365 & 255) == 0) { // L: 478
					if (PcmPlayer.PcmPlayer_stereo) { // L: 479
						...
						var2 = method938(((RawSound)super.sound).samples, var1, this.field365, var2, this.field359, this.field355, 0, var6, var3, this); // L: 480
					}
					...
					var2 = method942(0, 0, ((RawSound)super.sound).samples, var1, this.field365, var2, this.field359, this.field355, 0, var6, var3, this, this.field356, var5); // L: 484
				}

				this.field366 -= var2; // L: 486
				if (this.field366 != 0) { // L: 487
					return var2;
				}

				if (!this.method1000()) { // L: 488
					continue;
				}
			...
			if (this.field356 == 256 && (this.field365 & 255) == 0) { // L: 490
				...
				return method903(((RawSound)super.sound).samples, var1, this.field365, var2, this.field359, 0, var4, var3, this); // L: 492
			}
			...
			return method934(0, 0, ((RawSound)super.sound).samples, var1, this.field365, var2, this.field359, 0, var4, var3, this, this.field356, var5); // L: 496
		}
	}
	...
	int method928(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field366 > 0) { // L: 501
				int var6 = var2 + this.field366; // L: 502
				if (var6 > var4) { // L: 503
					var6 = var4;
				}

				this.field366 += var2; // L: 504
				if (this.field356 == -256 && (this.field365 & 255) == 0) { // L: 505
					if (PcmPlayer.PcmPlayer_stereo) { // L: 506
						...
						var2 = method940(((RawSound)super.sound).samples, var1, this.field365, var2, this.field359, this.field355, 0, var6, var3, this); // L: 507
					}
					...
					var2 = method1008(0, 0, ((RawSound)super.sound).samples, var1, this.field365, var2, this.field359, this.field355, 0, var6, var3, this, this.field356, var5); // L: 511
				}

				this.field366 -= var2; // L: 513
				if (this.field366 != 0) { // L: 514
					return var2;
				}

				if (!this.method1000()) { // L: 515
					continue;
				}
			...
			if (this.field356 == -256 && (this.field365 & 255) == 0) { // L: 517
				...
				return method932(((RawSound)super.sound).samples, var1, this.field365, var2, this.field359, 0, var4, var3, this); // L: 519
			}
			...
			return method915(0, 0, ((RawSound)super.sound).samples, var1, this.field365, var2, this.field359, 0, var4, var3, this, this.field356, var5); // L: 523
		}
	}

	@ObfuscatedName("bf")
	boolean method1000() {
		int var1 = this.field357; // L: 528
		int var2;
		int var3;
		if (var1 == Integer.MIN_VALUE) { // L: 531
			...
			var2 = method945(var1, this.field358); // L: 537
			var3 = method901(var1, this.field358); // L: 538
		}

		if (var1 == this.field359 && var2 == this.field367 && var3 == this.field361) { // L: 540
			if (this.field357 == Integer.MIN_VALUE) { // L: 570
				this.field357 = 0; // L: 571
				this.field361 = 0; // L: 572
				this.field367 = 0; // L: 573
				this.field359 = 0; // L: 574
				this.remove(); // L: 575
				return true; // L: 576
			} else {
				this.method1007(); // L: 578
				return false; // L: 579
			}
		} else {
			if (this.field359 < var1) { // L: 541
				this.field355 = 1; // L: 542
				this.field366 = var1 - this.field359; // L: 543
			} else if (this.field359 > var1) { // L: 545
				this.field355 = -1; // L: 546
				this.field366 = this.field359 - var1; // L: 547
			} else {
				this.field355 = 0; // L: 549
			}

			if (this.field367 < var2) { // L: 550
				this.field360 = 1; // L: 551
				if (this.field366 == 0 || this.field366 > var2 - this.field367) { // L: 552
					this.field366 = var2 - this.field367;
				}
			} else if (this.field367 > var2) { // L: 554
				this.field360 = -1; // L: 555
				if (this.field366 == 0 || this.field366 > this.field367 - var2) { // L: 556
					this.field366 = this.field367 - var2;
				}
			} else {
				this.field360 = 0; // L: 558
			}

			if (this.field361 < var3) { // L: 559
				this.field369 = 1; // L: 560
				if (this.field366 == 0 || this.field366 > var3 - this.field361) { // L: 561
					this.field366 = var3 - this.field361;
				}
			} else if (this.field361 > var3) { // L: 563
				this.field369 = -1; // L: 564
				if (this.field366 == 0 || this.field366 > this.field361 - var3) { // L: 565
					this.field366 = this.field361 - var3;
				}
			} else {
				this.field369 = 0; // L: 567
			}
	...
	@ObfuscatedName("br")
	int vmethod1041() {
		int var1 = this.field359 * 3 >> 6; // L: 31
	...
	public static RawPcmStream createRawPcmStream(RawSound var0, int var1, int var2) {
		return var0.samples != null && var0.samples.length != 0 ? new RawPcmStream(var0, (int)((long)var0.sampleRate * 256L * (long)var1 / (long)(PcmPlayer.field293 * 100)), var2 << 6) : null; // L: 63 64
	}
	...
	static int method938(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field367 += var9.field360 * (var6 - var3); // L: 783
		var9.field361 += var9.field369 * (var6 - var3); // L: 784
		...
		var9.field359 = var4 >> 2; // L: 801
		var9.field365 = var2 << 8; // L: 802
		return var3; // L: 803
	}
	...
	static int method939(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field359 += var12.field355 * (var9 - var4); // L: 814
		var4 <<= 1; // L: 815
		var9 <<= 1; // L: 816
		...
		var12.field367 = var5 >> 2; // L: 848
		var12.field361 = var6 >> 2; // L: 849
		var12.field365 = var3 << 8; // L: 850
		return var4 >> 1; // L: 851
	}
	...
	static int method940(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field367 += var9.field360 * (var6 - var3); // L: 860
		var9.field361 += var9.field369 * (var6 - var3); // L: 861
		...
		var9.field359 = var4 >> 2; // L: 878
		var9.field365 = var2 << 8; // L: 879
		return var3; // L: 880
	}
	...
	static int method941(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field359 += var12.field355 * (var9 - var4); // L: 891
		var4 <<= 1; // L: 892
		var9 <<= 1; // L: 893
		...
		var12.field367 = var5 >> 2; // L: 925
		var12.field361 = var6 >> 2; // L: 926
		var12.field365 = var3 << 8; // L: 927
		return var4 >> 1; // L: 928
	}
	...
	static int method942(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field367 -= var11.field360 * var5; // L: 932
		var11.field361 -= var11.field369 * var5; // L: 933
		...
		var11.field367 += var11.field360 * var5; // L: 950
		var11.field361 += var11.field369 * var5; // L: 951
		var11.field359 = var6; // L: 952
		var11.field365 = var4; // L: 953
		return var5; // L: 954
	}
	...
	static int method943(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field359 -= var5 * var13.field355; // L: 958
		...
		var5 >>= 1; // L: 984
		var13.field359 += var13.field355 * var5; // L: 985
		var13.field367 = var6; // L: 986
		var13.field361 = var7; // L: 987
		var13.field365 = var4; // L: 988
		return var5; // L: 989
	}
	...
	static int method1008(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field367 -= var11.field360 * var5; // L: 993
		var11.field361 -= var11.field369 * var5; // L: 994
		...
		var11.field367 += var11.field360 * var5; // L: 1011
		var11.field361 += var11.field369 * var5; // L: 1012
		var11.field359 = var6; // L: 1013
		var11.field365 = var4; // L: 1014
		return var5; // L: 1015
	}
	...
	static int method992(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field359 -= var5 * var13.field355; // L: 1019
		...
		var5 >>= 1; // L: 1044
		var13.field359 += var13.field355 * var5; // L: 1045
		var13.field367 = var6; // L: 1046
		var13.field361 = var7; // L: 1047
		var13.field365 = var4; // L: 1048
		return var5; // L: 1049
	}
}
