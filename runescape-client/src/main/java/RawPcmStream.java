...
public class RawPcmStream extends PcmStream {
	...
	RawPcmStream(RawSound var1, int var2, int var3, int var4) {
		...
		this.field347 = var1.field267; // L: 54
		this.field338 = var2; // L: 55
		this.field339 = var3; // L: 56
		this.field340 = var4; // L: 57
	...
	RawPcmStream(RawSound var1, int var2, int var3) {
		...
		this.field347 = var1.field267; // L: 42
		this.field338 = var2; // L: 43
		this.field339 = var3; // L: 44
		this.field340 = 8192; // L: 45
	...
	void method851() {
		...
		this.field342 = method930(this.field339, this.field340); // L: 74
		this.field343 = method847(this.field339, this.field340); // L: 75
	} // L: 76
	...
	protected int vmethod5920() {
		return this.field339 == 0 && this.field350 == 0 ? 0 : 1; // L: 208 209
	}

	@ObfuscatedName("ae")
	@Export("fill")
	public synchronized void fill(int[] var1, int var2, int var3) {
		if (this.field339 == 0 && this.field350 == 0) { // L: 213
			...
			if (this.numLoops < 0) { // L: 241
				if (this.field347) { // L: 242
					if (this.field338 < 0) { // L: 243
						var9 = this.method874(var1, var2, var5, var3, var4.samples[this.start]); // L: 244
					...
					while (true) {
						var9 = this.method873(var1, var9, var6, var3, var4.samples[this.end - 1]); // L: 250
						...
						var9 = this.method874(var1, var9, var5, var3, var4.samples[this.start]); // L: 254
					...
					while (true) {
						var9 = this.method874(var1, var9, var5, var3, var4.samples[this.end - 1]); // L: 262
					...
					while (true) {
						var9 = this.method873(var1, var9, var6, var3, var4.samples[this.start]); // L: 269
				...
				if (this.numLoops > 0) { // L: 275
					if (this.field347) { // L: 276
						label127: {
							if (this.field338 < 0) { // L: 277
								var9 = this.method874(var1, var2, var5, var3, var4.samples[this.start]); // L: 278
							...
							do {
								var9 = this.method873(var1, var9, var6, var3, var4.samples[this.end - 1]); // L: 285
								...
								var9 = this.method874(var1, var9, var5, var3, var4.samples[this.start]); // L: 290
						...
						if (this.field338 < 0) { // L: 297
							while (true) {
								var9 = this.method874(var1, var9, var5, var3, var4.samples[this.end - 1]); // L: 299
							...
							while (true) {
								var9 = this.method873(var1, var9, var6, var3, var4.samples[this.start]); // L: 313
				...
				if (this.field338 < 0) { // L: 326
					this.method874(var1, var9, 0, var3, 0); // L: 327
					if (this.field345 < 0) { // L: 328
						this.field345 = -1; // L: 329
						this.method903(); // L: 330
						this.remove(); // L: 331
					}
				} else {
					this.method873(var1, var9, var7, var3, 0); // L: 335
					if (this.field345 >= var7) { // L: 336
						this.field345 = var7; // L: 337
						this.method903(); // L: 338
						this.remove(); // L: 339
					}
				}
	...
	public synchronized void skip(int var1) {
		if (this.field350 > 0) { // L: 345
			if (var1 >= this.field350) { // L: 346
				if (this.field339 == Integer.MIN_VALUE) { // L: 347
					this.field339 = 0; // L: 348
					this.field343 = 0; // L: 349
					this.field342 = 0; // L: 350
					this.field341 = 0; // L: 351
					this.remove(); // L: 352
					var1 = this.field350; // L: 353
				}

				this.field350 = 0; // L: 355
				this.method851(); // L: 356
			} else {
				this.field341 += this.field349 * var1; // L: 359
				this.field342 += this.field348 * var1; // L: 360
				this.field343 += this.field351 * var1; // L: 361
				this.field350 -= var1; // L: 362
			}
		}
		...
		this.field345 += this.field338 * var1; // L: 387
		if (this.numLoops < 0) { // L: 388
			if (!this.field347) { // L: 389
	...
	public synchronized void method853(int var1) {
		this.method875(var1 << 6, this.method857()); // L: 83
	} // L: 84

	@ObfuscatedName("aj")
	synchronized void method942(int var1) {
		this.method875(var1, this.method857()); // L: 87
	} // L: 88

	@ObfuscatedName("ad")
	synchronized void method875(int var1, int var2) {
		this.field339 = var1; // L: 91
		this.field340 = var2; // L: 92
		this.field350 = 0; // L: 93
		this.method851(); // L: 94
	} // L: 95
	...
	public synchronized int method857() {
		return this.field340 < 0 ? -1 : this.field340; // L: 102
	}
	...
	@ObfuscatedName("az")
	void method903() {
		if (this.field350 != 0) { // L: 118
			if (this.field339 == Integer.MIN_VALUE) {
				this.field339 = 0; // L: 119
			}

			this.field350 = 0; // L: 120
			this.method851(); // L: 121
		}
	...
	public synchronized void method910(int var1, int var2) {
		this.method862(var1, var2, this.method857()); // L: 126
	} // L: 127

	@ObfuscatedName("ai")
	public synchronized void method862(int var1, int var2, int var3) {
		if (var1 == 0) { // L: 130
			this.method875(var2, var3); // L: 131
		} else {
			int var4 = method930(var2, var3); // L: 134
			int var5 = method847(var2, var3); // L: 135
			if (var4 == this.field342 && var5 == this.field343) { // L: 136
				this.field350 = 0; // L: 137
			} else {
				...
				if (var5 - this.field343 > var6) {
					var6 = var5 - this.field343; // L: 144
				}

				if (this.field343 - var5 > var6) { // L: 145
				...
				this.field350 = var1; // L: 147
				this.field339 = var2; // L: 148
				this.field340 = var3; // L: 149
				this.field349 = (var2 - this.field341) / var1; // L: 150
				this.field348 = (var4 - this.field342) / var1; // L: 151
				this.field351 = (var5 - this.field343) / var1; // L: 152
			}
		}
	} // L: 132 138 153
	...
	public synchronized void method863(int var1) {
		if (var1 == 0) { // L: 156
			this.method942(0); // L: 157
			this.remove(); // L: 158
		} else if (this.field342 == 0 && this.field343 == 0) { // L: 161
			this.field350 = 0; // L: 162
			...
			if (-this.field343 > var2) { // L: 172
				var2 = -this.field343;
			}

			if (this.field343 > var2) { // L: 173
				var2 = this.field343;
			}
			...
			this.field350 = var1; // L: 175
			this.field339 = Integer.MIN_VALUE; // L: 176
			this.field349 = -this.field341 / var1; // L: 177
			this.field348 = -this.field342 / var1; // L: 178
			this.field351 = -this.field343 / var1; // L: 179
		}
	} // L: 159 166 180
	...
	public boolean method944() {
		return this.field350 != 0; // L: 196
	}

	@ObfuscatedName("bp")
	int method873(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field350 > 0) { // L: 474
				int var6 = var2 + this.field350; // L: 475
				if (var6 > var4) { // L: 476
					var6 = var4;
				}

				this.field350 += var2; // L: 477
				if (this.field338 == 256 && (this.field345 & 255) == 0) { // L: 478
					if (class347.PcmPlayer_stereo) { // L: 479
						...
						var2 = method884(((RawSound)super.sound).samples, var1, this.field345, var2, this.field341, this.field349, 0, var6, var3, this); // L: 480
					}
				} else if (class347.PcmPlayer_stereo) { // L: 483
					...
					var2 = method888(0, 0, ((RawSound)super.sound).samples, var1, this.field345, var2, this.field341, this.field349, 0, var6, var3, this, this.field338, var5); // L: 484
				}

				this.field350 -= var2; // L: 486
				if (this.field350 != 0) { // L: 487
					return var2;
				}

				if (!this.method977()) { // L: 488
					continue;
				}
			...
			if (this.field338 == 256 && (this.field345 & 255) == 0) { // L: 490
				if (class347.PcmPlayer_stereo) { // L: 491
					return method877(0, ((RawSound)super.sound).samples, var1, this.field345, var2, this.field342, this.field343, 0, var4, var3, this);
				}

				return method913(((RawSound)super.sound).samples, var1, this.field345, var2, this.field341, 0, var4, var3, this); // L: 492
			}

			if (class347.PcmPlayer_stereo) { // L: 495
			...
			return method880(0, 0, ((RawSound)super.sound).samples, var1, this.field345, var2, this.field341, 0, var4, var3, this, this.field338, var5); // L: 496
		}
	}
	...
	int method874(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field350 > 0) { // L: 501
				int var6 = var2 + this.field350; // L: 502
				if (var6 > var4) { // L: 503
					var6 = var4;
				}

				this.field350 += var2; // L: 504
				if (this.field338 == -256 && (this.field345 & 255) == 0) { // L: 505
					if (class347.PcmPlayer_stereo) { // L: 506
						...
						var2 = method956(((RawSound)super.sound).samples, var1, this.field345, var2, this.field341, this.field349, 0, var6, var3, this); // L: 507
					}
				} else if (class347.PcmPlayer_stereo) { // L: 510
					...
					var2 = method890(0, 0, ((RawSound)super.sound).samples, var1, this.field345, var2, this.field341, this.field349, 0, var6, var3, this, this.field338, var5); // L: 511
				}

				this.field350 -= var2; // L: 513
				if (this.field350 != 0) { // L: 514
					return var2;
				}

				if (!this.method977()) { // L: 515
					continue;
				}
			...
			if (this.field338 == -256 && (this.field345 & 255) == 0) { // L: 517
				if (class347.PcmPlayer_stereo) { // L: 518
					return method879(0, ((RawSound)super.sound).samples, var1, this.field345, var2, this.field342, this.field343, 0, var4, var3, this);
				}

				return method878(((RawSound)super.sound).samples, var1, this.field345, var2, this.field341, 0, var4, var3, this); // L: 519
			}

			if (class347.PcmPlayer_stereo) { // L: 522
			...
			return method882(0, 0, ((RawSound)super.sound).samples, var1, this.field345, var2, this.field341, 0, var4, var3, this, this.field338, var5); // L: 523
		}
	}
	...
	boolean method977() {
		...
		if (var1 == Integer.MIN_VALUE) { // L: 531
			...
			var2 = method930(var1, this.field340); // L: 537
			var3 = method847(var1, this.field340); // L: 538
		}

		if (var1 == this.field341 && var2 == this.field342 && var3 == this.field343) { // L: 540
			if (this.field339 == Integer.MIN_VALUE) { // L: 570
				this.field339 = 0; // L: 571
				this.field343 = 0; // L: 572
				this.field342 = 0; // L: 573
				this.field341 = 0; // L: 574
				this.remove(); // L: 575
				return true; // L: 576
			} else {
				this.method851(); // L: 578
				return false; // L: 579
			}
		} else {
			if (this.field341 < var1) { // L: 541
				this.field349 = 1; // L: 542
				this.field350 = var1 - this.field341; // L: 543
			} else if (this.field341 > var1) { // L: 545
				this.field349 = -1; // L: 546
				this.field350 = this.field341 - var1; // L: 547
			} else {
				this.field349 = 0; // L: 549
			}

			if (this.field342 < var2) { // L: 550
				this.field348 = 1; // L: 551
				if (this.field350 == 0 || this.field350 > var2 - this.field342) { // L: 552
					this.field350 = var2 - this.field342;
				}
			} else if (this.field342 > var2) { // L: 554
				this.field348 = -1; // L: 555
				if (this.field350 == 0 || this.field350 > this.field342 - var2) { // L: 556
			...
			if (this.field343 < var3) { // L: 559
				this.field351 = 1; // L: 560
				if (this.field350 == 0 || this.field350 > var3 - this.field343) { // L: 561
					this.field350 = var3 - this.field343;
				}
			} else if (this.field343 > var3) { // L: 563
				this.field351 = -1; // L: 564
				if (this.field350 == 0 || this.field350 > this.field343 - var3) { // L: 565
	...
	public static RawPcmStream createRawPcmStream(RawSound var0, int var1, int var2) {
		return var0.samples != null && var0.samples.length != 0 ? new RawPcmStream(var0, (int)((long)var0.sampleRate * 256L * (long)var1 / (long)(PcmPlayer.field291 * 100)), var2 << 6) : null; // L: 63 64
	}
	...
	static int method884(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field342 += var9.field348 * (var6 - var3); // L: 783
		var9.field343 += var9.field351 * (var6 - var3); // L: 784
	...
	static int method922(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field341 += var12.field349 * (var9 - var4); // L: 814
		var4 <<= 1; // L: 815
		var9 <<= 1; // L: 816
	...
	static int method956(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, RawPcmStream var9) {
		...
		var9.field342 += var9.field348 * (var6 - var3); // L: 860
		var9.field343 += var9.field351 * (var6 - var3); // L: 861
	...
	static int method887(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, RawPcmStream var12) {
		...
		var12.field341 += var12.field349 * (var9 - var4); // L: 891
		var4 <<= 1; // L: 892
		var9 <<= 1; // L: 893
	...
	static int method888(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field342 -= var11.field348 * var5; // L: 932
		var11.field343 -= var11.field351 * var5; // L: 933
		...
		var11.field342 += var11.field348 * var5; // L: 950
		var11.field343 += var11.field351 * var5; // L: 951
	...
	static int method871(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field341 -= var5 * var13.field349; // L: 958
		...
		var5 >>= 1; // L: 984
		var13.field341 += var13.field349 * var5; // L: 985
		var13.field342 = var6; // L: 986
		var13.field343 = var7; // L: 987
	...
	static int method890(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field342 -= var11.field348 * var5; // L: 993
		var11.field343 -= var11.field351 * var5; // L: 994
		...
		var11.field342 += var11.field348 * var5; // L: 1011
		var11.field343 += var11.field351 * var5; // L: 1012
	...
	static int method891(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field341 -= var5 * var13.field349; // L: 1019
		...
		var5 >>= 1; // L: 1044
		var13.field341 += var13.field349 * var5; // L: 1045
		var13.field342 = var6; // L: 1046
		var13.field343 = var7; // L: 1047
