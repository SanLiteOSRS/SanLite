...
public class IgnoreList extends NameableContainer {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
		...
		if (var2 == 1) {
			...
			var8.packetBuffer.method6852(FloorOverlayDefinition.baseX * 64 + var0);
			var8.packetBuffer.writeShort(class320.baseY * 64 + var1);
			...
			var8.packetBuffer.writeShort(class320.baseY * 64 + var1);
			var8.packetBuffer.method6951(FloorOverlayDefinition.baseX * 64 + var0);
			...
			var8.packetBuffer.method6851(FloorOverlayDefinition.baseX * 64 + var0);
			var8.packetBuffer.method6951(class320.baseY * 64 + var1);
			var8.packetBuffer.writeShort(var3);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 4) {
			Client.mouseCrossX = var6;
			...
			var8.packetBuffer.method6851(class320.baseY * 64 + var1);
			var8.packetBuffer.method6951(FloorOverlayDefinition.baseX * 64 + var0);
			...
			var8.packetBuffer.method6841(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.method6852(var3);
			var8.packetBuffer.method6852(class320.baseY * 64 + var1);
			var8.packetBuffer.method6951(FloorOverlayDefinition.baseX * 64 + var0);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 6) {
			Client.mouseCrossX = var6;
			...
			if (var2 == 7) {
				...
				if (var2 == 14) {
					...
					var8.packetBuffer.method6851(class320.baseY * 64 + var1);
					var8.packetBuffer.method6851(var3);
					var8.packetBuffer.writeShort(FloorOverlayDefinition.baseX * 64 + var0);
					Client.packetWriter.addNode(var8);
				} else if (var2 == 21) {
					Client.mouseCrossX = var6;
					Client.mouseCrossY = var7;
					...
					if (var2 == 24) {
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								Client.packetWriter.addNode(var8);
								Client.field727 = 0;
								FriendsChatManager.field3934 = class87.getWidget(var1);
		...
		if (FriendsChatManager.field3934 != null && Client.field727 == 0) {
