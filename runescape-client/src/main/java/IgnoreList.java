...
public class IgnoreList extends NameableContainer {
	...
	public void read(Buffer var1, int var2) {
		while (var1.offset < var2) { // L: 31
			...
			if (var3 == 4) { // L: 33
				Username var10 = new Username(var1.readStringCp1252NullTerminated(), this.field4671); // L: 34
				if (!var10.hasCleanName()) {
					throw new IllegalStateException(); // L: 35
				}

				boolean var11 = false; // L: 36
				InvDefinition.friendSystem.method1901(var10.getName(), var11); // L: 37
			} else {
				boolean var4 = (var3 & 1) != 0; // L: 40
				Username var5 = new Username(var1.readStringCp1252NullTerminated(), this.field4671); // L: 41
				Username var6 = new Username(var1.readStringCp1252NullTerminated(), this.field4671); // L: 42
