			...
			if (var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.clickedWidget)) {
				...
				if (!var10.isIf3 || !WorldMapManager.isComponentHidden(var10)) {
					if (var10.contentType > 0) {
						ArchiveDiskAction.method4244(var10);
					}
								...
								if (var10.type == 2) {
									...
									if (var10.type == 4) {
										...
										if (var39 == null) {
											...
											if (!var10.isIf3) {
												var45 = class335.method6599(var45, var10);
											}
											...
											if (var40 == null) {
												...
												if (!var10.spriteTiling) {
													...
													if (var10.spriteAngle != 0) {
														var40.method6204(var10.width / 2 + var12, var10.height / 2 + var13, var10.spriteAngle, var22);
													} else if (var14 != 0) {
													...
													for (var24 = 0; var24 < var22; ++var24) {
														for (var25 = 0; var25 < var23; ++var25) {
															if (var10.spriteAngle != 0) {
																var40.method6204(var20 / 2 + var12 + var24 * var20, var21 / 2 + var13 + var21 * var25, var10.spriteAngle, 4096);
															} else if (var14 != 0) {
										...
										if (var10.type == 6) {
											...
											Rasterizer3D.method3084(var10.width / 2 + var12, var10.height / 2 + var13);
											var23 = Rasterizer3D.Rasterizer3D_sine[var10.modelAngleX] * var10.modelZoom >> 16;
											var24 = Rasterizer3D.Rasterizer3D_cosine[var10.modelAngleX] * var10.modelZoom >> 16;
											if (var42 != null) {
												if (!var10.isIf3) {
													var42.method2997(0, var10.modelAngleY, 0, var10.modelAngleX, 0, var23, var24);
												} else {
													var42.calculateBoundsCylinder();
													if (var10.modelOrthog) {
														...
														var42.method2997(0, var10.modelAngleY, var10.modelAngleZ, var10.modelAngleX, var10.modelOffsetX, var22 + var23 + var10.modelOffsetY, var24 + var10.modelOffsetY);
													}
												}
											}
											...
											if (var10.type == 8 && var10 == GrandExchangeEvents.field39 && Client.field782 == Client.field783) {
												...
												String var44;
												for (var33 = class335.method6599(var33, var10); var33.length() > 0; var20 = var20 + var32.ascent + 1) {
												...
												for (var33 = class335.method6599(var33, var10); var33.length() > 0; var26 = var26 + var32.ascent + 1) {
											...
											if (var10.type == 9) {
												...
												if (var10.lineWid == 1) {
													...
													UrlRequester.method3384(var19, var20, var21, var22, var10.color, var10.lineWid);
												}
											}
										}
									}
