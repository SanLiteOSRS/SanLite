...
public class class30 {
   ...
   static final class30 field251 = new class30(0);
   @ObfuscatedName("j")
   @ObfuscatedSignature(
      signature = "Laz;"
   )
   static final class30 field250 = new class30(1);
   @ObfuscatedName("m")
   @ObfuscatedGetter(
      intValue = -2137893013
   )
   ...
   static final void updatePlayers(PacketBuffer var0, int var1) {
      ...
      for(int var3 = 0; var3 < Players.Players_pendingUpdateCount; ++var3) {
         ...
         if ((var6 & 512) != 0) {
            ...
            var5.field958 = (var8 & '\uffff') + Client.cycle;
            ...
            if (var5.username != null && var5.appearance != null) {
               ...
               if (!var21 && Client.field737 == 0 && !var5.isHidden) {
                  ...
                  if (var22.modIcon * 714577229 != -1) {
                     DirectByteArrayCopier.addGameMessage(var15, AbstractWorldMapData.getModIconString(var22.modIcon * 714577229) + var5.username.getName(), var18);
                  } else {
   ...
   static final void method534(Widget var0, int var1) {
