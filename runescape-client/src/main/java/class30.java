...
public class class30 {
	...
	static int method605(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.FRIEND_COUNT) {
			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (PacketWriter.friendSystem.method1926() && var3 >= 0 && var3 < PacketWriter.friendSystem.friendsList.getSize()) {
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					var5 = Interpreter.Interpreter_stringStack[--WorldMapDecoration.Interpreter_stringStackSize];
					Entity.method3340(var5);
					return 1;
				} else if (var0 == ScriptOpcodes.CLAN_LEAVECHAT) {
					class266.method5060();
					return 1;
				} else if (var0 == ScriptOpcodes.IGNORE_COUNT) {
					if (!PacketWriter.friendSystem.method1926()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = -1;
					} else {
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (PacketWriter.friendSystem.method1926() && var3 >= 0 && var3 < PacketWriter.friendSystem.ignoreList.getSize()) {
				...
				if (var5 == 0) {
					...
					if (var6 == 0) {
						...
						if (var6 == 1) {
							...
							var4.npcCycle = Client.cycle;
							var7 = var0.readBits(3);
							var4.method2127(var7, (byte)2);
							var8 = var0.readBits(3);
							var4.method2127(var8, (byte)2);
	...
	static Widget method604(Widget var0) {
		Widget var1 = TextureProvider.method2862(var0);
		if (var1 == null) {
			var1 = var0.parent;
		}
