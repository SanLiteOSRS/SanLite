		...
		for (int var1 = 0; var1 < Client.npcCount; ++var1) { // L: 4860
			...
			if (var2 != null && var2.isVisible() && var2.definition.isVisible == var0 && var2.definition.transformIsVisible()) { // L: 4862
				...
				if (var3 >= 0 && var3 < 104 && var4 >= 0 && var4 < 104) { // L: 4865
					if (var2.field1190 * -1671884800 == 1 && (var2.x & 127) == 64 && (var2.y & 127) == 64) { // L: 4866
					...
					class12.scene.drawEntity(class268.Client_plane, var2.x, var2.y, ObjectComposition.getTileHeight(var2.field1190 * 373555200 - 64 + var2.x, var2.field1190 * 373555200 - 64 + var2.y, class268.Client_plane), var2.field1190 * 373555200 - 64 + 60, var2, var2.rotation, var5, var2.isWalking); // L: 4872
				}
			}
		}
