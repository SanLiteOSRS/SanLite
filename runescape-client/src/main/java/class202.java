...
public class class202 {
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) { // L: 1503
			...
			NameableContainer.archive13 = class440.newArchive(13, true, false, true, false); // L: 1532
			...
			var23 += NameableContainer.archive13.percentage() * 2 / 100; // L: 1560
			...
			if (Client.titleLoadingStage == 45) { // L: 1593
				...
				FloorOverlayDefinition.WorldMapElement_fonts = new Fonts(ChatChannel.archive8, NameableContainer.archive13); // L: 1615
			} else {
				int var1;
				if (Client.titleLoadingStage == 50) { // L: 1618
					...
					if (Client.titleLoadingStage == 80) { // L: 1770
						...
						} else if (!NameableContainer.archive13.isFullyLoaded()) { // L: 1869
							Login.Login_loadingText = "Loading interfaces - " + (96 + NameableContainer.archive13.loadPercent() / 50) + "%"; // L: 1870
					...
					Archive var13 = NameableContainer.archive13; // L: 1715
					...
					class150.Ignored_cached = new class429(class153.field1729, 47, class271.clientLanguage, class119.archive2); // L: 1736
					LoginType.varcs = new Varcs(); // L: 1737
					Archive var16 = class119.archive2; // L: 1738
					Archive var17 = ChatChannel.archive8; // L: 1739
					Archive var18 = NameableContainer.archive13; // L: 1740
