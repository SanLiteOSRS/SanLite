...
public class class171 implements WorldMapSection {
	...
	public int[] getBorderTileLengths(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) {
			...
			int[] var4 = new int[]{this.field1998 * 64 - this.field1999 * 64 + var2 + (this.field2000 * 8 - this.field2003 * 8), var3 + (this.field2005 * 64 - this.field2006 * 64) + (this.field2001 * 8 - this.field2004 * 8)};
			return var4;
		}
	}
	...
	public Coord coord(int var1, int var2) {
		if (!this.containsPosition(var1, var2)) {
			...
			int var4 = this.field2006 * 64 - this.field2005 * 64 + var2 + (this.field2004 * 8 - this.field2001 * 8);
