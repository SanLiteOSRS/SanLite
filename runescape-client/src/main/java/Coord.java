...
public class Coord {
	...
	static final void method5753(int var0, int var1) {
		if (Client.hintArrowType == 2) { // L: 4944
			GrandExchangeOfferUnitPriceComparator.worldToScreen(Client.field506 * 64 + (Client.hintArrowX - GameEngine.baseX * 64 << 7), (Client.hintArrowY - class178.baseY * 64 << 7) + Client.field669 * 4096, Client.field505 * 4); // L: 4945
