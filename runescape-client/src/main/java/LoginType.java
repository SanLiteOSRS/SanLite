...
public class LoginType {
	...
	static {
		...
		field4100 = new LoginType(7, 1, "", "");
		field4095 = new LoginType(8, 2, "", "");
		field4096 = new LoginType(1, 3, "", "");
		field4093 = new LoginType(2, 4, "", "");
		field4102 = new LoginType(4, 5, "", "");
		field4099 = new LoginType(5, 6, "", "");
		field4094 = new LoginType(3, 7, "", "");
		field4101 = new LoginType(6, -1, "", "", true, new LoginType[]{oldscape, field4100, field4095, field4093, field4096});
	}
	...
	static final void runIntfCloseListeners(int var0, int var1) {
		if (UserComparator8.loadInterface(var0)) {
			UserComparator5.runComponentCloseListeners(Widget.Widget_interfaceComponents[var0], var1);
		}
	}
}
