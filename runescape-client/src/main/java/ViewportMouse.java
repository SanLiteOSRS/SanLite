...
public class ViewportMouse {
	...
	public static char method4918(byte var0) {
		...
		if (var1 == 0) {
			...
			if (var1 >= 128 && var1 < 160) { // L: 52
				char var2 = class384.cp1252AsciiExtension[var1 - 128]; // L: 53
				if (var2 == 0) { // L: 54
					var2 = '?';
				}
	...
	static int method4919(int var0, int var1, int var2) {
		if ((Tiles.Tiles_renderFlags[var0][var1][var2] & 8) != 0) { // L: 970
			return 0;
		} else {
			return var0 > 0 && (Tiles.Tiles_renderFlags[1][var1][var2] & 2) != 0 ? var0 - 1 : var0; // L: 971
		}
	}
}
