...
public class class118 implements class110 {
	...
	static void method2686() {
		...
		WorldMapLabelSize.field2580 = new byte[4][104][104];
		ClanChannelMember.field1504 = new int[4][105][105];
		SoundCache.field321 = new byte[4][105][105];
		class194.field2280 = new int[105][105];
		Tiles.Tiles_hue = new int[104];
		Nameable.Tiles_saturation = new int[104];
		Tiles.Tiles_lightness = new int[104];
		UserComparator5.Tiles_hueMultiplier = new int[104];
		VerticalAlignment.field1874 = new int[104];
	}
	...
	public static HealthBarDefinition method2683(int var0) {
		...
		if (var1 != null) {
			...
			byte[] var2 = GrandExchangeOfferAgeComparator.HealthBarDefinition_archive.takeFile(33, var0);
	...
	static void sortWorldList(int var0, boolean var1, int var2, boolean var3) {
		if (class334.World_worlds != null) {
			class286.doWorldSorting(0, class334.World_worlds.length - 1, var0, var1, var2, var3);
		}
	...
	static final void drawInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		for (int var9 = 0; var9 < var0.length; ++var9) {
			...
			if (var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.clickedWidget)) {
				...
				if (!var10.isIf3 || !StudioGame.isComponentHidden(var10)) {
					...
					if (var10 == Client.clickedWidget) {
						if (var1 != -1412584499 && !var10.isScrollBar) {
							BufferedFile.field4430 = var0;
							HitSplatDefinition.field1945 = var6;
							class78.field1000 = var7;
							continue;
						}

						if (Client.isDraggingWidget && Client.field531) {
							...
							if (var16 < Client.field659) {
								var16 = Client.field659;
							}

							if (var16 + var10.height > Client.field659 + Client.clickedWidgetParent.height) {
						...
						if (var10.contentType != 0) {
							if (var10.contentType == 1336) {
								if (Client.displayFps) {
									var13 += 15;
									class114.fontPlain12.drawRightAligned("Fps:" + GameEngine.fps, var12 + var10.width, var13, 16776960, -1);
									var13 += 15;
									...
									class114.fontPlain12.drawRightAligned("Mem:" + var20 + "k", var12 + var10.width, var13, var21, -1);
									var13 += 15;
								}
								continue;
							}
							...
							if (var10.contentType == 1337) {
								...
								class291.drawEntities(var12, var13, var10.width, var10.height);
								Client.field504[var10.rootIndex] = true;
								Rasterizer2D.Rasterizer2D_setClip(var2, var3, var4, var5);
								continue;
							}

							if (var10.contentType == 1338) {
								class148.drawMinimap(var10, var12, var13, var11);
								Rasterizer2D.Rasterizer2D_setClip(var2, var3, var4, var5);
								continue;
							}

							if (var10.contentType == 1339) {
								Nameable.drawCompass(var10, var12, var13, var11);
								Rasterizer2D.Rasterizer2D_setClip(var2, var3, var4, var5);
								continue;
							}

							if (var10.contentType == 1400) {
								Varcs.worldMap.draw(var12, var13, var10.width, var10.height, Client.cycle);
							}

							if (var10.contentType == 1401) {
								Varcs.worldMap.drawOverview(var12, var13, var10.width, var10.height);
							}

							if (var10.contentType == 1402) {
								Client.loginScreenRunesAnimation.draw(var12, Client.cycle);
							}
						}

						if (var10.type == 0) {
							if (!var10.isIf3 && StudioGame.isComponentHidden(var10) && var10 != class4.mousedOverWidgetIf1) {
								continue;
							}
							...
							if (var30 != null) {
								class12.drawWidgets(var30.group, var15, var16, var17, var18, var12, var13, var11);
							}
						...
						if (Client.isResizable || Client.field687[var11] || Client.gameDrawingMode > 1) {
							...
							if (var10.type != 1) {
								...
								if (var10.type == 2) {
									...
									for (var20 = 0; var20 < var10.rawHeight; ++var20) {
										for (var21 = 0; var21 < var10.rawWidth; ++var21) {
											...
											if (var10.itemIds[var19] <= 0) {
												...
												if (var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3 && var23 < var5 || var10 == class143.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
													SpritePixels var35;
													if (Client.isItemSelected == 1 && var19 == Calendar.selectedItemSlot && var10.id == MidiPcmStream.selectedItemWidget) {
														var35 = EnumComposition.getItemSprite(var26, var10.itemQuantities[var19], 2, 0, 2, false);
													} else {
														var35 = EnumComposition.getItemSprite(var26, var10.itemQuantities[var19], 1, 3153952, 2, false);
													}

													if (var35 != null) {
														if (var10 == class143.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
															...
															if (var1 != -1) {
																...
																if (var25 + var23 < Rasterizer2D.Rasterizer2D_yClipStart && var28.scrollY > 0) {
																	var29 = (Rasterizer2D.Rasterizer2D_yClipStart - var23 - var25) * Client.field538 / 3;
																	...
																	SecureRandomCallable.invalidateWidget(var28);
																}

																if (var25 + var23 + 32 > Rasterizer2D.Rasterizer2D_yClipEnd && var28.scrollY < var28.scrollHeight - var28.height) {
																	var29 = (var25 + var23 + 32 - Rasterizer2D.Rasterizer2D_yClipEnd) * Client.field538 / 3;
																	if (var29 > Client.field538 * 10) {
																		var29 = Client.field538 * 10;
																	}
														...
														} else if (var10 == WorldMapDecoration.field2722 && var19 == Client.field599) {
									...
									if (class28.runCs1(var10)) {
										var19 = var10.color2;
										if (var10 == class4.mousedOverWidgetIf1 && var10.mouseOverColor2 != 0) {
											var19 = var10.mouseOverColor2;
										}
									} else {
										var19 = var10.color;
										if (var10 == class4.mousedOverWidgetIf1 && var10.mouseOverColor != 0) {
											var19 = var10.mouseOverColor;
										}
									}

									if (var10.fill) {
										switch(var10.fillMode.field4554) {
										case 1:
									...
									if (var10.type == 4) {
										...
										if (var39 == null) {
											...
											if (var10.isIf3 && var10.itemId != -1) {
												ItemComposition var45 = UserComparator6.ItemDefinition_get(var10.itemId);
												var44 = var45.name;
												if (var44 == null) {
													var44 = "null";
												}
										...
										SpritePixels var40;
										if (!var10.isIf3) {
											var40 = var10.getSprite(class28.runCs1(var10));
											if (var40 != null) {
										...
										if (var10.type == 6) {
											boolean var36 = class28.runCs1(var10);
											if (var36) {
											...
											var22 = 0;
											if (var10.itemId != -1) {
												var33 = UserComparator6.ItemDefinition_get(var10.itemId);
												if (var33 != null) {
												...
												if (var10.modelId == 0) {
													...
													var41 = class340.localPlayer.getModel();
												}
											} else if (var20 == -1) {
												var41 = var10.getModel((SequenceDefinition)null, -1, var36, class340.localPlayer.appearance);
												if (var41 == null && Widget.field3223) {
													SecureRandomCallable.invalidateWidget(var10);
												}
											} else {
												SequenceDefinition var47 = UserComparator5.SequenceDefinition_get(var20);
												var41 = var10.getModel(var47, var10.modelFrame, var36, class340.localPlayer.appearance);
												if (var41 == null && Widget.field3223) {
													SecureRandomCallable.invalidateWidget(var10);
												}
											}

											Rasterizer3D.method3913(var10.width / 2 + var12, var10.height / 2 + var13);
											...
											if (var41 != null) {
												if (!var10.isIf3) {
													...
													if (var10.modelOrthog) {
														...
														var41.method4241(0, var10.modelAngleY, var10.modelAngleZ, var10.modelAngleX, var10.modelOffsetX, var23 + var22 + var10.modelOffsetY, var24 + var10.modelOffsetY);
													}
												}
											}
												...
												for (var21 = 0; var21 < var10.rawHeight; ++var21) {
													for (var22 = 0; var22 < var10.rawWidth; ++var22) {
														if (var10.itemIds[var20] > 0) {
															var33 = UserComparator6.ItemDefinition_get(var10.itemIds[var20] - 1);
															String var34;
															if (var33.isStackable != 1 && var10.itemQuantities[var20] == 1) {
																var34 = UserComparator5.colorStartTag(16748608) + var33.name + "</col>";
															} else {
																var34 = UserComparator5.colorStartTag(16748608) + var33.name + "</col>" + " " + 'x' + FriendSystem.formatItemStacks(var10.itemQuantities[var20]);
															}
											...
											if (var10.type == 8 && var10 == class281.field3375 && Client.field628 == Client.field714) {
												var19 = 0;
												var20 = 0;
												Font var31 = class114.fontPlain12;
												String var32 = var10.text;

												String var43;
												for (var32 = class7.method60(var32, var10); var32.length() > 0; var20 = var20 + var31.ascent + 1) {
												...
												for (var32 = class7.method60(var32, var10); var32.length() > 0; var26 = var26 + var31.ascent + 1) {
											...
											if (var10.type == 9) {
												...
												if (var10.lineWid == 1) {
													...
													ScriptEvent.method2147(var19, var20, var21, var22, var10.color, var10.lineWid);
												}
											}
										}
									}
