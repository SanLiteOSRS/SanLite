					...
					if (Login.loginIndex == 0) {
						...
						if (Login.loginIndex == 1) {
							...
							if (Login.loginIndex == 2) {
								...
								var35 += 15;
								var36 = 361;
								if (GameEngine.field481 != null) {
									var38 = GameEngine.field481.highX / 2;
									if (var4 == 1 && var44 >= GameEngine.field481.lowX - var38 && var44 <= var38 + GameEngine.field481.lowX && var34 >= var36 - 15 && var34 < var36) {
								...
								if (var4 == 1 && var44 >= var38 - 75 && var44 <= var38 + 75 && var34 >= var37 - 20 && var34 <= var37 + 20) {
									...
									if (Login.Login_username.length() == 0) {
										GameEngine.setLoginResponseString("", "Please enter your username/email address.", "");
										return;
									}

									if (Login.Login_password.length() == 0) {
										GameEngine.setLoginResponseString("", "Please enter your password.", "");
										return;
									}

									GameEngine.setLoginResponseString("", "Connecting to server...", "");
								...
								if (Login.loginIndex == 4) {
									...
									if (var4 == 1 && var44 >= var35 - 75 && var44 <= var35 + 75 && var34 >= var8 - 20 && var34 <= var8 + 20) {
										...
										if (SecureRandomCallable.otp.length() != 6) {
											GameEngine.setLoginResponseString("", "Please enter a 6-digit PIN.", "");
											return;
										}
									...
									if (Login.loginIndex == 7) {
										...
										if (var4 == 1 && var44 >= var35 - 75 && var44 <= var35 + 75 && var34 >= var8 - 20 && var34 <= var8 + 20) {
											...
											GameEngine.setLoginResponseString("", "Page has opened in a new window.", "(Please check your popup blocker.)");
											Login.loginIndex = 6;
											return;
										}
