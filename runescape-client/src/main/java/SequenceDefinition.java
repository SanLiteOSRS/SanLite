...
public class SequenceDefinition extends DualNode {
   ...
   public static FillMode[] method4689() {
      return new FillMode[]{FillMode.GRADIENT, FillMode.GRADIENTALPHA, FillMode.SOLID};
   }
}
