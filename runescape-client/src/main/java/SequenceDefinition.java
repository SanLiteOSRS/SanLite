...
public class SequenceDefinition extends DualNode {
	...
	static void method3381() {
		if (TileItem.worldMap != null) {
			TileItem.worldMap.method6504(VertexNormal.Client_plane, WorldMapSectionType.baseX * 64 + (class67.localPlayer.x >> 7), PlayerComposition.baseY * 64 + (class67.localPlayer.y >> 7), false);
