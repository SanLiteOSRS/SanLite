...
public class ObjectComposition extends DualNode {
	...
	static {
		...
		field2196 = new ModelData[4]; // L: 24
	}
	...
	public final Renderable getEntity(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
		...
		if (this.clipType * 65536 >= 0) { // L: 281
			if (var9 instanceof Model) { // L: 282
				...
				var9 = ((ModelData)var9).method4450(var3, var4, var5, var6, true, this.clipType * 65536); // L: 283
			}
		}
	...
	final ModelData getModelData(int var1, int var2) {
		...
		if (this.models == null) { // L: 325
			...
			if (var5 > 1) { // L: 343
				var3 = new ModelData(field2196, var5);
			}
		} else {
			int var9 = -1; // L: 346
	...
	public final ObjectComposition transform() {
		...
		return var2 != -1 ? class91.getObjectDefinition(var2) : null; // L: 402 403
	}
	...
	public int getIntParam(int var1, int var2) {
		return AttackOption.method2721(this.params, var1, var2); // L: 407
	}
	...
	public String getStringParam(int var1, String var2) {
		return class30.method448(this.params, var1, var2); // L: 411
	}
		...
		if (this.transforms == null) { // L: 422
			...
			for (int var1 = 0; var1 < this.transforms.length; ++var1) { // L: 423
				if (this.transforms[var1] != -1) { // L: 424
					ObjectComposition var2 = class91.getObjectDefinition(this.transforms[var1]); // L: 425
