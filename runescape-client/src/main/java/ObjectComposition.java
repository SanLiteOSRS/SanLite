...
public class ObjectComposition extends DualNode {
	...
	static {
		...
		field2159 = new ModelData[4]; // L: 24
	}
	...
	@ObfuscatedSignature(
		descriptor = "(II)Z",
		garbageValue = "-1726931023"
	)
	public final boolean method3872(int var1) {
	...
	@ObfuscatedName("al")
	@ObfuscatedSignature(
		descriptor = "(II[[IIIII)Lib;",
		garbageValue = "734212322"
	)
	@Export("getEntity")
	public final Renderable getEntity(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
		...
		if (this.clipType * 65536 >= 0) { // L: 275
			if (var9 instanceof Model) { // L: 276
				...
				var9 = ((ModelData)var9).method4235(var3, var4, var5, var6, true, this.clipType * 65536); // L: 277
			}
		}
	...
	@ObfuscatedName("ac")
	@ObfuscatedSignature(
		descriptor = "(II[[IIIILhg;II)Ljh;",
		garbageValue = "-384879196"
	)
	...
	final ModelData getModelData(int var1, int var2) {
		...
		if (this.models == null) { // L: 319
			...
			if (var5 > 1) { // L: 337
				var3 = new ModelData(field2159, var5);
			}
		} else {
			int var9 = -1; // L: 340
		...
		ModelData var8 = new ModelData(var3, var2 == 0 && !var4 && !var11, null == this.recolorFrom, null == this.retextureFrom, true); // L: 365
		if (var1 == 4 && var2 > 3) { // L: 366
			var8.method4239(256); // L: 367
	...
	public final ObjectComposition transform() {
		...
		return var2 != -1 ? class59.getObjectDefinition(var2) : null; // L: 396 397
	}
	...
	@ObfuscatedSignature(
		descriptor = "(I)Z",
		garbageValue = "1499452179"
	)
	@Export("hasSound")
	public boolean hasSound() {
		if (this.transforms == null) { // L: 437
			return this.ambientSoundId != -1 || this.soundEffectIds != null;
		} else {
			for (int var1 = 0; var1 < this.transforms.length; ++var1) { // L: 438
				if (this.transforms[var1] != -1) { // L: 439
					ObjectComposition var2 = class59.getObjectDefinition(this.transforms[var1]); // L: 440
					if (var2.ambientSoundId != -1 || var2.soundEffectIds != null) { // L: 441
						return true;
					}
				}
			}
