...
public class ObjectComposition extends DualNode {
	...
	static {
		...
		field2087 = new ModelData[4]; // L: 24
	}
	...
	public final Renderable getEntity(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
		...
		if (this.clipType * 65536 >= 0) { // L: 275
			if (var9 instanceof Model) { // L: 276
				...
				var9 = ((ModelData)var9).method4081(var3, var4, var5, var6, true, this.clipType * 65536); // L: 277
			}
		}
	...
	public final ObjectComposition transform() {
		...
		return var2 != -1 ? InterfaceParent.getObjectDefinition(var2) : null; // L: 396 397
	}
	...
	public int getIntParam(int var1, int var2) {
		return Language.method6584(this.params, var1, var2); // L: 401
	}
	...
	public String getStringParam(int var1, String var2) {
		return FriendLoginUpdate.method7304(this.params, var1, var2); // L: 405
	}
		...
		if (this.transforms == null) { // L: 416
			...
			for (int var1 = 0; var1 < this.transforms.length; ++var1) { // L: 417
				if (this.transforms[var1] != -1) { // L: 418
					ObjectComposition var2 = InterfaceParent.getObjectDefinition(this.transforms[var1]); // L: 419
	...
	public static class129 method3734(int var0) {
		class129 var1 = (class129)SequenceDefinition.SequenceDefinition_cachedModel.get((long)var0); // L: 382
		if (var1 != null) { // L: 383
			return var1;
		} else {
			var1 = class125.method2906(class34.SequenceDefinition_animationsArchive, SequenceDefinition.SequenceDefinition_skeletonsArchive, var0, false); // L: 384
			if (var1 != null) { // L: 385
