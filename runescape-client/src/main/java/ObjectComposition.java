...
public class ObjectComposition extends DualNode {
	...
	public final Renderable getEntity(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
		...
		if (this.clipType * 65536 >= 0) {
			if (var9 instanceof Model) {
				...
				var9 = ((ModelData)var9).method3798(var3, var4, var5, var6, true, this.clipType * 65536);
			}
		}
			...
			while (true) {
				if (!IgnoreList.isKeyDown()) {
					...
					if (Login.hoveredWorldIndex != -1) {
						...
						if (Login.worldSelectPage < Login.worldSelectPagesCount && BuddyRankComparator.worldSelectRightSprite != null && MouseHandler.MouseHandler_lastPressedX >= class68.canvasWidth - BuddyRankComparator.worldSelectRightSprite.subWidth - 5 && MouseHandler.MouseHandler_lastPressedX <= class68.canvasWidth && MouseHandler.MouseHandler_lastPressedY >= Client.canvasHeight / 2 - 50 && MouseHandler.MouseHandler_lastPressedY <= Client.canvasHeight / 2 + 50) {
							++Login.worldSelectPage;
						}
					}
					break;
	...
	public static IndexedSprite method3046(AbstractArchive var0, int var1) {
		...
		if (!var2) {
			...
			var4.subHeight = class374.SpriteBuffer_spriteHeights[0] * 81063440;
	...
	static final void method3013(Actor var0) {
		...
		if (var0.pathLength == 0) {
			...
			int var10 = var0.x;
			int var2 = var0.y;
			int var3 = var0.pathX[var0.pathLength - 1] * 128 + var0.field1023 * 64;
			int var4 = var0.pathY[var0.pathLength - 1] * 128 + var0.field1023 * 64;
			if (var10 < var3) {
				if (var2 < var4) {
