...
public class ModelData extends Renderable {
	...
	static {
		field2753 = new int[10000]; // L: 49
		field2754 = new int[10000]; // L: 50
		field2755 = 0; // L: 51
	...
	public ModelData(ModelData[] var1, int var2) {
		...
		for (var10 = 0; var10 < var2; ++var10) { // L: 932
			...
			if (var11 != null) { // L: 934
				...
				var9 |= var11.field2721 != null; // L: 948
			}
		}
		...
		if (var9) { // L: 964
			this.field2721 = new int[this.verticesCount][]; // L: 965
			this.field2735 = new int[this.verticesCount][]; // L: 966
		}
		...
		for (var10 = 0; var10 < var2; ++var10) { // L: 978
			...
			if (var11 != null) { // L: 980
				...
				for (var12 = 0; var12 < var11.faceCount; ++var12) { // L: 981
					...
					this.indices1[this.faceCount] = this.method5180(var11, var11.indices1[var12]); // L: 1004
					this.indices2[this.faceCount] = this.method5180(var11, var11.indices2[var12]); // L: 1005
					this.indices3[this.faceCount] = this.method5180(var11, var11.indices3[var12]); // L: 1006
				...
				for (var12 = 0; var12 < var11.textureTriangleCount; ++var12) { // L: 1009
					...
					if (var13 == 0) { // L: 1011
						this.texTriangleX[this.textureTriangleCount] = (short)this.method5180(var11, var11.texTriangleX[var12]); // L: 1012
						this.texTriangleY[this.textureTriangleCount] = (short)this.method5180(var11, var11.texTriangleY[var12]); // L: 1013
						this.texTriangleZ[this.textureTriangleCount] = (short)this.method5180(var11, var11.texTriangleZ[var12]); // L: 1014
					}
	...
	public ModelData(ModelData var1, boolean var2, boolean var3, boolean var4, boolean var5) {
		...
		this.field2721 = var1.field2721; // L: 1104
		this.field2735 = var1.field2735; // L: 1105
		this.ambient = var1.ambient; // L: 1106
		this.contrast = var1.contrast; // L: 1107
	}

	@ObfuscatedName("al")
	void method5176(byte[] var1) {
		...
		if (var18 == 1) { // L: 169
			this.field2721 = new int[var9][]; // L: 170
			this.field2735 = new int[var9][]; // L: 171
		}
		...
		if (var18 == 1) { // L: 203
			for (var53 = 0; var53 < var9; ++var53) { // L: 204
				...
				this.field2721[var53] = new int[var54]; // L: 206
				this.field2735[var53] = new int[var54]; // L: 207

				for (var55 = 0; var55 < var54; ++var55) { // L: 208
					this.field2721[var53][var55] = var6.readUnsignedByte(); // L: 209
					this.field2735[var53][var55] = var6.readUnsignedByte(); // L: 210
				}
			}
		}
	...
	void method5233(byte[] var1) {
		...
		if (var17 == 1) { // L: 376
			this.field2721 = new int[var9][]; // L: 377
			this.field2735 = new int[var9][]; // L: 378
		}
		...
		if (var17 == 1) { // L: 405
			for (var40 = 0; var40 < var9; ++var40) { // L: 406
				...
				this.field2721[var40] = new int[var41]; // L: 408
				this.field2735[var40] = new int[var41]; // L: 409

				for (var42 = 0; var42 < var41; ++var42) { // L: 410
					this.field2721[var40][var42] = var8.readUnsignedByte(); // L: 411
					this.field2735[var40][var42] = var8.readUnsignedByte(); // L: 412
				}
			}
		}
	...
	final int method5180(ModelData var1, int var2) {
		int var3 = -1; // L: 1023
		...
		if (var3 == -1) { // L: 1033
			...
			if (var1.field2721 != null) { // L: 1038
				this.field2721[this.verticesCount] = var1.field2721[var2]; // L: 1039
				this.field2735[this.verticesCount] = var1.field2735[var2]; // L: 1040
			}
	...
	public ModelData method5182(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
	...
	public final Model toModel(int var1, int var2, int var3, int var4, int var5) {
		...
		if (this.textureTriangleCount > 0 && this.textureCoords != null) { // L: 1497
			...
			var8.field3006 = new int[var8.field3028]; // L: 1506
			var8.field3007 = new int[var8.field3028]; // L: 1507
			var8.field2999 = new int[var8.field3028]; // L: 1508
			var10 = 0; // L: 1509

			int var11;
			for (var11 = 0; var11 < this.textureTriangleCount; ++var11) { // L: 1510
				if (var9[var11] > 0 && this.textureRenderTypes[var11] == 0) { // L: 1511
					var8.field3006[var10] = this.texTriangleX[var11] & '\uffff'; // L: 1512
					var8.field3007[var10] = this.texTriangleY[var11] & '\uffff'; // L: 1513
					var8.field2999[var10] = this.texTriangleZ[var11] & '\uffff'; // L: 1514
			...
			var8.field2990 = new byte[this.faceCount]; // L: 1519

			for (var11 = 0; var11 < this.faceCount; ++var11) { // L: 1520
				if (this.textureCoords[var11] != -1) { // L: 1521
					var8.field2990[var11] = (byte)var9[this.textureCoords[var11] & 255];
				} else {
					var8.field2990[var11] = -1; // L: 1522
				}
			}
		}
			...
			if (var12 == -1) { // L: 1537
				if (var17 != 0) { // L: 1538
					if (var17 == 1) { // L: 1555
						...
						var8.faceColors1[var16] = method5174(this.faceColors[var16] & '\uffff', var14); // L: 1558
					...
					var8.faceColors1[var16] = method5174(var15, var14); // L: 1545
					...
					var8.faceColors2[var16] = method5174(var15, var14); // L: 1549
					...
					var8.faceColors3[var16] = method5174(var15, var14); // L: 1553
				}
				...
				if (var17 == 1) { // L: 1586
					...
					var8.faceColors1[var16] = method5199(var14); // L: 1589
				...
				var8.faceColors1[var16] = method5199(var14); // L: 1576
				...
				var8.faceColors2[var16] = method5199(var14); // L: 1580
				...
				var8.faceColors3[var16] = method5199(var14); // L: 1584
			}
		}

		this.method5250(); // L: 1597
		...
		var8.field2991 = this.priority; // L: 1608
		...
		var8.field3011 = this.field2721; // L: 1612
		var8.field3012 = this.field2735; // L: 1613
		return var8; // L: 1614
	}
	...
	static void method5196(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
						...
						if (var13 >= var1.minBoundZ && var13 <= var1.maxBoundZ) { // L: 1450
							for (int var14 = 0; var14 < var8; ++var14) { // L: 1451
								...
								if (var12 == var7[var14] && var13 == var1.verticesZ[var14] && var11 == var1.verticesY[var14] && var15.magnitude != 0) { // L: 1453
									...
									++var6; // L: 1468
									field2753[var9] = field2755; // L: 1469
									field2754[var14] = field2755; // L: 1470
								}
							}
						}
					}
		...
		if (var6 >= 3 && var5) { // L: 1474
			for (var9 = 0; var9 < var0.faceCount; ++var9) { // L: 1475
				if (field2753[var0.indices1[var9]] == field2755 && field2753[var0.indices2[var9]] == field2755 && field2753[var0.indices3[var9]] == field2755) { // L: 1476
			...
			for (var9 = 0; var9 < var1.faceCount; ++var9) { // L: 1481
				if (field2755 == field2754[var1.indices1[var9]] && field2755 == field2754[var1.indices2[var9]] && field2755 == field2754[var1.indices3[var9]]) { // L: 1482
	...
	@ObfuscatedName("bo")
	static final int method5174(int var0, int var1) {
	...
	@ObfuscatedName("bd")
	static final int method5199(int var0) {
		if (var0 < 2) { // L: 1625
			var0 = 2;
		} else if (var0 > 126) {
			var0 = 126; // L: 1626
