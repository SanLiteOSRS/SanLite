...
public class ModelData extends Renderable {
	...
	static {
		field2347 = new int[10000]; // L: 49
		field2348 = new int[10000]; // L: 50
		field2323 = 0; // L: 51
	...
	public ModelData(ModelData[] var1, int var2) {
		...
		for (var10 = 0; var10 < var2; ++var10) { // L: 932
			...
			if (var11 != null) { // L: 934
				...
				var9 |= var11.field2307 != null; // L: 948
			}
		}
		...
		if (var9) { // L: 964
			this.field2307 = new int[this.verticesCount][]; // L: 965
			this.field2335 = new int[this.verticesCount][]; // L: 966
		}
		...
		for (var10 = 0; var10 < var2; ++var10) { // L: 978
			...
			if (var11 != null) { // L: 980
				...
				for (var12 = 0; var12 < var11.faceCount; ++var12) { // L: 981
					...
					this.indices1[this.faceCount] = this.method4080(var11, var11.indices1[var12]); // L: 1004
					this.indices2[this.faceCount] = this.method4080(var11, var11.indices2[var12]); // L: 1005
					this.indices3[this.faceCount] = this.method4080(var11, var11.indices3[var12]); // L: 1006
				...
				for (var12 = 0; var12 < var11.textureTriangleCount; ++var12) { // L: 1009
					...
					if (var13 == 0) { // L: 1011
						this.texTriangleX[this.textureTriangleCount] = (short)this.method4080(var11, var11.texTriangleX[var12]); // L: 1012
						this.texTriangleY[this.textureTriangleCount] = (short)this.method4080(var11, var11.texTriangleY[var12]); // L: 1013
						this.texTriangleZ[this.textureTriangleCount] = (short)this.method4080(var11, var11.texTriangleZ[var12]); // L: 1014
					}
	...
	public ModelData(ModelData var1, boolean var2, boolean var3, boolean var4, boolean var5) {
		...
		this.field2307 = var1.field2307; // L: 1104
		this.field2335 = var1.field2335; // L: 1105
	...
	void method4064(byte[] var1) {
		...
		if (var18 == 1) { // L: 169
			this.field2307 = new int[var9][]; // L: 170
			this.field2335 = new int[var9][]; // L: 171
		}
		...
		if (var18 == 1) { // L: 203
			for (var53 = 0; var53 < var9; ++var53) { // L: 204
				...
				this.field2307[var53] = new int[var54]; // L: 206
				this.field2335[var53] = new int[var54]; // L: 207

				for (var55 = 0; var55 < var54; ++var55) { // L: 208
					this.field2307[var53][var55] = var6.readUnsignedByte(); // L: 209
					this.field2335[var53][var55] = var6.readUnsignedByte(); // L: 210
				}
			}
		}
	...
	void method4097(byte[] var1) {
		...
		if (var17 == 1) { // L: 376
			this.field2307 = new int[var9][]; // L: 377
			this.field2335 = new int[var9][]; // L: 378
		}
		...
		if (var17 == 1) { // L: 405
			for (var40 = 0; var40 < var9; ++var40) { // L: 406
				...
				this.field2307[var40] = new int[var41]; // L: 408
				this.field2335[var40] = new int[var41]; // L: 409

				for (var42 = 0; var42 < var41; ++var42) { // L: 410
					this.field2307[var40][var42] = var8.readUnsignedByte(); // L: 411
					this.field2335[var40][var42] = var8.readUnsignedByte(); // L: 412
				}
			}
		}
	...
	final int method4080(ModelData var1, int var2) {
		...
		if (var3 == -1) { // L: 1033
			...
			if (var1.field2307 != null) { // L: 1038
				this.field2307[this.verticesCount] = var1.field2307[var2]; // L: 1039
				this.field2335[this.verticesCount] = var1.field2335[var2]; // L: 1040
			}
	...
	public final Model toModel(int var1, int var2, int var3, int var4, int var5) {
		...
		if (this.textureTriangleCount > 0 && this.textureCoords != null) { // L: 1497
			...
			var8.field2646 = new int[var8.field2637]; // L: 1506
			var8.field2613 = new int[var8.field2637]; // L: 1507
			var8.field2614 = new int[var8.field2637]; // L: 1508
			var10 = 0; // L: 1509

			int var11;
			for (var11 = 0; var11 < this.textureTriangleCount; ++var11) { // L: 1510
				if (var9[var11] > 0 && this.textureRenderTypes[var11] == 0) { // L: 1511
					var8.field2646[var10] = this.texTriangleX[var11] & '\uffff'; // L: 1512
					var8.field2613[var10] = this.texTriangleY[var11] & '\uffff'; // L: 1513
					var8.field2614[var10] = this.texTriangleZ[var11] & '\uffff'; // L: 1514
			...
			var8.field2608 = new byte[this.faceCount]; // L: 1519
			...
			if (var12 == -1) { // L: 1537
				if (var17 != 0) { // L: 1538
					if (var17 == 1) { // L: 1555
						...
						var8.faceColors1[var16] = method4090(this.faceColors[var16] & '\uffff', var14); // L: 1558
					...
					var8.faceColors1[var16] = method4090(var15, var14); // L: 1545
					...
					var8.faceColors2[var16] = method4090(var15, var14); // L: 1549
					...
					var8.faceColors3[var16] = method4090(var15, var14); // L: 1553
				}
				...
				if (var17 == 1) { // L: 1586
					...
					var8.faceColors1[var16] = method4111(var14); // L: 1589
				...
				var8.faceColors1[var16] = method4111(var14); // L: 1576
				...
				var8.faceColors2[var16] = method4111(var14); // L: 1580
				...
				var8.faceColors3[var16] = method4111(var14); // L: 1584
			}
		}

		this.method4067(); // L: 1597
		...
		var8.field2588 = this.priority; // L: 1608
		...
		var8.field2624 = this.field2307; // L: 1612
		var8.field2618 = this.field2335; // L: 1613
		return var8; // L: 1614
	}
	...
	static void method4078(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
						...
						if (var13 >= var1.minBoundZ && var13 <= var1.maxBoundZ) { // L: 1450
							for (int var14 = 0; var14 < var8; ++var14) { // L: 1451
								...
								if (var12 == var7[var14] && var13 == var1.verticesZ[var14] && var11 == var1.verticesY[var14] && var15.magnitude != 0) { // L: 1453
									...
									++var6; // L: 1468
									field2347[var9] = field2323; // L: 1469
									field2348[var14] = field2323; // L: 1470
								}
							}
						}
					}
		...
		if (var6 >= 3 && var5) { // L: 1474
			for (var9 = 0; var9 < var0.faceCount; ++var9) { // L: 1475
				if (field2347[var0.indices1[var9]] == field2323 && field2347[var0.indices2[var9]] == field2323 && field2347[var0.indices3[var9]] == field2323) { // L: 1476
			...
			for (var9 = 0; var9 < var1.faceCount; ++var9) { // L: 1481
				if (field2323 == field2348[var1.indices1[var9]] && field2323 == field2348[var1.indices2[var9]] && field2323 == field2348[var1.indices3[var9]]) { // L: 1482
