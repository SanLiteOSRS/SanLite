...
public abstract class AbstractArchive {
   ...
   public byte[] takeFileEncrypted(int var1, int var2, int[] var3) {
      if (var1 >= 0 && var1 < this.files.length && this.files[var1] != null && var2 >= 0 && var2 < this.files[var1].length) {
         ...
         byte[] var5 = class43.byteArrayFromObject(this.files[var1][var2], false);
   ...
   public byte[] getFile(int var1, int var2) {
      if (var1 >= 0 && var1 < this.files.length && this.files[var1] != null && var2 >= 0 && var2 < this.files[var1].length) {
         ...
         byte[] var4 = class43.byteArrayFromObject(this.files[var1][var2], false);
         return var4;
      } else {
         return null;
      }
      ...
      if (this.groups[var1] == null) {
         ...
         if (var6) {
            ...
            if (var2 == null || var2[0] == 0 && var2[1] == 0 && var2[2] == 0 && var2[3] == 0) {
               var18 = class43.byteArrayFromObject(this.groups[var1], false);
            } else {
               var18 = class43.byteArrayFromObject(this.groups[var1], true);
