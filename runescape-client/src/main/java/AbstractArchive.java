...
public abstract class AbstractArchive {
	...
	void decodeIndex(byte[] var1) {
		this.hash = class343.method6673(var1, var1.length); // L: 37
		Buffer var2 = new Buffer(WorldMapCacheName.decompressBytes(var1)); // L: 38
		...
		if (var3 >= 5 && var3 <= 7) { // L: 40
			...
			if (var3 >= 7) { // L: 51
				for (var7 = 0; var7 < this.groupCount; ++var7) { // L: 52
					this.groupIds[var7] = var5 += var2.method8612(); // L: 53
			...
			if (var3 >= 7) { // L: 77
				for (var7 = 0; var7 < this.groupCount; ++var7) { // L: 78
					...
					for (var11 = 0; var11 < var9; ++var11) { // L: 84
						var12 = this.fileIds[var8][var11] = var5 += var2.method8612(); // L: 85
						if (var12 > var10) { // L: 86
							var10 = var12;
						}
					}
	...
	public byte[] takeFileEncrypted(int var1, int var2, int[] var3) {
		if (var1 >= 0 && var1 < this.files.length && this.files[var1] != null && var2 >= 0 && var2 < this.files[var1].length) { // L: 125
			...
			byte[] var5 = Frames.method4623(this.files[var1][var2], false); // L: 134
	...
	public byte[] getFile(int var1, int var2) {
		if (var1 >= 0 && var1 < this.files.length && this.files[var1] != null && var2 >= 0 && var2 < this.files[var1].length) { // L: 185
			...
			byte[] var4 = Frames.method4623(this.files[var1][var2], false); // L: 194
			return var4; // L: 195
		} else {
			return null;
		}
		...
		if (this.groups[var1] == null) { // L: 238
			...
			if (var6) { // L: 249
				...
				if (var2 == null || var2[0] == 0 && var2[1] == 0 && var2[2] == 0 && var2[3] == 0) { // L: 251
					var21 = Frames.method4623(this.groups[var1], false); // L: 256
				} else {
					var21 = Frames.method4623(this.groups[var1], true); // L: 252
					Buffer var8 = new Buffer(var21); // L: 253
					var8.xteaDecrypt(var2, 5, var8.array.length); // L: 254
				}

				byte[] var25 = WorldMapCacheName.decompressBytes(var21); // L: 259
	...
	public int getGroupId(String var1) {
		...
		return this.groupNameHashTable.get(JagexCache.hashString(var1)); // L: 352
	}
	...
	public int getFileId(int var1, String var2) {
		...
		return this.fileNameHashTables[var1].get(JagexCache.hashString(var2)); // L: 357
	}
	...
	public boolean isValidFileName(String var1, String var2) {
		...
		int var3 = this.groupNameHashTable.get(JagexCache.hashString(var1)); // L: 363
		if (var3 < 0) { // L: 364
			return false;
		} else {
			int var4 = this.fileNameHashTables[var3].get(JagexCache.hashString(var2)); // L: 365
			return var4 >= 0; // L: 366
		}
	}
	...
	public byte[] takeFileByNames(String var1, String var2) {
		...
		int var3 = this.groupNameHashTable.get(JagexCache.hashString(var1)); // L: 373
		int var4 = this.fileNameHashTables[var3].get(JagexCache.hashString(var2)); // L: 374
	...
	public boolean tryLoadFileByNames(String var1, String var2) {
		...
		int var4 = this.fileNameHashTables[var3].get(JagexCache.hashString(var2)); // L: 382
	...
	public boolean tryLoadGroupByName(String var1) {
		...
		int var2 = this.groupNameHashTable.get(JagexCache.hashString(var1)); // L: 388
	...
	public void loadRegionFromName(String var1) {
		...
		int var2 = this.groupNameHashTable.get(JagexCache.hashString(var1)); // L: 394
		if (var2 >= 0) { // L: 395
	...
	public int groupLoadPercentByName(String var1) {
		...
		int var2 = this.groupNameHashTable.get(JagexCache.hashString(var1)); // L: 401
