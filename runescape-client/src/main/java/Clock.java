...
public abstract class Clock {
	...
	public static boolean method3594(AbstractArchive var0, AbstractArchive var1, AbstractArchive var2, MidiPcmStream var3) {
	...
	static final void loadRegions(boolean var0, PacketBuffer var1) {
		...
		if (!Client.isInInstance) {
			...
			boolean var15 = var1.method5566() == 1;
			var4 = var1.method5591();
