	...
	static final void method229() {
		...
		if (!var0) {
			...
			for (var1 = 0; var1 < class90.regionLandArchives.length; ++var1) {
				...
				if (var2 != null) {
					var3 = (class41.regions[var1] >> 8) * 64 - class182.baseX * 64;
					var4 = (class41.regions[var1] & 255) * 64 - SecureRandomFuture.baseY * 64;
			...
			if (!var0) {
				...
				if (!Client.isInInstance) {
					...
					for (var46 = 0; var46 < var1; ++var46) {
						var3 = (class41.regions[var46] >> 8) * 64 - class182.baseX * 64;
						var4 = (class41.regions[var46] & 255) * 64 - SecureRandomFuture.baseY * 64;
					...
					for (var46 = 0; var46 < var1; ++var46) {
						...
						if (var50 != null) {
							var4 = (class41.regions[var46] >> 8) * 64 - class182.baseX * 64;
							var48 = (class41.regions[var46] & 255) * 64 - SecureRandomFuture.baseY * 64;
							Timer.playPcmPlayers();
				...
				if (var4 > ItemLayer.Client_plane) {
					var4 = ItemLayer.Client_plane;
				}

				if (var4 < ItemLayer.Client_plane - 1) {
					var4 = ItemLayer.Client_plane - 1;
				}
