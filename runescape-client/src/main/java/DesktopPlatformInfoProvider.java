...
public class DesktopPlatformInfoProvider implements class487 {
	...
	public PlatformInfo get() {
		byte var1;
		if (ClanChannel.field1764.startsWith("win")) { // L: 16
			var1 = 1;
		} else if (ClanChannel.field1764.startsWith("mac")) { // L: 17
			var1 = 2;
		} else if (ClanChannel.field1764.startsWith("linux")) { // L: 18
			var1 = 3;
		} else {
			var1 = 4; // L: 19
		}
		...
		return new PlatformInfo(var1, var28, var7, var8, this.field4852, this.field4853, this.field4854, false, var10, var11, var12, 0, var13, var14, var15, var16, 0, 0, 0, 0, var17, var18, var23, 0, "", ""); // L: 99
	}
	...
	void method8625(String var1) {
		if (var1.startsWith("1.")) { // L: 103
			this.method8626(var1); // L: 104
		} else {
			this.method8627(var1); // L: 107
		}
	...
	void method8626(String var1) {
		...
		try {
			this.field4852 = Integer.parseInt(var2[1]); // L: 114
			var2 = var2[2].split("_"); // L: 115
			this.field4853 = Integer.parseInt(var2[0]); // L: 116
			this.field4854 = Integer.parseInt(var2[1]); // L: 117
	...
	void method8627(String var1) {
		...
		try {
			this.field4852 = Integer.parseInt(var2[0]); // L: 125
			this.field4853 = Integer.parseInt(var2[1]); // L: 126
			this.field4854 = Integer.parseInt(var2[2]); // L: 127
