...
public class DesktopPlatformInfoProvider implements class494 {
	...
	public PlatformInfo get() {
		byte var1;
		if (TaskHandler.field2320.startsWith("win")) { // L: 16
			var1 = 1;
		} else if (TaskHandler.field2320.startsWith("mac")) { // L: 17
			var1 = 2;
		} else if (TaskHandler.field2320.startsWith("linux")) { // L: 18
			var1 = 3;
		} else {
			var1 = 4; // L: 19
		}
		...
		return new PlatformInfo(var1, var29, var7, var8, this.field4924, this.field4923, this.field4925, false, var10, var11, var12, 0, var13, var14, var15, var16, 0, 0, 0, 0, var17, var18, var23, 0, "", "", var27); // L: 100
	}
	...
	void method8826(String var1) {
		if (var1.startsWith("1.")) { // L: 104
			this.method8834(var1); // L: 105
		} else {
			this.method8828(var1); // L: 108
		}
	...
	void method8834(String var1) {
		...
		try {
			this.field4924 = Integer.parseInt(var2[1]); // L: 115
			var2 = var2[2].split("_"); // L: 116
			this.field4923 = Integer.parseInt(var2[0]); // L: 117
			this.field4925 = Integer.parseInt(var2[1]); // L: 118
	...
	void method8828(String var1) {
		...
		try {
			this.field4924 = Integer.parseInt(var2[0]); // L: 126
			this.field4923 = Integer.parseInt(var2[1]); // L: 127
			this.field4925 = Integer.parseInt(var2[2]); // L: 128
