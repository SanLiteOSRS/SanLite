...
public class DesktopPlatformInfoProvider implements PlatformInfoProvider {
	...
	static final void method6380(int var0, int var1, boolean var2) {
		if (!var2 || var0 != HealthBarDefinition.field1671 || WorldMapArea.field2053 != var1) {
			...
			NameableContainer.updateGameState(25);
			ScriptFrame.drawLoadingMessage("Loading - please wait.", true);
			int var3 = WorldMapSectionType.baseX * 64;
			int var4 = PlayerComposition.baseY * 64;
			WorldMapSectionType.baseX = (var0 - 6) * 8;
			PlayerComposition.baseY = (var1 - 6) * 8;
			int var5 = WorldMapSectionType.baseX * 64 - var3;
			int var6 = PlayerComposition.baseY * 64 - var4;
			var3 = WorldMapSectionType.baseX * 64;
			var4 = PlayerComposition.baseY * 64;
