...
public class DesktopPlatformInfoProvider implements PlatformInfoProvider {
	...
	public PlatformInfo get() {
		byte var1;
		if (class17.formattedOperatingSystemName.startsWith("win")) { // L: 16
			var1 = 1;
		} else if (class17.formattedOperatingSystemName.startsWith("mac")) { // L: 17
			var1 = 2;
		} else if (class17.formattedOperatingSystemName.startsWith("linux")) { // L: 18
			var1 = 3;
		} else {
			var1 = 4; // L: 19
		}
		...
		return new PlatformInfo(var1, var28, var7, var8, this.field4637, this.field4640, this.field4641, false, var10, var11, var12, 0, var13, var14, var15, var16, 0, 0, 0, 0, var17, var18, var23, 0, "", ""); // L: 99
	}
	...
	void method7828(String var1) {
		if (var1.startsWith("1.")) { // L: 103
			this.method7829(var1); // L: 104
		} else {
			this.method7832(var1); // L: 107
		}
	...
	void method7829(String var1) {
		...
		try {
			this.field4637 = Integer.parseInt(var2[1]); // L: 114
			var2 = var2[2].split("_"); // L: 115
			this.field4640 = Integer.parseInt(var2[0]); // L: 116
			this.field4641 = Integer.parseInt(var2[1]); // L: 117
	...
	void method7832(String var1) {
		...
		try {
			this.field4637 = Integer.parseInt(var2[0]); // L: 125
			this.field4640 = Integer.parseInt(var2[1]); // L: 126
			this.field4641 = Integer.parseInt(var2[2]); // L: 127
