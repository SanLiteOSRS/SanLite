...
public class DesktopPlatformInfoProvider implements class475 {
	...
	public PlatformInfo get() {
		byte var1;
		if (class20.field99.startsWith("win")) { // L: 16
			var1 = 1;
		} else if (class20.field99.startsWith("mac")) { // L: 17
			var1 = 2;
		} else if (class20.field99.startsWith("linux")) { // L: 18
			var1 = 3;
		} else {
			var1 = 4; // L: 19
		}
		...
		return new PlatformInfo(var1, var28, var7, var8, this.field4812, this.field4810, this.field4814, false, var10, var11, var12, 0, var13, var14, var15, var16, 0, 0, 0, 0, var17, var18, var23, 0, "", ""); // L: 99
	}
	...
	void method8408(String var1) {
		if (var1.startsWith("1.")) { // L: 103
			this.method8416(var1); // L: 104
		} else {
			this.method8413(var1); // L: 107
		}
	...
	@ObfuscatedSignature(
		...
		garbageValue = "-761802138"
	)
	void method8416(String var1) {
		String[] var2 = var1.split("\\."); // L: 112

		try {
			this.field4812 = Integer.parseInt(var2[1]); // L: 114
			var2 = var2[2].split("_"); // L: 115
			this.field4810 = Integer.parseInt(var2[0]); // L: 116
			this.field4814 = Integer.parseInt(var2[1]); // L: 117
	...
	@ObfuscatedSignature(
		descriptor = "(Ljava/lang/String;I)V",
		garbageValue = "1850654986"
	)
	void method8413(String var1) {
		String[] var2 = var1.split("\\."); // L: 123

		try {
			this.field4812 = Integer.parseInt(var2[0]); // L: 125
			this.field4810 = Integer.parseInt(var2[1]); // L: 126
			this.field4814 = Integer.parseInt(var2[2]); // L: 127
