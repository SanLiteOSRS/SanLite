...
public class class321 {
	...
	static final void method6030(int var0, int var1, boolean var2) {
		if (!var2 || var0 != class193.field2197 || class221.field2647 != var1) {
			...
			int var3 = ApproximateRouteStrategy.baseX * 64;
			int var4 = class250.baseY * 64;
			ApproximateRouteStrategy.baseX = (var0 - 6) * 8;
			class250.baseY = (var1 - 6) * 8;
			int var5 = ApproximateRouteStrategy.baseX * 64 - var3;
			int var6 = class250.baseY * 64 - var4;
			var3 = ApproximateRouteStrategy.baseX * 64;
			var4 = class250.baseY * 64;
