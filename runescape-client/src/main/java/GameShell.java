...
public abstract class GameShell extends Applet implements Runnable, FocusListener, WindowListener {
	...
	protected GameShell() {
		...
		class297.method5494(new DevicePcmPlayerProvider());
	}
	...
	final synchronized void addCanvas() {
		...
		this.isCanvasInvalid = false;
		this.field445 = PlayerAppearance.method4141();
	}
	...
	void method1009() {
		long var1 = PlayerAppearance.method4141();
		long var3 = field430[class49.field400];
		field430[class49.field400] = var1;
		class49.field400 = class49.field400 + 1 & 31;
	...
	void method1081() {
		...
		long var4 = field429[Messages.field1251];
		field429[Messages.field1251] = var2;
		Messages.field1251 = Messages.field1251 + 1 & 31;
	...
	public final void destroy() {
		if (this == gameShell && !isKilled) {
			stopTimeMs = PlayerAppearance.method4141();
			ClanChat.method5311(5000L);
			this.kill();
		}
	}
	...
	public final synchronized void paint(Graphics var1) {
		if (this == gameShell && !isKilled) {
			this.field441 = true;
			if (PlayerAppearance.method4141() - this.field445 > 1000L) {
	...
	public void run() {
		try {
			...
			while (stopTimeMs == 0L || PlayerAppearance.method4141() < stopTimeMs) {
				ArchiveLoader.field524 = clock.wait(cycleDurationMillis, fiveOrOne);

				for (int var5 = 0; var5 < ArchiveLoader.field524; ++var5) {
					this.method1009();
				}
	...
	public final void stop() {
		if (this == gameShell && !isKilled) {
			stopTimeMs = PlayerAppearance.method4141() + 4000L;
		}
	}
