...
public abstract class GameShell extends Applet implements Runnable, FocusListener, WindowListener {
   ...
   @ObfuscatedName("p")
   protected static long[] field423 = new long[32];
   @ObfuscatedName("g")
   protected static long[] field417 = new long[32];
   @ObfuscatedName("ak")
   @ObfuscatedGetter(
      intValue = 868948239
   )
   static int field436 = 500;
   @ObfuscatedName("aq")
   @Export("hasFocus")
   ...
   @ObfuscatedName("at")
   volatile boolean field435 = true;
   @ObfuscatedName("ao")
   ...
   final synchronized void addCanvas() {
      ...
      this.field424 = SequenceDefinition.currentTimeMs();
   }
   ...
   void method877() {
      long var1 = SequenceDefinition.currentTimeMs();
   ...
   void method878() {
      Container var1 = this.container();
      long var2 = SequenceDefinition.currentTimeMs();
   ...
   protected final void drawInitial(int var1, String var2, boolean var3) {
      try {
         ...
         if (WorldMapData_1.field326 == null) {
            WorldMapData_1.field326 = new java.awt.Font("Helvetica", 1, 13);
            HealthBarUpdate.field987 = this.canvas.getFontMetrics(WorldMapData_1.field326);
         }
         ...
         try {
            ...
            var6.setFont(WorldMapData_1.field326);
            var6.setColor(Color.white);
            var6.drawString(var2, (304 - HealthBarUpdate.field987.stringWidth(var2)) / 2, 22);
            ...
            var4.setFont(WorldMapData_1.field326);
            var4.setColor(Color.white);
            var4.drawString(var2, var7 + (304 - HealthBarUpdate.field987.stringWidth(var2)) / 2, var8 + 22);
         }
   ...
   protected final void method891() {
      ...
      WorldMapData_1.field326 = null;
      HealthBarUpdate.field987 = null;
   }
   ...
   public final void destroy() {
      if (this == gameShell && !isKilled) {
         stopTimeMs = SequenceDefinition.currentTimeMs();
         UserList.method5062(5000L);
         this.kill();
      }
   }
   ...
   public final synchronized void paint(Graphics var1) {
      if (this == gameShell && !isKilled) {
         this.field435 = true;
         if (SequenceDefinition.currentTimeMs() - this.field424 > 1000L) {
   ...
   public final void stop() {
      if (this == gameShell && !isKilled) {
         stopTimeMs = SequenceDefinition.currentTimeMs() + 4000L;
      }
   }
   ...
   public void run() {
      try {
         if (TaskHandler.javaVendor != null) {
            ...
            if (var1.indexOf("sun") != -1 || var1.indexOf("apple") != -1) {
               ...
               if (var2.startsWith("1.6.0_")) {
                  int var3;
                  for(var3 = 6; var3 < var2.length() && NetCache.isCharDigit(var2.charAt(var3)); ++var3) {
                  }

                  String var4 = var2.substring(6, var3);
                  if (TaskHandler.method3423(var4) && WallDecoration.parseInt(var4) < 10) {
                     this.error("wrongjava");
                     return;
                  }
               }
         ...
         this.addCanvas();
         this.setUp();
         clock = Bounds.method5869();

         while(stopTimeMs == 0L || SequenceDefinition.currentTimeMs() < stopTimeMs) {
            field413 = clock.wait(field447, field419);
   ...
   public static boolean method1004(File var0, boolean var1) {
      try {
   ...
   static Sprite[] method897() {
      ...
      for(int var1 = 0; var1 < class325.SpriteBuffer_spriteCount; ++var1) {
         ...
         var2.yOffset = class325.SpriteBuffer_xOffsets[var1];
         var2.xOffset = class325.SpriteBuffer_yOffsets[var1];
   ...
   static void method867(int var0, int var1) {
      PacketBufferNode var2 = MenuAction.method1994(ClientPacket.field2192, Client.packetWriter.isaacCipher);
      var2.packetBuffer.writeIntLE16(var0);
      var2.packetBuffer.method5443(var1);
      Client.packetWriter.method2177(var2);
   }
}
