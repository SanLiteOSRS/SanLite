		...
		if (var1 != null) { // L: 75
			...
			if (var2.hasCleanName()) { // L: 77
				...
				if (this.friendsListIsFull()) { // L: 78
					...
					PacketBufferNode var3 = class120.getPacketBufferNode(ClientPacket.field3030, Client.packetWriter.isaacCipher); // L: 106
		...
		if (var1 != null) { // L: 197
			...
			if (var2.hasCleanName()) { // L: 199
				if (this.friendsList.removeByUsername(var2)) { // L: 200
					...
					PacketBufferNode var3 = class120.getPacketBufferNode(ClientPacket.field3036, Client.packetWriter.isaacCipher); // L: 203
		...
		if (var1 != null) { // L: 212
			...
			if (var2.hasCleanName()) { // L: 214
				if (this.ignoreList.removeByUsername(var2)) { // L: 215
					...
					PacketBufferNode var3 = class120.getPacketBufferNode(ClientPacket.field2938, Client.packetWriter.isaacCipher); // L: 218
