...
public class FriendSystem {
	...
	final void readUpdate(Buffer var1, int var2) {
		...
		if (PcmPlayer.friendsChatManager != null) { // L: 55
			PcmPlayer.friendsChatManager.clearFriends(); // L: 56
		}
		...
		if (var1 != null) { // L: 91
			...
			if (var2.hasCleanName()) { // L: 93
				if (this.friendsListIsFull()) { // L: 94
					...
					PacketBufferNode var3 = DecorativeObject.getPacketBufferNode(ClientPacket.field2998, Client.packetWriter.isaacCipher); // L: 118
		...
		if (var1 != null) { // L: 141
			...
			if (var2.hasCleanName()) { // L: 143
				if (this.canAddIgnore()) { // L: 144
					...
					PacketBufferNode var3 = DecorativeObject.getPacketBufferNode(ClientPacket.field2959, Client.packetWriter.isaacCipher); // L: 166
		...
		if (var1 != null) { // L: 189
			...
			if (var2.hasCleanName()) { // L: 191
				if (this.friendsList.removeByUsername(var2)) { // L: 192
					...
					PacketBufferNode var3 = DecorativeObject.getPacketBufferNode(ClientPacket.field2954, Client.packetWriter.isaacCipher); // L: 195
				...
				if (PcmPlayer.friendsChatManager != null) { // L: 213
					PcmPlayer.friendsChatManager.clearFriends(); // L: 214
				}
		...
		if (var1 != null) { // L: 220
			...
			if (var2.hasCleanName()) { // L: 222
				if (this.ignoreList.removeByUsername(var2)) { // L: 223
					...
					PacketBufferNode var3 = DecorativeObject.getPacketBufferNode(ClientPacket.field3034, Client.packetWriter.isaacCipher); // L: 226
