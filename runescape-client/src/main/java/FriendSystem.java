...
public class FriendSystem {
   ...
   final void method1783(Buffer var1, int var2) {
   ...
   final void method1776() {
      for(FriendLoginUpdate var1 = (FriendLoginUpdate)this.friendsList.friendLoginUpdates.last(); var1 != null; var1 = (FriendLoginUpdate)this.friendsList.friendLoginUpdates.previous()) {
         if ((long)var1.field3621 < SequenceDefinition.currentTimeMs() / 1000L - 5L) {
            if (var1.world > 0) {
         ...
         if (var2.hasCleanName()) {
            if (this.canAddFriend()) {
               ...
               if (WorldMapIcon_1.localPlayer.username.equals(var2)) {
                  ...
                  PacketBufferNode var3 = MenuAction.method1994(ClientPacket.field2201, Client.packetWriter.isaacCipher);
                  var3.packetBuffer.writeByte(Buddy.stringCp1252NullTerminatedByteSize(var1));
                  var3.packetBuffer.writeStringCp1252NullTerminated(var1);
                  Client.packetWriter.method2177(var3);
               }
            }
         }
      }
      ...
      if (var1 != null) {
         ...
         if (var2.hasCleanName()) {
            if (this.friendsList.removeByUsername(var2)) {
               class43.method759();
               PacketBufferNode var3 = MenuAction.method1994(ClientPacket.field2225, Client.packetWriter.isaacCipher);
               var3.packetBuffer.writeByte(Buddy.stringCp1252NullTerminatedByteSize(var1));
               var3.packetBuffer.writeStringCp1252NullTerminated(var1);
               Client.packetWriter.method2177(var3);
            }
      ...
      if (var1 != null) {
         ...
         if (var2.hasCleanName()) {
            if (this.ignoreList.removeByUsername(var2)) {
               class43.method759();
               PacketBufferNode var3 = MenuAction.method1994(ClientPacket.field2266, Client.packetWriter.isaacCipher);
               var3.packetBuffer.writeByte(Buddy.stringCp1252NullTerminatedByteSize(var1));
               var3.packetBuffer.writeStringCp1252NullTerminated(var1);
               Client.packetWriter.method2177(var3);
            }
   ...
   static void method1822(Widget var0) {
