...
public class class19 {
	...
	static final void addObjects(int var0, int var1, int var2, int var3, int var4, int var5, Scene var6, CollisionMap var7) {
		if (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var1][var2] & 2) != 0 || (Tiles.Tiles_renderFlags[var0][var1][var2] & 16) == 0) { // L: 345 346 347
			...
			if (var8.hasSound()) { // L: 389
				...
				var22.maxX = (var23 + var1) * 16384; // L: 400
				var22.maxY = (var24 + var2) * 16384; // L: 401
			...
			if (var5 == 22) { // L: 414
				if (!Client.isLowDetail || var8.int1 != 0 || var8.interactType == 1 || var8.boolean2) { // L: 415
					...
					var6.newGroundObject(var0, var1, var2, var16, (Renderable)var34, var19, var21); // L: 419
				...
				if (var5 >= 12) { // L: 444
					...
					var6.newWallObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field988[var4], 0, var19, var21); // L: 457
					if (var4 == 0) { // L: 458
					...
					var6.newWallObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field989[var4], 0, var19, var21); // L: 494
					...
					if (var5 == 2) { // L: 504
						...
						var6.newWallObject(var0, var1, var2, var16, (Renderable)var31, (Renderable)var32, Tiles.field988[var4], Tiles.field988[var28], var19, var21); // L: 516
						...
						var6.newWallObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field989[var4], 0, var19, var21); // L: 543
						...
						var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, Tiles.field988[var4], 0, 0, 0, var19, var21); // L: 566
					} else {
						Object var25;
						long var29;
						if (var5 == 5) { // L: 569
							var28 = 16; // L: 570
							var29 = var6.getWallObjectTag(var0, var1, var2); // L: 571
							if (0L != var29) { // L: 572
							...
							var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, Tiles.field988[var4], 0, var28 * Tiles.field990[var4], var28 * Tiles.field991[var4], var19, var21); // L: 576
						} else if (var5 == 6) { // L: 579
							var28 = 8; // L: 580
							var29 = var6.getWallObjectTag(var0, var1, var2); // L: 581
							if (var29 != 0L) { // L: 582
							...
							var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, 256, var4, var28 * Tiles.field995[var4], var28 * Tiles.field993[var4], var19, var21); // L: 586
							...
							var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var34, (Renderable)null, 256, var23, 0, 0, var19, var21); // L: 594
						} else if (var5 == 8) { // L: 597
							var28 = 8; // L: 598
							var29 = var6.getWallObjectTag(var0, var1, var2); // L: 599
							if (0L != var29) { // L: 600
								var28 = class82.getObjectDefinition(NetSocket.Entity_unpackID(var29)).int2 / 2;
							}
							...
							var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)var26, 256, var4, var28 * Tiles.field995[var4], var28 * Tiles.field993[var4], var19, var21); // L: 612
						}
					}
				}
			} else {
			...
			if (Client.minimapState != 2 && Client.minimapState != 5) { // L: 12292
				...
				for (var8 = 0; var8 < 104; ++var8) { // L: 12302
					for (var16 = 0; var16 < 104; ++var16) { // L: 12303
						...
						if (var14 != null) { // L: 12305
							...
							PcmPlayer.drawSpriteOnMinimap(var1, var2, var11, var12, DecorativeObject.mapDotSprites[0], var4); // L: 12308
						}
					}
				}
				...
				for (var8 = 0; var8 < Client.npcCount; ++var8) { // L: 12312
					...
					if (var9 != null && var9.isVisible()) { // L: 12314
						...
						if (var18 != null && var18.drawMapDot && var18.isInteractable) { // L: 12317
							...
							PcmPlayer.drawSpriteOnMinimap(var1, var2, var11, var12, DecorativeObject.mapDotSprites[1], var4); // L: 12320
						}
					}
				}
				...
				for (var10 = 0; var10 < var8; ++var10) { // L: 12326
					...
					if (var15 != null && var15.isVisible() && !var15.isHidden && var15 != ModelData0.localPlayer) { // L: 12328
						...
						if (var15.isFriend()) { // L: 12331
							...
							PcmPlayer.drawSpriteOnMinimap(var1, var2, var12, var13, DecorativeObject.mapDotSprites[2], var4); // L: 12335
						}
					}
				}
				...
				if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) { // L: 12338
					...
					if (Client.hintArrowType == 2) { // L: 12347
						var10 = Client.hintArrowX * 4 - SecureRandomCallable.baseX * 256 + 2 - ModelData0.localPlayer.x / 32; // L: 12348
						var11 = Client.hintArrowY * 4 - GrandExchangeOfferOwnWorldComparator.baseY * 256 + 2 - ModelData0.localPlayer.y / 32; // L: 12349
	...
	static final void clanKickUser(String var0) {
		if (PcmPlayer.friendsChatManager != null) { // L: 12439
			PacketBufferNode var1 = DecorativeObject.getPacketBufferNode(ClientPacket.field2983, Client.packetWriter.isaacCipher); // L: 12440
