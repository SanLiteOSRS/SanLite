	...
	static int method1963(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) { // L: 1470
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				PacketBufferNode var13 = DecorativeObject.getPacketBufferNode(ClientPacket.field2972, Client.packetWriter.isaacCipher); // L: 1491
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					...
					var11 = DecorativeObject.getPacketBufferNode(ClientPacket.field3048, Client.packetWriter.isaacCipher); // L: 1499
					...
					var11 = DecorativeObject.getPacketBufferNode(ClientPacket.field3033, Client.packetWriter.isaacCipher); // L: 1508
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						var11 = DecorativeObject.getPacketBufferNode(ClientPacket.field3017, Client.packetWriter.isaacCipher); // L: 1558
						...
						if (var4.length() > 500) { // L: 1568
							...
							PacketBufferNode var6 = DecorativeObject.getPacketBufferNode(ClientPacket.field3044, Client.packetWriter.isaacCipher); // L: 1570
						...
						Interpreter.Interpreter_intStack[++class12.Interpreter_intStackSize - 1] = DecorativeObject.getTapToDrop() ? 1 : 0; // L: 1627
						return 1; // L: 1628
					} else if (var0 == 3129) {
						...
						Client.field657 = var2 ? Interpreter.scriptDotWidget.id : KeyHandler.scriptActiveWidget.id; // L: 1680
						return 1; // L: 1681
					} else {
						boolean var3;
	...
	static void method1964(int var0, String var1) {
		...
		for (int var6 = 0; var6 < var2; ++var6) { // L: 9731
			...
			if (var7 != null && var7 != ModelData0.localPlayer && var7.username != null && var7.username.equals(var5)) { // L: 9733
				...
				if (var0 == 1) { // L: 9734
					var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2965, Client.packetWriter.isaacCipher); // L: 9736
					...
					var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2962, Client.packetWriter.isaacCipher); // L: 9743
					...
					var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2969, Client.packetWriter.isaacCipher); // L: 9750
					...
					var8 = DecorativeObject.getPacketBufferNode(ClientPacket.field2980, Client.packetWriter.isaacCipher); // L: 9757
