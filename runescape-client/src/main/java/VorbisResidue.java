...
public class VorbisResidue {
	...
	@ObfuscatedName("f")
	void method873(float[] var1, int var2, boolean var3) {
		int var4;
		...
		if (!var3) { // L: 35
			...
			for (int var8 = 0; var8 < 8; ++var8) { // L: 40
				...
				while (var9 < var6) { // L: 42
					...
					int var11;
					if (var8 == 0) { // L: 43
						var10 = VorbisSample.VorbisSample_codebooks[this.classbook].method1053(); // L: 45
						...
						if (var12 >= 0) { // L: 56
							...
							if (this.residueType == 0) { // L: 59
								...
								for (int var19 = 0; var19 < var15; ++var19) { // L: 61
									float[] var20 = var14.method1056(); // L: 62
								...
								while (var15 < this.partitionSize) { // L: 68
									float[] var16 = var14.method1056(); // L: 69
