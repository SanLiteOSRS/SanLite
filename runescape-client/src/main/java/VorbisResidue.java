...
public class VorbisResidue {
	...
	@ObfuscatedName("h")
	void method877(float[] var1, int var2, boolean var3) {
		int var4;
		...
		if (!var3) {
			...
			for (int var8 = 0; var8 < 8; ++var8) {
				...
				while (var9 < var6) {
					...
					int var11;
					if (var8 == 0) {
						var10 = VorbisSample.VorbisSample_codebooks[this.classbook].method1048();
