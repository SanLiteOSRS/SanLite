...
public class Message extends DualNode {
	...
	final void fillSenderUsername() {
		if (this.sender != null) {
			this.senderUsername = new Username(class186.method3725(this.sender), class60.loginType);
		} else {
	...
	static final void drawSpriteOnMinimap(int var0, int var1, int var2, int var3, Sprite var4, SpriteMask var5) {
		if (var4 != null) {
			...
			if (var7 <= 6400) {
				...
				if (var7 > 2500) {
					var4.method6201(var10 + var5.width / 2 - var4.width / 2, var5.height / 2 - var11 - var4.height / 2, var0, var1, var5.width, var5.height, var5.xStarts, var5.xWidths);
				} else {
