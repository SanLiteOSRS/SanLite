...
public class Message extends DualNode {
   ...
   final void fillSenderUsername() {
      if (this.sender != null) {
         this.senderUsername = new Username(NetSocket.removeImageTag(this.sender), FontName.loginType);
      } else {
         ...
         if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFEREMPTY) {
            ...
            if (var0 == ScriptOpcodes.TRADINGPOST_SORTBY_NAME) {
               ...
               if (var0 == ScriptOpcodes.TRADINGPOST_GETOFFERWORLD) {
                  ...
                  var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                  var11 = (GrandExchangeEvent)class2.grandExchangeEvents.events.get(var3);
                  long var5 = SequenceDefinition.currentTimeMs() - Occluder.field1890 - var11.age;
         ...
         if (var0 == ScriptOpcodes.APPEND) {
            ...
            if (var0 == ScriptOpcodes.FROMDATE) {
               ...
               if (var0 == ScriptOpcodes.TOSTRING) {
                  ...
                  Interpreter.Interpreter_stringStackSize -= 2;
                  Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = WallDecoration.method3245(TriBool.method5084(Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize], Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize + 1], class60.clientLanguage));
                  return 1;
               } else {
                  int var5;
                  byte[] var13;
                  ...
                  if (var0 == ScriptOpcodes.PARAHEIGHT) {
                     ...
                     var10 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                     Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = NetCache.isCharDigit((char)var10) ? 1 : 0;
                     return 1;
