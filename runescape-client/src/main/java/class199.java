		...
		if (Login.worldSelectOpen) { // L: 1658
			...
			if (GrandExchangeOfferOwnWorldComparator.worldSelectBackSprites != null) { // L: 1741
				...
				if (BufferedNetSocket.worldSelectLeftSprite != null && Login.worldSelectPage > 0) { // L: 1762
					BufferedNetSocket.worldSelectLeftSprite.drawAt(8, Language.canvasHeight / 2 - BufferedNetSocket.worldSelectLeftSprite.subHeight / 2); // L: 1763
				}

				if (class140.worldSelectRightSprite != null && Login.worldSelectPage < Login.worldSelectPagesCount) { // L: 1765
					class140.worldSelectRightSprite.drawAt(CollisionMap.canvasWidth - class140.worldSelectRightSprite.subWidth - 8, Language.canvasHeight / 2 - class140.worldSelectRightSprite.subHeight / 2); // L: 1766
				}
			...
			if (Client.gameState == 20) { // L: 1889
				ModelData0.titleboxSprite.drawAt(Login.loginBoxX + 180 - ModelData0.titleboxSprite.subWidth / 2, 271 - ModelData0.titleboxSprite.subHeight / 2); // L: 1890
				var30 = 201; // L: 1891
