...
public class class348 {
	...
	static {
		field3729 = new short[]{6798, 8741, 25238, 4626, 4550}; // L: 4
		...
		field3727 = new short[]{-10304, 9104, -1, -1, -1}; // L: 12
	...
	static void method6643() {
		Tiles.field1030 = null; // L: 61
		AccessFile.field5129 = null; // L: 62
		Tiles.field1031 = null; // L: 63
		Tiles.field1028 = null; // L: 64
		class168.field1833 = null; // L: 65
		TextureProvider.field2750 = null; // L: 66
		class306.field3195 = null; // L: 67
		World.Tiles_hue = null; // L: 68
		WorldMapLabelSize.Tiles_saturation = null; // L: 69
		class539.Tiles_lightness = null; // L: 70
		Tiles.Tiles_hueMultiplier = null; // L: 71
		class384.field4473 = null; // L: 72
	} // L: 73
	...
	static boolean method6644(Date var0) {
		Date var1 = class528.method9191(); // L: 1100
		return var0.after(var1); // L: 1101
	}
}
