...
public final class Projectile extends Entity {
   ...
   Projectile(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      ...
      this.isMoving = false;
      int var12 = HealthBarUpdate.getSpotAnimationDefinition(this.id).sequence;
      if (var12 != -1) {
         this.sequenceDefinition = Widget.getSequenceDefinition(var12);
      } else {
   ...
   protected final Model getModel() {
      SpotAnimationDefinition var1 = HealthBarUpdate.getSpotAnimationDefinition(this.id);
   ...
   public static boolean loadInterface(int var0) {
      if (WorldMapDecoration.loadedInterfaces[var0]) {
         return true;
         ...
         if (var1 == 0) {
            WorldMapDecoration.loadedInterfaces[var0] = true;
            return true;
         } else {
