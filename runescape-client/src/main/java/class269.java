		...
		if (!var0) { // L: 5552
			...
			if (!var0) { // L: 5570
				...
				if (IgnoreList.client.hasFrame()) { // L: 5695
					var17 = class120.getPacketBufferNode(ClientPacket.field2995, Client.packetWriter.isaacCipher); // L: 5697
				...
				var17 = class120.getPacketBufferNode(ClientPacket.field2976, Client.packetWriter.isaacCipher); // L: 5717
