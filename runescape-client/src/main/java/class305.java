		...
		if (var0 == ScriptOpcodes.FRIEND_COUNT) { // L: 2341
			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					DecorativeObject.method4392(var5, var6); // L: 2379
					return 1; // L: 2380
					...
					if (PcmPlayer.friendsChatManager != null) { // L: 2409
						Interpreter.Interpreter_stringStack[++class9.Interpreter_stringStackSize - 1] = PcmPlayer.friendsChatManager.name; // L: 2410
					} else {
					...
					if (PcmPlayer.friendsChatManager != null) { // L: 2416
						Interpreter.Interpreter_intStack[++class12.Interpreter_intStackSize - 1] = PcmPlayer.friendsChatManager.getSize(); // L: 2417
					} else {
					...
					if (PcmPlayer.friendsChatManager != null && var3 < PcmPlayer.friendsChatManager.getSize()) { // L: 2424
						Interpreter.Interpreter_stringStack[++class9.Interpreter_stringStackSize - 1] = PcmPlayer.friendsChatManager.get(var3).getUsername().getName(); // L: 2425
					} else {
					...
					if (PcmPlayer.friendsChatManager != null && var3 < PcmPlayer.friendsChatManager.getSize()) { // L: 2432
						Interpreter.Interpreter_intStack[++class12.Interpreter_intStackSize - 1] = ((Buddy)PcmPlayer.friendsChatManager.get(var3)).getWorld(); // L: 2433
					} else {
					...
					if (PcmPlayer.friendsChatManager != null && var3 < PcmPlayer.friendsChatManager.getSize()) { // L: 2440
						Interpreter.Interpreter_intStack[++class12.Interpreter_intStackSize - 1] = ((Buddy)PcmPlayer.friendsChatManager.get(var3)).rank; // L: 2441
					} else {
					...
					Interpreter.Interpreter_intStack[++class12.Interpreter_intStackSize - 1] = PcmPlayer.friendsChatManager != null ? PcmPlayer.friendsChatManager.minKick : 0; // L: 2447
					return 1; // L: 2448
					...
					Interpreter.Interpreter_intStack[++class12.Interpreter_intStackSize - 1] = PcmPlayer.friendsChatManager != null ? PcmPlayer.friendsChatManager.rank : 0; // L: 2456
					return 1; // L: 2457
					...
					if (PcmPlayer.friendsChatManager != null && var3 < PcmPlayer.friendsChatManager.getSize() && PcmPlayer.friendsChatManager.get(var3).getUsername().equals(ModelData0.localPlayer.username)) { // L: 2494
					...
					if (PcmPlayer.friendsChatManager != null && PcmPlayer.friendsChatManager.owner != null) { // L: 2501
						Interpreter.Interpreter_stringStack[++class9.Interpreter_stringStackSize - 1] = PcmPlayer.friendsChatManager.owner; // L: 2502
					} else {
					...
					if (PcmPlayer.friendsChatManager != null && var3 < PcmPlayer.friendsChatManager.getSize() && ((FriendsChatMember)PcmPlayer.friendsChatManager.get(var3)).isFriend()) { // L: 2509
					...
					if (var0 == 3628) {
						...
						if (var0 == 3629) {
							...
							if (PcmPlayer.friendsChatManager != null) { // L: 2600
								PcmPlayer.friendsChatManager.removeComparator(); // L: 2601
							}

							return 1; // L: 2603
						} else if (var0 == 3645) {
							var7 = Interpreter.Interpreter_intStack[--class12.Interpreter_intStackSize] == 1; // L: 2606
							if (PcmPlayer.friendsChatManager != null) { // L: 2607
								PcmPlayer.friendsChatManager.addComparator(new UserComparator1(var7)); // L: 2608
							}

							return 1; // L: 2610
						} else if (var0 == 3646) {
							var7 = Interpreter.Interpreter_intStack[--class12.Interpreter_intStackSize] == 1; // L: 2613
							if (PcmPlayer.friendsChatManager != null) { // L: 2614
								PcmPlayer.friendsChatManager.addComparator(new UserComparator2(var7)); // L: 2615
							}

							return 1; // L: 2617
						} else if (var0 == 3647) {
							var7 = Interpreter.Interpreter_intStack[--class12.Interpreter_intStackSize] == 1; // L: 2620
							if (PcmPlayer.friendsChatManager != null) { // L: 2621
								PcmPlayer.friendsChatManager.addComparator(new UserComparator3(var7)); // L: 2622
							}

							return 1; // L: 2624
						} else if (var0 == 3648) {
							var7 = Interpreter.Interpreter_intStack[--class12.Interpreter_intStackSize] == 1; // L: 2627
							if (PcmPlayer.friendsChatManager != null) { // L: 2628
								PcmPlayer.friendsChatManager.addComparator(new UserComparator4(var7)); // L: 2629
							}

							return 1; // L: 2631
						} else if (var0 == 3649) {
							var7 = Interpreter.Interpreter_intStack[--class12.Interpreter_intStackSize] == 1; // L: 2634
							if (PcmPlayer.friendsChatManager != null) { // L: 2635
								PcmPlayer.friendsChatManager.addComparator(new UserComparator5(var7)); // L: 2636
							}

							return 1; // L: 2638
						} else if (var0 == 3650) {
							var7 = Interpreter.Interpreter_intStack[--class12.Interpreter_intStackSize] == 1; // L: 2641
							if (PcmPlayer.friendsChatManager != null) { // L: 2642
								PcmPlayer.friendsChatManager.addComparator(new UserComparator6(var7)); // L: 2643
							}

							return 1; // L: 2645
						} else if (var0 == 3651) {
							var7 = Interpreter.Interpreter_intStack[--class12.Interpreter_intStackSize] == 1; // L: 2648
							if (PcmPlayer.friendsChatManager != null) { // L: 2649
								PcmPlayer.friendsChatManager.addComparator(new UserComparator7(var7)); // L: 2650
							}

							return 1; // L: 2652
						} else if (var0 == 3652) {
							var7 = Interpreter.Interpreter_intStack[--class12.Interpreter_intStackSize] == 1; // L: 2655
							if (PcmPlayer.friendsChatManager != null) { // L: 2656
								PcmPlayer.friendsChatManager.addComparator(new UserComparator8(var7)); // L: 2657
							}

							return 1; // L: 2659
						} else if (var0 == 3653) {
							var7 = Interpreter.Interpreter_intStack[--class12.Interpreter_intStackSize] == 1; // L: 2662
							if (PcmPlayer.friendsChatManager != null) { // L: 2663
								PcmPlayer.friendsChatManager.addComparator(new UserComparator9(var7)); // L: 2664
							}

							return 1; // L: 2666
						} else if (var0 == 3654) {
							var7 = Interpreter.Interpreter_intStack[--class12.Interpreter_intStackSize] == 1; // L: 2669
							if (PcmPlayer.friendsChatManager != null) { // L: 2670
								PcmPlayer.friendsChatManager.addComparator(new UserComparator10(var7)); // L: 2671
							}

							return 1; // L: 2673
						} else if (var0 == 3655) {
							if (PcmPlayer.friendsChatManager != null) { // L: 2676
								PcmPlayer.friendsChatManager.sort(); // L: 2677
							}
							...
							if (PcmPlayer.friendsChatManager != null) { // L: 2688
								PcmPlayer.friendsChatManager.addComparator(new BuddyRankComparator(var7)); // L: 2689
							}
					...
					if (PcmPlayer.friendsChatManager != null && var3 < PcmPlayer.friendsChatManager.getSize() && ((FriendsChatMember)PcmPlayer.friendsChatManager.get(var3)).isIgnored()) { // L: 2517
