...
public class class224 {
	...
	static {
		field2587 = new short[]{6798, 8741, 25238, 4626, 4550};
		...
		field2584 = new short[]{-10304, 9104, -1, -1, -1};
			...
			while (true) {
				...
				while (!var8) {
					...
					if (var13 > 0 && var14 > 0 && var13 < 103 && var14 < 103) {
						ObjectComposition var15 = MidiPcmStream.getObjectDefinition(var5);
