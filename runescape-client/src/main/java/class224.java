...
public class class224 {
	...
	static {
		field2577 = new short[]{6798, 8741, 25238, 4626, 4550};
		...
		field2575 = new short[]{-10304, 9104, -1, -1, -1};
			...
			for (var6 = 0; var6 < 104; ++var6) {
				...
				if (var7 != 0L) {
					...
					if (var10 >= 0 && InvDefinition.WorldMapElement_get(var10).field3255) {
						...
						Client.field891[Client.mapIconCount] = var5;
						Client.field892[Client.mapIconCount] = var6;
						++Client.mapIconCount;
					}
				}
			}
