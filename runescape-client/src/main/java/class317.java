...
public class class317 {
	...
	static final void method6527(int var0, int var1) {
		if (Client.hintArrowType == 2) { // L: 4903
			class374.worldToScreen(Client.field765 * 64 + (Client.field653 - WorldMapData_0.baseX * 64 << 7), Client.field704 * 64 + (Client.field511 - GameObject.baseY * 64 << 7), Client.field546 * 2); // L: 4904
