	...
	void method5762(int var1) {
		...
		for (int var11 = 0; var11 < var2; ++var11) {
			for (int var12 = 0; var12 < var2; ++var12) {
				int var13 = var21[var12 + var2 * var11] = (int)(var18[var11] * var18[var12] / var19 * 256.0D);
				if (!var10 && var13 > 0) {
					var10 = true;
				}
			}
		...
		if (var0 == ScriptOpcodes.CLIENTCLOCK) {
			...
			if (var0 == ScriptOpcodes.INV_GETOBJ) {
				...
				if (var0 == ScriptOpcodes.COORD) {
					...
					var4 = Canvas.baseX * 64 + (WorldMapSprite.localPlayer.x >> 7);
					var5 = class118.baseY * 64 + (WorldMapSprite.localPlayer.y >> 7);
