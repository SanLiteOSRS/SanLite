...
public class class3 implements Enumerated {
   ...
   static final class3 field19 = new class3(2, 0, Integer.class, new class1());
   @ObfuscatedName("j")
   @ObfuscatedSignature(
      signature = "Lk;"
   )
   static final class3 field14 = new class3(0, 1, Long.class, new class2());
   @ObfuscatedName("i")
   @ObfuscatedSignature(
      signature = "Lk;"
   )
   static final class3 field15 = new class3(1, 2, String.class, new class4());
   @ObfuscatedName("f")
   static int[] field26;
   @ObfuscatedName("ay")
   protected static boolean field21;
   @ObfuscatedName("k")
   @ObfuscatedGetter(
      intValue = 244177539
   )
   ...
   public static void sendStackTrace(String var0, Throwable var1) {
      if (var1 != null) {
         ...
         try {
            String var2 = "";
            if (var1 != null) {
               var2 = WallDecoration.method3242(var1);
            }
            ...
            URL var3 = new URL(RunException.RunException_applet.getCodeBase(), "clienterror.ws?c=" + class208.RunException_revision + "&u=" + RunException.localPlayerName + "&v1=" + TaskHandler.javaVendor + "&v2=" + TaskHandler.javaVersion + "&ct=" + GZipDecompressor.RunException_clientType + "&e=" + var2);
   ...
   static boolean method42(String var0) {
      if (var0 == null) {
         return false;
      } else {
         try {
