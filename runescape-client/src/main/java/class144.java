...
public class class144 {
	...
	static final void logOut() {
		...
		HealthBarDefinition.field1579.clear();
		...
		class120.archive3.clearFiles();
		Language.archive4.clearFiles();
		Decimator.archive5.clearFiles();
		InvDefinition.field1520.clearFiles();
		Skeleton.archive7.clearFiles();
		class108.archive6.clearFiles();
		class74.archive9.clearFiles();
		class270.archive8.clearFiles();
		class126.field1453.clearFiles();
