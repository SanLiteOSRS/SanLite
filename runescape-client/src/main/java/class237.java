...
public class class237 {
	...
	@ObfuscatedSignature(
		signature = "(I)V",
		garbageValue = "1306338492"
	)
	public final void method4429() {
		this.field3169 = 0;
	}
	...
	public final void method4425(int var1, int var2, Sprite var3, float var4) {
		int var5 = (int)(18.0F * var4);
		Sprite var6 = this.method4422(var5);
		int var7 = var5 * 2 + 1;
		...
		for (var10 = 0; var10 < this.field3169; ++var10) {
			...
			this.bounds.method6020(var8, var9);
			this.method4428(var6, var3, var9);
		}
	...
	void method4428(Sprite var1, Sprite var2, Bounds var3) {
