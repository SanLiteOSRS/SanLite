				...
				if (var4 != 0 && var4 != 1 && var4 != 2) { // L: 141
					if (var4 == 3 || var4 == 4) { // L: 151
						...
						for (var12 = 0; var12 < var7; ++var12) { // L: 168
							var21[var12] = class464.loadClassFromDescriptor(var8[var12]);
						}

						Class var22 = class464.loadClassFromDescriptor(var20); // L: 169
						if (class464.loadClassFromDescriptor(var5).getClassLoader() == null) { // L: 170
							throw new SecurityException();
						}

						Method[] var13 = class464.loadClassFromDescriptor(var5).getDeclaredMethods(); // L: 171
					...
					if (class464.loadClassFromDescriptor(var5).getClassLoader() == null) { // L: 148
						throw new SecurityException();
					}

					var2.fields[var3] = Reflection.findField(class464.loadClassFromDescriptor(var5), var6); // L: 149
				}
