...
public class class127 extends class128 {
	...
	static final void method2887(int var0, int var1) {
		if (Client.hintArrowType == 2) { // L: 5117
			GrandExchangeOfferOwnWorldComparator.worldToScreen(Client.hintArrowSubX * 64 + (Client.hintArrowX - class300.baseX * 64 << 7), Client.hintArrowSubY * 64 + (Client.hintArrowY - Message.baseY * 64 << 7), Client.hintArrowHeight * 4); // L: 5118
