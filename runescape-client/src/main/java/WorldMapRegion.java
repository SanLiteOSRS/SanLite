...
public class WorldMapRegion {
   ...
   void method476(int var1, int var2, int var3) {
      ...
      if (var4 != null) {
         if (var3 == this.pixelsPerTile * 64) {
            ...
            var4.method6025(var1, var2, var3, var3);
         }
   ...
   void getIcon(ObjectDefinition var1, int var2, int var3, int var4, AbstractWorldMapData var5) {
      ...
      if (var1.transforms != null) {
         ...
         WorldMapElement var9 = WorldMapData_0.getWorldMapElement(var1.mapIconId);
      ...
      while(var4.hasNext()) {
         ...
         if (var5.hasValidElement()) {
            ...
            if (var1.contains(var6)) {
               WorldMapElement var7 = WorldMapData_0.getWorldMapElement(var6);
               this.method430(var7, var5.screenX, var5.screenY, var2, var3);
            }
         }
      }
   ...
   void drawNonLinkMapIcons(int var1, int var2, HashSet var3, int var4) {
      ...
      while(var7.hasNext()) {
         ...
         if (var12 != null && var12.hasValidElement()) {
            var12.screenX = var10;
            var12.screenY = var11;
            WorldMapElement var13 = WorldMapData_0.getWorldMapElement(var12.getElement());
   ...
   void method515(HashSet var1, int var2, int var3) {
      ...
      while(var4.hasNext()) {
         AbstractWorldMapIcon var5 = (AbstractWorldMapIcon)var4.next();
         if (var5.hasValidElement()) {
            WorldMapElement var6 = WorldMapData_0.getWorldMapElement(var5.getElement());
            if (var6 != null && var1.contains(var6.getObjectId())) {
               this.method430(var6, var5.screenX, var5.screenY, var2, var3);
            }
         }
      }
   ...
   void method445(AbstractWorldMapIcon var1, int var2, int var3, float var4) {
      WorldMapElement var5 = WorldMapData_0.getWorldMapElement(var1.getElement());
   ...
   WorldMapLabel method437(int var1) {
      WorldMapElement var2 = WorldMapData_0.getWorldMapElement(var1);
   ...
   static int method464(int var0, Script var1, boolean var2) {
      ...
      if (var0 == ScriptOpcodes.MES) {
         ...
         if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
            var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
            var10 = 0;
            if (TaskHandler.method3423(var3)) {
               var10 = WallDecoration.parseInt(var3);
            }

            PacketBufferNode var12 = MenuAction.method1994(ClientPacket.field2202, Client.packetWriter.isaacCipher);
            ...
            if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
               var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
               var14 = MenuAction.method1994(ClientPacket.field2280, Client.packetWriter.isaacCipher);
               var14.packetBuffer.writeByte(var3.length() + 1);
               var14.packetBuffer.writeStringCp1252NullTerminated(var3);
               Client.packetWriter.method2177(var14);
               return 1;
            } else if (var0 == ScriptOpcodes.RESUME_STRINGDIALOG) {
               var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
               var14 = MenuAction.method1994(ClientPacket.field2194, Client.packetWriter.isaacCipher);
               var14.packetBuffer.writeByte(var3.length() + 1);
               var14.packetBuffer.writeStringCp1252NullTerminated(var3);
               Client.packetWriter.method2177(var14);
               return 1;
               ...
               if (var0 == ScriptOpcodes.OPPLAYER) {
                  ...
                  var15 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                  var14 = MenuAction.method1994(ClientPacket.field2227, Client.packetWriter.isaacCipher);
                  ...
                  if (var7.length() > 500) {
                     ...
                     PacketBufferNode var6 = MenuAction.method1994(ClientPacket.field2232, Client.packetWriter.isaacCipher);
