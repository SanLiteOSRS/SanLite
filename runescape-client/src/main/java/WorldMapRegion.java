...
public class WorldMapRegion {
	...
	void getIcon(ObjectComposition var1, int var2, int var3, int var4, AbstractWorldMapData var5) {
		...
		if (this.worldMapData_0 != null) { // L: 143
			var7 = new Coord(this.worldMapData_0.minPlane + var2, var3 + this.worldMapData_0.regionXLow * 64, this.worldMapData_0.regionYLow * 4096 + var4); // L: 144
		} else {
			WorldMapData_1 var8 = (WorldMapData_1)var5; // L: 147
			var7 = new Coord(var2 + var8.minPlane, var8.regionXLow * 64 + var3 + var8.getChunkXLow() * 8, var8.regionYLow * 4096 + var4 + var8.getChunkYLow() * 8); // L: 148
		}
				...
				for (int var7 = 0; var7 < var6.length; ++var7) { // L: 510
					...
					if (PendingSpawn.method2164(var8.decoration)) { // L: 513
						...
						if (var8.decoration == WorldMapDecorationType.field3559.id) { // L: 523
							...
							if (var8.rotation == 1) {
								Rasterizer2D.method7838(this.pixelsPerTile * var1 + this.pixelsPerTile - 1, this.pixelsPerTile * (63 - var2), 1, var10); // L: 525
							}
						...
						if (var8.decoration == WorldMapDecorationType.field3560.id) { // L: 529
							...
							if (var11 == 0) { // L: 531
								for (var12 = 0; var12 < this.pixelsPerTile; ++var12) { // L: 532
									Rasterizer2D.method7838(var12 + this.pixelsPerTile * var1, (64 - var2) * this.pixelsPerTile - 1 - var12, 1, var10); // L: 533
								}
							} else {
								for (var12 = 0; var12 < this.pixelsPerTile; ++var12) { // L: 537
									Rasterizer2D.method7838(var12 + this.pixelsPerTile * var1, var12 + this.pixelsPerTile * (63 - var2), 1, var10); // L: 538
								}
							}
						}
					}
	...
	void method4571(int var1, int var2, int var3, int var4) {
		...
		if (var3 == 3) {
			Rasterizer2D.method7838(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, this.pixelsPerTile, var4); // L: 768
		}
									...
									case 1:
										if (class152.method3039(UrlRequester.getWidgetFlags(var9))) { // L: 11419
											...
											if (var22 != null) { // L: 11421
												PacketBufferNode var23 = DecorativeObject.getPacketBufferNode(ClientPacket.field3000, Client.packetWriter.isaacCipher); // L: 11422
