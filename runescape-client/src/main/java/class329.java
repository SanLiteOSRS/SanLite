...
public class class329 {
	...
	static final void method5875(int var0, int var1, boolean var2) {
		if (!var2 || var0 != WorldMapSectionType.field2828 || class433.field4657 != var1) { // L: 5647
			...
			int var3 = SecureRandomCallable.baseX * 64; // L: 5654
			int var4 = GrandExchangeOfferOwnWorldComparator.baseY * 64; // L: 5655
			SecureRandomCallable.baseX = (var0 - 6) * 8; // L: 5656
			GrandExchangeOfferOwnWorldComparator.baseY = (var1 - 6) * 8; // L: 5657
			int var5 = SecureRandomCallable.baseX * 64 - var3; // L: 5658
			int var6 = GrandExchangeOfferOwnWorldComparator.baseY * 64 - var4; // L: 5659
			var3 = SecureRandomCallable.baseX * 64; // L: 5660
			var4 = GrandExchangeOfferOwnWorldComparator.baseY * 64; // L: 5661
			...
			for (int var13 = var20; var8 != var13; var13 += var21) { // L: 5700
				for (var14 = var10; var14 != var11; var14 += var12) { // L: 5701
					...
					for (int var17 = 0; var17 < 4; ++var17) { // L: 5704
						if (var15 >= 0 && var16 >= 0 && var15 < 104 && var16 < 104) { // L: 5705
