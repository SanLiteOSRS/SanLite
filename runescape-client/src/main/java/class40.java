...
public class class40 {
	...
	static int method837(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.CHAT_GETFILTER_PUBLIC) {
			...
			class3.privateChatMode = NPCDefinition.method4828(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
		...
		for (int var1 = 0; var1 < Client.npcCount; ++var1) {
			...
			if (var2 != null && var2.isVisible() && var2.definition.isVisible == var0 && var2.definition.transformIsVisible()) {
				...
				if (var3 >= 0 && var3 < 104 && var4 >= 0 && var4 < 104) {
					...
					WorldMapArea.scene.drawEntity(Player.Client_plane, var2.x, var2.y, GraphicsObject.getTileHeight(var2.size * 64 - 64 + var2.x, var2.size * 64 - 64 + var2.y, Player.Client_plane), var2.size * 64 - 64 + 60, var2, var2.rotation, var5, var2.isWalking);
				}
			}
		}
