...
public final class Sprite extends Rasterizer2D {
   ...
   @ObfuscatedName("y")
   public void method6066(int var1, int var2, int var3, int var4) {
      if (var3 > 0 && var4 > 0) {
   ...
   @ObfuscatedName("z")
   public void method6010(int var1, int var2, int var3) {
      var1 += this.yOffset;
      var2 += this.xOffset;
   ...
   @ObfuscatedName("as")
   public void method6025(int var1, int var2, int var3, int var4) {
