...
public final class Sprite extends Rasterizer2D {
	...
	@ObfuscatedName("l")
	public void method6175(int var1, int var2, int var3) {
		var1 += this.xOffset;
		var2 += this.yOffset;
		int var4 = var1 + var2 * Rasterizer2D.Rasterizer2D_width;
		int var5 = 0;
		...
		if (var7 > 0 && var6 > 0) {
			if (var3 == 256) {
				method6176(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9);
			} else {
	...
	@ObfuscatedName("am")
	public void method6178(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) {
			int var6 = this.subWidth;
			int var7 = this.subHeight;
			int var8 = 0;
			...
			if (var5 == 256) {
				method6179(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6);
			} else {
				method6180(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6, var5);
			}
	...
	@ObfuscatedName("ao")
	public void method6181(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
	...
	@ObfuscatedName("ak")
	public void method6158(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
		try {
			int var10 = -var3 / 2;
			int var11 = -var4 / 2;
	...
	@ObfuscatedName("aa")
	public void method6184(int var1, int var2, int var3, int var4) {
		this.method6185(this.width << 3, this.height << 3, var1 << 4, var2 << 4, var3, var4);
	}

	@ObfuscatedName("ab")
	void method6185(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var6 != 0) {
			var1 -= this.xOffset << 4;
			var2 -= this.yOffset << 4;
	...
	@ObfuscatedName("j")
	static void method6176(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
	...
	@ObfuscatedName("ai")
	static void method6179(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15) {
	...
	@ObfuscatedName("ag")
	static void method6180(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16) {
