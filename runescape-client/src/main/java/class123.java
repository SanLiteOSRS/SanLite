...
public enum class123 implements MouseWheel {
	...
	public static void method2781(int var0, int var1, int var2, boolean var3) {
		PacketBufferNode var4 = DecorativeObject.getPacketBufferNode(ClientPacket.field2955, Client.packetWriter.isaacCipher); // L: 12656
		...
		var4.packetBuffer.writeIntME(var3 ? Client.field482 : 0); // L: 12660
