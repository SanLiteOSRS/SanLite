			...
			if (Client.minimapState != 2 && Client.minimapState != 5) { // L: 12075
				...
				if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) { // L: 12121
					...
					if (Client.hintArrowType == 2) { // L: 12130
						var10 = Client.hintArrowX * 4 - class28.baseX * 256 + 2 - class101.localPlayer.x / 32; // L: 12131
						var11 = Client.hintArrowY * 4 - WorldMapLabelSize.baseY * 256 + 2 - class101.localPlayer.y / 32; // L: 12132
