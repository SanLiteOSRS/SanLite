...
public class MusicPatchPcmStream extends PcmStream {
	...
	static final void method4148(class203 var0) {
		...
		if (class203.field2328 == var0) { // L: 6505
			...
			var6 = (var4 & 7) + FriendsChatManager.field3818; // L: 6510
		...
		if (class203.field2335 == var0) { // L: 6528
			...
			var8 = (var6 & 7) + FriendsChatManager.field3818; // L: 6535
			...
			if (class203.field2329 == var0) { // L: 6541
				...
				var9 = (var7 & 7) + FriendsChatManager.field3818; // L: 6549
				...
				if (class203.field2332 == var0) { // L: 6587
					...
					int var41 = (var10 & 7) + FriendsChatManager.field3818; // L: 6598
					...
					if (class203.field2331 == var0) { // L: 6614
						...
						var4 = (var2 & 7) + FriendsChatManager.field3818; // L: 6617
						...
						var7 = (var5 & 7) + FriendsChatManager.field3818; // L: 6642
						...
						var7 = (var5 & 7) + FriendsChatManager.field3818; // L: 6657
						...
						var5 = (var3 & 7) + FriendsChatManager.field3818; // L: 6678
						...
						if (class203.field2327 == var0) { // L: 6690
							...
							int var15 = (var13 & 7) + FriendsChatManager.field3818; // L: 6704
						...
						if (class203.field2330 == var0) { // L: 6755
							...
							var9 = (var7 & 7) + FriendsChatManager.field3818; // L: 6763
