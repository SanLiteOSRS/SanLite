...
public class MusicPatchPcmStream extends PcmStream {
	...
	void method4816(MusicPatchNode var1, int[] var2, int var3, int var4, int var5) {
		if ((this.superStream.field2929[var1.field2970] & 4) != 0 && var1.field2985 < 0) {
			int var6 = this.superStream.field2924[var1.field2970] / (class276.field3287 * 332661776);
			...
			while (true) {
				...
				int var8 = class276.field3287 * 332661776 / 100;
	...
	void method4817(MusicPatchNode var1, int var2) {
		if ((this.superStream.field2929[var1.field2970] & 4) != 0 && var1.field2985 < 0) {
			int var3 = this.superStream.field2924[var1.field2970] / (class276.field3287 * 332661776);
