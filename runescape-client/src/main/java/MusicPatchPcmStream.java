...
public class MusicPatchPcmStream extends PcmStream {
	...
	void method4890(MusicPatchNode var1, int[] var2, int var3, int var4, int var5) {
		if ((this.superStream.field2948[var1.field2980] & 4) != 0 && var1.field2978 < 0) {
			int var6 = this.superStream.field2939[var1.field2980] / (PcmPlayer.field279 * 22050);
			...
			while (true) {
				...
				int var8 = PcmPlayer.field279 * 22050 / 100;
	...
	void method4891(MusicPatchNode var1, int var2) {
		if ((this.superStream.field2948[var1.field2980] & 4) != 0 && var1.field2978 < 0) {
			int var3 = this.superStream.field2939[var1.field2980] / (PcmPlayer.field279 * 22050);
