...
public class class154 extends class166 {
				...
				if (var14 == -1) {
					...
					for (int var20 = 0; var20 <= var14; ++var20) {
						...
						if (var15) {
							...
							var6[var10++] = NameableContainer.method6823(var11, var16, var19, 0.0F);
	...
	static void method3127() {
		if (ClanChannel.worldMap != null) {
			ClanChannel.worldMap.method7313(class160.Client_plane, ApproximateRouteStrategy.baseX * 64 + (class19.localPlayer.x >> 7), class250.baseY * 64 + (class19.localPlayer.y >> 7), false);
