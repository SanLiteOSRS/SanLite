...
public abstract class AbstractWorldMapData {
			...
			for (var8 = 0; var8 < var5; ++var8) { // L: 94
				...
				if (var9 != 0) { // L: 96
					...
					for (var11 = 0; var11 < var9; ++var11) { // L: 100
						int var12 = var3.method8028(); // L: 101
	...
	public static void method5107(int var0, int var1, int var2, boolean var3) {
		PacketBufferNode var4 = class120.getPacketBufferNode(ClientPacket.field3008, Client.packetWriter.isaacCipher); // L: 12126
		var4.packetBuffer.method7952(var2); // L: 12127
		var4.packetBuffer.writeShort(var1); // L: 12128
		var4.packetBuffer.method7971(0); // L: 12129
		var4.packetBuffer.method7961(var0); // L: 12130
