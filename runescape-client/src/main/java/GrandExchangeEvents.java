	...
	static int method146(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.STOCKMARKET_GETOFFERTYPE) {
			...
			if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFEREMPTY) {
				...
				Interpreter.Interpreter_intStack[++VarcInt.Interpreter_intStackSize - 1] = var12 == 0 ? 1 : 0;
				return 1;
			} else if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFERSTABLE) {
				var3 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize];
				var12 = Client.grandExchangeOffers[var3].status();
				Interpreter.Interpreter_intStack[++VarcInt.Interpreter_intStackSize - 1] = var12 == 2 ? 1 : 0;
				return 1;
			} else if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFERFINISHED) {
				var3 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize];
				var12 = Client.grandExchangeOffers[var3].status();
				Interpreter.Interpreter_intStack[++VarcInt.Interpreter_intStackSize - 1] = var12 == 5 ? 1 : 0;
				return 1;
			} else if (var0 == ScriptOpcodes.STOCKMARKET_ISOFFERADDING) {
				var3 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize];
				var12 = Client.grandExchangeOffers[var3].status();
				Interpreter.Interpreter_intStack[++VarcInt.Interpreter_intStackSize - 1] = var12 == 1 ? 1 : 0;
				return 1;
			} else {
				boolean var13;
				if (var0 == ScriptOpcodes.TRADINGPOST_SORTBY_NAME) {
					...
					if (AbstractUserComparator.grandExchangeEvents != null) {
						AbstractUserComparator.grandExchangeEvents.sort(GrandExchangeEvents_nameComparator, var13);
					}
					...
					var13 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize] == 1;
					if (AbstractUserComparator.grandExchangeEvents != null) {
						AbstractUserComparator.grandExchangeEvents.sort(GrandExchangeEvents_priceComparator, var13);
					}
					...
					var13 = Interpreter.Interpreter_intStack[VarcInt.Interpreter_intStackSize] == 1;
					boolean var4 = Interpreter.Interpreter_intStack[VarcInt.Interpreter_intStackSize + 1] == 1;
					if (AbstractUserComparator.grandExchangeEvents != null) {
						Client.GrandExchangeEvents_worldComparator.filterWorlds = var4;
						AbstractUserComparator.grandExchangeEvents.sort(Client.GrandExchangeEvents_worldComparator, var13);
					}
					...
					var13 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize] == 1;
					if (AbstractUserComparator.grandExchangeEvents != null) {
						AbstractUserComparator.grandExchangeEvents.sort(GrandExchangeEvents_ageComparator, var13);
					}
					...
					var13 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize] == 1;
					if (AbstractUserComparator.grandExchangeEvents != null) {
						AbstractUserComparator.grandExchangeEvents.sort(GrandExchangeEvents_quantityComparator, var13);
					}
					...
					if (var0 == ScriptOpcodes.TRADINGPOST_GETOFFERWORLD) {
						var3 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize];
						var11 = (GrandExchangeEvent)AbstractUserComparator.grandExchangeEvents.events.get(var3);
						Interpreter.Interpreter_intStack[++VarcInt.Interpreter_intStackSize - 1] = var11.world;
						return 1;
						...
						var3 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize];
						var11 = (GrandExchangeEvent)AbstractUserComparator.grandExchangeEvents.events.get(var3);
						long var5 = class298.currentTimeMillis() - class4.field17 - var11.age;
						...
						var3 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize];
						var11 = (GrandExchangeEvent)AbstractUserComparator.grandExchangeEvents.events.get(var3);
						Interpreter.Interpreter_intStack[++VarcInt.Interpreter_intStackSize - 1] = var11.grandExchangeOffer.totalQuantity;
						return 1;
					} else if (var0 == ScriptOpcodes.TRADINGPOST_GETOFFERPRICE) {
						var3 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize];
						var11 = (GrandExchangeEvent)AbstractUserComparator.grandExchangeEvents.events.get(var3);
						Interpreter.Interpreter_intStack[++VarcInt.Interpreter_intStackSize - 1] = var11.grandExchangeOffer.unitPrice;
						return 1;
					} else if (var0 == ScriptOpcodes.TRADINGPOST_GETOFFERITEM) {
						var3 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize];
						var11 = (GrandExchangeEvent)AbstractUserComparator.grandExchangeEvents.events.get(var3);
						Interpreter.Interpreter_intStack[++VarcInt.Interpreter_intStackSize - 1] = var11.grandExchangeOffer.id;
						return 1;
					} else {
						return 2;
					}
