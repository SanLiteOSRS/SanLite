...
public class StructComposition extends DualNode {
	...
	void decodeNext(Buffer var1, int var2) {
		if (var2 == 249) {
			this.params = class167.readStringIntParameters(var1, this.params); // L: 44
		}
	...
	public int getIntParam(int var1, int var2) {
		return AttackOption.method2721(this.params, var1, var2); // L: 49
	}
	...
	public String getStringParam(int var1, String var2) {
		return class30.method448(this.params, var1, var2); // L: 53
	}
	...
	public static boolean isCharPrintable(char var0) {
		if (var0 >= ' ' && var0 <= '~') { // L: 184
			return true;
		} else if (var0 >= 160 && var0 <= 255) { // L: 185
			return true;
		} else {
