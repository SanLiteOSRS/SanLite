...
public class PcmStreamMixer extends PcmStream {
	...
	void method2396(Node var1, PcmStreamMixerListener var2) {
	...
	void method2431(PcmStreamMixerListener var1) {
		var1.remove();
		var1.remove2();
	...
	public final synchronized void fill(int[] var1, int var2, int var3) {
		do {
			...
			synchronized(var5) {
				...
				if (var7 < 0) {
					var5.field1420 = 0;
					this.method2431(var5);
				} else {
					var5.field1420 = var7;
					this.method2396(var5.previous, var5);
				}
			}
		} while(var3 != 0);
		...
		do {
			...
			synchronized(var3) {
				...
				if (var5 < 0) {
					...
					var3.field1420 = var5;
					this.method2396(var3.previous, var3);
				}
			}
		} while(var1 != 0);
