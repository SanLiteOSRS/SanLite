...
public class PcmStreamMixer extends PcmStream {
	...
	void method730() {
		if (this.field273 > 0) { // L: 23
			for (PcmStreamMixerListener var1 = (PcmStreamMixerListener)this.field272.last(); var1 != null; var1 = (PcmStreamMixerListener)this.field272.previous()) { // L: 24
				var1.field411 -= this.field273; // L: 25
			}

			this.field274 -= this.field273; // L: 27
	...
	void method731(Node var1, PcmStreamMixerListener var2) {
		...
		this.field274 = ((PcmStreamMixerListener)this.field272.sentinel.previous).field411; // L: 35
	} // L: 36
	...
	void method737(PcmStreamMixerListener var1) {
		...
		if (var2 == this.field272.sentinel) {
			this.field274 = -1; // L: 42
		} else {
			this.field274 = ((PcmStreamMixerListener)var2).field411; // L: 43
		}
