			...
			if (var5 == 22) {
				...
				if (var5 != 10 && var5 != 11) {
					...
					if (var5 >= 12) {
						...
						var6.newWallObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)null, Tiles.field990[var4], 0, var19, var21);
						if (var4 == 0) {
							if (var8.clipped) {
						...
						var6.newWallObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)null, Tiles.field989[var4], 0, var19, var21);
						if (var8.clipped) {
							if (var4 == 0) {
								class392.field4374[var0][var1][var2 + 1] = 50;
							} else if (var4 == 1) {
						...
						if (var5 == 2) {
							...
							var6.newWallObject(var0, var1, var2, var16, (Renderable)var30, (Renderable)var24, Tiles.field990[var4], Tiles.field990[var22], var19, var21);
							if (var8.modelClipped) {
								if (var4 == 0) {
									var10000 = class420.field4545[var0][var1];
									var10000[var2] |= 585;
							...
							var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)null, Tiles.field990[var4], 0, 0, 0, var19, var21);
						} else {
							long var23;
							Object var25;
							if (var5 == 5) {
								...
								var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, Tiles.field990[var4], 0, var22 * Tiles.field992[var4], var22 * Tiles.field993[var4], var19, var21);
							} else if (var5 == 6) {
								var22 = 8;
								var23 = var6.getWallObjectTag(var0, var1, var2);
								if (var23 != 0L) {
								...
								var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)null, 256, var4, var22 * Tiles.field997[var4], var22 * Tiles.field995[var4], var19, var21);
							} else if (var5 == 7) {
								var28 = var4 + 2 & 3;
								if (var8.animationId == -1 && var8.transforms == null) {
								...
								var6.newDecorativeObject(var0, var1, var2, var16, (Renderable)var25, (Renderable)var26, 256, var4, var22 * Tiles.field997[var4], var22 * Tiles.field995[var4], var19, var21);
							}
						}
					}
				} else {
