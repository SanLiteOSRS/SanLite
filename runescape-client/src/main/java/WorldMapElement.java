...
public class WorldMapElement extends DualNode {
   ...
   int field3204 = Integer.MAX_VALUE;
   @ObfuscatedName("b")
   @ObfuscatedGetter(
      intValue = -1806876145
   )
   int field3206 = Integer.MAX_VALUE;
   @ObfuscatedName("g")
   @ObfuscatedGetter(
      intValue = -1042672469
   )
   int field3207 = Integer.MIN_VALUE;
   @ObfuscatedName("e")
   @ObfuscatedGetter(
      intValue = -566631507
   )
   int field3208 = Integer.MIN_VALUE;
   @ObfuscatedName("z")
   @ObfuscatedSignature(
      signature = "Lib;"
   )
   ...
   public static synchronized void method4291(byte[] var0) {
