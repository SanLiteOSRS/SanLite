...
public class InterfaceParent extends Node {
	...
	public static SpritePixels SpriteBuffer_getSprite(AbstractArchive var0, int var1, int var2) {
		return !GrandExchangeEvent.SpriteBuffer_loadSpritesFromArchive(var0, var1, var2) ? null : ScriptFrame.method1084();
	}
				...
				if (!var10.isIf3 || !class263.isComponentHidden(var10)) {
					...
					if (var10 == Client.clickedWidget) {
						...
						if (Client.isDraggingWidget && Client.field668) {
							...
							if (var15 + var10.width > Client.field669 + Client.field664.width) {
								var15 = Client.field669 + Client.field664.width - var10.width;
							}
							...
							if (var16 + var10.height > Client.field628 + Client.field664.height) {
								var16 = Client.field628 + Client.field664.height - var10.height;
							}
									...
									for (var20 = 0; var20 < var10.rawHeight; ++var20) {
										for (var21 = 0; var21 < var10.rawWidth; ++var21) {
											...
											if (var10.itemIds[var19] <= 0) {
												...
												if (var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3 && var23 < var5 || var10 == GroundObject.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
													SpritePixels var35;
													...
													if (var35 != null) {
														if (var10 == GroundObject.dragInventoryWidget && var19 == Client.dragItemSlotSource) {
									...
									if (var10.type == 4) {
										...
										if (var39 == null) {
											...
											if (var10.isIf3 && var10.itemId != -1) {
												ItemComposition var45 = class67.ItemComposition_get(var10.itemId);
												var44 = var45.name;
												if (var44 == null) {
													var44 = "null";
												}
										...
										if (var10.type == 6) {
											...
											var22 = 0;
											if (var10.itemId != -1) {
												var33 = class67.ItemComposition_get(var10.itemId);
												if (var33 != null) {
												...
												for (var21 = 0; var21 < var10.rawHeight; ++var21) {
													for (var22 = 0; var22 < var10.rawWidth; ++var22) {
														if (var10.itemIds[var20] > 0) {
															var33 = class67.ItemComposition_get(var10.itemIds[var20] - 1);
															String var34;
