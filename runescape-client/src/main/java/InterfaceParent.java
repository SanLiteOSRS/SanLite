...
public class InterfaceParent extends Node {
   ...
   public static void method1128(PacketBuffer var0) {
               ...
               if (var0 == ScriptOpcodes.WORLDMAP_GETCONFIGORIGIN) {
                  ...
                  if (var0 == 6618) {
                     ...
                     if (var0 == 6619) {
                        ...
                        LoginScreenAnimation.getWorldMap().method6221(Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
                        return 1;
                     } else if (var0 == 6625) {
                        LoginScreenAnimation.getWorldMap().method6259();
                        return 1;
                     } else if (var0 == 6626) {
                        LoginScreenAnimation.getWorldMap().method6223(Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
                        return 1;
                     } else if (var0 == 6627) {
                        LoginScreenAnimation.getWorldMap().method6224();
                        return 1;
                     } else {
                        boolean var10;
                           ...
                           if (var0 == ScriptOpcodes.WORLDMAP_DISABLEELEMENT) {
                              ...
                              if (var0 == ScriptOpcodes.WORLDMAP_LISTELEMENT_START) {
                                 ...
                                 if (var0 == ScriptOpcodes.MEC_TEXT) {
                                    var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
                                    var6 = WorldMapData_0.getWorldMapElement(var3);
                                    if (var6.name == null) {
      ...
      if (var5 != null) {
         ...
         if (var11) {
            ...
            if (var7) {
               ...
               if (var0 == 1) {
                  var10 = MenuAction.method1994(ClientPacket.field2253, Client.packetWriter.isaacCipher);
               ...
               if (var0 == 2) {
                  var10 = MenuAction.method1994(ClientPacket.field2206, Client.packetWriter.isaacCipher);
                  var10.packetBuffer.writeInt(var1);
                  var10.packetBuffer.writeShort(var2);
                  var10.packetBuffer.writeShort(var3);
                  Client.packetWriter.method2177(var10);
               ...
               if (var0 == 3) {
                  var10 = MenuAction.method1994(ClientPacket.field2233, Client.packetWriter.isaacCipher);
                  var10.packetBuffer.writeInt(var1);
                  var10.packetBuffer.writeShort(var2);
                  var10.packetBuffer.writeShort(var3);
                  Client.packetWriter.method2177(var10);
               ...
               if (var0 == 4) {
                  var10 = MenuAction.method1994(ClientPacket.field2204, Client.packetWriter.isaacCipher);
                  var10.packetBuffer.writeInt(var1);
                  var10.packetBuffer.writeShort(var2);
                  var10.packetBuffer.writeShort(var3);
                  Client.packetWriter.method2177(var10);
               ...
               if (var0 == 5) {
                  var10 = MenuAction.method1994(ClientPacket.field2221, Client.packetWriter.isaacCipher);
                  var10.packetBuffer.writeInt(var1);
                  var10.packetBuffer.writeShort(var2);
                  var10.packetBuffer.writeShort(var3);
                  Client.packetWriter.method2177(var10);
               ...
               if (var0 == 6) {
                  var10 = MenuAction.method1994(ClientPacket.field2244, Client.packetWriter.isaacCipher);
                  var10.packetBuffer.writeInt(var1);
                  var10.packetBuffer.writeShort(var2);
                  var10.packetBuffer.writeShort(var3);
                  Client.packetWriter.method2177(var10);
               ...
               if (var0 == 7) {
                  var10 = MenuAction.method1994(ClientPacket.field2276, Client.packetWriter.isaacCipher);
                  var10.packetBuffer.writeInt(var1);
                  var10.packetBuffer.writeShort(var2);
                  var10.packetBuffer.writeShort(var3);
                  Client.packetWriter.method2177(var10);
               ...
               if (var0 == 8) {
                  var10 = MenuAction.method1994(ClientPacket.field2199, Client.packetWriter.isaacCipher);
                  var10.packetBuffer.writeInt(var1);
                  var10.packetBuffer.writeShort(var2);
                  var10.packetBuffer.writeShort(var3);
                  Client.packetWriter.method2177(var10);
               ...
               if (var0 == 9) {
                  var10 = MenuAction.method1994(ClientPacket.field2288, Client.packetWriter.isaacCipher);
                  var10.packetBuffer.writeInt(var1);
                  var10.packetBuffer.writeShort(var2);
                  var10.packetBuffer.writeShort(var3);
                  Client.packetWriter.method2177(var10);
               ...
               if (var0 == 10) {
                  var10 = MenuAction.method1994(ClientPacket.field2245, Client.packetWriter.isaacCipher);
                  var10.packetBuffer.writeInt(var1);
                  var10.packetBuffer.writeShort(var2);
                  var10.packetBuffer.writeShort(var3);
                  Client.packetWriter.method2177(var10);
