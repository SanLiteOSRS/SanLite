		...
		if (var0 == ScriptOpcodes.FRIEND_COUNT) { // L: 2052
			...
			if (var0 == ScriptOpcodes.FRIEND_GETNAME) {
				...
				if (var0 == ScriptOpcodes.FRIEND_SETRANK) {
					...
					if (InterfaceParent.clanChat != null && var3 < InterfaceParent.clanChat.getSize() && ((FriendsChatMember)InterfaceParent.clanChat.get(var3)).isFriend()) { // L: 2220
					...
					if (InterfaceParent.clanChat != null && var3 < InterfaceParent.clanChat.getSize() && ((FriendsChatMember)InterfaceParent.clanChat.get(var3)).isIgnored()) { // L: 2228
