...
public class class285 {
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.field1184 >= Client.cycle) { // L: 4009
			...
			if (var0.field1194 == Client.cycle || var0.sequence == -1 || var0.sequenceDelay != 0 || var0.sequenceFrameCycle + 1 > ScriptFrame.SequenceDefinition_get(var0.sequence).frameLengths[var0.sequenceFrame]) { // L: 4011
				...
				var4 = var0.field1140 * 128 + var0.field1205 * 1526988800; // L: 4014
				int var5 = var0.field1182 * 128 + var0.field1205 * 1526988800; // L: 4015
				int var6 = var0.field1181 * 128 + var0.field1205 * 1526988800; // L: 4016
				int var7 = var0.field1183 * 128 + var0.field1205 * 1526988800; // L: 4017
		...
		if (var0.x < 128 || var0.y < 128 || var0.x >= 13184 || var0.y >= 13184) { // L: 4026
			...
			var0.x = var0.pathX[0] * 128 + var0.field1205 * 1526988800; // L: 4031
			var0.y = var0.pathY[0] * 128 + var0.field1205 * 1526988800; // L: 4032
		...
		if (class101.localPlayer == var0 && (var0.x < 1536 || var0.y < 1536 || var0.x >= 11776 || var0.y >= 11776)) { // L: 4035 4036
			...
			var0.x = var0.pathX[0] * 128 + var0.field1205 * 1526988800; // L: 4041
			var0.y = var0.pathY[0] * 128 + var0.field1205 * 1526988800; // L: 4042
	...
	static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) { // L: 7815
			...
			if (var1 == 0) { // L: 7821
				var7 = class356.scene.getWallObjectTag(var0, var2, var3);
			}

			if (var1 == 1) { // L: 7822
				var7 = class356.scene.getDecorativeObjectTag(var0, var2, var3);
			}
			...
			if (var1 == 3) { // L: 7824
				var7 = class356.scene.getGroundObjectTag(var0, var2, var3);
			}
			...
			if (var7 != 0L) { // L: 7825
				...
				if (var1 == 0) { // L: 7830
					class356.scene.removeWallObject(var0, var2, var3); // L: 7831
				...
				if (var1 == 1) { // L: 7835
					class356.scene.removeDecorativeObject(var0, var2, var3);
				}
				...
				if (var1 == 3) { // L: 7842
					class356.scene.removeGroundObject(var0, var2, var3); // L: 7843
