...
public class Fonts {
	...
	static final void method7226(int var0, int var1, int var2, int var3, int var4, int var5, int var6, Scene var7, CollisionMap var8) {
		...
		if (var6 == 22) { // L: 1037
			...
			var7.newGroundObject(var0, var2, var3, var17, (Renderable)var30, var20, var22); // L: 1041
			...
			if (var6 >= 12) { // L: 1053
				...
				var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field988[var5], 0, var20, var22); // L: 1065
				...
				var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field989[var5], 0, var20, var22); // L: 1073
				...
				if (var6 == 2) { // L: 1077
					...
					var7.newWallObject(var0, var2, var3, var17, (Renderable)var31, (Renderable)var25, Tiles.field988[var5], Tiles.field988[var23], var20, var22); // L: 1089
					...
					var7.newWallObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field989[var5], 0, var20, var22); // L: 1097
					...
					var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, Tiles.field988[var5], 0, 0, 0, var20, var22); // L: 1113
				} else {
					long var24;
					Object var26;
					if (var6 == 5) { // L: 1116
						var23 = 16; // L: 1117
						var24 = var7.getWallObjectTag(var0, var2, var3); // L: 1118
						if (var24 != 0L) { // L: 1119
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)null, Tiles.field988[var5], 0, var23 * Tiles.field990[var5], var23 * Tiles.field991[var5], var20, var22); // L: 1123
					} else if (var6 == 6) { // L: 1126
						var23 = 8; // L: 1127
						var24 = var7.getWallObjectTag(var0, var2, var3); // L: 1128
						if (0L != var24) { // L: 1129
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)null, 256, var5, var23 * Tiles.field995[var5], var23 * Tiles.field993[var5], var20, var22); // L: 1133
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var30, (Renderable)null, 256, var29, 0, 0, var20, var22); // L: 1141
					} else if (var6 == 8) { // L: 1144
						var23 = 8; // L: 1145
						var24 = var7.getWallObjectTag(var0, var2, var3); // L: 1146
						if (0L != var24) { // L: 1147
							var23 = class82.getObjectDefinition(NetSocket.Entity_unpackID(var24)).int2 / 2;
						}
						...
						var7.newDecorativeObject(var0, var2, var3, var17, (Renderable)var26, (Renderable)var27, 256, var5, var23 * Tiles.field995[var5], var23 * Tiles.field993[var5], var20, var22); // L: 1159
					}
				}
			}
		} else {
