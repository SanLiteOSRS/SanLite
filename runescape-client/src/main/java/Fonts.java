		...
		if (var5 != 0L) {
			...
			if (var15.mapSceneId != -1) {
				...
				if (var16 != null) {
					...
					int var18 = (var15.sizeY * 4 - var16.subHeight * -1478377216) / 2;
		...
		if (var5 != 0L) {
			...
			if (var20.mapSceneId != -1) {
				...
				if (var28 != null) {
					...
					var14 = (var20.sizeY * 4 - var28.subHeight * -1478377216) / 2;
		...
		if (var5 != 0L) {
			...
			if (var23.mapSceneId != -1) {
				...
				if (var24 != null) {
					...
					int var11 = (var23.sizeY * 4 - var24.subHeight * -1478377216) / 2;
