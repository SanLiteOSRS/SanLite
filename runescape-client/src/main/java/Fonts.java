...
public class Fonts {
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			WorldMapRectangle.archive3 = class4.newArchive(0, false, true, true);
			MenuAction.archive4 = class4.newArchive(1, false, true, true);
			class115.archive2 = class4.newArchive(2, true, false, true);
			class260.archive5 = class4.newArchive(3, false, true, true);
			ReflectionCheck.field444 = class4.newArchive(4, false, true, true);
			ObjectComposition.archive7 = class4.newArchive(5, true, true, true);
			class276.archive6 = class4.newArchive(6, true, true, true);
			class135.archive9 = class4.newArchive(7, false, true, true);
			World.archive8 = class4.newArchive(8, false, true, true);
			VarcInt.field1645 = class4.newArchive(9, false, true, true);
			class81.archive10 = class4.newArchive(10, false, true, true);
			...
			byte var33 = 0;
			var14 = var33 + WorldMapRectangle.archive3.percentage() * 4 / 100;
			var14 += MenuAction.archive4.percentage() * 4 / 100;
			var14 += class115.archive2.percentage() * 2 / 100;
			var14 += class260.archive5.percentage() * 2 / 100;
			var14 += ReflectionCheck.field444.percentage() * 6 / 100;
			var14 += ObjectComposition.archive7.percentage() * 4 / 100;
			var14 += class276.archive6.percentage() * 2 / 100;
			var14 += class135.archive9.percentage() * 56 / 100;
			var14 += World.archive8.percentage() * 2 / 100;
			var14 += VarcInt.field1645.percentage() * 2 / 100;
			var14 += class81.archive10.percentage() * 2 / 100;
			...
			if (var14 != 100) {
				...
				class21.method323(WorldMapRectangle.archive3, "Animations");
				class21.method323(MenuAction.archive4, "Skeletons");
				class21.method323(ReflectionCheck.field444, "Sound FX");
				class21.method323(ObjectComposition.archive7, "Maps");
				class21.method323(class276.archive6, "Music Tracks");
				class21.method323(class135.archive9, "Models");
			...
			if (Client.titleLoadingStage == 45) {
				...
				var17 = ReflectionCheck.field444;
				...
				FriendsChatManager.pcmPlayer1 = class114.method2487(GameEngine.taskHandler, 1, 2048);
				MusicPatchPcmStream.pcmStreamMixer = new PcmStreamMixer();
				FriendsChatManager.pcmPlayer1.setStream(MusicPatchPcmStream.pcmStreamMixer);
				Language.decimator = new Decimator(22050, class276.field3287 * 332661776);
				...
				if (Client.titleLoadingStage == 50) {
					...
					var14 = class28.method408(class81.archive10, World.archive8);
					...
					if (!class115.archive2.isFullyLoaded()) {
						...
						PendingSpawn.method2121(class115.archive2, class135.archive9);
						Archive var29 = class115.archive2;
						var2 = class135.archive9;
						...
						Archive var24 = class135.archive9;
						...
						UserComparator10.method2444(class115.archive2, class135.archive9, Client.isMembersWorld, class87.fontPlain11);
						class15.method210(class115.archive2, WorldMapRectangle.archive3, MenuAction.archive4);
						WorldMapDecoration.method3802(class115.archive2, class135.archive9);
						...
						Archive var18 = class260.archive5;
						Archive var28 = class135.archive9;
					...
					if (MusicPatch.headIconPkSprites == null) {
						...
						if (!VertexNormal.SpriteBuffer_loadSpritesFromArchive(var2, var3, 0)) {
							var22 = null;
						} else {
							var22 = class174.SpriteBuffer_loadSpritesFromBuffer();
						}
					...
					if (!VarcInt.field1645.isFullyLoaded()) {
						Login.Login_loadingText = "Loading textures - " + "0%";
						Login.Login_loadingPercent = 90;
					} else {
						MusicPatch.textureProvider = new TextureProvider(VarcInt.field1645, World.archive8, 20, VarbitComposition.clientPreferences.field1193, Client.isLowDetail ? 64 : 128);
					...
					class184.mouseRecorder = new class81();
					...
					if (!class81.archive10.tryLoadFileByNames("huffman", "")) {
						...
						Huffman var0 = new Huffman(class81.archive10.takeFileByNames("huffman", ""));
					...
					if (!class260.archive5.isFullyLoaded()) {
						Login.Login_loadingText = "Loading interfaces - " + class260.archive5.loadPercent() * 4 / 5 + "%";
