		...
		if (var0 != null && var0.isVisible()) {
			...
			for (int var80 = 0; var80 < 4; ++var80) {
				...
				if (var97 >= 0) {
					...
					var95 = NetFileRequest.method4245(var0.hitSplatTypes[var80]);
				...
				if (var15 >= 0) {
					var81 = NetFileRequest.method4245(var15);
