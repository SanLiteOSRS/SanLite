...
public class ApproximateRouteStrategy extends RouteStrategy {
	...
	static final void logOut() {
		...
		ItemComposition.ItemComposition_cached.clear(); // L: 2810
		ItemComposition.ItemComposition_cachedModels.clear(); // L: 2811
		ItemComposition.ItemComposition_cachedSprites.clear(); // L: 2812
		...
		class150.Ignored_cached.method7724(); // L: 2823
		...
		ParamComposition.ParamComposition_cached.clear(); // L: 2831
		class287.method5687(); // L: 2833
		Ignored.method6968(); // L: 2834
		class439.DBRowType_cache.clear(); // L: 2836
		Client.Widget_cachedModels.clear(); // L: 2838
		Client.Widget_cachedFonts.clear(); // L: 2839
		PlayerComposition.PlayerComposition_cachedModels.clear(); // L: 2841
		...
		if (var5 != null) { // L: 9270
			...
			if (var11) { // L: 9281
				...
				if (var7) { // L: 9288
					...
					if (var0 == 1) { // L: 9291
						var10 = class120.getPacketBufferNode(ClientPacket.field2964, Client.packetWriter.isaacCipher); // L: 9293
					...
					if (var0 == 2) { // L: 9299
						var10 = class120.getPacketBufferNode(ClientPacket.field2983, Client.packetWriter.isaacCipher); // L: 9301
					...
					if (var0 == 3) { // L: 9307
						var10 = class120.getPacketBufferNode(ClientPacket.field3012, Client.packetWriter.isaacCipher); // L: 9309
					...
					if (var0 == 5) { // L: 9323
						var10 = class120.getPacketBufferNode(ClientPacket.field3027, Client.packetWriter.isaacCipher); // L: 9325
					...
					if (var0 == 8) { // L: 9347
						var10 = class120.getPacketBufferNode(ClientPacket.field2959, Client.packetWriter.isaacCipher); // L: 9349
					...
					if (var0 == 9) { // L: 9355
						var10 = class120.getPacketBufferNode(ClientPacket.field2974, Client.packetWriter.isaacCipher); // L: 9357
					...
					if (var0 == 10) { // L: 9363
						var10 = class120.getPacketBufferNode(ClientPacket.field3010, Client.packetWriter.isaacCipher); // L: 9365
