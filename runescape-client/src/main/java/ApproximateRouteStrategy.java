	...
	static void drawTitle(Font var0, Font var1, Font var2) {
		...
		if (Login.worldSelectOpen) {
			if (DevicePcmPlayerProvider.worldSelectBackSprites == null) {
				DevicePcmPlayerProvider.worldSelectBackSprites = Messages.SpriteBuffer_getSpritePixelsByName(World.archive8, "sl_back", "");
			}
			...
			if (FriendsChatManager.worldSelectRightSprite == null) {
				FriendsChatManager.worldSelectRightSprite = class196.SpriteBuffer_getIndexedSpriteByName(World.archive8, "rightarrow", "");
			}
			...
			if (DevicePcmPlayerProvider.worldSelectBackSprites != null) {
				...
				if (FriendsChatManager.worldSelectRightSprite != null && Login.worldSelectPage < Login.worldSelectPagesCount) {
					FriendsChatManager.worldSelectRightSprite.drawAt(InvDefinition.canvasWidth - FriendsChatManager.worldSelectRightSprite.subWidth - 8, GameEngine.canvasHeight / 2 - FriendsChatManager.worldSelectRightSprite.subHeight / 2);
				}
