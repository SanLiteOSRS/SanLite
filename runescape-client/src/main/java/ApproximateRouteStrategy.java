	...
	static void readPlayerUpdate(PacketBuffer var0, int var1) {
		...
		if (var3 == 0) {
			if (var2) {
				...
				Players.Players_regions[var1] = (var4.plane << 28) + (class118.baseY * 64 + var4.pathY[0] >> 13) + (Canvas.baseX * 64 + var4.pathX[0] >> 13 << 14);
				if (var4.field1138 != -1) {
			...
			if (var3 == 1) {
				...
				if (var5 == 0) {
					...
					var8 = var6 >> 14 & 16383;
					var9 = var6 & 16383;
					var10 = (Canvas.baseX * 64 + var8 + var4.pathX[0] & 16383) - Canvas.baseX * 64;
					var11 = (class118.baseY * 64 + var9 + var4.pathY[0] & 16383) - class118.baseY * 64;
					if (Client.localPlayerIndex == var1 && (var4.x < 1536 || var4.y < 1536 || var4.x >= 11776 || var4.y >= 11776)) {
						var4.resetPath(var10, var11);
						var4.field1067 = false;
					} else if (var2) {
