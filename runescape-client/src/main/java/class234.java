...
public class class234 {
	...
	public void method4441() {
		this.field2491 = new class232[1]; // L: 7
		class230 var1 = class230.field2460; // L: 8
		this.field2491[0] = new class232(var1.field2466, var1.field2467); // L: 9
	} // L: 10
	...
	public int method4446(int var1, int var2, int var3, RouteStrategy var4, CollisionMap var5, boolean var6, int[] var7, int[] var8) {
		return this.method4445(var1, var2, var3, var4, var5, var6, var7, var8, this.field2491[0]); // L: 13
	}
	...
	int method4445(int var1, int var2, int var3, RouteStrategy var4, CollisionMap var5, boolean var6, int[] var7, int[] var8, class232 var9) {
		var9.method4401(); // L: 17
		int var10 = var9.method4405(); // L: 18
		int var11 = var9.method4400();
		int[][] var12 = var9.method4427(); // L: 20
		int[][] var13 = var9.method4406(); // L: 21
		int[] var14 = var9.method4409(); // L: 22
		int[] var15 = var9.method4428(); // L: 23
		boolean var16;
		if (var3 == 1) { // L: 25
			...
			var16 = this.method4450(var1, var2, var3, var4, var5, var9); // L: 27
		}

		int var17 = var1 - (var10 >> 1); // L: 28
		int var18 = var2 - (var11 >> 1); // L: 29
		int var19 = var9.method4403(); // L: 30
		int var20 = var9.method4404(); // L: 31
		int var21;
		int var22;
		int var24;
		if (!var16) { // L: 32
	...
	final boolean method4444(int var1, int var2, RouteStrategy var3, CollisionMap var4, class232 var5) {
		int var6 = var5.method4405(); // L: 101
		int var7 = var5.method4400(); // L: 102
		int[][] var8 = var5.method4427(); // L: 103
		int[][] var9 = var5.method4406(); // L: 104
		int[] var10 = var5.method4409(); // L: 105
		int[] var11 = var5.method4428(); // L: 106
		int var12 = var5.method4430(); // L: 107
		...
		while (var25 != var20) { // L: 123
			...
			if (var3.hasArrived(1, var13, var14, var4)) { // L: 131
				var5.method4402(var13, var14); // L: 132
				return true; // L: 133
			}
		...
		var5.method4402(var13, var14); // L: 193
		return false; // L: 194
	}
	...
	final boolean method4457(int var1, int var2, RouteStrategy var3, CollisionMap var4, class232 var5) {
		int var6 = var5.method4405(); // L: 198
		int var7 = var5.method4400(); // L: 199
		int[][] var8 = var5.method4427(); // L: 200
		int[][] var9 = var5.method4406(); // L: 201
		int[] var10 = var5.method4409(); // L: 202
		int[] var11 = var5.method4428(); // L: 203
		int var12 = var5.method4430(); // L: 204
		...
		while (var20 != var25) { // L: 218
			...
			if (var3.hasArrived(2, var13, var14, var4)) { // L: 226
				var5.method4402(var13, var14); // L: 227
				return true; // L: 228
			}
		...
		var5.method4402(var13, var14); // L: 316
		return false; // L: 317
	}
	...
	final boolean method4450(int var1, int var2, int var3, RouteStrategy var4, CollisionMap var5, class232 var6) {
		int var7 = var6.method4405(); // L: 321
		int var8 = var6.method4400(); // L: 322
		int[][] var9 = var6.method4427(); // L: 323
		int[][] var10 = var6.method4406(); // L: 324
		int[] var11 = var6.method4409(); // L: 325
		int[] var12 = var6.method4428(); // L: 326
		int var13 = var6.method4430(); // L: 327
						...
						do {
							...
							do {
								if (var27 == var21) { // L: 341
									var6.method4402(var14, var15); // L: 459
									return false; // L: 460
								}
								...
								if (var4.hasArrived(var3, var14, var15, var5)) { // L: 349
									var6.method4402(var14, var15); // L: 350
									return true; // L: 351
								}
	...
	public static class546[] FillMode_values() {
		return new class546[]{class546.field5316, class546.SOLID, class546.field5317}; // L: 15
	}
}
