...
public class class234 {
	...
	public void method4570() {
		this.field2474 = new class232[1]; // L: 7
		class230 var1 = class230.field2447; // L: 8
		this.field2474[0] = new class232(var1.field2453, var1.field2454); // L: 9
	} // L: 10
	...
	public int method4571(int var1, int var2, int var3, RouteStrategy var4, CollisionMap var5, boolean var6, int[] var7, int[] var8) {
		return this.method4572(var1, var2, var3, var4, var5, var6, var7, var8, this.field2474[0]); // L: 13
	}
	...
	int method4572(int var1, int var2, int var3, RouteStrategy var4, CollisionMap var5, boolean var6, int[] var7, int[] var8, class232 var9) {
		var9.method4519(); // L: 17
		int var10 = var9.method4523(); // L: 18
		int var11 = var9.method4524(); // L: 19
		int[][] var12 = var9.method4526(); // L: 20
		int[][] var13 = var9.method4546(); // L: 21
		int[] var14 = var9.method4527(); // L: 22
		int[] var15 = var9.method4528(); // L: 23
		boolean var16;
		if (var3 == 1) { // L: 25
			...
			var16 = this.method4583(var1, var2, var3, var4, var5, var9); // L: 27
		}

		int var17 = var1 - (var10 >> 1); // L: 28
		int var18 = var2 - (var11 >> 1); // L: 29
		int var19 = var9.method4552(); // L: 30
		int var20 = var9.method4557(); // L: 31
		int var21;
		int var22;
		int var24;
		if (!var16) { // L: 32
			...
			for (int var28 = var24 - var23; var28 <= var24 + var23; ++var28) { // L: 41
				for (int var29 = var25 - var23; var29 <= var23 + var25; ++var29) { // L: 42
					...
					if (var30 >= 0 && var31 >= 0 && var30 < var10 && var31 < var11 && var12[var30][var31] < 100) { // L: 45 46
						...
						if (var28 < var24) { // L: 48
							var32 = var24 - var28;
						} else if (var28 > var26 + var24 - 1) { // L: 49
						...
						if (var29 < var25) { // L: 51
							var33 = var25 - var29;
						} else if (var29 > var25 + var27 - 1) { // L: 52
	...
	final boolean method4573(int var1, int var2, RouteStrategy var3, CollisionMap var4, class232 var5) {
		int var6 = var5.method4523(); // L: 101
		int var7 = var5.method4524(); // L: 102
		int[][] var8 = var5.method4526(); // L: 103
		int[][] var9 = var5.method4546(); // L: 104
		int[] var10 = var5.method4527(); // L: 105
		int[] var11 = var5.method4528(); // L: 106
		int var12 = var5.method4529(); // L: 107
		...
		while (var25 != var20) { // L: 123
			...
			if (var3.hasArrived(1, var13, var14, var4)) { // L: 131
				var5.method4520(var13, var14); // L: 132
				return true; // L: 133
			}
		...
		var5.method4520(var13, var14); // L: 193
		return false;
	}
	...
	final boolean method4574(int var1, int var2, RouteStrategy var3, CollisionMap var4, class232 var5) {
		int var6 = var5.method4523(); // L: 198
		int var7 = var5.method4524(); // L: 199
		int[][] var8 = var5.method4526(); // L: 200
		int[][] var9 = var5.method4546();
		int[] var10 = var5.method4527();
		int[] var11 = var5.method4528();
		int var12 = var5.method4529(); // L: 204
		int var13 = var1;
		int var14 = var2;
		...
		while (var25 != var20) { // L: 218
			...
			if (var3.hasArrived(2, var13, var14, var4)) { // L: 226
				var5.method4520(var13, var14); // L: 227
				return true; // L: 228
			}
		...
		var5.method4520(var13, var14); // L: 316
		return false; // L: 317
	}
	...
	final boolean method4583(int var1, int var2, int var3, RouteStrategy var4, CollisionMap var5, class232 var6) {
		int var7 = var6.method4523(); // L: 321
		int var8 = var6.method4524(); // L: 322
		int[][] var9 = var6.method4526(); // L: 323
		int[][] var10 = var6.method4546(); // L: 324
		int[] var11 = var6.method4527(); // L: 325
		int[] var12 = var6.method4528(); // L: 326
		int var13 = var6.method4529(); // L: 327
		...
		while (true) {
			...
			while (true) {
						...
						do {
							...
							do {
								if (var21 == var27) { // L: 341
									var6.method4520(var14, var15); // L: 459
									return false; // L: 460
								}
								...
								if (var4.hasArrived(var3, var14, var15, var5)) { // L: 349
									var6.method4520(var14, var15); // L: 350
									return true; // L: 351
								}
								...
								if (var16 < var7 - var3 && var17 > 0 && var10[var16 + 1][var17 - 1] == 0 && (var22[var3 + var23][var24 - 1] & 19136899) == 0) { // L: 419 420 421
									...
									while (true) {
										...
										if ((var22[var3 + var23][var26 + (var24 - 1)] & 19136995) != 0 || (var22[var26 + var23][var24 - 1] & 19136911) != 0) { // L: 423 424
											break;
										}
				...
				for (var26 = 1; var26 < var3; ++var26) { // L: 448
					if ((var22[var26 + var23][var3 + var24] & 19137016) != 0 || (var22[var3 + var23][var24 + var26] & 19136995) != 0) { // L: 449 450
						continue label303;
					}
				}
	...
	static int method4589(AbstractArchive var0, AbstractArchive var1) {
		int var2 = 0; // L: 177
		String[] var3 = Login.field949; // L: 179
