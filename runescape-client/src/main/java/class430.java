...
final class class430 implements class429 {
	...
	@ObfuscatedName("z")
	@ObfuscatedSignature(
		descriptor = "(Ljava/lang/Integer;Lqw;B)V",
		garbageValue = "-20"
	)
	...
	@ObfuscatedName("o")
	@ObfuscatedSignature(
		descriptor = "(ILjava/lang/String;Llj;II)Lji;",
		garbageValue = "92661502"
	)
	public static PacketBufferNode method7571(int var0, String var1, Language var2, int var3) {
		PacketBufferNode var4 = class433.getPacketBufferNode(ClientPacket.field2979, Client.packetWriter.isaacCipher); // L: 17
		...
		ArchiveDiskAction.method5785(var4.packetBuffer, var1); // L: 167
		if (var0 == class296.field3531.rsOrdinal()) { // L: 168
			var4.packetBuffer.writeByte(var3); // L: 169
		}

		var4.packetBuffer.method7730(var4.packetBuffer.offset - var5); // L: 171
		return var4; // L: 172
	}
}
