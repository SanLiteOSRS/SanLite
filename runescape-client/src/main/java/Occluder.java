...
public final class Occluder {
	...
	public static int method4089(Buffer var0, String var1) {
		...
		byte[] var3 = Language.method5070(var1);
		var0.writeSmartByteShort(var3.length);
		var0.offset += class377.huffman.compress(var3, 0, var3.length, var0.array, var0.offset);
	...
	static final void method4088(int var0) {
		...
		class12.clientPreferences.areaSoundEffectsVolume = var0;
