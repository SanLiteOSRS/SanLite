            ...
            if (var32 || !var9.isIf3 || var12 < var14 && var13 < var15) {
               ...
               if (var9.contentType == 1337) {
                  ...
                  if (!Client.isMenuOpen && var33) {
                     if (var9.contentType == 1400) {
                        WorldMapCacheName.worldMap.method6236(var10, var11, var9.width, var9.height, var17, var18);
                     } else {
                  ...
                  if (var9.isIf3) {
                     ...
                     if (var9.hasListener) {
                        ...
                        if (var9.field2610 && var34 && var9.onClickRepeat != null) {
                           var27 = new ScriptEvent();
                           var27.boolean1 = true;
                           var27.widget = var9;
                        ...
                        if (var9.field2610 && !var34) {
                           var9.field2610 = false;
