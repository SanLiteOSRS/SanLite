			...
			if (class263.field3060 == var0) { // L: 7674
				...
				if (class263.field3062 == var0) { // L: 7701
					...
					if (var17 != null) { // L: 7720
						...
						if (var29 != null) { // L: 7741
							...
							var17.field1104 = var6 * 128 + var19 * 64; // L: 7746
							var17.field1106 = var7 * 128 + var20 * 64; // L: 7747
				...
				if (class263.field3067 == var0) { // L: 7766
					...
					if (var7 >= 0 && var8 >= 0 && var7 < 103 && var8 < 103) { // L: 7775
						if (var5 == 0) { // L: 7776
							WallObject var31 = class175.scene.method4147(class128.Client_plane, var7, var8); // L: 7777
						...
						if (var5 == 1) { // L: 7787
							DecorativeObject var40 = class175.scene.method4049(class128.Client_plane, var7, var8); // L: 7788
						...
						if (var5 == 3) { // L: 7805
							GroundObject var42 = class175.scene.getGroundObject(class128.Client_plane, var7, var8); // L: 7806
