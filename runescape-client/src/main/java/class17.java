			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						Client.field652 = 3;
						Client.field653 = var2 ? class432.scriptDotWidget.id : class341.scriptActiveWidget.id;
						return 1;
					} else {
						boolean var3;
			...
			if (var0 == ScriptOpcodes.INTERPOLATE) {
				...
				if (var3 == 0) {
					...
					case 4:
						...
						break;
					default:
						Interpreter.Interpreter_intStack[++class295.Interpreter_intStackSize - 1] = (int)Math.pow((double)var3, 1.0D / (double)var4);
					}
