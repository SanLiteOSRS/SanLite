...
public class class17 extends class14 {
	...
	void vmethod338(class11 var1) {
		var1.field93 = this.field144;
		var1.field111 = this.field143;
		var1.field95 = this.field147;
		var1.field96 = this.field145;
		var1.field113 = this.field149;
	}
	...
	public static final boolean isKeyDown() {
		synchronized(KeyHandler.KeyHandler_instance) {
			if (KeyHandler.field277 == KeyHandler.field279) {
				return false;
			} else {
				MenuAction.field982 = KeyHandler.field274[KeyHandler.field277];
				class25.field207 = KeyHandler.field255[KeyHandler.field277];
				KeyHandler.field277 = KeyHandler.field277 + 1 & 127;
				return true;
			}
		}
	}
