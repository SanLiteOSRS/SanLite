...
class class17 implements SSLSession {
	...
	static final void method273(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7, int var8) {
		...
		if (var2 == 1) { // L: 8375
			...
			var9 = class120.getPacketBufferNode(ClientPacket.field2951, Client.packetWriter.isaacCipher); // L: 8500
			var9.packetBuffer.writeShort(Canvas.selectedItemId); // L: 8501
			var9.packetBuffer.writeIntME(WorldMapData_1.baseY * 64 + var1); // L: 8502
			var9.packetBuffer.writeInt(GameObject.selectedItemWidget); // L: 8503
			var9.packetBuffer.writeIntME(var3); // L: 8504
			...
			var9.packetBuffer.writeIntME(Client.selectedSpellItemId); // L: 8775
			var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8776
			var9.packetBuffer.writeIntME(WorldMapData_1.baseY * 64 + var1); // L: 8777
			var9.packetBuffer.writeIntME(class128.baseX * 64 + var0); // L: 8778
			var9.packetBuffer.method7961(Client.selectedSpellChildIndex); // L: 8779
			var9.packetBuffer.method7972(ClanSettings.selectedSpellWidget); // L: 8780
			var9.packetBuffer.writeIntME(var3); // L: 8781
			...
			var9 = class120.getPacketBufferNode(ClientPacket.field3042, Client.packetWriter.isaacCipher); // L: 8845
			var9.packetBuffer.method7961(WorldMapData_1.baseY * 64 + var1); // L: 8846
			var9.packetBuffer.method7961(class128.baseX * 64 + var0); // L: 8847
			var9.packetBuffer.writeShort(var3); // L: 8848
			var9.packetBuffer.method7952(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8849
			...
			var9 = class120.getPacketBufferNode(ClientPacket.field2965, Client.packetWriter.isaacCipher); // L: 9172
			var9.packetBuffer.method7961(var3); // L: 9173
			var9.packetBuffer.writeShort(WorldMapData_1.baseY * 64 + var1); // L: 9174
			var9.packetBuffer.method8004(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 9175
			...
			var9 = class120.getPacketBufferNode(ClientPacket.field3041, Client.packetWriter.isaacCipher); // L: 8413
			var9.packetBuffer.method8136(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8414
			var9.packetBuffer.method7962(class128.baseX * 64 + var0); // L: 8415
			var9.packetBuffer.method7962(WorldMapData_1.baseY * 64 + var1); // L: 8416
			...
			var9.packetBuffer.writeIntME(class128.baseX * 64 + var0); // L: 9029
			var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 9030
			var9.packetBuffer.method7962(var3); // L: 9031
			var9.packetBuffer.writeIntME(WorldMapData_1.baseY * 64 + var1); // L: 9032
			...
			if (var2 == 7) {
				...
				if (var14 != null) { // L: 8880
					...
					var10 = class120.getPacketBufferNode(ClientPacket.field2958, Client.packetWriter.isaacCipher); // L: 8888
					...
					var10.packetBuffer.method7952(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8893
				...
				if (var14 != null) { // L: 8821
					...
					var10 = class120.getPacketBufferNode(ClientPacket.field2949, Client.packetWriter.isaacCipher); // L: 8828
					var10.packetBuffer.method7961(Client.selectedSpellChildIndex); // L: 8829
					var10.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8830
					var10.packetBuffer.method7972(ClanSettings.selectedSpellWidget); // L: 8831
					var10.packetBuffer.method7961(var3); // L: 8832
					var10.packetBuffer.method7962(Client.selectedSpellItemId); // L: 8833
				...
				if (var14 != null) { // L: 8864
					...
					var10 = class120.getPacketBufferNode(ClientPacket.field2969, Client.packetWriter.isaacCipher); // L: 8872
					var10.packetBuffer.method7962(var3); // L: 8873
					var10.packetBuffer.method7952(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8874
				...
				if (var14 != null) { // L: 8721
					...
					var10 = class120.getPacketBufferNode(ClientPacket.field2961, Client.packetWriter.isaacCipher); // L: 8729
					var10.packetBuffer.method7961(var3); // L: 8730
				...
				if (var14 != null) { // L: 8705
					...
					var10 = class120.getPacketBufferNode(ClientPacket.field3034, Client.packetWriter.isaacCipher); // L: 8713
					var10.packetBuffer.writeIntME(var3); // L: 8714
				...
				if (var14 != null) { // L: 8422
					...
					var10 = class120.getPacketBufferNode(ClientPacket.field3044, Client.packetWriter.isaacCipher); // L: 8430
					var10.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8431
					var10.packetBuffer.writeIntME(var3); // L: 8432
				...
				if (var14 != null) { // L: 8674
					...
					var10 = class120.getPacketBufferNode(ClientPacket.field2941, Client.packetWriter.isaacCipher); // L: 8682
				...
				if (var2 == 14) {
					...
					if (var16 != null) { // L: 8631
						...
						var10 = class120.getPacketBufferNode(ClientPacket.field3018, Client.packetWriter.isaacCipher); // L: 8639
						var10.packetBuffer.method7952(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8640
						var10.packetBuffer.writeShort(ApproximateRouteStrategy.selectedItemSlot); // L: 8641
						var10.packetBuffer.method7962(var3); // L: 8642
						var10.packetBuffer.method7916(GameObject.selectedItemWidget); // L: 8643
						var10.packetBuffer.writeIntME(Canvas.selectedItemId); // L: 8644
					...
					if (var16 != null) { // L: 8476
						...
						var10.packetBuffer.method7962(var3); // L: 8484
						var10.packetBuffer.writeShort(Client.selectedSpellChildIndex); // L: 8485
						var10.packetBuffer.method7952(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8486
						var10.packetBuffer.method7971(ClanSettings.selectedSpellWidget); // L: 8487
						var10.packetBuffer.writeIntME(Client.selectedSpellItemId); // L: 8488
					...
					var9.packetBuffer.writeIntME(Canvas.selectedItemId); // L: 8559
					var9.packetBuffer.method8004(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8560
					var9.packetBuffer.method7961(ApproximateRouteStrategy.selectedItemSlot); // L: 8561
					var9.packetBuffer.writeShort(WorldMapData_1.baseY * 64 + var1); // L: 8562
					var9.packetBuffer.method7961(class128.baseX * 64 + var0); // L: 8563
					var9.packetBuffer.writeIntME(var3); // L: 8564
					...
					var9 = class120.getPacketBufferNode(ClientPacket.field3006, Client.packetWriter.isaacCipher); // L: 8395
					var9.packetBuffer.writeIntME(Client.selectedSpellItemId); // L: 8396
					var9.packetBuffer.writeShort(var3); // L: 8397
					var9.packetBuffer.writeIntME(WorldMapData_1.baseY * 64 + var1); // L: 8398
					var9.packetBuffer.method7952(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8399
					var9.packetBuffer.writeInt(ClanSettings.selectedSpellWidget); // L: 8400
					var9.packetBuffer.writeIntME(class128.baseX * 64 + var0); // L: 8401
					var9.packetBuffer.writeIntME(Client.selectedSpellChildIndex); // L: 8402
					...
					var9 = class120.getPacketBufferNode(ClientPacket.field3029, Client.packetWriter.isaacCipher); // L: 8606
					var9.packetBuffer.method7952(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8607
					var9.packetBuffer.method7961(WorldMapData_1.baseY * 64 + var1); // L: 8608
					...
					var9 = class120.getPacketBufferNode(ClientPacket.field2945, Client.packetWriter.isaacCipher); // L: 8696
					var9.packetBuffer.writeShort(var3); // L: 8697
					var9.packetBuffer.method8136(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8698
					var9.packetBuffer.method7961(class128.baseX * 64 + var0); // L: 8699
					...
					var9.packetBuffer.method7952(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 9060
					var9.packetBuffer.method7961(class128.baseX * 64 + var0); // L: 9061
					var9.packetBuffer.method7962(WorldMapData_1.baseY * 64 + var1); // L: 9062
					var9.packetBuffer.writeIntME(var3); // L: 9063
					...
					var9.packetBuffer.method7961(var3); // L: 9014
					var9.packetBuffer.method7961(WorldMapData_1.baseY * 64 + var1); // L: 9015
					var9.packetBuffer.writeIntME(class128.baseX * 64 + var0); // L: 9016
					var9.packetBuffer.method8004(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 9017
					...
					var9.packetBuffer.writeIntME(WorldMapData_1.baseY * 64 + var1); // L: 8801
					var9.packetBuffer.method7962(var3); // L: 8802
					var9.packetBuffer.method8136(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8803
					var9.packetBuffer.writeIntME(class128.baseX * 64 + var0); // L: 8804
					...
					if (var2 == 24) {
						...
						if (var17 != null) { // L: 8528
							...
							if (var12) { // L: 8531
								var11 = class120.getPacketBufferNode(ClientPacket.field2939, Client.packetWriter.isaacCipher); // L: 8533
						...
						if (var2 == 26) {
							...
							Widget var15;
							if (var2 == 28) {
								var9 = class120.getPacketBufferNode(ClientPacket.field2939, Client.packetWriter.isaacCipher); // L: 9143
								...
								var9 = class120.getPacketBufferNode(ClientPacket.field2939, Client.packetWriter.isaacCipher); // L: 8570
								...
								var9 = class120.getPacketBufferNode(ClientPacket.field2980, Client.packetWriter.isaacCipher); // L: 9079
								var9.packetBuffer.writeInt(var1); // L: 9080
								var9.packetBuffer.writeShort(ApproximateRouteStrategy.selectedItemSlot); // L: 9081
								var9.packetBuffer.method7961(Canvas.selectedItemId); // L: 9082
								var9.packetBuffer.method7971(GameObject.selectedItemWidget); // L: 9083
								var9.packetBuffer.writeIntME(var0); // L: 9084
								...
								var9 = class120.getPacketBufferNode(ClientPacket.field3038, Client.packetWriter.isaacCipher); // L: 8661
								var9.packetBuffer.writeInt(ClanSettings.selectedSpellWidget); // L: 8662
								var9.packetBuffer.writeIntME(var0); // L: 8663
								var9.packetBuffer.writeShort(Client.selectedSpellChildIndex); // L: 8664
								var9.packetBuffer.method7971(var1); // L: 8665
								var9.packetBuffer.writeIntME(var4); // L: 8666
								...
								var9.packetBuffer.writeIntME(var4); // L: 8997
								var9.packetBuffer.method7972(var1); // L: 8998
								...
								var9 = class120.getPacketBufferNode(ClientPacket.field2970, Client.packetWriter.isaacCipher); // L: 8541
								var9.packetBuffer.method7971(var1); // L: 8542
								var9.packetBuffer.method7961(var0); // L: 8543
								var9.packetBuffer.method7962(var4); // L: 8544
								...
								var9 = class120.getPacketBufferNode(ClientPacket.field2993, Client.packetWriter.isaacCipher); // L: 9121
								var9.packetBuffer.method7961(var4); // L: 9122
								var9.packetBuffer.method7972(var1); // L: 9123
								var9.packetBuffer.method7962(var0); // L: 9124
								...
								var9 = class120.getPacketBufferNode(ClientPacket.field2992, Client.packetWriter.isaacCipher); // L: 8922
								var9.packetBuffer.writeShort(var0); // L: 8923
								var9.packetBuffer.method7962(var4); // L: 8924
								var9.packetBuffer.method7916(var1); // L: 8925
								...
								var9 = class120.getPacketBufferNode(ClientPacket.field3043, Client.packetWriter.isaacCipher); // L: 8965
								var9.packetBuffer.method7961(var0); // L: 8966
								var9.packetBuffer.method7972(var1); // L: 8967
								var9.packetBuffer.method7961(var4); // L: 8968
								...
								if (var2 == 38) {
									...
									Client.selectedItemName = SoundCache.colorStartTag(16748608) + UserComparator3.ItemComposition_get(var4).name + SoundCache.colorStartTag(16777215); // L: 9115
								...
								if (var2 == 39) {
									...
									var9.packetBuffer.method7961(var4); // L: 9133
									var9.packetBuffer.method7962(var0); // L: 9134
									...
									var9 = class120.getPacketBufferNode(ClientPacket.field3019, Client.packetWriter.isaacCipher); // L: 9155
									var9.packetBuffer.writeInt(var1); // L: 9156
									var9.packetBuffer.method7962(var0); // L: 9157
									var9.packetBuffer.method7962(var4); // L: 9158
									...
									var9 = class120.getPacketBufferNode(ClientPacket.field3040, Client.packetWriter.isaacCipher); // L: 9068
									var9.packetBuffer.writeInt(var1); // L: 9069
									var9.packetBuffer.writeIntME(var0); // L: 9070
									var9.packetBuffer.writeIntME(var4); // L: 9071
									...
									var9.packetBuffer.writeIntME(var4); // L: 8653
									...
									var9 = class120.getPacketBufferNode(ClientPacket.field3032, Client.packetWriter.isaacCipher); // L: 8985
									var9.packetBuffer.method7962(var0); // L: 8986
									var9.packetBuffer.method7961(var4); // L: 8987
									var9.packetBuffer.method7971(var1); // L: 8988
									...
									if (var16 != null) { // L: 8584
										...
										var10 = class120.getPacketBufferNode(ClientPacket.field3011, Client.packetWriter.isaacCipher); // L: 8592
										var10.packetBuffer.writeShort(var3); // L: 8593
										var10.packetBuffer.method7952(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8594
									...
									if (var16 != null) { // L: 8906
										...
										var10.packetBuffer.method7952(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8915
										var10.packetBuffer.writeIntME(var3); // L: 8916
									...
									if (var16 != null) { // L: 8615
										...
										var10.packetBuffer.method8136(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8624
										var10.packetBuffer.method7962(var3); // L: 8625
									...
									if (var16 != null) { // L: 9037
										...
										var10.packetBuffer.method7961(var3); // L: 9046
										var10.packetBuffer.method8004(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 9047
									...
									if (var16 != null) { // L: 8737
										...
										var10.packetBuffer.writeIntME(var3); // L: 8746
									...
									if (var16 != null) { // L: 8753
										...
										var10.packetBuffer.method8004(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8762
										var10.packetBuffer.method7962(var3); // L: 8763
									...
									if (var16 != null) { // L: 8512
										...
										var10.packetBuffer.writeIntME(var3); // L: 8522
									...
									if (var16 != null) { // L: 8460
										...
										var10 = class120.getPacketBufferNode(ClientPacket.field2988, Client.packetWriter.isaacCipher); // L: 8468
										var10.packetBuffer.method7952(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8469
										var10.packetBuffer.writeIntME(var3); // L: 8470
										...
										if (var2 != 57) {
											if (var2 == 58) {
												...
												if (var17 != null) { // L: 8438
													...
													var10.packetBuffer.method7916(ClanSettings.selectedSpellWidget); // L: 8450
													var10.packetBuffer.method7961(Client.selectedSpellChildIndex); // L: 8451
													var10.packetBuffer.method7971(var1); // L: 8452
													var10.packetBuffer.writeShort(Client.selectedSpellItemId); // L: 8453
													var10.packetBuffer.method7961(var4); // L: 8454
											...
											if (var2 == 1001) {
												...
												var9.packetBuffer.method7962(var3); // L: 8957
												var9.packetBuffer.writeIntME(WorldMapData_1.baseY * 64 + var1); // L: 8958
												var9.packetBuffer.method7961(class128.baseX * 64 + var0); // L: 8959
												var9.packetBuffer.method7952(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L: 8960
											...
											if (var2 == 1002) {
												...
												var9 = class120.getPacketBufferNode(ClientPacket.field2996, Client.packetWriter.isaacCipher); // L: 8858
											...
											if (var2 == 1003) {
												...
												if (var14 != null) { // L: 8937
													...
													if (var18 != null) { // L: 8940
														var11 = class120.getPacketBufferNode(ClientPacket.field3035, Client.packetWriter.isaacCipher); // L: 8942
														var11.packetBuffer.method7962(var18.id); // L: 8943
											...
											if (var2 == 1004) {
												...
												var9 = class120.getPacketBufferNode(ClientPacket.field2937, Client.packetWriter.isaacCipher); // L: 8813
												var9.packetBuffer.writeShort(var3); // L: 8814
												var9.packetBuffer.writeShort(class128.baseX * 64 + var0); // L: 8815
												var9.packetBuffer.writeIntME(WorldMapData_1.baseY * 64 + var1); // L: 8816
											...
											if (var2 == 1005) {
												...
												if (var17 != null && var17.itemQuantities[var0] >= 100000) { // L: 9093
													class65.addGameMessage(27, "", var17.itemQuantities[var0] + " x " + UserComparator3.ItemComposition_get(var4).name);
												} else {
													var10 = class120.getPacketBufferNode(ClientPacket.field2979, Client.packetWriter.isaacCipher); // L: 9096
													var10.packetBuffer.method7962(var4); // L: 9097
					...
					if (var9.contentType == 1337) { // L: 10917
						...
						if (var9.isIf3) { // L: 10985
									...
									case 1:
										if (ItemComposition.method3909(class97.getWidgetFlags(var9))) { // L: 11000
											...
											if (var22 != null) { // L: 11002
												...
												var23.packetBuffer.method7916(var22[0]); // L: 11004
												var23.packetBuffer.method7971(var9.id); // L: 11005
												var23.packetBuffer.method7916(var22[1]); // L: 11006
												var23.packetBuffer.writeShort(var9.childIndex); // L: 11007
												var23.packetBuffer.method7916(var22[2]); // L: 11008
												var23.packetBuffer.method7916(var9.method5839()); // L: 11009
							...
							if (var9.hasListener) { // L: 11026
								...
								if (Client.clickedWidget != null || Nameable.dragInventoryWidget != null || Client.isMenuOpen) { // L: 11035
									var21 = false; // L: 11036
									var36 = false; // L: 11037
									var35 = false; // L: 11038
								}
						...
						if (!var9.isIf3) { // L: 11277
							if (Client.clickedWidget != null || Nameable.dragInventoryWidget != null || Client.isMenuOpen) { // L: 11278
								continue;
							}
