...
public class HitSplatDefinition extends DualNode {
   ...
   void decodeNext(Buffer var1, int var2) {
      if (var2 == 1) {
         ...
         this.field3313 = var1.readMedium();
      } else if (var2 == 3) {
   ...
   public final HitSplatDefinition transform() {
      ...
      return var2 != -1 ? StructDefinition.getHitSplatDefinition(var2) : null;
   }
   ...
   public Font getFont() {
      if (this.fontId == -1) {
         ...
         if (var1 != null) {
            ...
            var1 = class169.SpriteBuffer_getFont(GrandExchangeOfferTotalQuantityComparator.HitSplatDefinition_spritesArchive, class43.HitSplatDefinition_fontsArchive, this.fontId, 0);
            if (var1 != null) {
   ...
   static final void method4478(int var0, int var1, int var2, int var3, int var4) {
