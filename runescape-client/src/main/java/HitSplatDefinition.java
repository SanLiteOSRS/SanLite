...
public class HitSplatDefinition extends DualNode {
	...
	public SpritePixels method4587() {
		if (this.field3355 < 0) {
			...
			SpritePixels var1 = (SpritePixels)HitSplatDefinition_cachedSprites.get((long)this.field3355);
			if (var1 != null) {
				return var1;
			} else {
	...
	public SpritePixels method4585() {
		if (this.field3358 < 0) {
			...
			SpritePixels var1 = (SpritePixels)HitSplatDefinition_cachedSprites.get((long)this.field3358);
			if (var1 != null) {
				return var1;
			} else {
