...
public class HitSplatDefinition extends DualNode {
	...
	public SpritePixels method3091() {
		if (this.field1800 < 0) {
			...
			SpritePixels var1 = (SpritePixels)HealthBarDefinition_cached.get((long)this.field1800);
			if (var1 != null) {
				return var1;
			} else {
				var1 = class258.SpriteBuffer_getSprite(field1797, this.field1800, 0);
				if (var1 != null) {
					HealthBarDefinition_cached.put(var1, (long)this.field1800);
				}
	...
	public SpritePixels method3121() {
		if (this.field1806 < 0) {
			...
			SpritePixels var1 = (SpritePixels)HealthBarDefinition_cached.get((long)this.field1806);
			if (var1 != null) {
				return var1;
			} else {
				var1 = class258.SpriteBuffer_getSprite(field1797, this.field1806, 0);
				if (var1 != null) {
					HealthBarDefinition_cached.put(var1, (long)this.field1806);
				}
	...
	public SpritePixels method3122() {
		if (this.field1814 < 0) {
			...
			SpritePixels var1 = (SpritePixels)HealthBarDefinition_cached.get((long)this.field1814);
			if (var1 != null) {
				return var1;
			} else {
				var1 = class258.SpriteBuffer_getSprite(field1797, this.field1814, 0);
				if (var1 != null) {
					HealthBarDefinition_cached.put(var1, (long)this.field1814);
				}
