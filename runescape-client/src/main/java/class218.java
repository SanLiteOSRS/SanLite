...
public class class218 {
	...
	static final void method4210(byte[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, Scene var8, CollisionMap[] var9) {
		Buffer var10 = new Buffer(var0);
		int var11 = -1;

		while (true) {
			int var12 = var10.method5567();
			if (var12 == 0) {
				return;
			}
			...
			while (true) {
				...
				if (var17 == var4 && var16 >= var5 && var16 < var5 + 8 && var15 >= var6 && var15 < var6 + 8) {
					...
					int var22 = var2 + FloorDecoration.method2963(var16 & 7, var15 & 7, var7, var21.sizeX, var21.sizeY, var20);
					int var25 = var16 & 7;
					int var26 = var15 & 7;
					...
					if (var22 > 0 && var30 > 0 && var22 < 103 && var30 < 103) {
						...
						class247.method4584(var1, var22, var30, var11, var20 + var7 & 3, var19, var8, var32);
					}
				}
			}
		}
