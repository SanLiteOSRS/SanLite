...
public enum StudioGame implements Enumerated {
   ...
   public static FloorUnderlayDefinition method4057(int var0) {
   ...
   static void method4059(PacketBuffer var0, int var1) {
   ...
   static final void method4058(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
