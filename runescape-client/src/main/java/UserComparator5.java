		...
		if (Client.minimapState == 0 || Client.minimapState == 3) {
			if (!Client.isMenuOpen && (MouseHandler.MouseHandler_lastButton == 1 || !UserComparator9.mouseCam && MouseHandler.MouseHandler_lastButton == 4)) {
				...
				if (var3.contains(var4, var5)) {
					...
					int var11 = var9 + PlayerComposition.localPlayer.x >> 7;
					int var12 = PlayerComposition.localPlayer.y - var10 >> 7;
					...
					var13.packetBuffer.method5570(KeyHandler.KeyHandler_pressedKeys[82] ? (KeyHandler.KeyHandler_pressedKeys[81] ? 2 : 1) : 0);
					var13.packetBuffer.method5761(class41.baseY * 64 + var12);
					...
					var13.packetBuffer.writeShort(PlayerComposition.localPlayer.x);
					var13.packetBuffer.writeShort(PlayerComposition.localPlayer.y);
