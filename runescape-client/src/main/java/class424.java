...
public class class424 implements MouseWheel {
	...
	static {
		field4569 = new class424(5, 0);
		field4561 = new class424(3, 2);
		field4563 = new class424(1, 5);
		field4564 = new class424(0, 6);
		field4565 = new class424(4, 7);
		field4562 = new class424(2, 8);
	}
