...
public class PcmPlayer {
   ...
   @Export("timeMs")
   long timeMs = SequenceDefinition.currentTimeMs();
   @ObfuscatedName("e")
   @ObfuscatedGetter(
      intValue = 1742403687
   )
   ...
   PcmStream[] field1396 = new PcmStream[8];
   @ObfuscatedName("at")
   @ObfuscatedSignature(
      signature = "[Ldz;"
   )
   PcmStream[] field1397 = new PcmStream[8];
   ...
   public final synchronized void tryDiscard() {
      ...
      try {
         ...
         this.close();
         this.field1389 = SequenceDefinition.currentTimeMs() + 2000L;
      }
   ...
   final void fill(int[] var1, int var2) {
      ...
      this.timeMs = SequenceDefinition.currentTimeMs();
   }
   ...
   public static Font SpriteBuffer_getFontByName(AbstractArchive var0, AbstractArchive var1, String var2, String var3) {
      ...
      return class169.SpriteBuffer_getFont(var0, var1, var4, var5);
   }
}
