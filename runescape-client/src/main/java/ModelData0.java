   ...
   static void method3201(int var0, String var1) {
      ...
      for(int var6 = 0; var6 < var2; ++var6) {
         ...
         if (var7 != null && var7 != WorldMapIcon_1.localPlayer && var7.username != null && var7.username.equals(var5)) {
            ...
            if (var0 == 1) {
               var8 = MenuAction.method1994(ClientPacket.field2272, Client.packetWriter.isaacCipher);
               var8.packetBuffer.writeShort(var3[var6]);
               var8.packetBuffer.method5545(0);
               Client.packetWriter.method2177(var8);
            } else if (var0 == 4) {
               var8 = MenuAction.method1994(ClientPacket.field2279, Client.packetWriter.isaacCipher);
               var8.packetBuffer.method5432(var3[var6]);
               var8.packetBuffer.method5545(0);
               Client.packetWriter.method2177(var8);
            } else if (var0 == 6) {
               var8 = MenuAction.method1994(ClientPacket.field2249, Client.packetWriter.isaacCipher);
               var8.packetBuffer.method5443(var3[var6]);
               var8.packetBuffer.method5435(0);
               Client.packetWriter.method2177(var8);
            } else if (var0 == 7) {
               var8 = MenuAction.method1994(ClientPacket.field2260, Client.packetWriter.isaacCipher);
               var8.packetBuffer.method5435(0);
