...
public class WorldMapLabel {
	...
	static final void method475(int var0, int var1) {
		if (Client.hintArrowType == 2) {
			WorldMapCacheName.worldToScreen(Client.hintArrowSubX * 64 + (Client.hintArrowX - UserComparator8.baseX * 64 << 7), Client.hintArrowSubY * 64 + (Client.hintArrowY - HealthBar.baseY * 64 << 7), Client.hintArrowHeight * 4);
