	...
	static final void method5120(PacketBuffer var0) {
		for (int var1 = 0; var1 < Client.field549; ++var1) { // L: 7966
			...
			if ((var4 & 512) != 0) { // L: 7978
				var3.field1203 = var0.method7974(); // L: 7979
			}

			if ((var4 & 4) != 0) { // L: 7981
				var3.spotAnimation = var0.method8143(); // L: 7982
				var5 = var0.method7974(); // L: 7983
			...
			if ((var4 & 16) != 0) { // L: 8029
				var3.definition = class193.getNpcDefinition(var0.method7964()); // L: 8030
				var3.field1131 = var3.definition.size; // L: 8031
			...
			if ((var4 & 256) != 0) { // L: 8041
				var3.field1188 = Client.cycle + var0.method8143(); // L: 8042
				var3.field1158 = Client.cycle + var0.method8143(); // L: 8043
				var3.field1190 = var0.readByte(); // L: 8044
				var3.field1191 = var0.method7975(); // L: 8045
				var3.field1169 = var0.method7970(); // L: 8046
			...
			if (WorldMapSectionType.field2826 && (var4 & 2048) != 0 || !WorldMapSectionType.field2826 && (var4 & 1) != 0) { // L: 8049
				...
				var3.field1181 = var0.method7975(); // L: 8051
				var3.field1180 = var0.method7960(); // L: 8052
				var3.field1140 = var0.method7960(); // L: 8053
				var3.field1183 = var0.readUnsignedShort() + Client.cycle; // L: 8054
				var3.field1136 = var0.readUnsignedShort() + Client.cycle; // L: 8055
				var3.field1185 = var0.method8143(); // L: 8056
			...
			if ((var4 & 8) != 0) { // L: 8095
				var5 = var0.method7964(); // L: 8096
				var6 = var0.method8143(); // L: 8097
				if (WorldMapSectionType.field2826) { // L: 8098
					var3.field1141 = var0.method8023() == 1; // L: 8099
				}
			...
			if ((var4 & 128) != 0) { // L: 8105
				var3.targetIndex = var0.method7964(); // L: 8106
