...
public class WorldMapLabel {
	...
	static final void method488() {
		int var0 = class204.field2420 * 16384 + 64;
		int var1 = WorldMapManager.field348 * 16384 + 64;
		int var2 = Language.getTileHeight(var0, var1, ItemLayer.Client_plane) - field275;
		...
		var1 = class9.field42 * 16384 + 64;
		var2 = Language.getTileHeight(var0, var1, ItemLayer.Client_plane) - class206.field2446;
		...
		if (SceneTilePaint.cameraPitch < var7) {
			SceneTilePaint.cameraPitch = (var7 - SceneTilePaint.cameraPitch) * WorldMapCacheName.field329 / 1000 + SceneTilePaint.cameraPitch + class329.field3867;
			if (SceneTilePaint.cameraPitch > var7) {
		...
		if (SceneTilePaint.cameraPitch > var7) {
			SceneTilePaint.cameraPitch -= WorldMapCacheName.field329 * (SceneTilePaint.cameraPitch - var7) / 1000 + class329.field3867;
			if (SceneTilePaint.cameraPitch < var7) {
				SceneTilePaint.cameraPitch = var7;
			}
		}
