...
public final class WorldMapManager {
	...
	public void load(AbstractArchive var1, String var2, boolean var3) {
		if (!this.loadStarted) { // L: 42
			...
			int var4 = var1.getGroupId(WorldMapCacheName.field3049.name); // L: 48
			int var5 = var1.getFileId(var4, var2); // L: 49
			Buffer var6 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field3049.name, var2)); // L: 50
			Buffer var7 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field3044.name, var2)); // L: 51
			...
			if (var1.isValidFileName(WorldMapCacheName.field3045.name, var2)) { // L: 97
				byte[] var20 = var1.takeFileByNames(WorldMapCacheName.field3045.name, var2); // L: 98
				this.compositeTextureSprite = Interpreter.method2032(var20); // L: 99
			}
	...
	public final void drawTiles(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		float[] var12 = Rasterizer2D.field5088; // L: 115
		...
		int var18 = var14.height + var14.y - 1; // L: 128
		...
		Rasterizer3D.method4383(var9, var10, var11, var12); // L: 134
		...
		for (int var22 = var14.x; var22 < var14.width + var14.x; ++var22) { // L: 139
			for (int var23 = var14.y; var23 < var14.height + var14.y; ++var23) { // L: 140
				this.regions[var22][var23].method5173(var5 + var19 * (this.regions[var22][var23].regionX * 64 - var20) / 64, var8 - var19 * (this.regions[var22][var23].regionY * 64 - var21 + 64) / 64, var19); // L: 141
			}
		}
	...
	public final void drawElements(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, HashSet var9, HashSet var10, int var11, int var12, boolean var13) {
		...
		for (var19 = var14.x; var19 < var14.width + var14.x; ++var19) { // L: 152
			for (var20 = var14.y; var20 < var14.y + var14.height; ++var20) { // L: 153
				...
				this.regions[var19][var20].method5274(var5 + var16 * (this.regions[var19][var20].regionX * 64 - var17) / 64, var8 - var16 * (this.regions[var19][var20].regionY * 64 - var18 + 64) / 64, var16, var9); // L: 157
			}
		}
			...
			if (var6 > 0 && var6 % var7 < var7 / 2) { // L: 174
				...
				while (true) {
					...
					while (var11.hasNext()) { // L: 187
						...
						int var13 = var3 * (var12.coord2.x - this.tileX * 4096) / (this.tileWidth * 4096); // L: 190
		...
		if (!this.loaded) { // L: 201
			...
			for (int var17 = var12.x; var17 < var12.width + var12.x; ++var17) { // L: 209
				for (int var18 = var12.y; var18 < var12.y + var12.height; ++var18) { // L: 210
					List var19 = this.regions[var17][var18].method5204(var5 + var14 * (this.regions[var17][var18].regionX * 64 - var15) / 64, var8 + var6 - var14 * (this.regions[var17][var18].regionY * 64 - var16 + 64) / 64, var14, var9, var10); // L: 211
