...
public final class WorldMapManager {
	...
	public void method4733(AbstractArchive var1, String var2, boolean var3, boolean var4) {
		if (!this.field2490) { // L: 42
			...
			this.field2504 = (this.mapAreaData.getRegionHighY() - this.mapAreaData.getRegionLowY() + 1) * 4096; // L: 67
			...
			if (var6 > 0 && var6 % var7 < var7 / 2) { // L: 174
				...
				while (true) {
					...
					while (var11.hasNext()) {
						...
						int var14 = var4 - (var12.coord2.y - this.field2499 * 4096) * var4 / (this.field2504 * 64); // L: 191
