...
public final class WorldMapManager {
		...
		while (true) {
			if (var1.bitsRemaining(Client.packetWriter.serverPacketLength) >= 27) {
				...
				if (var2 != 32767) {
					...
					var4.method2131(class215.localPlayer.pathX[0] + var6, class215.localPlayer.pathY[0] + var7, var9 == 1);
					continue;
				}
			}
	...
	static final void worldToMinimap(int var0, int var1, int var2, int var3, Sprite var4, SpriteMask var5) {
		...
		if (var6 > 4225 && var6 < 90000) {
			...
			byte var17 = 20;
			class4.redHintArrowSprite.method6269(var15 + (var0 + var5.width / 2 - var17 / 2), var5.height / 2 + var1 - var17 / 2 - var16 - 10, var17, var17, 15, 15, var12, 256);
		} else {
