...
public class class307 {
	...
	static int method5650(int var0, Script var1, boolean var2) {
		if (var0 < 1000) {
			...
			return NPCComposition.method4922(var0, var1, var2);
		} else if (var0 < 4100) {
			return SecureRandomCallable.method1203(var0, var1, var2);
		} else if (var0 < 4200) {
			return ItemLayer.method2902(var0, var1, var2);
		} else if (var0 < 4300) {
			return TextureProvider.method2888(var0, var1, var2);
		} else if (var0 < 5100) {
			return Renderable.method3376(var0, var1, var2);
		} else if (var0 < 5400) {
	...
	static final void drawObject(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var5 != 0L) {
			...
			ObjectComposition var15 = Canvas.getObjectDefinition(var14);
		...
		if (var5 != 0L) {
			...
			ObjectComposition var20 = Canvas.getObjectDefinition(var10);
		...
		if (0L != var5) {
			...
			ObjectComposition var21 = Canvas.getObjectDefinition(var7);
