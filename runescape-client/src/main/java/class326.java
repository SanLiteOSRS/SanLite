...
public class class326 {
	...
	public class326() {
		...
		this.field4093 = new int[2048]; // L: 12
		this.field4095 = new int[2048]; // L: 13
		this.field4094 = 0; // L: 14
		UserComparator7.field1366 = new int[2000]; // L: 22
		int var1 = 0; // L: 23
		int var2 = 240; // L: 24

		int var4;
		for (byte var3 = 12; var1 < 16; var2 -= var3) { // L: 25
			var4 = VarbitComposition.method3556((double)((float)var2 / 360.0F), 0.9998999834060669D, (double)(0.075F + (float)var1 * 0.425F / 16.0F)); // L: 27
			UserComparator7.field1366[var1] = var4; // L: 28
			++var1; // L: 26
		}

		var2 = 48; // L: 30

		for (int var6 = var2 / 6; var1 < UserComparator7.field1366.length; var2 -= var6) { // L: 31 32 38
			var4 = var1 * 2; // L: 33

			for (int var5 = VarbitComposition.method3556((double)((float)var2 / 360.0F), 0.9998999834060669D, 0.5D); var1 < var4 && var1 < UserComparator7.field1366.length; ++var1) { // L: 34 35
				UserComparator7.field1366[var1] = var5; // L: 36
			}
		}
	...
	@ObfuscatedSignature(
		descriptor = "(II)V",
		garbageValue = "-1593801136"
	)
	void method6064(int var1) {
		int var2 = var1 * 2 + 1; // L: 44
		double[] var3 = class149.method3135(0.0D, (double)((float)var1 / 3.0F), var1); // L: 45
	...
	public final void method6058(int var1, int var2) {
		if (this.field4094 < this.field4093.length) { // L: 69
			this.field4093[this.field4094] = var1; // L: 70
			this.field4095[this.field4094] = var2; // L: 71
			++this.field4094; // L: 72
		}
	} // L: 73
	...
	public final void method6060(int var1, int var2, SpritePixels var3, float var4) {
		...
		int var11;
		int var12;
		for (var10 = 0; var10 < this.field4094; ++var10) { // L: 87
			var11 = this.field4093[var10]; // L: 88
			var12 = this.field4095[var10]; // L: 89
			...
			this.bounds.method6937(var8, var9); // L: 93
			this.method6061(var6, var3, var9); // L: 94
		}
		...
		for (var10 = 0; var10 < var3.pixels.length; ++var10) { // L: 98
			if (var3.pixels[var10] == 0) { // L: 99
				...
				if (var11 <= 0) { // L: 104
					...
					if (var11 > UserComparator7.field1366.length) { // L: 108
						var11 = UserComparator7.field1366.length;
					}

					var12 = UserComparator7.field1366[var11 - 1]; // L: 109
	...
	@ObfuscatedName("w")
	@ObfuscatedSignature(
		descriptor = "(Lqj;Lqj;Lnz;I)V",
		garbageValue = "594445038"
	)
