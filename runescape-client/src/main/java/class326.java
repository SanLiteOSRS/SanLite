...
public class class326 {
	...
	static int method5868(int var0, Script var1, boolean var2) {
		...
		if (var0 == 6600) { // L: 4118
			...
			int var15 = SecureRandomCallable.baseX * 64 + (ModelData0.localPlayer.x >> 7); // L: 4120
			int var8 = GrandExchangeOfferOwnWorldComparator.baseY * 64 + (ModelData0.localPlayer.y >> 7); // L: 4121
