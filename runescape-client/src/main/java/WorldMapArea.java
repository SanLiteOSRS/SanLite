...
public class WorldMapArea {
	...
	static void method508() {
		if (GrandExchangeOfferAgeComparator.worldMap != null) {
			GrandExchangeOfferAgeComparator.worldMap.method6524(ScriptEvent.Client_plane, class69.baseX * 64 + (ByteArrayPool.localPlayer.x >> 7), class89.baseY * 64 + (ByteArrayPool.localPlayer.y >> 7), false);
