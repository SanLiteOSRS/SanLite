...
public class Language implements Enumerated {
	...
	static SecureRandom method3749() {
	...
	static void method3758(int var0, Coord var1, boolean var2) {
		...
		UserComparator4.getWorldMap().method6381(var3, var7, var1, var2);
	}
}
