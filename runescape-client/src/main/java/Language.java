...
public class Language implements class345 {
	...
	static {
		Language_EN = new Language("EN", "en", "English", ModeWhere.field4327, 0, "GB"); // L: 12
		Language_DE = new Language("DE", "de", "German", ModeWhere.field4327, 1, "DE"); // L: 13
		Language_FR = new Language("FR", "fr", "French", ModeWhere.field4327, 2, "FR"); // L: 14
		Language_PT = new Language("PT", "pt", "Portuguese", ModeWhere.field4327, 3, "BR"); // L: 15
		Language_NL = new Language("NL", "nl", "Dutch", ModeWhere.field4310, 4, "NL"); // L: 16
		Language_ES = new Language("ES", "es", "Spanish", ModeWhere.field4310, 5, "ES"); // L: 17
		Language_ES_MX = new Language("ES_MX", "es-mx", "Spanish (Latin American)", ModeWhere.field4327, 6, "MX"); // L: 18
	...
	static void method6695() {
		Players.Players_count = 0; // L: 650

		for (int var0 = 0; var0 < 2048; ++var0) { // L: 651
			Players.field1372[var0] = null; // L: 652
			Players.field1379[var0] = class204.field2355; // L: 653
		}
