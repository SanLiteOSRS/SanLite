...
public enum class193 implements MouseWheel {
	...
	static final void drawWidgets(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		if (FloorOverlayDefinition.loadInterface(var0)) { // L: 9764
			WallObject.field2663 = null; // L: 9771
			GraphicsObject.drawInterface(Calendar.Widget_interfaceComponents[var0], -1, var1, var2, var3, var4, var5, var6, var7); // L: 9772
			if (WallObject.field2663 != null) { // L: 9773
				GraphicsObject.drawInterface(WallObject.field2663, -1412584499, var1, var2, var3, var4, MouseHandler.field240, Tile.field2344, var7); // L: 9774
				WallObject.field2663 = null; // L: 9775
			}
