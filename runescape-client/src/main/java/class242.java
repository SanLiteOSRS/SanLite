		...
		if (Widget.Widget_loadedInterfaces[var0]) {
			...
			if (var1 == 0) {
				...
				if (class81.Widget_interfaceComponents[var0] == null) {
					class81.Widget_interfaceComponents[var0] = new Widget[var1];
				}
				...
				for (int var2 = 0; var2 < var1; ++var2) {
					if (class81.Widget_interfaceComponents[var0][var2] == null) {
						...
						if (var3 != null) {
							class81.Widget_interfaceComponents[var0][var2] = new Widget();
							class81.Widget_interfaceComponents[var0][var2].id = var2 + (var0 << 16);
							if (var3[0] == -1) {
								class81.Widget_interfaceComponents[var0][var2].decode(new Buffer(var3));
							} else {
								class81.Widget_interfaceComponents[var0][var2].decodeLegacy(new Buffer(var3));
							}
						}
					}
				}
