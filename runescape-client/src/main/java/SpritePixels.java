...
public final class SpritePixels extends Rasterizer2D {
	...
	public SpritePixels method9156() {
	...
	@ObfuscatedName("d")
	public void method9149(int var1, int var2, int var3) {
		...
		if (var7 > 0 && var6 > 0) { // L: 549
			if (var3 == 256) {
				method9110(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9); // L: 550
			} else {
				method9162(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9, var3); // L: 551
			}
	...
	@ObfuscatedName("y")
	public void method9112(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) { // L: 593
			...
			if (var5 == 256) { // L: 635
				method9113(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6);
			} else {
				method9138(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6, var5); // L: 636
			}
	...
	@ObfuscatedName("ai")
	public void method9115(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
	...
	@ObfuscatedName("aw")
	public void method9117(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
		try {
	...
	@ObfuscatedName("ar")
	public void method9135(int var1, int var2, int var3, int var4) {
		this.method9116(this.width << 3, this.height << 3, var1 << 4, var2 << 4, var3, var4); // L: 773
	} // L: 774

	@ObfuscatedName("al")
	void method9116(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var6 != 0) { // L: 777
	...
	@ObfuscatedName("e")
	static void method9110(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
	...
	@ObfuscatedName("g")
	static void method9162(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13) {
	...
	@ObfuscatedName("aa")
	static void method9138(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16) {
