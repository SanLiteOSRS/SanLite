...
public final class SpritePixels extends Rasterizer2D {
	...
	public SpritePixels method9909() {
	...
	public void setRaster() {
		Rasterizer2D.method9766(this.pixels, this.subWidth, this.subHeight, (float[])null); // L: 69
	} // L: 70
	...
	@ObfuscatedName("ai")
	public void method9848(int var1, int var2, int var3) {
		...
		if (var7 > 0 && var6 > 0) { // L: 549
			if (var3 == 256) {
				method9849(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9); // L: 550
			} else {
				method9875(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9, var3); // L: 551
			}
	...
	@ObfuscatedName("at")
	public void method9836(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) { // L: 593
			...
			if (var5 == 256) { // L: 635
				method9852(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6);
			} else {
				method9924(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6, var5); // L: 636
			}
	...
	@ObfuscatedName("bg")
	public void method9911(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
	...
	@ObfuscatedName("br")
	public void method9856(int var1, int var2, int var3, int var4, int var5, int var6, double var7, int var9) {
		try {
	...
	@ObfuscatedName("ba")
	public void method9857(int var1, int var2, int var3, int var4) {
		this.method9855(this.width << 3, this.height << 3, var1 << 4, var2 << 4, var3, var4); // L: 773
	} // L: 774

	@ObfuscatedName("bk")
	void method9855(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var6 != 0) { // L: 777
	...
	@ObfuscatedName("ac")
	static void method9849(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12) {
	...
	@ObfuscatedName("al")
	static void method9875(int var0, int var1, int var2, int[] var3, int[] var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13) {
	...
	@ObfuscatedName("bj")
	static void method9852(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15) {
	...
	@ObfuscatedName("bd")
	static void method9924(int var0, int var1, int var2, int var3, int[] var4, int[] var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16) {
