...
public abstract class AbstractByteArrayCopier {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
		...
		if (var2 == 1) {
			...
			var8.packetBuffer.method5609(class89.baseY * 64 + var1);
			var8.packetBuffer.method5609(class69.baseX * 64 + var0);
			...
			var8.packetBuffer.method5602(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.writeIntME(class69.baseX * 64 + var0);
			var8.packetBuffer.method5609(var3);
			var8.packetBuffer.method5609(class89.baseY * 64 + var1);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 4) {
			...
			var8.packetBuffer.writeIntME(class69.baseX * 64 + var0);
			var8.packetBuffer.writeIntME(class89.baseY * 64 + var1);
			...
			var8.packetBuffer.method5610(class69.baseX * 64 + var0);
			var8.packetBuffer.writeIntME(class89.baseY * 64 + var1);
			var8.packetBuffer.method5727(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.method5610(var3);
			Client.packetWriter.addNode(var8);
			...
			var8.packetBuffer.writeShort(class69.baseX * 64 + var0);
			var8.packetBuffer.method5609(class89.baseY * 64 + var1);
			Client.packetWriter.addNode(var8);
		} else {
			...
			if (var2 == 7) {
				...
				if (var2 == 14) {
					...
					var8.packetBuffer.writeShort(class89.baseY * 64 + var1);
					...
					var8.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					var8.packetBuffer.method5609(class69.baseX * 64 + var0);
					var8.packetBuffer.method5610(class89.baseY * 64 + var1);
					var8.packetBuffer.writeIntME(var3);
					Client.packetWriter.addNode(var8);
				} else if (var2 == 21) {
					Client.mouseCrossX = var6;
