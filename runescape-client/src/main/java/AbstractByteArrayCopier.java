			...
			if (var0 != null) { // L: 11359
				...
				if (var4 != null) { // L: 11366
					...
					if (var5 != -1) { // L: 11383
						...
						class146.tempMenuAction.field880 = Client.field615[var5]; // L: 11389
						class146.tempMenuAction.field879 = Client.menuActions[var5]; // L: 11390
						class146.tempMenuAction.action = Client.menuTargets[var5]; // L: 11391
					}
