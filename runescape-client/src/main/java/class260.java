...
public final class class260 {
	...
	static final void method5000(int var0, int var1) {
		...
		if (class7.cameraPitch < var0) {
			class7.cameraPitch = (var0 - class7.cameraPitch) * DecorativeObject.field2573 / 1000 + class7.cameraPitch + WorldMapSectionType.field2723;
			if (class7.cameraPitch > var0) {
		...
		if (class7.cameraPitch > var0) {
			class7.cameraPitch -= (class7.cameraPitch - var0) * DecorativeObject.field2573 / 1000 + WorldMapSectionType.field2723;
			if (class7.cameraPitch < var0) {
				class7.cameraPitch = var0;
			}
		}
		...
		if (var2 > 0) {
			class7.cameraYaw = class7.cameraYaw + WorldMapSectionType.field2723 + var2 * DecorativeObject.field2573 / 1000;
			class7.cameraYaw &= 2047;
		}

		if (var2 < 0) {
			class7.cameraYaw -= -var2 * DecorativeObject.field2573 / 1000 + WorldMapSectionType.field2723;
			class7.cameraYaw &= 2047;
		}
