...
public class class41 {
	...
	static void playSong(int var0) {
		if (var0 == -1 && !Client.field647) {
			...
			UserComparator5.playMusicTrack(2, class108.archive6, var0, 0, Decimator.clientPreferences.musicVolume, false);
		}
	...
	static final void drawWidgets(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		if (Huffman.loadInterface(var0)) {
			...
			if (UrlRequest.field1224 != null) {
				StructComposition.drawInterface(UrlRequest.field1224, -1412584499, var1, var2, var3, var4, PcmPlayer.field191, class68.field976, var7);
				UrlRequest.field1224 = null;
			}
