...
public class class41 {
	...
	static final void method623(int var0, int var1, int var2, int var3, int var4, int var5, Scene var6, CollisionMap var7) {
		if (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var1][var2] & 2) != 0 || (Tiles.Tiles_renderFlags[var0][var1][var2] & 16) == 0) {
			...
			ObjectComposition var8 = Canvas.getObjectDefinition(var3);
			int var9;
			int var10;
			if (var4 != 1 && var4 != 3) {
				var9 = var8.sizeX;
			...
			if (var5 == 22) {
				...
				if (var5 != 10 && var5 != 11) {
					...
					if (var5 >= 12) {
						...
						var6.method3356(var0, var1, var2, var16, 1, 1, (Renderable)var22, 0, var19, var21);
						...
						var6.newBoundaryObject(var0, var1, var2, var16, (Renderable)var22, (Renderable)null, Tiles.field527[var4], 0, var19, var21);
						if (var4 == 0) {
							if (var8.clipped) {
						...
						var6.newBoundaryObject(var0, var1, var2, var16, (Renderable)var22, (Renderable)null, Tiles.field528[var4], 0, var19, var21);
						if (var8.clipped) {
							if (var4 == 0) {
								class171.field2036[var0][var1][var2 + 1] = 50;
							} else if (var4 == 1) {
						...
						if (var5 == 2) {
							...
							var6.newBoundaryObject(var0, var1, var2, var16, (Renderable)var29, (Renderable)var30, Tiles.field527[var4], Tiles.field527[var28], var19, var21);
							if (var8.modelClipped) {
								if (var4 == 0) {
									var10000 = HealthBarUpdate.field1031[var0][var1];
									var10000[var2] |= 585;
							...
							var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var22, (Renderable)null, Tiles.field527[var4], 0, 0, 0, var19, var21);
						} else {
							long var31;
							Object var33;
							if (var5 == 5) {
								...
								var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var33, (Renderable)null, Tiles.field527[var4], 0, var28 * Tiles.field523[var4], var28 * Tiles.field529[var4], var19, var21);
							} else if (var5 == 6) {
								var28 = 8;
								var31 = var6.getBoundaryObjectTag(var0, var1, var2);
								if (var31 != 0L) {
								...
								var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var33, (Renderable)null, 256, var4, var28 * Tiles.field531[var4], var28 * Tiles.field533[var4], var19, var21);
							} else if (var5 == 7) {
								var23 = var4 + 2 & 3;
								if (var8.animationId == -1 && var8.transforms == null) {
								...
								var6.newWallDecoration(var0, var1, var2, var16, (Renderable)var33, (Renderable)var26, 256, var4, var28 * Tiles.field531[var4], var28 * Tiles.field533[var4], var19, var21);
							}
						}
					}
				} else {
					...
					if (var22 != null && var6.method3356(var0, var1, var2, var16, var9, var10, (Renderable)var22, var5 == 11 ? 256 : 0, var19, var21) && var8.clipped) {
						var23 = 15;
	...
	static final void updateItemPile(int var0, int var1) {
		...
		if (var2 == null) {
			UserComparator3.scene.removeGroundItemPile(ItemLayer.Client_plane, var0, var1);
		} else {
			long var3 = -99999999L;
			TileItem var5 = null;
			...
			for (var6 = (TileItem)var2.last(); var6 != null; var6 = (TileItem)var2.previous()) {
				ItemComposition var7 = KitDefinition.ItemDefinition_get(var6.id);
			...
			if (var5 == null) {
				...
				UserComparator3.scene.newGroundItemPile(ItemLayer.Client_plane, var0, var1, Language.getTileHeight(var0 * 128 + 64, var1 * 128 + 64, ItemLayer.Client_plane), var5, var9, var12, var11);
			}
		}
	}
	...
	static final void closeInterface(InterfaceParent var0, boolean var1) {
		...
		PlayerComposition.method4177(var2);
