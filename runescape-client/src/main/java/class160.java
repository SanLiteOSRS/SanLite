...
public enum class160 implements Enumerated {
	...
	static final void method3538(int var0, int var1, int var2) {
		int var3;
	...
	static final void method3539(PacketBuffer var0) {
		for (int var1 = 0; var1 < Client.field676; ++var1) {
			...
			int var7;
			if ((var4 & 2) != 0) {
				var5 = var0.method5590();
				if (var5 == 65535) {
					var5 = -1;
				}

				var6 = var0.method5583();
			...
			if ((var4 & 1) != 0) {
				var3.targetIndex = var0.method5591();
			...
			if ((var4 & 32) != 0) {
				var3.spotAnimation = var0.method5591();
			...
			int var8;
			if ((var4 & 16) != 0) {
				var5 = var0.method5591();
				var6 = var0.method5592();
				...
				if (var6 > 0) {
					for (var7 = 0; var7 < var6; ++var7) {
						...
						if (var9 != 32767) {
							...
							int var12 = var9 > 0 ? var0.method5583() : var11;
