		...
		if (Client.minimapState == 0 || Client.minimapState == 3) { // L: 3854
			if (!Client.isMenuOpen && (MouseHandler.MouseHandler_lastButton == 1 || !Login.mouseCam && MouseHandler.MouseHandler_lastButton == 4)) { // L: 3855
				...
				if (var3.contains(var4, var5)) { // L: 3860
					...
					PacketBufferNode var13 = DecorativeObject.getPacketBufferNode(ClientPacket.field3023, Client.packetWriter.isaacCipher); // L: 3871
					...
					var13.packetBuffer.method7641(GrandExchangeOfferOwnWorldComparator.baseY * 64 + var12); // L: 3874
					var13.packetBuffer.writeShort(SecureRandomCallable.baseX * 64 + var11); // L: 3875
