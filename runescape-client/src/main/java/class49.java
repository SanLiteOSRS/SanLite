...
public class class49 {
   ...
   static int method811(int var0, Script var1, boolean var2) {
      if (var0 == ScriptOpcodes.VIEWPORT_SETFOV) {
         ...
         Interpreter.Interpreter_intStackSize -= 2;
         Client.field875 = (short)Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize];
         if (Client.field875 <= 0) {
            Client.field875 = 256;
         }

         Client.field876 = (short)Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1];
         ...
         Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = Client.field875;
         Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = Client.field876;
         return 1;
