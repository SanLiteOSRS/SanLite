...
public class VorbisFloor {
	...
	VorbisFloor() {
		...
		int var2 = var1.method1118(16); // L: 81
		if (var2 != 1) { // L: 82
			throw new RuntimeException(); // L: 83
		} else {
			int var3 = var1.method1118(5); // L: 85
			int var4 = 0; // L: 86
			...
			this.field268 = new int[var4]; // L: 93
			this.field273 = new int[var4]; // L: 94
			this.field275 = new int[var4]; // L: 95
			this.field276 = new int[var4][]; // L: 96

			int var8;
			for (var5 = 0; var5 < var4; ++var5) { // L: 97
				this.field268[var5] = var1.method1118(3) + 1; // L: 98
				var6 = this.field273[var5] = var1.method1118(2); // L: 99
				if (var6 != 0) { // L: 100
				...
				this.field276[var5] = var10; // L: 103
			...
			this.multiplier = var1.method1118(2) + 1; // L: 106
			var5 = var1.method1118(4); // L: 107
			var6 = 2; // L: 108
			...
			this.field270 = new int[var6]; // L: 110
			this.field270[0] = 0; // L: 111
			this.field270[1] = 1 << var5; // L: 112
			var6 = 2; // L: 113

			for (var7 = 0; var7 < var3; ++var7) { // L: 114
				var8 = this.field272[var7]; // L: 115

				for (int var9 = 0; var9 < this.field268[var8]; ++var9) { // L: 116
	...
	class59 method734(class60 var1) {
		boolean var2 = var1.method1117() != 0; // L: 121
		if (!var2) { // L: 122
			...
			int var4 = this.field270.length; // L: 124
			if (var3.field430 == null || var3.field430.length < var4) { // L: 125
				var3.field430 = new int[var4]; // L: 126
				var3.field431 = new int[var4]; // L: 127
				var3.field435 = new boolean[var4]; // L: 128
			}
			...
			var5 = field274[this.multiplier - 1]; // L: 131
			int var6 = Tile.iLog(var5 - 1); // L: 132
			var3.field431[0] = var1.method1118(var6); // L: 133
			var3.field431[1] = var1.method1118(var6); // L: 134
			int var7 = 2; // L: 135

			for (int var8 = 0; var8 < this.field272.length; ++var8) { // L: 136
				int var9 = this.field272[var8]; // L: 137
				int var10 = this.field268[var9]; // L: 138
				int var11 = this.field273[var9]; // L: 139
				...
				for (int var14 = 0; var14 < var10; ++var14) { // L: 143
					int var15 = this.field276[var9][var13 & var12]; // L: 144
					var13 >>>= var11; // L: 145
					var3.field431[var7++] = var15 >= 0 ? VorbisSample.field383[var15].method1035(var1) : 0; // L: 146
				}
			}
