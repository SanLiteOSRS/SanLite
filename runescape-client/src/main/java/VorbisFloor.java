...
public class VorbisFloor {
	...
	@ObfuscatedName("n")
	int method2521(int var1, int var2, int var3, int var4, int var5) {
		int var6 = var4 - var2;
		int var7 = var3 - var1;
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method2440();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field1376[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method2440() : 0;
				}
			}
	...
	void method2517(float[] var1, int var2) {
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method2512(field1377, var6);
			var8 = method2528(field1377, var6);
			var9 = this.method2521(field1377[var7], field1376[var7], field1377[var8], field1376[var8], field1377[var6]);
	...
	@ObfuscatedName("t")
	static int method2528(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
