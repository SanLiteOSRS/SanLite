...
public class VorbisFloor {
	...
	static {
		field1422 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field1420 = new int[var5];
			this.field1420[0] = 0;
			this.field1420[1] = 1 << var4;
			var5 = 2;
			...
			if (field1418 == null || field1418.length < var5) {
				...
				field1428 = new int[var5];
				field1425 = new boolean[var5];
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field1420.length;
			...
			var3 = field1422[this.multiplier - 1];
			int var4 = DevicePcmPlayerProvider.iLog(var3 - 1);
			field1428[0] = VorbisSample.readBits(var4);
			field1428[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				for (int var12 = 0; var12 < var8; ++var12) {
					...
					var11 >>>= var9;
					field1428[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method2432() : 0;
				}
			}
	...
	void method2501(float[] var1, int var2) {
		...
		int var4 = field1422[this.multiplier - 1];
		boolean[] var5 = field1425;
		field1425[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method2506(field1418, var6);
			var8 = method2495(field1418, var6);
			var9 = this.method2504(field1418[var7], field1428[var7], field1418[var8], field1428[var8], field1418[var6]);
			var10 = field1428[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field1425;
				field1425[var8] = true;
				var14[var7] = true;
				field1425[var6] = true;
				if (var10 >= var13) {
					field1428[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field1428[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field1425[var6] = false;
				field1428[var6] = var9;
			}
		}
		...
		var6 = 0;
		var7 = field1428[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field1425[var8]) {
				var9 = field1418[var8];
				var10 = field1428[var8] * this.multiplier;
				this.method2496(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
