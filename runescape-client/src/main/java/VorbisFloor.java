...
public class VorbisFloor {
	...
	static {
		field311 = new int[]{256, 128, 86, 64}; // L: 8
	...
	VorbisFloor() {
		...
		if (var1 != 1) { // L: 109
			...
			this.field302 = new int[var5]; // L: 137
			this.field302[0] = 0; // L: 138
			this.field302[1] = 1 << var4; // L: 139
			var5 = 2; // L: 140
			...
			if (field309 == null || field309.length < var5) { // L: 145
				field309 = new int[var5]; // L: 146
				field310 = new int[var5]; // L: 147
				field303 = new boolean[var5]; // L: 148
			}
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) { // L: 83
			int var3 = var1; // L: 84
			int var4 = field309[var1]; // L: 85
			int var5 = field310[var1]; // L: 86
			boolean var6 = field303[var1]; // L: 87

			for (int var7 = var1 + 1; var7 <= var2; ++var7) { // L: 88
				int var8 = field309[var7]; // L: 89
				if (var8 < var4) { // L: 90
					field309[var3] = var8; // L: 91
					field310[var3] = field310[var7]; // L: 92
					field303[var3] = field303[var7]; // L: 93
					++var3; // L: 94
					field309[var7] = field309[var3]; // L: 95
					field310[var7] = field310[var3]; // L: 96
					field303[var7] = field303[var3]; // L: 97
				}
			}

			field309[var3] = var4; // L: 100
			field310[var3] = var5; // L: 101
			field303[var3] = var6; // L: 102
	...
	boolean readSubmapFloor() {
		...
		if (!var1) { // L: 154
			...
			int var2 = this.field302.length; // L: 155
			...
			var3 = field311[this.multiplier - 1]; // L: 157
			int var4 = Player.iLog(var3 - 1); // L: 158
			field310[0] = VorbisSample.readBits(var4); // L: 159
			field310[1] = VorbisSample.readBits(var4); // L: 160
			int var5 = 2; // L: 161
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) { // L: 162
				...
				for (int var12 = 0; var12 < var8; ++var12) { // L: 169
					...
					var11 >>>= var9; // L: 171
					field310[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method1080() : 0; // L: 172
				}
			}
	...
	void method776(float[] var1, int var2) {
		int var3 = this.field302.length; // L: 179
		int var4 = field311[this.multiplier - 1]; // L: 180
		boolean[] var5 = field303; // L: 181
		field303[1] = true; // L: 182
		var5[0] = true; // L: 183
		...
		for (var6 = 2; var6 < var3; ++var6) { // L: 184
			var7 = method775(field309, var6); // L: 185
			var8 = method771(field309, var6); // L: 186
			var9 = this.method787(field309[var7], field310[var7], field309[var8], field310[var8], field309[var6]); // L: 187
			var10 = field310[var6]; // L: 188
			int var11 = var4 - var9; // L: 189
			int var13 = (var11 < var9 ? var11 : var9) << 1; // L: 191
			if (var10 != 0) { // L: 192
				boolean[] var14 = field303; // L: 193
				field303[var8] = true; // L: 195
				var14[var7] = true; // L: 196
				field303[var6] = true; // L: 197
				if (var10 >= var13) { // L: 198
					field310[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1; // L: 199
				} else {
					field310[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9; // L: 202
				}
			} else {
				field303[var6] = false; // L: 206
				field310[var6] = var9; // L: 207
			}
		}

		this.VarbisFloor_sort(0, var3 - 1); // L: 210
		var6 = 0; // L: 211
		var7 = field310[0] * this.multiplier; // L: 212

		for (var8 = 1; var8 < var3; ++var8) { // L: 213
			if (field303[var8]) { // L: 214
				var9 = field309[var8]; // L: 215
				var10 = field310[var8] * this.multiplier; // L: 216
				this.method773(var6, var7, var9, var10, var1, var2); // L: 217
				if (var9 >= var2) { // L: 218
					return;
				}
