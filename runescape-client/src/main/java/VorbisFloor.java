...
public class VorbisFloor {
	...
	static {
		field280 = new int[]{256, 128, 86, 64}; // L: 8
	...
	VorbisFloor() {
		...
		if (var1 != 1) { // L: 109
			...
			if (field282 == null || field282.length < var5) { // L: 145
				field282 = new int[var5]; // L: 146
				field281 = new int[var5]; // L: 147
				field275 = new boolean[var5]; // L: 148
			}
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) { // L: 83
			int var3 = var1; // L: 84
			int var4 = field282[var1]; // L: 85
			int var5 = field281[var1]; // L: 86
			boolean var6 = field275[var1]; // L: 87

			for (int var7 = var1 + 1; var7 <= var2; ++var7) { // L: 88
				int var8 = field282[var7]; // L: 89
				if (var8 < var4) { // L: 90
					field282[var3] = var8; // L: 91
					field281[var3] = field281[var7]; // L: 92
					field275[var3] = field275[var7]; // L: 93
					++var3; // L: 94
					field282[var7] = field282[var3]; // L: 95
					field281[var7] = field281[var3]; // L: 96
					field275[var7] = field275[var3]; // L: 97
				}
			}

			field282[var3] = var4; // L: 100
			field281[var3] = var5; // L: 101
			field275[var3] = var6; // L: 102
	...
	boolean readSubmapFloor() {
		...
		if (!var1) { // L: 154
			...
			for (var3 = 0; var3 < var2; ++var3) { // L: 156
				field282[var3] = this.field273[var3];
			}

			var3 = field280[this.multiplier - 1]; // L: 157
			int var4 = Client.iLog(var3 - 1); // L: 158
			field281[0] = VorbisSample.readBits(var4); // L: 159
			field281[1] = VorbisSample.readBits(var4); // L: 160
			int var5 = 2; // L: 161
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) { // L: 162
				...
				int var11 = 0; // L: 167
				if (var9 > 0) { // L: 168
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method1055();
				}

				for (int var12 = 0; var12 < var8; ++var12) { // L: 169
					int var13 = this.subclassBooks[var7][var11 & var10]; // L: 170
					var11 >>>= var9; // L: 171
					field281[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method1055() : 0; // L: 172
				}
			}
	...
	@ObfuscatedName("av")
	void method741(float[] var1, int var2) {
		int var3 = this.field273.length; // L: 179
		int var4 = field280[this.multiplier - 1]; // L: 180
		boolean[] var5 = field275; // L: 181
		field275[1] = true; // L: 182
		var5[0] = true; // L: 183
		...
		for (var6 = 2; var6 < var3; ++var6) { // L: 184
			var7 = method758(field282, var6); // L: 185
			var8 = method736(field282, var6); // L: 186
			var9 = this.method754(field282[var7], field281[var7], field282[var8], field281[var8], field282[var6]); // L: 187
			var10 = field281[var6]; // L: 188
			int var11 = var4 - var9; // L: 189
			int var13 = (var11 < var9 ? var11 : var9) << 1; // L: 191
			if (var10 != 0) { // L: 192
				boolean[] var14 = field275; // L: 193
				field275[var8] = true; // L: 195
				var14[var7] = true; // L: 196
				field275[var6] = true; // L: 197
				if (var10 >= var13) { // L: 198
					field281[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1; // L: 199
				} else {
					field281[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9; // L: 202
				}
			} else {
				field275[var6] = false; // L: 206
				field281[var6] = var9; // L: 207
			}
		}

		this.VarbisFloor_sort(0, var3 - 1); // L: 210
		var6 = 0; // L: 211
		var7 = field281[0] * this.multiplier; // L: 212

		for (var8 = 1; var8 < var3; ++var8) { // L: 213
			if (field275[var8]) { // L: 214
				var9 = field282[var8]; // L: 215
				var10 = field281[var8] * this.multiplier; // L: 216
				this.method738(var6, var7, var9, var10, var1, var2); // L: 217
				if (var9 >= var2) { // L: 218
					return;
				}
