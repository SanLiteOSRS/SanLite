...
public class VorbisFloor {
	...
	static {
		field1425 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field1422 = new int[var5];
			this.field1422[0] = 0;
			this.field1422[1] = 1 << var4;
			var5 = 2;
			...
			if (field1429 == null || field1429.length < var5) {
				field1429 = new int[var5];
				field1430 = new int[var5];
				field1431 = new boolean[var5];
			}
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field1429[var1];
			int var5 = field1430[var1];
			boolean var6 = field1431[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field1429[var7];
				if (var8 < var4) {
					field1429[var3] = var8;
					field1430[var3] = field1430[var7];
					field1431[var3] = field1431[var7];
					++var3;
					field1429[var7] = field1429[var3];
					field1430[var7] = field1430[var3];
					field1431[var7] = field1431[var3];
				}
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			var3 = field1425[this.multiplier - 1];
			int var4 = JagexCache.iLog(var3 - 1);
			field1430[0] = VorbisSample.readBits(var4);
			field1430[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				for (int var12 = 0; var12 < var8; ++var12) {
					...
					var11 >>>= var9;
					field1430[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method2472() : 0;
				}
			}
	...
	void method2537(float[] var1, int var2) {
		...
		int var4 = field1425[this.multiplier - 1];
		boolean[] var5 = field1431;
		field1431[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method2549(field1429, var6);
			var8 = method2532(field1429, var6);
			var9 = this.method2556(field1429[var7], field1430[var7], field1429[var8], field1430[var8], field1429[var6]);
			var10 = field1430[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field1431;
				field1431[var8] = true;
				var14[var7] = true;
				field1431[var6] = true;
				if (var10 >= var13) {
					field1430[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field1430[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field1431[var6] = false;
				field1430[var6] = var9;
			}
		}
		...
		var6 = 0;
		var7 = field1430[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field1431[var8]) {
				var9 = field1429[var8];
				var10 = field1430[var8] * this.multiplier;
				this.method2534(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
