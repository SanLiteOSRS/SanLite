...
public class VorbisFloor {
	...
	static {
		field1411 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			if (field1415 == null || field1415.length < var5) {
				field1415 = new int[var5];
				field1405 = new int[var5];
				field1416 = new boolean[var5];
			}
	...
	@ObfuscatedName("d")
	int method2586(int var1, int var2, int var3, int var4, int var5) {
		int var6 = var4 - var2;
		int var7 = var3 - var1;
	...
	@ObfuscatedName("c")
	void method2606(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field1415[var1];
			int var5 = field1405[var1];
			boolean var6 = field1416[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field1415[var7];
				if (var8 < var4) {
					field1415[var3] = var8;
					field1405[var3] = field1405[var7];
					field1416[var3] = field1416[var7];
					++var3;
					field1415[var7] = field1415[var3];
					field1405[var7] = field1405[var3];
					field1416[var7] = field1416[var3];
				}
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field1407.length;

			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				field1415[var3] = this.field1407[var3];
			}

			var3 = field1411[this.multiplier - 1];
			int var4 = Coord.iLog(var3 - 1);
			field1405[0] = VorbisSample.readBits(var4);
			field1405[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method2510();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field1405[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method2510() : 0;
				}
			}
	...
	@ObfuscatedName("z")
	void method2590(float[] var1, int var2) {
		int var3 = this.field1407.length;
		int var4 = field1411[this.multiplier - 1];
		boolean[] var5 = field1416;
		field1416[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method2602(field1415, var6);
			var8 = method2600(field1415, var6);
			var9 = this.method2586(field1415[var7], field1405[var7], field1415[var8], field1405[var8], field1415[var6]);
			var10 = field1405[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field1416;
				field1416[var8] = true;
				var14[var7] = true;
				field1416[var6] = true;
				if (var10 >= var13) {
					field1405[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field1405[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field1416[var6] = false;
				field1405[var6] = var9;
			}
		}
		...
		var6 = 0;
		var7 = field1405[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field1416[var8]) {
				var9 = field1415[var8];
				var10 = field1405[var8] * this.multiplier;
				this.method2606(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
	...
	@ObfuscatedName("v")
	static int method2600(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
