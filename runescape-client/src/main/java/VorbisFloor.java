...
public class VorbisFloor {
	...
	static {
		field263 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field258 = new int[var5];
			this.field258[0] = 0;
			this.field258[1] = 1 << var4;
			var5 = 2;
			...
			for (var6 = 0; var6 < var2; ++var6) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field258[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field256 == null || field256.length < var5) {
				field256 = new int[var5];
				field266 = new int[var5];
				field265 = new boolean[var5];
			}
	...
	@ObfuscatedName("i")
	int method666(int var1, int var2, int var3, int var4, int var5) {
		int var6 = var4 - var2;
		int var7 = var3 - var1;
	...
	@ObfuscatedName("f")
	void method672(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field256[var1];
			int var5 = field266[var1];
			boolean var6 = field265[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field256[var7];
				if (var8 < var4) {
					field256[var3] = var8;
					field266[var3] = field266[var7];
					field265[var3] = field265[var7];
					++var3;
					field256[var7] = field256[var3];
					field266[var7] = field266[var3];
					field265[var7] = field265[var3];
				}
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field258.length;

			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				field256[var3] = this.field258[var3];
			}

			var3 = field263[this.multiplier - 1];
			int var4 = class143.iLog(var3 - 1);
			field266[0] = VorbisSample.readBits(var4);
			field266[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method988();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field266[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method988() : 0;
				}
			}
	...
	@ObfuscatedName("s")
	void method665(float[] var1, int var2) {
		int var3 = this.field258.length;
		int var4 = field263[this.multiplier - 1];
		boolean[] var5 = field265;
		field265[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method673(field256, var6);
			var8 = method664(field256, var6);
			var9 = this.method666(field256[var7], field266[var7], field256[var8], field266[var8], field256[var6]);
			var10 = field266[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field265;
				field265[var8] = true;
				var14[var7] = true;
				field265[var6] = true;
				if (var10 >= var13) {
					field266[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field266[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field265[var6] = false;
				field266[var6] = var9;
		...
		var6 = 0;
		var7 = field266[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field265[var8]) {
				var9 = field256[var8];
				var10 = field266[var8] * this.multiplier;
				this.method672(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
	...
	@ObfuscatedName("v")
	static int method673(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
