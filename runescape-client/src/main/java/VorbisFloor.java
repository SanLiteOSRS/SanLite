...
public class VorbisFloor {
	...
	static {
		field390 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field386 = new int[var5];
			this.field386[0] = 0;
			this.field386[1] = 1 << var4;
			var5 = 2;
			...
			if (field384 == null || field384.length < var5) {
				field384 = new int[var5];
				field394 = new int[var5];
				field393 = new boolean[var5];
			}
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field384[var1];
			int var5 = field394[var1];
			boolean var6 = field393[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field384[var7];
				if (var8 < var4) {
					field384[var3] = var8;
					field394[var3] = field394[var7];
					field393[var3] = field393[var7];
					++var3;
					field384[var7] = field384[var3];
					field394[var7] = field394[var3];
					field393[var7] = field393[var3];
				}
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			var3 = field390[this.multiplier - 1];
			int var4 = class5.iLog(var3 - 1);
			field394[0] = VorbisSample.readBits(var4);
			field394[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				for (int var12 = 0; var12 < var8; ++var12) {
					...
					var11 >>>= var9;
					field394[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method1111() : 0;
				}
			}
	...
	void method815(float[] var1, int var2) {
		int var3 = this.field386.length;
		int var4 = field390[this.multiplier - 1];
		boolean[] var5 = field393;
		field393[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method834(field384, var6);
			var8 = method809(field384, var6);
			var9 = this.method811(field384[var7], field394[var7], field384[var8], field394[var8], field384[var6]);
			var10 = field394[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field393;
				field393[var8] = true;
				var14[var7] = true;
				field393[var6] = true;
				if (var10 >= var13) {
					field394[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field394[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field393[var6] = false;
				field394[var6] = var9;
		...
		var6 = 0;
		var7 = field394[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field393[var8]) {
				var9 = field384[var8];
				var10 = field394[var8] * this.multiplier;
				this.method812(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
