...
public class VorbisFloor {
	...
	static {
		field280 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field277 = new int[var5];
			this.field277[0] = 0;
			this.field277[1] = 1 << var4;
			var5 = 2;
	...
	@ObfuscatedName("s")
	int method685(int var1, int var2, int var3, int var4, int var5) {
		int var6 = var4 - var2;
		int var7 = var3 - var1;
	...
	@ObfuscatedName("e")
	void method686(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			var3 = field280[this.multiplier - 1];
			int var4 = class111.iLog(var3 - 1);
			field285[0] = VorbisSample.readBits(var4);
			field285[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				for (int var12 = 0; var12 < var8; ++var12) {
					...
					var11 >>>= var9;
					field285[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method988() : 0;
				}
			}
	...
	@ObfuscatedName("i")
	void method706(float[] var1, int var2) {
		int var3 = this.field277.length;
		int var4 = field280[this.multiplier - 1];
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method699(field284, var6);
			var8 = method684(field284, var6);
			var9 = this.method685(field284[var7], field285[var7], field284[var8], field285[var8], field284[var6]);
			var10 = field285[var6];
			int var11 = var4 - var9;
			...
			if (var10 != 0) {
				...
				field276[var6] = true;
				if (var10 >= var13) {
					field285[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field285[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field276[var6] = false;
				field285[var6] = var9;
		...
		var6 = 0;
		var7 = field285[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field276[var8]) {
				var9 = field284[var8];
				var10 = field285[var8] * this.multiplier;
				this.method686(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
	...
	@ObfuscatedName("l")
	static int method684(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
