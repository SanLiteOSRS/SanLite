...
public class VorbisFloor {
	...
	static {
		field294 = new int[]{256, 128, 86, 64}; // L: 8
	...
	VorbisFloor() {
		class60 var1 = VorbisSample.field415; // L: 80
		int var2 = var1.method1184(16); // L: 81
		if (var2 != 1) { // L: 82
			throw new RuntimeException(); // L: 83
		} else {
			int var3 = var1.method1184(5); // L: 85
			int var4 = 0; // L: 86
			this.field291 = new int[var3]; // L: 87

			int var5;
			int var6;
			for (var5 = 0; var5 < var3; ++var5) { // L: 88
				var6 = var1.method1184(4); // L: 89
				this.field291[var5] = var6; // L: 90
				if (var6 >= var4) { // L: 91
					var4 = var6 + 1;
				}
			}

			this.field292 = new int[var4]; // L: 93
			this.field287 = new int[var4]; // L: 94
			this.field295 = new int[var4]; // L: 95
			this.field289 = new int[var4][]; // L: 96

			int var8;
			for (var5 = 0; var5 < var4; ++var5) { // L: 97
				this.field292[var5] = var1.method1184(3) + 1; // L: 98
				var6 = this.field287[var5] = var1.method1184(2); // L: 99
				if (var6 != 0) { // L: 100
				...
				this.field289[var5] = var10; // L: 103
			...
			this.multiplier = var1.method1184(2) + 1; // L: 106
			var5 = var1.method1184(4); // L: 107
			var6 = 2; // L: 108
			...
			this.field293 = new int[var6]; // L: 110
			this.field293[0] = 0; // L: 111
			this.field293[1] = 1 << var5; // L: 112
			var6 = 2; // L: 113

			for (var7 = 0; var7 < var3; ++var7) { // L: 114
				var8 = this.field291[var7]; // L: 115

				for (int var9 = 0; var9 < this.field292[var8]; ++var9) { // L: 116
	...
	class59 method767(class60 var1) {
		boolean var2 = var1.method1185() != 0; // L: 121
		if (!var2) { // L: 122
			...
			int var4 = this.field293.length; // L: 124
			if (var3.field450 == null || var3.field450.length < var4) { // L: 125
				var3.field450 = new int[var4]; // L: 126
				var3.field453 = new int[var4]; // L: 127
				var3.field454 = new boolean[var4]; // L: 128
			}
			...
			var5 = field294[this.multiplier - 1]; // L: 131
			int var6 = WorldMapRegion.iLog(var5 - 1); // L: 132
			var3.field453[0] = var1.method1184(var6); // L: 133
			var3.field453[1] = var1.method1184(var6); // L: 134
			int var7 = 2; // L: 135

			for (int var8 = 0; var8 < this.field291.length; ++var8) { // L: 136
				int var9 = this.field291[var8]; // L: 137
				int var10 = this.field292[var9]; // L: 138
				int var11 = this.field287[var9]; // L: 139
				...
				for (int var14 = 0; var14 < var10; ++var14) { // L: 143
					int var15 = this.field289[var9][var13 & var12]; // L: 144
					var13 >>>= var11; // L: 145
					var3.field453[var7++] = var15 >= 0 ? VorbisSample.field402[var15].method1083(var1) : 0; // L: 146
				}
			}
