...
public class VorbisFloor {
	...
	static {
		field1413 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field1411 = new int[var5];
			this.field1411[0] = 0;
			this.field1411[1] = 1 << var4;
			var5 = 2;
			...
			if (field1418 == null || field1418.length < var5) {
				...
				field1419 = new int[var5];
				field1409 = new boolean[var5];
			}
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			...
			int var5 = field1419[var1];
			boolean var6 = field1409[var1];
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field1411.length;
			...
			var3 = field1413[this.multiplier - 1];
			int var4 = IgnoreList.iLog(var3 - 1);
			field1419[0] = VorbisSample.readBits(var4);
			field1419[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				for (int var12 = 0; var12 < var8; ++var12) {
					...
					var11 >>>= var9;
					field1419[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method2402() : 0;
				}
			}
	...
	void method2465(float[] var1, int var2) {
		int var3 = this.field1411.length;
		int var4 = field1413[this.multiplier - 1];
		boolean[] var5 = field1409;
		field1409[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method2466(field1418, var6);
			var8 = method2460(field1418, var6);
			var9 = this.method2476(field1418[var7], field1419[var7], field1418[var8], field1419[var8], field1418[var6]);
			var10 = field1419[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field1409;
				field1409[var8] = true;
				var14[var7] = true;
				field1409[var6] = true;
				if (var10 >= var13) {
					field1419[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field1419[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field1409[var6] = false;
				field1419[var6] = var9;
			}
		}
		...
		var6 = 0;
		var7 = field1419[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field1409[var8]) {
				var9 = field1418[var8];
				var10 = field1419[var8] * this.multiplier;
				this.method2469(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
