...
public class VorbisFloor {
	...
	static {
		field387 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field394 = new int[var5];
			this.field394[0] = 0;
			this.field394[1] = 1 << var4;
			var5 = 2;
			...
			for (var6 = 0; var6 < var2; ++var6) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field394[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field389 == null || field389.length < var5) {
				field389 = new int[var5];
				field384 = new int[var5];
				field395 = new boolean[var5];
			}
	...
	@ObfuscatedName("o")
	int method782(int var1, int var2, int var3, int var4, int var5) {
		int var6 = var4 - var2;
		int var7 = var3 - var1;
	...
	@ObfuscatedName("g")
	void method780(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field389[var1];
			int var5 = field384[var1];
			boolean var6 = field395[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field389[var7];
				if (var8 < var4) {
					field389[var3] = var8;
					field384[var3] = field384[var7];
					field395[var3] = field395[var7];
					++var3;
					field389[var7] = field389[var3];
					field384[var7] = field384[var3];
					field395[var7] = field395[var3];
				}
			}
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field394.length;

			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				field389[var3] = this.field394[var3];
			}

			var3 = field387[this.multiplier - 1];
			int var4 = class10.iLog(var3 - 1);
			field384[0] = VorbisSample.readBits(var4);
			field384[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method1048();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field384[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method1048() : 0;
				}
			}
	...
	@ObfuscatedName("t")
	void method779(float[] var1, int var2) {
		int var3 = this.field394.length;
		int var4 = field387[this.multiplier - 1];
		boolean[] var5 = field395;
		field395[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method773(field389, var6);
			var8 = method774(field389, var6);
			var9 = this.method782(field389[var7], field384[var7], field389[var8], field384[var8], field389[var6]);
			var10 = field384[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field395;
				field395[var8] = true;
				var14[var7] = true;
				field395[var6] = true;
				if (var10 >= var13) {
					field384[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field384[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field395[var6] = false;
				field384[var6] = var9;
		...
		var6 = 0;
		var7 = field384[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field395[var8]) {
				var9 = field389[var8];
				var10 = field384[var8] * this.multiplier;
				this.method780(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
	...
	@ObfuscatedName("h")
	static int method773(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
