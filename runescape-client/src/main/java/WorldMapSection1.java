...
public class WorldMapSection1 implements WorldMapSection {
	...
	static final void method4839() {
		if (Decimator.FriendsChatManager_inFriendsChat) { // L: 3827
			if (PcmPlayer.friendsChatManager != null) { // L: 3828
				PcmPlayer.friendsChatManager.sort(); // L: 3829
			}
			...
			Decimator.FriendsChatManager_inFriendsChat = false; // L: 3837
		}
