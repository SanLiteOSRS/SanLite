...
public class WorldMapSection1 implements WorldMapSection {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.hintArrowType == 2) {
			MouseRecorder.worldToScreen((Client.hintArrowX - Messages.baseX * 64 << 7) + Client.hintArrowSubX * 4096, Client.hintArrowSubY * 64 + (Client.hintArrowY - Language.baseY * 64 << 7), Client.hintArrowHeight * 4);
