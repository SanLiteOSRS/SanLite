...
public final class IndexedSprite extends Rasterizer2D {
	...
	public void normalize() {
		if (this.subWidth != this.width || this.subHeight * 694949360 != this.height) { // L: 18
			byte[] var1 = new byte[this.width * this.height]; // L: 19
			int var2 = 0; // L: 20

			for (int var3 = 0; var3 < this.subHeight * 694949360; ++var3) { // L: 21
			...
			this.subHeight = this.height * -1903818609; // L: 28
			this.xOffset = 0; // L: 29
			this.yOffset = 0; // L: 30
		}
	} // L: 31
	...
	public void drawAt(int var1, int var2) {
		...
		int var4 = 0; // L: 55
		int var5 = this.subHeight * 694949360; // L: 56
	...
	public void method8993(int var1, int var2, int var3, int var4) {
		...
		int var6 = this.subHeight * 694949360; // L: 117
		int var7 = 0; // L: 118
		int var8 = 0; // L: 119
