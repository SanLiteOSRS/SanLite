...
public class UserComparator3 extends AbstractUserComparator {
	...
	static int method2607(int var0, Script var1, boolean var2) {
		...
		if (var0 >= 2000) {
			var0 -= 1000;
			var4 = class127.getWidget(Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
			var3 = false;
		} else {
		...
		if (var0 == ScriptOpcodes.CC_SETOP) {
			...
			if (var11 >= 0 && var11 <= 9) {
				var4.setAction(var11, Interpreter.Interpreter_stringStack[--class122.Interpreter_stringStackSize]);
				return 1;
			} else {
			...
			if (var0 == ScriptOpcodes.CC_SETDRAGGABLE) {
				...
				var4.parent = ItemComposition.getWidgetChild(var11, var6);
				return 1;
				...
				var4.dataText = Interpreter.Interpreter_stringStack[--class122.Interpreter_stringStackSize];
				return 1;
			} else if (var0 == ScriptOpcodes.CC_SETTARGETVERB) {
				var4.spellActionName = Interpreter.Interpreter_stringStack[--class122.Interpreter_stringStackSize];
				return 1;
				...
				if (var0 != ScriptOpcodes.CC_SETOPKEY) {
					...
					if (var0 == ScriptOpcodes.CC_SETOPTKEY) {
						...
						ArchiveDiskActionHandler.Widget_setKey(var4, var5, var8, var9);
						return 1;
						...
						if (var11 >= 0 && var11 <= 9) {
							EnumComposition.Widget_setKeyRate(var4, var11, var6, var7);
							return 1;
						} else {
						...
						EnumComposition.Widget_setKeyRate(var4, var5, var6, var7);
						return 1;
					} else if (var0 == ScriptOpcodes.CC_SETOPKEYIGNOREHELD) {
						--Interpreter.Interpreter_intStackSize;
						var11 = Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize] - 1;
						if (var11 >= 0 && var11 <= 9) {
							class67.Widget_setKeyIgnoreHeld(var4, var11);
							return 1;
						} else {
							throw new RuntimeException();
						}
						...
						var5 = 10;
						class67.Widget_setKeyIgnoreHeld(var4, var5);
						return 1;
					} else {
						return 2;
					}
					...
					if (var7 >= 0 && var7 <= 9) {
						ArchiveDiskActionHandler.Widget_setKey(var4, var7, var10, var8);
						return 1;
					} else {
						throw new RuntimeException();
					}
	...
	static final void updateItemPile(int var0, int var1) {
		NodeDeque var2 = Client.groundItems[class18.Client_plane][var0][var1];
		if (var2 == null) {
			ArchiveLoader.scene.removeGroundItemPile(class18.Client_plane, var0, var1);
		} else {
			long var3 = -99999999L;
			TileItem var5 = null;
			...
			for (var6 = (TileItem)var2.last(); var6 != null; var6 = (TileItem)var2.previous()) {
				ItemComposition var7 = class19.ItemComposition_get(var6.id);
			...
			if (var5 == null) {
				...
				long var9 = GameObject.calculateTag(var0, var1, 3, false, 0);
				ArchiveLoader.scene.newGroundItemPile(class18.Client_plane, var0, var1, WorldMapLabel.getTileHeight(var0 * 128 + 64, var1 * 128 + 64, class18.Client_plane), var5, var9, var13, var8);
			}
		}
	}
}
