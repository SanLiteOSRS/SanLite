...
public class WorldMapID {
	...
	static int method600(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) {
			...
			class234.addGameMessage(0, "", var3);
			return 1;
		} else if (var0 == ScriptOpcodes.ANIM) {
			VarcInt.Interpreter_intStackSize -= 2;
			Tiles.performPlayerAnimation(PlayerComposition.localPlayer, Interpreter.Interpreter_intStack[VarcInt.Interpreter_intStackSize], Interpreter.Interpreter_intStack[VarcInt.Interpreter_intStackSize + 1]);
			return 1;
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
				var10 = 0;
				if (ArchiveDiskAction.isNumber(var3)) {
					var10 = class279.parseInt(var3);
				}

				PacketBufferNode var12 = ItemContainer.getPacketBufferNode(ClientPacket.field2291, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
					var14 = ItemContainer.getPacketBufferNode(ClientPacket.field2245, Client.packetWriter.isaacCipher);
					...
					var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
					var14 = ItemContainer.getPacketBufferNode(ClientPacket.field2261, Client.packetWriter.isaacCipher);
					var14.packetBuffer.writeByte(var3.length() + 1);
					var14.packetBuffer.writeStringCp1252NullTerminated(var3);
					Client.packetWriter.addNode(var14);
					return 1;
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						FloorDecoration.method2931(var15, var7);
						return 1;
						...
						Widget var13 = CollisionMap.getWidget(var9);
						...
						var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize];
						boolean var4 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize] == 1;
						AttackOption.openURL(var3, var4, false);
						return 1;
					} else if (var0 == ScriptOpcodes.RESUME_OBJDIALOG) {
						var15 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize];
						var14 = ItemContainer.getPacketBufferNode(ClientPacket.field2250, Client.packetWriter.isaacCipher);
						...
						if (var7.length() > 500) {
							...
							var6.packetBuffer.writeShort(1 + FloorDecoration.stringCp1252NullTerminatedByteSize(var7) + FloorDecoration.stringCp1252NullTerminatedByteSize(var5));
						...
						if (var0 == ScriptOpcodes.SETHIDEUSERNAME) {
							...
							Timer.clientPreferences.hideUsername = var16;
							GrandExchangeOffer.savePreferences();
							return 1;
							...
							var16 = Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize] == 1;
							if (var16 == Timer.clientPreferences.titleMusicDisabled) {
								Timer.clientPreferences.titleMusicDisabled = !var16;
								GrandExchangeOffer.savePreferences();
							}
							...
							var15 = 100 - Math.min(Math.max(Interpreter.Interpreter_intStack[--VarcInt.Interpreter_intStackSize], 0), 100);
							WorldMapSection1.method626((double)((float)var15 / 200.0F + 0.5F));
							return 1;
						} else if (var0 == 3182) {
							float var8 = ((float)Timer.clientPreferences.field1057 - 0.5F) * 200.0F;
							Interpreter.Interpreter_intStack[++VarcInt.Interpreter_intStackSize - 1] = 100 - Math.round(var8);
							return 1;
						} else {
							return 2;
						}
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (PlayerComposition.localPlayer == var0 && (var0.x < 1536 || var0.y < 1536 || var0.x >= 11776 || var0.y >= 11776)) {
			var0.sequence = -1;
			var0.spotAnimation = -1;
			var0.field984 = 0;
			var0.field973 = 0;
		...
		if (var0.field940 != 0) {
			...
			var8 = var0.orientation - var0.rotation & 2047;
			if (var8 == 0 && var0.false0) {
				var0.targetIndex = -1;
				var0.false0 = false;
			}
			...
			if (var8 != 0) {
				...
				if (var8 > 1024) {
					...
					var10 = true;
					if (var8 < var0.field940 || var8 > 2048 - var0.field940) {
						var0.rotation = var0.orientation;
						var10 = false;
					}

					if (var0.readySequence == var0.movementSequence && (var0.field954 > 25 || var10)) {
					...
					if (var0.movementSequence == var0.readySequence && (var0.field954 > 25 || var10)) {
		...
		SceneTilePaint.method3154(var0);
	}
