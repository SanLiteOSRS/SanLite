...
public class LoginScreenAnimation {
	...
	final void method2292(int var1) {
		...
		if (this.field1224 * 359650093 > 0) { // L: 113
		...
		if (this.field1224 * 359650093 == 0 && this.field1225 * 16 == 0) { // L: 115
	...
	final void method2300(int var1) {
		...
		if (this.field1224 * 359650093 > 0) { // L: 165
			this.method2297(this.field1224 * 359650093, this.field1222); // L: 166
