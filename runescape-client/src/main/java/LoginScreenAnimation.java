...
public class LoginScreenAnimation {
	...
	final void method2255(int var1) {
		...
		if (this.field1175 * 16 > 0) {
			this.field1175 = this.field1175 * 16 - var1 * 4;
		}

		if (this.field1169 * 16 > 0) {
			this.field1169 = this.field1169 * 16 - var1 * 4;
		}

		if (this.field1175 * 16 == 0 && this.field1169 * 16 == 0) {
		...
		this.field1181 = this.field1181 * 10000 + var1 * 10000;
	...
	final void method2257(int var1) {
		...
		if (this.field1175 * 16 > 0) {
			this.method2258(this.field1175 * 16, this.field1174);
		} else if (this.field1169 * 16 > 0) {
			this.method2258(this.field1169 * 16, this.field1173);
		} else {
