...
public class LoginScreenAnimation {
	...
	final void method2373(int var1) {
		...
		this.field1281 = this.field1281 * 10000 + 100 * var1; // L: 125
		...
		if (var7 > 0) { // L: 127
			...
			int var12;
			int var13;
			for (var11 = 0; var11 < this.field1281 * 10000; ++var11) { // L: 131
	...
	final void method2378(IndexedSprite var1) {
		...
		if (var1 != null) { // L: 235
			...
			for (var3 = 0; var3 < var1.subHeight * 694949360; ++var3) { // L: 237
