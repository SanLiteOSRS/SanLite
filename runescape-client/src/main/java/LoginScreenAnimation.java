...
public class LoginScreenAnimation {
	...
	final void method2153(int var1) {
		...
		if (this.field1178 * 16 > 0) {
			this.field1178 = this.field1178 * 16 - var1 * 4;
		}

		if (this.field1169 * 16 == 0 && this.field1178 * 16 == 0) {
	...
	final void method2155(int var1) {
		...
		if (this.field1169 * 16 > 0) {
			this.method2171(this.field1169 * 16, this.field1175);
		} else if (this.field1178 * 16 > 0) {
			this.method2171(this.field1178 * 16, this.field1168);
		} else {
