...
public class LoginScreenAnimation {
	...
	final void method2195(int var1) {
		...
		if (this.field1202 * 16 > 0) {
			this.field1202 = this.field1202 * 16 - var1 * 4;
		}

		if (this.field1201 * 16 > 0) {
			this.field1201 = this.field1201 * 16 - var1 * 4;
		}

		if (this.field1202 * 16 == 0 && this.field1201 * 16 == 0) {
		...
		for (var7 = 256 - var1; var7 < 256; ++var7) {
			this.field1196[var7] = (int)(Math.sin((double)this.field1197 / 14.0D) * 16.0D + Math.sin((double)this.field1197 / 15.0D) * 14.0D + Math.sin((double)this.field1197 / 16.0D) * 12.0D);
			++this.field1197;
		}

		this.field1209 = this.field1209 * 10000 + var1 * 100;
		...
		if (var7 > 0) {
			...
			int var12;
			int var13;
			for (var11 = 0; var11 < this.field1209 * 10000; ++var11) {
	...
	final void method2222(int var1) {
		...
		if (this.field1202 * 16 > 0) {
			this.method2198(this.field1202 * 16, this.field1200);
		} else if (this.field1201 * 16 > 0) {
			this.method2198(this.field1201 * 16, this.field1207);
		} else {
	...
	final void method2200(IndexedSprite var1) {
		...
		for (var2 = 0; var2 < 5000; ++var2) {
			...
			this.field1205[var3] = (int)(Math.random() * 256.0D);
		}
