...
public class LoginScreenAnimation {
   ...
   void method1730() {
      ...
      for(var1 = 0; var1 < 64; ++var1) {
         this.field1014[var1 + 64] = var1 * 4 + '\uff00';
      }

      for(var1 = 0; var1 < 64; ++var1) {
         this.field1014[var1 + 128] = var1 * 262144 + '\uffff';
      }
   ...
   final void method1756(int var1) {
      ...
      this.field1023 = this.field1023 * 10000 + var1 * 100;
      ...
      if (var7 > 0) {
         ...
         int var12;
         int var13;
         for(var11 = 0; var11 < this.field1023 * 10000; ++var11) {
      ...
      for(int var3 = 1; var3 < 255; ++var3) {
         ...
         for(int var9 = var6; var9 < var7; ++var9) {
            ...
            if (var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart && var11 < Rasterizer2D.Rasterizer2D_xClipEnd) {
               ...
               SpotAnimationDefinition.rasterProvider.pixels[var8++] = -16777216 | ((var10 & 16711935) * var12 + (var14 & 16711935) * var13 & -16711936) + (var12 * (var10 & '\uff00') + var13 * (var14 & '\uff00') & 16711680) >> 8;
            } else {
               ++var8;
            }
         }
