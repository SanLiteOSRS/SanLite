...
public class LoginScreenAnimation {
	...
	final void method2187(int var1) {
		...
		if (this.field1198 * 16 > 0) {
			this.field1198 = this.field1198 * 16 - var1 * 4;
		}

		if (this.field1197 * 16 > 0) {
			this.field1197 = this.field1197 * 16 - var1 * 4;
		}

		if (this.field1198 * 16 == 0 && this.field1197 * 16 == 0) {
		...
		for (var7 = 256 - var1; var7 < 256; ++var7) {
			this.field1193[var7] = (int)(Math.sin((double)this.field1194 / 14.0D) * 16.0D + Math.sin((double)this.field1194 / 15.0D) * 14.0D + Math.sin((double)this.field1194 / 16.0D) * 12.0D);
			++this.field1194;
		}

		this.field1206 = this.field1206 * 10000 + var1 * 100;
		...
		if (var7 > 0) {
			...
			int var12;
			int var13;
			for (var11 = 0; var11 < this.field1206 * 10000; ++var11) {
	...
	final void method2209(int var1) {
		...
		if (this.field1198 * 16 > 0) {
			this.method2206(this.field1198 * 16, this.field1191);
		} else if (this.field1197 * 16 > 0) {
			this.method2206(this.field1197 * 16, this.field1208);
		} else {
