...
public class LoginScreenAnimation {
	...
	final void method1899(int var1) {
		...
		if (this.field1097 * 16 > 0) {
			this.field1097 = this.field1097 * 16 - var1 * 4;
		}

		if (this.field1098 * 16 > 0) {
			this.field1098 = this.field1098 * 16 - var1 * 4;
		}

		if (this.field1097 * 16 == 0 && this.field1098 * 16 == 0) {
		...
		this.field1087 = this.field1087 * 10000 + var1 * 100;
		...
		if (var7 > 0) {
			...
			int var12;
			int var13;
			for (var11 = 0; var11 < this.field1087 * 10000; ++var11) {
	...
	final void method1901(int var1) {
		...
		if (this.field1097 * 16 > 0) {
			this.method1902(this.field1097 * 16, this.field1095);
		} else if (this.field1098 * 16 > 0) {
			this.method1902(this.field1098 * 16, this.field1102);
		} else {
	...
	final void method1904(IndexedSprite var1) {
		...
		if (var1 != null) {
			...
			for (var3 = 0; var3 < var1.subHeight * -1478377216; ++var3) {
