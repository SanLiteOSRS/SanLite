...
public class LoginScreenAnimation {
	...
	final void method2222(int var1) {
		...
		if (this.field1217 * 16 > 0) {
			this.field1217 = this.field1217 * 16 - var1 * 4;
		}

		if (this.field1213 * 1552540857 > 0) {
			this.field1213 -= var1 * 981173796;
		}

		if (this.field1217 * 16 == 0 && this.field1213 * 1552540857 == 0) {
		...
		this.field1212 = this.field1212 * 10000 + 10000 * var1;
	...
	final void method2248(int var1) {
		...
		if (this.field1217 * 16 > 0) {
			this.method2225(this.field1217 * 16, this.field1215);
		} else if (this.field1213 * 1552540857 > 0) {
			this.method2225(this.field1213 * 1552540857, this.field1216);
		} else {
