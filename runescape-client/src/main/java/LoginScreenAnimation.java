...
public class LoginScreenAnimation {
	...
	final void method2346(int var1) {
		...
		if (this.field1231 * 16 > 0) { // L: 114
			this.field1231 = this.field1231 * 16 - var1 * 4;
		}

		if (this.field1226 * 16 == 0 && this.field1231 * 16 == 0) { // L: 115
	...
	final void method2374(int var1) {
		...
		} else if (this.field1231 * 16 > 0) { // L: 168
			this.method2348(this.field1231 * 16, this.field1221); // L: 169
		} else {
