...
public class LoginScreenAnimation {
	...
	final void method1930(int var1) {
		...
		this.field1058 = this.field1058 * 10000 + var1 * 10000;
		...
		if (var7 > 0) {
			...
			int var12;
			int var13;
			for (var11 = 0; var11 < this.field1058 * 100; ++var11) {
		...
		for (int var3 = 1; var3 < 255; ++var3) {
			...
			for (int var9 = var6; var9 < var7; ++var9) {
				...
				if (var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart && var11 < Rasterizer2D.Rasterizer2D_xClipEnd) {
					...
					FileSystem.rasterProvider.pixels[var8++] = -16777216 | (var12 * (var10 & 65280) + var13 * (var14 & 65280) & 16711680) + ((var10 & 16711935) * var12 + (var14 & 16711935) * var13 & -16711936) >> 8;
				} else {
					++var8;
				}
			}
