...
public class LoginScreenAnimation {
	...
	final void method1880(int var1) {
		...
		if (this.field1020 * 945230157 > 0) {
			this.field1020 -= var1 * 772423188;
		}

		if (this.field1030 * 16 == 0 && this.field1020 * 945230157 == 0) {
	...
	final int method1881(int var1, int var2, int var3) {
		int var4 = 256 - var3;
	...
	final void method1882(int var1) {
		...
		if (this.field1030 * 16 > 0) {
			this.method1883(this.field1030 * 16, this.field1010);
		} else if (this.field1020 * 945230157 > 0) {
			this.method1883(this.field1020 * 945230157, this.field1019);
		} else {
	...
	final void method1883(int var1, int[] var2) {
		int var3 = this.field1015.length;

		for (int var4 = 0; var4 < var3; ++var4) {
			if (var1 > 768) {
				this.field1015[var4] = this.method1881(this.field1016[var4], var2[var4], 1024 - var1);
			} else if (var1 > 256) {
				this.field1015[var4] = var2[var4];
			} else {
				this.field1015[var4] = this.method1881(var2[var4], this.field1016[var4], 256 - var1);
			}
		}
