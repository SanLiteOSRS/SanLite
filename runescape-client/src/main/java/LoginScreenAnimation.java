...
public class LoginScreenAnimation {
	...
	final void method1880(int var1) {
		...
		if (this.field1064 * 16 > 0) {
			this.field1064 = this.field1064 * 16 - var1 * 4;
		}

		if (this.field1066 * 16 == 0 && this.field1064 * 16 == 0) {
		...
		this.field1073 = this.field1073 * 10000 + var1 * 10000;
	...
	final void method1882(int var1) {
		...
		if (this.field1066 * 16 > 0) {
			this.method1886(this.field1066 * 16, this.field1061);
		} else if (this.field1064 * 16 > 0) {
			this.method1886(this.field1064 * 16, this.field1065);
		} else {
			...
			for (int var11 = 0; var11 < 64; ++var11) {
				for (int var12 = 0; var12 < 64; ++var12) {
					if (var10 == var4 && var11 >= var5 && var11 < var5 + 8 && var12 >= var6 && var12 < var6 + 8) {
						int var15 = var2 + SceneTilePaint.method3187(var11 & 7, var12 & 7, var7);
						int var18 = var11 & 7;
						int var19 = var12 & 7;
						int var20 = var7 & 3;
						int var17;
