...
public class LoginScreenAnimation {
	...
	final void method2502(int var1) {
		...
		if (this.field1266 * 16 > 0) { // L: 114
			this.field1266 = this.field1266 * 16 - var1 * 4;
		}

		if (this.field1269 * 16 == 0 && this.field1266 * 16 == 0) { // L: 115
	...
	final void method2504(int var1) {
		...
		} else if (this.field1266 * 16 > 0) { // L: 168
			this.method2505(this.field1266 * 16, this.field1264); // L: 169
		} else {
