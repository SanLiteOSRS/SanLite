...
public class class15 extends SSLSocketFactory {
	...
	public class15() {
		this.field68 = new SecureRandom(); // L: 43
	} // L: 46
	...
	public Socket createSocket(Socket var1, String var2, int var3, boolean var4) throws IOException {
		...
		TlsClientProtocol var5 = new TlsClientProtocol(var1.getInputStream(), var1.getOutputStream(), this.field68); // L: 56
		return this.method195(var2, var5); // L: 57
	}
