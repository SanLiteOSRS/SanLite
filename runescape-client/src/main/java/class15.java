...
public class class15 extends SSLSocketFactory {
	...
	class15() {
		this.field84 = new SecureRandom(); // L: 43
	} // L: 53
	...
	SSLSocket method188(String var1, TlsClientProtocol var2) {
	...
	public Socket createSocket(Socket var1, String var2, int var3, boolean var4) throws IOException {
		...
		TlsClientProtocol var5 = new TlsClientProtocol(var1.getInputStream(), var1.getOutputStream(), this.field84); // L: 63
		return this.method188(var2, var5); // L: 64
	}
	...
	public static class15 method190() {
		if (field83 == null) { // L: 47
			field83 = new class15(); // L: 48
		}
