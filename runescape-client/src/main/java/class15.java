...
public class class15 extends SSLSocketFactory {
	...
	public class15() {
		this.field67 = new SecureRandom(); // L: 43
	} // L: 46
	...
	SSLSocket method187(String var1, TlsClientProtocol var2) {
	...
	public Socket createSocket(Socket var1, String var2, int var3, boolean var4) throws IOException {
		...
		TlsClientProtocol var5 = new TlsClientProtocol(var1.getInputStream(), var1.getOutputStream(), this.field67); // L: 56
		return this.method187(var2, var5); // L: 57
	}
