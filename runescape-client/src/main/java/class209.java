...
public class class209 {
	...
	static {
		field2331 = new class209(0); // L: 4
		field2329 = new class209(1); // L: 5
		field2343 = new class209(2); // L: 6
		field2337 = new class209(3); // L: 7
		field2332 = new class209(4, class197.field2087); // L: 8
		field2333 = new class209(5); // L: 9
		field2328 = new class209(6, class197.field2088); // L: 10
		field2330 = new class209(7, class197.field2091); // L: 11
		field2335 = new class209(8, class197.field2093); // L: 12
		field2342 = new class209(9, class197.field2089); // L: 13
