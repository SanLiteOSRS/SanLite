...
public class class209 {
	...
	static {
		field2109 = new class209(0, class223.field2347); // L: 4
		field2106 = new class209(1, class223.field2348); // L: 5
		field2110 = new class209(2, class223.field2346); // L: 6
		field2108 = new class209(3, class223.field2354); // L: 7
		field2107 = new class209(4, class223.field2351); // L: 8
		field2105 = new class209(5, class223.field2349); // L: 9
		field2111 = new class209(6, class223.field2352); // L: 10
	}
	...
	static GameBuild[] method3850() {
		return new GameBuild[]{GameBuild.LIVE, GameBuild.BUILDLIVE, GameBuild.RC, GameBuild.WIP}; // L: 13
	}
	...
	public static boolean method3851(int var0) {
		return var0 == WorldMapDecorationType.field3879.id; // L: 51
	}
}
