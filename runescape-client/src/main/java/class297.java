...
public class class297 {
	...
	static final String formatItemStacks(int var0) {
		...
		if (var1.length() > 9) {
			...
			return var1.length() > 6 ? " " + WorldMapAreaData.colorStartTag(16777215) + var1.substring(0, var1.length() - 4) + "K" + " " + " (" + var1 + ")" + "</col>" : " " + WorldMapAreaData.colorStartTag(16776960) + var1 + "</col>";
		}
	}
}
