			...
			if (Client.minimapState != 2 && Client.minimapState != 5) {
				...
				for (var8 = 0; var8 < 104; ++var8) {
					for (var9 = 0; var9 < 104; ++var9) {
						NodeDeque var15 = Client.groundItems[ItemLayer.Client_plane][var8][var9];
						if (var15 != null) {
				...
				if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
					...
					if (Client.hintArrowType == 2) {
						var10 = Client.hintArrowX * 4 - class182.baseX * 256 + 2 - class60.localPlayer.x / 32;
						var11 = Client.hintArrowY * 4 - SecureRandomFuture.baseY * 256 + 2 - class60.localPlayer.y / 32;
