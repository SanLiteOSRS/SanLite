				...
				if (var0 == ScriptOpcodes.FROMDATE) { // L: 3263
					...
					if (var0 == ScriptOpcodes.TOSTRING) { // L: 3281
						...
						if (var0 == ScriptOpcodes.PARAHEIGHT) { // L: 3291
							...
							var11 = NameableContainer.archive13.takeFile(var5, 0); // L: 3296
							...
							var11 = NameableContainer.archive13.takeFile(var5, 0); // L: 3306
							...
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class168.isAlphaNumeric((char)var10) ? 1 : 0; // L: 3337
							return 1; // L: 3338
