		...
		if (var0 == ScriptOpcodes.CLIENTCLOCK) { // L: 2124
			...
			if (var0 == ScriptOpcodes.INV_GETOBJ) { // L: 2128
				...
				if (var0 == ScriptOpcodes.COORD) { // L: 2169
					...
					var4 = SecureRandomCallable.baseX * 64 + (ModelData0.localPlayer.x >> 7); // L: 2171
					var5 = GrandExchangeOfferOwnWorldComparator.baseY * 64 + (ModelData0.localPlayer.y >> 7); // L: 2172
