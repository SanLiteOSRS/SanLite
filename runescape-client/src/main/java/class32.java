   ...
   static final void method544(int var0, int var1, int var2, int var3, int var4, int var5, Scene var6, CollisionMap var7) {
      if (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var1][var2] & 2) != 0 || (Tiles.Tiles_renderFlags[var0][var1][var2] & 16) == 0) {
         ...
         if (var8.method4542()) {
            ...
            var22.field1049 = var0;
            var22.field1050 = var1 * 128;
            var22.field1048 = var2 * 16384;
            var23 = var8.sizeX;
            var24 = var8.sizeY;
            if (var4 == 1 || var4 == 3) {
               var23 = var8.sizeY;
            ...
            var22.soundEffectIds = var8.field3378;
         ...
         if (var5 == 22) {
            if (!Client.isLowDetail || var8.int1 != 0 || var8.interactType == 1 || var8.boolean2) {
               if (var8.animationId == -1 && var8.transforms == null) {
                  var34 = var8.method4504(22, var4, var15, var17, var16, var18);
               } else {
            ...
            if (var5 >= 12) {
               if (var8.animationId == -1 && var8.transforms == null) {
                  var34 = var8.method4504(var5, var4, var15, var17, var16, var18);
               } else {
               ...
               if (var8.interactType != 0 && var7 != null) {
                  var7.method3493(var1, var2, var9, var10, var8.boolean1);
               }

            } else if (var5 == 0) {
               if (var8.animationId == -1 && var8.transforms == null) {
                  var34 = var8.method4504(0, var4, var15, var17, var16, var18);
               } else {
               ...
               if (var8.animationId == -1 && var8.transforms == null) {
                  var34 = var8.method4504(1, var4, var15, var17, var16, var18);
               } else {
               ...
               if (var5 == 2) {
                  ...
                  Object var30;
                  if (var8.animationId == -1 && var8.transforms == null) {
                     var29 = var8.method4504(2, var4 + 4, var15, var17, var16, var18);
                     var30 = var8.method4504(2, var28, var15, var17, var16, var18);
                  } else {
                  ...
                  if (var8.animationId == -1 && var8.transforms == null) {
                     var34 = var8.method4504(3, var4, var15, var17, var16, var18);
                  } else {
                  ...
                  if (var8.animationId == -1 && var8.transforms == null) {
                     var34 = var8.method4504(4, var4, var15, var17, var16, var18);
                  } else {
                  ...
                  if (var5 == 5) {
                     ...
                     if (0L != var31) {
                        var28 = class215.getObjectDefinition(BoundaryObject.method3214(var31)).int2;
                     }

                     if (var8.animationId == -1 && var8.transforms == null) {
                        var33 = var8.method4504(4, var4, var15, var17, var16, var18);
                     } else {
                     ...
                     var31 = var6.getBoundaryObjectTag(var0, var1, var2);
                     if (var31 != 0L) {
                        var28 = class215.getObjectDefinition(BoundaryObject.method3214(var31)).int2 / 2;
                     }

                     if (var8.animationId == -1 && var8.transforms == null) {
                        var33 = var8.method4504(4, var4 + 4, var15, var17, var16, var18);
                     } else {
                     ...
                     var23 = var4 + 2 & 3;
                     if (var8.animationId == -1 && var8.transforms == null) {
                        var34 = var8.method4504(4, var23 + 4, var15, var17, var16, var18);
                     } else {
                     ...
                     if (var8.animationId == -1 && var8.transforms == null) {
                        var33 = var8.method4504(4, var4 + 4, var15, var17, var16, var18);
                        var26 = var8.method4504(4, var27 + 4, var15, var17, var16, var18);
                     } else {
                        var33 = new DynamicObject(var3, 4, var4 + 4, var0, var1, var2, var8.animationId, true, (Entity)null);
            ...
            if (var8.animationId == -1 && var8.transforms == null) {
               var34 = var8.method4504(10, var4, var15, var17, var16, var18);
            } else {
