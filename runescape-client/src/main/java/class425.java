...
public class class425 {
	...
	static void resumePauseWidget(int var0, int var1) {
		PacketBufferNode var2 = class120.getPacketBufferNode(ClientPacket.field3020, Client.packetWriter.isaacCipher); // L: 9262
		var2.packetBuffer.writeIntME(var1); // L: 9263
		var2.packetBuffer.method7972(var0); // L: 9264
