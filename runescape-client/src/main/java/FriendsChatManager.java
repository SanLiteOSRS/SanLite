...
public class FriendsChatManager extends NameableContainer
{
	...
	Nameable newInstance() {
		return new FriendsChatMember(); // L: 24
	}
	...
	Nameable[] newTypedArray(int var1) {
		return new FriendsChatMember[var1]; // L: 28
	}
	...
	public final void readUpdate(Buffer var1) {
		...
		if (var4 != 255) { // L: 87
			...
			for (int var5 = 0; var5 < var4; ++var5) { // L: 89
				FriendsChatMember var6 = (FriendsChatMember)this.addLastNoPreviousUsername(new Username(var1.readStringCp1252NullTerminated(), this.loginType)); // L: 90
	...
	public final void method5653(Buffer var1) {
		...
		if (var5) { // L: 105
			...
			var6 = (FriendsChatMember)this.getByCurrentUsername(var2); // L: 107
			if (var6 != null && var6.getWorld() == var3) { // L: 108
				this.remove(var6); // L: 109
			}
		} else {
			var1.readStringCp1252NullTerminated(); // L: 113
			var6 = (FriendsChatMember)this.getByCurrentUsername(var2); // L: 114
			if (var6 == null) { // L: 115
				if (this.getSize() > super.capacity) { // L: 116
					return;
				}

				var6 = (FriendsChatMember)this.addLastNoPreviousUsername(var2); // L: 117
			}
	...
	public final void clearFriends() {
		for (int var1 = 0; var1 < this.getSize(); ++var1) { // L: 126
			((FriendsChatMember)this.get(var1)).clearIsFriend(); // L: 127
		}
	...
	public final void invalidateIgnoreds() {
		for (int var1 = 0; var1 < this.getSize(); ++var1) { // L: 132
			((FriendsChatMember)this.get(var1)).clearIsIgnored(); // L: 133
		}
