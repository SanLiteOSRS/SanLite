...
public class FriendsChatManager extends NameableContainer {
	...
	public final void readUpdate(Buffer var1) {
		...
		if (var4 != 255) { // L: 60
			...
			for (int var5 = 0; var5 < var4; ++var5) { // L: 62
				FriendsChatMember var6 = (FriendsChatMember)this.addLastNoPreviousUsername(new Username(var1.readStringCp1252NullTerminated(), this.loginType)); // L: 63
	...
	public final void method6463(Buffer var1) {
		...
		if (var5) { // L: 78
			...
			var6 = (FriendsChatMember)this.getByCurrentUsername(var2); // L: 80
			if (var6 != null && var6.getWorld() == var3) { // L: 81
				this.remove(var6); // L: 82
			}
		} else {
			var1.readStringCp1252NullTerminated(); // L: 86
			var6 = (FriendsChatMember)this.getByCurrentUsername(var2); // L: 87
			if (var6 == null) { // L: 88
				if (this.getSize() > super.capacity) { // L: 89
					return;
				}

				var6 = (FriendsChatMember)this.addLastNoPreviousUsername(var2); // L: 90
			}
	...
	public final void clearFriends() {
		for (int var1 = 0; var1 < this.getSize(); ++var1) { // L: 99
			((FriendsChatMember)this.get(var1)).clearIsFriend(); // L: 100
		}
	...
	public final void invalidateIgnoreds() {
		for (int var1 = 0; var1 < this.getSize(); ++var1) { // L: 105
			((FriendsChatMember)this.get(var1)).clearIsIgnored(); // L: 106
		}
