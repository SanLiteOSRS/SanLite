...
public class class229 implements WorldMapSection {
	...
	public int[] getBorderTileLengths(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) {
			...
			int[] var4 = new int[]{this.field2737 * 64 - this.field2733 * 64 + var2 + (this.field2741 * 8 - this.field2739 * 8), var3 + (this.field2743 * 64 - this.field2738 * 64) + (this.field2742 * 8 - this.field2740 * 8)};
			return var4;
		}
	}
	...
	public Coord coord(int var1, int var2) {
		if (!this.containsPosition(var1, var2)) {
			...
			int var4 = this.field2738 * 64 - this.field2743 * 64 + var2 + (this.field2740 * 8 - this.field2742 * 8);
