...
public class class229 implements WorldMapSection {
	...
	public static class437 method5021(int var0) {
		class437 var1 = (class437)class437.DBTableType_cache.get((long)var0); // L: 23
		if (var1 != null) { // L: 24
			return var1;
		} else {
			byte[] var2 = class437.field4708.takeFile(39, var0); // L: 25
			var1 = new class437(); // L: 26
			if (var2 != null) { // L: 27
				var1.method7808(new Buffer(var2));
			}

			var1.method7809(); // L: 28
			class437.DBTableType_cache.put(var1, (long)var0); // L: 29
			return var1; // L: 30
		}
	}
