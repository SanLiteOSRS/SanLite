...
public class class229 implements WorldMapSection {
	...
	public int[] getBorderTileLengths(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) { // L: 43
			...
			int[] var4 = new int[]{this.field2797 * 64 - this.field2795 * 64 + var2 + (this.field2801 * 8 - this.field2799 * 8), var3 + (this.field2794 * 64 - this.field2793 * 64) + (this.field2802 * 8 - this.field2800 * 8)}; // L: 46 47 48
			return var4; // L: 49
		}
	}
	...
	public Coord coord(int var1, int var2) {
		if (!this.containsPosition(var1, var2)) { // L: 54
			...
			int var4 = this.field2793 * 64 - this.field2794 * 64 + var2 + (this.field2800 * 8 - this.field2802 * 8); // L: 58
