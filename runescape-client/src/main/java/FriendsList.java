...
public class FriendsList extends UserList {
   ...
   static void performPlayerAnimation(Player var0, int var1, int var2) {
      if (var0.sequence == var1 && var1 != -1) {
         int var3 = Widget.getSequenceDefinition(var1).field3492;
         if (var3 == 1) {
      ...
      } else if (var1 == -1 || var0.sequence == -1 || Widget.getSequenceDefinition(var1).field3508 >= Widget.getSequenceDefinition(var0.sequence).field3508) {
         var0.sequence = var1;
         var0.sequenceFrame = 0;
         var0.sequenceFrameCycle = 0;
         var0.sequenceDelay = var2;
