...
public class FriendsList extends NameableContainer {
	...
	static void method6449(int var0, Coord var1, boolean var2) {
		...
		int var5 = SecureRandomCallable.baseX * 64 + (ModelData0.localPlayer.x >> 7); // L: 4739
		int var6 = GrandExchangeOfferOwnWorldComparator.baseY * 64 + (ModelData0.localPlayer.y >> 7); // L: 4740
