...
public class FriendsList extends NameableContainer {
			...
			if (var1.offset < var2) { // L: 40
				...
				if (var4 != null && var4.hasCleanName()) { // L: 55
					...
					if (var6 != var11.world) { // L: 91
						var11.int2 = ++this.field4457 - 1; // L: 92
					...
					var11.field4472 = var9; // L: 97
					var11.field4473 = var10; // L: 98
					continue; // L: 99
				}
	...
	public static SpritePixels SpriteBuffer_getSprite(AbstractArchive var0, int var1, int var2) {
		byte[] var4 = var0.takeFile(var1, var2); // L: 105
		boolean var3;
		if (var4 == null) { // L: 106
			var3 = false; // L: 107
		} else {
			class335.SpriteBuffer_decode(var4); // L: 110
			var3 = true; // L: 111
		}

		return !var3 ? null : class31.method466(); // L: 113 114
	}
}
