...
public class class334 {
	...
	static {
		...
		for (var0 = 0; var0 < field4054.length; ++var0) {
			field4054[var0] = -1;
		}
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.field1157 >= Client.cycle) {
			...
			var3 = var0.field1153 * 128 + var0.field1113 * 64;
			var4 = var0.field1144 * 128 + var0.field1113 * 64;
			...
			if (var0.field1158 == Client.cycle || var0.sequence == -1 || var0.sequenceDelay != 0 || var0.sequenceFrameCycle + 1 > class78.SequenceDefinition_get(var0.sequence).frameLengths[var0.sequenceFrame]) {
				...
				var4 = var0.field1153 * 128 + var0.field1113 * 64;
				int var5 = var0.field1144 * 128 + var0.field1113 * 64;
				int var6 = var0.field1147 * 128 + var0.field1113 * 64;
				int var7 = var0.field1156 * 128 + var0.field1113 * 64;
		...
		if (var0.field1170 != 0) {
			...
			if (var2 != 0) {
				...
				boolean var10;
				if (var2 > 1024) {
					var0.rotation -= var0.field1139 ? var2 : var0.field1170;
					var10 = true;
