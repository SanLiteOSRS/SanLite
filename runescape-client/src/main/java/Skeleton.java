...
public class Skeleton extends Node {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.hintArrowType == 2) { // L: 4985
			Decimator.worldToScreen((Client.field527 - class213.baseX * 64 << 7) + Client.field530 * 4096, (Client.field697 - class101.baseY * 64 << 7) + Client.field531 * 4096, Client.field529 * 2); // L: 4986
