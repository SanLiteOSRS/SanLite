...
final class class309 implements Callable {
	...
	class309(PriorityQueue var1, AtomicBoolean var2) {
		this.val$waves = var1; // L: 109
		this.val$cancelled = var2;
	}

	public Object call() {
		while (!this.val$waves.isEmpty() && !this.val$cancelled.get()) { // L: 112
			((class310)this.val$waves.peek()).field3456.method1039(); // L: 113
			this.val$waves.remove(); // L: 114
		}
	...
	static void sortWorldList(int var0, boolean var1, int var2, boolean var3) {
		if (World.World_worlds != null) { // L: 171
			ViewportMouse.doWorldSorting(0, World.World_worlds.length - 1, var0, var1, var2, var3); // L: 172
		}
