...
public class SpotAnimationDefinition extends DualNode {
   ...
   void decodeNext(Buffer var1, int var2) {
      if (var2 == 1) {
         ...
         this.field3221 = var1.readUnsignedByte();
      } else if (var2 == 8) {
         this.field3233 = var1.readUnsignedByte();
      } else {
         int var3;
         int var4;
         if (var2 == 40) {
   ...
   public final Model getModel(int var1) {
      ...
      if (var2 == null) {
         ModelData var3 = ModelData.method2703(SpotAnimationDefinition_modelArchive, this.archive, 0);
         if (var3 == null) {
            return null;
         }
         ...
         var2 = var3.toModel(this.field3221 + 64, this.field3233 + 850, -30, -50, -30);
         SpotAnimationDefinition_cachedModels.put(var2, (long)this.id);
      }

      Model var5;
      if (this.sequence != -1 && var1 != -1) {
         var5 = Widget.getSequenceDefinition(this.sequence).transformSpotAnimationModel(var2, var1);
      } else {
