...
public class IterableNodeDeque implements Iterable, Collection {
	...
	@Export("last")
	public Node last() {
		return this.method6163((Node)null); // L: 46
	}
	...
	Node method6163(Node var1) {
		...
		if (var2 == this.sentinel) { // L: 54
			this.field4150 = null; // L: 55
			return null; // L: 56
		} else {
			this.field4150 = var2.previous; // L: 58
			return var2; // L: 59
		}
	}
	...
	public Node previous() {
		Node var1 = this.field4150; // L: 64
		if (var1 == this.sentinel) { // L: 65
			this.field4150 = null; // L: 66
			return null; // L: 67
		} else {
			this.field4150 = var1.previous; // L: 69
			return var1; // L: 70
		}
	}
	...
	Node[] method6166() {
		Node[] var1 = new Node[this.method6191()]; // L: 88
		int var2 = 0; // L: 89
	...
	public int size() {
		return this.method6191(); // L: 104
	}

	public boolean isEmpty() {
		return this.method6165(); // L: 109
	}
	...
	public boolean add(Object var1) {
		return this.method6168((Node)var1); // L: 170
	}
