...
public abstract class UrlRequester implements Runnable {
	...
	static final void doCheat(String var0) {
		...
		PacketBufferNode var1 = DecorativeObject.getPacketBufferNode(ClientPacket.field2988, Client.packetWriter.isaacCipher); // L: 3915
	...
	static final void method2536(PendingSpawn var0) {
		...
		if (var0.type == 3) {
			var1 = class175.scene.getGroundObjectTag(var0.plane, var0.x, var0.y); // L: 7860
		}
