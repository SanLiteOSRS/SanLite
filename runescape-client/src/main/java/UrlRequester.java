...
public class UrlRequester implements Runnable {
	...
	public static void method3381(boolean var0) {
	...
	static void method3383(Font var0, Font var1) {
		int var4;
		int var5;
		...
		if (JagexCache.worldSelectFlagSprites == null) {
			JagexCache.worldSelectFlagSprites = PlayerAppearance.method4107(GrandExchangeOfferUnitPriceComparator.archive8, "sl_flags", "");
		}

		if (StudioGame.worldSelectArrows == null) {
			StudioGame.worldSelectArrows = PlayerAppearance.method4107(GrandExchangeOfferUnitPriceComparator.archive8, "sl_arrows", "");
		}

		if (Interpreter.worldSelectStars == null) {
			Interpreter.worldSelectStars = PlayerAppearance.method4107(GrandExchangeOfferUnitPriceComparator.archive8, "sl_stars", "");
		}
	...
	static final void method3384(int var0, int var1, int var2, int var3, int var4, int var5) {
		int var6 = var2 - var0;
		int var7 = var3 - var1;
		...
		if (var10 != 0) {
			...
			Rasterizer3D.method3087(var21, var22, var23, var17, var18, var19, var4);
			Rasterizer3D.method3078(var17, var19, var20);
			Rasterizer3D.method3087(var21, var23, var24, var17, var19, var20, var4);
		}
	}
}
