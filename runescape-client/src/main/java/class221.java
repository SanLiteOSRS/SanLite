...
public class class221 implements WorldMapSection {
	...
	public int[] getBorderTileLengths(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) {
			...
			int[] var4 = new int[]{this.field2688 * 64 - this.field2681 * 64 + var2 + (this.field2686 * 8 - this.field2685 * 8), var3 + (this.field2684 * 64 - this.field2679 * 64) + (this.field2682 * 8 - this.field2683 * 8)};
			return var4;
		}
	}
	...
	public Coord coord(int var1, int var2) {
		if (!this.containsPosition(var1, var2)) {
			...
			int var4 = this.field2679 * 64 - this.field2684 * 64 + var2 + (this.field2683 * 8 - this.field2682 * 8);
