	...
	static final void method4531(class263 var0) {
		...
		if (class263.field3013 == var0) {
			...
			if (var8 >= 0 && var9 >= 0 && var8 < 103 && var9 < 103) {
				if (var6 == 0) {
					WallObject var34 = FriendSystem.scene.method4150(class160.Client_plane, var8, var9);
					if (var34 != null) {
				...
				if (var6 == 1) {
					DecorativeObject var44 = FriendSystem.scene.method4224(class160.Client_plane, var8, var9);
					if (var44 != null) {
				...
				if (var6 == 3) {
					GroundObject var46 = FriendSystem.scene.getGroundObject(class160.Client_plane, var8, var9);
					if (var46 != null) {
				...
				if (class263.field3009 == var0) {
					...
					if (var17 != null) {
						...
						if (var29 != null) {
							...
							var17.model0 = var29;
							var17.field1084 = var14 * 128 + var19 * 64;
							var17.field1095 = var15 * 128 + var20 * 64;
