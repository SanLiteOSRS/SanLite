...
public class class21 {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.hintArrowType == 2) { // L: 4655
			Skeleton.worldToScreen(Client.field723 * 64 + (Client.hintArrowX - class26.baseX * 64 << 7), Client.field541 * 64 + (Client.hintArrowY - class158.baseY * 64 << 7), Client.field770 * 2); // L: 4656
