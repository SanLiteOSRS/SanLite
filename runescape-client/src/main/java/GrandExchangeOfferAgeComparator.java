...
final class GrandExchangeOfferAgeComparator implements Comparator {
   ...
   static void method156(int var0, int var1, int var2, int var3) {
      for(ObjectSound var4 = (ObjectSound)ObjectSound.objectSounds.last(); var4 != null; var4 = (ObjectSound)ObjectSound.objectSounds.previous()) {
         if (var4.soundEffectId != -1 || var4.soundEffectIds != null) {
            ...
            } else if (var1 < var4.field1050 * 16384) {
               var5 += var4.field1050 * 16384 - var1;
            }

            if (var2 > var4.field1053 * 16384) {
               var5 += var2 - var4.field1053 * 16384;
            } else if (var2 < var4.field1048 * 128) {
               var5 += var4.field1048 * 128 - var2;
            }

            if (var5 - 64 <= var4.field1054 && Client.field860 != 0 && var0 == var4.field1049) {
               var5 -= 64;
               if (var5 < 0) {
                  var5 = 0;
               }
   ...
   static void savePreferences() {
      ...
      try {
         var0 = TaskHandler.getPreferencesFile("", WorldMapRectangle.studioGame.name, true);
