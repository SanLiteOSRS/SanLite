			...
			if (var0 == ScriptOpcodes.APPEND) {
				...
				if (var0 == ScriptOpcodes.FROMDATE) {
					...
					if (var0 == ScriptOpcodes.TOSTRING) {
						...
						WorldMapDecoration.Interpreter_stringStackSize -= 2;
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class326.method6313(ArchiveDiskAction.compareStrings(Interpreter.Interpreter_stringStack[WorldMapDecoration.Interpreter_stringStackSize], Interpreter.Interpreter_stringStack[WorldMapDecoration.Interpreter_stringStackSize + 1], WorldMapSection1.clientLanguage));
						return 1;
					} else {
						int var5;
						byte[] var13;
