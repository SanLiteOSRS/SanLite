		...
		if (var0 != null && var0.isVisible() && !var0.isHidden) {
			...
			if (var2 >= 0 && var2 < 104 && var3 >= 0 && var3 < 104) {
				...
				if (var0.model0 != null && Client.cycle >= var0.animationCycleStart && Client.cycle < var0.animationCycleEnd) {
					var0.isUnanimated = false;
					var0.tileHeight = Language.getTileHeight(var0.x, var0.y, ItemLayer.Client_plane);
					var0.playerCycle = Client.cycle;
					UserComparator3.scene.addNullableObject(ItemLayer.Client_plane, var0.x, var0.y, var0.tileHeight, 60, var0, var0.rotation, var4, var0.field648, var0.field649, var0.field650, var0.field651);
				} else {
					...
					var0.tileHeight = Language.getTileHeight(var0.x, var0.y, ItemLayer.Client_plane);
					var0.playerCycle = Client.cycle;
					UserComparator3.scene.drawEntity(ItemLayer.Client_plane, var0.x, var0.y, var0.tileHeight, 60, var0, var0.rotation, var4, var0.isWalking);
				}
			}
		}
	...
	static final void updateInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		for (int var8 = 0; var8 < var0.length; ++var8) {
			...
			if (var9 != null && var9.parentId == var1 && (!var9.isIf3 || var9.type == 0 || var9.hasListener || KeyHandler.getWidgetClickMask(var9) != 0 || var9 == Client.clickedWidgetParent || var9.contentType == 1338)) {
				if (var9.isIf3) {
					if (Renderable.isComponentHidden(var9)) {
						continue;
					}
				} else if (var9.type == 0 && var9 != WorldMapSection1.mousedOverWidgetIf1 && Renderable.isComponentHidden(var9)) {
					continue;
				}
