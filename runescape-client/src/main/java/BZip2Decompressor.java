...
public final class BZip2Decompressor {
	...
	public static int BZip2Decompressor_decompress(byte[] var0, int var1, byte[] var2, int var3, int var4) {
		synchronized(BZip2Decompressor_state) { // L: 20
			...
			BZip2Decompressor_state.field5251 = 0; // L: 29
	...
	static void method9530(BZip2State var0) {
		...
		int var13 = var0.field5251; // L: 133
		var0.field5251 += var10 - var10; // L: 134
		if (var0.field5251 < var13) { // L: 135
		}
		...
		class163.BZip2Decompressor_block = var6; // L: 140
		var0.field5270 = var7; // L: 141
	...
	static void BZip2Decompressor_decompress(BZip2State var0) {
		...
		if (class163.BZip2Decompressor_block == null) { // L: 174
			class163.BZip2Decompressor_block = new int[var0.blockSize100k * 100000];
		}
				...
				while (true) {
					...
					while (var46 != var42) { // L: 302
						if (var46 != 0 && var46 != 1) { // L: 303
							...
							class163.BZip2Decompressor_block[var47] = var0.seqToUnseq[var1 & 255] & 255; // L: 397
							++var47; // L: 398
							if (var45 == 0) { // L: 399
								++var43; // L: 400
								var45 = 50; // L: 401
							...
							for (var10000[var1 & 255] += var48; var48 > 0; --var48) { // L: 333 336
								class163.BZip2Decompressor_block[var47] = var1 & 255; // L: 334
								++var47; // L: 335
							}
						}
					}
					...
					for (var36 = 0; var36 < var47; ++var36) { // L: 426
						var1 = (byte)(class163.BZip2Decompressor_block[var36] & 255); // L: 427
						var10000 = class163.BZip2Decompressor_block; // L: 428
						int var10001 = var0.cftab[var1 & 255];
						var10000[var10001] |= var36 << 8;
						var10002 = var0.cftab[var1 & 255]++; // L: 429
					}

					var0.field5270 = class163.BZip2Decompressor_block[var0.originalPointer] >> 8; // L: 431
					var0.nblocks_used = 0; // L: 432
					var0.field5270 = class163.BZip2Decompressor_block[var0.field5270]; // L: 433
					var0.su_ch2 = (byte)(var0.field5270 & 255); // L: 434
					var0.field5270 >>= 8; // L: 436
					++var0.nblocks_used; // L: 437
					var0.field5246 = var47; // L: 438
					method9530(var0); // L: 439
					if (var0.field5246 + 1 == var0.nblocks_used && var0.su_rNToGo == 0) { // L: 440
						var26 = true;
						break;
					}
