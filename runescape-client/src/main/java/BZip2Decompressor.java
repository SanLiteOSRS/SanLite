...
public final class BZip2Decompressor {
	...
	static void method5845(BZip2State var0) {
		...
		int[] var6 = ItemLayer.BZip2Decompressor_block;
		...
		var0.su_ch2 = var5;
		ItemLayer.BZip2Decompressor_block = var6;
		var0.field3779 = var7;
	...
	static void BZip2Decompressor_decompress(BZip2State var0) {
		...
		if (ItemLayer.BZip2Decompressor_block == null) {
			ItemLayer.BZip2Decompressor_block = new int[var0.blockSize100k * 100000];
		}
				...
				while (true) {
					...
					while (var46 != var42) {
						if (var46 != 0 && var46 != 1) {
							...
							ItemLayer.BZip2Decompressor_block[var47] = var0.seqToUnseq[var1 & 255] & 255;
							++var47;
							if (var45 == 0) {
								++var43;
								var45 = 50;
							...
							for (var10000[var1 & 255] += var48; var48 > 0; --var48) {
								ItemLayer.BZip2Decompressor_block[var47] = var1 & 255;
								++var47;
							}
						}
					}
					...
					for (var36 = 0; var36 < var47; ++var36) {
						var1 = (byte)(ItemLayer.BZip2Decompressor_block[var36] & 255);
						var10000 = ItemLayer.BZip2Decompressor_block;
						int var10001 = var0.cftab[var1 & 255];
						var10000[var10001] |= var36 << 8;
						var10002 = var0.cftab[var1 & 255]++;
					}

					var0.field3779 = ItemLayer.BZip2Decompressor_block[var0.originalPointer] >> 8;
					var0.nblocks_used = 0;
					var0.field3779 = ItemLayer.BZip2Decompressor_block[var0.field3779];
