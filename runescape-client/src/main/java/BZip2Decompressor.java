...
public final class BZip2Decompressor {
	...
	static void method6788(BZip2State var0) {
		...
		int[] var6 = class375.BZip2Decompressor_block;
		int var7 = var0.field4195;
		byte[] var8 = var0.outputArray;
		int var9 = var0.next_out;
		int var10 = var0.outputLength;
		int var12 = var0.field4174 + 1;
		...
		int var13 = var0.field4177;
		var0.field4177 += var10 - var10;
		if (var0.field4177 < var13) {
		}
		...
		var0.su_ch2 = var5;
		class375.BZip2Decompressor_block = var6;
		var0.field4195 = var7;
	...
	static void BZip2Decompressor_decompress(BZip2State var0) {
		...
		if (class375.BZip2Decompressor_block == null) {
			class375.BZip2Decompressor_block = new int[var0.blockSize100k * 100000];
		}
				...
				while (true) {
					...
					while (var46 != var42) {
						if (var46 != 0 && var46 != 1) {
							...
							class375.BZip2Decompressor_block[var47] = var0.seqToUnseq[var1 & 255] & 255;
							++var47;
							if (var45 == 0) {
								++var43;
								var45 = 50;
							...
							for (var10000[var1 & 255] += var48; var48 > 0; --var48) {
								class375.BZip2Decompressor_block[var47] = var1 & 255;
								++var47;
							}
						}
					}
					...
					for (var36 = 0; var36 < var47; ++var36) {
						var1 = (byte)(class375.BZip2Decompressor_block[var36] & 255);
						var10000 = class375.BZip2Decompressor_block;
