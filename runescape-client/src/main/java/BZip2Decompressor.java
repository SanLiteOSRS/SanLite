...
public final class BZip2Decompressor {
	...
	public static int BZip2Decompressor_decompress(byte[] var0, int var1, byte[] var2, int var3, int var4) {
		synchronized(BZip2Decompressor_state) {
			...
			BZip2Decompressor_state.field4175 = 0;
	...
	static void method6862(BZip2State var0) {
		...
		int var13 = var0.field4175;
		var0.field4175 += var10 - var10;
		if (var0.field4175 < var13) {
		}
		...
		while (true) {
			while (var26) {
				...
				while (true) {
					...
					var0.field4182 = BZip2State.BZip2Decompressor_block[var0.originalPointer] >> 8;
					var0.nblocks_used = 0;
					var0.field4182 = BZip2State.BZip2Decompressor_block[var0.field4182];
					var0.su_ch2 = (byte)(var0.field4182 & 255);
					var0.field4182 >>= 8;
					++var0.nblocks_used;
					var0.field4201 = var47;
					method6862(var0);
					if (var0.field4201 + 1 == var0.nblocks_used && var0.su_rNToGo == 0) {
						var26 = true;
						break;
					}
