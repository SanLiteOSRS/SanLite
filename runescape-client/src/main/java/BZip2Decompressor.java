...
public final class BZip2Decompressor {
	...
	public static int BZip2Decompressor_decompress(byte[] var0, int var1, byte[] var2, int var3, int var4) {
		synchronized(BZip2Decompressor_state) { // L: 20
			...
			BZip2Decompressor_state.field5217 = 0; // L: 29
	...
	static void method9719(BZip2State var0) {
		...
		int var13 = var0.field5217; // L: 133
		var0.field5217 += var10 - var10; // L: 134
		if (var0.field5217 < var13) { // L: 135
		}
		...
		while (true) {
			while (var26) {
				...
				while (true) {
					...
					var0.field5224 = BZip2State.BZip2Decompressor_block[var0.originalPointer] >> 8; // L: 431
					var0.nblocks_used = 0; // L: 432
					var0.field5224 = BZip2State.BZip2Decompressor_block[var0.field5224]; // L: 433
					var0.su_ch2 = (byte)(var0.field5224 & 255); // L: 434
					var0.field5224 >>= 8; // L: 436
					++var0.nblocks_used; // L: 437
					var0.field5243 = var47; // L: 438
					method9719(var0); // L: 439
					if (var0.field5243 + 1 == var0.nblocks_used && var0.su_rNToGo == 0) { // L: 440
						var26 = true;
						break;
					}
