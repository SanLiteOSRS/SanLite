...
public final class class371 {
	...
	float[] method6675() {
		...
		if ((double)this.field4241[2] < 0.999D && (double)this.field4241[2] > -0.999D) {
			...
			var1[0] = 0.0F;
			var1[1] = (float)Math.atan2((double)this.field4241[2], 0.0D);
	...
	static final void method6674(int var0, int var1) {
		if (Client.hintArrowType == 2) {
			class148.worldToScreen((Client.hintArrowX - Canvas.baseX * 64 << 7) + Client.hintArrowSubX * 4096, Client.hintArrowSubY * 64 + (Client.hintArrowY - class118.baseY * 64 << 7), Client.hintArrowHeight * 2);
