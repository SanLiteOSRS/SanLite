...
public class SoundSystem implements Runnable {
	...
	static final void method813(class264 var0) {
		...
		if (class264.field3046 == var0) { // L: 7364
			...
			var3 = var1.method7954() * 4; // L: 7366
			var4 = var1.method7960(); // L: 7367
			var5 = var1.method7954(); // L: 7368
			var6 = var1.method7954(); // L: 7369
			var7 = (var6 >> 4 & 7) + class392.field4456; // L: 7370
			var38 = (var6 & 7) + ItemComposition.field2163; // L: 7371
			var39 = var1.method8023(); // L: 7372
			byte var40 = var1.readByte(); // L: 7373
			var11 = var1.method7965(); // L: 7374
			var12 = var1.readUnsignedShort(); // L: 7375
			var13 = var1.readShort(); // L: 7376
			var14 = var1.method7955() * 4; // L: 7377
			...
			if (class264.field3054 == var0) { // L: 7391
				...
				var3 = var1.method7965(); // L: 7393
				var4 = var1.method7960(); // L: 7394
				var5 = var1.method8023(); // L: 7395
				var6 = (var5 >> 4 & 7) + class392.field4456; // L: 7396
				var7 = (var5 & 7) + ItemComposition.field2163; // L: 7397
				byte var8 = var1.method7960(); // L: 7398
				byte var9 = var1.method7975(); // L: 7399
				var10 = var1.method7955(); // L: 7400
				var11 = var10 >> 2; // L: 7401
				var12 = var10 & 3; // L: 7402
				var13 = Client.field564[var11]; // L: 7403
				var14 = var1.method7964(); // L: 7404
				byte var15 = var1.method7970(); // L: 7405
				int var16 = var1.method7964(); // L: 7406
				Player var17;
			...
			if (class264.field3049 == var0) { // L: 7456
				var2 = var1.method7965(); // L: 7457
				var3 = var1.method8023(); // L: 7458
				...
				var6 = var1.method7965(); // L: 7506
				var7 = var1.method7955(); // L: 7507
				...
				if (class264.field3051 == var0) { // L: 7538
					var2 = var1.method7954(); // L: 7539
					var3 = var2 >> 2; // L: 7540
					var37 = var2 & 3; // L: 7541
					var5 = Client.field564[var3]; // L: 7542
					var6 = var1.method7955(); // L: 7543
					var7 = (var6 >> 4 & 7) + class392.field4456; // L: 7544
					var38 = (var6 & 7) + ItemComposition.field2163; // L: 7545
					var39 = var1.method7964(); // L: 7546
					if (var7 >= 0 && var38 >= 0 && var7 < 103 && var38 < 103) { // L: 7547
						if (var5 == 0) { // L: 7548
							WallObject var33 = MusicPatchNode.scene.method4281(Tiles.Client_plane, var7, var38); // L: 7549
						...
						if (var5 == 1) { // L: 7559
							DecorativeObject var44 = MusicPatchNode.scene.method4282(Tiles.Client_plane, var7, var38); // L: 7560
						...
						if (var5 == 3) { // L: 7577
							GroundObject var46 = MusicPatchNode.scene.getGroundObject(Tiles.Client_plane, var7, var38); // L: 7578
					...
					var2 = var1.method7954(); // L: 7585
					var3 = (var2 >> 4 & 7) + class392.field4456; // L: 7586
					var37 = (var2 & 7) + ItemComposition.field2163; // L: 7587
					var5 = var1.method8143(); // L: 7588
					var6 = var1.method7965(); // L: 7589
					var7 = var1.method7955(); // L: 7590
					...
					if (class264.field3047 == var0) { // L: 7622
						var2 = var1.method7964(); // L: 7623
						var3 = var1.readUnsignedShort(); // L: 7624
						var37 = var1.method7955(); // L: 7625
						...
						var2 = var1.method8023(); // L: 7639
						var3 = var2 >> 2; // L: 7640
						var37 = var2 & 3; // L: 7641
						var5 = Client.field564[var3]; // L: 7642
						var6 = var1.method8023(); // L: 7643
	...
	static final boolean method817(Widget var0) {
		...
		if (var1 == 205) { // L: 11756
			...
			if (var1 == 326) { // L: 11772
				PacketBufferNode var4 = class120.getPacketBufferNode(ClientPacket.field3024, Client.packetWriter.isaacCipher); // L: 11774
