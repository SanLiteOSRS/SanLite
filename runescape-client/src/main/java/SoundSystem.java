...
public class SoundSystem implements Runnable {
   ...
   public void run() {
      try {
         ...
         class3.sendStackTrace((String)null, var4);
      }
   ...
   public static void method2415(Buffer var0, int var1) {
   ...
   public static void method2417() {
      try {
         ...
         int var2;
         if (var0.exists()) {
            class167.randomDat = new BufferedFile(new AccessFile(var0, "rw", 25L), 24, 0);
         } else {
            label38:
            for(int var1 = 0; var1 < Login.field1181.length; ++var1) {
               for(var2 = 0; var2 < GrandExchangeEvent.field47.length; ++var2) {
                  ...
                  if (var3.exists()) {
                     class167.randomDat = new BufferedFile(new AccessFile(var3, "rw", 25L), 24, 0);
                     break label38;
                  }
               }
            }
