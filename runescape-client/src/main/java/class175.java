	...
	static boolean updateExternalPlayer(PacketBuffer var0, int var1) {
		...
		if (var2 == 0) {
			...
			if (Client.players[var1] != null) {
				...
				var9 = var7 >> 14 & 255;
				var10 = var7 & 255;
				var11.pathTraversed[0] = Players.field1286[var1];
				var11.plane = (byte)var8;
				var11.resetPath((var9 << 13) + var3 - GrandExchangeOfferOwnWorldComparator.baseX * 64, (var10 << 13) + var4 - VarcInt.baseY * 64);
				var11.field1070 = false;
				return true;
			}
		} else if (var2 == 1) {
