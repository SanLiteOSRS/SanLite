...
public class SpriteMask extends DualNode {
	...
	SpriteMask(int var1, int var2, int[] var3, int[] var4, int var5) {
		this.width = var1; // L: 1086
		this.height = var2; // L: 1087
		this.xWidths = var3; // L: 1088
		this.xStarts = var4; // L: 1089
	} // L: 1090
	...
	public boolean contains(int var1, int var2) {
		if (var2 >= 0 && var2 < this.xStarts.length) { // L: 1093
			int var3 = this.xStarts[var2]; // L: 1094
			if (var1 >= var3 && var1 <= var3 + this.xWidths[var2]) { // L: 1095
				return true;
			}
		}
	...
	public static int method5838(float[] var0, int var1, float var2, boolean var3, float var4, boolean var5, float[] var6) {
		...
		float var44 = (Math.abs(var2) + Math.abs(var4)) * (float)(var1 + 1) * class121.field1479; // L: 19
		if (var7 <= var44) { // L: 20
			return -1; // L: 21
		} else {
			...
			if (var1 == 0) { // L: 31
				...
				class419 var11 = new class419(var9, var1); // L: 50
				...
				int var14 = method5838(var12, var1 - 1, var2, false, var4, false, var41); // L: 56
				if (var14 == -1) { // L: 57
					return 0; // L: 58
				} else {
					...
					for (int var20 = 0; var20 <= var14; ++var20) { // L: 65
						...
						if (var20 == 0) { // L: 67
							var16 = var2; // L: 68
							var18 = AbstractUserComparator.method7640(var9, var1, var2); // L: 69
						...
						var17 = AbstractUserComparator.method7640(var9, var1, var19); // L: 83
						if (var15) { // L: 84
							var15 = false; // L: 85
							...
							float var26 = AbstractUserComparator.method7640(var11.field4664, var11.field4660, var16); // L: 101
							float var23;
							if (Math.abs(var26) < class121.field1479) { // L: 102
								var23 = var16; // L: 103
							} else {
								float var27 = AbstractUserComparator.method7640(var11.field4664, var11.field4660, var19); // L: 106
								if (Math.abs(var27) < class121.field1479) { // L: 107
									var23 = var19; // L: 108
								} else {
									...
									do {
										...
										float var38 = class121.field1480 * Math.abs(var25) + 0.0F; // L: 138
										...
										if (var40) { // L: 141
											if (Math.abs(var30) >= var38 && Math.abs(var26) > Math.abs(var27)) { // L: 142
												...
												if (var28 == var24) { // L: 148
													...
													var31 = ((var32 - var33) * var39 * 2.0F * var32 - (var25 - var24) * (var33 - 1.0F)) * var34; // L: 155
												...
												var34 = var30; // L: 160
												var30 = var29; // L: 161
												if (2.0F * var31 < var32 * 3.0F * var39 - Math.abs(var38 * var32) && var31 < Math.abs(var32 * 0.5F * var34)) { // L: 162
											...
											var27 = AbstractUserComparator.method7640(var11.field4664, var11.field4660, var25); // L: 175
	...
	static void playSong(int var0) {
		if (var0 == -1 && !Client.playingJingle) { // L: 4031
			class177.method3538(); // L: 4032
		} else if (var0 != -1 && var0 != Client.currentTrackGroupId && PacketWriter.clientPreferences.method2495() != 0 && !Client.playingJingle) { // L: 4034
			class284.method5566(2, class153.archive6, var0, 0, PacketWriter.clientPreferences.method2495(), false); // L: 4035
		}

		Client.currentTrackGroupId = var0; // L: 4037
	} // L: 4038
}
