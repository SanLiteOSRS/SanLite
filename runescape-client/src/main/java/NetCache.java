...
public class NetCache {
	...
	public static void method4419(Applet var0, String var1) {
		class51.applet = var0;
		if (var1 != null) {
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			var0 += DesktopPlatformInfoProvider.archive17.method4356() && DesktopPlatformInfoProvider.archive17.isFullyLoaded() ? 1 : 0;
			if (var0 != 100) {
				if (var0 != 0) {
			...
			var28.method3847(9, 128);
			class80.pcmPlayer0 = PendingSpawn.method1809(GameShell.taskHandler, 0, 22050);
			class80.pcmPlayer0.setStream(var28);
			Clock.method3594(Coord.archive15, class192.archive14, NetFileRequest.archive4, var28);
			MenuAction.pcmPlayer1 = PendingSpawn.method1809(GameShell.taskHandler, 1, 2048);
			...
			if (Client.titleLoadingStage == 50) {
				...
				if (Client.titleLoadingStage == 70) {
					if (!AbstractWorldMapIcon.archive2.isFullyLoaded()) {
						...
						MusicPatchNode2.method3779(AbstractWorldMapIcon.archive2);
						...
						Script.method2326(AbstractWorldMapIcon.archive2, Language.archive7);
						...
						class197.method3793(AbstractWorldMapIcon.archive2, BuddyRankComparator.archive0, LoginPacket.archive1);
						PacketWriter.method2372(AbstractWorldMapIcon.archive2, Language.archive7);
						AttackOption.method2174(AbstractWorldMapIcon.archive2);
						...
						TaskHandler.method3575(AbstractWorldMapIcon.archive2, GrandExchangeOfferUnitPriceComparator.archive8, UrlRequest.archive13);
						...
						if (var15.isFullyLoaded()) {
							...
							for (int var17 = 0; var17 < AbstractByteArrayCopier.WorldMapElement_count; ++var17) {
								...
								if (var18 != null) {
									...
									GrandExchangeOfferTotalQuantityComparator.WorldMapElement_cached[var17].method4480();
								}
							}
						}
					...
					if (!WorldMapID.archive10.tryLoadFileByNames("huffman", "")) {
						...
						VerticalAlignment.method4451(var19);
