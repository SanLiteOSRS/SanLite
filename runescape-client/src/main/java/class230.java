	...
	static void readPlayerUpdate(PacketBuffer var0, int var1) {
		...
		if (var3 == 0) { // L: 201
			if (var2) { // L: 202
				...
				Players.Players_regions[var1] = (var4.plane << 28) + (GrandExchangeOfferOwnWorldComparator.baseY * 64 + var4.pathY[0] >> 13) + (SecureRandomCallable.baseX * 64 + var4.pathX[0] >> 13 << 14); // L: 207
			...
			if (var3 == 1) { // L: 215
				...
				if (var5 == 0) { // L: 326
					...
					var10 = (SecureRandomCallable.baseX * 64 + var8 + var4.pathX[0] & 16383) - SecureRandomCallable.baseX * 64; // L: 356
					var11 = (GrandExchangeOfferOwnWorldComparator.baseY * 64 + var9 + var4.pathY[0] & 16383) - GrandExchangeOfferOwnWorldComparator.baseY * 64; // L: 357
