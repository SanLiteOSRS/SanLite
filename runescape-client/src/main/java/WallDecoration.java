...
public final class WallDecoration {
	...
	public static void method4338(String var0, String var1, int var2, int var3) throws IOException {
		...
		FriendsChatManager.JagexCache_idxFiles = new BufferedFile[DevicePcmPlayerProvider.idxCount];

		for (var9 = 0; var9 < DevicePcmPlayerProvider.idxCount; ++var9) {
			FriendsChatManager.JagexCache_idxFiles[var9] = new BufferedFile(new AccessFile(SecureRandomCallable.getFile("main_file_cache.idx" + var9), "rw", 1048576L), 6000, 0);
		}
