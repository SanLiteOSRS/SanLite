...
public class World {
	...
	static void method1427(int var0, int var1, int var2, int var3) {
		for (ObjectSound var4 = (ObjectSound)ObjectSound.objectSounds.last(); var4 != null; var4 = (ObjectSound)ObjectSound.objectSounds.previous()) {
			if (var4.soundEffectId != -1 || var4.soundEffectIds != null) {
				int var5 = 0;
				if (var1 > var4.field722 * 16384) {
					var5 += var1 - var4.field722 * 16384;
				} else if (var1 < var4.x * 16384) {
					var5 += var4.x * 16384 - var1;
				}

				if (var2 > var4.field723 * 128) {
					var5 += var2 - var4.field723 * 128;
				...
				if (var5 - 64 <= var4.field718 && Decimator.clientPreferences.areaSoundEffectsVolume != 0 && var0 == var4.plane) {
					...
					if (var4.stream1 == null) {
						if (var4.soundEffectId >= 0) {
							SoundEffect var7 = SoundEffect.readSoundEffect(InvDefinition.field1520, var4.soundEffectId, 0);
							if (var7 != null) {
					...
					if (var4.stream2 == null) {
						if (var4.soundEffectIds != null && (var4.field725 -= var3) <= 0) {
							...
							SoundEffect var12 = SoundEffect.readSoundEffect(InvDefinition.field1520, var4.soundEffectIds[var11], 0);
							if (var12 != null) {
	...
	public static final void method1428(class32 var0) {
		...
		if (var0 == ScriptOpcodes.WORLDLIST_FETCH) {
			...
			if (var0 == ScriptOpcodes.WORLDLIST_START) {
				...
				if (var0 == ScriptOpcodes.WORLDLIST_SPECIFIC) {
					...
					Nameable.sortWorldList(var3, var10, var8, var6);
					return 1;
	...
	static final void method1426(Actor var0) {
		...
		int var2 = var0.field1062 * 128 + var0.field1023 * 64;
		int var3 = var0.field1064 * 128 + var0.field1023 * 64;
