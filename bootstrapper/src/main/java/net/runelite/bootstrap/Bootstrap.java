...
class Bootstrap
{
	...
	private void createArtifacts()
	{
		try
		{
			...
			artifacts[31].setHash(getChecksumFile("./runelite-client/target/" + artifacts[31].getName()));
			...
			artifacts[32].setHash(getChecksumFile("./runelite-api/target/" + artifacts[32].getName()));
			...
			artifacts[33].setHash(getChecksumFile("./runescape-api/target/" + artifacts[33].getName()));
			...
			artifacts[34].setHash(getChecksumFile("./http-api/target/" + artifacts[34].getName()));
			...
			artifacts[35].setHash(getChecksumFile("./injected-client/target/" + artifacts[35].getName()));
